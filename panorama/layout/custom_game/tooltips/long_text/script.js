...
function localizeMaybe(text) {
    return text.startsWith("#") ? $.Localize(text) : text;
}
function TooltipContents({ title, text }) {
    const localizedTitle = localizeMaybe(title);
    const localizedText = localizeMaybe(text);
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "Content" },
        localizedTitle !== "" && react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "title", text: localizedTitle, html: true }),
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "Text", text: localizedText, html: true })));
}
function setupTooltip() {
    const title = tooltipPanel.GetAttributeString("title", "");
    const text = tooltipPanel.GetAttributeString("text", "");
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_1__.createElement(TooltipContents, { title: title, text: text }), tooltipPanel);
}
(() => {
    tooltipPanel.SetPanelEvent("ontooltiploaded", setupTooltip);
    const parent = tooltipPanel.GetParent();
    const grandParent = parent === null || parent === void 0 ? void 0 : parent.GetParent();
    [parent === null || parent === void 0 ? void 0 : parent.FindChildTraverse("LeftArrow"), parent === null || parent === void 0 ? void 0 : parent.FindChildTraverse("RightArrow"), grandParent === null || grandParent === void 0 ? void 0 : grandParent.FindChildTraverse("TopArrow"), grandParent === null || grandParent === void 0 ? void 0 : grandParent.FindChildTraverse("BottomArrow")].forEach((arrow) => {
        if (arrow) {
            arrow.style.washColor = "#12141a";
        }
    });
    tooltipPanel.style.minHeight = "150px";
})();
