...
const EconTypeWithTag = new Map([
    ["skin", ""],
    ["material_effect", "DOTA_Tooltip_ability_"],
]);
function EconContents({ iEconID, rarity, video, item_type, }) {
    var _a, _b;
    let itemDesc = "";
    if (`#item_${iEconID}_description` != $.Localize(`#item_${iEconID}_description`)) {
        itemDesc = $.Localize(`#item_${iEconID}_description`);
    }
    let tag = "";
