...
"use strict";
/*!**********************************!*\
  !*** ./popups/reward/script.tsx ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RewardPopup: () => (/* binding */ RewardPopup)
/* harmony export */ });
...
function HidePopup() {
    ...
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null), pSelf);
}
const Econ_type = [
    "Barrage",
    "AttackEffect",
...
function RewardPopup({ response_str }) {
    var _a, _b;
    ...
    let add_item_list = (_a = response.add_item_list) !== null && _a !== void 0 ? _a : {};
    let player_vip = (_b = response.player_vip) !== null && _b !== void 0 ? _b : {};
    let pass_duration_text = "";
    if (player_vip != undefined && (player_vip === null || player_vip === void 0 ? void 0 : player_vip.level) == 1) {
        let date = new Date(player_vip.expire * 1000);
        let year = date.getFullYear();
        let month = date.getMonth() + 1 < 10 ? "0" + (date.getMonth() + 1) : date.getMonth() + 1;
        let day = date.getDate() < 10 ? "0" + date.getDate() : date.getDate();
        pass_duration_text = $.Localize("#reward_pass_until") + year + "-" + month + "-" + day;
    }
    let Moonstone = 0;
    let Starlight = 0;
    let Box = [];
    let EconList = [];
    for (const i in add_item_list) {
        const item_info = add_item_list[i];
        const item_type = add_item_list[i].item_type;
        const item_num = add_item_list[i].item_num;
        if (item_type == "Moonstone") {
            Moonstone = Moonstone + item_num;
        }
        else if (item_type == "Starlight") {
            Starlight = Starlight + item_num;
        }
        else if (item_type == "Box") {
            Box.push(item_info);
        }
        else {
            EconList.push(item_info);
        }
    }
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
        if (EconList.length > 0) {
            GameEvents.SendCustomGameEventToServer("refresh_econ_data", {});
        }
    }, [response]);
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "RewardPopup_root", hittest: true, onactivate: () => { HidePopup(); } },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "RewardPopup_main" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardPopup_title", text: $.Localize("#reward_title") }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "RewardPopup_content" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_vip", visibility: pass_duration_text == "" ? "collapse" : "visible" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Reward_vip_title", text: $.Localize("#reward_vip_title") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Reward_vip_text", text: pass_duration_text })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_wallet", visibility: Moonstone > 0 || Starlight > 0 ? "visible" : "collapse" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Reward_wallet_title", text: $.Localize("#reward_wallet_title") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_wallet_content" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "reward_moonstone_text", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: Moonstone > 0 }), html: true, localizedText: "#reward_moonstone_get", dialogVariables: { value: Moonstone } }),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "reward_starlight_text", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: Starlight > 0 }), html: true, localizedText: "#reward_starlight_get", dialogVariables: { value: Starlight } }))),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_item", visibility: EconList.length > 0 ? "visible" : "collapse" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Reward_item_title", text: $.Localize("#reward_item_title") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_item_content" }, EconList.map((item_info, i) => {
                        var _a, _b, _c, _d, _e;
                        let item_id = (_a = item_info.item_id) !== null && _a !== void 0 ? _a : 0;
                        let name = (_b = item_info.item_name) !== null && _b !== void 0 ? _b : "";
                        let dust = (_c = item_info.to_dust) !== null && _c !== void 0 ? _c : 0;
                        let num = (_d = item_info.item_num) !== null && _d !== void 0 ? _d : 1;
                        let rarity = (_e = item_info.item_rarity) !== null && _e !== void 0 ? _e : 0;
                        return react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_econ_item", key: i },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "RewardItemImage", scaling: "stretch", src: "file://{resources}/images/custom_game/items/item_" + item_id + ".png" }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "RewardItemBG", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("Rarity" + rarity) }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "RewardItemNameBG" }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardItemName", localizedText: "#Item_" + item_info.item_id }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardItemNum", text: "x" + num }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardItemToDust", html: true, className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: dust > 0 }), localizedText: "#reward_to_dust", dialogVariables: { value: dust } }));
                    }))),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_box", visibility: Box.length > 0 ? "visible" : "collapse" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Reward_box_title", text: $.Localize("#reward_box_title") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Reward_box_content" }, Box.map((item_info, i) => {
                        var _a;
                        let treasureIndex = Number(item_info.item_id) - 1300000;
                        let num = (_a = item_info.item_num) !== null && _a !== void 0 ? _a : 1;
                        return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "reward_treasure", key: i, className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(`treasure${treasureIndex}`) },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "reward_treasure_num", text: "x" + num }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "reward_treasure_bottombar" },
                                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "reward_treasure_title", text: $.Localize(`#treasure_${treasureIndex}`) }))));
                    })))),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardPopup_close", text: $.Localize("#reward_close") }))));
}
(function () {
    let pSelf = $.GetContextPanel();
    pSelf.SetPanelEvent("onload", () => {
        let response_str = pSelf.GetAttributeString("response_str", "");
        (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(RewardPopup, { response_str: response_str }), $.GetContextPanel());
    });
    pSelf.SetPanelEvent("oncancel", () => {
        (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null), pSelf);
    });
})();
