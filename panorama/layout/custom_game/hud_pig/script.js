...
function Root() {
    ...
    let last_buy_time = ((_h = player_bank_coin === null || player_bank_coin === void 0 ? void 0 : player_bank_coin.last_buy_time) !== null && _h !== void 0 ? _h : 0);
    let joker_coin = ((_j = player_bank_coin === null || player_bank_coin === void 0 ? void 0 : player_bank_coin.joker_coin) !== null && _j !== void 0 ? _j : 0);
    let price = "";
    let productInfo;
    if (productData) {
        let lan = $.Language().toLocaleLowerCase();
        Object.values(productData).forEach((item) => {
            if (item.id === PRODUCT_ID) {
                productInfo = item;
                if (lan == "schinese") {
                    price = "￥" + Number(item.real_price).toFixed(0);
                }
                else if (lan == "russian") {
                    price = "₽" + Number(item.russia_real_price).toFixed(1);
                }
                else {
                    price = "$" + Number(item.overseas_real_price).toFixed(1);
                }
            }
        });
    }
    let countdown = "";
    let buyed = last_buy_time > 0;
    if (player_bank_coin) {
        let now = Date.now();
        const diff = Math.floor((expire_time * 1000 - now));
        ...
        countdown = $.Localize("#countdown_time").replace("{day}", days.toString())
    ...
    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "Hud_Pig", hittest: false, className: classnames__WEBPACK_IMPORTED_MODULE_3___default()({ show: windowState }) },
        ...
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(ToggleButton, { id: "ToggleBtn", selected: (player_setting === null || player_setting === void 0 ? void 0 : player_setting.auto_bank_coin_page) == 0, onactivate: () => {
                let new_data = {
                    ...
                    auto_view_creep: player_setting === null || player_setting === void 0 ? void 0 : player_setting.auto_view_creep,
                    right_ability_selection: player_setting === null || player_setting === void 0 ? void 0 : player_setting.right_ability_selection,
                    auto_bank_coin_page: (player_setting === null || player_setting === void 0 ? void 0 : player_setting.auto_bank_coin_page) == 1 ? 0 : 1,
                };
