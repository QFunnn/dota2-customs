...
/***/ "./EOMDesign/Layout/EOM_Divider/EOM_Divider.tsx"
/*!******************************************************!*\
  !*** ./EOMDesign/Layout/EOM_Divider/EOM_Divider.tsx ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EOM_Divider)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "../../../../../node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
...
class EOM_Divider extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor() {
        super(...arguments);
        this.defaultClass = () => { return classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_Divider", this.props.defaultClass); };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp()), this.props.children));
    }
...
/* harmony import */ var _EOMDesign_Icons_EOM_IconSearch__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../EOMDesign/Icons/EOM_IconSearch */ "./EOMDesign/Icons/EOM_IconSearch.tsx");
...
/* harmony import */ var _EOMDesign_Inputs_EOM_IconButton_EOM_IconButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../EOMDesign/Inputs/EOM_IconButton/EOM_IconButton */ "./EOMDesign/Inputs/EOM_IconButton/EOM_IconButton.tsx");
/* harmony import */ var _EOMDesign_Layout_EOM_Divider_EOM_Divider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../EOMDesign/Layout/EOM_Divider/EOM_Divider */ "./EOMDesign/Layout/EOM_Divider/EOM_Divider.tsx");
...
function Handbook() {
    ...
    const CosmeticData = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
        const data = {};
        for (const Econ_type in EconList) {
            const list = EconList[Econ_type];
            if (list != undefined) {
                for (const i in list) {
                    const econ = list[i];
                    if (data[Econ_type] == undefined) {
                        data[Econ_type] = {};
                    }
                    let bid = econ.bid;
                    data[Econ_type][econ.id] = {
                        rarity: econ.rarity,
                        tag: BidTreasureMap[bid],
                        cost: econ.cost,
                        name: econ.name,
                        is_collectible: econ.is_collectible == 1,
                    };
                }
            }
        }
    ...
    const keys = Object.keys(CosmeticData).sort((a, b) => {
        if (a == "AttackEffect" || a == "BlinkEffect") {
            return 1;
        }
        return -1;
    });
    ...
    {
        let list = {};
        for (const i in Econ_type) {
            list[Econ_type[i]] = {};
        }
        for (const index in Econdata_Barrage) {
            const EconInfo = Econdata_Barrage[index];
            list["Barrage"][String(EconInfo.item_id)] = {
        ...
        for (const index in Econdata_AttackEffect) {
            const EconInfo = Econdata_AttackEffect[index];
            list["AttackEffect"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_Wearable) {
            const EconInfo = Econdata_Wearable[index];
            list["Wearable"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_Pet) {
            const EconInfo = Econdata_Pet[index];
            list["Pet"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_KillSound) {
            const EconInfo = Econdata_KillSound[index];
            list["KillSound"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_KillEffect) {
            const EconInfo = Econdata_KillEffect[index];
            list["KillEffect"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_BlinkEffect) {
            const EconInfo = Econdata_BlinkEffect[index];
            list["BlinkEffect"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_CosmeticsAbility) {
            const EconInfo = Econdata_CosmeticsAbility[index];
            list["CosmeticsAbility"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_Particle) {
            const EconInfo = Econdata_Particle[index];
            list["Particle"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_Avatar) {
            const EconInfo = Econdata_Avatar[index];
            list["Avatar"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
        ...
        for (const index in Econdata_PetParticle) {
            const EconInfo = Econdata_PetParticle[index];
            list["PetParticle"][String(EconInfo.item_id)] = {
                equip: EconInfo.equip == "1" ? "true" : "false",
                type: EconInfo.item_type,
                name: EconInfo.item_name,
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Handbook", align: "center center", width: "1428px", height: "92%" },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookTabGroup" }, keys.map((type, index) => {
            const lock = !bPASS && (type == "AttackEffect" || type == "BlinkEffect");
            return react__WEBPACK_IMPORTED_MODULE_2__.createElement(TabButton, { enabled: !lock, key: index, id: type, group: "HandbookTabGroup", localizedText: "#" + type, selected: index == 0 }, lock && react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "Lock" }));
        })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Layout_EOM_Divider_EOM_Divider__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "HandbookDivider" }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookItemContainer" }, keys.map((type, index) => {
            var _a, _b;
            return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(HandbookItemList, { key: type, type: type, selected: index == 0, itemList: CosmeticData[type], PlayerEconData: PlayerEconData[type], starlight: (_b = (_a = moneyData === null || moneyData === void 0 ? void 0 : moneyData[Players.GetLocalPlayer()]) === null || _a === void 0 ? void 0 : _a.starlight) !== null && _b !== void 0 ? _b : 0 }));
        }))));
}
function HandbookItemList({ type, selected, itemList, PlayerEconData, starlight }) {
    const [tag, setTag] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(0);
    const [filterWord, setFilterWord] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [equipList, setEquipList] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
    const [showOwned, setShowOwned] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(true);
    const [showNotOwned, setShowNotOwned] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(true);
    const [rarityFilters, setRarityFilters] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({
        "0": true,
        "4": true,
        "3": true,
        "2": true,
    ...
    const ownedCount = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
        if (!itemList || !PlayerEconData)
            return 0;
        return Object.keys(itemList).filter(itemID => itemID !== "5000097" && PlayerEconData[itemID] !== undefined).length;
    }, [itemList, PlayerEconData]);
    const notOwnedCount = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
        if (!itemList)
            return 0;
        return Object.keys(itemList).filter(itemID => itemID !== "5000097" && (PlayerEconData === undefined || PlayerEconData[itemID] === undefined)).length;
    }, [itemList, PlayerEconData]);
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
        let list = [];
        if (PlayerEconData != undefined) {
            for (const itemID in PlayerEconData) {
                const element = PlayerEconData[itemID];
                if (element != undefined) {
                    if (element.equip == "true") {
                        list.push(itemID);
                    }
                }
            }
    ...
    const ChangeEquip = (itemID, isEquip, IsTemp) => {
        if (!IsTemp) {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__.Send2ServerCallback)("equip_item", { item_id: Number(itemID), equip: isEquip, type: type }, () => { });
        }
        else {
            GameEvents.SendCustomGameEventToServer('EquipTempItem', {
                item_id: Number(itemID), type: type, equip: isEquip ? 1 : 0
            });
        }
    };
    const toggleRarity = (rarity) => {
        setRarityFilters(prev => (Object.assign(Object.assign({}, prev), { [rarity]: !prev[rarity] })));
    };
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(TabContents, { tabid: type, group: "HandbookTabGroup", selected: selected },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookSubHeader", flowChildren: "right" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "FilterCheckboxes" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Owned", selected: showOwned, onactivate: () => setShowOwned(!showOwned) },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: `${$.Localize("#DOTA_Shop_Item_Already_Owned")} (${ownedCount})` })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_NotOwned", selected: showNotOwned, onactivate: () => setShowNotOwned(!showNotOwned) },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: `${$.Localize("#DOTA_Diretide2020_Cosmetics_Not_Owned")} (${notOwnedCount})` })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Limited", selected: rarityFilters["0"], onactivate: () => toggleRarity("0") },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#rarity_0") })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Immortal", selected: rarityFilters["4"], onactivate: () => toggleRarity("4") },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#rarity_4") })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Mythical", selected: rarityFilters["3"], onactivate: () => toggleRarity("3") },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#rarity_3") })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Rare", selected: rarityFilters["2"], onactivate: () => toggleRarity("2") },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#rarity_2") })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(ToggleButton, { className: "Filter_Normal", selected: rarityFilters["1"], onactivate: () => toggleRarity("1") },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#rarity_1") }))),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookSearch" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextEntry, { placeholder: "#DOTA_Search", oninputsubmit: (self) => {
                        setFilterWord(self.text);
                    }, ontextentrychange: (self) => {
                        if (self.text == "") {
                            setFilterWord("");
                        }
                    } }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_IconButton_EOM_IconButton__WEBPACK_IMPORTED_MODULE_7__.EOM_IconButton, { align: "right center", width: "24px", icon: react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Icons_EOM_IconSearch__WEBPACK_IMPORTED_MODULE_5__["default"], null) }))),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Layout_EOM_Divider_EOM_Divider__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "HandbookBreadcrumbDivider" }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookItemList", width: "100%", scroll: "y", flowChildren: "down" },
            showOwned && (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { width: "100%", flowChildren: "right-wrap" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "HandbookItemListPlayer" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#DOTA_Shop_Item_Already_Owned") })),
                Object.keys(itemList).sort((a, b) => { var _a, _b, _c, _d; return ((Number((_b = (_a = itemList === null || itemList === void 0 ? void 0 : itemList[a]) === null || _a === void 0 ? void 0 : _a.rarity) !== null && _b !== void 0 ? _b : "1")) >= (Number((_d = (_c = itemList === null || itemList === void 0 ? void 0 : itemList[b]) === null || _c === void 0 ? void 0 : _c.rarity) !== null && _d !== void 0 ? _d : "1")) ? -1 : 1); }).map((itemID, index) => {
                    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
                    if (PlayerEconData != undefined && PlayerEconData[itemID] != undefined && itemList != undefined) {
                        let name = PlayerEconData[itemID].name;
                        let rarity = (_b = (_a = itemList[itemID]) === null || _a === void 0 ? void 0 : _a.rarity) !== null && _b !== void 0 ? _b : "1";
                        if (rarityFilters[rarity] !== false) {
                            if (Number(itemList[itemID].tag) == tag || tag == 0) {
                                if (itemID == "5000097")
                                    return;
                                if (name.search(new RegExp(filterWord, "gim")) > -1 || $.Localize("#Item_" + itemID).search(new RegExp(filterWord, "gim")) > -1) {
                                    return react__WEBPACK_IMPORTED_MODULE_2__.createElement(HandbookItem, { equip: equipList.indexOf(itemID) != -1, key: itemID, id: itemID, name: name, cost: (_d = (_c = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _c === void 0 ? void 0 : _c.cost) !== null && _d !== void 0 ? _d : 0, tag: (_f = (_e = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _e === void 0 ? void 0 : _e.tag) !== null && _f !== void 0 ? _f : "", rarity: (_h = (_g = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _g === void 0 ? void 0 : _g.rarity) !== null && _h !== void 0 ? _h : "1", temp: (_j = PlayerEconData === null || PlayerEconData === void 0 ? void 0 : PlayerEconData[itemID]) === null || _j === void 0 ? void 0 : _j.temp, is_collectible: (_k = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _k === void 0 ? void 0 : _k.is_collectible, onEquip: (id) => {
                                            let origin_item = "";
                                            if (PlayerEconData[id].type == "Wearable") {
                                                if (equipList[1] != undefined) {
                                                    origin_item = equipList[1];
                                                }
                                                setEquipList([equipList[1], itemID]);
                                            }
                                            else {
                                                origin_item = equipList[0];
                                                setEquipList([itemID]);
                                            }
                                            if (origin_item != "" && origin_item != undefined) {
                                                if (!PlayerEconData[origin_item].temp) {
                                                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__.Send2ServerCallback)("equip_item", {
                                                        item_id: Number(origin_item), type: type, equip: 0
                                                    }, (response) => {
                                                        if (response.result == 1) {
                                                            ChangeEquip(itemID, 1, PlayerEconData[itemID].temp);
                                                        }
                                                    });
                                                }
                                                else {
                                                    ChangeEquip(itemID, 0, PlayerEconData[origin_item].temp);
                                                    ChangeEquip(itemID, 1, PlayerEconData[itemID].temp);
                                                }
                                            }
                                            else {
                                            ...
                                            if (PlayerEconData[id].type == "Wearable") {
                                                if (equipList.indexOf(id) > -1) {
                                                    setEquipList(equipList.splice(equipList.indexOf(id), 1));
                                                }
                                            }
                                            else {
                                                setEquipList([]);
                                            }
                                            ChangeEquip(itemID, 0, PlayerEconData[itemID].temp);
                                        } });
                                }
                            }
                        }
            ...
            showNotOwned && (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { width: "100%", flowChildren: "right-wrap" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "HandbookItemListLock" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: $.Localize("#DOTA_Diretide2020_Cosmetics_Not_Owned") })),
                Object.keys(itemList).sort((a, b) => { var _a, _b, _c, _d; return ((Number((_b = (_a = itemList === null || itemList === void 0 ? void 0 : itemList[a]) === null || _a === void 0 ? void 0 : _a.rarity) !== null && _b !== void 0 ? _b : "1")) >= (Number((_d = (_c = itemList === null || itemList === void 0 ? void 0 : itemList[b]) === null || _c === void 0 ? void 0 : _c.rarity) !== null && _d !== void 0 ? _d : "1")) ? -1 : 1); }).map((itemID, index) => {
                    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
                    if (itemID == "5000097")
                        return;
                    if (PlayerEconData != undefined && itemList != undefined) {
                        if (PlayerEconData[itemID] == undefined) {
                            let name = itemList[itemID].name;
                            let rarity = (_b = (_a = itemList[itemID]) === null || _a === void 0 ? void 0 : _a.rarity) !== null && _b !== void 0 ? _b : "1";
                            if (rarityFilters[rarity] !== false) {
                                if (Number(itemList[itemID].tag) == tag || tag == 0) {
                                    if (name.search(new RegExp(filterWord, "gim")) > -1 || $.Localize("#econ_" + name).search(new RegExp(filterWord, "gim")) > -1) {
                                        return react__WEBPACK_IMPORTED_MODULE_2__.createElement(HandbookItem, { key: itemID, id: itemID, name: name, cost: (_d = (_c = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _c === void 0 ? void 0 : _c.cost) !== null && _d !== void 0 ? _d : 0, tag: (_f = (_e = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _e === void 0 ? void 0 : _e.tag) !== null && _f !== void 0 ? _f : "", rarity: (_h = (_g = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _g === void 0 ? void 0 : _g.rarity) !== null && _h !== void 0 ? _h : "1", starlight: starlight, is_collectible: (_j = itemList === null || itemList === void 0 ? void 0 : itemList[itemID]) === null || _j === void 0 ? void 0 : _j.is_collectible });
                                    }
                                }
                            }
                        }
...
function HandbookItem({ id, name, equip, cost, tag, rarity, temp, starlight, onEquip, onUnequip, is_collectible }) {
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("HandbookItem", "Rarity" + rarity, { Lock: equip == undefined }), flowChildren: "down", width: "250px" },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookItemWrapper", width: "250px", height: "280px" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { width: "250px", height: "280px" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "HandbookItemImage", scaling: "stretch", src: "file://{resources}/images/custom_game/items/item_" + id + ".png" }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "HandbookItemBG" }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "HandbookItemNameBG" }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "HandbookItemName", localizedText: "#item_" + id }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookItemRarity", className: "HandbookItemLineBg" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { localizedText: "#rarity_" + rarity })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HandbookItemLink" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "HandbookItemRarityIcon" })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "HandbookItemTemp", text: $.Localize("#handbook_item_temp"), className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: temp }) })),
            is_collectible && (react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "HandbookItemCollectibleTag", src: $.Language() === "schinese" ? "file://{images}/custom_game/new_draw/tag_mythic_zh.png" : "file://{images}/custom_game/new_draw/tag_mythic_en.png" }))),
        equip == true &&
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { horizontalAlign: "center" }, localizedText: "#Remove", type: "Tui3", color: "Red", onactivate: () => {
                    if (onUnequip) {
                        onUnequip(id);
                    }
                } }),
        equip == false &&
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { horizontalAlign: "center" }, localizedText: "#Equip", type: "Tui3", color: "Green", onactivate: () => {
                    if (onEquip) {
                        onEquip(id);
                    }
                } }),
        equip == undefined &&
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_6__["default"], { style: { horizontalAlign: "center" }, type: "Tui3", color: "Purple", visibility: cost > 0 ? "collapse" : "visible", enabled: (starlight !== null && starlight !== void 0 ? starlight : 0) >= cost, onactivate: () => {
                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__.Send2ServerCallback)("shard_exchange", { item_id: id }, (response) => {
                        if (response.result != undefined && response.result == -1) {
                            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__.ShowCustomPopup)("CommonMsg", { title: "", content: ($.Localize("#common_exchange_fail")) });
                        }
                        else {
                            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_9__.ShowPopup)("RewardPopup", "reward", { response_str: JSON.stringify(response) });
                        }
                    });
                } },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { align: "center center", flowChildren: "right" },
                    cost > 0 ? react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Icons_EOM_Icon_EOM_Icon__WEBPACK_IMPORTED_MODULE_4__["default"], { width: "26px", src: "file://{images}/custom_game/icon/shard.png", style: { marginRight: "4px" } })
                        : react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: cost > 0 ? cost : $.Localize("#treasure_0") })))));
}


/***/ },

/***/ "./hud_customer_service/script.tsx"
/*!*****************************************!*\
  !*** ./hud_customer_service/script.tsx ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function CustomerService() {
    let IsCNplayer = $.Language() == "schinese";
    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "CustomerService_qrcode" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "qrcode_main", className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("", { Show: IsCNplayer }) }),
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(TextButton, { id: "qrcode_abroad", className: classnames__WEBPACK_IMPORTED_MODULE_0___default()({ Show: !IsCNplayer }), text: $.Localize("#Join_Discord"), onactivate: () => {
...
const CAN_PAY_LIMIT = 10;
let hud_inventory_change_page_listener;
function hasProductWithTag(productData, tag) {
    var _a;
    if (productData == undefined) {
        return false;
    }
    for (const i in productData) {
        if (((_a = productData[i]) === null || _a === void 0 ? void 0 : _a.tag) == tag) {
            return true;
        }
    }
    return false;
...
function Inventory() {
    ...
    }, [Page, hasPurchaseProducts, hasLimitProducts]);
    if (hud_inventory_change_page_listener) {
        GameEvents.Unsubscribe(hud_inventory_change_page_listener);
    }
    hud_inventory_change_page_listener = GameEvents.Subscribe("hud_inventory_change_page", (event) => {
        SetPage(event.page);
    });
...
function PassPage({ money, productData, canPay }) {
    ...
    if (((_b = (_a = passData === null || passData === void 0 ? void 0 : passData[player_id]) === null || _a === void 0 ? void 0 : _a.level) !== null && _b !== void 0 ? _b : 0) == 1) {
        let date = new Date(passData[player_id].expire * 1000);
        let year = date.getFullYear();
        let month = date.getMonth() + 1 < 10 ? "0" + (date.getMonth() + 1) : date.getMonth() + 1;
        let day = date.getDate() < 10 ? "0" + date.getDate() : date.getDate();
        pass_duration_text = $.Localize("#pass_until") + year + "-" + month + "-" + day;
    }
    let product_joker = {};
    let product_cash = [];
    if (productData) {
        for (const i in productData) {
            ...
            if (product && product.tag == "Pass") {
                if (product.pay_type) {
                    product_joker = product;
                }
                else {
                    let new_product = Object.assign({}, product);
                    let lang = $.Language().toLocaleLowerCase();
                    if (lang == "schinese") {
                        new_product.price_to_show = `(￥${((_c = product.real_price) !== null && _c !== void 0 ? _c : 0).toFixed(2)})`;
                    }
                    else if (lang == "russian") {
                        new_product.price_to_show = `(₽${((_d = product.russia_real_price) !== null && _d !== void 0 ? _d : 0).toFixed(2)})`;
                    }
                    else {
                        new_product.price_to_show = `($${((_e = product.overseas_real_price) !== null && _e !== void 0 ? _e : 0).toFixed(2)})`;
                    }
                    product_cash.push(new_product);
                }
            }
        }
    }
                ...
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Button, { id: "BuyBtn", onactivate: () => {
                        if (canPay) {
                            ...
                            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_7__.ShowCustomPopup)("CommonNotice", {
                                ...
                                bottom: ($.Localize("#Unique_no_pay_button_desc_bottom")),
                                width: 1200,
                                height: 800,
                            });
                        }
    ...
    if (productData != undefined) {
        for (const i in productData) {
            ...
            if (product != undefined) {
                if (product.tag == "Resource") {
                    let price = "";
                    let item_list = [];
                    if ($.Language() == "schinese") {
                        price = "￥" + Number((_a = product.real_price) !== null && _a !== void 0 ? _a : 0).toFixed(0);
                    }
                    else if ($.Language() == "russian") {
                        price = "₽" + Number((_b = product.russia_real_price) !== null && _b !== void 0 ? _b : 0).toFixed(1);
                    }
                    else {
                        price = "$" + Number((_c = product.overseas_real_price) !== null && _c !== void 0 ? _c : 0).toFixed(1);
                    }
                    for (const j in product.items) {
...
function getLimitPayTypeIcon(payType) {
    ...
    return `file://{images}/custom_game/token/${payType}.png`;
}
function LimitPage({ productData, productLimitData, canPay }) {
    var _a;
    let store_items = [];
    let productLimitCounts = {};
    if (productLimitData != undefined) {
        const playerId = Players.GetLocalPlayer();
        const playerLimitData = productLimitData[playerId];
        if (playerLimitData != undefined) {
            for (const i in playerLimitData) {
                const limitInfo = playerLimitData[i];
                if (limitInfo != undefined && limitInfo.pid != undefined) {
                    productLimitCounts[String(limitInfo.pid)] = (_a = limitInfo.count) !== null && _a !== void 0 ? _a : 0;
                }
            }
        }
    }
    if (productData != undefined) {
        for (const i in productData) {
            const product = productData[i];
            if (product != undefined && product.tag == "xianshi") {
                store_items.push(product);
            }
        }
    }
