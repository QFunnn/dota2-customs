...
/* harmony import */ var _EOMDesign_Inputs_EOM_SearchBox_EOM_SearchBox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../EOMDesign/Inputs/EOM_SearchBox/EOM_SearchBox */ "./EOMDesign/Inputs/EOM_SearchBox/EOM_SearchBox.tsx");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/utils */ "./utils/utils.ts");
/* harmony import */ var _base_popup__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../base_popup */ "./hud_popup/base_popup.tsx");
...
const notPayssion = [1000, 2000, 3000, 5000];
const pID2Name = {
    [1000]: "alipay",
    [2000]: "wechat",
    [3000]: "paypal",
...
class Popup_StoreMoneyPayment extends _EOMDesign_EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_6__["default"] {
    constructor(props) {
        ...
        this.defaultPayment = (_d = (_c = GameUI.CustomUIConfig().PaymentWayKv[this.currency].default) !== null && _c !== void 0 ? _c : GameUI.CustomUIConfig().PaymentWayKv["USD"].default) !== null && _d !== void 0 ? _d : {};
    }
    componentDidMount() {
        const { itemData, count } = this.props;
        this.requestIDList.push((0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.Send2ServerCallback)("order_create", {
        ...
        this.eventID = GameEvents.Subscribe("payment_result", (event) => {
            if (event.order_id == this.state.alipay.order) {
                ...
                if (event.status == 0) {
                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "success", PopupID: this.overseaPupupID, group: this.props.group });
                    this.onPaymentEnd(0);
                }
                else if (event.status == 1) {
                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "gotoUrl", PopupID: this.overseaPupupID, group: this.props.group });
                    this.onPaymentEnd(1);
                }
                else if (event.status == 2) {
                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "failure", PopupID: this.overseaPupupID, group: this.props.group });
                    this.onPaymentEnd(2);
                }
            }
        });
    ...
    onPaymentEnd(status) {
        ...
        switch (status) {
            case 1:
                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreBuyItemResult", { result: "success", group: this.props.group });
                break;
            default:
                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreBuyItemResult", { result: "failure", group: this.props.group });
                break;
        }
    }
    componentWillUnmount() {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.print)("componentWillUnmount");
    ...
    UpdateOtherPayment() {
        var _a;
        return Object.entries((_a = GameUI.CustomUIConfig().PaymentWayKv[this.state.currency].others) !== null && _a !== void 0 ? _a : {});
    }
    filterPayments(word) {
        var _a;
        let otherPayment = Object.entries((_a = GameUI.CustomUIConfig().PaymentWayKv[this.state.currency].others) !== null && _a !== void 0 ? _a : {});
        if (word == "") {
            return otherPayment;
        }
        else {
            let RegT = new RegExp(word);
            return otherPayment.filter(([pay_name]) => {
                return RegT.test((String(pay_name)));
            });
        }
    }
    convertSteamIDtoFakeName(steamID) {
        let result = "";
        for (let index = 0; index < steamID.length; index++) {
            const str = steamID[index];
            result += String.fromCharCode(Number(str) + 97);
        }
        return result;
    }
    requestLinkAndOpen(paytype, pmid, email) {
        var _a;
        const itemData = this.props.itemData;
        const params = {
            pid: itemData.id,
        ...
        if (paytype == 1000) {
            if (this.state.alipay.link != "") {
                this.overseaPupupID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreQRCodePayment", { result: "loading", link: this.state.alipay.link, logo: "file://{images}/custom_game/icon/alipay_logo.png", group: this.props.group });
            }
        }
        else if (paytype == 2000) {
            if (this.state.wxpay.link != "") {
                this.overseaPupupID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreQRCodePayment", { result: "loading", link: this.state.wxpay.link, logo: "file://{images}/custom_game/icon/wxpay_logo.png", group: this.props.group });
            }
        }
        else {
            this.overseaPupupID = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "loading", group: this.props.group });
            this.requestIDList.push((0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.Send2ServerCallback)("order_create", {
                ...
                pay_type: paytype,
                p_mid: params.pmid,
                contributor: (_a = GameUI.CustomUIConfig().PaymentWayKv.RegionMap[params.pmid]) !== null && _a !== void 0 ? _a : "",
            }, (res) => {
                var _a, _b;
                if (res.code == 0 && ((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.payment_order)) {
                    ...
                    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "gotoUrl", link: res.data.payment_order.link, PopupID: this.overseaPupupID, group: this.props.group });
                }
                else {
                    if (((_b = res === null || res === void 0 ? void 0 : res.data) === null || _b === void 0 ? void 0 : _b.payment_order) != undefined) {
                        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.ShowCustomPopup)("StoreOverseaPayment", { result: "failure", link: res.data.payment_order.link, PopupID: this.overseaPupupID, group: this.props.group });
                    }
                }
            }));
        }
    ...
    render() {
        const { PopupID, itemData, count, group } = this.props;
        const { alipay, wxpay, status, autoCloseTime, payTab, filteredPayments, currency, email } = this.state;
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_base_popup__WEBPACK_IMPORTED_MODULE_9__.BasePopup, { width: "960px", height: "580px", group: group, title: "#Popup_StoreMoneyPayment_Title", closeOnClickOuter: status != -1, closeOnEsc: status != -1 },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { horizontalAlign: "center", width: "100%", marginTop: "10px" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { visibility: payTab == "right" ? "visible" : "collapse", horizontalAlign: "left", verticalAlign: "center", flowChildren: "right", width: "fit-children" }, ["CNY", "USD", "RUB"].map((currency_name, i) => {
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(RadioButton, { key: i, className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("CurrencyOption"), group: "currency", text: $.Localize("#PaymentCurrency_" + currency_name), selected: currency == currency_name, onactivate: () => {
                            this.setState({ currency: currency_name });
                            this.setState({ otherPayment: this.UpdateOtherPayment() });
                            this.setState({ filteredPayments: this.filterPayments("") });
                        } });
                })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { horizontalAlign: "center", verticalAlign: "center", flowChildren: "right" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_DataDisplay_EOM_Label_EOM_Label__WEBPACK_IMPORTED_MODULE_3__["default"], { color: "#FFD05F", fontSize: "24px", text: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_8__.getStoreItemCost)(itemData, count) })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Inputs_EOM_SearchBox_EOM_SearchBox__WEBPACK_IMPORTED_MODULE_7__.EOM_SearchBox, { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(payTab), onSearch: text => this.setState({ filteredPayments: this.filterPayments(text) }) })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(payTab), width: "100%", height: "300px", margin: "20px" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_base_popup__WEBPACK_IMPORTED_MODULE_9__.PopupBox, { id: "NormalType", width: "100%", height: "100%" },
                    ...
                    this.language != "schinese" &&
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { align: "center center", flowChildren: "right-wrap", width: "100%", height: "100%", scroll: "y" }, Object.entries(this.defaultPayment).map(([pay_name, pay_type]) => {
                            let payType = Number.isNaN(Number(pay_type)) ? 6000 : pay_type;
                            return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { key: pay_name, className: "PaytypeMain", onactivate: () => this.requestLinkAndOpen(payType, pay_name, email) },
                                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Image, { src: `file://{images}/custom_game/paymentways/${pay_name}.png` })));
                        }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_base_popup__WEBPACK_IMPORTED_MODULE_9__.PopupBox, { id: "MoreType", width: "100%", height: "100%", flowChildren: "right-wrap", scroll: "y" }, filteredPayments.map(([pay_name, pay_type]) => {
                    let payType = Number.isNaN(Number(pay_type)) ? 6000 : pay_type;
                    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { key: pay_name, className: "Paytype", onactivate: self => {
                            ...
                            this.requestLinkAndOpen(payType, pay_name, email);
                        } },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Image, { src: `file://{images}/custom_game/paymentways/${pay_name}.png` })));
                }))),
