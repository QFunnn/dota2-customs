...
function PlayerLose() {
    const [windowState, toggleWindow] = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.useToggleWindow)("HUD_PlayerLose");
    const [GameRank, SetGameRank] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(8);
    const [TeamCount, SetTeamCount] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(8);
    const [score_new, setScore] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(0);
    const [score_origin, setOriginScore] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(0);
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.useGameEvent)("ShowPlayerLose", (event) => {
        var _a, _b;
        toggleWindow(true);
        SetGameRank(event.game_rank);
        SetTeamCount(event.valid_team);
        setScore((_a = event.score) !== null && _a !== void 0 ? _a : 0);
        setOriginScore((_b = event.origin_score) !== null && _b !== void 0 ? _b : 0);
    });
    return (!windowState ?
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null)
        :
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_root", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: windowState }) },
                ...
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_main" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_Topbar" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "HUD_PlayerLose_title", text: $.Localize("#HUD_PlayerLose_you_lose") })),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_rank" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "rank_title" },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "rank_title_text", text: $.Localize("#HUD_PlayerLose_your_rank") })),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "rank_main" },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "rank_main_text", text: `${GameRank} / ${TeamCount}` }))),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_DotaMind" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "DotaMind_title" },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "rank_title_text", text: $.Localize("#dota_mind_score") })),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "DotaMind_main" },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "DotaMind_main_origin", text: score_origin.toFixed(0) }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "DotaMind_main_arrow" }),
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "DotaMind_main_new", text: score_new.toFixed(0) })),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "DotaMind_bottom" },
                            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "DotaMind_desc", text: $.Localize("#HUD_PlayerLose_desc") }))),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_PlayerLose_Bottombar" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_4__["default"], { width: "160px", height: "60px", align: "left center", text: $.Localize("#HUD_EndGame_shopping"), color: "Gold", onactivate: () => {
                                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_6__.RecordButtonClick)("PlayerLose_Store");
                                ToggleWindows("Hud_Inventory", true);
                            } }),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_4__["default"], { width: "160px", height: "60px", align: "right center", text: $.Localize("#HUD_PlayerLose_confirm"), color: "Blue", onactivate: () => {
                                toggleWindow(false);
                            } })))));
}
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(PlayerLose, null), $.GetContextPanel());
