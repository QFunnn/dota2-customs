...
/* harmony import */ var _hud_customer_service_script__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../hud_customer_service/script */ "./hud_customer_service/script.tsx");
...
const FEEDBACK_LENGTH_LIMIT = 1000;
function Feedback() {
    var _a;
    const [windowState, toggleWindow] = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.useToggleWindow)("Hud_Feedback");
    const refFeedbackEntry = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
    ...
    return (!windowState ?
        ...
        :
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_Feedback_root", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: windowState }) },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_hud_customer_service_script__WEBPACK_IMPORTED_MODULE_4__.CustomerService, null),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_Feedback_main" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "HUD_Feedback_title" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "HUD_Feedback_title_text", text: $.Localize("#HUD_Feedback_title_text") }),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Button, { id: "HUD_Feedback_close_button", onactivate: () => {
                                toggleWindow(false);
                            } })),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextEntry, { id: "HUD_Feedback_textentry", multiline: true, ref: refFeedbackEntry, placeholder: $.Localize("#HUD_Feedback_textentry_placeholder"), ontextentrychange: () => {
                            var _a, _b;
                            if (refFeedbackEntry.current != undefined) {
                                SetContent((_b = (_a = refFeedbackEntry === null || refFeedbackEntry === void 0 ? void 0 : refFeedbackEntry.current) === null || _a === void 0 ? void 0 : _a.text) !== null && _b !== void 0 ? _b : "");
                            }
                            else {
                                SetContent("");
                            }
                        } },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "HUD_Feedback_limit", text: ((_a = refFeedbackEntry.current) === null || _a === void 0 ? void 0 : _a.text.length) + " / " + FEEDBACK_LENGTH_LIMIT })),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextButton, { id: "HUD_Feedback_confirm", enabled: refFeedbackEntry != undefined && Content != "", text: $.Localize("#HUD_Feedback_confirm"), onactivate: () => {
                            var _a;
                            GameEvents.SendCustomGameEventToServer("send_feedback", {
                                desc: ((_a = refFeedbackEntry.current) === null || _a === void 0 ? void 0 : _a.text) || "",
                            });
                            if (refFeedbackEntry.current != undefined) {
                                refFeedbackEntry.current.text = "";
                            }
                            Game.EmitSound("General.ButtonClick");
                        } }))));
}
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(Feedback, null), $.GetContextPanel());
