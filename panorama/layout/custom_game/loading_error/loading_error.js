...
/***/ "./commonLib/hooks/useIsComponnetMounted.ts"
/*!**************************************************!*\
  !*** ./commonLib/hooks/useIsComponnetMounted.ts ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ useIsComponentMounted)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../../../node_modules/react/index.js");
...
/***/ "./commonLib/hooks/useMakeRender.ts"
/*!******************************************!*\
  !*** ./commonLib/hooks/useMakeRender.ts ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useMakeRenderOnLocalEvent: () => (/* binding */ useMakeRenderOnLocalEvent)
/* harmony export */ });
/* unused harmony exports useMakeRender, useMakeRenderOnLocalEventByDep, useMakeRenderOnLocalEventCallback */
/* harmony import */ var _useLocalEvent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./useLocalEvent */ "./commonLib/hooks/useLocalEvent.ts");
/* harmony import */ var _useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./useStateIfMounted */ "./commonLib/hooks/useStateIfMounted.ts");


//如果某个状态是一个对象或数组，更新改状态属性的时候不想新建对象，令状态改变从而刷新组件，可使用useMakerRender来改变一个flag状态来让组件刷新
function useMakeRender() {
    const [flag, setFlag] = (0,_useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__["default"])(false);
    const [makeRender] = (0,_useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__["default"])(() => {
        //$.Msg("makeRender");
        return (doIt = true) => {
            if (doIt != false) {
                setFlag(prev => !prev);
...
function useMakeRenderOnLocalEvent(eventName, enableObj) {
    const makeRender = useMakeRender();
    const enabled = (enableObj === null || enableObj === void 0 ? void 0 : enableObj.enabled) !== false;
    (0,_useLocalEvent__WEBPACK_IMPORTED_MODULE_0__.useLocalEvent)(eventName, () => {
        makeRender();
    }, [makeRender], enabled);
}
function useMakeRenderOnLocalEventByDep(eventName, enabled) {
    const makeRender = useMakeRender();
    (0,_useLocalEvent__WEBPACK_IMPORTED_MODULE_0__.useLocalEvent)(eventName, () => {
        if (enabled != false) {
            makeRender();
...
function useMakeRenderOnLocalEventCallback(eventName, listener, dependencies = []) {
    const makeRender = useMakeRender();
    (0,_useLocalEvent__WEBPACK_IMPORTED_MODULE_0__.useLocalEvent)(eventName, data => {
...
/***/ "./commonLib/hooks/useStateIfMounted.ts"
/*!**********************************************!*\
  !*** ./commonLib/hooks/useStateIfMounted.ts ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ useStateIfMounted)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../../../node_modules/react/index.js");
...
/* harmony export */ });
/* unused harmony exports emitLocalEvent, onceLocalEvent, onLocalEventWithPrecondition, onLocalEventAndDoFirst, clearAllLocalEventListeners, checkAndClearOnReload */
// 初始化监听器注册表（挂载到全局）
...
/***/ "./commonLib/utils/localize_utils.ts"
/*!*******************************************!*\
  !*** ./commonLib/utils/localize_utils.ts ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getFormatLocalize: () => (/* binding */ getFormatLocalize)
/* harmony export */ });
/* unused harmony exports getlocalize, getlocalize2, getFormatLocalizeEmpty, getRawLocalize, getValidLocalize */
/* harmony import */ var _string_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./string_utils */ "./commonLib/utils/string_utils.ts");
/**
 * 本地化相关工具方法
 */

/**
 * 获取本地化,可以传入服务器给定的本地化，或者本地化的本地化。
 * @param serverLocalize 服务器本地化
 * @param localLocalize  本地本地化
 * @returns
 */
function getlocalize(serverLocalize, local) {
    var _a, _b, _c;
    const language = $.Language().toLowerCase();
    let reLocalize = local ? $.Localize(`#${local}`) : $.Localize(``);
    if (serverLocalize) {
        if (language == "schinese") {
            reLocalize = (_a = serverLocalize["1"]) !== null && _a !== void 0 ? _a : $.Localize(`#${local}`);
        }
        else {
            reLocalize = (_c = (_b = serverLocalize["2"]) !== null && _b !== void 0 ? _b : serverLocalize["1"]) !== null && _c !== void 0 ? _c : $.Localize(`#${local}`);
        }
    }
    else {
        return reLocalize;
...
/**
 * 获取本地化,可以传入服务器给定的本地化，或者本地化的本地化。与上面不同的是，serverLocalize是一个下标从0开始的数组
 * @param serverLocalize 服务器本地化
 * @param localLocalize  本地本地化
 * @returns
 */
function getlocalize2(serverLocalize, local) {
    var _a, _b, _c;
    const language = $.Language().toLowerCase();
    let reLocalize = local ? $.Localize(`#${local}`) : $.Localize(``);
    if (serverLocalize) {
        if (language == "schinese") {
            reLocalize = (_a = serverLocalize[0]) !== null && _a !== void 0 ? _a : $.Localize(`#${local}`);
        }
        else {
            reLocalize = (_c = (_b = serverLocalize[1]) !== null && _b !== void 0 ? _b : serverLocalize[0]) !== null && _c !== void 0 ? _c : $.Localize(`#${local}`);
        }
    }
    else {
        return reLocalize;
...
function getFormatLocalize(id, ...args) {
    if (args.length == 0) {
        return $.Localize(`#${id}`);
    }
    return (0,_string_utils__WEBPACK_IMPORTED_MODULE_0__.str4mat)($.Localize(`#${id}`), ...args);
}
function getFormatLocalizeEmpty(id, ...args) {
    var _a;
    return (_a = getValidLocalize(id, ...args)) !== null && _a !== void 0 ? _a : "";
}
function getRawLocalize(id) {
    return $.Localize(`#${id}`);
}
function getValidLocalize(token, ...args) {
    const newToken = `#${token}`;
    const str = $.Localize(newToken);
    if (str == newToken) {
        return null;
    }
    if (args.length > 0) {
        return (0,_string_utils__WEBPACK_IMPORTED_MODULE_0__.str4mat)(str, ...args);
    }
    return str;
}
...
/***/ "./loading_error/loadingErrorMap/LoadingErrorPanel.tsx"
/*!*************************************************************!*\
  !*** ./loading_error/loadingErrorMap/LoadingErrorPanel.tsx ***!
  \*************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LoadingErrorPanel: () => (/* binding */ LoadingErrorPanel)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "../../../node_modules/react/jsx-runtime.js");
/* harmony import */ var _commonLib_hooks_useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @commonLib/hooks/useStateIfMounted */ "./commonLib/hooks/useStateIfMounted.ts");
...
// 加载错误
function LoadingErrorPanel() {
    const [isLoadingError, setIsLoadingError] = (0,_commonLib_hooks_useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__["default"])(false);
    // 载入超时;
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_3__.useGameEvent)("s2c_loading_over_time", () => {
...
/***/ "./loading_error/loadingErrorMap/NoticePanel.tsx"
/*!*******************************************************!*\
  !*** ./loading_error/loadingErrorMap/NoticePanel.tsx ***!
  \*******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function (SettlementType) {
    SettlementType[SettlementType["PERSONAL_AI"] = 1] = "PERSONAL_AI";
    SettlementType[SettlementType["TEAM_PRACTICE"] = 2] = "TEAM_PRACTICE";
    SettlementType[SettlementType["NORMAL_MATCH"] = 3] = "NORMAL_MATCH";
    SettlementType[SettlementType["CHEAT_MODE"] = 4] = "CHEAT_MODE";
    SettlementType[SettlementType["SYSTEM_ERROR"] = 5] = "SYSTEM_ERROR";
})(SettlementType || (SettlementType = {}));
function NoticePanel() {
    const [settlementType, setSettlementType] = (0,_commonLib_hooks_useStateIfMounted__WEBPACK_IMPORTED_MODULE_1__["default"])(undefined);
    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_3__.useGameEvent)("s2c_settlement_type", data => {
        setSettlementType(data === null || data === void 0 ? void 0 : data.type);
    }, []);
    if (!settlementType || settlementType === SettlementType.NORMAL_MATCH) {
        return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {});
    }
...
/***/ "./loading_error/loadingErrorMap/PlayerLockPanel.tsx"
/*!***********************************************************!*\
  !*** ./loading_error/loadingErrorMap/PlayerLockPanel.tsx ***!
  \***********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PlayerLockPanel: () => (/* binding */ PlayerLockPanel)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "../../../node_modules/react/jsx-runtime.js");
/* harmony import */ var _commonLib_utils_localize_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @commonLib/utils/localize_utils */ "./commonLib/utils/localize_utils.ts");
...
function PlayerLockPanel() {
    ...
    const lockExpiration = playerInfo === null || playerInfo === void 0 ? void 0 : playerInfo.lockExpiration;
    const localize = $.Localize(`#loading_error_negative_0`);
