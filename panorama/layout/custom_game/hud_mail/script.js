...
(function (MailOperation) {
    MailOperation[MailOperation["read"] = 1] = "read";
    MailOperation[MailOperation["receive"] = 2] = "receive";
    MailOperation[MailOperation["del"] = 9] = "del";
...
const getTitle = (mailData) => {
    ...
    const mapData = {
        ["schinese"]: (_a = mailData.title) !== null && _a !== void 0 ? _a : "",
        ["english"]: (_b = mailData.title_en) !== null && _b !== void 0 ? _b : "",
        ["russian"]: (_c = mailData.title_ru) !== null && _c !== void 0 ? _c : "",
    };
    return (_d = mapData[language]) !== null && _d !== void 0 ? _d : mailData.title_en;
};
const getContent = (mailData) => {
    ...
    const mapData = {
        ["schinese"]: (_a = mailData.content) !== null && _a !== void 0 ? _a : "",
        ["english"]: (_b = mailData.content_en) !== null && _b !== void 0 ? _b : "",
        ["russian"]: (_c = mailData.content_ru) !== null && _c !== void 0 ? _c : "",
    };
    return (_d = mapData[language]) !== null && _d !== void 0 ? _d : mailData.content_en;
};
const getItems = (mailData) => {
    if (mailData == undefined || mailData.items == undefined) {
        return [];
    }
    let items = JSON.parse(mailData.items);
...
function Root() {
    const [windowState, toggleWindow] = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_4__.useToggleWindow)("Hud_Mail");
    const [mails, setMails] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({});
    const [refresh, setRefresh] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    function MaliOperate(type, step, mail_id) {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_4__.Send2ServerCallback)("MailOperate", {
            operate_type: type,
            step: step,
            mail_id: mail_id
        }, function (data) {
            if (data.code == 0) {
                if (data.data && data.data.player_mails) {
                    data.data.player_mails.forEach((mail) => {
                        if (mail.step != 9 && mail.expire_time > Date.now() / 1000) {
                            mails[mail.mail_id] = Object.assign(mails[mail.mail_id], mail);
                        }
                        else {
                            delete mails[mail.mail_id];
                        }
                    });
                    setRefresh(!refresh);
                }
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
        if (windowState) {
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_4__.Send2ServerCallback)("get_mails", {}, (data) => {
                if (data.code == 0) {
                    if (data.data && data.data.player_mails) {
                        const res = {};
                        data.data.player_mails.forEach((mail) => {
                            if (mail.step != 9 && mail.expire_time > Date.now() / 1000) {
                                res[mail.mail_id] = mail;
                            }
                        });
                        setMails(res);
                    }
    ...
    const [previewID, setPreviewID] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(-1);
    const previewMail = mails[previewID.toString()];
    return windowState ? react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "Hud_Mail", hittest: false },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Popup_EOM_Popup__WEBPACK_IMPORTED_MODULE_3__.EOM_PopupBG, { hasTitle: true }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Button, { id: "Close", onactivate: () => {
                toggleWindow(false);
            } }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Title", text: $.Localize("#Hud_Mail") }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "MailList" }, Object.values(mails).map((mail) => {
            var _a;
            const bOpen = ((_a = mail.step) !== null && _a !== void 0 ? _a : 0) >= 1;
            return react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { key: mail.mail_id, className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("MailRow", { Open: bOpen, selected: previewID == mail.mail_id }), onactivate: () => {
                    setPreviewID(mail.mail_id);
                    if (mail.step == 0) {
                        MaliOperate(1, MailOperation.read, mail.mail_id);
                    }
                } },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "Icon" }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RowTitle", text: getTitle(mail) }),
                mail.step == 2 && react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "Recevied" }));
        })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "MailDetail" }, previewID != -1 && react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "MailTitle", html: true, text: getTitle(previewMail) }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "MailContent" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "MailContentText", html: true, text: getContent(previewMail) })),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "ItemList" }, Object.values(getItems(previewMail)).map((item) => {
                return react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { key: item.item_id, className: "reward" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "RewardItemImage", scaling: "stretch", src: "file://{resources}/images/custom_game/items/item_" + item.item_id + ".png" }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "RewardItemBG", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("Rarity" + item.rarity) }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardItemName", localizedText: "#Item_" + item.item_id }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "RewardItemNum", text: "x" + item.amounts }));
            })))),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "LeftBtns" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextButton, { text: "#receive_all", enabled: Object.keys(mails).length > 0, onactivate: () => {
                    MaliOperate(2, MailOperation.receive);
                } }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextButton, { text: "#del_received", enabled: Object.keys(mails).length > 0, onactivate: () => {
                    MaliOperate(2, MailOperation.del);
                } })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Panel, { id: "RightBtns" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextButton, { text: "#receive_reward", enabled: previewMail != undefined && previewMail.items != undefined && (previewMail === null || previewMail === void 0 ? void 0 : previewMail.step) == 1, onactivate: () => {
                    if ((previewMail === null || previewMail === void 0 ? void 0 : previewMail.step) == 1) {
                        MaliOperate(1, MailOperation.receive, previewMail === null || previewMail === void 0 ? void 0 : previewMail.mail_id);
                    }
                } }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(TextButton, { text: "#del", enabled: previewMail != undefined && (previewMail === null || previewMail === void 0 ? void 0 : previewMail.step) == 2, onactivate: () => {
                    if ((previewMail === null || previewMail === void 0 ? void 0 : previewMail.step) == 2) {
                        MaliOperate(1, MailOperation.del, previewMail === null || previewMail === void 0 ? void 0 : previewMail.mail_id);
                    }
                } }))) : react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null);
}
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(Root, null), $.GetContextPanel());
