...
function CreatePhraseGroupInContent(parent, group_header_name, group_header_icon = "", skip_sort = false) {
	...
	if (!skip_sort) DefaultChildrenSort(parent, "group_header_name", true);
...
function UpdateFavorites() {
	let favorites = GameUI.Player.GetSettingValue("chatWheelFavourites");
