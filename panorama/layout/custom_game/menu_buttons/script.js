...
/***/ "./EOMDesign/Navigation/EOM_MenuButton/EOM_MenuButton.tsx"
/*!****************************************************************!*\
  !*** ./EOMDesign/Navigation/EOM_MenuButton/EOM_MenuButton.tsx ***!
  \****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EOM_MenuButton: () => (/* binding */ EOM_MenuButton),
/* harmony export */   EOM_MenuButtons: () => (/* binding */ EOM_MenuButtons)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "../../../../../node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../utils/utils */ "./utils/utils.ts");
/* harmony import */ var _DataDisplay_EOM_Image_EOM_Image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../DataDisplay/EOM_Image/EOM_Image */ "./EOMDesign/DataDisplay/EOM_Image/EOM_Image.tsx");




class EOM_MenuButtons extends react__WEBPACK_IMPORTED_MODULE_1__.PureComponent {
    constructor() {
        super(...arguments);
        this.state = { select_name: "", subscribeEnable: true };
    }
    componentDidMount() {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "LeftTopMain", className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("InitHide", { InitAnimation: !this.props.collapse }), hittest: false },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "EOM_MenuButtons" }, this.props.list.map((sName, sLoc) => {
                return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { id: "EOM_MenuButtons_" + sName, key: sName, className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_MenuButton", { IsActive: this.state.select_name == sName }), onactivate: self => {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_DataDisplay_EOM_Image_EOM_Image__WEBPACK_IMPORTED_MODULE_3__["default"], { id: `${sName}Icon`, className: "LeftTopButtonIcon", backgroundImage: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.getImagePath)("icon/" + sName + ".png") }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: "#MenuButton_" + sName })));
            }))));
    }
}
EOM_MenuButtons.defaultProps = {
    onToggle: (menuName, state) => {
        GameEvents.SendEventClientSide("custom_ui_toggle_windows", { window_name: "MenuButton_" + menuName, show_state: state });
    },
    collapse: false
};
class EOM_MenuButton extends react__WEBPACK_IMPORTED_MODULE_1__.PureComponent {
    constructor() {
        super(...arguments);
        this.state = { hasMark: false, selected: false };
        this.OnActive = () => {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(TabButton, Object.assign({ group: "TopLeft", className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(this.props.className, "EOM_MenuButton") }, this.props, { onactivate: self => {
                this.setState({ selected: !this.state.selected });
                self.IsSelected = () => {
                    return !this.state.selected;
                };
                if (this.props.onactivate) {
                    this.props.onactivate(self);
                }
                else {
                    this.OnActive();
                }
            ...
            label &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "EOM_MenuLabel", text: typeof label == "string" ? label : "" }),
            this.state.hasMark &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Image, { className: "EOM_MenuExclamationMark" }),
            icon));
    }
}
...
function isActivityActive(activity, now = Math.floor(Date.now() / 1000)) {
    var _a, _b, _c;
    const state = Number((_a = activity === null || activity === void 0 ? void 0 : activity.state) !== null && _a !== void 0 ? _a : 0);
    if (state === 2 || state === 3) {
        return true;
    }
    const startTime = Number((_b = activity === null || activity === void 0 ? void 0 : activity.start_time) !== null && _b !== void 0 ? _b : 0);
    const endTime = Number((_c = activity === null || activity === void 0 ? void 0 : activity.end_time) !== null && _c !== void 0 ? _c : 0);
    return startTime >= 0 && endTime > now && startTime <= now;
}
function MenuButtons() {
    ...
    const dragonBoatIcon = language === "schinese"
        ? "file://{images}/custom_game/activity/dragonboat/football/conv_icon_01.png"
        : language === "russian"
