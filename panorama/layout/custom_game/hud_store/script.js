...
/***/ "./EOMDesign/Navigation/EOM_Breadcrumb/EOM_Breadcrumb.tsx"
/*!****************************************************************!*\
  !*** ./EOMDesign/Navigation/EOM_Breadcrumb/EOM_Breadcrumb.tsx ***!
  \****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EOM_Breadcrumb)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
...
class EOM_Breadcrumb extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor() {
        super(...arguments);
        this.defaultClass = () => {
            return "EOM_Breadcrumb";
        };
        this.state = { selectedIndex: (this.props.defaultSelected != undefined) ? Math.min(this.props.list.length - 1, Math.max(0, this.props.defaultSelected - 1)) : undefined };
        this.onSelect = (index) => {
        ...
        this.onHover = (index) => {
            if (this.props.activateType == "onhover") {
                this.onSelect(index);
            }
        };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp()), this.props.list.map((name, index) => {
            var _a, _b;
            if (index > 0) {
                return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, { key: index },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "EOM_BreadcrumbSeparator", text: "/" }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(TabButton, { key: index + ((_a = this.props.group) !== null && _a !== void 0 ? _a : ""), selected: this.props.selected != undefined ? this.props.selected - 1 == index : this.state.selectedIndex == index, group: this.props.group, onactivate: () => this.onSelect(index), localizedText: name, onmouseover: () => this.onHover(index) })));
            }
            else {
                return react__WEBPACK_IMPORTED_MODULE_0__.createElement(TabButton, { key: index + ((_b = this.props.group) !== null && _b !== void 0 ? _b : ""), selected: this.props.selected != undefined ? this.props.selected - 1 == index : this.state.selectedIndex == index, group: this.props.group, onactivate: () => this.onSelect(index), localizedText: name, onmouseover: () => this.onHover(index) });
            }
        })));
    }
}
EOM_Breadcrumb.defaultProps = {
    list: [],
...
function DoUniqueString(str) {
    ...
    let result = "_" + Math.random().toString().substr(3, 3) + GameUI.CustomUIConfig()._Record_UniqueString + "_" + str;
...
/***/ "./hud_store/StoreItem/StoreItem.tsx"
/*!*******************************************!*\
  !*** ./hud_store/StoreItem/StoreItem.tsx ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _StoreItemImage_StoreItemImage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../StoreItemImage/StoreItemImage */ "./hud_store/StoreItemImage/StoreItemImage.tsx");
...
class StoreItem extends _EOMDesign_EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_4__.EOM_PureComponent {
    render() {
        var _a;
        const { itemName, enabled, tagName, rarity, labels, itemImage, button, onBuyItem } = this.props;
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_5__.EOM_BaseButton, { enabled: enabled, className: "StoreItem", onactivate: self => {
                if (onBuyItem) {
                    onBuyItem();
                }
            } },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_StoreItemImage_StoreItemImage__WEBPACK_IMPORTED_MODULE_6__.StoreItemImage, { itemName: itemName, rarity: rarity, itemImage: itemImage }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { className: "StoreItemLabels", verticalAlign: "bottom", marginBottom: "74px", flowChildren: "up" }, labels === null || labels === void 0 ? void 0 : labels.map((labelInfo, index) => {
                return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { key: index, flowChildren: "down" },
                    labelInfo.countdown &&
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Countdown, { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("CountDown", { Show: false }), endTime: labelInfo.countdown, hittest: false },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: "{t:d:t:countdown_time}" })),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_DataDisplay_EOM_Image_EOM_Image__WEBPACK_IMPORTED_MODULE_3__["default"], { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("StoreItemLabel", labelInfo.type) },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { text: labelInfo.label }))));
            })),
            tagName != undefined &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("StoreItemTag", tagName) },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { text: $.Localize("#StoreTag_" + tagName) })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_EOMDesign_Inputs_EOM_Button_EOM_Button__WEBPACK_IMPORTED_MODULE_5__["default"], { type: "P2", color: button === null || button === void 0 ? void 0 : button.color, text: (_a = button === null || button === void 0 ? void 0 : button.text) !== null && _a !== void 0 ? _a : "", icon: button === null || button === void 0 ? void 0 : button.icon, marginTop: "277px", horizontalAlign: "center" })));
    }
}
...
class Store extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
    ...
    getStoreItemData(product_list) {
        let list = {};
        for (const key in product_list) {
            const storeItem = product_list[key];
            if (storeItem.tag != "Item") {
                if (list[storeItem.tag] == undefined) {
                    list[storeItem.tag] = [];
                }
                list[storeItem.tag].push(storeItem);
            }
        }
    ...
    componentDidMount() {
        ...
        this.netTableIDList.push(CustomNetTables.SubscribeNetTableListener("service", (tableName, key, value) => {
            ...
            if (key == "player_wallet") {
                this.setState({
                    player_wallet: {
                        moonstone: (_b = (_a = value === null || value === void 0 ? void 0 : value[Players.GetLocalPlayer()]) === null || _a === void 0 ? void 0 : _a.moonstone) !== null && _b !== void 0 ? _b : 0,
                        starlight: (_d = (_c = value === null || value === void 0 ? void 0 : value[Players.GetLocalPlayer()]) === null || _c === void 0 ? void 0 : _c.starlight) !== null && _d !== void 0 ? _d : 0,
                    }
                });
            }
            if (key == "product_list") {
                this.setState({
                    storeItemData: this.getStoreItemData(value)
                });
            }
        }));
    }
    componentWillUnmount() {
        for (const id of this.gameEventIDList) {
    ...
    getStoreItemProps(itemData) {
        return {
            itemName: "#Goods_" + itemData.id,
            itemImage: "file://{images}/custom_game/store_items/" + itemData.id + ".png",
            button: this.getButtonData(itemData),
    ...
    getTagName(itemData) {
        const isFree = itemData.real_price == 0;
    ...
    getButtonData(itemData) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        if (((_a = itemData.real_price) !== null && _a !== void 0 ? _a : 0) == 0) {
            return { color: "Green", text: "免费" };
        }
        const sLanguage = $.Language().toLowerCase();
        if (itemData.pay_type == undefined || itemData.pay_type == PayType.MONEY) {
            let dollarMark = "$";
            let price = (_c = (_b = itemData.overseas_real_price) !== null && _b !== void 0 ? _b : itemData.real_price) !== null && _c !== void 0 ? _c : 0;
            if (sLanguage == "schinese") {
                dollarMark = "￥";
                price = (_d = itemData.real_price) !== null && _d !== void 0 ? _d : 0;
            }
            else if (sLanguage == "russian") {
                dollarMark = "₽";
                price = (_e = itemData.russia_real_price) !== null && _e !== void 0 ? _e : 0;
            }
            else if (sLanguage == "english") {
                dollarMark = "$";
                price = (_f = itemData.overseas_real_price) !== null && _f !== void 0 ? _f : 0;
            }
