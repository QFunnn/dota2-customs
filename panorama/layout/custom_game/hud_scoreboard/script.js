...
/***/ "./EOMDesign/Container/EOM_Tooltip/EOM_Tooltip.tsx"
/*!*********************************************************!*\
  !*** ./EOMDesign/Container/EOM_Tooltip/EOM_Tooltip.tsx ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EOM_TooltipBG: () => (/* binding */ EOM_TooltipBG),
/* harmony export */   EOM_TooltipDivder: () => (/* binding */ EOM_TooltipDivder),
/* harmony export */   EOM_TooltipHeader: () => (/* binding */ EOM_TooltipHeader),
/* harmony export */   "default": () => (/* binding */ EOM_Tooltip)
/* harmony export */ });
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! classnames */ "../../../../../node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
...
class EOM_Tooltip extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor() {
        super(...arguments);
        this.defaultClass = () => { return classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_Tooltip"); };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp(), { onactivate: () => { }, onload: (self) => { self.AddClass("EOM_PopupMainShow"); } }), this.props.children));
    }
}
class EOM_TooltipBG extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__.EOM_PureComponent {
    constructor() {
        super(...arguments);
        this.defaultClass = () => { return classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_TooltipBG"); };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp())));
    }
}
class EOM_TooltipHeader extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__.EOM_PureComponent {
    constructor() {
        super(...arguments);
        this.defaultClass = () => { return classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_TooltipHeader"); };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp()), this.props.children));
    }
}
class EOM_TooltipDivder extends _EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__.EOM_PureComponent {
    constructor() {
        super(...arguments);
        this.defaultClass = () => { return classnames__WEBPACK_IMPORTED_MODULE_0___default()("EOM_TooltipDivder", this.props.type); };
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({}, this.props, this.getBaseProp())));
    }
...
/* harmony import */ var _EOMDesign_Container_EOM_Tooltip_EOM_Tooltip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../EOMDesign/Container/EOM_Tooltip/EOM_Tooltip */ "./EOMDesign/Container/EOM_Tooltip/EOM_Tooltip.tsx");
...
const TeamIcons = GameUI.CustomUIConfig().team_icons;
const DOTA_ITEM_SLOT_MIN = 0;
const DOTA_ITEM_SLOT_MAX = 5;
const DOTA_ITEM_NEUTRAL_SLOT = 16;
function Scoreboard() {
    const [windowState, toggleWindow] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    const [TeamPlayers, SetTeamPlayers] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(GetTeamPlayers());
    const [Mute, SetMute] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(InitMuteState());
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.useGameEvent)("custom_ui_toggle_flyout_scoreboard", data => {
        if (data.visible == undefined) {
            toggleWindow((windowState) => {
                return !windowState;
            });
        }
        else {
            toggleWindow(data.visible == 1);
        }
    }, []);
    ...
    function GetTeamPlayers() {
        ...
        for (const TeamID of AllTeamIDs) {
            const Team = Game.GetTeamDetails(TeamID);
            const TeamPlayers = Game.GetPlayerIDsOnTeam(TeamID);
            for (const Playerid of TeamPlayers) {
                let thisTeam = TeamPlayerArray.find((value) => { return value.TeamID == TeamID; });
                if (thisTeam != undefined) {
                    thisTeam.TeamPlayers.push(Playerid);
                }
                else {
                    TeamPlayerArray.push({ TeamID: TeamID, TeamPlayers: [Playerid] });
                }
            }
        }
    ...
    function InitMuteState() {
        ...
        for (let index = 0; index < Players.GetMaxPlayers(); index++) {
            if (Players.IsValidPlayerID(index)) {
                mute_array.push({ Playerid: index, Mute: false });
            }
        }
        return mute_array;
    }
    ...
    for (let index = 0; index < Mute.length; index++) {
        if (!Mute[index].Mute && Mute[index].Playerid != Players.GetLocalPlayer()) {
            AllMuted = false;
        }
    }
    TeamPlayers.sort((TeamA, TeamB) => {
        var _a, _b, _c, _d;
        let totalA = 0;
        let totalB = 0;
        for (let index = 0; index < TeamA.TeamPlayers.length; index++) {
            const Playerid = TeamA.TeamPlayers[index];
            totalA = totalA + ((_b = (_a = CustomNetTables.GetTableValue("player_info", Playerid)) === null || _a === void 0 ? void 0 : _a.gold) !== null && _b !== void 0 ? _b : 0);
        }
        for (let index = 0; index < TeamB.TeamPlayers.length; index++) {
            const Playerid = TeamB.TeamPlayers[index];
            totalB = totalB + ((_d = (_c = CustomNetTables.GetTableValue("player_info", Playerid)) === null || _c === void 0 ? void 0 : _c.gold) !== null && _d !== void 0 ? _d : 0);
        }
    ...
    return (!windowState ?
        ...
        :
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Tooltip_EOM_Tooltip__WEBPACK_IMPORTED_MODULE_4__["default"], { id: "Hud_Scoreboard_main", flowChildren: "down", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Show: windowState }) },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Hud_Scoreboard_title" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_hero", text: $.Localize("#Hud_Scoreboard_title_player") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_gold", text: $.Localize("#Hud_Scoreboard_title_gold") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_win", text: $.Localize("#Hud_Scoreboard_title_win") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_lose", text: $.Localize("#Hud_Scoreboard_title_lose") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_ability", text: $.Localize("#Hud_Scoreboard_title_abilities") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_talent", text: $.Localize("#Hud_Scoreboard_title_talent") }),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "Hud_Scoreboard_title_item", text: $.Localize("#Hud_Scoreboard_title_items") })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Hud_Scoreboard_list" }, TeamPlayers.map((TeamPlayerInfo, index) => {
                    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(ScoreTeam, { key: index, TeamID: TeamPlayerInfo.TeamID, TeamPlayers: TeamPlayerInfo.TeamPlayers, Mute: Mute, SetMute: SetMute }));
                })),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Hud_Scoreboard_bottombar" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "Hud_Scoreboard_Mute" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Button, { id: "AllMute_Button", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Muted: AllMuted }), onactivate: (p) => {
                                let new_mute = Mute.slice();
                                let new_mute_state = !AllMuted;
                                for (let index = 0; index < new_mute.length; index++) {
                                    if (new_mute[index].Mute != new_mute_state && new_mute[index].Playerid != Players.GetLocalPlayer()) {
                                        new_mute[index].Mute = new_mute_state;
                                        Game.SetPlayerMuted(new_mute[index].Playerid, new_mute_state);
                                        GameEvents.SendCustomGameEventToServer("set_mute_player", { disable: new_mute_state, toPlayerId: new_mute[index].Playerid });
                                    }
                                }
                                SetMute(new_mute);
                            }, onmouseover: (p) => [
                                $.DispatchEvent("DOTAShowTextTooltip", p, AllMuted ? $.Localize("#Hud_Scoreboard_AllMute_disable") : $.Localize("#Hud_Scoreboard_AllMute_enable"))
                            ], onmouseout: (p) => {
                                $.DispatchEvent("DOTAHideTextTooltip", p);
                            } }),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "AllMute_text", text: AllMuted ? $.Localize("#Hud_Scoreboard_AllMute_tip_active") : $.Localize("#Hud_Scoreboard_AllMute_tip_unactive") })))));
}
function ScoreTeam({ TeamID, TeamPlayers, Mute, SetMute }) {
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "ScoreTeam" },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "TeamIcon" }),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "TeamContent" }, TeamPlayers.map((Playerid, index) => {
            return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(PlayerInfo, { key: index, Playerid: Playerid, Mute: Mute, SetMute: SetMute }));
        }))));
}
function PlayerInfo({ Playerid, Mute, SetMute }) {
    var _a, _b, _c, _d;
    let hero = Players.GetPlayerHeroEntityIndex(Playerid);
    let abilities = [];
    let items = [];
    let item_neutral = Entities.GetItemInSlot(hero, DOTA_ITEM_NEUTRAL_SLOT);
    let gold = 0;
    let pvpRecord = CustomNetTables.GetTableValue("pvp_record", Playerid);
    let winCount = 0;
    let loseCount = 0;
    let LocalMute = ((_a = Mute.find((muteInfo) => {
        return muteInfo.Playerid == Playerid;
    })) === null || _a === void 0 ? void 0 : _a.Mute) || false;
    let hasScepter = Entities.HasScepter(hero);
    let hasShard = Entities.HasBuff(hero, "modifier_item_aghanims_shard");
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.useHeartBeat)(1);
    for (let index = 0; index < Entities.GetAbilityCount(hero); index++) {
        ...
        if (Abilities.GetAbilityType(ability) == 2)
            continue;
        if (ability != -1 && (0,_utils_utils__WEBPACK_IMPORTED_MODULE_5__.IsValidAbility)(ability)) {
            abilities.push(ability);
        }
    }
    let ability_count = abilities.length;
    if (abilities.length < 6) {
        for (let i = 0; i < 6 - ability_count; i++) {
            abilities.push(-1);
        }
    }
    ...
    if (CustomNetTables.GetTableValue("player_info", Playerid) != undefined) {
        gold = (_b = CustomNetTables.GetTableValue("player_info", Playerid).gold) !== null && _b !== void 0 ? _b : 0;
    }
    if (pvpRecord != undefined) {
        winCount = (_c = pvpRecord.win) !== null && _c !== void 0 ? _c : 0;
        loseCount = (_d = pvpRecord.lose) !== null && _d !== void 0 ? _d : 0;
    }
    return (react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_main", flowChildren: "right" },
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_hero", flowChildren: "right" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(DOTAHeroImage, { id: "PlayerInfo_hero_icon_img", heroname: Entities.GetUnitName(hero), heroimagestyle: "landscape" }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_hero_textInfo" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "PlayerInfo_Playername", text: Players.GetPlayerName(Playerid) }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_hero_lvlname" },
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_hero_lvl" },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "PlayerInfo_hero_lvl_title", text: $.Localize("#hero_level") }),
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "PlayerInfo_hero_lvl_num", text: Entities.GetLevel(hero) })),
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "PlayerInfo_hero_name", text: $.Localize(`#${Entities.GetUnitName(hero)}`) }))),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Button, { id: "PlayerInfo_mute", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Muted: LocalMute, Show: Playerid != Players.GetLocalPlayer() }), onactivate: (p) => {
                    let new_mute = Mute.slice();
                    let LocalMuteIndex = new_mute.findIndex((muteInfo) => {
                        return muteInfo.Playerid == Playerid;
                    });
                    if (LocalMuteIndex != -1) {
                        new_mute[LocalMuteIndex].Mute = !new_mute[LocalMuteIndex].Mute;
                        Game.SetPlayerMuted(Playerid, !new_mute[LocalMuteIndex].Mute);
                        GameEvents.SendCustomGameEventToServer("set_mute_player", { disable: !new_mute[LocalMuteIndex].Mute, toPlayerId: Playerid });
                    }
                    else {
                        new_mute.push({ Playerid: Playerid, Mute: false });
                        Game.SetPlayerMuted(Playerid, false);
                        GameEvents.SendCustomGameEventToServer("set_mute_player", { disable: false, toPlayerId: Playerid });
                    }
                    SetMute(new_mute);
                }, onmouseover: (p) => [
                    $.DispatchEvent("DOTAShowTextTooltip", p, LocalMute ? $.Localize("#PlayerInfo_Mute_disable") : $.Localize("#PlayerInfo_Mute_enable"))
                ], onmouseout: (p) => {
                    $.DispatchEvent("DOTAHideTextTooltip", p);
                } })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_gold" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Image, { id: "PlayerInfo_gold_icon", src: "s2r://panorama/images/hud/reborn/gold_small_psd.vtex" }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { text: gold, className: "CommonGoldNum" })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_pvp_record" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "pvp_record_win", text: winCount }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(Label, { id: "pvp_record_lose", text: loseCount })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_abilities", flowChildren: "right" }, abilities.map((ability, index) => {
            return react__WEBPACK_IMPORTED_MODULE_2__.createElement(DOTAAbilityImage, { key: index, className: "playerinfo_ability", abilityname: Abilities.GetAbilityName(ability), showtooltip: true });
        })),
        react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_items" },
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_items_bonus" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_items_scepter", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Active: hasScepter }) }),
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_items_shard", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ Active: hasShard }) })),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "PlayerInfo_items_main" }, items.map((item, index) => {
                return react__WEBPACK_IMPORTED_MODULE_2__.createElement(DOTAItemImage, { key: index, className: "playerinfo_item" + index, itemname: Abilities.GetAbilityName(item), showtooltip: true, scaling: "stretch-to-fit-y-preserve-aspect" });
            })),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "playerinfo_item_neutral_slot" },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement(DOTAItemImage, { className: "playerinfo_item_neutral", itemname: Abilities.GetAbilityName(item_neutral), showtooltip: true, scaling: "stretch-to-fit-y-preserve-aspect" })))));
}
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_2__.createElement(Scoreboard, null), $.GetContextPanel());
function HideToggleScoreBoard() {
    var _a, _b, _c;
    let pHud = $.GetContextPanel();
    while (pHud && pHud.id != "Hud") {
        pHud = pHud.GetParent();
    }
    let btn = (_c = (_b = (_a = pHud.FindChildTraverse("HUDElements")) === null || _a === void 0 ? void 0 : _a.FindChildTraverse("MenuButtons")) === null || _b === void 0 ? void 0 : _b.FindChildTraverse("ButtonBar")) === null || _c === void 0 ? void 0 : _c.FindChildTraverse("ToggleScoreboardButton");
    if (btn === null || btn === void 0 ? void 0 : btn.visible) {
        btn.visible = false;
    }
}
...
(function () {
    ...
    let pToggleScoreboardButton = pHud === null || pHud === void 0 ? void 0 : pHud.FindChildTraverse("ToggleScoreboardButton");
    if (pToggleScoreboardButton) {
        pToggleScoreboardButton.style.visibility = "collapse";
    }
    $.RegisterEventHandler("DOTACustomUI_SetFlyoutScoreboardVisible", $.GetContextPanel(), SetFlyoutScoreboardVisible);
    HideToggleScoreBoard();
})();
