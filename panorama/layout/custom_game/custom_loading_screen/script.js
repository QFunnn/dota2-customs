...
"use strict";
/*!******************************************!*\
  !*** ./custom_loading_screen/script.tsx ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
function adjustChatPanel() {
    ...
    while (pHud != null && pHud.id != "DotaLoadingScreen") {
        let p = pHud.GetParent();
        if (p != null) {
            pHud = p;
        }
    }
    let LoadingScreenChat = pHud.FindChildTraverse("LoadingScreenChat");
    if (LoadingScreenChat != null) {
    }
    let ChatLinesContainer = pHud.FindChildTraverse("ChatLinesContainer");
    if (ChatLinesContainer != null) {
        ChatLinesContainer.style.height = "210px";
    }
}
function loadthis() {
    adjustChatPanel();
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_0__.render)(react__WEBPACK_IMPORTED_MODULE_1__.createElement(CustomLoadingScreen, null), $.GetContextPanel());
}
loadthis();
