...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SetupTooltips: () => (/* binding */ SetupTooltips)
/* harmony export */ });
/* unused harmony export GetTooltipDisplayProp */
...
"use strict";
/*!**********************************************************************!*\
  !*** ./view/tooltips/page/common_module_tips/common_module_tips.tsx ***!
  \**********************************************************************/
/* harmony import */ var _commonLib_ext_dollor_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @commonLib/ext/dollor_extension */ "./commonLib/ext/dollor_extension.ts");
/* harmony import */ var _commonLib_modules_tooltip_tooltip_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @commonLib/modules/tooltip/tooltip_utils */ "./commonLib/modules/tooltip/tooltip_utils.ts");
...
function _render(data) {
    ...
    if (data == null)
        return null;
    const _type = GameUI.CustomUIConfig().GetCurTooltipType();
    if (!_type)
        return null;
    // match_detail_tips 专用：数据未就绪时轮询等待
    if (_type === "match_detail_tips") {
        const mgr = (_a = Game.DataHub) === null || _a === void 0 ? void 0 : _a.PlayerInfoMgr;
        if (!(mgr === null || mgr === void 0 ? void 0 : mgr.getMatchDetail(data.matchId))) {
            const originalMatchId = data.matchId;
            let tries = 0;
            const poll = () => {
                tries++;
                // 检查当前 tooltip 是否还是同一场比赛
                const curData = GameUI.CustomUIConfig().GetCurTooltipData();
                if ((curData === null || curData === void 0 ? void 0 : curData.matchId) !== originalMatchId)
                    return;
                if (mgr === null || mgr === void 0 ? void 0 : mgr.getMatchDetail(originalMatchId)) {
                    (0,react_panorama_x__WEBPACK_IMPORTED_MODULE_2__.render)(_render(data), $.GetContextPanel());
                }
                else if (tries < 15) {
                    $.Schedule(1.0, poll);
                }
    ...
    return (_b = GameUI.CustomUIConfig()) === null || _b === void 0 ? void 0 : _b.GetTooltipsModule(null, data);
}
(0,_commonLib_modules_tooltip_tooltip_utils__WEBPACK_IMPORTED_MODULE_1__.SetupTooltips)($.GetContextPanel(), _render); // noShadow = true
