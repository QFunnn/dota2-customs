...
/***/ "./hud_handbook/ItemList/ItemList.tsx"
/*!********************************************!*\
  !*** ./hud_handbook/ItemList/ItemList.tsx ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class ItemList extends _EOMDesign_EOM_BaseComponent__WEBPACK_IMPORTED_MODULE_2__.EOM_PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            tabIndex: 0
    ...
    render() {
        const { name, item_type, List } = this.props;
        let titleName = name;
        if (item_type == "skin") {
            titleName = $.Localize(`#${name}`);
        }
        if (item_type == "material_effect") {
            titleName = $.Localize(`#DOTA_Tooltip_ability_${name}`);
        }
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_1__["default"], { id: "Item" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_1__["default"], { id: "Card" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { id: "Name", text: titleName }),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(DOTAHeroImage, { id: "HeroImage", visible: item_type == "skin", heroname: name, heroimagestyle: "portrait" }),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(DOTAItemImage, { id: "ItemImage", visible: item_type == "material_effect", itemname: name })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_1__["default"], { id: "ItemContainer" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_1__["default"], { id: "Main", onmouseover: (p) => {
                        p.SetFocus();
                    }, onmouseout: (p) => {
                    } }, List.map((item_info, i) => {
                    let LabelText = item_info.is_equip == 1 ? "DOTA_Armory_Filter_Equipped" : (item_info.is_have == 1 ? "DOTA_OwnedItemSet_Selector_Title" : "DOTA_Diretide2020_Cosmetics_Not_Owned");
                    let ButtonText = item_info.is_equip == 1 ? "DOTA_Armory_ContextMenu_Unequip" : "DOTA_Armory_ContextMenu_Equip";
                    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EOMDesign_Container_EOM_Panel_EOM_Panel__WEBPACK_IMPORTED_MODULE_1__["default"], { key: i, id: "HeroItemInfo" },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Image, { id: "itemImage", src: `file://{images}/custom_game/items/item_${item_info.id}.png`, scaling: "stretch-to-cover-preserve-aspect", onmouseover: (self) => {
                                var _a, _b;
                                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.ShowCustomTooltip)(self, "tooltip_econ", { iEconID: (_a = item_info.id) !== null && _a !== void 0 ? _a : 1000001, rarity: (_b = item_info.rarity) !== null && _b !== void 0 ? _b : 1, item_type: item_type });
                            }, onmouseout: (self) => {
                                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.HideCustomTooltip)(self, "tooltip_econ");
                            } }),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { id: "itemName", text: $.Localize(`#item_${item_info.id}`) }),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { id: "itemEquip", text: $.Localize(`#${LabelText}`) }),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Button, { id: "equipButton", visible: item_info.is_have == 1, onactivate: () => {
                                if (item_info.is_equip == 1) {
                            ...
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: $.Localize(`#${ButtonText}`) })));
                })))));
    }
}
...
/***/ "./hud_handbook/ProfilePanel/ProfilePanel.tsx"
/*!****************************************************!*\
  !*** ./hud_handbook/ProfilePanel/ProfilePanel.tsx ***!
  \****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class ProfilePanel extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    getNetTableValue(key) {
        ...
        return (_c = val) !== null && _c !== void 0 ? _c : 0;
    }
    render() {
        var _a, _b, _c, _d, _e, _f;
        const { visible } = this.props;
        const { isEditingSkin, selectedSkinId } = this.state;
        const localPlayer = Players.GetLocalPlayer();
        const playerInfo = Game.GetPlayerInfo(localPlayer);
        const steamID = (_a = playerInfo === null || playerInfo === void 0 ? void 0 : playerInfo.player_steamid) !== null && _a !== void 0 ? _a : "";
        const playerName = (_b = playerInfo === null || playerInfo === void 0 ? void 0 : playerInfo.player_name) !== null && _b !== void 0 ? _b : "";
        const career_total_first_place = this.getNetTableValue("career_total_first_place");
        const career_total_login_days = this.getNetTableValue("career_total_login_days");
        const career_total_matches = this.getNetTableValue("career_total_matches");
        const season_total_matches = this.getNetTableValue("season_total_matches");
        ...
        for (const key in econAvatarData) {
            ...
            if (item && Number(item.equip) === 1) {
                localAvatarFrameId = Number(item.item_id);
                break;
            }
        }
        ...
        const winRate = season_total_matches > 0
            ? Math.round((season_total_top_four / season_total_matches) * 100)
            : 0;
        const icon_data_list = [
            { name: "skin_count", value: this.props.skin_count },
            { name: "career_total_first_place", value: career_total_first_place },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "ProfileHeroArea" },
                ...
                isEditingSkin ? (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "ProfileEditActionContainer" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "ProfileSaveBtn", onactivate: () => {
                            ...
                            this.setState({ isEditingSkin: false, selectedSkinId: this.state.selectedSkinId });
                            if (this.state.selectedSkinId != show_skin_id) {
...
class HandbookNew extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
    ...
    getTreasureList(treasures) {
        ...
        for (const treasureIndex in treasures) {
            const data = treasures[treasureIndex];
            list.push(data);
        }
        return list;
    }
    getList(group) {
        ...
        for (const index in group) {
            ...
            const belong = data.tag;
            if (list[belong] == undefined) {
                list[belong] = [];
            }
            list[belong].push(data);
        }
        return list;
    }
    getSkinCount(skin_list) {
        let total_skin_count = 0;
        let has_skin_count = 0;
        for (const hero_name in skin_list) {
            for (const skin_name in skin_list[hero_name]) {
                total_skin_count++;
                if (skin_list[hero_name][skin_name].is_have == 1) {
                    has_skin_count++;
                }
            }
        }
        ...
        this.netTableIDList.push(CustomNetTables.SubscribeNetTableListener("service", (tableName, key, value) => {
            ...
            if (key == "skin_list") {
                ...
                this.setState({
                    ...
                    skin_count: this.getSkinCount(skin_list)
                });
            }
        }));
    }
