...
function ReadConfigs() {
  ...
  const parsed = JSON.parseSafe(rawValue);
  if (!Array.isArray(parsed)) return [];
  return parsed.filter(config => {
...
const LoadoutPicker = () => {
  ...
  libs.createEffect(() => {
    ...
    if (Array.isArray(savedConfigs)) {
      setConfigs(savedConfigs.filter(config => {
        return typeof config?.id === "string" && typeof config.name === "string";
      }));
    }
  });
        ...
        children: config => (() => {
          const _el$7 = libs.createElement("Panel", {
            ...
            _el$11 = libs.createElement("Label", {
              ...
              get text() {
                return `属性 ${Object.keys(config().attributes ?? {}).length} · 祝福 ${config().blessings?.length ?? 0} · 遗物 ${config().artifacts?.length ?? 0}`;
              }
            }, _el$10);
          ...
          libs.insert(_el$8, libs.createComponent(EOM_Button.EOM_BaseButton, {
            "class": "DemoButton GreenButton",
            onactivate: () => saveConfig(config().id),
            get children() {
              return libs.createElement("Label", {
                text: "保存当前"
              }, null);
          ...
          libs.insert(_el$8, libs.createComponent(EOM_Button.EOM_BaseButton, {
            ...
            onactivate: () => deleteConfig(config().id),
            get children() {
              return libs.createElement("Label", {
                text: "删除"
              }, null);
          ...
          libs.insert(_el$10, libs.createComponent(EOM_ToggleButton.EOM_ToggleButton, {
            get selected() {
          ...
          libs.effect(_$p => libs.setProp(_el$11, "text", `属性 ${Object.keys(config().attributes ?? {}).length} · 祝福 ${config().blessings?.length ?? 0} · 遗物 ${config().artifacts?.length ?? 0}`, _$p));
          return _el$7;
        })()
      }));
      return _el$;
    ...
    get children() {
      return libs.createComponent(EOM_DebugTool, {
        ...
        get containerElement() {
          ...
          }), libs.createComponent(UpgradePicker, {}), libs.createComponent(PropertyPicker, {}), libs.createComponent(PrivilagePicker, {}), libs.createComponent(LoadoutPicker, {}), libs.createComponent(ServicePicker, {}), libs.createComponent(UnitInfo, {}), libs.createComponent(ServiceSwitch, {})];
        },
        get children() {
