...
const TERRORBLADE_BASE_SKIN_ID = '5100074';
const TERRORBLADE_ULTIMATE_SKIN_ID = '5100075';
const TERRORBLADE_TRANSFORMATION_SCENES = {
  original: 'scene/yange_activity_shop.vmap',
  normal: 'scene/yange_normal_activity_shop.vmap',
  ultimate: 'scene/yange_ult_activity_shop.vmap'
};
const TERRORBLADE_TRANSFORMATION_OPTIONS = [{
  id: 'original',
  label: '#Not_Transformed'
}, {
  id: 'normal',
  label: '#Normal_Transformed'
}, {
  id: 'ultimate',
  label: '#Awake_Transformed'
}];
...
if (!isSpectator()) {
  ...
  const useCosmetic = () => {
    ...
    let isOwn = oid => {
      if (oid == TERRORBLADE_BASE_SKIN_ID) {
        return playerOrnament()[TERRORBLADE_BASE_SKIN_ID] != undefined || playerOrnament()[TERRORBLADE_ULTIMATE_SKIN_ID] != undefined;
      }
    ...
    const [cosmeticShelfList, setCosmeticShelfList] = libs.createSignal((() => {
      ...
      Object.keys(KeyValues.CosmeticsKv).forEach(oid => {
        kv = KeyValues.CosmeticsKv[oid];
        if (kv) {
          if (oid == "5100000" || oid == TERRORBLADE_ULTIMATE_SKIN_ID) {
            return;
          }
          if (kv.tool == 1 && !isToolMode) {
            return;
    ...
    const previewOwned = () => previewID() == "" || playerOrnament()[previewID()] != undefined || previewID().endsWith("0000") || previewID() == TERRORBLADE_BASE_SKIN_ID && playerOrnament()[TERRORBLADE_ULTIMATE_SKIN_ID] != undefined;
  ...
  const Cosmetic = () => {
    ...
    const [terrorbladeTransformation, setTerrorbladeTransformation] = libs.createSignal('original');
    const isTerrorbladeSkinPreview = libs.createMemo(() => previewID() == TERRORBLADE_BASE_SKIN_ID);
    const ownsTerrorbladeBaseSkin = libs.createMemo(() => playerOrnament()[TERRORBLADE_BASE_SKIN_ID] != undefined);
    const ownsTerrorbladeUltimateSkin = libs.createMemo(() => playerOrnament()[TERRORBLADE_ULTIMATE_SKIN_ID] != undefined);
    const equippedTerrorbladeSkinID = libs.createMemo(() => {
      const terrorbladeHeroID = Number(KeyValues.CosmeticsKv[TERRORBLADE_BASE_SKIN_ID]?.hero);
      return Object.keys(playerOrnament()).find(oid => {
        const ornament = playerOrnament()[oid];
        return ornament.equip == 1 && ornament.pool == OrnamentType.HERO_SKIN && Number(KeyValues.CosmeticsKv[oid]?.hero) == terrorbladeHeroID;
      });
    });
    const equippedTerrorbladeTransformation = libs.createMemo(() => {
      if (playerOrnament()[TERRORBLADE_ULTIMATE_SKIN_ID]?.equip == 1) {
        return 'ultimate';
      }
      if (playerOrnament()[TERRORBLADE_BASE_SKIN_ID]?.equip == 1) {
        return 'normal';
      }
    });
    libs.createEffect(libs.on(isTerrorbladeSkinPreview, (active, previous) => {
      if (active && !previous) {
        setTerrorbladeTransformation('original');
      }
    }));
    const previewTerrorbladeTransformation = transformation => {
      setTerrorbladeTransformation(transformation);
      if (transformation == 'original') {
        return;
      }
      const oid = transformation == 'ultimate' ? TERRORBLADE_ULTIMATE_SKIN_ID : TERRORBLADE_BASE_SKIN_ID;
      const unlocked = transformation == 'ultimate' ? ownsTerrorbladeUltimateSkin() : ownsTerrorbladeBaseSkin();
      if (unlocked && equippedTerrorbladeTransformation() != transformation) {
        callAction('ornament_equip', {
          hid: Number(KeyValues.CosmeticsKv[TERRORBLADE_BASE_SKIN_ID]?.hero),
          oid: Number(oid),
    ...
    const livePreviewID = () => {
      if (!isTerrorbladeSkinPreview()) {
        return previewID();
      }
      switch (terrorbladeTransformation()) {
        case 'normal':
          return TERRORBLADE_BASE_SKIN_ID;
        case 'ultimate':
          return TERRORBLADE_ULTIMATE_SKIN_ID;
        default:
          return equippedTerrorbladeSkinID() ?? TERRORBLADE_BASE_SKIN_ID;
      }
    };
    const IsLocked = oid => {
      if (oid == TERRORBLADE_BASE_SKIN_ID) {
        return !ownsTerrorbladeBaseSkin() && !ownsTerrorbladeUltimateSkin();
      }
      return playerOrnament()[oid] == undefined && !oid.endsWith("0000");
    };
    const isEquip = (cosmeticID, isColorList) => {
      ...
      if (cosmeticID == TERRORBLADE_BASE_SKIN_ID) {
        return playerOrnament()[TERRORBLADE_BASE_SKIN_ID]?.equip == 1 || playerOrnament()[TERRORBLADE_ULTIMATE_SKIN_ID]?.equip == 1;
      }
        ...
        return [libs.createComponent(EOM_Panel.EOM_Panel, {
          ...
          get children() {
            return [libs.createComponent(EOM_Panel.EOM_Panel, {
                                  ...
                                  get children() {
                                    return [libs.createComponent(libs.Show, {
                                      ...
                                      get children() {
                                        ...
                                        libs.insert(_el$0, libs.createComponent(GenericPanel.CImage, {
                                          id: "TrialMark",
                                          get ["class"]() {
                                            return $.Language().toLocaleLowerCase();
                                          }
                                        }), _el$1);
                                        libs.insert(_el$1, libs.createComponent(CosmeticCard.EOM_CountdownWithIcon, {
                                      ...
                                      get children() {
                                        return [libs.createComponent(libs.Show, {
                                          ...
                                          get children() {
                                            ...
                                            libs.insert(_el$9, libs.createComponent(CosmeticCard.EOM_CountdownWithIcon, {
                                              id: "HeroRoleCountdown",
                                              get endTime() {
                                                return Number(getCosmeticExpire(oid()));
                                              }
                    ...
                    return [libs.createComponent(libs.Switch, {
                      get children() {
                        return [libs.createComponent(libs.Match, {
                          ...
                          get when() {
                            return libs.memo(() => selectedTagType() == OrnamentType.HERO_SKIN)() && !isTerrorbladeSkinPreview();
                          },
                          get children() {
                            return libs.createComponent(EOM_Panel.EOM_Panel, {
                              id: "CosmeticGet",
                                          ...
                                          get children() {
                                            return [libs.createComponent(libs.Show, {
                                              ...
                                              get children() {
                                                ...
                                                libs.insert(_el$12, libs.createComponent(GenericPanel.CImage, {
                                                  id: "TrialMark",
                                                  get ["class"]() {
                                                    return $.Language().toLocaleLowerCase();
                                                  }
                                                }), _el$13);
                                                libs.insert(_el$13, libs.createComponent(CosmeticCard.EOM_CountdownWithIcon, {
                                                  id: "HeroRoleCountdown",
                                                  get endTime() {
                                          ...
                                          get children() {
                                            return [libs.createComponent(libs.Show, {
                                              ...
                                              get children() {
                                                ...
                                                libs.insert(_el$10, libs.createComponent(GenericPanel.CImage, {
                                                  id: "TrialMark",
                                                  get ["class"]() {
                                                    return $.Language().toLocaleLowerCase();
                                                  }
                                                }), _el$11);
                                                libs.insert(_el$11, libs.createComponent(CosmeticCard.EOM_CountdownWithIcon, {
                                                  id: "HeroRoleCountdown",
                                                  get endTime() {
                                                    return Number(getCosmeticExpire(id()));
                                                  }
                      ...
                      get children() {
                        return libs.createComponent(EOM_Button.EOM_BaseButton, {
                          ...
                          onactivate: self => {
                            const cosmeticID = livePreviewID();
                            setLiveLoading(cosmeticID);
                            SetHeroSkinLive(Number(cosmeticID));
                            setShowLive(true);
                          },
                          get children() {
                            return [libs.createComponent(EOM_Panel.EOM_Panel, {
              ...
              get when() {
                return libs.memo(() => !!isTerrorbladeSkinPreview())() && !showLive();
              },
              get children() {
                return libs.createComponent(EOM_Panel.EOM_Panel, {
                  id: "TerrorbladeCosmeticTransformationSelector",
                  get children() {
                    return libs.createComponent(libs.Index, {
                      each: TERRORBLADE_TRANSFORMATION_OPTIONS,
                      children: option => {
                        const unlocked = () => option().id == 'ultimate' ? ownsTerrorbladeUltimateSkin() : ownsTerrorbladeBaseSkin();
                        const chosen = () => option().id != 'original' && equippedTerrorbladeTransformation() == option().id;
                        const status = () => chosen() ? '#Current_selection' : !unlocked() ? '#Unlock_Preview' : option().id == 'original' ? '#Lock_Preview' : '#Choose';
                        return libs.createComponent(EOM_Button.EOM_BaseButton, {
                          get className() {
                            return libs.classNames('TransformationOption', {
                              Previewing: terrorbladeTransformation() == option().id,
                              Chosen: chosen(),
                              Locked: !unlocked()
                            });
                          },
                          onactivate: () => previewTerrorbladeTransformation(option().id),
                          get children() {
                            return [libs.createComponent(GenericPanel.CLabel, {
                              ...
                              className: "TransformationStatus",
                              get text() {
                                return status();
                              }
                            })];
                  ...
                  get children() {
                    return libs.createComponent(libs.Switch, {
                      ...
                      get children() {
                        return [libs.createComponent(libs.Match, {
                          get when() {
                            return isTerrorbladeSkinPreview();
                          },
                          get children() {
                            return libs.createComponent(EOM_Panel.EOM_Panel, {
                              id: "TerrorbladeCosmeticPreviewViewport",
                              hittest: false,
                              get children() {
                                const _el$3 = libs.createElement("DOTAScenePanel", {
                                  get map() {
                                    return TERRORBLADE_TRANSFORMATION_SCENES[terrorbladeTransformation()];
                                  },
                                ...
                                libs.setProp(_el$3, "className", "TerrorbladeCosmeticMainPreview");
                                libs.setProp(_el$3, "yawmin", -160);
                                libs.effect(_$p => libs.setProp(_el$3, "map", TERRORBLADE_TRANSFORMATION_SCENES[terrorbladeTransformation()], _$p));
                                return _el$3;
                              }
                            });
                          }
                                              ...
                                              get children() {
                                                return [libs.createComponent(libs.Show, {
                                                  ...
                                                  get children() {
                                                    ...
                                                    libs.insert(_el$15, libs.createComponent(CosmeticCard.EOM_CountdownWithIcon, {
                                                      id: "HeroRoleCountdown",
                                                      get endTime() {
                                                        return Number(getCosmeticExpire(oid()));
                                                      }
                            ...
                            return libs.createComponent(EOM_Panel.EOM_Panel, {
                              ...
                              get children() {
                                return [(() => {
                                    ...
                                    children: slot => {
                                      return (() => {
                                        ...
                                        libs.effect(_p$ => {
                                          ...
                                          _v$2 !== _p$._v$2 && (_p$._v$2 = libs.setProp(_el$17, "text", _v$2, _p$._v$2));
                                          return _p$;
                                        }, {
                                          _v$: undefined,
                                          _v$2: undefined
                                  ...
                                  const _el$5 = libs.createElement("MoviePanel", {
                                    id: "MoviePreview",
                                    get src() {
                                  ...
                                  libs.effect(_$p => libs.setProp(_el$5, "src", `file://{resources}/videos/${selectingID()}.webm`, _$p));
                                  return _el$5;
                                })()];
                              }
                            });
                            ...
                            return libs.createComponent(EOM_Panel.EOM_Panel, {
                              ...
                              get children() {
                                return [(() => {
                                  ...
                                  libs.insert(_el$6, () => bunnySlotList.map(index => {
                                    return libs.createComponent(EOM_Button.EOM_BaseButton, {
                                  ...
                                  get children() {
                                    return libs.createComponent(libs.Show, {
                                      ...
                                      get children() {
                                        const _el$7 = libs.createElement("DOTAScenePanel", {
                                          particleonly: false,
                                          allowrotation: true,
                                          light: "preview_light",
                                          camera: "preview_camera",
                                        ...
                                        typeof _ref$ === "function" ? libs.use(_ref$, _el$7) : bunnyTeamRef = _el$7;
                                        libs.setProp(_el$7, "style", {
                                          width: '100%',
                                          height: '100%'
                                        });
                                        libs.setProp(_el$7, "onload", self => {
