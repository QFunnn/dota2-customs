...
const INTERNATIONAL_SOURCE_OPTIONS = [{
  id: "arcade_browse",
  localization: "#Community_Survey_Source_INT_01"
}, {
  id: "eom_discord",
  localization: "#Community_Survey_Source_INT_02"
}, {
  id: "friend_or_spectator",
  localization: "#Community_Survey_Source_INT_03"
}, {
  id: "stream_or_video",
  localization: "#Community_Survey_Source_INT_04"
}, {
  id: "random",
  localization: "#Community_Survey_Source_INT_05"
}, {
  id: "custom_hero_chaos",
  localization: "#Community_Survey_Source_INT_06"
}, {
  id: "auto_gladiators",
  localization: "#Community_Survey_Source_INT_07"
}];
...
function Popup_CommunitySurvey(props) {
  ...
  const getAnswers = () => {
    ...
    return [{
      id: 1,
      answer: GetLocalization(sourceOption.localization)
    }, {
      id: 2,
      answer: GetLocalization(recommendOption.localization)
    }];
  };
  const submit = () => {
              ...
              get children() {
                return [(() => {
                  ...
                  const _el$23 = libs.createElement("Label", {
                    get text() {
                      return GetLocalization(option.localization);
                    }
                  }, null);
                  libs.effect(_$p => libs.setProp(_el$23, "text", GetLocalization(option.localization), _$p));
                  return _el$23;
                })()];
              }
            })
          ...
          return libs.createComponent(EOM_Button.EOM_BaseButton, {
            ...
            get children() {
              return [(() => {
                ...
                libs.effect(_$p => libs.setProp(_el$26, "text", GetLocalization(option.localization), _$p));
                return _el$26;
              })()];
            }
          });
  ...
  return libs.createComponent(BasePopup, {
    ...
    get children() {
      return [libs.createComponent(Player.CurrencyGroup, {
        ...
        libs.setProp(_el$0, "height", "40px");
        libs.setProp(_el$0, "flowChildren", "right");
        libs.setProp(_el$1, "className", "LeftLabel");
        libs.insert(_el$0, libs.createComponent(Player.CurrencyIcon, {
          get tokenID() {
            return local.itemData.pay_type;
          }
        }), _el$10);
        libs.setProp(_el$10, "className", "CostLabel");
        libs.setProp(_el$11, "height", "40px");
        libs.setProp(_el$11, "flowChildren", "right");
        libs.setProp(_el$12, "className", "LeftLabel");
        libs.insert(_el$11, libs.createComponent(EOM_NumberAdjust.EOM_NumberAdjust, {
          get value() {
        ...
        libs.setProp(_el$13, "marginTop", "22px");
...
const EOM_QRCode = props => {
  ...
  return (() => {
    ...
    libs.insert(_el$, libs.createComponent(EOM_MultiDropDown.GenericPanel2, {
      type: "UICanvas",
      style: {
...
const Popup_PaymentOrder = props => {
  ...
  function PaymentWaySort(list, all = false) {
    return list.sort((a, b) => multiCompare(all ? (KeyValues.payments_order[b].region == "" ? 1 : 0) - (KeyValues.payments_order[a].region == "" ? 1 : 0) : (KeyValues.payments_order[a].region == "" ? 1 : 0) - (KeyValues.payments_order[b].region == "" ? 1 : 0), a < b ? -1 : a > b ? 1 : 0));
  }
  {
