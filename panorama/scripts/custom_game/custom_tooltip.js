...
function UpdateTooltip()
{
    ...
    if (skill_change != "undefined" && skill_change != "")
    {
    ...
    let is_chest = $.GetContextPanel().GetAttributeString("is_chest_info", "")

    if (is_chest != "" && is_chest != "undefined")
    {
        header_text.text = $.Localize("#chest_pair_info_header")
        info_text.text = $.Localize("#chest_pair_info_text")
        info_text.AddClass("info_text_chest")

        let chest_cd = $.GetContextPanel().GetAttributeString("chest_cd", "")
        let chest_games = $.GetContextPanel().GetAttributeString("chest_games", "")

        header_text_level.text = (chest_cd != "") ? chest_cd : chest_games
        return
    }
