...
function SetGameplayKVDefinition(kv) {
    const config = GameUI.CustomUIConfig();
    const keys = (values) => Object.keys(values !== null && values !== void 0 ? values : {});
    config.NoSpellAmpKv = new Set(keys(kv === null || kv === void 0 ? void 0 : kv.no_spell_amp));
    config.NotRearmableAbilitiesKv = new Set(keys(kv === null || kv === void 0 ? void 0 : kv.not_rearmable));
    config.TorturePipeKv = new Set(keys(kv === null || kv === void 0 ? void 0 : kv.torture_pipe));
    config.ReflectionAbilitiesKv = new Set(keys(kv === null || kv === void 0 ? void 0 : kv.reflection));
}
function SetKVDefinition(payload) {
    var _a;
    // $.Msg("ABILITY KV EVENT RESPONSE");
    if (payload.abilities_items_kv) {
        const typedPayload = payload;
        ability_kv = (_a = typedPayload.abilities_items_kv) !== null && _a !== void 0 ? _a : {};
        SetGameplayKVDefinition(typedPayload.gameplay_kv);
        return;
    }
    ability_kv = payload;
}
