...
'use strict'; const exports = {}; GameUI.__loadModule('TeamSuggestionIcon', exports); const require = GameUI.__require;
...
const TeamSuggestionIcon = props => {
  const [local, others] = libs.splitProps(props, ["show", "tooltipPosition", "children"]);
  return libs.createComponent(EOM_Panel.EOM_Panel, libs.mergeProps(() => EOM_Panel.EOMProps(others, {
    className: libs.classNames('TeamSuggestionIcon', {
      IconShow: props.show
    })
  }), {
    hittest: false,
    get children() {
      return [libs.createElement("DOTAParticleScenePanel", {
        id: "TeamSuggestionIcon_Particle",
        particleName: "particles/ui/team_suggestion_icon.vpcf",
        cameraOrigin: "0 0 110",
        lookAt: "0 0 0",
        fov: 90,
        particleonly: true,
        hittest: false
      }, null), libs.createComponent(EOM_Icon.EOM_Icon, {
        size: '48',
        get src() {
          return getSrcPath("hero_selection/s11_icon_secommend_01.png");
        },
        get tooltipPosition() {
          return local.tooltipPosition;
        },
        onmouseover: self => {
          if (props.show) {
            $.DispatchEvent("DOTAShowTextTooltip", self, "#TeammateSuggestion");
          }
        },
        onmouseout: self => {
...
exports.TeamSuggestionIcon = TeamSuggestionIcon;
