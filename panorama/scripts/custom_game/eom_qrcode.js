...
'use strict'; const exports = {}; GameUI.__loadModule('EOM_QRCode', exports); const require = GameUI.__require;
...
const EOM_QRCode = props => {
  ...
  const [qrcode] = libs.createSignal(qrcodegen$1.QrCode.encodeText(local.value, qrcodegen$1.QrCode.Ecc.QUARTILE));
  const defaultStyle = () => {
  ...
  return (() => {
    ...
    libs.insert(_el$, libs.createComponent(GenericPanel.UICanvas, {
      style: {
