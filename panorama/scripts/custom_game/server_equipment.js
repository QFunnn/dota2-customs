      ...
      get children() {
        ...
        libs.insert(_el$6, libs.createComponent(libs.For, {
          ...
          children: gem => {
            ...
            const rarity = () => {
              if (!empty) {
                return KeyValues.gem_entry_main[gem.gem_item_id].rarity;
              }
              return 0;
            };
            return (() => {
...
function Gem(props) {
  const rarity = () => {
    ...
    return CustomUIConfig.gem_entry_main[props.gem_item_id]?.rarity ?? 0;
  };
  return (() => {
    const _el$9 = libs.createElement("Panel", {
      ...
      _el$0 = libs.createElement("Image", {
        id: "GemIcon",
        get src() {
          return `file://{images}/custom_game/store_items/${props.gem_item_id}.png`;
        }
      }, _el$9);
    ...
    libs.effect(_p$ => {
      const _v$5 = "Gem Rarity" + rarity(),
        _v$6 = `file://{images}/custom_game/store_items/${props.gem_item_id}.png`;
