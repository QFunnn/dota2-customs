  ...
  */
  ...
  function Yzy_ServiceItem(params) {
    ...
    const getItemName = () => {
      ...
      if (getItemType() == 123) {
        if ((_m = (_l = getItem()) === null || _l === void 0 ? void 0 : _l.pokemons) === null || _m === void 0 ? void 0 : _m.pokemon_id) {
          return `#Pokemon_${(_p = (_o = getItem()) === null || _o === void 0 ? void 0 : _o.pokemons) === null || _p === void 0 ? void 0 : _p.pokemon_id}`;
        }
      }
      return $.Localize("#" + getItemID());
    };
    const getItemDescription = () => {
      ...
      } else if (getItemType() == 123) {
        if (!((_h = getItem()) === null || _h === void 0 ? void 0 : _h.pokemons)) {
          return $.Localize("#" + getItemType() + '_Description');
        }
      }
    ...
    const getItemRarity = () => {
      ...
      } else if (getItemType() == 123 && ((_r = (_q = getItem()) === null || _q === void 0 ? void 0 : _q.pokemons) === null || _r === void 0 ? void 0 : _r.pokemon_id)) {
        const sLeague = String((_u = (_t = (_s = getItem()) === null || _s === void 0 ? void 0 : _s.pokemons) === null || _t === void 0 ? void 0 : _t.pokemon_id) !== null && _u !== void 0 ? _u : '').substring(3, 4);
        return (_v = {
          '1': 3,
          '2': 2,
          '3': 4
        }[sLeague]) !== null && _v !== void 0 ? _v : 1;
      } else if (getItemType() == '175') {
        return (_y = (_w = CfgGetter_qizhen()) === null || _w === void 0 ? void 0 : _w[(_x = getItemID()) !== null && _x !== void 0 ? _x : '']) === null || _y === void 0 ? void 0 : _y['rarity'];
      }
      if (((_1 = (_z = CfgGetter_shop_items()) === null || _z === void 0 ? void 0 : _z[(_0 = getItemID()) !== null && _0 !== void 0 ? _0 : '']) === null || _1 === void 0 ? void 0 : _1['rarity']) != undefined) {
        return (_3 = (_2 = CfgGetter_shop_items()) === null || _2 === void 0 ? void 0 : _2[getItemID()]) === null || _3 === void 0 ? void 0 : _3['rarity'];
      }
      return 1;
    };
    const getItemImage = () => {
      ...
      if (getItemType() == 210) {
        ...
        if (((_t = (_s = getItem()) === null || _s === void 0 ? void 0 : _s.pokemons) === null || _t === void 0 ? void 0 : _t.pokemon_id) == undefined) {
          return `file://{images}/custom_game/pokemon/pokemon_icon/unknown_1.png`;
        }
        return `file://{images}/custom_game/pokemon/pokemon_icon/${(_v = (_u = getItem()) === null || _u === void 0 ? void 0 : _u.pokemons) === null || _v === void 0 ? void 0 : _v.pokemon_id}.png`;
      }
    ...
    return (() => {
      const _el$59 = createElement("Panel", mergeProps(props, {
          get ["class"]() {
            return classNames('Yzy_ServiceItem', 'Rarity_' + getItemRarity(), props.class, props.className, getItemType());
          },
      ...
      spread(_el$59, mergeProps(props, {
        ...
        "onmouseover": p => {
          ...
          if (getItemType() == 123 && ((_h = getItem()) === null || _h === void 0 ? void 0 : _h.pokemons)) {
            ShowTooltip(p, 'equip_tooltip', {
              type: 'Pokemon',
              data: (_j = getItem()) === null || _j === void 0 ? void 0 : _j.pokemons
            });
            return;
          }
          if (getItemType() == 171) {
            ShowTooltip(p, 'common_detail_tooltip', {
              ...
              tGroups: Str2RewardList((_o = (_m = (_k = CfgGetter_mining_drop()) === null || _k === void 0 ? void 0 : _k[(_l = getItemID()) !== null && _l !== void 0 ? _l : '']) === null || _m === void 0 ? void 0 : _m.reward) !== null && _o !== void 0 ? _o : []).map(item => {
                return {
          ...
          if (getItemType() == 201) {
            ShowTooltip(p, 'shopitem_tooltip', {
              'tShopItemCfg': (_p = CfgGetter_shop()) === null || _p === void 0 ? void 0 : _p[getItemID()]
            });
            return;
          }
          ShowTooltip(p, 'common_detail_tooltip', {
  ...
  function Yzy_ServiceItemName(params) {
    ...
    const getItemName = () => {
      ...
      switch (getItemType()) {
        ...
        case 123:
          if ((_g = (_f = getItem()) === null || _f === void 0 ? void 0 : _f.pokemons) === null || _g === void 0 ? void 0 : _g.pokemon_id) {
            return $.Localize(`#Pokemon_${(_j = (_h = getItem()) === null || _h === void 0 ? void 0 : _h.pokemons) === null || _j === void 0 ? void 0 : _j.pokemon_id}`) + (getShowCount() ? "x" + ((_k = getItem()) === null || _k === void 0 ? void 0 : _k.count) : '');
          }
          return $.Localize("#ServicePokemonTitle") + (getShowCount() ? "x" + ((_l = getItem()) === null || _l === void 0 ? void 0 : _l.count) : '');
        default:
          return $.Localize("#" + getItemID()) + (getShowCount() ? "x" + ((_m = getItem()) === null || _m === void 0 ? void 0 : _m.count) : '');
      }
    };
    const getItemRarity = () => {
      var _a, _b, _c, _d, _e, _f, _g, _h;
      ...
      if (getItemType() == 123 && ((_d = (_c = getItem()) === null || _c === void 0 ? void 0 : _c.pokemons) === null || _d === void 0 ? void 0 : _d.pokemon_id)) {
        const sLeague = String((_g = (_f = (_e = getItem()) === null || _e === void 0 ? void 0 : _e.pokemons) === null || _f === void 0 ? void 0 : _f.pokemon_id) !== null && _g !== void 0 ? _g : '').substring(3, 4);
        return (_h = {
          '1': 3,
          '2': 2,
          '3': 4
        }[sLeague]) !== null && _h !== void 0 ? _h : 1;
      }
      return params.rarity;
    };
    return createComponent(Yzy_Label, mergeProps(props, {
  ...
  function GsSelection() {
    ...
    const getPlayerRewards = createMemo(() => {
      ...
      if (getMode() == 0 || getMode() == 2) {
        ...
        if (!diffData) return [];
        const tRewardList = Str2RewardList(diffData.player_reward_win).filter(t => t[0] && '#' + t[0] != $.Localize('#' + t[0]));
        tRewardList.push(...((_b = Str2RewardList(diffData.player_reward_win_ui || "")) !== null && _b !== void 0 ? _b : []));
        tRewardList.push(...((_c = Str2RewardList(diffData.activity_reward_2 || "")) !== null && _c !== void 0 ? _c : []));
  ...
  function ArchiveChallenge() {
    ...
    return (() => {
      ...
      insert(_el$7, createComponent(Index, {
        each: ['archive_challenge_1', 'archive_challenge_3', 'archive_challenge_4', 'archive_challenge_5', 'archive_challenge_8', 'archive_challenge_9', 'archive_challenge_13', 'archive_challenge_14', 'archive_challenge_20'],
        children: (getName, i) => {
          const getCfg = () => {
            var _a;
  ...
  function CardBtn(props) {
    ...
    const [getReduceCost] = useNetEventTable(t => t || 0, 'card', () => 'resource_' + getter_iLocalPlayer());
    const getKeybind = createMemo(() => {
      var _a, _b;
    ...
    const getCost = () => {
      ...
      const iReduceCost = ((_d = getReduceCost()) === null || _d === void 0 ? void 0 : _d['draw_card_cost']) || 0;
      iSelectCost = iSelectCost - iReduceCost;
    ...
    const getCount = () => {
      ...
      let iMaxCount = ((_d = CfgGetter_settings_common()) === null || _d === void 0 ? void 0 : _d['CardSelectionMaxCost']) || 0;
      if (iMaxCount == 0) {
        return 0;
      }
      let iReduceCost = ((_e = getReduceCost()) === null || _e === void 0 ? void 0 : _e['draw_card_cost']) || 0;
      iMaxCount = iMaxCount - iReduceCost;
      let iCost = 0;
      let iCount = 0;
      while (iWood >= iCost) {
  ...
  function SelectionCard() {
    ...
    const getRefreshText = createMemo(() => {
      ...
      let iCost = Math.min((((_b = CfgGetter_settings_common()) === null || _b === void 0 ? void 0 : _b['CardSelectionRefreshBaseCost']) || 0) + (getCardRefreshCount() || 0) * (((_c = CfgGetter_settings_common()) === null || _c === void 0 ? void 0 : _c['CardSelectionRefreshPerCost']) || 0), ((_d = CfgGetter_settings_common()) === null || _d === void 0 ? void 0 : _d['CardSelectionRefreshMaxCost']) || 0);
      iCost = iCost - iReduceCost;
      return ReplaceTextVariable('#CardRefreshCount', iCost);
    });
    const [getShow, setShow] = createSignal(false);
    createEffect(() => {
      if (getData() != undefined) {
              ...
              insert(_el$16, createComponent(Show, {
                ...
                get children() {
                  ...
                  insert(_el$17, () => Object.values(getAttributeValues()).map((sKey, i) => {
                    ...
                    const GetCardExtractPct = () => {
                      const fPct = AttributeKind$1.CardEffect.Get(getter_iPlayerSelectedHero());
                      return Number((fVal * fPct * 0.01).toFixed(2));
                    };
                    return createComponent(Yzy_Attribute, {
                      id: sAttributeID,
                      val: fVal,
                      get children() {
                        return createComponent(Show, {
                          get when() {
                            return GetCardExtractPct() > 0;
                          },
                          get children() {
                            const _el$21 = createElement("Label", {
                              "class": "ExtractPct",
                              get text() {
                                return `(${GetCardExtractPct()}${(_e = PctUnitAttributes[(_d = ID2Attribute[sAttributeID]) === null || _d === void 0 ? void 0 : _d.name]) !== null && _e !== void 0 ? _e : ''})`;
                              },
                              html: true
                            }, null);
                            effect(_$p => setProp(_el$21, "text", `(${GetCardExtractPct()}${(_e = PctUnitAttributes[(_d = ID2Attribute[sAttributeID]) === null || _d === void 0 ? void 0 : _d.name]) !== null && _e !== void 0 ? _e : ''})`, _$p));
                            return _el$21;
                          }
                        });
                      }
  ...
  function SelectionRelic() {
    ...
    const [getUserPrvg] = useNetEventTable(t => {
      return t || {};
    ...
    return (() => {
      ...
      insert(_el$2, createComponent(Index, {
        ...
        children: (getName, i) => {
          ...
          const getStarValueKey = i => {
            var _a, _b;
            const tAbltVal = (_b = (_a = getKv()) === null || _a === void 0 ? void 0 : _a['AbilityValues']) !== null && _b !== void 0 ? _b : {};
            const spl = 'star_' + i + '_';
            for (const sKey in tAbltVal) {
              if (sKey.startsWith(spl)) {
                return sKey;
              }
            }
            return undefined;
          ...
          return (() => {
            ...
            insert(_el$16, createComponent(Index, {
              ...
              children: getStar => {
                ...
                const getPrvgId = () => {
                  var _a;
                  return (_a = getKv()) === null || _a === void 0 ? void 0 : _a[`start_${i}_lock`];
                };
                const getStarKey = () => getStarValueKey(i);
                const getIsUnlock = () => {
                  var _a, _b;
                  return ((_b = getUserPrvg()[(_a = getPrvgId()) !== null && _a !== void 0 ? _a : '']) !== null && _b !== void 0 ? _b : 0) >= 1;
                };
                const getVal = () => {
                  var _a, _b, _c;
                  return (_b = (_a = getKv()) === null || _a === void 0 ? void 0 : _a['AbilityValues']) === null || _b === void 0 ? void 0 : _b[(_c = getStarKey()) !== null && _c !== void 0 ? _c : ''];
                };
                const getEndStr = () => {
                  var _a;
                  return (_a = getStarKey()) === null || _a === void 0 ? void 0 : _a.substring(('star_' + i + '_').length);
                };
                const getVisible = () => getPrvgId() != undefined && getStarKey() != undefined && getIsUnlock();
                return (() => {
                  const _el$17 = createElement("Panel", {
                      id: `StarDesc_${i}`,
                      get ["class"]() {
                        return classNames('StarEffectDesc', {
                          'Locked': !getVisible()
                        });
                      }
                    }, null),
                    _el$18 = createElement("Label", {
                      "class": "Title",
                      text: `#RelicStarEffectTitle_${i}`
                    }, _el$17);
                  setProp(_el$17, "id", `StarDesc_${i}`);
                  setProp(_el$18, "text", `#RelicStarEffectTitle_${i}`);
                  insert(_el$17, createComponent(Show, {
                    get when() {
                      return memo(() => !!((_a = getEndStr()) === null || _a === void 0))() ? void 0 : _a.startsWith('106');
                    },
                    get children() {
                      return createComponent(Yzy_Attribute, {
                        get id() {
                          return (_b = getEndStr()) !== null && _b !== void 0 ? _b : '';
                        },
                        get val() {
                          return (_c = getVal()) !== null && _c !== void 0 ? _c : 0;
                        }
                      });
                    }
                  }), null);
                  insert(_el$17, createComponent(Show, {
                    get when() {
                      return !((_d = getEndStr()) === null || _d === void 0 ? void 0 : _d.startsWith('106'));
                    },
                    get children() {
                      const _el$19 = createElement("Label", {
                        id: "StarDesc",
                        get text() {
                          return ReplaceTextVariable(`#relic_privilege_${getPrvgId()}_desc`, GreenText(getVal()));
                        },
                        html: true
                      }, null);
                      effect(_$p => setProp(_el$19, "text", ReplaceTextVariable(`#relic_privilege_${getPrvgId()}_desc`, GreenText(getVal())), _$p));
                      return _el$19;
                    }
                  }), null);
                  effect(_$p => setProp(_el$17, "class", classNames('StarEffectDesc', {
                    'Locked': !getVisible()
                  }), _$p));
                  return _el$17;
                })();
  ...
  function Conclusion() {
    ...
    const getPlayerMain = () => {
      ...
      for (const t of (_a = getRewardData()) !== null && _a !== void 0 ? _a : []) {
        if (!t.equips && !t.gems && !t.ancients && !t.holies && !t.pokemons) {
          tReward.push(t);
        }
      }
