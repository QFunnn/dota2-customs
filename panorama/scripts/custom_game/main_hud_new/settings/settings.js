...
const showSelfDuelNoticeCheckbox = panel("ShowSelfDuelNotice");
...
GameUI.OnCheckBoxShowSelfDuelNotice = () => sendSettingsUpdateToServer();
...
function sendSettingsUpdateToServer() {
    ...
    const data = {
        ...
        showSelfDuelNotice: showSelfDuelNoticeCheckbox.checked
    };
...
function applyPlayerSettings(playersSettings) {
    ...
    showSelfDuelNoticeCheckbox.checked = playersSettings.showSelfDuelNotice === undefined
        ? true
        : readNetBool(playersSettings.showSelfDuelNotice);
