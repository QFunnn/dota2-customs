...
(function (factory) {
  ...
  */
  ...
  const ServGetter_UserPokemon = useNetEventTable(t => t, 'service', () => 'UserPokemon_' + getter_iLocalPlayer())[0];

  const ServGetter_UserPokemonWear = useNetEventTable(t => t, 'service', () => 'UserPokemonWear_' + getter_iLocalPlayer())[0];
  ...
  function PackPokemonItem(params) {
    var _a;
    const [local, props] = splitProps(params, ['data', 'item_id', 'hide_wear_icon']);
    const getPrvg51 = () => {
      var _a, _b, _c;
      return (_c = (_b = (_a = ServGetter_UserItem()) === null || _a === void 0 ? void 0 : _a['1185051']) === null || _b === void 0 ? void 0 : _b.count) !== null && _c !== void 0 ? _c : 0;
    };
    const getPrvg52 = () => {
      var _a, _b, _c;
      return (_c = (_b = (_a = ServGetter_UserItem()) === null || _a === void 0 ? void 0 : _a['1185052']) === null || _b === void 0 ? void 0 : _b.count) !== null && _c !== void 0 ? _c : 0;
    };
    const getPrvg53 = () => {
      var _a, _b, _c;
      return (_c = (_b = (_a = ServGetter_UserItem()) === null || _a === void 0 ? void 0 : _a['1185053']) === null || _b === void 0 ? void 0 : _b.count) !== null && _c !== void 0 ? _c : 0;
    };
    const getData = (_a = local.data) !== null && _a !== void 0 ? _a : createMemo(() => {
      var _a;
      return ((_a = ServGetter_UserPokemon()) === null || _a === void 0 ? void 0 : _a[local.item_id]) || {};
    });
    const getRarity = createMemo(() => {
      var _a, _b, _c;
      const sLeague = String((_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.pokemon_id) !== null && _b !== void 0 ? _b : '').substring(3, 4);
      const t = {
        '1': 2,
        '2': 3,
        '3': 4
      };
      return (_c = t[sLeague]) !== null && _c !== void 0 ? _c : 1;
    });
    const getImage = createMemo(() => {
      var _a, _b;
      return `file://{images}/custom_game/pokemon/pokemon_icon/${(_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.pokemon_id) !== null && _b !== void 0 ? _b : ''}.png`;
    });
    const getIsLock = createMemo(() => {
      var _a;
      return ((_a = getData()) === null || _a === void 0 ? void 0 : _a.lock) == 1;
    ...
    const getPotentialLeft = createMemo(() => {
      var _a, _b, _c, _d;
      ...
      iPotentialLeft += getPrvg53();
      return iPotentialLeft > 0 ? iPotentialLeft : 0;
    });
    const getHasWear = createMemo(() => {
      var _a;
      const tWear = ServGetter_UserPokemonWear();
      for (const sSlot in tWear || {}) {
        if (tWear[sSlot] == ((_a = getData()) === null || _a === void 0 ? void 0 : _a.id) && sSlot.substring(1, 3) == '01') return true;
      }
      return false;
    });
    const getTotalLevel = () => {
    ...
    return (() => {
      ...
      spread(_el$53, mergeProps(props, {
        ...
        "onmouseout": p => {
          ...
          HideTooltip();
          if (getIsNew()) {
            GameUI.CustomUIConfig()['Pokemon_Touch'] = (_b = GameUI.CustomUIConfig()['Pokemon_Touch']) !== null && _b !== void 0 ? _b : [];
            GameUI.CustomUIConfig()['Pokemon_Touch'].push((_c = getData()) === null || _c === void 0 ? void 0 : _c.id);
            Timer(() => {
              Request('Equip_PokemonTouch', {
                'ids': GameUI.CustomUIConfig()['Pokemon_Touch']
              });
              delete GameUI.CustomUIConfig()['Pokemon_Touch'];
            }, 1, "PackPokemonItem_Touch");
          }
        }
      }), true);
      insert(_el$55, createComponent(Show, {
      ...
      insert(_el$55, createComponent(Show, {
        ...
        get children() {
          const _el$57 = createElement("Panel", {
            ...
            _el$58 = createElement("Label", {
              "class": 'CountTitle',
              get text() {
                return String(getPotentialLeft());
              }
            }, _el$57);
  ...
  const CfgGetter_pokemon_affix_effect = useSystemConfig('pokemon_affix_effect');

  const CfgGetter_pokemon_gongming_effect = useSystemConfig('pokemon_gongming_effect');

  const CfgGetter_pokemon_score = useSystemConfig('pokemon_score');
  ...
  function EquipTooltip(props) {
    ...
    return (() => {
      ...
      insert(_el$, createComponent(Show, {
        get when() {
          return props.type == 'Pokemon';
        },
        get children() {
          return createComponent(PokemonInfoTooltip, mergeProps(props, {
            get data() {
              return props.data;
            }
          }));
  ...
  function PokemonInfoTooltip(props) {
    return (() => {
      const _el$5 = createElement("Panel", {
        id: "PokemonInfoTooltip",
        hittest: false
      }, null);
      insert(_el$5, createComponent(PokemonTooltipHeader, {
        get data() {
          return props.data;
        },
        get prvg53() {
      ...
      insert(_el$5, createComponent(PokemonTooltipAffix, mergeProps(props, {
        get data() {
          return props.data;
        }
      })), null);
  ...
  function GetPokemonRarity(data) {
    var _a, _b;
    const sLeague = String((_a = data === null || data === void 0 ? void 0 : data.pokemon_id) !== null && _a !== void 0 ? _a : '').substring(3, 4);
    return (_b = {
      '1': 2,
      '2': 3,
      '3': 4
    }[sLeague]) !== null && _b !== void 0 ? _b : 1;
  }
  function PokemonTooltipHeader(props) {
    var _a, _b;
    ...
    const getPotentialLeft = () => {
      var _a, _b, _c, _d, _e, _f;
      let iPotentialLeft = ((_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.potential_max) !== null && _b !== void 0 ? _b : 0) - ((_d = (_c = getData()) === null || _c === void 0 ? void 0 : _c.potential) !== null && _d !== void 0 ? _d : 0);
      iPotentialLeft += (_f = (_e = props.prvg53) === null || _e === void 0 ? void 0 : _e.call(props)) !== null && _f !== void 0 ? _f : 0;
      return iPotentialLeft > 0 ? iPotentialLeft : 0;
    };
    const getScore = () => {
      var _a, _b;
      if (((_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.score) !== null && _b !== void 0 ? _b : 0) > 0) {
        if (getter_bDebugMode()) {
          return `${getData().score}(UI=${CalcPokemonScore(getData())})`;
        }
    ...
    return (() => {
      const _el$6 = createElement("Panel", {
        ...
        _el$1 = createElement("Label", {
          get text() {
            return ReplaceTextVariable(`#PokemonPotentialLeft`, getPotentialLeft());
          },
          html: true
        }, _el$0);
        createElement("Panel", {
      ...
      insert(_el$6, createComponent(Yzy_Label, {
        ...
        get text() {
          return `#pokemon_${(_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.pokemon_id) !== null && _b !== void 0 ? _b : ''}`;
        }
      }), _el$0);
  ...
  function PokemonTooltipAffix(props) {
    const getData = () => props.data;
    const getRarity = () => GetPokemonRarity(getData());
    const getPotentialUseOver = () => {
      var _a, _b, _c, _d;
      return ((_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.potential) !== null && _b !== void 0 ? _b : 0) >= ((_d = (_c = getData()) === null || _c === void 0 ? void 0 : _c.potential_max) !== null && _d !== void 0 ? _d : 0);
    };
    const getAffixGroup = createMemo(() => {
      ...
      for (const affix of (_b = (_a = getData()) === null || _a === void 0 ? void 0 : _a.affix) !== null && _b !== void 0 ? _b : []) {
        if (affix.c < 3) {
          if (tAffixGroup[affix.c] == undefined) tAffixGroup[affix.c] = [];
        ...
        children: getValue => {
          ...
          return (() => {
            ...
            insert(_el$27, createComponent(Index, {
              ...
              children: affix => createComponent(PokemonTooltipAffixRow, {
                get affix() {
                  return affix();
                },
                get potentialUseOver() {
                  return getPotentialUseOver();
                },
                get pokemon_py_result() {
                  return props.pokemon_py_result;
                },
                get prvg51() {
                  return props.prvg51;
                },
      ...
      insert(_el$15, createComponent(Show, {
        ...
        get children() {
          ...
          insert(_el$21, createComponent(Index, {
            ...
            children: affix => createComponent(PokemonTooltipRsncRow, {
              get affix() {
                return affix();
              }
            })
  ...
  function PokemonTooltipRsncRow(props) {
    ...
    const getValues = tAffix => {
      var _a, _b, _c, _d, _e, _f;
      const tCfg = (_b = (_a = CfgGetter_pokemon_gongming_effect()) === null || _a === void 0 ? void 0 : _a[String(tAffix.a)]) !== null && _b !== void 0 ? _b : {};
      const iMin = (_c = tCfg['min_val']) !== null && _c !== void 0 ? _c : 0;
      const iMax = (_d = tCfg['max_val']) !== null && _d !== void 0 ? _d : 0;
      let val = iMin + (iMax - iMin) * tAffix.v * 0.01;
      const ratio = (_e = tCfg['ratio']) !== null && _e !== void 0 ? _e : 1;
      if (ratio) {
        val = Number(val.toFixed(ratio));
      }
      const tValues = {};
      tValues['min-max'] = val;
      tValues['min_val'] = iMin;
      tValues['max_val'] = NumFixRatio(iMin + (iMax - iMin) * getRedLimit() * 0.01, ratio);
      tValues['param1'] = (_f = tCfg['param']) !== null && _f !== void 0 ? _f : '';
      return tValues;
    };
    return (() => {
      const _el$28 = createElement("Panel", {
  ...
  function PokemonTooltipAffixRow(props) {
    ...
    const getIsHide = () => {
      var _a, _b;
      return !props.potentialUseOver && ((_b = (_a = props.affix.r) === null || _a === void 0 ? void 0 : _a.hide) !== null && _b !== void 0 ? _b : 0) == 1;
    };
    const getEffect = createMemo(() => {
      var _a;
      const cfg = (_a = CfgGetter_pokemon_affix_effect()) === null || _a === void 0 ? void 0 : _a[String(getAffix().a)];
      return cfg || {
        value_down: 0,
        value_up: 0,
        coefficient: '',
    ...
    const getCoefficient = createMemo(() => {
      var _a;
      let iCoefficient = 0;
      for (const i of Array.from({
        ...
        let iVal = 0;
        for (const s of String((_a = getEffect().coefficient) !== null && _a !== void 0 ? _a : '').split('|')) {
    ...
    const getScaledDownUp = () => {
      const effect = getEffect();
      const coefficient = getCoefficient();
      return {
        down: NumFixRatio(effect.value_down * coefficient, effect.ratio),
        up: NumFixRatio(effect.value_up * coefficient, effect.ratio),
        ratio: effect.ratio
      };
    };
    const getVal = () => {
      ...
      return ValuePct(props.affix.v, down, up, ratio);
    };
    const getPrvgCount = () => {
      var _a, _b, _c, _d;
      if (props.affix.c == 1) return (_b = (_a = props.prvg51) === null || _a === void 0 ? void 0 : _a.call(props)) !== null && _b !== void 0 ? _b : 0;
      if (props.affix.c == 2) return (_d = (_c = props.prvg52) === null || _c === void 0 ? void 0 : _c.call(props)) !== null && _d !== void 0 ? _d : 0;
      return 0;
    };
    const getBonus = () => getVal() * getPrvgCount() * 0.01;
  ...
  function CalcPokemonScore(tPokemon) {
    ...
    const pokemon_score = CfgGetter_pokemon_score();
    const pokemon_affix_effect = CfgGetter_pokemon_affix_effect();
    if (pokemon_score == undefined || pokemon_affix_effect == undefined) {
      return 0;
    }
    const bPotentialUseOver = ((_a = tPokemon.potential) !== null && _a !== void 0 ? _a : 0) >= ((_b = tPokemon.potential_max) !== null && _b !== void 0 ? _b : 0);
    let iScore = 0;
    for (const affix of tPokemon.affix || []) {
      if (affix.a == undefined || affix.v == undefined) continue;
      if (((_c = affix.c) !== null && _c !== void 0 ? _c : 0) >= 3) continue;
      if (!bPotentialUseOver && ((_e = (_d = affix.r) === null || _d === void 0 ? void 0 : _d.hide) !== null && _e !== void 0 ? _e : 0) == 1) continue;
      const cfg = pokemon_affix_effect[String(affix.a)];
      ...
      let iCoefficient = 0;
      for (let i = 1; i <= ((_f = affix.l) !== null && _f !== void 0 ? _f : 1); i++) {
        let iVal = 0;
        for (const s of String(coefficient !== null && coefficient !== void 0 ? coefficient : '').split('|')) {
          const [lvl, val] = s.split('=').map(v => Number(v));
          if (i < lvl) break;
          iVal = val;
        }
      ...
      const fVal = ValuePct(affix.v, value_down, value_up, ratio);
      iScore += ((_h = (_g = pokemon_score[String(affix.a)]) === null || _g === void 0 ? void 0 : _g['single_score']) !== null && _h !== void 0 ? _h : 0) * fVal;
    }
