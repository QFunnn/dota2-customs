...
(function (factory) {
  ...
  */
  ...
  const CfgGetter_privilege = useSystemConfig('privilege');
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      tShopItemCfg,
      bOnly
    } = (_a = GetTooltipParams('shopitem_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(ShopItemTooltip, {
      tShopItemCfg: tShopItemCfg,
      bOnly: bOnly
    }), $.GetContextPanel());
  });
  function ShopItemTooltip(props) {
    const getShopItemID = () => {
      var _a;
    ...
    return (() => {
      ...
      insert(_el$7, createComponent(Show, {
        ...
        get children() {
          return createComponent(Index, {
            get each() {
              return getShopItemRewardList().filter(k => !(String(k[0]).startsWith('118') || String(k[0]).startsWith('106')));
            },
            children: (getReward, i) => {
              const getItemID = () => getReward()[0];
              const getItemCount = () => getReward()[1];
              const getItemTitle = () => '#' + getItemID();
              const getItemRarity = () => {
                var _a, _b, _c, _d, _e;
                return (_e = (_c = (_b = (_a = CfgGetter_shop_items()) === null || _a === void 0 ? void 0 : _a[getItemID()]) === null || _b === void 0 ? void 0 : _b['rarity']) !== null && _c !== void 0 ? _c : (_d = props.tShopItemCfg) === null || _d === void 0 ? void 0 : _d.rarity) !== null && _e !== void 0 ? _e : 0;
              };
              return (() => {
                const _el$8 = createElement("Panel", {
                    get ["class"]() {
                      return classNames('RewardRow', 'Rarity_' + getItemRarity());
                    }
                  }, null),
                ...
                insert(_el$9, createComponent(Yzy_ServiceItem, {
                  get data() {
                    return {
                ...
                insert(_el$9, createComponent(Show, {
                  ...
                  get children() {
                    ...
                    effect(_$p => setProp(_el$0, "text", 'x' + getItemCount(), _$p));
                    return _el$0;
                  }
                }), null);
                effect(_p$ => {
                  const _v$ = classNames('RewardRow', 'Rarity_' + getItemRarity()),
                    _v$2 = getItemTitle();
      ...
      insert(_el$7, createComponent(Index, {
        get each() {
          return getShopItemRewardList().filter(k => String(k[0]).startsWith('106'));
        },
        children: (getReward, i) => {
          const getAttributeID = () => getReward()[0];
          const getValue = () => getReward()[1];
          return (() => {
            const _el$10 = createElement("Panel", {
              "class": "AttributeRow"
            }, null);
            insert(_el$10, createComponent(Yzy_Attribute, {
              get id() {
      ...
      insert(_el$7, createComponent(Index, {
        get each() {
          return getShopItemRewardList().filter(k => String(k[0]).startsWith('118'));
        },
        children: (getReward, i) => {
          const getPrivilegeID = () => getReward()[0].toString();
          const getValue = () => getReward()[1];
          const getKv = () => AbilitiesKv['privilege_' + getPrivilegeID()];
          const getText = () => {
            var _a, _b, _c, _d, _e, _f, _g;
            let s = '';
            if (getPrivilegeID().startsWith('1180')) {
              s = ReplaceAbltSpecialVals('privilege_' + getPrivilegeID(), $.Localize("#privilege_" + getPrivilegeID() + '_desc'));
            } else {
              s = ReplaceTextVariable("#" + getPrivilegeID(), {
                val: ((_c = (_b = (_a = getKv()) === null || _a === void 0 ? void 0 : _a['AbilityValues']) === null || _b === void 0 ? void 0 : _b['val']) !== null && _c !== void 0 ? _c : 1) * getValue()
              });
            }
            if (getKv()) {
              if (getKv()['Rarity'] != undefined) {
                s = SpanText(s, 'Rarity_' + getKv()['Rarity']);
              }
            } else if (((_e = (_d = CfgGetter_privilege()) === null || _d === void 0 ? void 0 : _d[getPrivilegeID()]) === null || _e === void 0 ? void 0 : _e['rarity']) != undefined) {
              s = SpanText(s, 'Rarity_' + ((_g = (_f = CfgGetter_privilege()) === null || _f === void 0 ? void 0 : _f[getPrivilegeID()]) === null || _g === void 0 ? void 0 : _g['rarity']));
            }
            return s;
          };
          return (() => {
            ...
            effect(_$p => setProp(_el$11, "text", getText(), _$p));
            return _el$11;
          })();
        }
      }), null);
      effect(_$p => setProp(_el$6, "text", getShopItemName(), _$p));
      return _el$;
    })();
  }
