...
(function (factory) {
  ...
  */
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      sRelicName
    } = (_a = GetTooltipParams('relic_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(RelicTooltip, {
      sRelicName: sRelicName
    }), $.GetContextPanel());
  });
  function RelicTooltip({
    sRelicName
  }) {
    const getKv = () => AbilitiesKv[sRelicName];
    ...
    const getDescription = () => {
      if ($.Localize('#' + sRelicName + '_Description') != '#' + sRelicName + '_Description') {
        return ReplaceAbltVals(sRelicName, $.Localize("#" + sRelicName + '_Description'));
      }
    };
    return (() => {
      const _el$ = createElement("Panel", {
        ...
        _el$7 = createElement("Image", {
          id: "Image",
          src: `file://{images}/custom_game/relics/${sRelicName}.png`,
      ...
      setProp(_el$7, "src", `file://{images}/custom_game/relics/${sRelicName}.png`);
      setProp(_el$9, "text", '#' + sRelicName);
      ...
      insert(_el$10, createComponent(Show, {
        ...
        get children() {
          ...
          effect(_$p => setProp(_el$11, "text", getDescription(), _$p));
          return _el$11;
        }
      }));
      return _el$;
