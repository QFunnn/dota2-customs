...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.halidom_tooltip = {}));
  ...
  */
  ...
  $.GetContextPanel().SetPanelEvent("ontooltiploaded", () => {
    ...
    const {
      sHalidomName,
      iEntID
    } = (_a = GetTooltipParams('halidom_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(HalidomTooltip, {
      sHalidomName: sHalidomName,
      iEntID: iEntID
    }), $.GetContextPanel());
  });
  function HalidomTooltip(props) {
    var _a, _b, _c, _d;
    const getKv = () => AbilitiesKv[props.sHalidomName];
    const getRarity = () => getKv()['Rarity'];
    ...
    return (() => {
      const _el$ = createElement("Panel", {}, null),
        ...
        _el$7 = createElement("Image", {
          id: "HalidomImage",
          get src() {
            return `file://{images}/custom_game/halidom/${props.sHalidomName}.png`;
          },
        ...
        _el$9 = createElement("Label", {
          id: "HalidomName",
          get text() {
            return '#' + props.sHalidomName;
          }
        }, _el$8),
        _el$10 = createElement("Label", {
          id: "Description",
          get text() {
            return ReplaceAbltVals(props.sHalidomName, $.Localize(`#${props.sHalidomName}_Description`), {
              'entid': getter_iPlayerSelectedHero(),
              'level': 1
            });
          },
          html: true
      ...
      insert(_el$8, createComponent(Show, {
        get when() {
          return ((_b = (_a = getKv()) === null || _a === void 0 ? void 0 : _a['AbilityValues']) === null || _b === void 0 ? void 0 : _b['cooldown']) != undefined;
        },
        get children() {
          const _el$0 = createElement("Label", {
            ...
            get dialogVariables() {
              return {
                'cooldown': Number((_d = (_c = getKv()) === null || _c === void 0 ? void 0 : _c['AbilityValues']) === null || _d === void 0 ? void 0 : _d['cooldown']).toFixed(0)
              };
            }
          }, null);
          effect(_$p => setProp(_el$0, "dialogVariables", {
            'cooldown': Number((_d = (_c = getKv()) === null || _c === void 0 ? void 0 : _c['AbilityValues']) === null || _d === void 0 ? void 0 : _d['cooldown']).toFixed(0)
          }, _$p));
          return _el$0;
        }
      ...
      insert(_el$3, createComponent(Show, {
        ...
        get children() {
          ...
          insert(_el$1, () => Object.values(getAttributeValues()).map((sKey, i) => {
            var _a, _b, _c;
      ...
      effect(_p$ => {
        const _v$ = classNames('HalidomTooltip', 'Rarity_' + getRarity()),
          _v$2 = `file://{images}/custom_game/halidom/${props.sHalidomName}.png`,
          _v$3 = '#' + props.sHalidomName,
          _v$4 = ReplaceAbltVals(props.sHalidomName, $.Localize(`#${props.sHalidomName}_Description`), {
            'entid': getter_iPlayerSelectedHero(),
            'level': 1
          });
        ...
        _v$4 !== _p$._v$4 && (_p$._v$4 = setProp(_el$10, "text", _v$4, _p$._v$4));
        return _p$;
      }, {
        _v$: undefined,
        _v$2: undefined,
  ...
  exports.HalidomTooltip = HalidomTooltip;
