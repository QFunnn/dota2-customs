...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.weapon_tooltip = {}));
  ...
  */
  ...
  function SkyBlueText(text, className = "") {
    return ColorText(text, "#00ffff", className);
  }
  ...
  const ID2Attribute = {
    ...
    '10600372': AttributeKind.FireBallProjectSpd,
  ...
  const PctUnitAttributes = {
    ...
    [AttributeKind.FireBallProjectSpd.name]: '%',
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      iEntID
    } = (_a = GetTooltipParams('weapon_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(WeaponTooltip, {
      iEntID: iEntID
    }), $.GetContextPanel());
  });
  function WeaponTooltip(props) {
    var _a, _b;
    const [getWeapon] = useDiyPolymer(() => props.iEntID, 'weapon');
    ...
    const getLevelUpGold = createMemo(() => {
      var _a, _b;
      return (_b = (_a = CfgGetter_weapon_attribute()) === null || _a === void 0 ? void 0 : _a[getLevel()]) === null || _b === void 0 ? void 0 : _b['gold'];
    });
    const getBaseAttribute = createMemo(() => {
      var _a, _b, _c;
      let t = [];
      for (const sID of Object.keys(((_a = CfgGetter_weapon_attribute()) === null || _a === void 0 ? void 0 : _a[getLevel()]) || {})) {
        if (sID.startsWith('106')) {
          t.push({
            'id': sID,
            'val': Number((((_c = (_b = CfgGetter_weapon_attribute()) === null || _b === void 0 ? void 0 : _b[getLevel()]) === null || _c === void 0 ? void 0 : _c[sID]) * (1 + AttributeKind$1.WeaponStatsPct.Get(props.iEntID) * 0.01)).toFixed(2))
          });
        }
      }
      return t;
    });
    const getWeaponAffix = createMemo(() => {
      var _a, _b;
      let s1 = '';
      if (((_a = getWeaponData()) === null || _a === void 0 ? void 0 : _a.affix.length) <= 0) {
        s1 = $.Localize("#WeaponAffixDes");
      } else {
        (_b = getWeaponData()) === null || _b === void 0 ? void 0 : _b.affix.forEach((tAffix, i) => {
          var _a;
          const sAffixName = tAffix.name;
          const iAffixCount = tAffix.count;
          s1 += GreenText(ReplaceAbltSpecialVals(sAffixName, $.Localize("#" + sAffixName + '_Description')));
          if (AbilitiesKv[sAffixName]['IsOnly'] == 1) {
            s1 += SkyBlueText($.Localize("#WeaponAffixOnlyTag"));
          } else {
            s1 += SkyBlueText(` [x${iAffixCount}]`);
          }
          if (i != ((_a = getWeaponData()) === null || _a === void 0 ? void 0 : _a.affix.length) - 1) {
            s1 += '<br/>';
          }
        });
      }
    ...
    return (() => {
      const _el$ = createElement("Panel", {
          get ["class"]() {
            return classNames('WeaponTooltip');
          }
        }, null);
        createElement("Panel", {
          "class": "BG"
        ...
        _el$10 = createElement("Label", {
          id: "GoldCost",
          get text() {
            return YellowText(String(getLevelUpGold() || 0));
          },
          html: true
        }, _el$1),
      ...
      insert(_el$11, createComponent(Show, {
        get when() {
          return getBaseAttribute().length > 0;
        },
        get children() {
          return [(() => {
            const _el$12 = createElement("Panel", {
              ...
              const _el$14 = createElement("Label", {
                get text() {
                  return `${YellowText($.Localize("#WeaponBaseAttribute"))}`;
                },
                html: true
              }, _el$12);
            effect(_$p => setProp(_el$14, "text", `${YellowText($.Localize("#WeaponBaseAttribute"))}`, _$p));
            return _el$12;
          })(), (() => {
            ...
            insert(_el$15, createComponent(Index, {
              ...
              children: getV => {
                const getID = () => getV().id;
                const getName = () => $.Localize('#' + getID());
                const getValue = () => getV().val;
                const getVal = () => {
                  var _a;
                  return `+ ${getValue()}${(_a = PctUnitAttributes[ID2Attribute[getID()].name]) !== null && _a !== void 0 ? _a : ''}`;
                };
                return createComponent(WeaponAttributeRow, {
                  get name() {
                    return getName();
                  },
                  get val() {
      ...
      insert(_el$16, createComponent(Show, {
        get when() {
          return ((_b = (_a = getWeaponData()) === null || _a === void 0 ? void 0 : _a.affix) !== null && _b !== void 0 ? _b : []).length > 0;
        },
        get children() {
          return [(() => {
            const _el$17 = createElement("Panel", {
              ...
              const _el$19 = createElement("Label", {
                get text() {
                  return `${YellowText($.Localize("#WeaponAffix"))}`;
                },
                html: true
              }, _el$17);
            effect(_$p => setProp(_el$19, "text", `${YellowText($.Localize("#WeaponAffix"))}`, _$p));
            return _el$17;
          })(), (() => {
            const _el$20 = createElement("Panel", {
              ...
              _el$21 = createElement("Label", {
                get text() {
                  return getWeaponAffix();
                },
                html: true
              }, _el$20);
            effect(_$p => setProp(_el$21, "text", getWeaponAffix(), _$p));
            return _el$20;
          })()];
        }
      }));
      effect(_p$ => {
        const _v$ = classNames('WeaponTooltip'),
          _v$2 = getImage(),
          _v$3 = 'Lv.' + getLevel(),
          _v$4 = $.Localize('#WeaponName'),
          _v$5 = YellowText(String(getLevelUpGold() || 0));
        _v$ !== _p$._v$ && (_p$._v$ = setProp(_el$, "class", _v$, _p$._v$));
        _v$2 !== _p$._v$2 && (_p$._v$2 = setProp(_el$7, "src", _v$2, _p$._v$2));
  ...
  function WeaponAttributeRow(props) {
    const getVal = typeof props.val == 'function' ? props.val : () => props.val;
    return (() => {
      const _el$23 = createElement("Panel", {
          get ["class"]() {
            return classNames('WeaponAttributeRow');
          }
        }, null),
      ...
      setProp(_el$24, "className", "Name");
      setProp(_el$25, "className", "Value");
      effect(_p$ => {
        const _v$6 = classNames('WeaponAttributeRow'),
          _v$7 = props.name,
          _v$8 = getVal();
        _v$6 !== _p$._v$6 && (_p$._v$6 = setProp(_el$23, "class", _v$6, _p$._v$6));
        _v$7 !== _p$._v$7 && (_p$._v$7 = setProp(_el$24, "text", _v$7, _p$._v$7));
        _v$8 !== _p$._v$8 && (_p$._v$8 = setProp(_el$25, "text", _v$8, _p$._v$8));
        return _p$;
      }, {
        _v$6: undefined,
        _v$7: undefined,
  ...
  exports.WeaponTooltip = WeaponTooltip;
