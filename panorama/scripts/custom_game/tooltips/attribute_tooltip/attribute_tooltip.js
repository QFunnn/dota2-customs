...
(function (factory) {
  ...
  const ID2Attribute = {
    ...
    '10600534': AttributeKind$1.DmgAmp_1,
    '10600535': AttributeKind$1.StrGain.AMP_2,
    '10600536': AttributeKind$1.AgiGain.AMP_2,
    '10600537': AttributeKind$1.IntGain.AMP_2,
    '10600538': AttributeKind$1.AtkGain.AMP_2,
    '10600539': AttributeKind$1.AtkPureGain.AMP_2,
    '10600540': AttributeKind$1.HpGain.AMP_2,
    '10600541': AttributeKind$1.PhyFixedGain.AMP_2,
    '10600542': AttributeKind$1.MgcFixedGain.AMP_2,
    '10600543': AttributeKind$1.PhyCritDmg.AMP_2,
    '10600544': AttributeKind$1.MgcCritDmg.AMP_2,
    '10600545': AttributeKind$1.PureCritDmg.AMP_2,
    '10600546': AttributeKind$1.CreepDmg.AMP_2,
    '10600547': AttributeKind$1.EliteDmg.AMP_2,
    '10600548': AttributeKind$1.ChallengeDmg.AMP_2,
    '10600549': AttributeKind$1.BossDmg.AMP_2,
    '10600550': AttributeKind$1.ArchiveDmg.AMP_2,
    '10600551': AttributeKind$1.AtkDmg.AMP_2,
    '10600552': AttributeKind$1.AbltDmg.AMP_2,
    '10600553': AttributeKind$1.PhyDmg.AMP_2,
    '10600554': AttributeKind$1.MgcDmg.AMP_2,
    '10600555': AttributeKind$1.PureDmg.AMP_2,
    '10600556': AttributeKind$1.AllDmg.AMP_2,
    '10600557': AttributeKind$1.HolyDmg.AMP_2,
    '10600558': AttributeKind$1.NatureDmg.AMP_2,
    '10600559': AttributeKind$1.FrostDmg.AMP_2,
    '10600560': AttributeKind$1.FireDmg.AMP_2,
    '10600561': AttributeKind$1.PhysicalDmg.AMP_2,
    '10600562': AttributeKind$1.ShadowDmg.AMP_2
  };
  const PctUnitAttributes = {
    ...
    [AttributeKind$1.DmgAmp_1.name]: '%',
    [AttributeKind$1.StrGain.AMP_2.name]: '%',
    [AttributeKind$1.AgiGain.AMP_2.name]: '%',
    [AttributeKind$1.IntGain.AMP_2.name]: '%',
    [AttributeKind$1.AtkGain.AMP_2.name]: '%',
    [AttributeKind$1.AtkPureGain.AMP_2.name]: '%',
    [AttributeKind$1.HpGain.AMP_2.name]: '%',
    [AttributeKind$1.PhyFixedGain.AMP_2.name]: '%',
    [AttributeKind$1.MgcFixedGain.AMP_2.name]: '%',
    [AttributeKind$1.PhyCritDmg.AMP_2.name]: '%',
    [AttributeKind$1.MgcCritDmg.AMP_2.name]: '%',
    [AttributeKind$1.PureCritDmg.AMP_2.name]: '%',
    [AttributeKind$1.CreepDmg.AMP_2.name]: '%',
    [AttributeKind$1.EliteDmg.AMP_2.name]: '%',
    [AttributeKind$1.ChallengeDmg.AMP_2.name]: '%',
    [AttributeKind$1.BossDmg.AMP_2.name]: '%',
    [AttributeKind$1.ArchiveDmg.AMP_2.name]: '%',
    [AttributeKind$1.AtkDmg.AMP_2.name]: '%',
    [AttributeKind$1.AbltDmg.AMP_2.name]: '%',
    [AttributeKind$1.PhyDmg.AMP_2.name]: '%',
    [AttributeKind$1.MgcDmg.AMP_2.name]: '%',
    [AttributeKind$1.PureDmg.AMP_2.name]: '%',
    [AttributeKind$1.AllDmg.AMP_2.name]: '%',
    [AttributeKind$1.HolyDmg.AMP_2.name]: '%',
    [AttributeKind$1.NatureDmg.AMP_2.name]: '%',
    [AttributeKind$1.FrostDmg.AMP_2.name]: '%',
    [AttributeKind$1.FireDmg.AMP_2.name]: '%',
    [AttributeKind$1.PhysicalDmg.AMP_2.name]: '%',
    [AttributeKind$1.ShadowDmg.AMP_2.name]: '%'
  };
  ...
  */
  ...
  function AttributeTooltip(props) {
    ...
    const tGroup14 = ['10600521', '10600522', '10600523', '10600524', '10600525', '10600526', '10600519', '10600520', '10600534'];
