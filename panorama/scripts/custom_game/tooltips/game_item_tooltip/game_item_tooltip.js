...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.game_item_tooltip = {}));
  ...
  */
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      ...
      uid,
      iEntID
    } = (_a = GetTooltipParams('game_item_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(GameItemTooltip, {
      sItemName: sItemName,
      uid: uid,
      iEntID: iEntID
    }), $.GetContextPanel());
  });
  function GameItemTooltip(props) {
    useNetEventTable(t => t, 'gameplay_item', () => {
      var _a;
      return (_a = props.uid) !== null && _a !== void 0 ? _a : -1;
    });
    const [getItemName, setItemName] = createSignal(props.sItemName);
    const getKv = () => ItemsKv[getItemName()];
    useAltDown();
    ...
    const getItemCost = createMemo(() => {
      var _a;
      return (_a = getKv()) === null || _a === void 0 ? void 0 : _a['ItemCost'];
    });
    return (() => {
      const _el$ = createElement("Panel", {
          get ["class"]() {
            return classNames('GameItemTooltip', `Rarity_${getRarity()}`);
          }
        }, null);
        createElement("Panel", {
          "class": "BG"
      ...
      insert(_el$7, createComponent(Yzy_ItemName, {
        ...
        get text() {
          return $.Localize("#DOTA_TOOLTIP_ability_" + getItemName());
        }
      }), null);
      insert(_el$7, createComponent(Show, {
        get when() {
          return getItemCost() != undefined;
        },
        get children() {
          const _el$8 = createElement("Panel", {
            ...
            _el$9 = createElement("Panel", {
              get ["class"]() {
                return classNames('ResRow');
              },
              hittest: false
            }, _el$8),
            _el$0 = createElement("Image", {
              "class": "ResIcon",
              src: `file://{images}/custom_game/common/icon/icon_gold.png`,
          ...
          setProp(_el$0, "src", `file://{images}/custom_game/common/icon/icon_gold.png`);
          effect(_p$ => {
            const _v$ = classNames('ResRow'),
              _v$2 = getItemCost();
      ...
      insert(_el$10, createComponent(Show, {
        ...
        get children() {
          ...
          insert(_el$11, createComponent(Index, {
            ...
            children: (getKey, i) => {
              var _a;
              const sID = getKey().substring(3);
              const fVal = ((_a = getKv()) === null || _a === void 0 ? void 0 : _a['AbilityValues'][getKey()]) || 0;
      ...
      insert(_el$3, createComponent(Show, {
        get when() {
          return "#DOTA_TOOLTIP_ability_" + props.sItemName + "_Description" != $.Localize("#DOTA_TOOLTIP_ability_" + props.sItemName + "_Description");
        },
        get children() {
          return createComponent(Yzy_Description, {
            get text() {
              return ReplaceAbltVals(props.sItemName, "#DOTA_TOOLTIP_ability_" + props.sItemName + "_Description");
            }
          });
        }
      }), null);
      insert(_el$3, createComponent(Show, {
        get when() {
          return "#DOTA_TOOLTIP_ability_" + props.sItemName + "_Tips" != $.Localize("#DOTA_TOOLTIP_ability_" + props.sItemName + "_Tips");
        },
        get children() {
          const _el$12 = createElement("Label", {
            id: "TipDes",
            get text() {
              return ReplaceAbltVals(props.sItemName, "#DOTA_TOOLTIP_ability_" + props.sItemName + "_Tips");
            },
            html: true
          }, null);
          effect(_$p => setProp(_el$12, "text", ReplaceAbltVals(props.sItemName, "#DOTA_TOOLTIP_ability_" + props.sItemName + "_Tips"), _$p));
          return _el$12;
        }
      }), null);
      effect(_$p => setProp(_el$, "class", classNames('GameItemTooltip', `Rarity_${getRarity()}`), _$p));
      return _el$;
    })();
  }

  exports.GameItemTooltip = GameItemTooltip;
