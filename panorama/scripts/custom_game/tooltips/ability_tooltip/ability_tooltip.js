...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ability_tooltip = {}));
  ...
  */
  ...
  if ($.GetContextPanel().paneltype == 'TooltipContents') {
    ...
    $.GetContextPanel().SetPanelEvent("ontooltiploaded", () => {
      ...
      const {
        ...
        iEntID,
        bDebug
      } = (_a = GetTooltipParams('ability_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
      render(() => createComponent(AbilityTooltip, {
        sAbltName: sAbltName,
        iEntID: iEntID,
        bDebug: bDebug
      }), $.GetContextPanel());
  ...
  function AbilityTooltip(_a) {
    var _b, _c;
    var {
        sAbltName,
        iEntID = -1,
        iLevel = 1} = _a,
      args = __rest(_a, ["sAbltName", "iEntID", "iLevel", "bDebug"]);
    const tKv = (_b = AbilitiesKv[sAbltName]) !== null && _b !== void 0 ? _b : {};
    let iAbltID = -1;
    if (-1 != iEntID) {
      iAbltID = Entities.GetAbilityByName(iEntID, sAbltName);
      if (iLevel == 1 && -1 != iAbltID) {
        iLevel = Abilities.GetLevel(iAbltID);
      }
    }
    let sTitleAbltName = $.Localize('#DOTA_TOOLTIP_ability_' + sAbltName);
    const iRarity = tKv['Rarity'] || 0;
    ...
    for (const sKey in tKv.AbilityValues) {
      let sDescription = `#DOTA_TOOLTIP_ability_${sAbltName}_${sKey}`;
    ...
    const getAbltAffix = createMemo(() => {
      return (tSelectedAffix === null || tSelectedAffix === void 0 ? void 0 : tSelectedAffix.filter(v => {
        var _a;
        return ((_a = AbilitiesKv[v === null || v === void 0 ? void 0 : v.name]) === null || _a === void 0 ? void 0 : _a['AmpAblt']) == sAbltName;
      })) || [];
    });
    return (() => {
      const _el$ = createElement("Panel", args, null),
        _el$2 = createElement("Panel", {}, _el$),
        _el$3 = createElement("Panel", {}, _el$),
        _el$4 = createElement("Panel", {}, _el$3),
        _el$5 = createElement("Panel", {}, _el$4),
        _el$6 = createElement("DOTAAbilityImage", {
      ...
      spread(_el$, mergeProps(args, {
        get className() {
          return classNames('AbilityTooltip', args.className, 'Rarity_' + iRarity);
        }
      }), true);
      ...
      setProp(_el$6, "abilityname", sAbltName);
      setProp(_el$7, "text", sTitleAbltName);
      ...
      insert(_el$3, createComponent(Show, {
        get when() {
          return $.Localize(`#DOTA_TOOLTIP_ability_${sAbltName}_Description`) != `#DOTA_TOOLTIP_ability_${sAbltName}_Description`;
        },
        get children() {
          return createComponent(Yzy_Description, {
            name: sAbltName,
            get text() {
              return ReplaceAbltVals(sAbltName, `#DOTA_TOOLTIP_ability_${sAbltName}_Description`, {
                'level': iLevel,
        ...
        return () => _c$() ? (() => {
          ...
          insert(_el$1, () => Object.keys(tSpecials).map(sKey => {
            ...
            if (sDescription.search(/\[.*?\]/) != -1) {
              let s = ReplaceAbltVals(sAbltName, sDescription, {
                'level': iLevel,
                'count': getter_bAltDown()
              });
              let i = s.search(/[:：]/);
      ...
      insert(_el$3, createComponent(Show, {
        get when() {
          return ((_c = getAbltAffix()) === null || _c === void 0 ? void 0 : _c.length) >= 0;
        },
        get children() {
          ...
          insert(_el$9, createComponent(Index, {
            ...
            children: (getAffix, i) => {
              ...
              return (() => {
                ...
                effect(_p$ => {
                  const _v$ = getName(),
                    _v$2 = `(${iAbltAffixCount()}): `;
                  _v$ !== _p$._v$ && (_p$._v$ = setProp(_el$17, "text", _v$, _p$._v$));
                  _v$2 !== _p$._v$2 && (_p$._v$2 = setProp(_el$18, "text", _v$2, _p$._v$2));
                  return _p$;
                }, {
                  _v$: undefined,
                  _v$2: undefined
