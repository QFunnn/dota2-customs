...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.weapon_suit_tooltip = {}));
  ...
  */
  ...
  const CfgGetter_weapon_suit = useSystemConfig('weapon_suit');
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      iEntID
    } = (_a = GetTooltipParams('weapon_suit_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(WeaponSuitTooltip, {
      iEntID: iEntID
    }), $.GetContextPanel());
  });
  function WeaponSuitTooltip(props) {
    const [getSuit] = useDiyPolymer(() => props.iEntID, 'suit');
    const getSuitData = createMemo(() => {
      var _a, _b;
      return (_b = (_a = getSuit()) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.Suit;
    });
    const getLevel = createMemo(() => {
      var _a;
      return (_a = getSuitData()) === null || _a === void 0 ? void 0 : _a.level;
    });
    const getPart = createMemo(() => {
      var _a;
      return (_a = getSuitData()) === null || _a === void 0 ? void 0 : _a.part;
    });
    return (() => {
      const _el$ = createElement("Panel", {
          get ["class"]() {
            return classNames('WeaponSuitTooltip', 'Rarity_' + getLevel());
          }
        }, null);
        createElement("Panel", {
          "class": "BG"
        ...
        _el$8 = createElement("Label", {
          id: "TipDes",
          get text() {
            return memo(() => getLevel() <= 0)() ? $.Localize("#WeaponSuitNotActiveTipDes") : ReplaceTextVariable("#WeaponSuitActiveTipDes", {
              'val': getLevel()
            });
          },
          html: true
      ...
      insert(_el$7, createComponent(Index, {
        each: ['part_1', 'part_2', 'part_3', 'part_4', 'part_5', 'part_6'],
        children: (getName, i) => {
          var _a, _b;
          const getPartLevel = () => {
            var _a;
            return (_a = getPart()) === null || _a === void 0 ? void 0 : _a[getName()];
          };
          const getCfg = () => {
            var _a;
            return (_a = CfgGetter_weapon_suit()) === null || _a === void 0 ? void 0 : _a[getName()];
          };
          const getID = () => {
            var _a;
            return (_a = getCfg()) === null || _a === void 0 ? void 0 : _a['attribute_id'];
          };
          const getVal = () => {
            var _a, _b, _c;
            return (_c = (_b = (_a = getCfg()) === null || _a === void 0 ? void 0 : _a['attribute_val']) === null || _b === void 0 ? void 0 : _b.split('|')) === null || _c === void 0 ? void 0 : _c[getPartLevel() - 1];
          };
          return (() => {
            const _el$9 = createElement("Panel", {
              ...
              _el$10 = createElement("Panel", {
                get ["class"]() {
                  return classNames('PartImage', `Rarity_${getPartLevel()}`);
                }
              }, _el$1);
              createElement("Panel", {
                "class": "BG"
              }, _el$10);
              const _el$12 = createElement("Image", {
                get src() {
                  return memo(() => getPartLevel() > 0)() ? `file://{images}/custom_game/suit/${getName() + '_' + getPartLevel()}.png` : 'file://{images}/custom_game/suit/part.png';
                }
              }, _el$10),
              ...
              _el$14 = createElement("Label", {
                id: "Name",
                get ["class"]() {
                  return classNames(`Rarity_${getPartLevel()}`);
                },
                get text() {
                  return memo(() => getPartLevel() > 0)() ? ReplaceTextVariable('#suit_' + getName() + '_level', {
                    'val': getPartLevel()
                  }) : '#suit_' + getName();
                },
                html: true
              ...
              get children() {
                const _el$15 = createElement("Panel", {
                  ...
                  _el$16 = createElement("Label", {
                    "class": "Name",
                    get text() {
                      return $.Localize('#' + getID());
                    }
                  }, _el$15),
                  _el$17 = createElement("Label", {
                    "class": "Value",
                    get text() {
                      return `+${getVal()}${(_b = PctUnitAttributes[(_a = ID2Attribute[getID()]) === null || _a === void 0 ? void 0 : _a.name]) !== null && _b !== void 0 ? _b : ''}`;
                    },
                    html: true
                  }, _el$15);
                effect(_p$ => {
                  const _v$3 = $.Localize('#' + getID()),
                    _v$4 = `+${getVal()}${(_b = PctUnitAttributes[(_a = ID2Attribute[getID()]) === null || _a === void 0 ? void 0 : _a.name]) !== null && _b !== void 0 ? _b : ''}`;
                  _v$3 !== _p$._v$3 && (_p$._v$3 = setProp(_el$16, "text", _v$3, _p$._v$3));
            ...
            effect(_p$ => {
              const _v$5 = classNames('PartImage', `Rarity_${getPartLevel()}`),
                _v$6 = memo(() => getPartLevel() > 0)() ? `file://{images}/custom_game/suit/${getName() + '_' + getPartLevel()}.png` : 'file://{images}/custom_game/suit/part.png',
                _v$7 = classNames(`Rarity_${getPartLevel()}`),
                _v$8 = memo(() => getPartLevel() > 0)() ? ReplaceTextVariable('#suit_' + getName() + '_level', {
                  'val': getPartLevel()
                }) : '#suit_' + getName();
              _v$5 !== _p$._v$5 && (_p$._v$5 = setProp(_el$10, "class", _v$5, _p$._v$5));
              _v$6 !== _p$._v$6 && (_p$._v$6 = setProp(_el$12, "src", _v$6, _p$._v$6));
              _v$7 !== _p$._v$7 && (_p$._v$7 = setProp(_el$14, "class", _v$7, _p$._v$7));
              _v$8 !== _p$._v$8 && (_p$._v$8 = setProp(_el$14, "text", _v$8, _p$._v$8));
              return _p$;
            }, {
              _v$5: undefined,
              _v$6: undefined,
      ...
      effect(_p$ => {
        const _v$ = classNames('WeaponSuitTooltip', 'Rarity_' + getLevel()),
          _v$2 = memo(() => getLevel() <= 0)() ? $.Localize("#WeaponSuitNotActiveTipDes") : ReplaceTextVariable("#WeaponSuitActiveTipDes", {
            'val': getLevel()
          });
  ...
  exports.WeaponSuitTooltip = WeaponSuitTooltip;
