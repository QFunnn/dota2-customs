...
(function (factory) {
  ...
  */
  ...
  $.GetContextPanel().SetPanelEvent('ontooltiploaded', () => {
    ...
    const {
      sCardName
    } = (_a = GetTooltipParams('card_tooltip', $.GetContextPanel())) !== null && _a !== void 0 ? _a : {};
    render(() => createComponent(CardTooltip, {
      sCardName: sCardName
    }), $.GetContextPanel());
  });
  function CardTooltip({
    ...
    const getKv = () => AbilitiesKv[sCardName];
    ...
    const getDescription = () => {
      if ($.Localize('#' + sCardName + '_Description') != '#' + sCardName + '_Description') {
        return ReplaceAbltVals(sCardName, $.Localize("#" + sCardName + '_Description'));
      }
    };
    const getCombinationName = () => {
      ...
      return ((_c = getKv()) === null || _c === void 0 ? void 0 : _c['Tag']).split(',')[1] || ((_d = getKv()) === null || _d === void 0 ? void 0 : _d['Tag']).split(',')[0];
    };
    ...
    return (() => {
      ...
      insert(_el$6, createComponent(Yzy_ItemImage, {
        name: sCardName
      }), _el$7);
        ...
        get children() {
          ...
          insert(_el$8, createComponent(Show, {
            ...
            get children() {
              ...
              effect(_$p => setProp(_el$0, "text", `(${getActiveCombinationCount()}/${getCombinationList().length})`, _$p));
              return _el$0;
            }
          }), null);
          effect(_$p => setProp(_el$9, "text", '#' + getCombinationName(), _$p));
          return _el$8;
        }
      }), null);
      insert(_el$1, createComponent(Show, {
        ...
        get children() {
          ...
          insert(_el$10, () => Object.values(getAttributeValues()).map((sKey, i) => {
            var _a, _b, _c, _d, _e;
              ...
              get children() {
                return createComponent(Show, {
                  ...
                  get children() {
                    ...
                    effect(_$p => setProp(_el$14, "text", `(${GetCardExtractPct()}${(_e = PctUnitAttributes[(_d = ID2Attribute[sAttributeID]) === null || _d === void 0 ? void 0 : _d.name]) !== null && _e !== void 0 ? _e : ''})`, _$p));
                    return _el$14;
                  }
                });
              }
        ...
        get children() {
          ...
          insert(_el$11, createComponent(Show, {
            ...
            get children() {
              ...
              insert(_el$13, () => Object.values(getCombinationAttributeValues()).map((sKey, i) => {
                var _a, _b, _c;
                const sAttributeID = sKey.substring(3);
