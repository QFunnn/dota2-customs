...
function _ScoreboardUpdater_UpdatePlayerPanel( scoreboardConfig, playersContainer, playerId, localPlayerTeamId )
{
	...
	if ( playerInfo )
	{
        ...
        // goldValue использует значение из серверной статистики
    ...
    //            var score_change_type=end_game_data['score_change_type'][steam_id] //1 плюс, 2 минус, 0 без изменений
    //            /**
...
//	$.Msg( "_ScoreboardUpdater_UpdateAllTeamsAndPlayers: ", scoreboardConfig );
	...
	for ( var teamId of Game.GetAllTeamIDs() )
	{
        ...
        //итоговое место команды (сначала по месту; если все места 0 — по золоту)
