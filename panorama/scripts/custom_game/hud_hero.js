...
if (!isSpectator()) {
  ...
  const useHeroDetail = props => {
    ...
    const previewHeroCosmeticList = libs.createMemo(() => {
      ...
      const coloring_list = [];
      list.forEach((data, _) => {
        if (data.cosmeticID == TERRORBLADE_ULTIMATE_SKIN_ID) {
          return;
        }
    ...
    const getPrevewSkinID = id => {
      if (id == TERRORBLADE_ULTIMATE_SKIN_ID) {
    ...
    const isEquip = (cosmeticID, isShelf = false) => {
      ...
      if (isShelf && cosmeticID == TERRORBLADE_BASE_SKIN_ID) {
        return local.player_skin[TERRORBLADE_BASE_SKIN_ID]?.equip == 1 || local.player_skin[TERRORBLADE_ULTIMATE_SKIN_ID]?.equip == 1;
      }
    ...
    const isTerrorbladeSkinPreview = libs.createMemo(() => previewSkinID() == TERRORBLADE_BASE_SKIN_ID);
    const ownsTerrorbladeBaseSkin = libs.createMemo(() => local.player_skin[TERRORBLADE_BASE_SKIN_ID] != undefined);
    const ownsTerrorbladeUltimateSkin = libs.createMemo(() => local.player_skin[TERRORBLADE_ULTIMATE_SKIN_ID] != undefined);
    const equippedTerrorbladeTransformation = libs.createMemo(() => {
      if (equippedID() == TERRORBLADE_ULTIMATE_SKIN_ID) {
        return 'ultimate';
      }
      if (equippedID() == TERRORBLADE_BASE_SKIN_ID) {
        return 'normal';
      }
    });
    ...
    libs.createEffect(libs.on([previewSkinID, terrorbladeTransformation], ([_previewSkinID, transformation]) => {
      if (_previewSkinID == TERRORBLADE_BASE_SKIN_ID) {
        setPreviewing(TERRORBLADE_TRANSFORMATION_SCENES[transformation]);
        return;
      }
    ...
    return {
      ...
      setPreviewSkinID,
      hasReward,
      isTerrorbladeSkinPreview,
      terrorbladeTransformation,
      equippedTerrorbladeTransformation,
      ownsTerrorbladeBaseSkin,
      ownsTerrorbladeUltimateSkin,
      previewTerrorbladeTransformation
    };
  };
        ...
        return [libs.createComponent(libs.Show, {
          ...
          get children() {
            return libs.createComponent(EOM_Panel.EOM_Panel, {
              ref: scene,
              id: "Preview3D",
              className: "TerrorbladePreviewViewport",
              width: "900px",
              height: "1000px",
              x: "-58px",
              align: "center center",
              get children() {
                ...
                libs.setProp(_el$7, "className", "TerrorbladeMainPreview");
                libs.setProp(_el$7, "yawmin", -160);
                libs.effect(_$p => libs.setProp(_el$7, "map", previewing(), _$p));
                return _el$7;
              }
            });
          }
          ...
          get children() {
            return [libs.createComponent(libs.Show, {
              ...
              const _el$8 = libs.createElement("Panel", {
                ...
                _el$11 = libs.createElement("Panel", {}, _el$9),
                _el$12 = libs.createElement("Image", {}, _el$11),
                _el$13 = libs.createElement("Panel", {}, _el$11),
                _el$14 = libs.createElement("Panel", {}, _el$9),
                _el$15 = libs.createElement("Image", {}, _el$14),
                _el$16 = libs.createElement("Panel", {}, _el$14),
                _el$17 = libs.createElement("Panel", {}, _el$9),
                _el$18 = libs.createElement("Image", {}, _el$17),
                _el$19 = libs.createElement("Panel", {}, _el$17);
              ...
              libs.insert(_el$8, libs.createComponent(EOM_Separator.EOM_Separator, {
                marginLeft: "-30px"
              }), _el$9);
              libs.insert(_el$8, libs.createComponent(EOM_Panel.EOM_Panel, {
              ...
              libs.setProp(_el$0, "className", "AttributeRow");
              libs.setProp(_el$0, "tooltip_text", "#Tooltip_Attribute_Attack");
              libs.setProp(_el$1, "className", "AttributeIcon Attack");
              libs.setProp(_el$10, "className", "AttributeValue");
              libs.insert(_el$10, libs.createComponent(GenericPanel.CLabel, {
                get text() {
                  return KeyValues.UnitsKv[hero_name()]?.AttackDamage ?? '';
                }
              }));
              libs.setProp(_el$11, "className", "AttributeRow");
              libs.setProp(_el$11, "tooltip_text", "#Tooltip_Attribute_Attackspeed");
              libs.setProp(_el$12, "className", "AttributeIcon AttackSpeed");
              libs.setProp(_el$13, "className", "AttributeValue");
              ...
              libs.setProp(_el$14, "className", "AttributeRow");
              libs.setProp(_el$14, "tooltip_text", "#Tooltip_Attribute_CritChance");
              libs.setProp(_el$15, "className", "AttributeIcon Crit");
              libs.setProp(_el$16, "className", "AttributeValue");
              libs.insert(_el$16, libs.createComponent(GenericPanel.CLabel, {
                get text() {
                  return KeyValues.UnitsKv[hero_name()]?.PhysicalCritChance ?? '';
                }
              }));
              libs.setProp(_el$17, "className", "AttributeRow");
              libs.setProp(_el$17, "tooltip_text", "#Tooltip_Attribute_Evasion");
              libs.setProp(_el$18, "className", "AttributeIcon Evade");
              libs.setProp(_el$19, "className", "AttributeValue");
              ...
              libs.insert(_el$8, libs.createComponent(EOM_Panel.EOM_Panel, {
                ...
                get children() {
                  return [libs.createComponent(libs.Show, {
                    ...
                    id: "SkinName",
                    get text() {
                      return libs.memo(() => !!isTerrorbladeSkinPreview())() ? `#${TERRORBLADE_BASE_SKIN_ID}` : `#${previewing()}`;
                    }
                  }), libs.createComponent(EOM_Separator.EOM_Separator, {
                    marginLeft: "-30px",
                    size: 'short'
                    ...
                    get text() {
                      return (() => {
                        if (isTerrorbladeSkinPreview()) {
                          return `#${TERRORBLADE_BASE_SKIN_ID}_description`;
                        }
              ...
              get children() {
                return libs.createComponent(EOM_Panel.EOM_Panel, {
                  id: "TerrorbladeTransformationSelector",
                  get children() {
                    return libs.createComponent(EOM_Panel.EOM_Panel, {
                      ...
                      children: (cosmeticData, index) => {
                        ...
                        return libs.createComponent(CosmeticCard.HeroCosmeticCard, {
                          ...
                          onactivate: () => {
                            ...
                            if (cosmeticData().cosmeticID != TERRORBLADE_BASE_SKIN_ID && !isLocked(cosmeticData().cosmeticID) && !equipped()) {
                              callAction('ornament_equip', {
                                hid: hero_id(),
              ...
              get children() {
                return [libs.createComponent(libs.Show, {
                  ...
                  get children() {
                    ...
                    libs.insert(_el$22, libs.createComponent(EOM_Image.EOM_Image, {
                      className: "ProductImage Invalid",
                      tooltip_text: "#comingSoon"
                    }));
                    libs.effect(_$p => libs.setProp(_el$22, "className", libs.classNames("ProductItem", "Rarity" + props.reward_data.rarity), _$p));
                    return _el$22;
                  }
