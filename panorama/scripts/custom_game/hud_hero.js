  ...
  return (() => {
    ...
    libs.effect(_p$ => {
      const _v$3 = "#courier_ability_" + props.type,
        ...
        _v$5 = getKeyValueDescription(GetLocalization("#DOTA_Tooltip_ability_" + props.abilityName + "_Description", ""), abilityValues(), {
          level: props.abilityLevel
        });
...
const CourierFishExplore = props => {
  ...
  return (() => {
    ...
    libs.setProp(_el$15, "width", "160px");
    libs.setProp(_el$15, "verticalAlign", "center");
  ...
  return libs.createComponent(EOM_MenuLayout.EOM_MenuLayout_Content, {
    ...
    get children() {
      const _el$19 = libs.createElement("Panel", {
        ...
        _el$21 = libs.createElement("DOTAParticleScenePanel", {
      ...
      typeof _ref$ === "function" ? libs.use(_ref$, _el$21) : courierUpgradeParticle = _el$21;
      ...
      libs.setProp(_el$22, "align", "center bottom");
      libs.setProp(_el$22, "marginBottom", "105px");
      ...
      libs.setProp(_el$27, "marginLeft", "15px");
      libs.setProp(_el$27, "width", "311px");
      ...
      libs.insert(_el$29, libs.createComponent(libs.Index, {
        each: STAR_LEVELS,
        children: star => {
      ...
      libs.setProp(_el$33, "width", "160px");
      ...
      libs.insert(_el$36, libs.createComponent(libs.Show, {
        ...
        get children() {
          ...
          libs.setProp(_el$37, "marginLeft", "31px");
          libs.setProp(_el$38, "flowChildren", "right");
          libs.setProp(_el$38, "horizontalAlign", "center");
          libs.insert(_el$38, libs.createComponent(Player.CurrencyIcon, {
            id: "UpgradeCostIcon",
            get tokenID() {
          ...
          libs.effect(_$p => libs.setProp(_el$39, "text", ` X<font color='${UPGRADE_COST <= courierExp() ? "#B6A391" : "#ec5b51"}'>${UPGRADE_COST}</font>`, _$p));
          return _el$37;
        }
      }), null);
      libs.effect(_p$ => {
        const _v$8 = sortCourierList().length > 6,
          _v$9 = `${currentPage()}/${totalPage()}`,
          _v$0 = "Rarity" + serviceCourierCfg().quality,
          _v$1 = "#" + courierID(),
          _v$10 = "#" + courierID() + "_access";
        _v$8 !== _p$._v$8 && (_p$._v$8 = libs.setProp(_el$24, "visible", _v$8, _p$._v$8));
        _v$9 !== _p$._v$9 && (_p$._v$9 = libs.setProp(_el$24, "text", _v$9, _p$._v$9));
        _v$0 !== _p$._v$0 && (_p$._v$0 = libs.setProp(_el$27, "className", _v$0, _p$._v$0));
        _v$1 !== _p$._v$1 && (_p$._v$1 = libs.setProp(_el$27, "text", _v$1, _p$._v$1));
        _v$10 !== _p$._v$10 && (_p$._v$10 = libs.setProp(_el$35, "text", _v$10, _p$._v$10));
        return _p$;
      }, {
        _v$8: undefined,
        _v$9: undefined,
      ...
      libs.insert(_el$2, libs.createComponent(libs.For, {
        ...
        children: (heroName, index) => {
          ...
          return (() => {
            ...
            libs.setProp(_el$15, "marginTop", "26px");
            libs.insert(_el$15, libs.createComponent(hero_card.HeroCard, {
              heroName: heroName,
              get selected() {
                return previewHeroName() == heroName;
              },
                ...
                return (() => {
                  ...
                  libs.insert(_el$24, libs.createComponent(libs.For, {
                    ...
                    children: (_, starIndex) => (() => {
                      ...
                      libs.effect(_$p => libs.setProp(_el$27, "classList", {
