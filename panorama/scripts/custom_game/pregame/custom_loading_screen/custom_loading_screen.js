...
(function (factory) {
  ...
  const { render: _render, createComponent, createElement, insert, setProp} = createRenderer({
  ...
  function ChatPanel() {
    return (() => {
      const _el$10 = createElement("Panel", {
        ...
        _el$11 = createElement("GenericPanel", {
          type: "DOTAChat",
          id: "CustomChat",
          "class": "PreGameChat",
  ...
  var _a, _b;
  function LoginPanelRoot() {
    return (() => {
      const _el$ = createElement("Panel", {
        id: "LoginPanelRoot",
        hittest: false
      }, null);
      insert(_el$, createComponent(LoadingPanel, {}), null);
      insert(_el$, createComponent(LogoPanel, {}), null);
      insert(_el$, createComponent(ChatPanel, {}), null);
      return _el$;
    })();
  }
  try {
    render(() => createComponent(LoginPanelRoot, {}), $('#LoginPanelRoot'));
  } catch (error) {}
  {
    let pLoadingScreenRoot = (_b = (_a = $.GetContextPanel()) === null || _a === void 0 ? void 0 : _a.GetParent()) === null || _b === void 0 ? void 0 : _b.GetParent();
    let pLoadingScreenChat = pLoadingScreenRoot.FindChildTraverse("LoadingScreenChat");
    if (pLoadingScreenChat) {
      pLoadingScreenChat.style.opacity = '0';
    }
  }
