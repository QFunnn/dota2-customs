...
config.SealingAbilitiesKv = new Set([
...
config.ReflectionAbilitiesKv = new Set([
...
config.AbilitiesPool = {
    ...
    "crystal_maiden": {
        ...
        "crystal_maiden_freezing_field": {
            "crystal_maiden_freezing_field_stop": 0
        }
    },
    "puck": {
        "1": "puck_illusory_orb",
    ...
    "brewmaster": {
        ...
        "3": "brewmaster_cinder_brew",
        "4": "brewmaster_drunken_brawler",
    ...
    "gyrocopter": {
        ...
        "3": "gyrocopter_flak_cannon",
        "4": "gyrocopter_call_down",
    },
    "tinker": {
        "1": "tinker_laser",
        "2": "tinker_march_of_the_machines",
        "3": "tinker_heat_seeking_missile_lua",
        "4": "tinker_deploy_turrets",
        "5": "tinker_rearm_lua",
    },
    "furion": {
        "1": "furion_sprout",
    ...
    "elder_titan": {
        ...
        // 	"elder_titan_ancestral_spirit": 0,
        // 	"elder_titan_return_spirit": 0,
        // },
    },
    "legion_commander": {
    ...
    "skeleton_king": {
        ...
        "2": "skeleton_king_vampiric_aura_lua",
    ...
    "night_stalker": {
        ...
        //"3": "night_stalker_hunter_in_the_night_lua",
    ...
    "broodmother": {
        ...
        "3": "broodmother_incapacitating_bite",
    ...
    "invoker": {
        "1": "invoker_forge_spirit_ad",
        "2": "invoker_deafening_blast_ad",
        "3": "invoker_chaos_meteor_ad",
        "4": "invoker_alacrity_ad",
        "5": "invoker_ice_wall_ad",
        "6": "invoker_tornado_ad",
        "7": "invoker_emp_ad",
        "8": "invoker_sun_strike_ad",
        "9": "invoker_cold_snap_ad",
        "10": "invoker_ghost_walk_ad",
    },
    "obsidian_destroyer": {
    ...
    "treant": {
        "1": "treant_natures_grasp",
        "2": "treant_leech_seed",
        "3": "treant_living_armor",
        "4": "treant_overgrowth",
    },
    "test": {
        "1": "test_kill_one",
        "2": "test_kill_all_neutral"
    }
};
config.HeroListKv = {
