...
const ExchangeItem = props => {
  const [local, others] = libs.splitProps(props, ["children", "owned", "previewing_id", "onPreview", "endTime", "onCancelPreview", "enable", "storeItem", "cosmetic_id", "isToolMode", "purchased_num", "OnBuy", "cosmeticTag"]);
