...
LinkLuaModifier(
	...
	"abilities/drow_ranger_frost_arrows_custom",
...
function drow_ranger_frost_arrows_custom:OnOrbImpact(params)
	...
	if self:GetCaster():HasScepter() then
		params.target:AddNewModifier(
			...
			self,
			"modifier_drow_ranger_frost_arrows_custom_debuff",
			{ duration = self:GetSpecialValueFor("shard_burst_slow_duration") }
		)
	end
end
...
function modifier_drow_ranger_frost_arrows_custom_orb:AttackModifier(params)
...
function modifier_drow_ranger_frost_arrows_custom_orb:GetModifierProcAttack_BonusDamage_Physical(params)
	...
	if self.records[params.record] then
		local bonus = 0
		local modifier_drow_ranger_frost_arrows_custom_debuff =
			params.target:FindModifierByName("modifier_drow_ranger_frost_arrows_custom_debuff")
		if modifier_drow_ranger_frost_arrows_custom_debuff then
			bonus = modifier_drow_ranger_frost_arrows_custom_debuff:GetStackCount()
				* self.ability:GetSpecialValueFor("shard_bonus_damage_per_stack")
		end
