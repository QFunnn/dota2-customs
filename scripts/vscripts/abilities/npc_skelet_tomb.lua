...
function npc_skelet_tomb:OnSpellStart()
	...
	local new_tomb = CreateUnitByName(
		"npc_skelet_tomb",
	...
	new_tomb.host_team = self:GetCaster().host_team
	new_tomb:AddNewModifier(nil, nil, "modifier_waveupgrade", {})
end

modifier_tomb_thinker = class({})

function modifier_tomb_thinker:IsHidden()
	return true
end

function modifier_tomb_thinker:IsPurgable()
	return false
end
...
function modifier_tomb_thinker:GetAuraEntityReject(hTarget)
	return hTarget:GetUnitName() == "npc_skelet_tomb" or hTarget.player_unit
end
...
function modifier_skelet_tomb:IsHidden()
	return false
end
function modifier_skelet_tomb:IsPurgable()
	return false
end
...
function modifier_skelet_tomb_cd:IsHidden()
	return false
end
function modifier_skelet_tomb_cd:IsPurgable()
	return false
end