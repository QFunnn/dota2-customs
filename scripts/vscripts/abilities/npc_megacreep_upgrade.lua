...
function modifier_megacreep_passive:IsHidden()
	return true
end
function modifier_megacreep_passive:IsPurgable()
	return false
end
...
function modifier_megacreep_passive:DeathEvent(param)
...
function modifier_megacreep_buf:IsPurgable()
	return false
end
...
function modifier_megacreep_buf:OnTooltip2()
	return self:GetAbility():GetSpecialValueFor("health") * self:GetStackCount()
end
