...
function npc_boar_spit:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_boar_cd", { duration = self:GetCooldownTimeRemaining() })
...
function modifier_boar_cd:IsHidden()
	return false
end
function modifier_boar_cd:IsPurgable()
	return false
end