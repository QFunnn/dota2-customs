...
function modifier_megacreep_bad_passive:IsHidden()
	return true
end
...
function modifier_megacreep_bad_debuf:IsPurgable()
	return false
end
...
function modifier_megacreep_bad_debuf:OnTooltip()
	return self:GetStackCount()
		* self:GetAbility():GetSpecialValueFor("damage")
