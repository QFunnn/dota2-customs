...
function npc_troll_summon:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_troll_cd", { duration = self:GetCooldownTimeRemaining() })
	self:GetCaster():EmitSound("n_creep_TrollWarlord.RaiseDead")
...
function modifier_troll_cd:IsHidden()
	return false
end
function modifier_troll_cd:IsPurgable()
	return false
end