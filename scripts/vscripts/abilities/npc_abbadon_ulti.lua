...
function modifier_abbadon_passive:DamageEvent_inc(params)
	...
	if self.parent:HasModifier("modifier_abbadon_cd") then
		return
	end
...
function modifier_abbadon_buff:IsHidden()
	return false
end
function modifier_abbadon_buff:IsPurgable()
	return false
end
...
function modifier_abbadon_buff:GetEffectAttachType()
...
function modifier_abbadon_cd:IsHidden()
	return false
end
function modifier_abbadon_cd:IsPurgable()
	return false
end
function modifier_abbadon_cd:IsDebuff()
	return true
end