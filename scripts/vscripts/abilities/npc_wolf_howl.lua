...
function npc_wolf_howl:OnSpellStart()
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_wolf_cd", { duration = self:GetCooldownTimeRemaining() })
...
function modifier_wolf_howl:IsHidden()
	return true
end

function modifier_wolf_howl:IsPurgable()
	return false
end
...
function modifier_wolf_howl_buff:IsPurgable()
	return false
end
...
function modifier_wolf_cd:IsHidden()
	return false
end
function modifier_wolf_cd:IsPurgable()
	return false
end