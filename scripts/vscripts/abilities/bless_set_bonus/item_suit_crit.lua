...
local a = "abilities/bless_set_bonus/item_suit_crit"
...
local j = i.EOMItem
local k = c()
k.name = "item_suit_crit"
d(k, j)
function k.prototype.OnCreated(self)
	self.particleID =
		ParticleManager:CreateParticle("particles/generic_gameplay/suit_crit.vpcf", PATTACH_CUSTOMORIGIN, nil)
