...
local a = "abilities/trait/trait_107"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_107"
end
n = e({ j(nil) }, n)
g.trait_107 = n
g.modifier_trait_107 = c()
local v = g.modifier_trait_107
v.name = "modifier_trait_107"
d(v, l)
...
function v.prototype.OnTraitInit(self, w)
	...
	w.hero:RemoveModifierByName("modifier_trait_107_buff")
	w.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_107_buff", {})
end
...
g.modifier_trait_107 = v
g.modifier_trait_107_buff = c()
local x = g.modifier_trait_107_buff
x.name = "modifier_trait_107_buff"
d(x, l)
...
function x.prototype.OnFuryGained(self, w)
