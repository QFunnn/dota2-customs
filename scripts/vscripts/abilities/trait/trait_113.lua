...
local a = "abilities/trait/trait_113"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_113"
end
n = e({ j(nil) }, n)
g.trait_113 = n
g.modifier_trait_113 = c()
local o = g.modifier_trait_113
o.name = "modifier_trait_113"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_113_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_113_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_113 = o
g.modifier_trait_113_buff = c()
local t = g.modifier_trait_113_buff
t.name = "modifier_trait_113_buff"
d(t, l)
...
function t.prototype.EDeclareFunctions(self)
	return { EOMModifierFunction.EOM_MODIFIER_PROPERTY_ICE_STACK_BONUS }
end
function t.prototype.EOM_GetModifierIceStackBonus(self, p)
