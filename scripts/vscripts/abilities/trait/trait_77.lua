...
local a = "abilities/trait/trait_77"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_77"
end
n = e({ j(nil) }, n)
g.trait_77 = n
g.modifier_trait_77 = c()
local o = g.modifier_trait_77
o.name = "modifier_trait_77"
d(o, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddAbilityMechanicsUpgrade(
			q,
			{
				...
				id = "80_effect_1",
				values = { effect_1 = self.stun_duration },
				description = "80_effect_1",
			}
		)
		local s = "80"
		do
