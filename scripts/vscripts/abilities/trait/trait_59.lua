...
local a = "abilities/trait/trait_59"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_59"
end
n = e({ j(nil) }, n)
g.trait_59 = n
g.modifier_trait_59 = c()
local o = g.modifier_trait_59
o.name = "modifier_trait_59"
d(o, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddAbilityMechanicsUpgrade(
			q,
			{
				...
				id = "183_effect_1",
				values = { crit_bonus = self.crit_bonus, max_stack = self.max_stack },
				description = "183_effect_1",
			}
		)
		do
			local t = 0
