...
local a = "abilities/trait/trait_99"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_99"
end
n = e({ j(nil) }, n)
g.trait_99 = n
g.modifier_trait_99 = c()
local o = g.modifier_trait_99
o.name = "modifier_trait_99"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_99_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_99_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_99 = o
g.modifier_trait_99_buff = c()
local u = g.modifier_trait_99_buff
u.name = "modifier_trait_99_buff"
d(u, l)
