...
local a = "abilities/trait/trait_114"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_114"
end
n = e({ j(nil) }, n)
g.trait_114 = n
g.modifier_trait_114 = c()
local o = g.modifier_trait_114
o.name = "modifier_trait_114"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_114_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_114_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_114 = o
g.modifier_trait_114_buff = c()
local t = g.modifier_trait_114_buff
t.name = "modifier_trait_114_buff"
d(t, l)
...
function t.prototype.EOM_GetModifierShieldStackBonus(self, p)
