...
local a = "abilities/trait/trait_116"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_116"
end
n = e({ j(nil) }, n)
g.trait_116 = n
g.modifier_trait_116 = c()
local o = g.modifier_trait_116
o.name = "modifier_trait_116"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_116_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_116_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_116 = o
g.modifier_trait_116_buff = c()
local t = g.modifier_trait_116_buff
t.name = "modifier_trait_116_buff"
d(t, l)
...
function t.prototype.EOM_GetModifierHeal_Bonus(self, p)
