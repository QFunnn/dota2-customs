...
local a = "abilities/trait/trait_78"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_78"
end
n = e({ j(nil) }, n)
g.trait_78 = n
g.modifier_trait_78 = c()
local o = g.modifier_trait_78
o.name = "modifier_trait_78"
d(o, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddAbilityMechanicsUpgrade(
			q,
			{
				...
				id = "trait_78",
				values = { trait_78 = self.guard_hp },
				description = "trait_78",
			}
		)
		local s = "118"
		do
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_78_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_78_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_78 = o
g.modifier_trait_78_buff = c()
local v = g.modifier_trait_78_buff
v.name = "modifier_trait_78_buff"
d(v, l)
