...
local a = "abilities/trait/trait_73"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_73"
end
n = e({ j(nil) }, n)
g.trait_73 = n
g.modifier_trait_73 = c()
local o = g.modifier_trait_73
o.name = "modifier_trait_73"
d(o, l)
...
function o.prototype.SaveStack(self, q)
	...
	PlayerData:saveData(r, "trait_73", q)
end
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_73_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_73_buff", {})
end
...
g.modifier_trait_73 = o
g.modifier_trait_73_buff = c()
local s = g.modifier_trait_73_buff
s.name = "modifier_trait_73_buff"
d(s, l)
...
function s.prototype.LoadStack(self)
	local r = self:GetParent():GetPlayerOwnerID()
	local t = PlayerData:loadData(r, "trait_73")
	if t == nil then
		t = 0
	end
	return t
