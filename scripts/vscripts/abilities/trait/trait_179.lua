...
local a = "abilities/trait/trait_179"
...
local n = "sect_attack"
local o = "item_attackspeed"
g.trait_179 = c()
local p = g.trait_179
p.name = "trait_179"
d(p, i)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_179"
end
p = e({ j(nil) }, p)
g.trait_179 = p
g.modifier_trait_179 = c()
local q = g.modifier_trait_179
q.name = "modifier_trait_179"
d(q, l)
