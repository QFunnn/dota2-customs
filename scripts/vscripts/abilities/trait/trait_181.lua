...
local a = "abilities/trait/trait_181"
...
local n = "sect_chaos"
local o = "item_chaos_damage_bonus"
g.trait_181 = c()
local p = g.trait_181
p.name = "trait_181"
d(p, i)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_181"
end
p = e({ j(nil) }, p)
g.trait_181 = p
g.modifier_trait_181 = c()
local q = g.modifier_trait_181
q.name = "modifier_trait_181"
d(q, l)
