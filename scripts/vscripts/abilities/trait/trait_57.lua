...
local a = "abilities/trait/trait_57"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_57"
end
n = e({ j(nil) }, n)
g.trait_57 = n
g.modifier_trait_57 = c()
local o = g.modifier_trait_57
o.name = "modifier_trait_57"
d(o, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddAbilityMechanicsUpgrade(
			q,
			{
				...
				id = "trait_57",
				values = { trait_57 = self.hp_percent },
				description = "trait_57",
			}
		)
	end
end
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_57_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_57_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_57 = o
g.modifier_trait_57_buff = c()
local s = g.modifier_trait_57_buff
s.name = "modifier_trait_57_buff"
d(s, l)
