...
local a = "abilities/trait/trait_175"
...
local n = "sect_injury"
local o = "item_injury_count"
g.trait_175 = c()
local p = g.trait_175
p.name = "trait_175"
d(p, i)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_175"
end
p = e({ j(nil) }, p)
g.trait_175 = p
g.modifier_trait_175 = c()
local q = g.modifier_trait_175
q.name = "modifier_trait_175"
d(q, l)
