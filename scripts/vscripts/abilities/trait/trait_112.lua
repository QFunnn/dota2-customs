...
local a = "abilities/trait/trait_112"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_112"
end
n = e({ j(nil) }, n)
g.trait_112 = n
g.modifier_trait_112 = c()
local o = g.modifier_trait_112
o.name = "modifier_trait_112"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_112_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_112_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_112 = o
g.modifier_trait_112_buff = c()
local t = g.modifier_trait_112_buff
t.name = "modifier_trait_112_buff"
d(t, l)
...
function t.prototype.EDeclareFunctions(self)
	return { EOMModifierFunction.EOM_MODIFIER_PROPERTY_FURY_STACK_BONUS }
end
function t.prototype.EOM_GetModifierFuryStackBonus(self, p)
