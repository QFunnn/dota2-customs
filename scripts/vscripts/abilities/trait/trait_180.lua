...
local a = "abilities/trait/trait_180"
...
local n = "sect_poison"
local o = "item_poison_count"
g.trait_180 = c()
local p = g.trait_180
p.name = "trait_180"
d(p, i)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_180"
end
p = e({ j(nil) }, p)
g.trait_180 = p
g.modifier_trait_180 = c()
local q = g.modifier_trait_180
q.name = "modifier_trait_180"
d(q, l)
