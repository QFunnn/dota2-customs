...
local a = "abilities/trait/trait_69"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_69"
end
n = e({ j(nil) }, n)
g.trait_69 = n
g.modifier_trait_69 = c()
local o = g.modifier_trait_69
o.name = "modifier_trait_69"
d(o, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddAbilityMechanicsUpgrade(
			q,
			{
				...
				id = "114_effect_1",
				values = { effect_1 = self.percent },
				description = "114_effect_1",
			}
		)
		local s = "114"
		do
