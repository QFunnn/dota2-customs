...
local a = "abilities/trait/trait_178"
...
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_178"
end
p = e({ j(nil) }, p)
g.trait_178 = p
g.modifier_trait_178 = c()
local q = g.modifier_trait_178
q.name = "modifier_trait_178"
d(q, l)
