...
local a = "abilities/trait/trait_117"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_117"
end
n = e({ j(nil) }, n)
g.trait_117 = n
g.modifier_trait_117 = c()
local o = g.modifier_trait_117
o.name = "modifier_trait_117"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_117_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_117_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_117 = o
g.modifier_trait_117_buff = c()
local t = g.modifier_trait_117_buff
t.name = "modifier_trait_117_buff"
d(t, l)
...
function t.prototype.EDeclareFunctions(self)
	return { EOMModifierFunction.EOM_MODIFIER_PROPERTY_POISON_STACK_BONUS }
end
function t.prototype.EOM_GetModifierPoisonStackBonus(self, p)
