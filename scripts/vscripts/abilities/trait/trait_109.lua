...
local a = "abilities/trait/trait_109"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_109"
end
n = e({ j(nil) }, n)
g.trait_109 = n
g.modifier_trait_109 = c()
local v = g.modifier_trait_109
v.name = "modifier_trait_109"
d(v, l)
...
function v.prototype.OnTraitInit(self, w)
	...
	w.hero:RemoveModifierByName("modifier_trait_109_buff")
	w.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_109_buff", {})
end
...
g.modifier_trait_109 = v
g.modifier_trait_109_buff = c()
local x = g.modifier_trait_109_buff
x.name = "modifier_trait_109_buff"
d(x, l)
...
function x.prototype.OnShieldGained(self, w)
