...
local a = "abilities/trait/trait_115"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_trait_115"
end
n = e({ j(nil) }, n)
g.trait_115 = n
g.modifier_trait_115 = c()
local o = g.modifier_trait_115
o.name = "modifier_trait_115"
d(o, l)
...
function o.prototype.OnTraitInit(self, p)
	p.hero:RemoveModifierByName("modifier_trait_115_buff")
	p.hero:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_trait_115_buff", {})
end
o = e(
	{ m(
		a,
...
g.modifier_trait_115 = o
g.modifier_trait_115_buff = c()
local t = g.modifier_trait_115_buff
t.name = "modifier_trait_115_buff"
d(t, l)
...
function t.prototype.EDeclareFunctions(self)
	return { EOMModifierFunction.EOM_MODIFIER_PROPERTY_INJURY_STACK_BONUS }
end
function t.prototype.EOM_GetModifierInjuryStackBonus(self, p)
