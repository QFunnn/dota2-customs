...
LinkLuaModifier(
	...
	"abilities/kunkka_tidebringer_custom",
		...
		for _, Target in pairs(Targets) do
			if Target ~= params.target then
				Target:AddNewModifier(
					...
					self,
					"modifier_kunkka_tidebringer_custom_slow",
					{ duration = MovespeedSlowDuration }
				)
			end
		end
	end
...
function modifier_kunkka_tidebringer_custom_passive:IsPurgeException()
	return false
end
function modifier_kunkka_tidebringer_custom_passive:RemoveOnDeath()
	return false
end
