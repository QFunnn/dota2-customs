...
function modifier_frostbitten_heal:IsPurgable()
	return false
end

function modifier_frostbitten_heal:IsHidden()
	return false
end
...
function modifier_frostbitten_heal:OnCreated(table)
	...
	self:GetParent():EmitSound("Creep.Wyvern_heal")
...
function modifier_frostbitten_heal_cd:IsHidden()
	return false
end
function modifier_frostbitten_heal_cd:IsPurgable()
	return false
end