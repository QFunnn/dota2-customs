...
LinkLuaModifier(
	"modifier_lone_druid_true_form_custom_fly",
	"abilities/lone_druid_true_form_custom",
...
function lone_druid_true_form_custom:OnToggle()
	...
	local modifier_lone_druid_true_form_custom = self:GetCaster()
		:FindModifierByName("modifier_lone_druid_true_form_custom")
...
function modifier_lone_druid_true_form_custom_fly:IsHidden()
	return true
end
function modifier_lone_druid_true_form_custom_fly:IsPurgable()
	return false
end
function modifier_lone_druid_true_form_custom_fly:IsPurgeException()
	return false
end
