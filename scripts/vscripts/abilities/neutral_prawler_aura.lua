...
function modifier_prawler_aura:IsPurgable()
	return false
end
function modifier_prawler_aura:IsHidden()
	return true
end
...
function modifier_prawler_aura_buff:IsPurgable()
	return false
end
function modifier_prawler_aura_buff:IsHidden()
	return false
end
...
function modifier_prawler_aura_buff:DamageEvent_out(params)
	...
	if not attacker:CheckLifesteal(params) then
		return
	end
