...
LinkLuaModifier(
	"modifier_naga_siren_song_of_the_siren_custom_aura",
	"abilities/naga_siren_song_of_the_siren_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_naga_siren_song_of_the_siren_custom_debuff",
	"abilities/naga_siren_song_of_the_siren_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_naga_siren_song_of_the_siren_custom_aura:IsPurgable()
	return false
end
function modifier_naga_siren_song_of_the_siren_custom_aura:IsPurgeException()
	return false
end
function modifier_naga_siren_song_of_the_siren_custom_aura:IsAura()
	return true
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetAuraDuration()
	return 0.5
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_INVULNERABLE + DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_ALL
end
function modifier_naga_siren_song_of_the_siren_custom_aura:GetModifierAura()
...
function modifier_naga_siren_song_of_the_siren_custom_aura:OnCreated()
	...
	self:GetCaster()
		:SwapAbilities(self:GetAbility():GetAbilityName(), "naga_siren_song_of_the_siren_cancel_custom", false, true)
...
function modifier_naga_siren_song_of_the_siren_custom_aura:OnDestroy()
	...
	self:GetCaster()
		:SwapAbilities(self:GetAbility():GetAbilityName(), "naga_siren_song_of_the_siren_cancel_custom", true, false)
end

modifier_naga_siren_song_of_the_siren_custom_debuff = class({})

function modifier_naga_siren_song_of_the_siren_custom_debuff:IsDebuff()
	return true
end
function modifier_naga_siren_song_of_the_siren_custom_debuff:IsPurgable()
	return false
end
function modifier_naga_siren_song_of_the_siren_custom_debuff:IsPurgeException()
	return false
end
