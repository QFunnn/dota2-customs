...
LinkLuaModifier(
	"modifier_bloodseeker_sanguivore_custom",
	"abilities/bloodseeker/bloodseeker_innate_custom",
...
function modifier_bloodseeker_sanguivore_custom:RemoveOnDeath()
	return false
end
