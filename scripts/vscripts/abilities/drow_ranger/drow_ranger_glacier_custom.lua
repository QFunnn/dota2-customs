...
LinkLuaModifier(
	"modifier_drow_ranger_glacier_custom_field",
	"abilities/drow_ranger/drow_ranger_glacier_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_drow_ranger_glacier_custom_blink",
	"abilities/drow_ranger/drow_ranger_glacier_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_drow_ranger_glacier_custom_blink:OnCreated(table)
	...
	local effect_end =
		ParticleManager:CreateParticle("particles/drow_ranger/marksman_blink_start.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_drow_ranger_glacier_custom_field:GetAuraDuration()
	return 0.1
end
function modifier_drow_ranger_glacier_custom_field:GetAuraRadius()
	return self.radius
end
function modifier_drow_ranger_glacier_custom_field:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_drow_ranger_glacier_custom_field:GetAuraSearchType()
