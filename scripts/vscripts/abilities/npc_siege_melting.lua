...
function modifier_siege_melting:IsHidden()
	return true
end
function modifier_siege_melting:IsPurgable()
	return false
end
...
function modifier_siege_armor:IsHidden()
	return false
end
function modifier_siege_armor:IsPurgable()
	return false
end
