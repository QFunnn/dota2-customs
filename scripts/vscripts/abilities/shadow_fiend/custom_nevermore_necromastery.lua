...
LinkLuaModifier(
	"modifier_custom_necromastery_souls",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_necromastery_kills",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_necromastery_tempo_track",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_necromastery_heal_cd",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_necromastery_attack_slow",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_necromastery_attack_silence",
	"abilities/shadow_fiend/custom_nevermore_necromastery",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_custom_necromastery_souls:RemoveOnDeath()
	return false
end
function modifier_custom_necromastery_souls:IsHidden()
	return false
end
function modifier_custom_necromastery_souls:IsPurgable()
	return false
end
...
function modifier_custom_necromastery_souls:RefreshSoulsMax()
	...
	if self.caster:HasModifier("modifier_custom_necromastery_kills") then
		self.max_souls = self.max_souls
			+ self.souls_per_kill * self.caster:GetUpgradeStack("modifier_custom_necromastery_kills")
	end
...
function modifier_custom_necromastery_souls:GetModifierAttackSpeedBonus_Constant()
	if not self.caster:HasTalent("modifier_nevermore_souls_7") then
		return
	end
...
function modifier_custom_necromastery_souls:AttackEvent_out(params)
		...
		if self.caster:HasTalent("modifier_nevermore_souls_6") then
			...
			if frenzy.silence == false and params.target:IsHero() then
				...
				params.target:AddNewModifier(
					...
					self.ability,
					"modifier_custom_necromastery_attack_silence",
					{ duration = self.silence_duration * (1 - params.target:GetStatusResistance()) }
				)
			end
		end
	...
	if not self.caster:HasTalent("modifier_nevermore_souls_4") then
		return
	end

	self.attack_count = self.attack_count + 1

	if self.attack_count < self.proc_count then
		return
	end
	self.attack_count = 0
...
function modifier_custom_necromastery_souls:DamageEvent_inc(params)
	...
	if not self.caster:HasTalent("modifier_nevermore_souls_5") then
		return
	end
	...
	if self.caster:HasModifier("modifier_custom_necromastery_heal_cd") then
		return
	end
	if self.caster:HasModifier("modifier_death") then
		return
	end
...
function modifier_custom_necromastery_kills:IsHidden()
	return false
end
function modifier_custom_necromastery_kills:IsPurgable()
	return false
end
function modifier_custom_necromastery_kills:GetTexture()
...
function modifier_custom_necromastery_tempo_track:IsHidden()
	return false
end
function modifier_custom_necromastery_tempo_track:IsPurgable()
	return false
end
function modifier_custom_necromastery_tempo_track:GetTexture()
...
function modifier_custom_necromastery_heal_cd:IsHidden()
	return false
end
function modifier_custom_necromastery_heal_cd:IsPurgable()
	return false
end
function modifier_custom_necromastery_heal_cd:IsDebuff()
	return true
end
function modifier_custom_necromastery_heal_cd:RemoveOnDeath()
	return false
end
function modifier_custom_necromastery_heal_cd:GetTexture()
	return "buffs/souls_heal_cd"
end
...
function modifier_custom_necromastery_attack_slow:IsHidden()
	return true
end
function modifier_custom_necromastery_attack_slow:IsPurgable()
	return true
end
...
function modifier_custom_necromastery_attack_silence:IsHidden()
	return true
end
function modifier_custom_necromastery_attack_silence:IsPurgable()
	return true
end
...
function modifier_custom_necromastery_attack_silence:GetEffectName()
	return "particles/generic_gameplay/generic_silenced.vpcf"
end
function modifier_custom_necromastery_attack_silence:ShouldUseOverheadOffset()
	return true
end
function modifier_custom_necromastery_attack_silence:GetEffectAttachType()
