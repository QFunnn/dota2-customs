...
LinkLuaModifier(
	"modifier_grimstroke_spirit_walk_custom",
	"abilities/grimstroke_spirit_walk_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_grimstroke_spirit_walk_custom_return",
	"abilities/grimstroke_spirit_walk_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function grimstroke_return_custom:OnSpellStart()
	...
	local modifier_grimstroke_spirit_walk_custom_return =
		self:GetCaster():FindModifierByName("modifier_grimstroke_spirit_walk_custom_return")
...
function grimstroke_spirit_walk_custom:OnSpellStart()
	...
	local modifier_grimstroke_spirit_walk_custom =
		target:AddNewModifier(self:GetCaster(), self, "modifier_grimstroke_spirit_walk_custom", { duration = duration })
	local modifier_grimstroke_spirit_walk_custom_return = self:GetCaster():AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_grimstroke_spirit_walk_custom_return",
		{ duration = duration }
...
function modifier_grimstroke_spirit_walk_custom_return:IsHidden()
	return true
end
function modifier_grimstroke_spirit_walk_custom_return:IsPurgable()
	return false
end
	...
	if IsServer() then
		...
		if self.caster:HasShard() then
			self.damageTable.damage = (
				self.damageTable.damage + self.damageTable.damage / 100 * self.shard_bonus_damage_pct
			)
		end
