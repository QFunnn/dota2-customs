...
function modifier_spider_toxin:IsHidden()
	return true
end

function modifier_spider_toxin:IsPurgable()
	return false
end
...
function modifier_toxin_thinker:IsHidden()
	return false
end

function modifier_toxin_thinker:IsPurgable()
	return false
end
...
function modifier_toxin_aura:IsPurgable()
	return false
end

function modifier_toxin_aura:IsHidden()
	return false
end
function modifier_toxin_aura:IsDebuff()
	return true
end
function modifier_toxin_aura:CheckState()
	return { [MODIFIER_STATE_PASSIVES_DISABLED] = true, [MODIFIER_STATE_SILENCED] = true }
end
...
function modifier_spider_toxin_cd:IsHidden()
	return false
end
function modifier_spider_toxin_cd:IsPurgable()
	return false
end