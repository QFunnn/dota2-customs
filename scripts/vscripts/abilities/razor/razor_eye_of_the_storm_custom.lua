...
LinkLuaModifier(
	...
	"abilities/razor/razor_eye_of_the_storm_custom",
...
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_tracker",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_cloud",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_legendary",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_slow",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_damage",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_cd",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_root",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_eye_of_the_storm_custom_attack_proc",
	"abilities/razor/razor_eye_of_the_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function razor_eye_of_the_storm_custom:GetCastRange(vLocation, hTarget)
	return self:GetSpecialValueFor("radius")
		+ self:GetCaster():GetTalentValue("modifier_razor_eye_5", "radius")
...
function razor_eye_of_the_storm_custom:OnSpellStart()
	...
	if caster:HasTalent("modifier_razor_eye_6") then
		caster:AddNewModifier(
			...
			self,
			"modifier_razor_eye_of_the_storm_custom_damage",
			{ duration = caster:GetTalentValue("modifier_razor_eye_6", "duration") }
		)
	...
	local duration = self:GetSpecialValueFor("duration")
		+ self:GetCaster():GetTalentValue("modifier_razor_eye_3", "duration")
...
function modifier_razor_eye_of_the_storm_custom:OnCreated(kv)
	...
	self.radius = self.ability:GetSpecialValueFor("radius")
		+ self.parent:GetTalentValue("modifier_razor_eye_5", "radius")
	self.damage = self.ability:GetSpecialValueFor("damage")
		+ self.parent:GetTalentValue("modifier_razor_eye_1", "damage")
	...
	self.cloud_unit = CreateUnitByName(
		"npc_dota_companion",
...
function modifier_razor_eye_of_the_storm_custom:Show()
	...
	local particle_name = wearables_system:GetParticleReplacementAbility(
		self:GetCaster(),
		"particles/razor/razor_rain_storm_new.vpcf",
		self
	)
...
function modifier_razor_eye_of_the_storm_custom:DamageEvent_out(params)
	...
	if not self.parent:HasModifier("modifier_razor_eye_of_the_storm_custom_legendary") then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom:GetModifierPreAttack_BonusDamage()
	if not self.parent:HasTalent("modifier_razor_eye_1") then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom:GetModifierAttackSpeedBonus_Constant()
	if not self.parent:HasTalent("modifier_razor_eye_4") then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom_slow:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_slow:IsPurgable()
	return false
end
...
function modifier_razor_eye_of_the_storm_custom_cloud:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_cloud:IsPurgable()
	return false
end
...
function modifier_razor_eye_of_the_storm_custom_legendary:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_legendary:IsPurgable()
	return false
end
function modifier_razor_eye_of_the_storm_custom_legendary:OnCreated()
	...
	local effect_cast =
		ParticleManager:CreateParticle("particles/razor/storm_legendary.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
...
function modifier_razor_eye_of_the_storm_custom_legendary:Strike()
	...
	if not self.mod.cloud_unit or self.mod.cloud_unit:IsNull() then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom_tracker:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_tracker:IsPurgable()
	return false
end
...
function modifier_razor_eye_of_the_storm_custom_tracker:GetModifierStatusResistanceStacking()
	if not self.parent:HasTalent("modifier_razor_eye_2") then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom_tracker:GetModifierAttackRangeBonus()
	if not self.parent:HasTalent("modifier_razor_eye_5") then
		return
	end
...
function modifier_razor_eye_of_the_storm_custom_damage:IsHidden()
	return false
end
function modifier_razor_eye_of_the_storm_custom_damage:IsPurgable()
	return false
end
function modifier_razor_eye_of_the_storm_custom_damage:GetTexture()
...
function modifier_razor_eye_of_the_storm_custom_cd:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_cd:IsPurgable()
	return false
end
function modifier_razor_eye_of_the_storm_custom_cd:RemoveOnDeath()
	return false
end
...
function modifier_razor_eye_of_the_storm_custom_root:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_root:IsPurgable()
	return true
end
...
function modifier_razor_eye_of_the_storm_custom_root:GetEffectName()
	return "particles/items3_fx/gleipnir_root.vpcf"
end

modifier_razor_eye_of_the_storm_custom_attack_proc = class({})
function modifier_razor_eye_of_the_storm_custom_attack_proc:IsHidden()
	return true
end
function modifier_razor_eye_of_the_storm_custom_attack_proc:IsPurgable()
	return false
end
