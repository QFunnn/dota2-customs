...
function modifier_razor_innate_custom:IsHidden()
	return true
end
function modifier_razor_innate_custom:IsPurgable()
	return false
end
function modifier_razor_innate_custom:RemoveOnDeath()
	return false
end
...
function modifier_razor_innate_custom:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_razor_current_1") then
		return
	end
