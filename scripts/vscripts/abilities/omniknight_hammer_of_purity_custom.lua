...
LinkLuaModifier(
	...
	"abilities/omniknight_hammer_of_purity_custom",
...
function modifier_omniknight_hammer_of_purity_custom:IsHidden()
	return true
end
function modifier_omniknight_hammer_of_purity_custom:IsPurgable()
	return false
end
function modifier_omniknight_hammer_of_purity_custom:IsPurgeException()
	return false
end
...
function modifier_omniknight_hammer_of_purity_custom:AttackLandedModifier(params)
	...
	if self:GetParent():HasAbility("omniknight_hammer_of_purity_custom") then
