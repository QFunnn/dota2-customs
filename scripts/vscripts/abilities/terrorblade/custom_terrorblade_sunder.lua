...
function custom_terrorblade_sunder:CastFilterResultTarget(target)
	...
	if
		target ~= nil
		and target:HasModifier("modifier_generic_debuff_immune")
		and not self:GetCaster():HasTalent("modifier_terror_sunder_6")
	then
...
function custom_terrorblade_sunder:OnSpellStart()
		...
		target:AddNewModifier(
			...
			"modifier_custom_terrorblade_sunder_rooted",
			{
				...
				duration = (1 - target:GetStatusResistance())
					* caster:GetTalentValue("modifier_terror_sunder_6", "root"),
			}
		)
	end
	...
	if caster:HasTalent("modifier_terror_sunder_7") and target ~= nil and is_enemy then
		...
		caster:SetHealth(
			caster:GetMaxHealth()
				* math.max(target_health_percent, self:GetSpecialValueFor("hit_point_minimum_pct"))
				* 0.01
		)

		caster:AddHealingInfo({
			ability_name = self:GetName(),
			inflictor = self,
			healing = caster:GetHealth() - current_health,
		})

		if
			caster:GetHealth() > current_health
			and caster:GetQuest() == "Terr.Quest_8"
		...
		target:SetHealth(
			target:GetMaxHealth()
				* math.max(caster_health_percent, self:GetSpecialValueFor("hit_point_minimum_pct"))
				* 0.01
		)
	end
	...
	if caster:HasTalent("modifier_terror_sunder_4") and is_enemy then
		...
		stats_target:AddNewModifier(
			...
			self,
			"modifier_custom_terrorblade_sunder_stats",
			{ duration = caster:GetTalentValue("modifier_terror_sunder_4", "duration") }
		)
	end
	...
	if caster:HasTalent("modifier_terror_sunder_2") then
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_terrorblade_sunder_shield",
			{ duration = caster:GetTalentValue("modifier_terror_sunder_2", "duration") }
		)
	end
end

modifier_custom_terrorblade_sunder_legendary = class({})
function modifier_custom_terrorblade_sunder_legendary:IsHidden()
	return true
end
function modifier_custom_terrorblade_sunder_legendary:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_tracker:IsHidden()
	return true
end
function modifier_custom_terrorblade_sunder_tracker:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_tracker:GetModifierCastRangeBonusStacking()
	if not self.parent:HasTalent("modifier_terror_sunder_3") then
		return
	end
...
function modifier_custom_terrorblade_sunder_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_terror_sunder_7") then
		return
	end
	...
	for _, aoe_target in pairs(self.parent:FindTargets(self.legendary_radius, target:GetAbsOrigin())) do
		...
		aoe_target:AddNewModifier(
			...
			self.ability,
			"modifier_custom_terrorblade_sunder_slow",
			{ duration = (1 - aoe_target:GetStatusResistance()) * self.legendary_slow }
		)
...
function modifier_custom_terrorblade_sunder_tracker:DamageEvent_inc(params)
	...
	if not self.parent:HasTalent("modifier_terror_sunder_5") then
		return
	end
...
function modifier_custom_terrorblade_sunder_slow:IsHidden()
	return true
end
...
function modifier_custom_terrorblade_sunder_cd:IsHidden()
	return false
end
function modifier_custom_terrorblade_sunder_cd:IsPurgable()
	return false
end
function modifier_custom_terrorblade_sunder_cd:RemoveOnDeath()
	return false
end
function modifier_custom_terrorblade_sunder_cd:IsDebuff()
	return true
end
...
function modifier_custom_terrorblade_sunder_stats:IsHidden()
	return false
end
function modifier_custom_terrorblade_sunder_stats:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_stats_self:IsHidden()
	return false
end
function modifier_custom_terrorblade_sunder_stats_self:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_rooted:IsHidden()
	return true
end
...
function modifier_custom_terrorblade_sunder_damage:IsHidden()
	return true
end
function modifier_custom_terrorblade_sunder_damage:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_shield:IsHidden()
	return true
end
function modifier_custom_terrorblade_sunder_shield:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_shield:OnCreated(table)
	...
	self.max_shield = self.parent:GetTalentValue("modifier_terror_sunder_2", "shield")
...
function modifier_custom_terrorblade_sunder_lethal:IsHidden()
	return true
end
function modifier_custom_terrorblade_sunder_lethal:IsPurgable()
	return false
end
...
function modifier_custom_terrorblade_sunder_lethal_cd:IsHidden()
	return false
end
function modifier_custom_terrorblade_sunder_lethal_cd:IsPurgable()
	return false
end
function modifier_custom_terrorblade_sunder_lethal_cd:GetTexture()
	return "buffs/midnight_haste"
end
function modifier_custom_terrorblade_sunder_lethal_cd:RemoveOnDeath()
	return false
end
function modifier_custom_terrorblade_sunder_lethal_cd:IsDebuff()
	return true
end
