...
LinkLuaModifier(
	...
	"abilities/witch_doctor/witch_doctor_scepter_ability_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_witch_doctor_scepter_ability_custom_aura",
	"abilities/witch_doctor/witch_doctor_scepter_ability_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function witch_doctor_scepter_ability_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"amir4an/particles/heroes/witch_doctor/amir4an_1x6/amir4an_1x6_witch_doctor_scepter_ambient.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"amir4an/particles/heroes/witch_doctor/amir4an_1x6/amir4an_1x6_witch_doctor_scepter_over_head_ambient.vpcf",
		context
	)
...
function modifier_witch_doctor_scepter_ability_custom_aura:NoDamage(params)
	...
	if not self.caster:HasModifier("modifier_witch_doctor_scepter_ability_custom") then
		return 0
	end
	...
	local particle =
		ParticleManager:CreateParticle("particles/witch_doctor/scepter_heal.vpcf", PATTACH_CUSTOMORIGIN_FOLLOW, target)
