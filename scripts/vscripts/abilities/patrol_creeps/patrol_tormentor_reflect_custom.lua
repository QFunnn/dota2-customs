...
LinkLuaModifier(
	"modifier_patrol_tormentor_reflect_custom",
	"abilities/patrol_creeps/patrol_tormentor_reflect_custom",
...
LinkLuaModifier(
	"modifier_tormentor_custom_mark",
	"modifiers/creeps/modifier_tormentor_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_tormentor_custom_field_cd",
	"modifiers/creeps/modifier_tormentor_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_tormentor_custom_field_knock_cd",
	"modifiers/creeps/modifier_tormentor_custom",
	LUA_MODIFIER_MOTION_NONE
)
