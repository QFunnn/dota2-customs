...
function modifier_npc_necro_melle_passive:IsHidden()
	return true
end
function modifier_npc_necro_melle_passive:IsPurgable()
	return false
end
...
function modifier_npc_necro_melle_passive:DeathEvent(params)
	...
	params.attacker:AddNewModifier(
		...
		self:GetAbility(),
		"modifier_stunned",
		{ duration = (1 - params.attacker:GetStatusResistance()) * self.stun }
	)
...
function modifier_npc_necro_melle_passive_heal:IsHidden()
	return false
end
...
function modifier_npc_necro_melle_passive_heal:GetModifierLifestealRegenAmplify_Percentage()
	return -self.reduce
end
...
function modifier_npc_necro_melle_passive_heal:GetEffectAttachType()
