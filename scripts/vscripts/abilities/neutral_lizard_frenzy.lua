...
function modifier_lizard_frenzy:IsPurgable()
	return false
end

function modifier_lizard_frenzy:IsHidden()
	return true
end
...
function modifier_lizard_frenzy:StartCast(target)
	...
	self:GetParent():AddNewModifier(
		...
		{ target = array_target, duration = 0.3, anim = ACT_DOTA_CAST_ABILITY_1, parent_mod = self:GetName() }
	)
end
...
function modifier_lizard_frenzy_buff:IsHidden()
	return false
end
function modifier_lizard_frenzy_buff:IsPurgable()
	return true
end
