...
LinkLuaModifier(
	"modifier_skywrath_mage_scepter_shield_custom",
	"abilities/skywrath_mage/skywrath_mage_scepter_shield_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_scepter_shield_custom_slow",
	"abilities/skywrath_mage/skywrath_mage_scepter_shield_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function skywrath_mage_scepter_shield_custom:OnSpellStart()
	...
	if
		not caster:HasModifier("modifier_skywrath_mage_mystic_flare_custom_legendary_caster") and not caster:IsStunned()
	then
...
function modifier_skywrath_mage_scepter_shield_custom:IsHidden()
	return false
end
function modifier_skywrath_mage_scepter_shield_custom:IsPurgable()
	return false
end
function modifier_skywrath_mage_scepter_shield_custom:OnCreated(table)
	...
	local effect_cast = ParticleManager:CreateParticle(
		"particles/skywrath/scepter_shield.vpcf",
...
function modifier_skywrath_mage_scepter_shield_custom:OnDestroy()
	...
	local damageTable = {
		...
		damage = self.max_shield * self.damage,
	}
	...
	local effect_cast = ParticleManager:CreateParticle(
		"particles/skywrath/scepter_shield_break.vpcf",
		PATTACH_CUSTOMORIGIN_FOLLOW,
		self.parent
	)
	ParticleManager:SetParticleControlEnt(
...
function modifier_skywrath_mage_scepter_shield_custom_slow:IsHidden()
	return true
end
function modifier_skywrath_mage_scepter_shield_custom_slow:IsPurgable()
	return true
end
