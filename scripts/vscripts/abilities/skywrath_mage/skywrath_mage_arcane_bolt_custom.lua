...
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_legendary",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_legendary_mana",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_slow",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_root",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_root_stack",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_range",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_lethal",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_arcane_bolt_custom_lethal_cd",
	"abilities/skywrath_mage/skywrath_mage_arcane_bolt_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function skywrath_mage_arcane_bolt_custom:GetManaCost(level)
	...
	if caster:HasModifier("modifier_skywrath_mage_arcane_bolt_custom_legendary") then
		bonus = caster:GetUpgradeStack("modifier_skywrath_mage_arcane_bolt_custom_legendary")
			* caster:GetTalentValue("modifier_sky_arcane_bolt_7", "mana")
			* caster:GetMaxMana()
			/ 100
	end
...
function skywrath_mage_arcane_bolt_custom:OnSpellStart(new_target)
	...
	local particle_projectile = wearables_system:GetParticleReplacementAbility(
		caster,
	...
	local bolt_speed = self:GetSpecialValueFor("bolt_speed")
		* (1 + caster:GetTalentValue("modifier_sky_arcane_bolt_6", "speed") / 100)
	...
	local int_multiplier = self:GetSpecialValueFor("int_multiplier")
		+ caster:GetTalentValue("modifier_sky_arcane_bolt_1", "damage") / 100
	...
	if caster:HasTalent("modifier_sky_arcane_bolt_2") then
		caster:AddNewModifier(
			...
			self,
			"modifier_skywrath_mage_arcane_bolt_custom_slow",
			{ duration = caster:GetTalentValue("modifier_sky_arcane_bolt_2", "duration") }
		)
	end
end
...
function skywrath_mage_arcane_bolt_custom:OnProjectileHit_ExtraData(target, location, extra_data)
	...
	if not extra_data.bolt_damage then
		return
	end
	...
	if caster:HasTalent("modifier_sky_arcane_bolt_6") then
		target:AddNewModifier(
			...
			self,
			"modifier_skywrath_mage_arcane_bolt_custom_root_stack",
			{ duration = caster:GetTalentValue("modifier_sky_arcane_bolt_6", "duration") }
		)
...
function skywrath_mage_arcane_bolt_custom_legendary:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_skywrath_mage_arcane_bolt_custom_legendary",
		{ duration = caster:GetTalentValue("modifier_sky_arcane_bolt_7", "duration") }
	)
end

modifier_skywrath_mage_arcane_bolt_custom_legendary = class({})
function modifier_skywrath_mage_arcane_bolt_custom_legendary:IsHidden()
	return true
end
function modifier_skywrath_mage_arcane_bolt_custom_legendary:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_arcane_bolt_custom_legendary:OnDestroy()
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_skywrath_mage_arcane_bolt_custom_legendary_mana",
		{ duration = self.parent:GetTalentValue("modifier_sky_arcane_bolt_7", "mana_duration") }
	)
end
...
function modifier_skywrath_mage_arcane_bolt_custom:IsHidden()
	return true
end
function modifier_skywrath_mage_arcane_bolt_custom:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_arcane_bolt_custom:SpellEvent(params)
	...
	if
		self.parent:HasTalent("modifier_sky_arcane_bolt_3")
		and RollPseudoRandomPercentage(self.mana_chance, 5251, self.parent)
	then
...
function modifier_skywrath_mage_arcane_bolt_custom:DamageEvent_inc(params)
	...
	if not self.parent:HasTalent("modifier_sky_arcane_bolt_5") then
		return
	end
	if self.parent ~= params.unit then
		return
	...
	if self.parent:HasModifier("modifier_skywrath_mage_arcane_bolt_custom_lethal_cd") then
		return
	end
	...
	self.parent:AddNewModifier(
		...
		"modifier_skywrath_mage_arcane_bolt_custom_lethal",
		{ duration = self.lethal_duration }
	)
	self.parent:AddNewModifier(
		self.parent,
		self.ability,
		"modifier_skywrath_mage_arcane_bolt_custom_lethal_cd",
		{ duration = self.lethal_cd }
	)
end
...
function modifier_skywrath_mage_arcane_bolt_custom:GetModifierHealthBonus()
	if not self.parent:HasTalent("modifier_sky_arcane_bolt_1") then
		return
	end
...
function modifier_skywrath_mage_arcane_bolt_custom:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_sky_arcane_bolt_4") then
		return
	end
	...
	if allow and not mod then
		mod =
			self.parent:AddNewModifier(self.parent, self.ability, "modifier_skywrath_mage_arcane_bolt_custom_range", {})
	end
...
function modifier_skywrath_mage_arcane_bolt_custom_legendary_mana:IsHidden()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_legendary_mana:IsPurgable()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_legendary_mana:OnCreated()
	...
	self.parent:EmitSound("Sky.Bolt_legendary_end")
	self.interval = 0.5
	self.mana = self.interval
		* (
			(
				self.parent:GetTalentValue("modifier_sky_arcane_bolt_7", "mana_inc")
				* (self.parent:GetMaxMana() - self.parent:GetMana())
				/ 100
...
function modifier_skywrath_mage_arcane_bolt_custom_slow:IsHidden()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_slow:IsPurgable()
	return true
end
...
function modifier_skywrath_mage_arcane_bolt_custom_root:IsHidden()
	return true
end
function modifier_skywrath_mage_arcane_bolt_custom_root:IsPurgable()
	return true
end
...
function modifier_skywrath_mage_arcane_bolt_custom_root_stack:IsHidden()
	return true
end
function modifier_skywrath_mage_arcane_bolt_custom_root_stack:IsPurgable()
	return false
end
		...
		self.parent:AddNewModifier(
			...
			"modifier_skywrath_mage_arcane_bolt_custom_root",
			{
				duration = (1 - self.parent:GetStatusResistance())
					* self.caster:GetTalentValue("modifier_sky_arcane_bolt_6", "root"),
			}
		)
		self:Destroy()
	end
...
function modifier_skywrath_mage_arcane_bolt_custom_range:IsHidden()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_range:IsPurgable()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_range:GetTexture()
	return "buffs/bolt_range"
end
...
function modifier_skywrath_mage_arcane_bolt_custom_lethal:IsHidden()
	return true
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal:IsPurgable()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal:IsDebuff()
	return true
end
...
function modifier_skywrath_mage_arcane_bolt_custom_lethal:OnCreated()
	...
	self.heal = (
		self.parent:GetTalentValue("modifier_sky_arcane_bolt_5", "heal")
...
function modifier_skywrath_mage_arcane_bolt_custom_lethal_cd:IsHidden()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal_cd:IsPurgable()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal_cd:GetTexture()
	return "buffs/bolt_lethal"
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal_cd:RemoveOnDeath()
	return false
end
function modifier_skywrath_mage_arcane_bolt_custom_lethal_cd:IsDebuff()
	return true
end
