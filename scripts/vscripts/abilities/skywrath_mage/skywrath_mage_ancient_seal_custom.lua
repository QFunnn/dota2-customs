...
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_silence",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_legendary",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_legendary_self",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_tracker",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_armor",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_damage",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_silence_cd",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom_pause",
	"abilities/skywrath_mage/skywrath_mage_ancient_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function skywrath_mage_ancient_seal_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/items/skywrath_mage/skywrath_arcana/skywrath_arcana_phylactery.vpcf",
		context
	)
...
function skywrath_mage_ancient_seal_custom:OnSpellStart(new_target)
	...
	local seal_duration = self:GetSpecialValueFor("seal_duration")
		+ caster:GetTalentValue("modifier_sky_seal_3", "duration")
	...
	if caster:HasTalent("modifier_sky_flare_4") then
		target:AddNewModifier(
			caster,
			self,
			"modifier_skywrath_mage_mystic_flare_custom_damage_inc",
			{ duration = caster:GetTalentValue("modifier_sky_flare_4", "duration") }
		)
	end
...
function skywrath_mage_ancient_seal_custom_legendary:GetAbilityChargeRestoreTime(level)
	...
	return self:GetSpecialValueFor("AbilityChargeRestoreTime")
		+ self:GetCaster():GetTalentValue("modifier_sky_seal_7", "cd")
		+ bonus
end
...
function skywrath_mage_ancient_seal_custom_legendary:OnSpellStart()
	local caster = self:GetCaster()
	local seal_duration = self:GetSpecialValueFor("seal_duration")
		+ caster:GetTalentValue("modifier_sky_seal_7", "delay")
		+ caster:GetTalentValue("modifier_sky_seal_3", "duration")
	...
	AddFOWViewer(
		...
		point,
		caster:GetTalentValue("modifier_sky_seal_7", "radius"),
		seal_duration,
		false
	)
...
function modifier_skywrath_mage_ancient_seal_custom_silence:IsHidden()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_silence:IsPurgable()
	return true
end
...
function modifier_skywrath_mage_ancient_seal_custom_silence:OnCreated()
	...
	self.resist = self.ability:GetSpecialValueFor("resist_debuff")
		+ self.caster:GetTalentValue("modifier_sky_seal_1", "magic")
	...
	self.damageTable =
		{ victim = self.parent, attacker = self.caster, ability = self:GetAbility(), damage_type = DAMAGE_TYPE_MAGICAL }
...
function modifier_skywrath_mage_ancient_seal_custom_silence:OnIntervalThink()
	...
	if
		...
		and self.caster:GetQuest() == "Sky.Quest_7"
		and not self.caster:QuestCompleted()
		and self.first_tick == true
	then
...
function modifier_skywrath_mage_ancient_seal_custom_silence:GetModifierLifestealRegenAmplify_Percentage()
	if not self.caster:HasTalent("modifier_sky_seal_1") then
		return
	end
...
function modifier_skywrath_mage_ancient_seal_custom_silence:GetModifierAttackSpeedBonus_Constant()
	if not self.caster:HasTalent("modifier_sky_seal_6") then
		return
	end
...
function modifier_skywrath_mage_ancient_seal_custom_legendary:IsHidden()
	return true
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_ancient_seal_custom_legendary:IsAura()
	return self:GetStackCount() == 1
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:GetAuraDuration()
	return 0
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:GetAuraRadius()
	return self.radius
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_skywrath_mage_ancient_seal_custom_legendary:GetModifierAura()
	return "modifier_skywrath_mage_ancient_seal_custom_silence"
end

modifier_skywrath_mage_ancient_seal_custom_legendary_self = class({})
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:IsHidden()
	return true
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:IsAura()
	return self:GetStackCount() == 1
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:GetAuraDuration()
	return 0.1
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:GetAuraRadius()
	return self.radius
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:GetAuraSearchType()
...
function modifier_skywrath_mage_ancient_seal_custom_legendary_self:GetModifierAura()
	return "modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect"
end

modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect = class({})
function modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect:IsHidden()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_ancient_seal_custom_tracker:IsHidden()
	return true
end
function modifier_skywrath_mage_ancient_seal_custom_tracker:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_ancient_seal_custom_tracker:GetModifierStatusResistanceStacking()
	if not self.parent:HasTalent("modifier_sky_seal_5") then
		return
	end
...
function modifier_skywrath_mage_ancient_seal_custom_tracker:SpellEvent(params)
	...
	if
		self.parent:HasTalent("modifier_sky_seal_5")
		and unit:GetTeamNumber() ~= self.parent:GetTeamNumber()
		and not unit:IsInvulnerable()
		and unit:IsUnit()
		and (self.parent:GetAbsOrigin() - unit:GetAbsOrigin()):Length2D() <= self.auto_radius
		and not unit:HasModifier("modifier_skywrath_mage_ancient_seal_custom_silence_cd")
	then
		...
		unit:AddNewModifier(
			...
			self.ability,
			"modifier_skywrath_mage_ancient_seal_custom_silence",
			{ duration = (1 - unit:GetStatusResistance()) * self.auto_silence }
		)
		unit:AddNewModifier(
			self.parent,
			self.ability,
			"modifier_skywrath_mage_ancient_seal_custom_silence_cd",
			{ duration = self.auto_cd }
		)
	end
	...
	if not self.parent:HasTalent("modifier_sky_seal_2") then
		return
	end
...
function modifier_skywrath_mage_ancient_seal_custom_tracker:DamageEvent_out(params)
	...
	if not self.parent:HasModifier("modifier_skywrath_mage_ancient_seal_custom_legendary_self_effect") then
		return
	end
	...
	if not RollPseudoRandomPercentage(self.legendary_chance, 6251, self.parent) then
		return
	end

	local particle =
		ParticleManager:CreateParticle("particles/skywrath/seal_refresh.vpcf", PATTACH_CUSTOMORIGIN, self.parent)
	ParticleManager:SetParticleControlEnt(
		particle,
		0,
		self.parent,
...
function modifier_skywrath_mage_ancient_seal_custom_armor:IsHidden()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_armor:IsPurgable()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_armor:GetTexture()
	return "buffs/seal_armor"
end
...
function modifier_skywrath_mage_ancient_seal_custom_damage:IsHidden()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_damage:IsPurgable()
	return false
end
function modifier_skywrath_mage_ancient_seal_custom_damage:GetTexture()
	return "buffs/seal_damage"
end
...
function modifier_skywrath_mage_ancient_seal_custom_silence_cd:IsHidden()
	return true
end
function modifier_skywrath_mage_ancient_seal_custom_silence_cd:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_ancient_seal_custom_silence_cd:RemoveOnDeath()
	return false
end

modifier_skywrath_mage_ancient_seal_custom_pause = class({})
function modifier_skywrath_mage_ancient_seal_custom_pause:IsHidden()
	return true
end
function modifier_skywrath_mage_ancient_seal_custom_pause:IsPurgable()
	return false
end
