...
function npc_werewolf_bloodrage:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_werewolf_cd", { duration = self:GetCooldownTimeRemaining() })
...
function modifier_werewolf_bloodrage:IsHidden()
	return false
end
...
function modifier_werewolf_bloodrage:GetEffectAttachType()
...
function modifier_werewolf_cd:IsHidden()
	return false
end
function modifier_werewolf_cd:IsPurgable()
	return false
end