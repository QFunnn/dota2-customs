...
LinkLuaModifier(
	"modifier_phantom_assassin_innate_cleave",
	"abilities/phantom_assassin_innate_cleave",
...
function modifier_phantom_assassin_innate_cleave:IsHidden()
	return false
end
function modifier_phantom_assassin_innate_cleave:IsPurgable()
	return false
end
function modifier_phantom_assassin_innate_cleave:IsPurgeException()
	return false
end
function modifier_phantom_assassin_innate_cleave:RemoveOnDeath()
	return false
end
