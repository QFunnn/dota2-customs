...
local phantome_ab4_2 = __TS__Class()
phantome_ab4_2.name = "phantome_ab4_2"
__TS__ClassExtends(phantome_ab4_2, MonsterAbility_CS)
function phantome_ab4_2.prototype.GetMosnterAbilityConfig(self)
	return {
		castPoint = 0.9,
		counterBreakWindowDuration = 0.9,
		castDuration = 2,
...
function phantome_ab4_2.prototype.armParticleLifetime(self, pid, lifeSec)
...
function phantome_ab4_2.prototype.Start(self)
	local caster = self:GetCaster()
	caster:SetAnimation("attack_swing")
	caster:EmitSound("Hero_Broodmother.SilkenBola.Target")
	caster:AddNewModifier(caster, self, "phantome_ab4_2_pre", { duration = 0.5 })
	Timers:CreateTimer(0.2, function()
		...
		caster:Mover(caster:GetAbsOrigin():__add(caster:GetForwardVector():__mul(450)), 0.3)
...
function phantome_ab4_2.prototype.PlayDamage(self, caster)
...
phantome_ab4_2 = __TS__DecorateLegacy({ registerAbility(nil) }, phantome_ab4_2)
local phantome_ab4_2_pre = __TS__Class()
phantome_ab4_2_pre.name = "phantome_ab4_2_pre"
__TS__ClassExtends(phantome_ab4_2_pre, BaseModifier)
function phantome_ab4_2_pre.prototype.OnCreated(self, params)
	local caster = self:GetCaster()
...
function phantome_ab4_2_pre.prototype.OnDestroy(self)
	if not IsServer() then
		return
	end
...
phantome_ab4_2_pre = __TS__DecorateLegacy({ registerModifier(nil) }, phantome_ab4_2_pre)
return ____exports