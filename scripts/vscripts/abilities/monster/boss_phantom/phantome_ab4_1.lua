...
local phantome_ab4_1 = __TS__Class()
phantome_ab4_1.name = "phantome_ab4_1"
__TS__ClassExtends(phantome_ab4_1, MonsterAbility_CS)
function phantome_ab4_1.prototype.GetMosnterAbilityConfig(self)
	return {
		castPoint = 0.9,
		castDuration = 2,
...
function phantome_ab4_1.prototype.armParticleLifetime(self, pid, lifeSec)
...
function phantome_ab4_1.prototype.Start(self)
	local caster = self:GetCaster()
	caster:SetAnimation("attack_swing")
	caster:EmitSound("Hero_Broodmother.SilkenBola.Target")
	caster:AddNewModifier(caster, self, "phantome_ab4_1_pre", { duration = 0.5 })
...
function phantome_ab4_1.prototype.PlayDamage(self, caster)
...
phantome_ab4_1 = __TS__DecorateLegacy({ registerAbility(nil) }, phantome_ab4_1)
local phantome_ab4_1_pre = __TS__Class()
phantome_ab4_1_pre.name = "phantome_ab4_1_pre"
__TS__ClassExtends(phantome_ab4_1_pre, BaseModifier)
function phantome_ab4_1_pre.prototype.OnCreated(self, params)
	local caster = self:GetCaster()
...
function phantome_ab4_1_pre.prototype.OnDestroy(self)
	if not IsServer() then
		return
	end
...
phantome_ab4_1_pre = __TS__DecorateLegacy({ registerModifier(nil) }, phantome_ab4_1_pre)
return ____exports