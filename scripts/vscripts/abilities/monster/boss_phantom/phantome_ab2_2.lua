...
local phantome_ab2_2 = __TS__Class()
phantome_ab2_2.name = "phantome_ab2_2"
__TS__ClassExtends(phantome_ab2_2, MonsterAbility_CS)
function phantome_ab2_2.prototype.GetMosnterAbilityConfig(self)
	return {
		castPoint = 1.2,
		counterBreakWindowDuration = 1.2,
		castDuration = 2,
...
function phantome_ab2_2.prototype.StartPrePhaseMove(self, done)
...
function phantome_ab2_2.prototype.GetPreMoveDuration(self, caster, distance)
...
function phantome_ab2_2.prototype.ResolveApproachTargetMovePoint(self, caster, target)
...
function phantome_ab2_2.prototype.IsValidApproachMovePoint(self, caster, targetPoint, currentTargetDistance, point)
...
function phantome_ab2_2.prototype.armParticleLifetime(self, pid, lifeSec)
	if not IsServer() then
		return
	end
	local done = false
...
function phantome_ab2_2.prototype.Start(self)
	local caster = self:GetCaster()
...
function phantome_ab2_2.prototype.PlayDamage(self, caster)
...
function phantome_ab2_2.prototype.Pull(self)
	local caster = self:GetCaster()
	local pos = caster:GetAbsOrigin()
	local enemies = FindUnitsInRadius(
		caster:GetTeamNumber(),
...
phantome_ab2_2 = __TS__DecorateLegacy({ registerAbility(nil) }, phantome_ab2_2)
return ____exports