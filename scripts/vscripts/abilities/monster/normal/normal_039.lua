...
--- 普通技能39 - 铁龙冲撞：预警后向前冲刺，撞击敌人造成伤害、击退和眩晕
____exports.normal_039 = __TS__Class()
local normal_039 = ____exports.normal_039
normal_039.name = "normal_039"
__TS__ClassExtends(normal_039, MonsterAbility_CS)
function normal_039.prototype.Precache(self, context)
...
function normal_039.prototype.GetMosnterAbilityConfig(self)
	return {
...
function normal_039.prototype.StartWarningEffect(self, caster)
	self:ClearWarningEffect()
...
function normal_039.prototype.UpdateWarningForward(self, caster, elapsed)
...
function normal_039.prototype.StartDash(self, caster)
	...
	caster:AddNewModifier(caster, self, "normal_039_pre", { duration = DASH_DURATION })
...
function normal_039.prototype.GetWarningEnd(self, caster)
	local origin = caster:GetAbsOrigin()
	return origin:__add(caster:GetForwardVector():__mul(DASH_DISTANCE))
end
function normal_039.prototype.StartDashEffect(self, caster)
...
function normal_039.prototype.HitDashEnemies(self, caster, position, forward, hitTargets)
	if not IsValidAlive(nil, caster) then
		return
	end
...
function normal_039.prototype.PlayHitEffect(self, target, forward)
...
function normal_039.prototype.ClearDashEffect(self)
...
function normal_039.prototype.ClearWarningEffect(self)
...
function normal_039.prototype.ClearAllEffects(self)
	self:ClearWarningEffect()
	self:ClearDashEffect()
end
normal_039 = __TS__DecorateLegacy({ registerAbility(nil) }, normal_039)
____exports.normal_039 = normal_039
____exports.normal_039_pre = __TS__Class()
local normal_039_pre = ____exports.normal_039_pre
normal_039_pre.name = "normal_039_pre"
__TS__ClassExtends(normal_039_pre, MonsterModifier_CS)
function normal_039_pre.prototype.GetEffectName(self)
	return "particles/bb/ss_primal_beast_2022_prestige_onslaught_charge_active_test2.vpcf"
end
normal_039_pre = __TS__DecorateLegacy({ registerModifier(nil) }, normal_039_pre)
____exports.normal_039_pre = normal_039_pre
return ____exports