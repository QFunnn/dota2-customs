...
local SPLIT_SUMMON_UNIT = "monster_11331"
local SPLIT_COUNT = 3
...
____exports.normal_013_1 = __TS__Class()
local normal_013_1 = ____exports.normal_013_1
normal_013_1.name = "normal_013_1"
__TS__ClassExtends(normal_013_1, MonsterAbility_CS)
function normal_013_1.prototype.Precache(self, context)
	PrecacheResource("particle", SPLIT_PARTICLE, context)
end
function normal_013_1.prototype.GetMosnterAbilityConfig(self)
	return { behavior = DOTA_ABILITY_BEHAVIOR_PASSIVE, castPoint = 0, castDuration = 0 }
end
function normal_013_1.prototype.GetIntrinsicModifierName(self)
	return "modifier_normal_013_1_split"
end
normal_013_1 = __TS__DecorateLegacy({ registerAbility(nil) }, normal_013_1)
____exports.normal_013_1 = normal_013_1
local modifier_normal_013_1_split = __TS__Class()
modifier_normal_013_1_split.name = "modifier_normal_013_1_split"
__TS__ClassExtends(modifier_normal_013_1_split, MonsterModifier_CS)
function modifier_normal_013_1_split.prototype.____constructor(self, ...)
	MonsterModifier_CS.prototype.____constructor(self, ...)
	self._triggered = false
end
function modifier_normal_013_1_split.prototype.DeclareEvents(self)
	return { { event = BusinessEvents.ON_UNIT_DEATH, target = { scope = "global" } } }
end
function modifier_normal_013_1_split.prototype.OnUnitDeath_CS(self, event)
...
function modifier_normal_013_1_split.prototype.Split(self, parent)
...
function modifier_normal_013_1_split.prototype.IsHidden(self)
	return true
end
function modifier_normal_013_1_split.prototype.IsPurgable(self)
	return false
end
modifier_normal_013_1_split =
	__TS__DecorateLegacy({ registerModifier(nil, "modifier_normal_013_1_split") }, modifier_normal_013_1_split)
return ____exports