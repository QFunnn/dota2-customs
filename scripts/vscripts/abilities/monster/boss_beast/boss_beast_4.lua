...
local SUMMON_TAG = "boss_beast_4_hound"
...
____exports.boss_beast_4 = __TS__Class()
local boss_beast_4 = ____exports.boss_beast_4
boss_beast_4.name = "boss_beast_4"
__TS__ClassExtends(boss_beast_4, BossPhaseTransitionAbility_CS)
function boss_beast_4.prototype.Precache(self, context)
...
function boss_beast_4.prototype.GetBossPhaseTransitionGesture(self)
	return ACT_DOTA_OVERRIDE_ABILITY_3
end
function boss_beast_4.prototype.GetBossPhaseTransitionGesturePlaybackRate(self)
	return 0.8
end
function boss_beast_4.prototype.GetBossPhaseTransitionConfig(self)
	return {
...
function boss_beast_4.prototype.PlayDomainEffect(self)
	local caster = self:GetCaster()
	if not IsValidAlive(nil, caster) then
		return
	end
...
function boss_beast_4.prototype.StartHoundWaves(self)
...
function boss_beast_4.prototype.PrepareHoundWave(self, waveIndex)
	local caster = self:GetCaster()
	if not IsValidAlive(nil, caster) then
		return
	end
...
function boss_beast_4.prototype.FindWaveTargets(self, caster)
...
function boss_beast_4.prototype.CreateChargePlan(self, caster, target, usedSpawnPositions)
	if not IsValidAlive(nil, target) then
		return
	end
...
function boss_beast_4.prototype.FindRandomTraversablePointAroundTarget(
	self,
	caster,
	target,
	targetPos,
...
function boss_beast_4.prototype.GetRandomChargeTargetPosition(self, target, targetPos)
...
function boss_beast_4.prototype.IsValidSummonPoint(self, origin, point)
	return self:GetInvalidSummonPointReason(origin, point) == nil
end
function boss_beast_4.prototype.GetInvalidSummonPointReason(self, origin, point, usedSpawnPositions)
...
function boss_beast_4.prototype.SummonPreparingHound(self, target, spawnPos, direction)
	local caster = self:GetCaster()
	...
	MyGameUnit:CreateSummonedUnitAsync({
		...
		onSpawn = function(____, unit)
			...
			unit:AddNewModifier(caster, self, "modifier_boss_beast_4_hound_prepare", { duration = WARNING_DURATION })
...
function boss_beast_4.prototype.StartHoundCharge(self, unit, direction)
	local caster = self:GetCaster()
	...
	unit:RemoveModifierByName("modifier_boss_beast_4_hound_prepare")
	unit:SetForwardVectorWithoutInterrupt(direction)
	unit:AddNewModifier(caster, self, "modifier_boss_beast_4_hound_charge", {
...
function boss_beast_4.prototype.GetWarningEnd(self, startPos, direction)
	return startPos:__add(direction:__mul(DASH_DISTANCE))
end
function boss_beast_4.prototype.PlaySummonEffect(self, pos, caster)
...
boss_beast_4 = __TS__DecorateLegacy({ registerAbility(nil) }, boss_beast_4)
____exports.boss_beast_4 = boss_beast_4
local modifier_boss_beast_4_hound_prepare = __TS__Class()
modifier_boss_beast_4_hound_prepare.name = "modifier_boss_beast_4_hound_prepare"
__TS__ClassExtends(modifier_boss_beast_4_hound_prepare, BaseModifier_CS)
function modifier_boss_beast_4_hound_prepare.prototype.IsHidden(self)
	return true
end
function modifier_boss_beast_4_hound_prepare.prototype.OnCreated(self)
	if not IsServer() then
		return
	end
...
function modifier_boss_beast_4_hound_prepare.prototype.OnDestroy(self)
	if not IsServer() then
		return
	end
	local parent = self:GetParent()
...
function modifier_boss_beast_4_hound_prepare.prototype.DeclareFunctions(self)
	return { MODIFIER_PROPERTY_OVERRIDE_ANIMATION, MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE }
end
function modifier_boss_beast_4_hound_prepare.prototype.GetOverrideAnimation(self)
	return ACT_DOTA_OVERRIDE_ABILITY_4
end
function modifier_boss_beast_4_hound_prepare.prototype.GetOverrideAnimationRate(self)
	return 1
end
function modifier_boss_beast_4_hound_prepare.prototype.CheckState(self)
	return {
...
modifier_boss_beast_4_hound_prepare =
	__TS__DecorateLegacy({ registerModifier(nil) }, modifier_boss_beast_4_hound_prepare)
local modifier_boss_beast_4_hound_charge = __TS__Class()
modifier_boss_beast_4_hound_charge.name = "modifier_boss_beast_4_hound_charge"
__TS__ClassExtends(modifier_boss_beast_4_hound_charge, BaseModifier_CS)
function modifier_boss_beast_4_hound_charge.prototype.____constructor(self, ...)
	BaseModifier_CS.prototype.____constructor(self, ...)
	self.direction = Vector(1, 0, 0)
	self.hitTargets = {}
end
function modifier_boss_beast_4_hound_charge.prototype.OnCreated(self, params)
	if not IsServer() then
		return
	end
	local parent = self:GetParent()
...
function modifier_boss_beast_4_hound_charge.prototype.OnIntervalThink(self)
	if not IsServer() then
		return
	end
	local parent = self:GetParent()
...
function modifier_boss_beast_4_hound_charge.prototype.OnDestroy(self)
	if not IsServer() then
		return
	end
	local parent = self:GetParent()
...
function modifier_boss_beast_4_hound_charge.prototype.HitEnemies(self, position)
	local parent = self:GetParent()
	local caster = self:GetCaster()
...
function modifier_boss_beast_4_hound_charge.prototype.CheckState(self)
	return { [MODIFIER_STATE_DISARMED] = true, [MODIFIER_STATE_NO_UNIT_COLLISION] = true }
end
modifier_boss_beast_4_hound_charge = __TS__DecorateLegacy({ registerModifier(nil) }, modifier_boss_beast_4_hound_charge)
return ____exports