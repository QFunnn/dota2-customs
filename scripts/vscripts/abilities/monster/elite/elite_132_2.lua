...
--- 精英技能3 - 蓄力后发射法球
____exports.elite_132_2 = __TS__Class()
local elite_132_2 = ____exports.elite_132_2
elite_132_2.name = "elite_132_2"
__TS__ClassExtends(elite_132_2, MonsterAbility_CS)
function elite_132_2.prototype.GetMosnterAbilityConfig(self)
	return {
		castRange = 1200,
		castPoint = 1.2,
		castDuration = 3.5,
...
elite_132_2 = __TS__DecorateLegacy({ registerAbility(nil) }, elite_132_2)
____exports.elite_132_2 = elite_132_2
return ____exports