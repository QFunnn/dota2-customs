...
--- 精英技能3 - 蓄力后发射法球
____exports.elite_026 = __TS__Class()
local elite_026 = ____exports.elite_026
elite_026.name = "elite_026"
__TS__ClassExtends(elite_026, MonsterAbility_CS)
function elite_026.prototype.GetMosnterAbilityConfig(self)
	return {
		castRange = 1200,
		castPoint = 1.2,
		castDuration = 1.8,
		...
		OnStart = function()
			...
			self:Timer(0, function()
				...
				local target_pos =
					start_point:__add(RotateVector2D(nil, forward_vector, RandomFloat(-20, 20)):__mul(2000))
...
elite_026 = __TS__DecorateLegacy({ registerAbility(nil) }, elite_026)
____exports.elite_026 = elite_026
return ____exports