...
____exports.elite_105 = __TS__Class()
local elite_105 = ____exports.elite_105
elite_105.name = "elite_105"
__TS__ClassExtends(elite_105, MonsterAbility_CS)
function elite_105.prototype.____constructor(self, ...)
	MonsterAbility_CS.prototype.____constructor(self, ...)
	self.targetEnemy = nil
end
function elite_105.prototype.Precache(self, context)
	PrecacheResource("particle", BLINK_PARTICLE, context)
end
function elite_105.prototype.GetMosnterAbilityConfig(self)
	return {
		...
		OnStart = function()
			...
			caster:AddNewModifier(caster, self, "modifier_elite_105_attack_distance", { duration = 5 })
		end,
	}
end
function elite_105.prototype.FindNearestEnemy(self, caster)
	return caster:GetMinDistanceUnit(ENEMY_SEARCH_RANGE)
end
function elite_105.prototype.FindBlinkPoint(self, caster, enemy)
...
function elite_105.prototype.IsValidBlinkPoint(self, casterOrigin, enemyOrigin, point)
...
function elite_105.prototype.PlayBlinkParticle(self, position)
	local pfx = ParticleManager:CreateParticle(BLINK_PARTICLE, PATTACH_WORLDORIGIN, nil)
	ParticleManager:SetParticleControl(pfx, 0, position)
	ParticleManager:ReleaseParticleIndex(pfx)
end
elite_105 = __TS__DecorateLegacy({ registerAbility(nil) }, elite_105)
____exports.elite_105 = elite_105
____exports.modifier_elite_105_attack_distance = __TS__Class()
local modifier_elite_105_attack_distance = ____exports.modifier_elite_105_attack_distance
modifier_elite_105_attack_distance.name = "modifier_elite_105_attack_distance"
__TS__ClassExtends(modifier_elite_105_attack_distance, MonsterModifier_CS)
function modifier_elite_105_attack_distance.prototype.GetAttributeBonus(self)
	return { bonus_attack_range = 200 }
end
modifier_elite_105_attack_distance = __TS__DecorateLegacy(
	{ registerModifier(nil, "modifier_elite_106_attack_distance") },
	modifier_elite_105_attack_distance
)
____exports.modifier_elite_105_attack_distance = modifier_elite_105_attack_distance
return ____exports