...
local a = "abilities/consumables/item_hammer_weapon_single"
...
local j = i.EOMItem
local k = c()
k.name = "item_hammer_weapon_single"
d(k, j)
...
function k.prototype.OnSpellStart(self)
	...
	SkillUpgrade:RequestEnqueueSkillUpgrade(m)
	l:EmitSound("General.LevelUp.Bonus")
	l:RemoveItem(self)
end
k = e({ h(nil) }, k)
return f