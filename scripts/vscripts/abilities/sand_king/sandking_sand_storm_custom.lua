...
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_target",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_tracker",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_caster",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_spider_ai",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_spider_effect",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_speed",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_cyclone",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_silence",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_damage_cd",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_heal",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_root",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_fade",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_sand_storm_custom_speed_cd",
	"abilities/sand_king/sandking_sand_storm_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sandking_sand_storm_custom:GetRadius()
	return self:GetSpecialValueFor("sand_storm_radius")
		+ self:GetCaster():GetTalentValue("modifier_sand_king_sand_6", "radius")
end
...
function sandking_sand_storm_custom:ProcLegendary(point)
	...
	if not caster:HasTalent("modifier_sand_king_sand_7") then
		return
	end
...
function sandking_sand_storm_custom:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_sandking_sand_storm_custom_caster",
		{ duration = duration, thinker = thinker:entindex() }
	)
	...
	if caster:HasTalent("modifier_sand_king_sand_4") then
		for i = 1, caster:GetTalentValue("modifier_sand_king_sand_4", "max") do
			...
			CreateModifierThinker(
				...
				self,
				"modifier_sandking_sand_storm_custom_cyclone",
				{ thinker = thinker:entindex(), angle = angel },
				caster:GetAbsOrigin(),
				caster:GetTeamNumber(),
				false
			)
...
function sandking_sand_storm_custom:GetDamage(target)
	...
	local damage = self:GetSpecialValueFor("sand_storm_damage")
		+ caster:GetTalentValue("modifier_sand_king_sand_1", "damage") * caster:GetMaxHealth() / 100
...
function modifier_sandking_sand_storm_custom:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom:OnCreated(table)
	...
	self.speed = (
		self.ability:GetSpecialValueFor("sand_storm_move_speed")
		+ self.caster:GetTalentValue("modifier_sand_king_sand_2", "speed")
	) / 100
	...
	self.effect_cast =
		ParticleManager:CreateParticle("particles/sand_king/sandking_sandstorm_custom.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_sandking_sand_storm_custom:IsAura()
	return true
end
...
function modifier_sandking_sand_storm_custom_target:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_target:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom_target:GetModifierMoveSpeedBonus_Percentage()
	...
	if not self.caster:HasTalent("modifier_sand_king_sand_1") then
		return
	end
	return self.slow
end
...
function modifier_sandking_sand_storm_custom_target:OnIntervalThink()
	...
	if self.is_enemy then
		...
		if
			...
			and self.caster:HasTalent("modifier_sand_king_sand_5")
			and not self.caster:HasModifier("modifier_sandking_sand_storm_custom_speed_cd")
		then
			self.caster:AddNewModifier(
				self.caster,
				self.ability,
				"modifier_sandking_sand_storm_custom_speed_cd",
				{ duration = self.speed_cd }
			)
			self.caster:AddNewModifier(
				self.caster,
				self.ability,
...
function modifier_sandking_sand_storm_custom_caster:IsHidden()
	return false
end
function modifier_sandking_sand_storm_custom_caster:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom_caster:GetModifierHealthRegenPercentage()
	if not self.caster:HasTalent("modifier_sand_king_sand_3") then
		return
	end
	if not self.caster:HasModifier("modifier_sandking_sand_storm_custom_target") then
		return
	end
	return self.regen
end
...
function sandking_sand_storm_custom_legendary:OnSpellStart()
	...
	if mod and mod:GetAuraOwner() and not mod:GetAuraOwner():IsNull() then
		...
		local effect_cast = ParticleManager:CreateParticle(
			"particles/muerta/veil_pull.vpcf",
	...
	for _, unit in pairs(units) do
		...
		mod:SetEndCallback(function()
			unit:AddNewModifier(
				...
				self,
				"modifier_sandking_sand_storm_custom_root",
				{ duration = (1 - unit:GetStatusResistance()) * root_duration }
			)
		end)
	end
end
...
function modifier_sandking_sand_storm_custom_spider_ai:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_spider_ai:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_spider_ai:RemoveOnDeath()
	return false
end
...
function modifier_sandking_sand_storm_custom_spider_ai:OnCreated(table)
	...
	ParticleManager:ReleaseParticleIndex(
		ParticleManager:CreateParticle("particles/neutral_fx/skeleton_spawn.vpcf", PATTACH_ABSORIGIN, self.parent)
	)
...
function modifier_sandking_sand_storm_custom_spider_ai:IsValidTarget(target)
	...
	if
		...
		or ((target:GetAbsOrigin() - self.parent:GetAbsOrigin()):Length2D() > self.radius)
		or (not target:IsHero() and not target:IsCreep())
		or target:IsCourier()
		or target:GetUnitName() == "npc_teleport"
		or target:HasModifier("modifier_monkey_king_wukongs_command_custom_soldier")
	then
		return false
	end
	return true
...
function modifier_sandking_sand_storm_custom_spider_ai:GetModifierProcAttack_Feedback(params)
	...
	if not params.target:IsCreep() and not params.target:IsHero() then
		return
	end
...
function modifier_sandking_sand_storm_custom_spider_effect:IsHidden()
	return false
end
function modifier_sandking_sand_storm_custom_spider_effect:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_spider_effect:GetTexture()
	return "buffs/sand_spider"
end
...
function modifier_sandking_sand_storm_custom_tracker:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_tracker:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom_tracker:SpellEvent(params)
	...
	if not self.caster:HasTalent("modifier_sand_king_sand_7") then
		return
	end
	...
	if self.no_proc[params.ability:GetName()] then
		return
	end
...
function modifier_sandking_sand_storm_custom_tracker:DeathEvent(params)
	...
	if
		...
		and unit:HasModifier("modifier_sandking_sand_storm_custom_spider_ai")
	then
		local effect_cast = ParticleManager:CreateParticle(
...
function modifier_sandking_sand_storm_custom_speed:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_speed:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom_cyclone:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_cyclone:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_cyclone:OnCreated(table)
	...
	self.effect_cast = ParticleManager:CreateParticle(
		"particles/sand_king/sand_tornado.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self:GetParent()
	)
...
function modifier_sandking_sand_storm_custom_cyclone:GetPosition()
	local abs = GetGroundPosition(
		self.center + Vector(math.cos(self.current_angle), math.sin(self.current_angle), 0) * self.radius,
		nil
	)
...
function modifier_sandking_sand_storm_custom_silence:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_silence:IsPurgable()
	return true
end
...
function modifier_sandking_sand_storm_custom_silence:GetEffectName()
	return "particles/generic_gameplay/generic_silenced.vpcf"
end
function modifier_sandking_sand_storm_custom_silence:ShouldUseOverheadOffset()
	return true
end
function modifier_sandking_sand_storm_custom_silence:GetEffectAttachType()
...
function modifier_sandking_sand_storm_custom_damage_cd:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_damage_cd:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_damage_cd:OnCreated()
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_sandking_sand_storm_custom_silence",
		{ duration = self.silence * (1 - self.parent:GetStatusResistance()) }
	)
	...
	DoDamage(
		{
			...
			damage = self.ability:GetDamage(self.parent) * self.damage,
			damage_type = DAMAGE_TYPE_MAGICAL,
		},
	...
	local particle =
		ParticleManager:CreateParticle("particles/sand_king/tornado_damage.vpcf", PATTACH_CUSTOMORIGIN, self.parent)
	ParticleManager:SetParticleControlEnt(
		particle,
		0,
		self.parent,
...
function modifier_sandking_sand_storm_custom_heal:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_heal:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_heal:OnCreated()
	self.heal = self:GetCaster():GetTalentValue("modifier_sand_king_sand_6", "heal")
		/ self:GetCaster():GetTalentValue("modifier_sand_king_sand_6", "duration")
...
function modifier_sandking_sand_storm_custom_heal:GetEffectName()
	return "particles/units/heroes/hero_oracle/oracle_purifyingflames.vpcf"
end

function modifier_sandking_sand_storm_custom_heal:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end
...
function modifier_sandking_sand_storm_custom_root:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_root:IsPurgable()
	return true
end
...
function modifier_sandking_sand_storm_custom_root:OnIntervalThink()
	...
	self.effect_cast =
		ParticleManager:CreateParticle("particles/sand_king/sand_root.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
	self:AddParticle(self.effect_cast, false, false, -1, false, false)
...
function modifier_sandking_sand_storm_custom_fade:IsHidden()
	return true
end
function modifier_sandking_sand_storm_custom_fade:IsPurgable()
	return false
end
...
function modifier_sandking_sand_storm_custom_speed_cd:IsHidden()
	return false
end
function modifier_sandking_sand_storm_custom_speed_cd:IsPurgable()
	return false
end
function modifier_sandking_sand_storm_custom_speed_cd:RemoveOnDeath()
	return false
end
function modifier_sandking_sand_storm_custom_speed_cd:IsDebuff()
	return true
end
