...
LinkLuaModifier(
	"modifier_sandking_epicenter_custom",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_slow",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_tracker",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_legendary",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_auto_cd",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_heal_reduce",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_heal",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_absorb",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_absorb_cd",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_speed",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sandking_epicenter_custom_shard_count",
	"abilities/sand_king/sandking_epicenter_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sandking_epicenter_custom:OnAbilityPhaseStart()
	...
	if
		caster:HasTalent("modifier_sand_king_epicenter_5")
		and not caster:HasModifier("modifier_sandking_epicenter_custom_absorb_cd")
	then
...
function sandking_epicenter_custom:OnAbilityPhaseInterrupted()
	...
	then
		caster:AddNewModifier(
			...
			self,
			"modifier_sandking_epicenter_custom_absorb_cd",
			{ duration = caster:GetTalentValue("modifier_sand_king_epicenter_5", "cd") }
		)
...
function sandking_epicenter_custom:OnSpellStart()
	...
	if caster:HasTalent("modifier_sand_king_epicenter_3") then
		caster:AddNewModifier(
			...
			self,
			"modifier_sandking_epicenter_custom_heal",
			{ duration = caster:GetTalentValue("modifier_sand_king_epicenter_3", "duration") }
		)
	end
...
function sandking_epicenter_custom:Pulse(pulse_loc, radius, main_skill, is_legendary)
	...
	self.particle_epicenter_fx = ParticleManager:CreateParticle(
	...
	if #targets > 0 then
		...
		if caster:HasTalent("modifier_sand_king_epicenter_6") then
			...
			caster:AddNewModifier(
				...
				self,
				"modifier_sandking_epicenter_custom_speed",
				{ duration = caster:GetTalentValue("modifier_sand_king_epicenter_6", "duration") }
			)
		end
	end
	...
	for _, target in pairs(targets) do
		...
		if caster:HasShard() and main_skill then
			target:AddNewModifier(
				...
				self,
				"modifier_sandking_epicenter_custom_shard_count",
				{ duration = self:GetSpecialValueFor("AbilityDuration") + 0.1 }
			)
		end
...
function modifier_sandking_epicenter_custom:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom:RemoveOnDeath()
	return false
end
...
function modifier_sandking_epicenter_custom:OnCreated(table)
	...
	self.pulses = self.ability:GetSpecialValueFor("epicenter_pulses")
		+ self:GetCaster():GetTalentValue("modifier_sand_king_epicenter_4", "max")
...
function modifier_sandking_epicenter_custom:OnIntervalThink()
	...
	self.ability:Pulse(
		...
		self.radius_init + self.radius_inc * self:GetStackCount(),
		true,
		false
	)
...
function modifier_sandking_epicenter_custom_slow:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_slow:IsPurgable()
	return true
end
...
function modifier_sandking_epicenter_custom_tracker:IsHidden()
	return true
end
function modifier_sandking_epicenter_custom_tracker:IsPurgable()
	return false
end
...
function modifier_sandking_epicenter_custom_tracker:GetModifierPercentageManacostStacking()
	if not self.parent:HasTalent("modifier_sand_king_epicenter_2") then
		return
	end
...
function sandking_epicenter_custom_legendary:OnSpellStart()
	...
	self:GetCaster():AddNewModifier(
		...
		self,
		"modifier_sandking_epicenter_custom_legendary",
		{ duration = self:GetCaster():GetTalentValue("modifier_sand_king_epicenter_7", "duration") }
	)
end

modifier_sandking_epicenter_custom_legendary = class({})
function modifier_sandking_epicenter_custom_legendary:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_legendary:IsPurgable()
	return false
end

function modifier_sandking_epicenter_custom_legendary:GetEffectName()
	return "particles/sand_king/epicenter_legendary.vpcf"
end
function modifier_sandking_epicenter_custom_legendary:GetStatusEffectName()
	return "particles/status_fx/status_effect_valkyrie_fire_wreath_magic_immunity.vpcf"
end
function modifier_sandking_epicenter_custom_legendary:StatusEffectPriority()
...
function modifier_sandking_epicenter_custom_auto_cd:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_auto_cd:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_auto_cd:RemoveOnDeath()
	return false
end
function modifier_sandking_epicenter_custom_auto_cd:IsDebuff()
	return true
end
function modifier_sandking_epicenter_custom_auto_cd:GetTexture()
	return "buffs/epicenter_auto"
end

modifier_sandking_epicenter_custom_heal_reduce = class({})
function modifier_sandking_epicenter_custom_heal_reduce:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_heal_reduce:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_heal_reduce:GetTexture()
	return "buffs/epicenter_damage"
end
...
function modifier_sandking_epicenter_custom_heal:IsHidden()
	return true
end
function modifier_sandking_epicenter_custom_heal:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_heal:GetTexture()
	return "buffs/epicenter_heal"
end
function modifier_sandking_epicenter_custom_heal:OnCreated()
	...
	self.max_shield = self:GetCaster():GetMaxHealth()
		* self:GetCaster():GetTalentValue("modifier_sand_king_epicenter_3", "shield")
		/ 100
...
function modifier_sandking_epicenter_custom_heal:DamageEvent_out(params)
	...
	if not params.unit:IsCreep() and not params.unit:IsRealHero() then
		return
	end
...
function modifier_sandking_epicenter_custom_absorb:IsHidden()
	return true
end
function modifier_sandking_epicenter_custom_absorb:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_absorb:OnCreated(table)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/sand_king/linken_active.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControlEnt(
...
function modifier_sandking_epicenter_custom_absorb:GetAbsorbSpell(params)
	...
	local particle = ParticleManager:CreateParticle(
		"particles/sand_king/linken_activea.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControlEnt(
...
function modifier_sandking_epicenter_custom_absorb_cd:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_absorb_cd:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_absorb_cd:RemoveOnDeath()
	return false
end
function modifier_sandking_epicenter_custom_absorb_cd:IsDebuff()
	return true
end
function modifier_sandking_epicenter_custom_absorb_cd:GetTexture()
	return "buffs/epicenter_linken"
end

modifier_sandking_epicenter_custom_speed = class({})
function modifier_sandking_epicenter_custom_speed:IsHidden()
	return false
end
function modifier_sandking_epicenter_custom_speed:IsPurgable()
	return false
end
function modifier_sandking_epicenter_custom_speed:GetTexture()
	return "buffs/epicenter_speed"
end
...
function modifier_sandking_epicenter_custom_shard_count:IsHidden()
	return true
end
function modifier_sandking_epicenter_custom_shard_count:IsPurgable()
	return false
end
...
function modifier_sandking_epicenter_custom_shard_count:OnRefresh()
	...
	if self:GetStackCount() >= self.max and self.proced == false then
		...
		self:GetParent():AddNewModifier(
			...
			{ duration = (1 - self:GetParent():GetStatusResistance()) * self.duration }
		)
	end
end