...
function modifier_centaur_aura:IsPurgable()
	return false
end
function modifier_centaur_aura:IsHidden()
	return true
end
...
function modifier_centaur_aura_buff:IsPurgable()
	return false
end
function modifier_centaur_aura_buff:IsHidden()
	return false
end
