...
function modifier_siege_attack:IsHidden()
	return true
end
function modifier_siege_attack:IsPurgable()
	return false
end
...
function modifier_siege_plusarmor:IsHidden()
	return false
end
function modifier_siege_plusarmor:IsPurgable()
	return false
end
