...
local a = "abilities/courier/courier_600024"
...
local q = c()
q.name = "courier_600024"
d(q, k)
function q.prototype.GetIntrinsicModifierName(self)
	return "modifier_courier_600024"
end
q = e({ l(nil) }, q)
local r = c()
r.name = "modifier_courier_600024"
d(r, n)
function r.prototype.GetBuffModifierName(self)
	return "modifier_courier_600024_buff"
end
r = e({ i(a, p) }, r)
local s = c()
s.name = "modifier_courier_600024_buff"
d(s, h)
...
function s.prototype.DynamicProperty(self)
	return {
		[PropertyFunction.MAGICAL_DAMAGE_MULTIPLIER_MUL] = function()
