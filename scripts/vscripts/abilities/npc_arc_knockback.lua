...
function npc_arc_knockback:OnSpellStart()
	...
	for _, enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(
			self.caster,
			self,
			"modifier_arc_knockback",
			{ pos = position, duration = self.knockback_duration * (1 - enemy:GetStatusResistance()) }
		)
	end
end

modifier_arc_knockback = class({})
function modifier_arc_knockback:IsHidden()
	return true
end
...
function modifier_arc_knockback_buf:IsHidden()
	return false
end
function modifier_arc_knockback_buf:IsPurgable()
	return false
end
...
function modifier_arc_knockback_buf:IsDebuff()
	return true
end
...
function npc_arc_knockback_passive:IsHidden()
	return true
end
...
function npc_arc_knockback_passive2:IsHidden()
	return true
end
...
function modifier_arc_knockback_cd:IsHidden()
	return false
end
function modifier_arc_knockback_cd:IsPurgable()
	return false
end