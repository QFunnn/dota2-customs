...
local a = "abilities/card_effect/card_effect_27"
...
f.card_effect_27 = c()
local i = f.card_effect_27
i.name = "card_effect_27"
d(i, h)
function i.prototype.spawn(self)
	...
	local m = k:AddNewModifier(k, k:GetDummyAbility(), "modifier_card_effect_27", {})
	m:SetStackCount(l * 10)
end
function i.prototype.dispose(self)
	local j = self:getPlayerID()
	local k = PlayerResource:GetSelectedHeroEntity(j)
	k:RemoveModifierByName("modifier_card_effect_27")
