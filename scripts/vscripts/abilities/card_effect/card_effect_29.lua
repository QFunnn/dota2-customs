...
local a = "abilities/card_effect/card_effect_29"
...
f.card_effect_29 = c()
local i = f.card_effect_29
i.name = "card_effect_29"
d(i, h)
...
function i.prototype.OnBattleEnd(self, j)
	...
	if j.illusionPlayerID ~= k and (k == j.winPlayerID or k == j.losePlayerID) then
		if j.winPlayerID == k then
