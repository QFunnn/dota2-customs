...
function modifier_bird_slow:IsPurgable()
	return false
end
function modifier_bird_slow:IsHidden()
	return true
end
...
function modifier_bird_slow_buff:IsPurgable()
	return false
end
function modifier_bird_slow_buff:IsHidden()
	return false
end
