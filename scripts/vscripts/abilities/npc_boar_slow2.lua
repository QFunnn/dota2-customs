...
function modifier_boar_passive2:IsHidden()
	return true
end
...
function modifier_boar_passive2:GetModifierProcAttack_Feedback(param)
...
function modifier_boar_slow_debuf2:IsHidden()
	return false
end

function modifier_boar_slow_debuf2:IsPurgable()
	return false
end
