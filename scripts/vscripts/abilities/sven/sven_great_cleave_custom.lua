...
LinkLuaModifier(
	"modifier_sven_great_cleave_custom",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_slow",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_slow_count",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_speed",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_speed_cd",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_legendary_slow",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_parry",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_parry_cd",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_vision_move",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_vision",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_break_cd",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_great_cleave_custom_break",
	"abilities/sven/sven_great_cleave_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sven_great_cleave_custom_legendary:GetCastRange(vLocation, hTarget)
	...
	if IsClient() then
		return caster:GetTalentValue("modifier_sven_cleave_7", "distance")
			- caster:GetTalentValue("modifier_sven_cleave_7", "width")
	else
		return 999999
	end
end
...
function sven_great_cleave_custom_legendary:OnProjectileHit_ExtraData(target, location, table)
	...
	if caster:HasTalent("modifier_sven_cleave_1") then
		target:AddNewModifier(
			...
			self,
			"modifier_sven_great_cleave_custom_slow_count",
			{ duration = caster:GetTalentValue("modifier_sven_cleave_1", "count_duration") }
		)
	end
	...
	target:AddNewModifier(
		...
		self,
		"modifier_sven_great_cleave_custom_legendary_slow",
		{ duration = caster:GetTalentValue("modifier_sven_cleave_7", "duration") * (1 - target:GetStatusResistance()) }
	)
...
function modifier_sven_great_cleave_custom:IsPurgable()
	return false
end
...
function modifier_sven_great_cleave_custom:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_sven_cleave_4") then
		return
	end
	if self.parent:HasModifier("modifier_sven_great_cleave_custom_speed") then
		return
	end
	if self.parent:HasModifier("modifier_sven_great_cleave_custom_speed_cd") then
		return
	end
...
function modifier_sven_great_cleave_custom:GetModifierBonusStats_Strength()
	if not self.parent:HasTalent("modifier_sven_cleave_3") then
		return
	end
...
function modifier_sven_great_cleave_custom:AttackEvent_inc(params)
	...
	if params.attacker:IsUnit() and self.parent == params.target then
		if
			self.parent:HasTalent("modifier_sven_cleave_5")
			and not self.parent:HasModifier("modifier_sven_great_cleave_custom_parry_cd")
		then
...
function modifier_sven_great_cleave_custom:AttackEvent_out(params)
	...
	if not self.parent:HasModifier("modifier_no_cleave") then
		DoCleaveAttack(
			...
			self.ability,
			cleaveDamage,
			self.great_cleave_start,
			self.great_cleave_end,
			self.great_cleave_distance,
	...
	if mod then
		...
		for i = 1, 2 do
			local particle = ParticleManager:CreateParticle(
				"particles/sven/cleave_speed_attack_range.vpcf",
		...
		local particle = ParticleManager:CreateParticle(
			"particles/sven/cleave_speed_attack.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			self.parent
		)
	...
	if self.parent:HasTalent("modifier_sven_cleave_1") then
		target:AddNewModifier(
			...
			self.ability,
			"modifier_sven_great_cleave_custom_slow_count",
			{ duration = self.slow_count }
		)
	end

	if
		self.parent:HasTalent("modifier_sven_cleave_6")
		and target:GetHealthPercent() <= self.vision_health
		and target:IsHero()
		and not target:HasModifier("modifier_sven_great_cleave_custom_break_cd")
	then
		target:AddNewModifier(
			self.parent,
			self.ability,
			"modifier_sven_great_cleave_custom_break_cd",
			{ duration = self.vision_cd }
		)
		target:AddNewModifier(
			self.parent,
			self.ability,
			"modifier_sven_great_cleave_custom_break",
			{ duration = self.vision_break * (1 - target:GetStatusResistance()) }
		)
	end
...
function modifier_sven_great_cleave_custom_vision:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_vision:IsPurgable()
	return false
end
...
function modifier_sven_great_cleave_custom_slow_count:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_slow_count:IsPurgable()
	return false
end
...
function modifier_sven_great_cleave_custom_slow_count:OnRefresh()
	...
	if self:GetStackCount() >= self.max then
		self.parent:AddNewModifier(
			...
			self:GetAbility(),
			"modifier_sven_great_cleave_custom_slow",
			{ duration = (1 - self.parent:GetStatusResistance()) * self.duration }
		)
		self:Destroy()
	end
end
...
function modifier_sven_great_cleave_custom_slow:IsHidden()
	return false
end
function modifier_sven_great_cleave_custom_slow:IsPurgable()
	return true
end
function modifier_sven_great_cleave_custom_slow:GetTexture()
	return "buffs/cleave_slow"
end
...
function modifier_sven_great_cleave_custom_speed:IsHidden()
	return false
end
function modifier_sven_great_cleave_custom_speed:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_speed:GetTexture()
	return "buffs/cleave_speed"
end
...
function modifier_sven_great_cleave_custom_legendary_slow:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_legendary_slow:IsPurgable()
	return true
end
...
function modifier_sven_great_cleave_custom_damage_perma:IsHidden()
	return not self:GetParent():HasTalent("modifier_sven_cleave_3")
end
function modifier_sven_great_cleave_custom_damage_perma:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_damage_perma:RemoveOnDeath()
	return false
end
function modifier_sven_great_cleave_custom_damage_perma:GetTexture()
	return "buffs/cleave_stack"
end
...
function modifier_sven_great_cleave_custom_parry:IsHidden()
	return false
end
function modifier_sven_great_cleave_custom_parry:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_parry:GetTexture()
	return "buffs/cleave_parry"
end
function modifier_sven_great_cleave_custom_parry:OnCreated(table)
	...
	self.buff_particles[1] = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_pangolier/pangolier_tailthump_buff.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self.parent
	)
	ParticleManager:SetParticleControlEnt(
		self.buff_particles[1],
		1,
		self.parent,
		PATTACH_ABSORIGIN_FOLLOW,
		nil,
	...
	self.buff_particles[2] = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_pangolier/pangolier_tailthump_buff_egg.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self.parent
	)
	ParticleManager:SetParticleControlEnt(
		self.buff_particles[2],
		1,
		self.parent,
		PATTACH_ABSORIGIN_FOLLOW,
		nil,
...
function modifier_sven_great_cleave_custom_parry_cd:IsHidden()
	return false
end
function modifier_sven_great_cleave_custom_parry_cd:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_parry_cd:GetTexture()
	return "buffs/cleave_parry"
end
function modifier_sven_great_cleave_custom_parry_cd:IsDebuff()
	return true
end
...
function modifier_sven_great_cleave_custom_vision_move:IsHidden()
	return false
end
function modifier_sven_great_cleave_custom_vision_move:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_vision_move:GetTexture()
	return "buffs/cleave_healing"
end
...
function modifier_sven_great_cleave_custom_speed_cd:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_speed_cd:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_speed_cd:RemoveOnDeath()
	return false
end
function modifier_sven_great_cleave_custom_speed_cd:GetTexture()
	return "buffs/cleave_speed"
end
function modifier_sven_great_cleave_custom_speed_cd:IsDebuff()
	return true
end
...
function modifier_sven_great_cleave_custom_break_cd:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_break_cd:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_break_cd:RemoveOnDeath()
	return false
end

modifier_sven_great_cleave_custom_break = class({})
function modifier_sven_great_cleave_custom_break:IsHidden()
	return true
end
function modifier_sven_great_cleave_custom_break:IsPurgable()
	return false
end
function modifier_sven_great_cleave_custom_break:CheckState()
	return { [MODIFIER_STATE_PASSIVES_DISABLED] = true }
end
function modifier_sven_great_cleave_custom_break:GetEffectName()
