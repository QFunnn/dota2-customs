...
LinkLuaModifier(
	"modifier_sven_warcry_custom_legendary_recast",
	"abilities/sven/sven_warcry_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_warcry_custom_legendary_barrier",
	"abilities/sven/sven_warcry_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_warcry_custom_legendary_barrier_knock_cd",
	"abilities/sven/sven_warcry_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sven_warcry_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/units/heroes/hero_snapfire/hero_snapfire_shotgun_pointblank_impact_sparks.vpcf",
		context
	)
	PrecacheResource(
		"particle",
...
function sven_warcry_custom:OnSpellStart()
	...
	local warcry_duration = self:GetSpecialValueFor("duration")
		+ caster:GetTalentValue("modifier_sven_cry_2", "duration")
	...
	for _, ally in pairs(allies) do
		...
		if caster:HasTalent("modifier_sven_cry_5") then
			ally:AddNewModifier(
				caster,
				self,
				"modifier_sven_warcry_custom_unslow",
				{ duration = caster:GetTalentValue("modifier_sven_cry_5", "duration") }
			)
		end
	end
...
function modifier_sven_warcry_custom:IsHidden()
	return false
end
...
function modifier_sven_warcry_custom:GetEffectAttachType()
...
function modifier_sven_warcry_custom:GetModifierAttackSpeedBonus_Constant()
	if not self.caster:HasTalent("modifier_sven_cry_3") then
		return
	end
	return self.speed
end
...
function modifier_sven_warcry_custom:GetModifierConstantHealthRegen()
	if not self.caster:HasTalent("modifier_sven_cry_1") then
		return
	end
...
function modifier_sven_warcry_custom_armor:IsHidden()
	return false
end
function modifier_sven_warcry_custom_armor:IsPurgable()
	return false
end
function modifier_sven_warcry_custom_armor:GetTexture()
	return "buffs/cry_reduce"
end
...
function modifier_sven_warcry_custom_slow:IsHidden()
	return false
end
function modifier_sven_warcry_custom_slow:IsPurgable()
	return false
end
function modifier_sven_warcry_custom_slow:GetTexture()
	return "buffs/cry_lowhp"
end
...
function modifier_sven_warcry_custom_resist:IsHidden()
	return false
end
function modifier_sven_warcry_custom_resist:IsPurgable()
	return false
end
function modifier_sven_warcry_custom_resist:GetTexture()
	return "buffs/cry_lowhp"
end
...
function modifier_sven_warcry_custom_tracker:IsPurgable()
	return false
end
...
function modifier_sven_warcry_custom_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_sven_cry_6") then
		return
	end
	...
	if #enemies > 0 then
		self.parent:AddNewModifier(
			self.parent,
			self.ability,
			"modifier_sven_warcry_custom_resist",
...
function modifier_sven_warcry_custom_tracker:GetModifierMoveSpeedBonus_Percentage()
	...
	if self.parent:HasModifier("modifier_sven_warcry_custom") then
		return
	end
...
function modifier_sven_warcry_custom_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_sven_cry_4") then
		return
	end
	...
	if not self.parent:HasModifier("modifier_sven_warcry_custom") then
		return
	end
...
function modifier_sven_warcry_custom_unslow:IsHidden()
	return true
end
function modifier_sven_warcry_custom_unslow:IsPurgable()
	return false
end
...
function modifier_sven_warcry_custom_legendary:IsHidden()
	return false
end
function modifier_sven_warcry_custom_legendary:IsPurgable()
	return false
end
function modifier_sven_warcry_custom_legendary:GetTexture()
	return "buffs/cry_legendary"
end
function modifier_sven_warcry_custom_legendary:OnCreated(table)
	...
	self.max = math.max(
		1,
		self.parent:GetTalentValue("modifier_sven_cry_7", "shield") * self.parent:GetPhysicalArmorValue(false)
	)
...
function modifier_sven_warcry_custom_quest:IsHidden()
	return true
end
function modifier_sven_warcry_custom_quest:IsPurgable()
	return false
end

modifier_sven_warcry_custom_legendary_recast = class({})
function modifier_sven_warcry_custom_legendary_recast:IsHidden()
	return true
end
function modifier_sven_warcry_custom_legendary_recast:IsPurgable()
	return false
end

modifier_sven_warcry_custom_legendary_barrier = class({})
function modifier_sven_warcry_custom_legendary_barrier:IsHidden()
	return true
end
function modifier_sven_warcry_custom_legendary_barrier:IsPurgable()
	return false
end
...
function modifier_sven_warcry_custom_legendary_barrier:OnIntervalThink()
	...
	for _, target in pairs(enemies) do
		if
			...
			and not target:HasModifier("modifier_sven_warcry_custom_legendary_barrier_knock_cd")
		then
...
function modifier_sven_warcry_custom_legendary_barrier_knock_cd:IsHidden()
	return true
end
function modifier_sven_warcry_custom_legendary_barrier_knock_cd:IsPurgable()
	return false
end

modifier_sven_warcry_custom_burn = class({})
function modifier_sven_warcry_custom_burn:IsHidden()
	return true
end
function modifier_sven_warcry_custom_burn:IsPurgable()
	return false
end
function modifier_sven_warcry_custom_burn:OnCreated()
	...
	self.particle =
		ParticleManager:CreateParticle("particles/sven/cry_radiance.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
