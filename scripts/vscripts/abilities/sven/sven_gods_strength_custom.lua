...
LinkLuaModifier(
	"modifier_sven_gods_strength_custom",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_root",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_tracker",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_legendary_stack",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_crit_armor",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_crit_slow",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_crit_anim",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_crit_anim2",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_str_bonus",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_proc_cd",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_root_cd",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_root_unmiss",
	"abilities/sven/sven_gods_strength_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sven_gods_strength_custom:LegendaryStack(count)
	...
	if not caster:HasTalent("modifier_sven_god_7") then
		return
	end
	local ability = caster:FindAbilityByName("sven_gods_strength_custom_legendary")
	if not ability or ability:GetCooldownTimeRemaining() > 0 then
		return
	end
	...
	for i = 1, count do
		caster:AddNewModifier(
			...
			self,
			"modifier_sven_gods_strength_custom_legendary_stack",
			{ duration = caster:GetTalentValue("modifier_sven_god_7", "duration", true) }
		)
	end
end
...
function sven_gods_strength_custom:ProcUlt(main)
	...
	local duration = self:GetSpecialValueFor("gods_strength_duration")
		+ caster:GetTalentValue("modifier_sven_god_3", "duration")
	...
	if caster:HasTalent("modifier_sven_god_6") then
		caster:AddNewModifier(
			...
			{ duration = caster:GetTalentValue("modifier_sven_god_6", "bkb"), effect = 1 }
		)
	end
...
function modifier_sven_gods_strength_custom:IsHidden()
	return true
end
...
function modifier_sven_gods_strength_custom_root:IsHidden()
	return false
end
function modifier_sven_gods_strength_custom_root:IsPurgable()
	return true
end
function modifier_sven_gods_strength_custom_root:GetTexture()
	return "buffs/hook_root"
end
...
function modifier_sven_gods_strength_custom_tracker:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_tracker:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_tracker:GetModifierAttackSpeedBonus_Constant()
	if not self.parent:HasTalent("modifier_sven_god_1") then
		return
	end
...
function modifier_sven_gods_strength_custom_tracker:GetModifierBaseAttack_BonusDamage()
	if not self.parent:HasTalent("modifier_sven_god_4") then
		return
	end
...
function modifier_sven_gods_strength_custom_tracker:UpdateUI()
	...
	if not self.parent:HasTalent("modifier_sven_god_7") then
		return
	end
...
function modifier_sven_gods_strength_custom_tracker:CheckState()
	if not self.parent:HasModifier("modifier_sven_gods_strength_custom") then
		return
	end
	if not self.parent:HasTalent("modifier_sven_god_5") then
		return
	end
	if self.parent:HasModifier("modifier_sven_gods_strength_custom_root_cd") then
		return
	end
	return {
...
function modifier_sven_gods_strength_custom_tracker:AttackEvent_out(params)
	...
	if mod then
		...
		if
			self.parent:HasTalent("modifier_sven_god_5")
			...
			for _, target in pairs(targets) do
				if not target:HasModifier("modifier_sven_gods_strength_custom_root") then
					target:AddNewModifier(
						...
						self.ability,
						"modifier_sven_gods_strength_custom_root",
						{ duration = (1 - target:GetStatusResistance()) * self.root_duration }
					)
				end
			end
		end
...
function modifier_sven_gods_strength_custom_tracker:DamageEvent_inc(params)
	...
	if
		not self.parent:PassivesDisabled()
		and not self.parent:HasModifier("modifier_death")
		and self.parent:HasTalent("modifier_sven_god_6")
		and self.parent:GetHealthPercent() <= self.parent:GetTalentValue("modifier_sven_god_6", "health")
		and not self.parent:HasModifier("modifier_sven_gods_strength_custom_proc_cd")
	then
...
function sven_gods_strength_custom_legendary:OnSpellStart()
	...
	local mod_crit = caster:AddNewModifier(
		caster,
		self,
		"modifier_sven_gods_strength_custom_crit",
		{ crit = crit * rage, duration = FrameTime() * 2 }
	)
...
function modifier_sven_gods_strength_custom_crit:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_crit:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_crit_armor:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_crit_armor:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_crit_armor:OnCreated(table)
	self.armor = math.max(
		0,
		self:GetParent():GetPhysicalArmorValue(false)
			* self:GetCaster():GetTalentValue("modifier_sven_god_7", "armor")
			/ 100
	) * -1
end
...
function modifier_sven_gods_strength_custom_crit_slow:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_crit_slow:IsPurgable()
	return true
end
...
function modifier_sven_gods_strength_custom_crit_anim:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_crit_anim:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_crit_anim2:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_crit_anim2:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_str_bonus:IsHidden()
	return false
end
function modifier_sven_gods_strength_custom_str_bonus:IsPurgable()
	return false
end
function modifier_sven_gods_strength_custom_str_bonus:GetTexture()
	return "buffs/spear_str"
end
...
function modifier_sven_gods_strength_custom_root_cd:IsHidden()
	return false
end
function modifier_sven_gods_strength_custom_root_cd:IsPurgable()
	return false
end
function modifier_sven_gods_strength_custom_root_cd:RemoveOnDeath()
	return false
end
function modifier_sven_gods_strength_custom_root_cd:IsDebuff()
	return true
end
function modifier_sven_gods_strength_custom_root_cd:GetTexture()
...
function modifier_sven_gods_strength_custom_root_unmiss:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_root_unmiss:IsPurgable()
	return false
end
...
function modifier_sven_gods_strength_custom_proc_cd:IsHidden()
	return false
end
function modifier_sven_gods_strength_custom_proc_cd:IsPurgable()
	return false
end
function modifier_sven_gods_strength_custom_proc_cd:RemoveOnDeath()
	return false
end
function modifier_sven_gods_strength_custom_proc_cd:IsDebuff()
	return true
end
function modifier_sven_gods_strength_custom_proc_cd:GetTexture()
	return "buffs/god_proc"
end
...
function modifier_sven_gods_strength_custom_legendary_stack:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_legendary_stack:IsPurgable()
	return false
end
