...
function modifier_sven_innate_custom:IsHidden()
	return true
end
function modifier_sven_innate_custom:IsPurgable()
	return false
end
function modifier_sven_innate_custom:RemoveOnDeath()
	return false
end
...
function modifier_sven_innate_custom_buff:IsHidden()
	return false
end
function modifier_sven_innate_custom_buff:IsPurgable()
	return false
end
function modifier_sven_innate_custom_buff:OnCreated(table)
	...
	self.outgoing = self:GetAbility():GetSpecialValueFor("outgoing")
		+ self.parent:GetTalentValue("modifier_sven_cleave_2", "damage")
	self.incoming = self:GetAbility():GetSpecialValueFor("incoming")
		+ self.parent:GetTalentValue("modifier_sven_cleave_2", "damage") * -1
end
