...
LinkLuaModifier(
	"modifier_alchemist_unstable_concoction_custom_tracker",
	"abilities/alchemist/alchemist_unstable_concoction_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_alchemist_unstable_concoction_custom:OnCreated(kv)
	...
	if self.parent:HasTalent("modifier_alchemist_unstable_legendary") then
		self.parent:UpdateUIshort({
			...
			max_time = self.time,
			stack = self.legendary_damage,
			style = "AlchemistUnstable",
		})
	end
...
function modifier_alchemist_unstable_concoction_custom:OnIntervalThink()
	...
	if self.parent:HasTalent("modifier_alchemist_unstable_legendary") then
		self.parent:UpdateUIshort({
			...
			max_time = self.time,
			stack = self.legendary_damage,
			active = self:GetElapsedTime() >= self.max_brew,
			style = "AlchemistUnstable",
		})
	end
...
function modifier_alchemist_unstable_concoction_custom_bonus:GetTexture()
	return "buffs/alchemist/unstable_3"
end
...
function modifier_alchemist_unstable_concoction_custom_charge_effect:GetEffectName()
	return "particles/econ/events/ti10/phase_boots_ti10.vpcf"
end
function modifier_alchemist_unstable_concoction_custom_charge_effect:GetStatusEffectName()
	return "particles/status_fx/status_effect_forcestaff.vpcf"
end
function modifier_alchemist_unstable_concoction_custom_charge_effect:StatusEffectPriority()
...
function modifier_alchemist_unstable_concoction_custom_tracker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_alchemist_unstable_concoction_custom_tracker:GetModifierAura()
...
function modifier_alchemist_unstable_concoction_custom_damage_aura:OnIntervalThink()
	...
	self.damageTable.damage = self.caster:HasModifier("modifier_alchemist_unstable_concoction_custom")
