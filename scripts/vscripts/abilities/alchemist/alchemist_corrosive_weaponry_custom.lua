...
function alchemist_corrosive_weaponry_custom:OnProjectileHitHandle(target, vLocation, iProjectileHandle)
	...
	target:AddNewModifier(
		...
		"modifier_alchemist_corrosive_weaponry_custom_legendary_slow",
		{ duration = caster:GetTalentValue("modifier_alchemist_greed_legendary", "slow_duration") }
	)
	target:AddNewModifier(
		caster,
		self,
		"modifier_alchemist_corrosive_weaponry_custom_legendary",
		{ duration = caster:GetTalentValue("modifier_alchemist_greed_legendary", "duration") }
	)
end
...
function modifier_alchemist_corrosive_weaponry_custom:AttackRecordEvent_out(params)
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_alchemist_corrosive_weaponry_custom_speed",
		{ duration = self.ability.talents.speed_duration, stack = stack }
	)
end
...
function modifier_alchemist_corrosive_weaponry_custom:AttackEvent_out(params)
	...
	if
		self.ability.talents.has_proc == 1
...
function modifier_alchemist_corrosive_weaponry_custom_debuff:IsHidden()
	return false
end
function modifier_alchemist_corrosive_weaponry_custom_debuff:IsPurgable()
	return not self.caster:HasTalent("modifier_alchemist_greed_4")
end
...
function modifier_alchemist_corrosive_weaponry_custom_debuff:OnRefresh(table)
	...
	if not self.caster:HasTalent("modifier_alchemist_greed_4") then
		return
	end
...
function modifier_alchemist_corrosive_weaponry_custom_poison:OnCreated()
	...
	self.damageTable = {
		...
		damage_type = self.ability.talents.proc_damage_type,
		damage = damage,
	}
