...
LinkLuaModifier(
	"modifier_life_stealer_innate_custom_tracker",
	"abilities/life_stealer/life_stealer_innate_custom",
...
function modifier_life_stealer_innate_custom_tracker:GetModifierAttackSpeedBonus_Constant()
	...
	return math.min(
		self.ability.attack_speed_init + self.ability.attack_speed_inc * self.caster:GetLevel(),
		self.ability.attack_speed_max
	) + self.parent:GetUpgradeStack("modifier_life_stealer_feast_custom_speed_bonus") * self.ability.talents.e1_speed
end