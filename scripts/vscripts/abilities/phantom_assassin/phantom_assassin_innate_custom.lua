...
LinkLuaModifier(
	"modifier_phantom_assassin_innate_custom_cd",
	"abilities/phantom_assassin/phantom_assassin_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_phantom_assassin_innate_custom:IsHidden()
	return true
end
function modifier_phantom_assassin_innate_custom:IsPurgable()
	return false
end
