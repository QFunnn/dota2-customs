...
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_dagger_poisonstack",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_double_proc",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_vision",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_heal",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_absorb",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_phantom_assassin_stifling_absorb_cd",
	"abilities/phantom_assassin/custom_phantom_assassin_stifling_dagger",
	LUA_MODIFIER_MOTION_NONE
)
...
function custom_phantom_assassin_stifling_dagger:OnSpellStart(new_target)
	...
	if caster:HasTalent("modifier_phantom_assassin_dagger_2") and not new_target then
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_phantom_assassin_stifling_heal",
			{ duration = caster:GetTalentValue("modifier_phantom_assassin_dagger_2", "duration") }
		)
	end
...
function custom_phantom_assassin_stifling_dagger:OnProjectileHit_ExtraData(hTarget, vLocation, table)
	...
	hTarget:AddNewModifier(
		caster,
		caster:BkbAbility(self, caster:HasTalent("modifier_phantom_assassin_dagger_5")),
		"modifier_custom_phantom_assassin_stifling_dagger_slow",
		{ duration = duration * (1 - hTarget:GetStatusResistance()) }
	)

	if
		caster:GetQuest() == "Phantom.Quest_5"
		and (hTarget:GetAbsOrigin() - caster:GetAbsOrigin()):Length2D() >= caster.quest.number
	...
	caster:PerformAttack(
		...
		true,
		true,
		caster:HasTalent("modifier_phantom_assassin_dagger_5"),
		false,
		false,
		true
	)
...
function modifier_custom_phantom_assassin_stifling_dagger_attack:IsHidden()
	return true
end
function modifier_custom_phantom_assassin_stifling_dagger_attack:IsPurgable()
	return false
end
...
function modifier_custom_phantom_assassin_stifling_dagger_slow:IsHidden()
	return false
end
...
function modifier_custom_phantom_assassin_stifling_dagger_slow:OnCreated(kv)
	...
	if self.caster:HasTalent("modifier_phantom_assassin_dagger_5") then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_custom_phantom_assassin_stifling_vision",
			{ duration = self.caster:GetTalentValue("modifier_phantom_assassin_dagger_5", "duration") }
		)
	else
...
function modifier_custom_phantom_assassin_stifling_dagger_poisonstack:IsPurgable()
	return true
end
function modifier_custom_phantom_assassin_stifling_dagger_poisonstack:IsHidden()
	return false
end
function modifier_custom_phantom_assassin_stifling_dagger_poisonstack:GetTexture()
	return "buffs/dagger_damage"
end
...
function modifier_custom_phantom_assassin_stifling_dagger_poisonstack:OnCreated(table)
	...
	self.damage = self.interval
		* (self.caster:GetTalentValue("modifier_phantom_assassin_dagger_3", "damage") / self.duration)
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:IsHidden()
	return not self:GetParent():HasTalent("modifier_phantom_assassin_dagger_7")
end
function modifier_custom_phantom_assassin_stifling_dagger_tracker:IsPurgable()
	return false
end
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:OnCreated()
	...
	self.poison_duration = self.parent:GetTalentValue("modifier_phantom_assassin_dagger_3", "duration", true)
		+ FrameTime() * 2
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:GetAbsorbSpell(params)
	...
	if not self.parent:HasTalent("modifier_phantom_assassin_dagger_6") then
		return
	end
	if self.parent:HasModifier("modifier_custom_phantom_assassin_stifling_absorb_cd") then
		return
	end
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:GetModifierCastRangeBonusStacking()
	if not self.parent:HasTalent("modifier_phantom_assassin_dagger_5") then
		return
	end
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:GetModifierPercentageCooldown()
	if not self.parent:HasTalent("modifier_phantom_assassin_dagger_4") then
		return
	end
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_phantom_assassin_dagger_3") then
		return
	end
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:SpellEvent(params)
	...
	if not RollPseudoRandomPercentage(chance, 1923, self.parent) then
		return
	end
	...
	if target then
		if params.ability == self.ability then
			self.parent:AddNewModifier(
				...
				self.ability,
				"modifier_custom_phantom_assassin_stifling_double_proc",
				{ target = target:entindex(), duration = self.auto_delay }
			)
		else
...
function modifier_custom_phantom_assassin_stifling_dagger_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_phantom_assassin_dagger_7") then
		return
	end
	if self:GetStackCount() <= 0 then
		return
...
function modifier_custom_phantom_assassin_stifling_legendary_cast:IsHidden()
	return true
end
function modifier_custom_phantom_assassin_stifling_legendary_cast:IsPurgable()
	return false
end
...
function modifier_custom_phantom_assassin_stifling_double_proc:IsHidden()
	return true
end
function modifier_custom_phantom_assassin_stifling_double_proc:IsPurgable()
	return false
end
function modifier_custom_phantom_assassin_stifling_double_proc:GetAttributes()
...
function modifier_custom_phantom_assassin_stifling_vision:IsHidden()
	return false
end
function modifier_custom_phantom_assassin_stifling_vision:IsPurgable()
	return false
end
function modifier_custom_phantom_assassin_stifling_vision:GetTexture()
	return "buffs/odds_mark"
end
...
function modifier_custom_phantom_assassin_stifling_heal:IsHidden()
	return false
end
function modifier_custom_phantom_assassin_stifling_heal:IsPurgable()
	return false
end
function modifier_custom_phantom_assassin_stifling_heal:GetTexture()
	return "buffs/phantom_slow"
end
...
function modifier_custom_phantom_assassin_stifling_absorb_cd:IsPurgable()
	return false
end
function modifier_custom_phantom_assassin_stifling_absorb_cd:IsHidden()
	return false
end
function modifier_custom_phantom_assassin_stifling_absorb_cd:GetTexture()
	return "buffs/sprout_move"
end
function modifier_custom_phantom_assassin_stifling_absorb_cd:IsDebuff()
	return true
end
...
function modifier_custom_phantom_assassin_stifling_absorb:IsHidden()
	return true
end
function modifier_custom_phantom_assassin_stifling_absorb:IsPurgable()
	return false
end
function modifier_custom_phantom_assassin_stifling_absorb:GetTexture()
	return "buffs/sprout_move"
end
