...
LinkLuaModifier(
	...
	"abilities/broodmother_insatiable_hunger_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_broodmother_insatiable_hunger_custom_cooldown",
	"abilities/broodmother_insatiable_hunger_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_broodmother_insatiable_hunger_custom:IsPurgeException()
	return false
end
function modifier_broodmother_insatiable_hunger_custom:RemoveOnDeath()
	return false
end
...
function modifier_broodmother_insatiable_hunger_custom:GetModifierPreAttack_BonusDamage(params)
	...
	if not self.parent:HasModifier("modifier_broodmother_insatiable_hunger") then
		return
	end
	...
	if self.parent:HasModifier("modifier_broodmother_insatiable_hunger_custom_cooldown") then
		return
	end
...
function modifier_broodmother_insatiable_hunger_custom_cooldown:IsHidden()
	return true
end
function modifier_broodmother_insatiable_hunger_custom_cooldown:IsPurgeException()
	return false
end
function modifier_broodmother_insatiable_hunger_custom_cooldown:IsPurgable()
	return false
end