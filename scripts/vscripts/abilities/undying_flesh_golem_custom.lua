...
LinkLuaModifier(
	"modifier_undying_flesh_golem_custom_fly",
	"abilities/undying_flesh_golem_custom",
...
function modifier_undying_flesh_golem_custom_fly:IsHidden()
	return true
end
function modifier_undying_flesh_golem_custom_fly:IsPurgable()
	return false
end
function modifier_undying_flesh_golem_custom_fly:IsPurgeException()
	return false
end
...
function modifier_undying_flesh_golem_custom_fly:OnIntervalThink()
	...
	local bHasRoll = self.caster:HasModifier("modifier_pangolier_gyroshell")
		or self.caster:HasModifier("modifier_pangolier_rollup")
