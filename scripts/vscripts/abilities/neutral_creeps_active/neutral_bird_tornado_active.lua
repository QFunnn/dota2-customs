...
LinkLuaModifier(
	"modifier_bird_tornado_active_tornado",
	"abilities/neutral_creeps_active/neutral_bird_tornado_active",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_bird_tornado_active_tornado_slow",
	"abilities/neutral_creeps_active/neutral_bird_tornado_active",
	LUA_MODIFIER_MOTION_NONE
)
...
function neutral_bird_tornado_active:OnSpellStart()
	...
	local tornado =
		CreateUnitByName("npc_dota_enraged_wildkin_tornado", point, true, nil, nil, real_caster:GetTeamNumber())
...
function modifier_bird_tornado_active_tornado:IsPurgable()
	return false
end
function modifier_bird_tornado_active_tornado:IsHidden()
	return true
end
...
function modifier_bird_tornado_active_tornado:GetModifierHealthBarPips()
	return self.health
end
function modifier_bird_tornado_active_tornado:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_bird_tornado_active_tornado:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_bird_tornado_active_tornado:GetAbsoluteNoDamagePure()
	return 1
end
...
function modifier_bird_tornado_active_tornado:AttackEvent_inc(param)
	...
	if self.parent ~= param.target then
		return
	end
...
function modifier_bird_tornado_active_tornado:IsAura()
	return true
end
function modifier_bird_tornado_active_tornado:GetAuraDuration()
	return 0.1
end
function modifier_bird_tornado_active_tornado:GetAuraRadius()
	return self.aoe
end
function modifier_bird_tornado_active_tornado:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_bird_tornado_active_tornado:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_bird_tornado_active_tornado:GetModifierAura()
	return "modifier_bird_tornado_active_tornado_slow"
end

modifier_bird_tornado_active_tornado_slow = class({})
function modifier_bird_tornado_active_tornado_slow:IsHidden()
	return false
end
function modifier_bird_tornado_active_tornado_slow:IsPurgable()
	return true
end
function modifier_bird_tornado_active_tornado_slow:GetTexture()
