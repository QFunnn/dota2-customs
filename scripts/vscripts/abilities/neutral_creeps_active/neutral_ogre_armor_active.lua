...
LinkLuaModifier(
	"modifier_ogre_armor_active_armor",
	"abilities/neutral_creeps_active/neutral_ogre_armor_active",
...
function modifier_ogre_armor_active_armor:IsPurgable()
	return true
end
function modifier_ogre_armor_active_armor:IsHidden()
	return false
end
...
function modifier_ogre_armor_active_armor:GetEffectName()
	return "particles/neutral_fx/ogre_magi_frost_armor.vpcf"
end
function modifier_ogre_armor_active_armor:GetEffectAttachType()
	return PATTACH_OVERHEAD_FOLLOW
end

function modifier_ogre_armor_active_armor:GetModifierMagicalResistanceBonus()
	return self.magic
end
function modifier_ogre_armor_active_armor:GetModifierPhysicalArmorBonus()
	return self.armor
end
