...
local a = "abilities/greevil_effect/greevil_effect_21"
...
g.greevil_effect_21 = c()
local m = g.greevil_effect_21
m.name = "greevil_effect_21"
d(m, l)
...
function m.prototype.spawn(self)
	self:AddCourierBuff("modifier_greevil_effect_21", {})
...
g.modifier_greevil_effect_21 = c()
local o = g.modifier_greevil_effect_21
o.name = "modifier_greevil_effect_21"
d(o, i)
function o.prototype.GetAbilitySpecialValue(self)
	self.interest_limit_bonus = self:GetGreevilEffectValueFor("greevil_effect_21", "interest_limit_bonus")
end
...
g.modifier_greevil_effect_21 = o
return g