...
LinkLuaModifier(
	"modifier_sven_gods_strength_custom_fly",
	"abilities/sven_gods_strength_custom",
...
function modifier_sven_gods_strength_custom_fly:IsHidden()
	return true
end
function modifier_sven_gods_strength_custom_fly:IsPurgable()
	return false
end
function modifier_sven_gods_strength_custom_fly:IsPurgeException()
	return false
end
