...
LinkLuaModifier(
	"modifier_item_alchemist_gold_skadi",
	"abilities/items/item_alchemist_gold_skadi",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_alchemist_gold_skadi_debuff",
	"abilities/items/item_alchemist_gold_skadi",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_alchemist_gold_skadi_debuff_active",
	"abilities/items/item_alchemist_gold_skadi",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_alchemist_gold_skadi_buff",
	"abilities/items/item_alchemist_gold_skadi",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_alchemist_gold_skadi_stun",
	"abilities/items/item_alchemist_gold_skadi",
	LUA_MODIFIER_MOTION_NONE
)
...
function item_alchemist_gold_skadi:OnSpellStart()
	...
	local target_mod = caster:GetTeamNumber() == target:GetTeamNumber() and "modifier_item_alchemist_gold_skadi_buff"
		or "modifier_item_alchemist_gold_skadi_debuff_active"
...
function modifier_item_alchemist_gold_skadi_debuff_active:GetEffectName()
...
function modifier_item_alchemist_gold_skadi_debuff_active:OnStackCountChanged(iStackCount)
	...
	if not self.effect_cast then
		self.effect_cast = self.parent:GenericParticle(
...
function modifier_item_alchemist_gold_skadi:GetModifierProcAttack_BonusDamage_Physical(params)
	...
	if
		self.parent:HasModifier("modifier_item_skadi_custom")
		or self.parent:HasModifier("modifier_item_disperser")
		or self.parent:HasModifier("modifier_item_diffusal_blade")
	then
		return
	end
