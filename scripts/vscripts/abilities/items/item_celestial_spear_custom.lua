...
LinkLuaModifier(
	"modifier_item_celestial_spear_custom",
	"abilities/items/item_celestial_spear_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_celestial_spear_custom_armor",
	"abilities/items/item_celestial_spear_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_item_celestial_spear_custom:AttackEvent_out(params)
	...
	target:AddNewModifier(
		...
		"modifier_item_celestial_spear_custom_armor",
		{ armor = self.ability.armor_reduce, duration = self.corruption_duration }
	)
