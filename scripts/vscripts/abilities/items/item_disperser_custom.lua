...
LinkLuaModifier(
	"modifier_item_disperser_custom_debuff_active",
	"abilities/items/item_disperser_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_disperser_custom_debuff_active_buff",
	"abilities/items/item_disperser_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_disperser_custom_debuff_active:GetEffectName()
