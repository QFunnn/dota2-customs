...
LinkLuaModifier(
	"modifier_item_essence_of_speed_auto",
...
function item_essence_of_speed:OnSpellStart()
	...
	if caster:HasModifier("modifier_item_essence_of_speed") then
		return
	end
...
function modifier_item_essence_of_speed_auto:OnIntervalThink()
	...
	if self.parent:HasModifier("modifier_item_essence_of_speed") then
		return
	end
