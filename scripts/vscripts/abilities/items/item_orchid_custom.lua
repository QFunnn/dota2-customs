...
function item_orchid_custom:OnSpellStart()
	...
	target:AddNewModifier(
		caster,
		self,
		"modifier_item_orchid_custom_debuff",
...
function modifier_item_orchid_custom_debuff:OnCreated(table)
	...
	local hit_effect =
		ParticleManager:CreateParticle("particles/items2_fx/orchid.vpcf", PATTACH_CUSTOMORIGIN_FOLLOW, self.parent)
...
function modifier_item_orchid_custom:RemoveOnDeath()
	return false
end
