...
LinkLuaModifier(
	"modifier_item_specialists_array_custom",
	"abilities/items/item_specialists_array_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_specialists_array_custom_damage",
	"abilities/items/item_specialists_array_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_specialists_array_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_specialists_array_custom:AttackStartEvent_out(params)
	...
	if not RollPseudoRandomPercentage(self.ability.proc_chance, 9403, self.parent) then
		return
	end
