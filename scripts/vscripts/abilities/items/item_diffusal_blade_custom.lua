...
LinkLuaModifier(
	"modifier_item_diffusal_blade_custom",
	"abilities/items/item_diffusal_blade_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_diffusal_blade_custom_debuff_active",
	"abilities/items/item_diffusal_blade_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function item_diffusal_blade_custom:OnSpellStart()
	...
	target:AddNewModifier(
		...
		self,
		"modifier_item_diffusal_blade_custom_debuff_active",
		{ duration = self.purge_slow_duration * (1 - target:GetStatusResistance()) }
	)
end
...
function modifier_item_diffusal_blade_custom_debuff_active:GetEffectName()
...
function modifier_item_diffusal_blade_custom:RemoveOnDeath()
	return false
end
