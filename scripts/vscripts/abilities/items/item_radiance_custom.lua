...
function modifier_radiance_custom_stats:RemoveOnDeath()
	return false
end
...
function modifier_radiance_custom_toggle:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_radiance_custom_toggle:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_radiance_custom_toggle:GetModifierAura()
