...
LinkLuaModifier(
	"modifier_item_witch_blade_custom_passive",
	"abilities/items/item_witch_blade_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_witch_blade_custom_poison",
	"abilities/items/item_witch_blade_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_witch_blade_custom_passive:AttackEvent_out(params)
	...
	if self.parent:HasModifier("modifier_item_devastator_custom_passive") then
		return
	end
	if not params.target:IsUnit() then
		return
...
function modifier_item_witch_blade_custom_poison:GetEffectName()
