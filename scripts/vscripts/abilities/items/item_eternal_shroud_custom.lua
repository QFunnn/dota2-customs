...
LinkLuaModifier(
	"modifier_item_eternal_shroud_custom",
	"abilities/items/item_eternal_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_eternal_shroud_custom_active",
	"abilities/items/item_eternal_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_eternal_shroud_custom_active_count",
	"abilities/items/item_eternal_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
