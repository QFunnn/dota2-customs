...
local modifier_item_0470_lightning_rod = ____item_0470.modifier_item_0470_lightning_rod
...
____exports.item_0345 = __TS__Class()
local item_0345 = ____exports.item_0345
item_0345.name = "item_0345"
__TS__ClassExtends(item_0345, BaseItem_CS)
function item_0345.prototype.Precache(self, context)
	PrecacheResource("particle", "particles/units/heroes/hero_leshrac/leshrac_lightning_bolt.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_zuus.vsndevts", context)
end
function item_0345.prototype.GetIntrinsicModifierName(self)
	return ____exports.modifier_item_0345_lightning_rod.name
end
item_0345 = __TS__DecorateLegacy({ registerAbility(nil) }, item_0345)
____exports.item_0345 = item_0345
____exports.modifier_item_0345_lightning_rod = __TS__Class()
local modifier_item_0345_lightning_rod = ____exports.modifier_item_0345_lightning_rod
modifier_item_0345_lightning_rod.name = "modifier_item_0345_lightning_rod"
__TS__ClassExtends(modifier_item_0345_lightning_rod, BaseModifier_CS)
function modifier_item_0345_lightning_rod.prototype.DeclareEvents(self)
	return { BusinessEvents.ON_AFTER_ABILITY_FULLY_CAST }
end
function modifier_item_0345_lightning_rod.prototype.IsHidden(self)
	return true
end
function modifier_item_0345_lightning_rod.prototype.IsPurgable(self)
	return false
end
function modifier_item_0345_lightning_rod.prototype.OnAfterAbilityFullyCast_CS(self, event)
	...
	if parent:HasModifier(modifier_item_0470_lightning_rod.name) then
		return
	end
...
function modifier_item_0345_lightning_rod.prototype.StrikeLightning(
	self,
	caster,
	ability,
...
function modifier_item_0345_lightning_rod.prototype.SelectTarget(self, caster, ability)
...
function modifier_item_0345_lightning_rod.prototype.GetHitCount(self, hitRecords, targetIndex)
...
function modifier_item_0345_lightning_rod.prototype.AddHitRecord(self, hitRecords, targetIndex)
	for ____, record in ipairs(hitRecords) do
		do
			if record.targetIndex ~= targetIndex then
				goto __continue35
...
function modifier_item_0345_lightning_rod.prototype.GetDamageMultiplier(self, ability, hitCount)
	local ability_same_target_decay_pct =
		math.min(100, math.max(0, ability:GetSpecialValueFor("ability_same_target_decay_pct")))
	local decayMultiplier = 1 - ability_same_target_decay_pct / 100
	return math.pow(decayMultiplier, hitCount)
end
function modifier_item_0345_lightning_rod.prototype.ApplyLightningDamage(self, caster, ability, target, damage)
	Damage:ApplyDamage({
		attacker = caster,
		victim = target,
		damage = damage,
...
function modifier_item_0345_lightning_rod.prototype.PlayEffects1(self, caster, target)
...
modifier_item_0345_lightning_rod = __TS__DecorateLegacy({ registerModifier(nil) }, modifier_item_0345_lightning_rod)
____exports.modifier_item_0345_lightning_rod = modifier_item_0345_lightning_rod
return ____exports