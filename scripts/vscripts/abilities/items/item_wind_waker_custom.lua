...
LinkLuaModifier(
	"modifier_item_wind_waker_custom_active",
	"abilities/items/item_wind_waker_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_wind_waker_custom_speed",
	"abilities/items/item_wind_waker_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function item_wind_waker_custom:OnSpellStart()
	...
	target:Purge(target ~= caster, target == caster, false, false, false)
	...
	target:AddNewModifier(
		...
		self,
		"modifier_item_wind_waker_custom_active",
		{ duration = self.cyclone_duration, particle_name = pfx_name }
	)
...
function modifier_item_wind_waker_custom_active:IsPurgable()
	return true
end
...
function modifier_item_wind_waker_custom_speed:IsPurgable()
	return true
end
