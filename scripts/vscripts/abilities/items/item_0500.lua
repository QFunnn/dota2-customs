...
____exports.item_0500 = __TS__Class()
local item_0500 = ____exports.item_0500
item_0500.name = "item_0500"
__TS__ClassExtends(item_0500, BaseItem_CS)
function item_0500.prototype.GetIntrinsicModifierName(self)
	return ____exports.modifier_item_0500_thorn_shield.name
end
item_0500 = __TS__DecorateLegacy({ registerAbility(nil) }, item_0500)
____exports.item_0500 = item_0500
____exports.modifier_item_0500_thorn_shield = __TS__Class()
local modifier_item_0500_thorn_shield = ____exports.modifier_item_0500_thorn_shield
modifier_item_0500_thorn_shield.name = "modifier_item_0500_thorn_shield"
__TS__ClassExtends(modifier_item_0500_thorn_shield, BaseModifier_CS)
function modifier_item_0500_thorn_shield.prototype.____constructor(self, ...)
...
function modifier_item_0500_thorn_shield.prototype.DeclareEvents(self)
	return { BusinessEvents.ON_DEAL_DAMAGE }
end
function modifier_item_0500_thorn_shield.prototype.GetAttributes(self)
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_item_0500_thorn_shield.prototype.OnCreated(self)
...
function modifier_item_0500_thorn_shield.prototype.OnIntervalThink(self)
	if not IsServer() then
		return
	end
	if not self:IsDynamicSageItem() then
...
function modifier_item_0500_thorn_shield.prototype.GetAttributeBonus(self)
...
function modifier_item_0500_thorn_shield.prototype.IsHidden(self)
	return true
end
function modifier_item_0500_thorn_shield.prototype.IsPurgable(self)
	return false
end
function modifier_item_0500_thorn_shield.prototype.OnDealDamage_CS(self, event)
	if not IsServer() then
		return
	end
...
function modifier_item_0500_thorn_shield.prototype.PlayEffects(self, parent, radius)
...
function modifier_item_0500_thorn_shield.prototype.IsSageBoots(self)
	local ____opt_0 = self:GetAbility()
	return (____opt_0 and ____opt_0:GetAbilityName()) == "item_0336"
end
function modifier_item_0500_thorn_shield.prototype.IsSageCloak(self)
	local ____opt_2 = self:GetAbility()
	return (____opt_2 and ____opt_2:GetAbilityName()) == "item_0335"
end
function modifier_item_0500_thorn_shield.prototype.IsDynamicSageItem(self)
	return self:IsSageBoots() or self:IsSageCloak()
end
function modifier_item_0500_thorn_shield.prototype.RecalculateDynamicBonus(self, forceRefresh)
	if self:IsSageBoots() then
...
function modifier_item_0500_thorn_shield.prototype.RecalculateMysticBonus(self, forceRefresh)
	local parent = self:GetParent()
...
function modifier_item_0500_thorn_shield.prototype.RecalculateSageHealthBonus(self, forceRefresh)
	local parent = self:GetParent()
	if not IsValid(nil, parent) then
		return
	end
...
modifier_item_0500_thorn_shield = __TS__DecorateLegacy({ registerModifier(nil) }, modifier_item_0500_thorn_shield)
____exports.modifier_item_0500_thorn_shield = modifier_item_0500_thorn_shield
return ____exports