...
LinkLuaModifier(
	"modifier_item_heavens_halberd_custom_speed",
	"abilities/items/item_heavens_halberd_custom",
	LUA_MODIFIER_MOTION_HORIZONTAL
)
...
function modifier_item_heavens_halberd_custom_disarm:IsHidden()
	return true
end
function modifier_item_heavens_halberd_custom_disarm:IsPurgable()
	return false
end
...
function modifier_item_heavens_halberd_custom_speed:IsHidden()
	return false
end
function modifier_item_heavens_halberd_custom_speed:IsPurgable()
	return true
end
