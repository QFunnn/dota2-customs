...
function modifier_item_giants_ring_custom_buff:IsHidden()
	return true
end
function modifier_item_giants_ring_custom_buff:IsPurgable()
	return false
end
function modifier_item_giants_ring_custom_buff:RemoveOnDeath()
	return false
end
function modifier_item_giants_ring_custom_buff:IsBuff()
	return true
end
function modifier_item_giants_ring_custom_buff:AllowIllusionDuplicate()
	return true
end
...
function modifier_item_giants_ring_custom_buff:OnCreated()
	...
	if
		...
		or self.parent:IsTempestDouble()
		or self.parent:IsClone()
		or self.parent:IsMonkeyClone()
	then
		return
	end
