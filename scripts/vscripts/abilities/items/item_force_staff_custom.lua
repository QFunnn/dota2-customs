...
LinkLuaModifier(
	"modifier_item_force_staff_custom_active",
	"abilities/items/item_force_staff_custom",
...
function modifier_item_force_staff_custom_active:GetStatusEffectName()
	return "particles/status_fx/status_effect_forcestaff.vpcf"
end
function modifier_item_force_staff_custom_active:StatusEffectPriority()
