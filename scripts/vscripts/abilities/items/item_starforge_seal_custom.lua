...
LinkLuaModifier(
	"modifier_item_starforge_seal_custom_leash",
	"abilities/items/item_starforge_seal_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function item_starforge_seal_custom:OnSpellStart()
	...
	CreateModifierThinker(
		...
		self,
		"modifier_item_starforge_seal_custom_thinker",
		{ duration = self:GetSpecialValueFor("max_duration"), damage_k = self.multicast_k or 1 },
		position,
...
function modifier_item_starforge_seal_custom_thinker:IsHidden()
	return true
end
function modifier_item_starforge_seal_custom_thinker:IsPurgable()
	return false
end
...
function modifier_item_starforge_seal_custom_burn:IsHidden()
	return false
end
...
function modifier_item_starforge_seal_custom_stun:IsHidden()
	return true
end
function modifier_item_starforge_seal_custom_stun:IsPurgable()
	return false
end
...
function modifier_item_starforge_seal_custom_stun:OnDestroy()
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_item_starforge_seal_custom_leash",
		{ duration = self.leash_duration * (1 - self.parent:GetStatusResistance()) }
	)
...
function modifier_item_starforge_seal_custom_stats:IsHidden()
	return true
end
function modifier_item_starforge_seal_custom_stats:IsPurgable()
	return false
end
...
function modifier_item_starforge_seal_custom_leash:IsPurgable()
	return true
end
