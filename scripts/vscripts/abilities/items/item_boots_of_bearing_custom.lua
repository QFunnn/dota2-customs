...
for _,unit in pairs(units) do 
    ...
    unit:AddNewModifier(caster, self, "modifier_item_boots_of_bearing_custom_haste", {duration = self.bonus_ms_duration})
end 
...
function modifier_item_boots_of_bearing_custom:GetAuraSearchTeam() return DOTA_UNIT_TARGET_TEAM_FRIENDLY end
function modifier_item_boots_of_bearing_custom:GetAuraSearchType() return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO end
function modifier_item_boots_of_bearing_custom:GetModifierAura() return "modifier_item_boots_of_bearing_custom_aura" end
function modifier_item_boots_of_bearing_custom:GetAuraRadius() return self.ability.radius end
