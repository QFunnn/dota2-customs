...
LinkLuaModifier(
	"modifier_item_crellas_crozier_custom_stats",
	"abilities/items/item_crellas_crozier_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_crellas_crozier_custom_active",
	"abilities/items/item_crellas_crozier_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_crellas_crozier_custom_aura",
	"abilities/items/item_crellas_crozier_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_crellas_crozier_custom_health_reduce",
	"abilities/items/item_crellas_crozier_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_crellas_crozier_custom_health_bonus",
	"abilities/items/item_crellas_crozier_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_crellas_crozier_custom_aura:GetModifierMoveSpeedBonus_Percentage()
	if not self.caster:HasModifier("modifier_item_crellas_crozier_custom_active") then
		return
	end
	return self.slow
end
...
function modifier_item_crellas_crozier_custom_aura:GetModifierHealChange()
	return (
		self.caster:HasModifier("modifier_item_crellas_crozier_custom_active") and self.active_reduce
		or self.heal_reduction
	)
end
...
function modifier_item_crellas_crozier_custom_active:IsPurgable()
	return true
end
...
function modifier_item_crellas_crozier_custom_active:OnIntervalThink()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/items8_fx/crellas_crozier_pulses.vpcf",
	...
	for _, target in pairs(targets) do
		if target:IsRealHero() then
			...
			local particle = ParticleManager:CreateParticle(
				"particles/items8_fx/crellas_crozier_pulses_target.vpcf",
...
function modifier_item_crellas_crozier_custom_health_bonus:GetAttributes()
