...
LinkLuaModifier(
	...
	"abilities/items/item_soulguard_custom",
	...
	if mod then
		...
		if target:IsRealHero() then
			CustomGameEventManager:Send_ServerToPlayer(
				PlayerResource:GetPlayer(target:GetPlayerOwnerID()),
				"generic_sound",
				{ sound = "DOTA_Item.BladeMail.Damage" }
			)
		end
		...
		local caster_pfx = ParticleManager:CreateParticle(
			"particles/units/heroes/hero_queenofpain/queenofpain_return.vpcf",
...
function modifier_item_soulguard_custom_reflect:GetEffectName()
	return "particles/items/soulguard_active.vpcf"
end
