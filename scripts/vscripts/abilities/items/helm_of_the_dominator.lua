...
item_helm_of_the_dominator_custom = item_helm_of_the_dominator_custom
	or {
...
LinkLuaModifier(
	...
	"abilities/items/helm_of_the_dominator",
	LUA_MODIFIER_MOTION_NONE
)

modifier_item_helm_of_the_dominator_custom = modifier_item_helm_of_the_dominator_custom
	or {
		IsHidden = function()
			return true
		end,
...
modifier_item_helm_of_the_dominator_custom_dominated = {
	...
	GetModifierModelScale = function(self)
		return self.bonus_model_scale
	end,
	GetEffectName = function(self)
		return "particles/items5_fx/helm_of_the_dominator_buff.vpcf"
	end,
}
