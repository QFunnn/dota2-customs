...
LinkLuaModifier(
	"modifier_item_alchemist_gold_heart",
	"abilities/items/item_alchemist_gold_heart",
...
LinkLuaModifier(
	"modifier_item_alchemist_gold_heart_buff_effect",
	"abilities/items/item_alchemist_gold_heart",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_alchemist_gold_heart_burn",
	"abilities/items/item_alchemist_gold_heart",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_alchemist_gold_heart:GetModifierBonusStats_Strength()
	if self.parent:HasModifier("modifier_item_heart_custom") then
		return
	end
...
function modifier_item_alchemist_gold_heart:GetModifierHealthRegenPercentage()
	...
	return self.parent:HasModifier("modifier_item_alchemist_gold_heart_buff")
			and (self.health_regen_pct + (self.active_regen * (1 - self.parent:GetHealthPercent() / 100)))
...
function modifier_item_alchemist_gold_heart_buff:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_item_alchemist_gold_heart_buff:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_item_alchemist_gold_heart_buff:GetModifierAura()
	return "modifier_item_alchemist_gold_heart_buff_effect"
end
...
function modifier_item_alchemist_gold_heart_burn:OnIntervalThink()
	...
	self.damageTable.damage = self.caster:HasModifier("modifier_item_alchemist_gold_heart_buff")
			and damage * self.active_bonus
		or damage
