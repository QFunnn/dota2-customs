...
LinkLuaModifier(
	...
	"abilities/items/item_hand_of_midas_custom",
...
function item_hand_of_midas_custom:GiveBonuses(target, givegold)
	...
	local name =
		wearables_system:GetParticleReplacementAbility(self:GetCaster(), "particles/items2_fx/hand_of_midas.vpcf", self)
