...
LinkLuaModifier(
	"modifier_item_angels_demise_custom",
	"abilities/items/item_angels_demise_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_angels_demise_custom_break",
	"abilities/items/item_angels_demise_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_angels_demise_custom_cd",
	"abilities/items/item_angels_demise_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_angels_demise_custom:DamageEvent_out(params)
	...
	local chance = unit:FindModifierByNameAndCaster("modifier_item_angels_demise_custom_break", self.parent)
			and self.crit_bonus
		or self.crit_chance
