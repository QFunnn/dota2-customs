...
LinkLuaModifier(
	"modifier_item_idol_of_screeauk_custom",
	"abilities/items/neutral/item_idol_of_screeauk_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_idol_of_screeauk_custom_bonus",
	"abilities/items/neutral/item_idol_of_screeauk_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_idol_of_screeauk_custom:AttackEvent_inc(params)
	...
	if not players[params.attacker:GetId()] then
		return
	end
...
function modifier_item_idol_of_screeauk_custom_bonus:IsPurgable()
	return true
end
