...
LinkLuaModifier(
	"modifier_item_dandelion_amulet_custom",
	"abilities/items/neutral/item_dandelion_amulet_custom",
...
function modifier_item_dandelion_amulet_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_dandelion_amulet_custom_shield:OnCreated(params)
	...
	local hit_effect = ParticleManager:CreateParticle(
		"particles/items7_fx/medallion_of_valor_friend.vpcf",
