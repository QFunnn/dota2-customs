...
LinkLuaModifier(
	...
	"abilities/items/neutral/item_kobold_cup_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_kobold_cup_custom_movespeed",
	"abilities/items/neutral/item_kobold_cup_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_kobold_cup_custom:IsAura()
	return true
end
function modifier_item_kobold_cup_custom:GetAuraDuration()
	return 0
end
function modifier_item_kobold_cup_custom:GetAuraRadius()
	return self.radius
end
function modifier_item_kobold_cup_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_item_kobold_cup_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_item_kobold_cup_custom:GetModifierAura()
	return "modifier_item_kobold_cup_custom_movespeed"
end
