...
LinkLuaModifier(
	"modifier_item_cloak_of_flames_custom_aura",
	"abilities/items/neutral/item_cloak_of_flames_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_cloak_of_flames_custom_tracker",
	"abilities/items/neutral/item_cloak_of_flames_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_cloak_of_flames_custom_tracker:GetAuraRadius()
	return self.radius
end
function modifier_item_cloak_of_flames_custom_tracker:GetAuraSearchFlags()
	return 0
end
function modifier_item_cloak_of_flames_custom_tracker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_item_cloak_of_flames_custom_tracker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_item_cloak_of_flames_custom_tracker:GetModifierAura()
	return "modifier_item_cloak_of_flames_custom_aura"
end
