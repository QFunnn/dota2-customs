...
LinkLuaModifier(
	"modifier_item_stormcrafter_custom",
	"abilities/items/neutral/item_stormcrafter_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_stormcrafter_custom_slow",
	"abilities/items/neutral/item_stormcrafter_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_stormcrafter_custom:RemoveOnDeath()
	return false
end
