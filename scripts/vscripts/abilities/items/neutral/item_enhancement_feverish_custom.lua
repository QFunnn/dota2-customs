...
LinkLuaModifier(
	"modifier_item_enhancement_feverish_custom",
	"abilities/items/neutral/item_enhancement_feverish_custom",
...
function modifier_item_enhancement_feverish_custom:RemoveOnDeath()
	return false
end
