...
LinkLuaModifier(
	"modifier_item_searing_signet_custom",
	"abilities/items/neutral/item_searing_signet_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_searing_signet_custom_burn",
	"abilities/items/neutral/item_searing_signet_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_searing_signet_custom:DamageEvent_out(params)
	...
	if params.original_damage <= self.damage_threshold then
		return
	end
