...
LinkLuaModifier(
	"modifier_item_defiant_shell_custom",
	"abilities/items/neutral/item_defiant_shell_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_defiant_shell_custom_damage",
	"abilities/items/neutral/item_defiant_shell_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_defiant_shell_custom:AttackStartEvent_inc(params)
	...
	if
		(target:GetAbsOrigin() - self.parent:GetAbsOrigin()):Length2D() > (self.parent:Script_GetAttackRange() + 100)
	then
		return
	end
