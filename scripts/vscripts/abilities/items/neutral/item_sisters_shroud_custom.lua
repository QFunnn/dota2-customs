...
LinkLuaModifier(
	"modifier_item_sisters_shroud_custom",
	"abilities/items/neutral/item_sisters_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_sisters_shroud_custom_evasion",
	"abilities/items/neutral/item_sisters_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_sisters_shroud_custom_blocked",
	"abilities/items/neutral/item_sisters_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_sisters_shroud_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_sisters_shroud_custom_evasion:GetTexture()
	return "item_sisters_shroud"
end
...
function modifier_item_sisters_shroud_custom_evasion:AttackFailEvent_inc(params)
	...
	if params.fail_type ~= 3 and params.fail_type ~= 2 then
		return
	end
