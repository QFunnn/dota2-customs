...
LinkLuaModifier(
	...
	"abilities/items/neutral/item_crippling_crossbow_custom",
...
function modifier_item_crippling_crossbow_custom:IsPurgable()
	return true
end
function modifier_item_crippling_crossbow_custom:GetEffectName()
	return "particles/items4_fx/hefty_crossbow_debuff.vpcf"
end
