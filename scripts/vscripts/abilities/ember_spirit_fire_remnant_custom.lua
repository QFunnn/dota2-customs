...
LinkLuaModifier(
	"modifier_ember_spirit_fire_remnant_custom",
	"abilities/ember_spirit_fire_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ember_spirit_fire_remnant_custom_thinker",
	"abilities/ember_spirit_fire_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ember_spirit_activate_fire_remnant_custom_blast_timer",
	"abilities/ember_spirit_fire_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function ember_spirit_fire_remnant_custom:Cast(name, target)
	...
	local remnant_unit =
		CreateUnitByName("npc_dota_ember_spirit_remnant", StartPosition, false, caster, caster, caster:GetTeamNumber())
	...
	remnant_unit.mod = caster:AddNewModifier(
		caster,
		self,
		"modifier_ember_spirit_fire_remnant_custom_timer",
	...
	remnant_unit:AddNewModifier(
		...
		self,
		"modifier_ember_spirit_activate_fire_remnant_custom_blast_timer",
		{ duration = (StartPosition - TargetPosition):Length2D() / remnant_speed }
	)
end

modifier_ember_spirit_fire_remnant_custom = class({})
function modifier_ember_spirit_fire_remnant_custom:IsHidden()
	return true
end
function modifier_ember_spirit_fire_remnant_custom:IsPurgable()
	return false
end
...
function modifier_ember_spirit_fire_remnant_custom_thinker:IsDebuff()
	return false
end
function modifier_ember_spirit_fire_remnant_custom_thinker:IsHidden()
	return false
end
function modifier_ember_spirit_fire_remnant_custom_thinker:IsPurgable()
	return false
end
...
function modifier_ember_spirit_activate_fire_remnant_custom_blast_timer:IsHidden()
	return true
end
function modifier_ember_spirit_activate_fire_remnant_custom_blast_timer:IsPurgable()
	return false
end
function modifier_ember_spirit_activate_fire_remnant_custom_blast_timer:OnDestroy()
	...
	if self:GetParent().mod == nil then
		return
	end
...
function modifier_ember_spirit_fire_remnant_custom_timer:IsHidden()
	return false
end
function modifier_ember_spirit_fire_remnant_custom_timer:IsPurgable()
	return false
end
