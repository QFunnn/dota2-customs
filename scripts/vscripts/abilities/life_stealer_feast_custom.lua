...
function modifier_life_stealer_feast_custom:IsHidden()
	return true
end
function modifier_life_stealer_feast_custom:IsPurgable()
	return false
end
function modifier_life_stealer_feast_custom:IsPurgeException()
	return false
end
function modifier_life_stealer_feast_custom:RemoveOnDeath()
	return false
end
