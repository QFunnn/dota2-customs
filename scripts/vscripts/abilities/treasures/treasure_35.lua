...
local a = "abilities/treasures/treasure_35"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_35"
end
n = e({ j(nil) }, n)
g.treasure_35 = n
g.modifier_treasure_35 = c()
local q = g.modifier_treasure_35
q.name = "modifier_treasure_35"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "110",
				special_value_name = "n_110_chance",
