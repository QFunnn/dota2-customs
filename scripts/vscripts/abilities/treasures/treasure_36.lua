...
local a = "abilities/treasures/treasure_36"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_36"
end
n = e({ j(nil) }, n)
g.treasure_36 = n
g.modifier_treasure_36 = c()
local q = g.modifier_treasure_36
q.name = "modifier_treasure_36"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "117",
				special_value_name = "n_117_bonus",
