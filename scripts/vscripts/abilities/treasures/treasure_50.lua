...
local a = "abilities/treasures/treasure_50"
...
local o = "89_effect_1"
g.treasure_50 = c()
local p = g.treasure_50
p.name = "treasure_50"
d(p, i)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_50"
end
p = e({ j(nil) }, p)
g.treasure_50 = p
g.modifier_treasure_50 = c()
local q = g.modifier_treasure_50
q.name = "modifier_treasure_50"
d(q, l)
