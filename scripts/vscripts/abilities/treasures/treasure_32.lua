...
local a = "abilities/treasures/treasure_32"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_32"
end
n = e({ j(nil) }, n)
g.treasure_32 = n
g.modifier_treasure_32 = c()
local q = g.modifier_treasure_32
q.name = "modifier_treasure_32"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "85",
				special_value_name = "n_85_chance",
