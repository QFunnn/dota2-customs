...
local a = "abilities/treasures/treasure_34"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_34"
end
n = e({ j(nil) }, n)
g.treasure_34 = n
g.modifier_treasure_34 = c()
local q = g.modifier_treasure_34
q.name = "modifier_treasure_34"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "103",
				special_value_name = "n_103_chance",
