...
local a = "abilities/treasures/treasure_29"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_29"
end
n = e({ j(nil) }, n)
g.treasure_29 = n
g.modifier_treasure_29 = c()
local q = g.modifier_treasure_29
q.name = "modifier_treasure_29"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "51",
				special_value_name = "n_51_gain_reduce_pct",
				operator = ABILITY_UPGRADES_OP.ABILITY_UPGRADES_OP_ADD,
				value = self.value,
			}
		)
		PlayerData:getHero(p):refreshAbility()
	end
end
