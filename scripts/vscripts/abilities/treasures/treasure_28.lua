...
local a = "abilities/treasures/treasure_28"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_28"
end
n = e({ j(nil) }, n)
g.treasure_28 = n
g.modifier_treasure_28 = c()
local q = g.modifier_treasure_28
q.name = "modifier_treasure_28"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "40",
				special_value_name = "n_40_max_crit",
