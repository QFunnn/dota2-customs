...
local a = "abilities/treasures/treasure_27"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_27"
end
n = e({ j(nil) }, n)
g.treasure_27 = n
g.modifier_treasure_27 = c()
local q = g.modifier_treasure_27
q.name = "modifier_treasure_27"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "26",
				special_value_name = "n_26_max_evade",
