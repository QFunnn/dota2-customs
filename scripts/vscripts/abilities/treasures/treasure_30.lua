...
local a = "abilities/treasures/treasure_30"
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_treasure_30"
end
n = e({ j(nil) }, n)
g.treasure_30 = n
g.modifier_treasure_30 = c()
local q = g.modifier_treasure_30
q.name = "modifier_treasure_30"
d(q, l)
	...
	if IsServer() then
		...
		AbilityUpgrades:AddSpecialValueUpgrade(
			p,
			{
				...
				ability_name = "64",
				special_value_name = "n_64_regen_reduce",
