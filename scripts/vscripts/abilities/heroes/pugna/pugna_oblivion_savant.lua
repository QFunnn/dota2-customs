...
LinkLuaModifier(
	"modifier_pugna_oblivion_savant_custom",
	"abilities/heroes/pugna/pugna_oblivion_savant",
...
function modifier_pugna_oblivion_savant_custom:IsHidden()
	return true
end
function modifier_pugna_oblivion_savant_custom:IsPurgable()
	return false
end
function modifier_pugna_oblivion_savant_custom:RemoveOnDeath()
	return false
end
