...
LinkLuaModifier(
	"modifier_terrorblade_reflection_lua_controller",
	"abilities/heroes/terrorblade/modifier_terrorblade_reflection_lua_controller",
...
function terrorblade_reflection_lua:ApplySlowAndCreateIllusion(enemy, delay)
	...
	Timers:CreateTimer(delay, function()
		...
		local existing_modifier =
			enemy:FindModifierByNameAndCaster("modifier_terrorblade_reflection_lua_controller", caster)
		...
		local illusion = CreateIllusions(caster, enemy, {
