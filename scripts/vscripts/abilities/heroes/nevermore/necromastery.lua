...
function modifier_nevermore_necromastery_auto:IsHidden()
	return true
end
function modifier_nevermore_necromastery_auto:IsPurgable()
	return false
end
function modifier_nevermore_necromastery_auto:RemoveOnDeath()
	return false
end
