...
LinkLuaModifier(
	"modifier_dragon_knight_inherited_vigor_lua",
	"abilities/heroes/dragon_knight/dragon_knight_inherited_vigor",
...
function modifier_dragon_knight_inherited_vigor_lua:IsHidden()
	return false
end
function modifier_dragon_knight_inherited_vigor_lua:IsDebuff()
	return false
end
function modifier_dragon_knight_inherited_vigor_lua:IsPurgable()
	return false
end
...
function modifier_dragon_knight_inherited_vigor_lua:OnCreated(keys)
	...
	self.regen_and_armor_multiplier_during_dragon_form = self.ability:GetSpecialValueFor(
