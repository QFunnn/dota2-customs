...
LinkLuaModifier ("modifier_devour_endurance_aura", "abilities/heroes/doom/devour_endurance_aura", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier ("modifier_devour_endurance_aura_buff", "abilities/heroes/doom/devour_endurance_aura", LUA_MODIFIER_MOTION_NONE)
