...
LinkLuaModifier(
	"modifier_devour_toughness_aura",
	"abilities/heroes/doom/devour_toughness_aura",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_devour_toughness_aura_buff",
	"abilities/heroes/doom/devour_toughness_aura",
	LUA_MODIFIER_MOTION_NONE
)
...
modifier_devour_toughness_aura = modifier_devour_toughness_aura
	or class({
...
function modifier_devour_toughness_aura:OnRefresh()
	self:OnCreated()
end
...
modifier_devour_toughness_aura_buff = modifier_devour_toughness_aura_buff
	or class({
		IsHidden = function(self)
			return false
		end,
