...
LinkLuaModifier ("modifier_devour_toughness_aura", "abilities/heroes/doom/devour_toughness_aura", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier ("modifier_devour_toughness_aura_buff", "abilities/heroes/doom/devour_toughness_aura", LUA_MODIFIER_MOTION_NONE)
