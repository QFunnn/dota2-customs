...
LinkLuaModifier(
	"modifier_devour_enrage_attack_speed",
	"abilities/heroes/doom/devour_enrage_attack_speed.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_devour_enrage_attack_speed_buff",
	"abilities/heroes/doom/devour_enrage_attack_speed.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_devour_enrage_attack_speed:IsHidden()
	return true
end
function modifier_devour_enrage_attack_speed:IsPurgable()
	return false
end
function modifier_devour_enrage_attack_speed:IsDebuff()
	return false
end
...
function modifier_devour_enrage_attack_speed:OnDeath(kv)
	...
	if not kv.unit or not kv.attacker or not kv.unit:IsRealHero() or kv.unit:IsReincarnating() then
		return
	end
...
function modifier_devour_enrage_attack_speed_buff:IsHidden()
	return false
end
function modifier_devour_enrage_attack_speed_buff:IsPurgable()
	return true
end
function modifier_devour_enrage_attack_speed_buff:IsDebuff()
	return false
end
...
function modifier_devour_enrage_attack_speed_buff:GetModifierAttackSpeedBonus_Constant()
