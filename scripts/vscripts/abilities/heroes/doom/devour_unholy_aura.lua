...
LinkLuaModifier(
	"modifier_devour_unholy_aura_buff",
	"abilities/heroes/doom/devour_unholy_aura",
...
modifier_devour_unholy_aura = modifier_devour_unholy_aura
	or class({
...
modifier_devour_unholy_aura_buff = modifier_devour_unholy_aura_buff
	or class({
		IsHidden = function(self)
			return false
		end,
