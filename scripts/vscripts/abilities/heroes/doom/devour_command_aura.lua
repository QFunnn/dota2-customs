...
LinkLuaModifier(
	"modifier_devour_command_aura_buff",
	"abilities/heroes/doom/devour_command_aura",
...
modifier_devour_command_aura = modifier_devour_command_aura
	or class({
...
modifier_devour_command_aura_buff = modifier_devour_command_aura_buff
	or class({
		IsHidden = function(self)
			return false
		end,
