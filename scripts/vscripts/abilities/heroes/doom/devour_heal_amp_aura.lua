...
LinkLuaModifier(
	"modifier_devour_heal_amp_aura_buff",
	"abilities/heroes/doom/devour_heal_amp_aura",
...
modifier_devour_heal_amp_aura = modifier_devour_heal_amp_aura
	or class({
...
modifier_devour_heal_amp_aura_buff = modifier_devour_heal_amp_aura_buff
	or class({
		IsHidden = function(self)
			return false
		end,
