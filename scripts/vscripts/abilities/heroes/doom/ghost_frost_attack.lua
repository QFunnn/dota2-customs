...
function modifer_ghost_frost_attack_lua:IsHidden()
	return true
end
function modifer_ghost_frost_attack_lua:IsPurgable()
	return false
end
function modifer_ghost_frost_attack_lua:GetAttributes()
