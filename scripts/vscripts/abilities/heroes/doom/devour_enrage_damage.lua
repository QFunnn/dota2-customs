...
LinkLuaModifier(
	"modifier_devour_enrage_damage",
	"abilities/heroes/doom/devour_enrage_damage.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_devour_enrage_damage_buff",
	"abilities/heroes/doom/devour_enrage_damage.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_devour_enrage_damage:IsHidden()
	return true
end
function modifier_devour_enrage_damage:IsPurgable()
	return false
end
function modifier_devour_enrage_damage:IsDebuff()
	return false
end
...
function modifier_devour_enrage_damage_buff:IsHidden()
	return false
end
function modifier_devour_enrage_damage_buff:IsPurgable()
	return true
end
function modifier_devour_enrage_damage_buff:IsDebuff()
	return false
end
...
function modifier_devour_enrage_damage_buff:GetModifierBaseDamageOutgoing_Percentage()
