...
LinkLuaModifier(
	"modifier_devour_magic_amplification_aura",
	"abilities/heroes/doom/devour_magic_amplification_aura",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_devour_magic_amplification_aura_debuff",
	"abilities/heroes/doom/devour_magic_amplification_aura",
	LUA_MODIFIER_MOTION_NONE
)
...
modifier_devour_magic_amplification_aura = modifier_devour_magic_amplification_aura
	or class({
...
modifier_devour_magic_amplification_aura_debuff = modifier_devour_magic_amplification_aura_debuff
	or class({
		IsHidden = function(self)
			return false
		end,
