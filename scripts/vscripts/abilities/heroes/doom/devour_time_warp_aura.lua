...
LinkLuaModifier(
	"modifier_devour_time_warp_aura",
	"abilities/heroes/doom/devour_time_warp_aura",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_devour_time_warp_aura_buff",
	"abilities/heroes/doom/devour_time_warp_aura",
	LUA_MODIFIER_MOTION_NONE
)
...
modifier_devour_time_warp_aura = modifier_devour_time_warp_aura
	or class({
...
modifier_devour_time_warp_aura_buff = modifier_devour_time_warp_aura_buff
	or class({
		IsHidden = function(self)
			return false
		end,
