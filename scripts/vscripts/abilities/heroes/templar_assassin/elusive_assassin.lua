...
LinkLuaModifier(
	"modifier_templar_assassin_elusive_assassin_lua",
	"abilities/heroes/templar_assassin/elusive_assassin",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_elusive_assassin_buff_lua",
	"abilities/heroes/templar_assassin/elusive_assassin",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_templar_assassin_elusive_assassin_lua:IsHidden()
	return true
end
function modifier_templar_assassin_elusive_assassin_lua:IsDebuff()
	return false
end
function modifier_templar_assassin_elusive_assassin_lua:IsPurgable()
	return false
end
function modifier_templar_assassin_elusive_assassin_lua:RemoveOnDeath()
	return false
end
function modifier_templar_assassin_elusive_assassin_lua:GetAttributes()
...
function modifier_templar_assassin_elusive_assassin_lua:OnDestroy(kv) end
...
function modifier_templar_assassin_elusive_assassin_buff_lua:IsHidden()
	return false
end
function modifier_templar_assassin_elusive_assassin_buff_lua:IsDebuff()
	return false
end
function modifier_templar_assassin_elusive_assassin_buff_lua:IsPurgable()
	return false
end
