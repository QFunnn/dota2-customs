...
LinkLuaModifier(
	...
	"abilities/heroes/night_stalker/midnight_feast",
...
function night_stalker_midnight_feast_custom:GetBehavior()
	if not self:Get_IsDaytime() then
...
function night_stalker_midnight_feast_custom:OnSpellStart()
	...
	local hunter_pfx = ParticleManager:CreateParticle(
...
function modifier_night_stalker_midnight_feast_custom:IsDebuff()
	return false
end
...
function modifier_night_stalker_midnight_feast_custom:GetAttributes()
