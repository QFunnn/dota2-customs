...
function modifier_undying_tombstone_zombie:IsHidden()
	return true
end
function modifier_undying_tombstone_zombie:IsPurgable()
	return false
end
...
function modifier_undying_tombstone_zombie:GetModifierAvoidDamage(params)
	if not params.attacker or not IsValidEntity(params.attacker) then
		return
	end
