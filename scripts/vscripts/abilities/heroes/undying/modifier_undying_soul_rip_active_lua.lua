...
function modifier_undying_soul_rip_active_lua:IsPurgable()
	return false
end
function modifier_undying_soul_rip_active_lua:IsHidden()
	return false
end
function modifier_undying_soul_rip_active_lua:GetTexture()
	return "undying_soul_rip"
end
function modifier_undying_soul_rip_active_lua:GetEffectName()
	return "particles/units/heroes/hero_undying/soul_rip_buff.vpcf"
end
...
function modifier_undying_soul_rip_active_lua:GetModifierBonusStats_Strength()
	return self.strength_bonus
end
function modifier_undying_soul_rip_active_lua:GetModifierModelScale()
	return self.strength_share_model_scale
end