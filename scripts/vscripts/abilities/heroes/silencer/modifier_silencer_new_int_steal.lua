...
function modifier_silencer_new_int_steal:IsHidden()
	return false
end
function modifier_silencer_new_int_steal:IsPurgable()
	return false
end
function modifier_silencer_new_int_steal:IsPurgeException()
	return false
end
function modifier_silencer_new_int_steal:RemoveOnDeath()
	return false
end
...
function modifier_silencer_new_int_steal:OnHeroKilled(keys)
	...
	if
		keys.target
		and keys.target:IsRealHero()
		and (keys.reincarnate == false or keys.reincarnate == nil)
		and keys.target:GetTeam() ~= caster:GetTeam()
	then
