...
LinkLuaModifier(
	"modifier_necrolyte_heartstopper_aura_custom",
	"abilities/heroes/necrolyte/heartstopper_aura",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_heartstopper_aura_damage_effect_custom",
	"abilities/heroes/necrolyte/heartstopper_aura",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_heartstopper_aura_counter_custom",
	"abilities/heroes/necrolyte/heartstopper_aura",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_necrolyte_heartstopper_aura_custom:GetModifierAura()
	return "modifier_necrolyte_heartstopper_aura_damage_effect_custom"
end
...
modifier_necrolyte_heartstopper_aura_damage_effect_custom = modifier_necrolyte_heartstopper_aura_damage_effect_custom
	or class({})

function modifier_necrolyte_heartstopper_aura_damage_effect_custom:IsHidden()
	return self.is_hidden
end
function modifier_necrolyte_heartstopper_aura_damage_effect_custom:IsDebuff()
	return true
end
function modifier_necrolyte_heartstopper_aura_damage_effect_custom:IsPurgable()
	return false
end
...
function modifier_necrolyte_heartstopper_aura_damage_effect_custom:HandleEnemyVisibility()
	if not IsValidEntity(self.parent) or not IsValidEntity(self.caster) then
		return
	end
...
function modifier_necrolyte_heartstopper_aura_counter_custom:IsHidden()
	return false
end
function modifier_necrolyte_heartstopper_aura_counter_custom:IsPurgable()
	return false
end
function modifier_necrolyte_heartstopper_aura_counter_custom:IsDebuff()
	return false
end
