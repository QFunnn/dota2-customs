...
LinkLuaModifier(
	"modifier_leshrac_decrepify_aura_lua",
	"abilities/heroes/leshrac/leshrac_greater_lightning_storm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_leshrac_decrepify_caster_lua",
	"abilities/heroes/leshrac/leshrac_greater_lightning_storm",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_leshrac_decrepify_aura_lua:IsHidden()
	return true
end
function modifier_leshrac_decrepify_aura_lua:IsBuff()
	return true
end
function modifier_leshrac_decrepify_aura_lua:IsDebuff()
	return false
end
function modifier_leshrac_decrepify_aura_lua:IsPurgable()
	return true
end
function modifier_leshrac_decrepify_aura_lua:IsPurgeException()
	return false
end
function modifier_leshrac_decrepify_aura_lua:IsAura()
	return true
end
function modifier_leshrac_decrepify_aura_lua:GetModifierAura()
	return "modifier_leshrac_decrepify"
end
function modifier_leshrac_decrepify_aura_lua:GetAuraRadius()
	return self.radius
end
function modifier_leshrac_decrepify_aura_lua:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_leshrac_decrepify_aura_lua:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_leshrac_decrepify_aura_lua:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_leshrac_decrepify_aura_lua:GetAuraDuration()
	return 0.5
end
...
function modifier_leshrac_decrepify_aura_lua:OnCreated(kv)
	...
	self.nihilism_particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_leshrac/leshrac_scepter_nihilism_caster_custom.vpcf",
...
function modifier_leshrac_decrepify_caster_lua:IsHidden()
	return false
end
function modifier_leshrac_decrepify_caster_lua:IsBuff()
	return true
end
function modifier_leshrac_decrepify_caster_lua:IsDebuff()
	return false
end
function modifier_leshrac_decrepify_caster_lua:IsPurgable()
	return true
end
function modifier_leshrac_decrepify_caster_lua:IsPurgeException()
	return false
end
function modifier_leshrac_decrepify_caster_lua:GetEffectName()
	return "particles/units/heroes/hero_leshrac/leshrac_scepter_target.vpcf"
end
function modifier_leshrac_decrepify_caster_lua:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end
function modifier_leshrac_decrepify_caster_lua:GetStatusEffectName()
	return "particles/status_fx/status_effect_ghost.vpcf"
end
function modifier_leshrac_decrepify_caster_lua:StatusEffectPriority()
	return 15
end
