...
function modifier_oracle_prognosticate_lua:IsHidden()
	return false
end
function modifier_oracle_prognosticate_lua:IsDebuff()
	return false
end
function modifier_oracle_prognosticate_lua:IsPurgable()
	return false
end
function modifier_oracle_prognosticate_lua:RemoveOnDeath()
	return false
end
function modifier_oracle_prognosticate_lua:GetAttributes()
...
function modifier_oracle_prognosticate_lua:OnDestroy(kv) end
...
function modifier_oracle_prognosticate_lua:GetModifierAvoidDamage(event)
	...
	if not RollPercentage(self.backtrack_chance_pct) then
		return 0
	end

	local backtrack_pfx = ParticleManager:CreateParticle(
