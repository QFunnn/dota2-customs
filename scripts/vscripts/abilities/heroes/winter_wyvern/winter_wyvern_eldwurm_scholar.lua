...
LinkLuaModifier(
	"modifier_winter_wyvern_eldwurm_scholar_custom",
	"abilities/heroes/winter_wyvern/winter_wyvern_eldwurm_scholar",
...
function modifier_winter_wyvern_eldwurm_scholar_custom:IsHidden()
	return true
end
function modifier_winter_wyvern_eldwurm_scholar_custom:IsPurgable()
	return false
end
function modifier_winter_wyvern_eldwurm_scholar_custom:RemoveOnDeath()
	return false
end
...
function modifier_winter_wyvern_eldwurm_scholar_custom:OnOrbCaptured(event)
	if event.team ~= self.parent:GetTeam() then
		return
	end
