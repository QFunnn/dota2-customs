...
LinkLuaModifier(
	"modifier_lone_druid_spirit_bear_orb_capture",
	"abilities/heroes/lone_druid/spirit_bear_orb_capture",
...
function modifier_lone_druid_spirit_bear_orb_capture:IsHidden()
	return false
end
function modifier_lone_druid_spirit_bear_orb_capture:IsDebuff()
	return false
end
function modifier_lone_druid_spirit_bear_orb_capture:IsPurgable()
	return false
end
function modifier_lone_druid_spirit_bear_orb_capture:RemoveOnDeath()
	return false
end
function modifier_lone_druid_spirit_bear_orb_capture:GetAttributes()
...
function modifier_lone_druid_spirit_bear_orb_capture:GetModifierDamageOutgoing_Percentage(event)
	...
	if not event.attacker or not event.target then
		return
	end
	if self.caster ~= event.attacker then
		return
	end
	if not event.target:HasModifier("modifier_capturing_orb_custom") then
		return
	end
