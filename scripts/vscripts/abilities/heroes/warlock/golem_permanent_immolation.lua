...
LinkLuaModifier(
	"modifier_warlock_golem_permanent_immolation_lua",
	"abilities/heroes/warlock/golem_permanent_immolation",
...
function modifier_warlock_golem_permanent_immolation_lua:IsHidden()
	return true
end
function modifier_warlock_golem_permanent_immolation_lua:IsDebuff()
	return false
end
function modifier_warlock_golem_permanent_immolation_lua:IsPurgable()
	return false
end
...
function modifier_warlock_golem_permanent_immolation_lua:OnIntervalThink()
	...
	if not self.owner:HasModifier("modifier_fountain_rejuvenation_effect_lua") then
		damage = damage
			+ self.manahealthboost * self.owner:GetHealthRegen()
			+ self.manahealthboost * self.owner:GetManaRegen()
	end
