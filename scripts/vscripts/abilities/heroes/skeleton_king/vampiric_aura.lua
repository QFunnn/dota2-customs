...
function modifier_skeleton_king_vampiric_aura_auto:IsHidden()
	return true
end
function modifier_skeleton_king_vampiric_aura_auto:IsPurgable()
	return false
end
function modifier_skeleton_king_vampiric_aura_auto:RemoveOnDeath()
	return false
end
