...
LinkLuaModifier(
	"modifier_dark_seer_wall_of_replica_lua",
	"abilities/heroes/dark_seer/modifier_dark_seer_wall_of_replica",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dark_seer_wall_of_replica_lua_thinker",
	"abilities/heroes/dark_seer/modifier_dark_seer_wall_of_replica_lua_thinker",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dark_seer_wall_of_replica_lua_empower",
	"abilities/heroes/dark_seer/modifier_dark_seer_wall_of_replica_lua_empower",
	LUA_MODIFIER_MOTION_NONE
)
...
function dark_seer_wall_of_replica_lua:OnSpellStart()
	...
	CreateModifierThinker(caster, self, "modifier_dark_seer_wall_of_replica_lua_thinker", {
		duration = duration,
		dir_x = direction.x,
		dir_y = direction.y,
