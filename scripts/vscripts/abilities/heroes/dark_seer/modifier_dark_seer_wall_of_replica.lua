...
function modifier_dark_seer_wall_of_replica_lua:IsHidden()
	return true
end
function modifier_dark_seer_wall_of_replica_lua:IsPurgable()
	return false
end
function modifier_dark_seer_wall_of_replica_lua:GetAttributes()
