...
LinkLuaModifier(
	"modifier_primal_beast_colossal_custom",
	"abilities/heroes/primal_beast/primal_beast_colossal",
...
function modifier_primal_beast_colossal_custom:IsHidden()
	return (IsValidEntity(self.parent) and not self.parent:HasModifier("modifier_capturing_orb_custom"))
end
function modifier_primal_beast_colossal_custom:IsPurgable()
	return false
end
function modifier_primal_beast_colossal_custom:RemoveOnDeath()
	return false
end
...
function modifier_primal_beast_colossal_custom:GetModifierIncomingDamage_Percentage()
	...
	if self.parent:HasModifier("modifier_capturing_orb_custom") then
