...
LinkLuaModifier(
	"modifier_elder_titan_natural_order_lua",
	"abilities/heroes/elder_titan/elder_titan_natural_order",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_elder_titan_natural_order_aura_magic_resistance_lua",
	"abilities/heroes/elder_titan/elder_titan_natural_order",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_elder_titan_natural_order_magic_resistance_effect_lua",
	"abilities/heroes/elder_titan/elder_titan_natural_order",
	LUA_MODIFIER_MOTION_NONE
)
...
function elder_titan_natural_order_lua:OnUpgrade()
	...
	if caster:GetUnitName() == "npc_dota_elder_titan_ancestral_spirit" then
		return
	end
...
function modifier_elder_titan_natural_order_lua:IsHidden()
	return true
end
function modifier_elder_titan_natural_order_lua:IsDebuff()
	return false
end
function modifier_elder_titan_natural_order_lua:IsPurgable()
	return false
end
function modifier_elder_titan_natural_order_lua:GetAttributes()
...
function modifier_elder_titan_natural_order_lua:OnAbilityExecuted(keys)
	...
	if keys.ability:GetAbilityName() ~= "elder_titan_ancestral_spirit_lua" then
		return
	end -- the spirit does not have this ability
...
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:IsPurgable()
	return false
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:IsHidden()
	return true
end

function modifier_elder_titan_natural_order_aura_magic_resistance_lua:IsAura()
	return true
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:GetAuraRadius()
	return IsValidEntity(self.ability) and self.ability:GetSpecialValueFor("radius") or 0
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_INVULNERABLE + DOTA_UNIT_TARGET_FLAG_NOT_ANCIENTS
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_elder_titan_natural_order_aura_magic_resistance_lua:GetModifierAura()
	return "modifier_elder_titan_natural_order_magic_resistance_effect_lua"
end
...
modifier_elder_titan_natural_order_magic_resistance_effect_lua = modifier_elder_titan_natural_order_magic_resistance_effect_lua
	or class({})

function modifier_elder_titan_natural_order_magic_resistance_effect_lua:IsPurgable()
	return false
end
