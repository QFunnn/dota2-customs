...
LinkLuaModifier(
	...
	"abilities/heroes/elder_titan/elder_titan_tip_the_scales",
...
function modifier_elder_titan_tip_the_scales_lua:IsHidden()
	return true
end
function modifier_elder_titan_tip_the_scales_lua:IsDebuff()
	return false
end
function modifier_elder_titan_tip_the_scales_lua:IsPurgable()
	return false
end
function modifier_elder_titan_tip_the_scales_lua:RemoveOnDeath()
	return false
end
function modifier_elder_titan_tip_the_scales_lua:GetAttributes()
