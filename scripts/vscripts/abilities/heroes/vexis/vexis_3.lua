...
n = e(
	{
		m(nil, {
			funcCondition = function(C, y)
				...
				return y:GetAutoCastState()
					and (S and S:IsCombatRoom() and not S:IsCombatEnd() or AbyssalHordeManager:IsRunning())
			end,
		}),
	},
	n
...
function T.prototype.StaticState(self)
