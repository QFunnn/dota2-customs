...
function modifier_clinkz_wind_walk_fade_custom:IsHidden()
	return true
end
function modifier_clinkz_wind_walk_fade_custom:IsDebuff()
	return false
end
function modifier_clinkz_wind_walk_fade_custom:IsPurgable()
	return false
end
function modifier_clinkz_wind_walk_fade_custom:GetPriority()
	return 2
end
...
function modifier_clinkz_wind_walk_custom:IsHidden()
	return false
end
function modifier_clinkz_wind_walk_custom:IsDebuff()
	return false
end
function modifier_clinkz_wind_walk_custom:IsPurgable()
	return false
end
function modifier_clinkz_wind_walk_custom:GetPriority()
	return 1
end
...
function modifier_clinkz_wind_walk_custom:OnAttack(event)
	...
	if event.attacker ~= self.caster then
		return
	end
	if self.caster:HasModifier("modifier_clinkz_wind_walk_fade_custom") then
		return
	end -- During the fade time, Clinkz can cast abilities, use items and perform attacks without breaking the invisibility
...
function modifier_clinkz_wind_walk_custom:OnAbilityExecuted(keys)
	...
	if exceptions[keys.ability:GetAbilityName()] then
		return
	end
