...
function modifier_clinkz_death_pact_custom:IsHidden()
	return false
end
function modifier_clinkz_death_pact_custom:IsPurgable()
	return false
end
function modifier_clinkz_death_pact_custom:RemoveOnDeath()
	return true
end
...
function modifier_clinkz_death_pact_custom:CreateNeutralAbility(creep_name)
	local ability_name = self.neutral_creep_ability_map[creep_name]
		or self.consumed_gains_random_neutral[creep_name] and self:GetRandomNeutralAbility()
