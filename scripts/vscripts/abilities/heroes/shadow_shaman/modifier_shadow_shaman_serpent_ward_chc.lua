...
function modifier_shadow_shaman_serpent_ward_chc:IsHidden()
	return true
end
function modifier_shadow_shaman_serpent_ward_chc:IsPurgable()
	return false
end
function modifier_shadow_shaman_serpent_ward_chc:GetAttributes()
...
function modifier_shadow_shaman_serpent_ward_chc:OnAttackCompleted(record, original_target)
	...
	if self.bonus_attack_targets <= 0 then
		return
	end
