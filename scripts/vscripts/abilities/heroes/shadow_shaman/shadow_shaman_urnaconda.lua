...
LinkLuaModifier(
	"modifier_shadow_shaman_urnaconda_thinker",
	"abilities/heroes/shadow_shaman/shadow_shaman_urnaconda",
...
function modifier_shadow_shaman_urnaconda_thinker:IsHidden()
	return false
end
function modifier_shadow_shaman_urnaconda_thinker:IsDebuff()
	return false
end
function modifier_shadow_shaman_urnaconda_thinker:IsStunDebuff()
	return false
end
function modifier_shadow_shaman_urnaconda_thinker:IsPurgable()
	return true
end
...
function modifier_shadow_shaman_urnaconda_thinker:OnCreated(kv)
	...
	local effect_cast = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_shadowshaman/shadowshaman_snake_jar.vpcf",
		PATTACH_WORLDORIGIN,
		self.parent
	)
