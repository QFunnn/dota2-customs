...
LinkLuaModifier(
	"modifier_keeper_of_the_light_illuminate_custom_self_thinker",
	"abilities/heroes/keeper_of_the_light/illuminate.lua",
...
function keeper_of_the_light_illuminate_custom:OnSpellStart()
	...
	if self.caster:HasModifier("modifier_keeper_of_the_light_spirit_form") then
		self.spirit_particle = ParticleManager:CreateParticle(
...
modifier_keeper_of_the_light_illuminate_custom_self_thinker = modifier_keeper_of_the_light_illuminate_custom_self_thinker
	or class({}) -- Custom class for attempting non-channel logic

function modifier_keeper_of_the_light_illuminate_custom_self_thinker:IsPurgable()
	return false
end
...
function modifier_keeper_of_the_light_illuminate_custom:OnIntervalThink()
	...
	self.parent:SetOrigin(self.parent:GetAbsOrigin() + (self.direction * self.speed * FrameTime()))
end
...
function keeper_of_the_light_illuminate_end_custom:ProcsMagicStick()
	return false
end
...
function keeper_of_the_light_illuminate_end_custom:OnSpellStart()
	...
	if illuminate then
		...
		local illuminate_self_thinker =
			self.caster:FindModifierByName("modifier_keeper_of_the_light_illuminate_custom_self_thinker")
