...
LinkLuaModifier(
	"modifier_chen_summon_convert_lua",
	"abilities/heroes/chen/chen_summon_convert",
...
function chen_summon_convert_lua:GetIntrinsicModifierName()
	return "modifier_chen_summon_convert_lua"
end
...
function chen_summon_convert_lua:CycleSummonType()
	...
	if next_stacks > (#chen_summon_convert_lua.summon_types - 1) then
		next_stacks = 0
	end
...
function modifier_chen_summon_convert_lua:IsPurgable()
	return false
end
function modifier_chen_summon_convert_lua:IsHidden()
	return true
end