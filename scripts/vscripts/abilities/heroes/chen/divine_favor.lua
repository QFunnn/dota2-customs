...
function modifier_chen_divine_favor_aura_lua:IsHidden()
	return true
end
function modifier_chen_divine_favor_aura_lua:IsDebuff()
	return false
end
function modifier_chen_divine_favor_aura_lua:IsPurgable()
	return false
end
function modifier_chen_divine_favor_aura_lua:IsAura()
	return true
end
function modifier_chen_divine_favor_aura_lua:GetModifierAura()
	return "modifier_chen_divine_favor_lua"
end
function modifier_chen_divine_favor_aura_lua:GetAuraRadius()
	return self.aura_radius
end
function modifier_chen_divine_favor_aura_lua:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_chen_divine_favor_aura_lua:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_chen_divine_favor_aura_lua:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NOT_MAGIC_IMMUNE_ALLIES
end
function modifier_chen_divine_favor_aura_lua:GetAuraDuration()
	return 0.5
end
...
function modifier_chen_divine_favor_lua:IsHidden()
	return false
end
function modifier_chen_divine_favor_lua:IsPurgable()
	return false
end
function modifier_chen_divine_favor_lua:IsBuff()
	return true
end
function modifier_chen_divine_favor_lua:IsDebuff()
	return false
end
