...
LinkLuaModifier(
	"modifier_force_of_nature_treant_lua",
	"abilities/heroes/furion/force_of_nature",
...
function modifier_force_of_nature_treant_lua:IsHidden()
	return true
end
function modifier_force_of_nature_treant_lua:IsPurgable()
	return false
end
