...
LinkLuaModifier(
	...
	"abilities/bristleback_bristleback_custom",
...
function modifier_bristleback_bristleback_custom:OnTakeDamage(keys)
	...
	if
		not self.parent:HasAbility("bristleback_quill_spray")
		or not self.parent:FindAbilityByName("bristleback_quill_spray"):IsTrained()
	then
		return
	end
