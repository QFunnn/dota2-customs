...
LinkLuaModifier(
	"modifier_npc_muerta_ursa_speed",
	"abilities/muerta/npc_muerta_ursa_abilities",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_npc_muerta_ursa_passive",
	"abilities/muerta/npc_muerta_ursa_abilities",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_npc_muerta_ursa_speed:IsPurgable()
	return true
end
...
function modifier_npc_muerta_ursa_debuff:GetTexture()
		...
		if IsValid(self.caster.ursa_creep_passive) then
			for i = 1, self.stacks do
				target:AddNewModifier(
					self.caster,
					self.caster.ursa_creep_passive,
					"modifier_npc_muerta_ursa_debuff",
					{ duration = self.caster.ursa_creep_passive.duration }
				)
			end
		end
...
function modifier_npc_muerta_ursa_slow:IsPurgable()
	return true
end
