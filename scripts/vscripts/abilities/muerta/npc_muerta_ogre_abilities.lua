...
LinkLuaModifier(
	"modifier_npc_muerta_ogre_hit_slow",
	"abilities/muerta/npc_muerta_ogre_abilities",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_npc_muerta_ogre_passive",
	"abilities/muerta/npc_muerta_ogre_abilities",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_npc_muerta_ogre_hit_slow:IsPurgable()
	return true
end
