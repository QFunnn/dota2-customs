...
function modifier_spider_passive:IsHidden()
	return true
end
...
function modifier_spider_passive:GetModifierProcAttack_Feedback(param)
...
function modifier_spider_debuff:IsHidden()
	return false
end
...
function modifier_spider_debuff:GetEffectAttachType()
