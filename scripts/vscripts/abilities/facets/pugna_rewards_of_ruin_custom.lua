...
LinkLuaModifier(
	"modifier_pugna_rewards_of_ruin_custom",
	"abilities/facets/pugna_rewards_of_ruin_custom",
...
function modifier_pugna_rewards_of_ruin_custom:IsPurgable()
	return false
end
function modifier_pugna_rewards_of_ruin_custom:RemoveOnDeath()
	return false
end
