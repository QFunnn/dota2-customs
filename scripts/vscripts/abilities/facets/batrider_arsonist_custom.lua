...
LinkLuaModifier(
	"modifier_batrider_arsonist_custom",
	"abilities/facets/batrider_arsonist_custom",
...
function modifier_batrider_arsonist_custom:IsHidden()
	return true
end
function modifier_batrider_arsonist_custom:IsPurgable()
	return false
end
function modifier_batrider_arsonist_custom:RemoveOnDeath()
	return false
end
