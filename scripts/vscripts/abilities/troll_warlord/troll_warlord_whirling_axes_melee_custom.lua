...
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_melee_custom",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_melee_custom_thinker",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_melee_custom_thinker_axe",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_tracker",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_melee_quest",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_melee_custom_stack",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_buff",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_legendary_stack",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_whirling_axes_attack",
	"abilities/troll_warlord/troll_warlord_whirling_axes_melee_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function troll_warlord_whirling_axes_melee_custom:LegendaryProc(index)
	...
	if not caster:HasTalent("modifier_troll_axes_legendary") then
		return 0
	end
	...
	if index ~= tracker:GetStackCount() then
		return
	end
	...
	caster:AddNewModifier(
		...
		"modifier_troll_warlord_whirling_axes_legendary_stack",
		{
			duration = caster:GetTalentValue("modifier_troll_axes_legendary", "duration", true),
			stack = tracker:GetStackCount(),
		}
	)
	tracker:UpdateUI()
end
...
function troll_warlord_whirling_axes_melee_custom:ProcHit(target, stun)
	...
	if caster:HasTalent("modifier_troll_axes_4") then
		target:AddNewModifier(
			...
			"modifier_troll_warlord_whirling_axes_melee_custom_stack",
			{ duration = caster:GetTalentValue("modifier_troll_axes_4", "duration") }
		)
	end
end
...
function troll_warlord_whirling_axes_melee_custom:GetDamage()
	...
	return self:GetSpecialValueFor("damage")
		+ caster:GetTalentValue("modifier_troll_axes_3", "damage") * caster:GetAverageTrueAttackDamage(nil) / 100
end
...
function troll_warlord_whirling_axes_melee_custom:OnSpellStart()
	...
	if
		not caster:HasModifier("modifier_troll_warlord_berserkers_rage_custom")
		and not caster:HasTalent("modifier_troll_rage_legendary")
	then
	...
	if caster:HasTalent("modifier_troll_axes_3") then
		caster:AddNewModifier(
			...
			self,
			"modifier_troll_warlord_whirling_axes_attack",
			{ duration = caster:GetTalentValue("modifier_troll_axes_3", "duration") }
		)
	end
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_troll_warlord_whirling_axes_melee_custom_thinker",
		{ duration = whirl_duration, damage = damage }
	)
end

modifier_troll_warlord_whirling_axes_melee_custom_thinker = class({})
function modifier_troll_warlord_whirling_axes_melee_custom_thinker:IsHidden()
	return true
end
function modifier_troll_warlord_whirling_axes_melee_custom_thinker:IsPurgable()
	return false
end
function modifier_troll_warlord_whirling_axes_melee_custom_thinker:GetAttributes()
		...
		if self.axes[i] and not self.axes[i]:IsNull() then
			...
			for _, unit in pairs(self.caster:FindTargets(self.hit_radius, absPos)) do
				if not self.targets[unit] then
					...
					unit:AddNewModifier(
						self.caster,
						self.caster:BkbAbility(self.ability, self.caster:HasScepter()),
						"modifier_troll_warlord_whirling_axes_melee_custom",
...
function modifier_troll_warlord_whirling_axes_melee_custom_thinker_axe:IsHidden()
	return true
end
function modifier_troll_warlord_whirling_axes_melee_custom_thinker_axe:IsPurgable()
	return false
end
...
function modifier_troll_warlord_whirling_axes_melee_custom:IsPurgable()
	return not self:GetCaster():HasScepter()
end
function modifier_troll_warlord_whirling_axes_melee_custom:GetTexture()
...
function modifier_troll_warlord_whirling_axes_attack:IsHidden()
	return false
end
function modifier_troll_warlord_whirling_axes_attack:IsPurgable()
	return true
end
function modifier_troll_warlord_whirling_axes_attack:GetTexture()
	return "buffs/quill_cdr"
end
...
function modifier_troll_warlord_whirling_axes_tracker:IsHidden()
	return true
end
function modifier_troll_warlord_whirling_axes_tracker:IsPurgable()
	return false
end
...
function modifier_troll_warlord_whirling_axes_tracker:UpdateUI()
	...
	if not self.parent:HasTalent("modifier_troll_axes_legendary") then
		return
	end
...
function modifier_troll_warlord_whirling_axes_tracker:AttackEvent_out(params)
	...
	for _, unit in pairs(self.parent:FindTargets(self.legendary_radius, target:GetAbsOrigin())) do
		unit:ApplyStun(
			...
			self.parent,
			(1 - unit:GetStatusResistance()) * self.legendary_stun
		)
...
function modifier_troll_warlord_whirling_axes_tracker:CheckState()
	local mod = self.parent:FindModifierByName("modifier_troll_warlord_whirling_axes_legendary_stack")
	if not mod or not mod.stack or mod.stack > 1 then
		return
	end
	return {
...
function modifier_troll_warlord_whirling_axes_melee_quest:IsHidden()
	return true
end
function modifier_troll_warlord_whirling_axes_melee_quest:IsPurgable()
	return false
end

modifier_troll_warlord_whirling_axes_buff = class({})
function modifier_troll_warlord_whirling_axes_buff:IsHidden()
	return false
end
function modifier_troll_warlord_whirling_axes_buff:IsPurgable()
	return false
end
function modifier_troll_warlord_whirling_axes_buff:GetTexture()
...
function modifier_troll_warlord_whirling_axes_buff:OnCreated(table)
	...
	self.shield = self.parent:GetTalentValue("modifier_troll_axes_6", "shield")
...
function modifier_troll_warlord_whirling_axes_legendary_stack:IsHidden()
	return true
end
function modifier_troll_warlord_whirling_axes_legendary_stack:IsPurgable()
	return false
end
...
function modifier_troll_warlord_whirling_axes_melee_custom_stack:IsHidden()
	return false
end
function modifier_troll_warlord_whirling_axes_melee_custom_stack:IsPurgable()
	return false
end
function modifier_troll_warlord_whirling_axes_melee_custom_stack:GetTexture()
	return "buffs/axes_stack"
end
