...
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom_ranged_slow",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom_ensnare",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_tracker",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_cd",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_rampage_custom",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_HORIZONTAL
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_legendary_charge",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_HORIZONTAL
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_legendary_agility",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_aoe_damage",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom_proc_damage",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom_attack_slow",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_berserkers_rage_custom_break_cd",
	"abilities/troll_warlord/troll_warlord_berserkers_rage_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function troll_warlord_berserkers_rage_custom:GetBehavior()
	if
		self:GetCaster():HasTalent("modifier_troll_rage_legendary")
		and not self:GetCaster():HasModifier("modifier_troll_warlord_berserkers_rage_custom")
	then
...
function troll_warlord_berserkers_rage_custom:GetCooldown(level)
	if not self:GetCaster():HasTalent("modifier_troll_rage_legendary") then
		return
	end
...
function troll_warlord_berserkers_rage_custom:GetCastRange(level)
	...
	if not caster:HasTalent("modifier_troll_rage_legendary") then
		return
	end
...
function troll_warlord_berserkers_rage_custom:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_troll_warlord_berserkers_rage_legendary_charge",
		{ duration = 3, x = point.x, y = point.y }
	)
end
...
function troll_warlord_berserkers_rage_custom:OnProjectileHit_ExtraData(target, vLocation, table)
	...
	if caster:HasTalent("modifier_troll_rage_6") then
		target:AddNewModifier(
			...
			self,
			"modifier_troll_warlord_berserkers_rage_custom_attack_slow",
			{ duration = caster:GetTalentValue("modifier_troll_rage_6", "slow_duration") }
		)

		if
			target:GetHealthPercent() <= caster:GetTalentValue("modifier_troll_rage_6", "health")
			and not target:HasModifier("modifier_troll_warlord_berserkers_rage_custom_break_cd")
		then
			...
			target:AddNewModifier(
				...
				self,
				"modifier_troll_warlord_berserkers_rage_custom_break_cd",
				{ duration = caster:GetTalentValue("modifier_troll_rage_6", "cd") }
			)
			local mod = target:AddNewModifier(
				caster,
				caster:BkbAbility(nil, false),
				"modifier_generic_break",
				{ duration = caster:GetTalentValue("modifier_troll_rage_6", "break_duration") }
			)
			if mod then
...
function modifier_troll_warlord_berserkers_rage_custom:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom:IsPurgable()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom:RemoveOnDeath()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom:OnCreated(kv)
	...
	if troll_warlord_weapon then
		local modifier_donate_hero_illusion_item =
			troll_warlord_weapon:FindModifierByName("modifier_donate_hero_illusion_item")
	...
	if troll_warlord_shoulder then
		local modifier_donate_hero_illusion_item =
			troll_warlord_shoulder:FindModifierByName("modifier_donate_hero_illusion_item")
		if modifier_donate_hero_illusion_item and modifier_donate_hero_illusion_item.pfx_list then
			for _, particle_item in pairs(modifier_donate_hero_illusion_item.pfx_list) do
				if particle_item then
					ParticleManager:SetParticleControl(particle_item, 1, Vector(239, 56, 15))
...
function modifier_troll_warlord_berserkers_rage_tracker:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_tracker:IsPurgable()
	return false
end
...
function modifier_troll_warlord_berserkers_rage_tracker:AllowMelle()
	return self.parent:HasModifier("modifier_troll_warlord_berserkers_rage_custom")
		or self.parent:HasTalent("modifier_troll_rage_legendary")
end
...
function modifier_troll_warlord_berserkers_rage_tracker:GetModifierPreAttack_BonusDamage()
	if not self.parent:HasTalent("modifier_troll_rage_3") then
		return
	end
...
function modifier_troll_warlord_berserkers_rage_tracker:GetModifierBaseAttackTimeConstant()
	...
	if
		self.parent:HasTalent("modifier_troll_fervor_6")
		and self.parent:HasModifier("modifier_troll_warlord_fervor_custom_max")
	then
...
function modifier_troll_warlord_berserkers_rage_tracker:AttackEvent_out(params)
	...
	if not self.parent:PassivesDisabled() then
		if
			(not params.ranged_attack or self.parent:HasTalent("modifier_troll_rage_legendary"))
			and not self.parent:HasModifier("modifier_troll_warlord_berserkers_rage_cd")
		then
	...
	if self.parent:HasTalent("modifier_troll_rage_3") then
		self.parent:GenericHeal(
			self.agi_heal * self.agi_damage * self.parent:GetAgility() / 100,
			self.ability,
			true,
			nil,
...
function modifier_troll_warlord_berserkers_rage_custom_ensnare:IsHidden()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom_ensnare:IsPurgable()
	return true
end
...
function modifier_troll_warlord_berserkers_rage_cd:IsHidden()
	return false
end
function modifier_troll_warlord_berserkers_rage_cd:IsPurgable()
	return false
end
function modifier_troll_warlord_berserkers_rage_cd:IsDebuff()
	return true
end
...
function troll_warlord_rampage_custom:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_troll_warlord_rampage_custom",
		{ x = point.x, y = point.y, duration = duration }
	)
end

modifier_troll_warlord_rampage_custom = class({})
function modifier_troll_warlord_rampage_custom:IsHidden()
	return true
end
function modifier_troll_warlord_rampage_custom:IsPurgable()
	return false
end
...
function modifier_troll_warlord_rampage_custom:GetModifierDisableTurning()
	return 1
end
function modifier_troll_warlord_rampage_custom:GetStatusEffectName()
	return "particles/status_fx/status_effect_forcestaff.vpcf"
end
function modifier_troll_warlord_rampage_custom:StatusEffectPriority()
...
function modifier_troll_warlord_berserkers_rage_custom_ranged_slow:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom_ranged_slow:IsPurgable()
	return true
end
...
function modifier_troll_warlord_berserkers_rage_legendary_charge:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_legendary_charge:IsPurgable()
	return false
end
...
function modifier_troll_warlord_berserkers_rage_legendary_charge:OnCreated(params)
	...
	local effect_cast = ParticleManager:CreateParticle(
		"particles/troll_warlord/rage_jump.vpcf",
...
function modifier_troll_warlord_berserkers_rage_legendary_charge:GetModifierDisableTurning()
	return 1
end
...
function modifier_troll_warlord_berserkers_rage_legendary_charge:OnDestroy()
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_troll_warlord_berserkers_rage_legendary_agility",
		{ duration = self.parent:GetTalentValue("modifier_troll_rage_legendary", "duration") }
	)
...
function modifier_troll_warlord_berserkers_rage_legendary_agility:IsHidden()
	return false
end
function modifier_troll_warlord_berserkers_rage_legendary_agility:IsPurgable()
	return false
end
function modifier_troll_warlord_berserkers_rage_legendary_agility:OnCreated()
	...
	self.parent:AddPercentStat(
		{ agi = self.parent:GetTalentValue("modifier_troll_rage_legendary", "agility") / 100 },
		self
	)
...
function modifier_troll_warlord_berserkers_rage_aoe_damage:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_aoe_damage:IsPurgable()
	return false
end
...
function modifier_troll_warlord_berserkers_rage_custom_proc_damage:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom_proc_damage:IsPurgable()
	return false
end
...
function modifier_troll_warlord_berserkers_rage_custom_agi_perma:IsHidden()
	return not self:GetCaster():HasTalent("modifier_troll_rage_4")
end
function modifier_troll_warlord_berserkers_rage_custom_agi_perma:IsPurgable()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom_agi_perma:RemoveOnDeath()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom_agi_perma:GetTexture()
	return "buffs/blink_agility"
end
...
function modifier_troll_warlord_berserkers_rage_custom_agi_perma:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_troll_rage_4") then
		return
	end
...
function modifier_troll_warlord_berserkers_rage_custom_unslow:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom_unslow:IsPurgable()
	return false
end
...
function modifier_troll_warlord_berserkers_rage_custom_attack_slow:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom_attack_slow:IsPurgable()
	return true
end
...
function modifier_troll_warlord_berserkers_rage_custom_break_cd:IsHidden()
	return true
end
function modifier_troll_warlord_berserkers_rage_custom_break_cd:IsPurgable()
	return false
end
function modifier_troll_warlord_berserkers_rage_custom_break_cd:RemoveOnDeath()
	return false
end
