...
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_tracker",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_slow",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_aura",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_damage",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_cd",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_troll_warlord_battle_trance_custom_legendary",
	"abilities/troll_warlord/troll_warlord_battle_trance_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function troll_warlord_battle_trance_custom:OnSpellStart()
	...
	local trance_duration = self:GetSpecialValueFor("trance_duration")
		+ caster:GetTalentValue("modifier_troll_trance_4", "duration")
	...
	if caster:HasTalent("modifier_troll_trance_4") then
		...
		if stack > 0 then
			caster:AddNewModifier(
				...
				{
					stack = stack,
					duration = trance_duration + caster:GetTalentValue("modifier_troll_trance_4", "linger"),
				}
			)
		end
	end
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_troll_warlord_battle_trance_custom",
		{ auto = 0, duration = trance_duration }
	)
	...
	if table.auto == 1 then
		...
		if self.parent:HasTalent("modifier_troll_trance_6") then
			...
			self.particle = ParticleManager:CreateParticle(
				"particles/troll_warlord/troll_linken_buff.vpcf",
				PATTACH_ABSORIGIN_FOLLOW,
				self.parent
			)
			ParticleManager:SetParticleControlEnt(
...
function modifier_troll_warlord_battle_trance_custom:GetAbsorbSpell(params)
	...
	if self.parent ~= self.parent then
		return
	end
	...
	local particle = ParticleManager:CreateParticle(
		"particles/troll_warlord/troll_linken.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self.parent
	)
	ParticleManager:SetParticleControlEnt(
...
function modifier_troll_warlord_battle_trance_custom:IsValidTarget(target)
	...
	if
		...
		and (target:IsHero() or target:IsCreep())
		and (target:GetAbsOrigin() - self.parent:GetAbsOrigin()):Length2D() <= 1500
	then
		return true
	end
...
function modifier_troll_warlord_battle_trance_custom:OnDestroy()
	...
	if self.parent:HasTalent("modifier_troll_trance_5") then
		...
		self.parent:GenericHeal(
			self.parent:GetMaxHealth() * self.parent:GetTalentValue("modifier_troll_trance_5", "heal") / 100,
			self.ability,
			nil,
			nil,
...
function modifier_troll_warlord_battle_trance_custom_tracker:IsHidden()
	return self:GetStackCount() == 1 or not self.parent:HasTalent("modifier_troll_trance_1")
end
function modifier_troll_warlord_battle_trance_custom_tracker:IsPurgable()
	return false
end
function modifier_troll_warlord_battle_trance_custom_tracker:GetTexture()
	return "buffs/duel_lowhp"
end
...
function modifier_troll_warlord_battle_trance_custom_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_troll_trance_1") then
		return
	end
...
function modifier_troll_warlord_battle_trance_custom_tracker:GetMinHealth()
	...
	if not self.parent:HasTalent("modifier_troll_trance_5") then
		return
	end
	if self.parent:HasModifier("modifier_troll_warlord_battle_trance_custom_cd") then
		return
	end
...
function modifier_troll_warlord_battle_trance_custom_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_troll_trance_3") then
		return
	end
	...
	if not RollPseudoRandomPercentage(chance, 3520, self.parent) then
		return
	end
...
function modifier_troll_warlord_battle_trance_custom_tracker:DamageEvent_inc(params)
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_troll_warlord_battle_trance_custom_cd",
		{ duration = self.parent:GetTalentValue("modifier_troll_trance_5", "cd") }
	)
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_troll_warlord_battle_trance_custom",
		{ auto = 1, duration = self.parent:GetTalentValue("modifier_troll_trance_5", "duration") }
	)
end
...
function modifier_troll_warlord_battle_trance_custom_tracker:IsAura()
	return self.parent:HasTalent("modifier_troll_trance_legendary")
end

modifier_troll_warlord_battle_trance_custom_aura = class({})
function modifier_troll_warlord_battle_trance_custom_aura:IsHidden()
	return true
end
function modifier_troll_warlord_battle_trance_custom_aura:IsPurgable()
	return false
end
...
function modifier_troll_warlord_battle_trance_custom_cd:IsHidden()
	return false
end
function modifier_troll_warlord_battle_trance_custom_cd:IsPurgable()
	return false
end
function modifier_troll_warlord_battle_trance_custom_cd:RemoveOnDeath()
	return false
end
function modifier_troll_warlord_battle_trance_custom_cd:IsDebuff()
	return true
end
function modifier_troll_warlord_battle_trance_custom_cd:GetTexture()
	return "buffs/trance_cd"
end
...
function modifier_troll_warlord_battle_trance_custom_slow:IsHidden()
	return true
end
function modifier_troll_warlord_battle_trance_custom_slow:IsPurgable()
	return false
end
...
function modifier_troll_warlord_battle_trance_custom_legendary:IsHidden()
	return false
end
function modifier_troll_warlord_battle_trance_custom_legendary:IsPurgable()
	return false
end
function modifier_troll_warlord_battle_trance_custom_legendary:RemoveOnDeath()
	return false
end
function modifier_troll_warlord_battle_trance_custom_legendary:IsDebuff()
	return true
end
...
function modifier_troll_warlord_battle_trance_custom_damage:IsHidden()
	return false
end
function modifier_troll_warlord_battle_trance_custom_damage:IsPurgable()
	return false
end
function modifier_troll_warlord_battle_trance_custom_damage:GetTexture()
	return "buffs/trance_slow"
end
