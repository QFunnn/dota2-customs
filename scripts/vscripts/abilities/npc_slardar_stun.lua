...
function modifier_stun_thinker:IsHidden()
	return false
end

function modifier_stun_thinker:IsPurgable()
	return false
end
...
function modifier_stun_thinker:OnCreated(table)
	...
	self.puddle_particle = ParticleManager:CreateParticle(
...
function modifier_stun_kdr:IsHidden()
	return false
end
function modifier_stun_kdr:IsPurgable()
	return false
end
...
function modifier_stun_kdr:IsDebuff()
	return false
end
...
function modifier_slardar_stun_cd:IsHidden()
	return false
end
function modifier_slardar_stun_cd:IsPurgable()
	return false
end