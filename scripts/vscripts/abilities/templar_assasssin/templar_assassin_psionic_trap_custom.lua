...
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_counter",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_debuff",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_stun",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_stun_cd",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_legendary",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_legendary_explosion",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_legendary_heal_reduce",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_speed",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_double_effect",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_double_attack",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_scepter",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_scepter_delay",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_scepter_caster",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_psionic_trap_custom_trap_invun",
	"abilities/templar_assasssin/templar_assassin_psionic_trap_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function templar_assassin_psionic_trap_custom:OnSpellStart()
	...
	if caster:HasTalent("modifier_templar_assassin_psionic_3") then
		caster:AddNewModifier(
			...
			self,
			"modifier_templar_assassin_psionic_trap_custom_trap_speed",
			{ duration = caster:GetTalentValue("modifier_templar_assassin_psionic_3", "duration") }
		)
	end
	...
	if caster:HasTalent("modifier_templar_assassin_psionic_4") then
		caster:AddNewModifier(
			...
			self,
			"modifier_templar_assassin_psionic_trap_custom_trap_double",
			{ duration = caster:GetTalentValue("modifier_templar_assassin_psionic_4", "duration") }
		)
	end
...
function templar_assassin_psionic_trap_custom:SetTrap(point, scepter)
	...
	if scepter ~= nil then
		local illusions = CreateIllusions(
			caster,
			caster,
			{ duration = scepter, outgoing_damage = -100, incoming_damage = 0 },
			1,
			0,
			false,
			false
		...
		for _, illusion in pairs(illusions) do
			...
			trap_modifier =
				illusion:AddNewModifier(caster, self, "modifier_templar_assassin_psionic_trap_custom_trap_scepter", {})
		end
	else
		local trap =
			CreateUnitByName("npc_dota_templar_assassin_psionic_trap", point, false, nil, nil, caster:GetTeamNumber())
...
function templar_assassin_psionic_trap_custom:ExplodeTrap(point, timer_k, is_legendary)
	...
	local damage = self:GetSpecialValueFor("trap_bonus_damage")
		+ caster:GetTalentValue("modifier_templar_assassin_psionic_1", "damage")
			* caster:GetAverageTrueAttackDamage(nil)
			/ 100
	...
	for _, enemy in pairs(targets) do
		...
		enemy:AddNewModifier(
			...
			self,
			"modifier_templar_assassin_psionic_trap_custom_trap_debuff",
			{ duration = duration * (1 - enemy:GetStatusResistance()), k = k }
		)
		...
		if caster:HasShard() then
			enemy:AddNewModifier(
				...
				{ duration = silence_duration * (1 - enemy:GetStatusResistance()) }
			)
		end
		...
		if k >= 0.99 then
			...
			local legendary_mod =
				enemy:FindModifierByName("modifier_templar_assassin_psionic_trap_custom_trap_legendary")
			if legendary_mod and not is_legendary then
				...
				enemy:AddNewModifier(
					...
					self,
					"modifier_templar_assassin_psionic_trap_custom_trap_legendary_explosion",
					{ stack = legendary_mod:GetStackCount() }
				)
			...
			if
				caster:IsAlive()
				and caster:HasTalent("modifier_templar_assassin_psionic_1")
				and not enemy:IsIllusion()
			then
...
function modifier_templar_assassin_psionic_trap_custom_trap_invun:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_invun:IsHidden()
	return true
end
...
function modifier_templar_assassin_psionic_trap_custom_trap:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap:OnCreated(params)
	...
	if self.caster:HasShard() then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_templar_assassin_psionic_trap_custom_trap_invun",
			{ duration = self.ability:GetSpecialValueFor("shard_invun") }
		)
	end
	...
	self.self_particle = ParticleManager:CreateParticle(
...
function modifier_templar_assassin_psionic_trap_custom_trap:OnDestroy()
	...
	if
		not self.trap_counter_modifier
		or self.trap_counter_modifier:IsNull()
		or not self.trap_counter_modifier.trap_count
	then
		return
	end
...
function modifier_templar_assassin_psionic_trap_custom_trap:OnIntervalThink()
	...
	if self.activated and self.invis then
		return
	end
...
function modifier_templar_assassin_psionic_trap_custom_trap:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_templar_assassin_psionic_trap_custom_trap:GetAbsoluteNoDamagePure()
	return 1
end
function modifier_templar_assassin_psionic_trap_custom_trap:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_templar_assassin_psionic_trap_custom_trap:GetModifierHealthBarPips()
	return 2
end
function modifier_templar_assassin_psionic_trap_custom_trap:GetModifierIncomingDamage_Percentage()
	return -100
end
...
function modifier_templar_assassin_psionic_trap_custom_trap:AttackEvent_inc(params, self_attack)
	...
	if attacker:GetTeamNumber() == self.parent:GetTeamNumber() and not self_attack then
		return
	end
...
function modifier_templar_assassin_psionic_trap_custom_counter:AttackEvent_out(params)
	...
	if
		...
		and self.parent:HasTalent("modifier_templar_assassin_psionic_7")
		and params.target:IsUnit()
	then
...
function modifier_templar_assassin_psionic_trap_custom_counter:GetModifierCastRangeBonusStacking()
	if not self.parent:HasTalent("modifier_templar_assassin_psionic_5") then
		return
	end
...
function modifier_templar_assassin_psionic_trap_custom_counter:AttackStartEvent_out(params)
	...
	if params.target:GetUnitName() == "npc_psi_blades_crystal_mini" then
		return
	end
	...
	if not self.parent:HasTalent("modifier_templar_assassin_psionic_4") then
		return
	end
	if not mod then
		return
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_templar_assassin_psionic_trap_custom_trap_double_attack",
		{ target = params.target:entindex(), duration = self.double_delay }
	)
end
...
function templar_assassin_trap_custom:OnSpellStart()
	...
	if not self.counter_modifier or self.counter_modifier:IsNull() then
		self.counter_modifier = self:GetCaster()
			:FindModifierByName("modifier_templar_assassin_psionic_trap_custom_counter")
	end

	if
		self.trap_ability
		and self.counter_modifier
		and self.counter_modifier.trap_count
		and #self.counter_modifier.trap_count > 0
	then
		...
		if self:GetAutoCastState() == true then
			CustomGameEventManager:Send_ServerToPlayer(
				...
				"get_cursor_position",
				{ ability = "templar_assassin_trap_custom" }
			)
		else
...
function templar_assassin_trap_custom:GetCursor(search_point)
	...
	for trap_number = 1, #self.counter_modifier.trap_count do
		if
			self.counter_modifier.trap_count[trap_number] and not self.counter_modifier.trap_count[trap_number]:IsNull()
		then
			if not distance then
				...
				if
					(search_point - self.counter_modifier.trap_count[trap_number]:GetParent():GetAbsOrigin()):Length2D()
					< distance
				then
					index = trap_number
					distance = (search_point - self.counter_modifier.trap_count[trap_number]:GetParent():GetAbsOrigin()):Length2D()
...
function templar_assassin_trap_teleport_custom:OnSpellStart()
	...
	if mod then
		if mod.illusion and not mod.illusion:IsNull() then
			local illusion_mod =
				mod.illusion:FindModifierByName("modifier_templar_assassin_psionic_trap_custom_trap_scepter")
...
function modifier_templar_assassin_psionic_trap_custom_trap_debuff:IsPurgable()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_debuff:GetTexture()
...
function modifier_templar_assassin_psionic_trap_custom_trap_debuff:OnCreated(params)
	...
	self.movespeed_reduced = (self.movement_speed_min + (self.movement_speed_max - self.movement_speed_min) * params.k)
		+ self.caster:GetTalentValue("modifier_templar_assassin_psionic_3", "slow")
...
function modifier_templar_assassin_psionic_trap_custom_trap_legendary:IsHidden()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary:GetTexture()
	return "buffs/coil_resist"
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_explosion:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_explosion:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_explosion:RemoveOnDeath()
	return false
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_heal_reduce:IsHidden()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_heal_reduce:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_legendary_heal_reduce:GetTexture()
	return "buffs/coil_resist"
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_stun:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun:IsStunDebuff()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun:IsPurgeException()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun:StatusEffectPriority()
	return MODIFIER_PRIORITY_HIGH
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun:GetStatusEffectName()
...
function modifier_templar_assassin_psionic_trap_custom_trap_stun_cd:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_stun_cd:IsPurgable()
	return false
end

modifier_templar_assassin_psionic_trap_custom_trap_speed = class({})
function modifier_templar_assassin_psionic_trap_custom_trap_speed:IsHidden()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_speed:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_speed:GetTexture()
	return "buffs/Step_mark"
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_cdr:IsHidden()
	return not self:GetCaster():HasTalent("modifier_templar_assassin_psionic_6")
end
function modifier_templar_assassin_psionic_trap_custom_trap_cdr:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_cdr:RemoveOnDeath()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_cdr:GetTexture()
	return "buffs/wrath_perma"
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_cdr:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_templar_assassin_psionic_6") then
		return
	end
...
function modifier_templar_assassin_psionic_trap_custom_trap_double_effect:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_double_effect:IsPurgable()
	return false
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_double:IsHidden()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_double:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_double:GetTexture()
	return "buffs/Shift_attacks"
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_double_attack:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_double_attack:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_double_attack:RemoveOnDeath()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_double_attack:GetAttributes()
...
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:GetStatusEffectName()
	return "particles/status_fx/status_effect_dark_seer_normal_punch_replica.vpcf"
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:StatusEffectPriority()
...
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:OnCreated()
	...
	self.caster:AddNewModifier(
		...
		self.main_ability,
		"modifier_templar_assassin_psionic_trap_custom_trap_scepter_caster",
		{ duration = self.duration, illusion = self.parent:entindex() }
	)
...
function modifier_templar_assassin_psionic_trap_custom_trap_scepter:Explode(teleport)
	...
	if teleport == 1 then
		...
		local effect =
			ParticleManager:CreateParticle("particles/items3_fx/blink_arcane_start.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_templar_assassin_psionic_trap_custom_trap_scepter_delay:IsHidden()
	return true
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter_delay:IsPurgable()
	return false
end
...
function modifier_templar_assassin_psionic_trap_custom_trap_scepter_caster:IsHidden()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter_caster:IsPurgable()
	return false
end
function modifier_templar_assassin_psionic_trap_custom_trap_scepter_caster:RemoveOnDeath()
	return false
end
