...
LinkLuaModifier(
	"modifier_templar_assassin_innate_custom",
	"abilities/templar_assasssin/templar_assassin_innate_custom",
...
function modifier_templar_assassin_innate_custom:IsHidden()
	return true
end
function modifier_templar_assassin_innate_custom:IsPurgable()
	return false
end
