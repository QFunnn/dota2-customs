...
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_damage",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_absorb",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_silence",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_legendary_attack",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_shield_speed",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_tracker",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_speed_slow",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_shield_immune",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_refraction_custom_recast",
	"abilities/templar_assasssin/templar_assassin_refraction_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function templar_assassin_refraction_custom:ProcHeal()
	...
	if not caster:HasTalent("modifier_templar_assassin_refraction_2") then
		return
	end
...
function templar_assassin_refraction_custom:OnProjectileHit_ExtraData(hTarget, vLocation, table)
	...
	if not table or not table.damage then
		return
	end
	...
	local real_damage = DoDamage(
		{ victim = hTarget, attacker = caster, damage = table.damage, damage_type = DAMAGE_TYPE_MAGICAL, ability = self },
...
function templar_assassin_refraction_custom:OnSpellStart()
	...
	if mod then
		caster:AddNewModifier(
			...
			self,
			"modifier_templar_assassin_refraction_custom_shield_immune",
			{ duration = caster:GetTalentValue("modifier_templar_assassin_refraction_7", "invun") }
		)
		mod:Destroy()
	...
	if caster:HasTalent("modifier_templar_assassin_refraction_6") then
		caster:AddNewModifier(
			...
			self,
			"modifier_templar_assassin_refraction_custom_shield_immune",
			{ duration = caster:GetTalentValue("modifier_templar_assassin_refraction_6", "duration") }
		)
	end
...
function modifier_templar_assassin_refraction_custom_damage:IsPurgable()
	return false
end
...
function modifier_templar_assassin_refraction_custom_damage:OnCreated()
	...
	self.instances = self.ability:GetSpecialValueFor("instances")
		+ self.parent:GetTalentValue("modifier_templar_assassin_refraction_3", "stack")
...
function modifier_templar_assassin_refraction_custom_absorb:IsPurgable()
	return false
end
function modifier_templar_assassin_refraction_custom_absorb:GetTexture()
	return "templar_assassin_refraction"
end
...
function modifier_templar_assassin_refraction_custom_absorb:OnCreated()
	...
	self.instances = self.ability:GetSpecialValueFor("instances")
	self.max_shield = self.ability:GetSpecialValueFor("shield_per_instance")
		+ self.parent:GetTalentValue("modifier_templar_assassin_refraction_6", "shield")
	...
	if not self.parent:HasTalent("modifier_templar_assassin_refraction_7") then
		return
	end
...
function modifier_templar_assassin_refraction_custom_absorb:OnIntervalThink()
	...
	self.parent:UpdateUIshort({
		...
		stack_icon = self:GetStackCount(),
		stack = "+" .. tostring(math.floor(self.damage_count)),
		style = "TemplarRefraction",
	})
end
...
function modifier_templar_assassin_refraction_custom_absorb:GetModifierIncomingDamageConstant(params)
	...
	if
		self.parent:GetQuest() == "Templar.Quest_5"
...
function modifier_templar_assassin_refraction_custom_absorb:GetAbsorbSpell(params)
	...
	if params.ability and params.ability:GetCaster() == self.parent then
		return
	end
	if self.blocked then
		return
	end
	if not self.parent:HasTalent("modifier_templar_assassin_refraction_6") then
		return
	end
...
function modifier_templar_assassin_refraction_custom_absorb:OnDestroy()
	...
	if self.parent:HasTalent("modifier_templar_assassin_refraction_4") then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_templar_assassin_refraction_custom_shield_speed",
			{ duration = self.parent:GetTalentValue("modifier_templar_assassin_refraction_4", "effect_duration") }
		)
	end
	...
	if self.parent:HasTalent("modifier_templar_assassin_refraction_5") then
		...
		for _, enemy in pairs(self.parent:FindTargets(radius)) do
			...
			enemy:AddNewModifier(
				self.parent,
				self.parent:BkbAbility(nil, false),
				"modifier_templar_assassin_refraction_custom_silence",
				{ duration = (1 - enemy:GetStatusResistance()) * silence }
			)
		end
	end
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_templar_assassin_refraction_custom_legendary_attack",
		{ duration = self.legendary_duration, stack = self.damage_count }
	)
end

modifier_templar_assassin_refraction_custom_legendary_attack = class({})
function modifier_templar_assassin_refraction_custom_legendary_attack:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_legendary_attack:IsPurgable()
	return false
end
...
function modifier_templar_assassin_refraction_custom_legendary_attack:OnIntervalThink()
	...
	self.parent:UpdateUIshort({
		...
		max_time = self.max_time,
		stack = "+" .. tostring(self:GetStackCount()),
		active = 1,
		style = "TemplarRefraction",
	})
end
...
function modifier_templar_assassin_refraction_custom_legendary_attack:StatusEffectPriority()
	return MODIFIER_PRIORITY_ULTRA
end

modifier_templar_assassin_refraction_custom_silence = class({})
function modifier_templar_assassin_refraction_custom_silence:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_silence:IsPurgable()
	return true
end
...
function modifier_templar_assassin_refraction_custom_silence:GetEffectName()
	return "particles/generic_gameplay/generic_silenced.vpcf"
end
function modifier_templar_assassin_refraction_custom_silence:ShouldUseOverheadOffset()
	return true
end
function modifier_templar_assassin_refraction_custom_silence:GetEffectAttachType()
...
function modifier_templar_assassin_refraction_custom_shield_speed:IsHidden()
	return false
end
function modifier_templar_assassin_refraction_custom_shield_speed:IsPurgable()
	return false
end
function modifier_templar_assassin_refraction_custom_shield_speed:GetTexture()
	return "buffs/refraction_speed"
end

modifier_templar_assassin_refraction_custom_tracker = class({})
function modifier_templar_assassin_refraction_custom_tracker:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_tracker:IsPurgable()
	return false
end
...
function modifier_templar_assassin_refraction_custom_tracker:GetModifierAttackSpeedBonus_Constant()
	if not self.parent:HasTalent("modifier_templar_assassin_refraction_4") then
		return
	end
	if
		not self.parent:HasModifier("modifier_templar_assassin_refraction_custom_damage")
		and not self.parent:HasModifier("modifier_templar_assassin_refraction_custom_shield_speed")
	then
		return
	end
...
function modifier_templar_assassin_refraction_custom_tracker:GetModifierMoveSpeedBonus_Constant()
	if not self.parent:HasTalent("modifier_templar_assassin_refraction_1") then
		return
	end
...
function modifier_templar_assassin_refraction_custom_tracker:AttackEvent_out(params)
	...
	if
		self.parent:HasTalent("modifier_templar_assassin_refraction_4")
		and (
			self.parent:HasModifier("modifier_templar_assassin_refraction_custom_damage")
			or self.parent:HasModifier("modifier_templar_assassin_refraction_custom_shield_speed")
		)
	then
		params.target:AddNewModifier(
			...
			self.ability,
			"modifier_templar_assassin_refraction_custom_speed_slow",
			{ duration = self.speed_slow }
		)
	end
end

modifier_templar_assassin_refraction_custom_speed_slow = class({})
function modifier_templar_assassin_refraction_custom_speed_slow:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_speed_slow:IsPurgable()
	return true
end
function modifier_templar_assassin_refraction_custom_speed_slow:GetTexture()
...
function modifier_templar_assassin_refraction_custom_shield_immune:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_shield_immune:IsPurgable()
	return false
end
function modifier_templar_assassin_refraction_custom_shield_immune:OnCreated()
	...
	self.parent = self:GetParent()
	self.particle = ParticleManager:CreateParticle(
		"particles/templar_assassin/shield_invun.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self.parent
	)
	ParticleManager:SetParticleControl(self.particle, 0, self.parent:GetOrigin())
...
function modifier_templar_assassin_refraction_custom_shield_immune:GetStatusEffectName()
	return "particles/status_fx/status_effect_omnislash.vpcf"
end
function modifier_templar_assassin_refraction_custom_shield_immune:StatusEffectPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end

modifier_templar_assassin_refraction_custom_recast = class({})
function modifier_templar_assassin_refraction_custom_recast:IsHidden()
	return true
end
function modifier_templar_assassin_refraction_custom_recast:IsPurgable()
	return false
end