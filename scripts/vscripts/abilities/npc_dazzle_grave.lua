...
function modifier_dazzle_grave:IsPurgable()
	return false
end

function modifier_dazzle_grave:IsHidden()
	return false
end
...
function modifier_dazzle_grave_cd:IsHidden()
	return false
end
function modifier_dazzle_grave_cd:IsPurgable()
	return false
end