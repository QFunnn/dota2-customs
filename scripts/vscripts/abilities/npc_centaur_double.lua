...
function npc_centaur_double:OnAbilityPhaseStart()
	self.phase_double_edge_pfx = ParticleManager:CreateParticle(
...
function npc_centaur_double:OnSpellStart()
	...
	target:AddNewModifier(
		caster,
		self,
		"modifier_centaur_double_slow",
		{ duration = self:GetSpecialValueFor("duration") }
	)
	target:AddNewModifier(
		caster,
		self,
		"modifier_centaur_double_heal",
		{ duration = self:GetSpecialValueFor("duration_heal") }
	)
...
function modifier_centaur_double_slow:IsHidden()
	return false
end
...
function modifier_centaur_double_heal:IsHidden()
	return false
end
...
function modifier_centaur_double_heal:GetModifierLifestealRegenAmplify_Percentage()
...
function modifier_centaur_double_cd:IsHidden()
	return false
end
function modifier_centaur_double_cd:IsPurgable()
	return false
end