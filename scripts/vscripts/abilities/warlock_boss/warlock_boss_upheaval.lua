...
LinkLuaModifier(
	"modifier_warlock_boss_upheaval_cd",
	"abilities/warlock_boss/warlock_boss_upheaval.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_warlock_boss_upheaval_thinker",
	"abilities/warlock_boss/warlock_boss_upheaval.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_warlock_boss_upheaval_slow",
	"abilities/warlock_boss/warlock_boss_upheaval.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_warlock_boss_upheaval_incoming",
	"abilities/warlock_boss/warlock_boss_upheaval.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function warlock_boss_upheaval:Precache(context)
...
function warlock_boss_upheaval:OnSpellStart()
	...
	self.thinker = CreateModifierThinker(
		...
		self,
		"modifier_warlock_boss_upheaval_thinker",
		{ duration = self:GetChannelTime() + FrameTime() * 3 },
...
function modifier_warlock_boss_upheaval_cd:IsHidden()
	return false
end
function modifier_warlock_boss_upheaval_cd:IsPurgable()
	return false
end

modifier_warlock_boss_upheaval_thinker = class({})

function modifier_warlock_boss_upheaval_thinker:IsHidden()
	return false
end

function modifier_warlock_boss_upheaval_thinker:IsPurgable()
	return false
end
...
function modifier_warlock_boss_upheaval_slow:IsHidden()
	return false
end
function modifier_warlock_boss_upheaval_slow:IsPurgable()
	return false
end
...
function modifier_warlock_boss_upheaval_incoming:IsHidden()
	return true
end
function modifier_warlock_boss_upheaval_incoming:IsPurgable()
	return false
end
...
function modifier_warlock_boss_upheaval_incoming:OnCreated(table)
	...
	if self.parent:GetUpgradeStack("modifier_waveupgrade_boss") == 2 then
		self.bkb =
			self.parent:AddNewModifier(self.parent, self:GetAbility(), "modifier_generic_debuff_immune", { effect = 1 })
	end
end

function modifier_warlock_boss_upheaval_incoming:OnDestroy()
	if not IsServer() then
		return
	end
...
function modifier_warlock_boss_upheaval_incoming:GetEffectName()
	return "particles/items3_fx/star_emblem_friend_shield.vpcf"
end

function modifier_warlock_boss_upheaval_incoming:GetEffectAttachType()
