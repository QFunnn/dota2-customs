...
LinkLuaModifier(
	...
	"abilities/tidehunter_kraken_shell_custom",
...
function modifier_tidehunter_kraken_shell_custom:OnTakeDamage(params)
	...
	if not self.parent:HasModifier("modifier_tidehunter_kraken_shell_custom_cooldown") then
		...
		self.parent:AddNewModifier(
			...
			self:GetAbility(),
			"modifier_tidehunter_kraken_shell_custom_cooldown",
			{ duration = self:GetAbility():GetSpecialValueFor("cooldown_purge") }
		)
	end
end
...
function modifier_tidehunter_kraken_shell_custom_cooldown:IsHidden()
	return true
end
function modifier_tidehunter_kraken_shell_custom_cooldown:IsPurgable()
	return false
end
function modifier_tidehunter_kraken_shell_custom_cooldown:RemoveOnDeath()
	return false
end