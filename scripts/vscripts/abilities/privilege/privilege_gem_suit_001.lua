...
local a = "abilities/privilege/privilege_gem_suit_001"
...
local j = c()
j.name = "privilege_gem_suit_001"
d(j, h)
function j.prototype.StaticProperty(self)
	return { [PropertyFunction.PHYSICAL_DAMAGE_BOOST] = self:GetSpecialValueFor("value") }
end
