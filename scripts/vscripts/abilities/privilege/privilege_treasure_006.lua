...
local a = "abilities/privilege/privilege_treasure_006"
...
function k.prototype.OnDestroy(self)
	...
	PropertySystem:RemoveStaticProperty(l:entindex(), "privilege_treasure_006")
end
...
function k.prototype.RefreshCollectionDamageAmplify(self)
	...
	local o = PlayerData:GetCollectionTotalLevelByRarity(self:GetPlayerID(), self.targetRarity, "fish")
