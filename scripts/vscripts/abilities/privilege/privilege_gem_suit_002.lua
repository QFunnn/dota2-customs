...
local a = "abilities/privilege/privilege_gem_suit_002"
...
n = e({ j(nil) }, n)
g = c()
g.name = "modifier_privilege_gem_suit_002"
d(g, l)
...
function g.prototype.StaticProperty(self)
	return { [PropertyFunction.PHYSICAL_DAMAGE_BOOST] = self.value }
end
g = e(
	{
		m(
