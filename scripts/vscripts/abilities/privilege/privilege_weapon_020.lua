...
local a = "abilities/privilege/privilege_weapon_020"
...
function j.prototype.EventListener(self)
	return {
		dungeon_room_clear = function(k, l)
			...
			if IsValid(p) then
				p:AddItemByName("item_ball_health_single")
				Notification:CombatToPlayer(
					o,
					{ message = "Notify_privilege_weapon_020", item_name = "item_ball_health" }
				)
			end
		end,
	}
