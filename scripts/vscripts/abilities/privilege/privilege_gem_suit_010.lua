...
local a = "abilities/privilege/privilege_gem_suit_010"
...
local j = c()
j.name = "privilege_gem_suit_010"
d(j, h)
function j.prototype.StaticProperty(self)
	return { [PropertyFunction.MAGICAL_DAMAGE_BOOST] = self:GetSpecialValueFor("value") }
end
