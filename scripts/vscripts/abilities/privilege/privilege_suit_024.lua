...
local a = "abilities/privilege/privilege_suit_024"
...
local l = c()
l.name = "privilege_suit_024"
d(l, j)
function l.prototype.StaticProperty(self)
	return { [PropertyFunction.POISON_DAMAGE_AMPLIFY] = self:GetSpecialValueFor("poison_damage") }
end
l = e({ h, k(nil) }, l)
return f