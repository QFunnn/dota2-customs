...
local a = "abilities/privilege/privilege_gem_suit_008"
...
n = e({ j(nil) }, n)
g = c()
g.name = "modifier_privilege_gem_suit_008"
d(g, l)
...
function g.prototype.AddProperty(self)
	PropertySystem:AddStaticProperty(self:GetParent():entindex(), "spell_damage_boost", self:GetName(), self.value)
...
function g.prototype.RemoveProperty(self)
	...
	PropertySystem:RemoveStaticProperty(self:GetParent():entindex(), self:GetName(), "spell_damage_boost")
	self.hasProperty = false
end
g = e(
	{
