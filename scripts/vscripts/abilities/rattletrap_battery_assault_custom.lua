...
LinkLuaModifier(
	"modifier_rattletrap_battery_assault_custom",
	"abilities/rattletrap_battery_assault_custom",
...
function modifier_rattletrap_battery_assault_custom:IsPurgable()
	return false
end
function modifier_rattletrap_battery_assault_custom:IsPurgeException()
	return false
end
