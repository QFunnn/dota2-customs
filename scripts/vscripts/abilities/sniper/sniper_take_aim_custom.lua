...
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_legendary",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_legendary_unit",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_legendary_damage",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_active",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_damage",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_block",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_damage_reduce",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_no_count_move",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom_break",
	"abilities/sniper/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function sniper_take_aim_custom:OnSpellStart()
	...
	if caster:HasTalent("modifier_sniper_aim_5") then
		caster:AddNewModifier(
			...
			self,
			"modifier_sniper_take_aim_custom_block",
			{ duration = caster:GetTalentValue("modifier_sniper_aim_5", "duration") }
		)
...
function sniper_take_aim_custom:OnProjectileThink_ExtraData(location, data)
	...
	if not EntIndexToHScript(data.thinker):HasModifier("modifier_sniper_take_aim_custom_legendary_unit") then
		return
	end
	...
	for _, enemy in pairs(enemies) do
		if
			enemy:GetUnitName() ~= "npc_teleport"
			and not enemy:HasModifier("modifier_skeleton_king_reincarnation_custom_legendary")
		then
			hit = true
...
function modifier_sniper_take_aim_custom:GetModifierStatusResistanceStacking()
	if not self.parent:HasTalent("modifier_sniper_aim_2") then
		return
	end
...
function modifier_sniper_take_aim_custom_active:IsHidden()
	return false
end
function modifier_sniper_take_aim_custom_active:IsPurgable()
	return false
end
...
function modifier_sniper_take_aim_custom_active:OnCreated(table)
	...
	if not self.parent:HasTalent("modifier_sniper_aim_7") then
		return
	end
...
function modifier_sniper_take_aim_custom_active:AttackEvent_out(params)
	...
	if self.parent:HasTalent("modifier_sniper_aim_6") and params.target:IsHero() and self.leashed == false then
		...
		params.target:AddNewModifier(
			...
			self.ability,
			"modifier_sniper_take_aim_custom_break",
			{ duration = (1 - params.target:GetStatusResistance()) * self.leash_duration }
		)
	end
end
...
function modifier_sniper_take_aim_custom_active:OnIntervalThink()
	...
	if self.count >= self.attack_pause then
		...
		local thinker = CreateModifierThinker(
			...
			self.ability,
			"modifier_sniper_take_aim_custom_legendary_unit",
			{ duration = (0.90 * self.distance) / self.speed },
			point,
		...
		FindClearSpaceForUnit(
			self.parent,
			self.parent:GetAbsOrigin() - self.parent:GetForwardVector() * (self.drow_back * self.attack_pause),
			false
		)
	end
...
function modifier_sniper_take_aim_custom_legendary_unit:IsHidden()
	return true
end
function modifier_sniper_take_aim_custom_legendary_unit:IsPurgable()
	return false
end

modifier_sniper_take_aim_custom_legendary_damage = class({})
function modifier_sniper_take_aim_custom_legendary_damage:IsHidden()
	return true
end
function modifier_sniper_take_aim_custom_legendary_damage:IsPurgable()
	return false
end
...
function modifier_sniper_take_aim_custom_armor:IsHidden()
	return false
end
function modifier_sniper_take_aim_custom_armor:IsPurgable()
	return false
end
function modifier_sniper_take_aim_custom_armor:GetTexture()
	return "buffs/headshot_armor"
end
...
function modifier_sniper_take_aim_custom_damage_reduce:IsHidden()
	return false
end
function modifier_sniper_take_aim_custom_damage_reduce:IsPurgable()
	return false
end
function modifier_sniper_take_aim_custom_damage_reduce:GetTexture()
	return "buffs/headshot_status"
end
...
function modifier_sniper_take_aim_custom_damage_reduce:OnIntervalThink()
	...
	if
		...
		or self.parent:HasModifier("modifier_sniper_take_aim_custom_no_count_move")
	then
		self.pos = self.parent:GetAbsOrigin()
		return
	end

	if self.pos == self.parent:GetAbsOrigin() then
		return
	end
	self:Destroy()
end
...
function modifier_sniper_take_aim_custom_no_count_move:IsHidden()
	return true
end
function modifier_sniper_take_aim_custom_no_count_move:IsPurgable()
	return false
end

modifier_sniper_take_aim_custom_damage = class({})
function modifier_sniper_take_aim_custom_damage:IsHidden()
	return false
end
function modifier_sniper_take_aim_custom_damage:IsPurgable()
	return false
end
function modifier_sniper_take_aim_custom_damage:GetTexture()
	return "buffs/assassinate_break"
end
...
function modifier_sniper_take_aim_custom_block:IsHidden()
	return true
end
function modifier_sniper_take_aim_custom_block:IsPurgable()
	return false
end
function modifier_sniper_take_aim_custom_block:OnCreated()
	...
	self.particle =
		ParticleManager:CreateParticle("particles/sniper/aim_block.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
	ParticleManager:SetParticleControlEnt(
		self.particle,
		0,
		self.parent,
...
function modifier_sniper_take_aim_custom_break:IsHidden()
	return true
end
function modifier_sniper_take_aim_custom_break:IsPurgable()
	return false
end
...
function modifier_sniper_take_aim_custom_break:GetEffectName()
