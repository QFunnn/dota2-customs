...
local a = "abilities/artifact/item_artifact_6"
...
g.item_artifact_6 = c()
local n = g.item_artifact_6
n.name = "item_artifact_6"
d(n, i)
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_6"
end
n = e({ j(nil) }, n)
g.item_artifact_6 = n
g.modifier_item_artifact_6 = c()
local o = g.modifier_item_artifact_6
o.name = "modifier_item_artifact_6"
d(o, l)
