...
local a = "abilities/artifact/item_artifact_66"
...
i.item_artifact_66 = c()
local p = i.item_artifact_66
p.name = "item_artifact_66"
d(p, k)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_66"
end
p = e({ l(nil) }, p)
i.item_artifact_66 = p
i.modifier_item_artifact_66 = c()
local q = i.modifier_item_artifact_66
q.name = "modifier_item_artifact_66"
d(q, n)
