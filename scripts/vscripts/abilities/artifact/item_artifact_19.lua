...
local a = "abilities/artifact/item_artifact_19"
...
i.item_artifact_19 = c()
local p = i.item_artifact_19
p.name = "item_artifact_19"
d(p, k)
function p.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_19"
end
p = e({ l(nil) }, p)
i.item_artifact_19 = p
i.modifier_item_artifact_19 = c()
local q = i.modifier_item_artifact_19
q.name = "modifier_item_artifact_19"
d(q, n)
