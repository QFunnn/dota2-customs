...
local a = "abilities/artifact/item_artifact_21"
...
g.item_artifact_21 = c()
local n = g.item_artifact_21
n.name = "item_artifact_21"
d(n, i)
...
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_21"
end
function n.prototype.OnSpellStart(self)
	...
	PlayerData:requestSectSelection(
		p,
		{ title = "选择幸运流派", sects = AbilityShop.pickList, ability_name = "item_artifact_21" },
		function(q, p, r)
...
n = e({ j(nil) }, n)
g.item_artifact_21 = n
g.modifier_item_artifact_21 = c()
local s = g.modifier_item_artifact_21
s.name = "modifier_item_artifact_21"
d(s, l)
