...
local a = "abilities/artifact/item_artifact_33"
...
j.item_artifact_33 = c()
local q = j.item_artifact_33
q.name = "item_artifact_33"
d(q, l)
function q.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_33"
end
q = e({ m(nil) }, q)
j.item_artifact_33 = q
j.modifier_item_artifact_33 = c()
local r = j.modifier_item_artifact_33
r.name = "modifier_item_artifact_33"
d(r, o)
