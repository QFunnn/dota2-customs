...
local a = "abilities/artifact/item_artifact_71"
...
g.item_artifact_71 = c()
local n = g.item_artifact_71
n.name = "item_artifact_71"
d(n, i)
function n.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_71"
end
n = e({ j(nil) }, n)
g.item_artifact_71 = n
g.modifier_item_artifact_71 = c()
local o = g.modifier_item_artifact_71
o.name = "modifier_item_artifact_71"
d(o, l)
...
function o.prototype.OnRoundStart(self)
	...
	Notification:combatToPlayer(
		p,
		{
			...
			string_itemname_artifact = "DOTA_Tooltip_ability_item_artifact_71",
