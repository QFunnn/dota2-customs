...
local a = "abilities/artifact/item_artifact_18"
...
h.item_artifact_18 = c()
local l = h.item_artifact_18
l.name = "item_artifact_18"
d(l, j)
		...
		e(r, function(s, t, u)
			...
			Notification:combatToPlayer(
				n,
				{
					...
					string_itemname_artifact = "DOTA_Tooltip_ability_item_artifact_18",
