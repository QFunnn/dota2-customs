...
local a = "abilities/artifact/item_artifact_hope_hammer"
...
local j = c()
j.name = "item_artifact_hope_hammer"
d(j, h)
...
function j.prototype.EventListener(self)
	return {
		damage_event = function(k, l)
			...
			then
				l.attacker:AddShield(self:GetSpecialValueFor("shield"), self:GetAbilityName())
			end
		end,
	}
end
