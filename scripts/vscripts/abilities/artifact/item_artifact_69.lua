...
local a = "abilities/artifact/item_artifact_69"
...
j.item_artifact_69 = c()
local q = j.item_artifact_69
q.name = "item_artifact_69"
d(q, l)
function q.prototype.GetIntrinsicModifierName(self)
	return "modifier_item_artifact_69"
end
q = e({ m(nil) }, q)
j.item_artifact_69 = q
j.modifier_item_artifact_69 = c()
local r = j.modifier_item_artifact_69
r.name = "modifier_item_artifact_69"
d(r, o)
