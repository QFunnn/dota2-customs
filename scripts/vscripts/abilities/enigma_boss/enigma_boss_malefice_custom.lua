...
LinkLuaModifier(
	"modifier_enigma_boss_malefice_custom_debuff",
	"abilities/enigma_boss/enigma_boss_malefice_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_malefice_custom_caster",
	"abilities/enigma_boss/enigma_boss_malefice_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_enigma_boss_malefice_custom_caster:IsHidden()
	return true
end
function modifier_enigma_boss_malefice_custom_caster:IsPurgable()
	return false
end
...
function modifier_enigma_boss_malefice_custom_debuff:IsHidden()
	return false
end
function modifier_enigma_boss_malefice_custom_debuff:IsPurgable()
	return false
end
...
function modifier_enigma_boss_malefice_custom_debuff:AttackEvent_out(params)
	...
	if self.caster ~= params.target then
		return
	end
