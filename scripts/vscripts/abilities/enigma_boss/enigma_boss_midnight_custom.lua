...
LinkLuaModifier(
	"modifier_enigma_boss_midnight_custom_thinker",
	"abilities/enigma_boss/enigma_boss_midnight_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_midnight_custom_debuff",
	"abilities/enigma_boss/enigma_boss_midnight_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_midnight_custom_delay",
	"abilities/enigma_boss/enigma_boss_midnight_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function enigma_boss_midnight_custom:OnSpellStart()
	...
	for i = 1, max do
		...
		repeat
			vec = RandomVector(RandomInt(radius, global_radius))
			count = count + 1
...
function modifier_enigma_boss_midnight_custom_thinker:IsHidden()
	return true
end
function modifier_enigma_boss_midnight_custom_thinker:IsPurgable()
	return false
end
function modifier_enigma_boss_midnight_custom_thinker:OnCreated(table)
	...
	local effect_cast =
		ParticleManager:CreateParticle("particles/enigma_boss/midnight_spawn.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_enigma_boss_midnight_custom_thinker:IsAura()
	return true
end
function modifier_enigma_boss_midnight_custom_thinker:GetAuraDuration()
	return 0.1
end
function modifier_enigma_boss_midnight_custom_thinker:GetAuraRadius()
	return self.radius
end
function modifier_enigma_boss_midnight_custom_thinker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_enigma_boss_midnight_custom_thinker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_enigma_boss_midnight_custom_thinker:GetModifierAura()
	return "modifier_enigma_boss_midnight_custom_debuff"
end

modifier_enigma_boss_midnight_custom_delay = class({})
function modifier_enigma_boss_midnight_custom_delay:IsHidden()
	return false
end
function modifier_enigma_boss_midnight_custom_delay:IsPurgable()
	return false
end
function modifier_enigma_boss_midnight_custom_delay:OnCreated()
	...
	self.effect_cast =
		ParticleManager:CreateParticle("particles/enigma_boss/midnight_aoe.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
...
function modifier_enigma_boss_midnight_custom_delay:OnIntervalThink()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/enigma_boss/midnight_timer.vpcf",
...
function modifier_enigma_boss_midnight_custom_debuff:IsHidden()
	return false
end
function modifier_enigma_boss_midnight_custom_debuff:IsPurgable()
	return false
end
