...
LinkLuaModifier(
	"modifier_enigma_boss_summon_custom_summon",
	"abilities/enigma_boss/enigma_boss_summon_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_summon_custom_tracker",
	"abilities/enigma_boss/enigma_boss_summon_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_enigma_boss_summon_custom_summon:IsHidden()
	return false
end
function modifier_enigma_boss_summon_custom_summon:IsPurgable()
	return false
end
...
function modifier_enigma_boss_summon_custom_tracker:IsHidden()
	return true
end
function modifier_enigma_boss_summon_custom_tracker:IsPurgable()
	return false
end
...
function modifier_enigma_boss_summon_custom_tracker:AttackEvent_out(params)
	...
	if not self.caster:HasModifier("modifier_waveupgrade_boss") then
		return
	end

	local attacker = params.attacker
	if not attacker.summoner or attacker.summoner ~= self.caster then
		return
	end
