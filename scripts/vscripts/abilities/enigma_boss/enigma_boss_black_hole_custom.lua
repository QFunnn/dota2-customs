...
LinkLuaModifier(
	"modifier_enigma_boss_black_hole_custom_thinker",
	"abilities/enigma_boss/enigma_boss_black_hole_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_black_hole_custom_debuff",
	"abilities/enigma_boss/enigma_boss_black_hole_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_black_hole_custom_debuff_cd",
	"abilities/enigma_boss/enigma_boss_black_hole_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_black_hole_custom_debuff_slow",
	"abilities/enigma_boss/enigma_boss_black_hole_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_enigma_boss_black_hole_custom_caster",
	"abilities/enigma_boss/enigma_boss_black_hole_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_enigma_boss_black_hole_custom_caster:IsHidden()
	return true
end
function modifier_enigma_boss_black_hole_custom_caster:IsPurgable()
	return false
end

modifier_enigma_boss_black_hole_custom_thinker = class({})
function modifier_enigma_boss_black_hole_custom_thinker:IsHidden()
	return true
end
function modifier_enigma_boss_black_hole_custom_thinker:IsPurgable()
	return false
end
function modifier_enigma_boss_black_hole_custom_thinker:OnCreated(table)
	...
	self.effect_cast = ParticleManager:CreateParticle(
		"particles/enigma_boss/black_hole_custom.vpcf",
...
function modifier_enigma_boss_black_hole_custom_thinker:GetAuraEntityReject(hEntity)
	return not hEntity:IsRealHero()
		or hEntity:HasModifier("modifier_enigma_boss_black_hole_custom_debuff_cd")
		or hEntity:IsDebuffImmune()
end

modifier_enigma_boss_black_hole_custom_debuff = class({})
function modifier_enigma_boss_black_hole_custom_debuff:IsHidden()
	return true
end
function modifier_enigma_boss_black_hole_custom_debuff:IsPurgable()
	return false
end
function modifier_enigma_boss_black_hole_custom_debuff:IsPurgeException()
	return true
end
function modifier_enigma_boss_black_hole_custom_debuff:IsStunDebuff()
	return true
end
...
function modifier_enigma_boss_black_hole_custom_debuff_cd:IsHidden()
	return true
end
function modifier_enigma_boss_black_hole_custom_debuff_cd:IsPurgable()
	return false
end

modifier_enigma_boss_black_hole_custom_debuff_slow = class({})
function modifier_enigma_boss_black_hole_custom_debuff_slow:IsHidden()
	return true
end
function modifier_enigma_boss_black_hole_custom_debuff_slow:IsPurgable()
	return false
end