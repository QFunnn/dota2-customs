...
LinkLuaModifier(
	"modifier_nyx_assassin_innate_custom",
...
function modifier_nyx_assassin_innate_custom:GetAuraDuration()
	return 0.5
end
function modifier_nyx_assassin_innate_custom:GetAuraRadius()
	return self.radius
end
function modifier_nyx_assassin_innate_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_nyx_assassin_innate_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO
end
function modifier_nyx_assassin_innate_custom:GetAuraSearchFlags()
...
function modifier_nyx_assassin_innate_custom:DeathEvent(params)
	...
	if
		((self.parent:GetAbsOrigin() - params.unit:GetAbsOrigin()):Length2D() > self.kill_radius)
...
function modifier_nyx_assassin_innate_custom_perma:IsHidden()
	return self.ability.talents.has_h4 == 0 or self:GetStackCount() >= self.ability.talents.h4_max
end
function modifier_nyx_assassin_innate_custom_perma:RemoveOnDeath()
	return false
end
function modifier_nyx_assassin_innate_custom_perma:GetTexture()
	return "buffs/nyx_assassin/hero_5"
end
