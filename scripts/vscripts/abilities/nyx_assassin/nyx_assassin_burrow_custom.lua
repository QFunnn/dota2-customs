...
function modifier_nyx_assassin_burrow_custom:OnCreated()
	...
	self.effect_cast = ParticleManager:CreateParticle(
		"particles/sand_king/burrow_legendary.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self.parent
	)
...
function modifier_nyx_assassin_burrow_custom_dash:StatusEffectPriority()
	return MODIFIER_PRIORITY_ULTRA
end
function modifier_nyx_assassin_burrow_custom_dash:GetStatusEffectName()
...
function modifier_nyx_assassin_burrow_custom_dash:OnCreated(params)
	...
	local effect_cast =
		ParticleManager:CreateParticle("particles/sand_king/sand_king_wave.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
