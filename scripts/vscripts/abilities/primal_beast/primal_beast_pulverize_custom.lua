...
LinkLuaModifier(
	"modifier_primal_beast_pulverize_custom_legendary_rock_cd",
	"abilities/primal_beast/primal_beast_pulverize_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_primal_beast_pulverize_custom_str_count",
	"abilities/primal_beast/primal_beast_pulverize_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_primal_beast_pulverize_custom_damage_reduce",
	"abilities/primal_beast/primal_beast_pulverize_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function primal_beast_pulverize_custom:AddLegendaryStack(only_str)
	...
	if caster:HasTalent("modifier_primal_beast_pulverize_4") then
		caster:AddNewModifier(
			...
			self,
			"modifier_primal_beast_pulverize_custom_str_count",
			{ duration = caster:GetTalentValue("modifier_primal_beast_pulverize_4", "duration") }
		)
	end

	if not caster:HasTalent("modifier_primal_beast_pulverize_7") then
		return
	end
	if only_str then
		return
	...
	local mod = caster:AddNewModifier(
		...
		self,
		"modifier_primal_beast_pulverize_custom_legendary_count",
		{ duration = caster:GetTalentValue("modifier_primal_beast_pulverize_7", "duration") }
	)
	if not mod then
		return
	end
...
function primal_beast_pulverize_custom:AddStrStack(target)
	...
	if not caster:HasTalent("modifier_primal_beast_pulverize_4") then
		return
	end
...
function primal_beast_pulverize_custom:GetChannelTime()
	local bonus = self:GetCaster():GetUpgradeStack("modifier_primal_beast_pulverize_custom_legendary_count")
		* self:GetSpecialValueFor("interval")
...
function primal_beast_pulverize_custom:OnSpellStart(new_target)
	...
	local duration = self:GetSpecialValueFor("channel_time")
		+ caster:GetUpgradeStack("modifier_primal_beast_pulverize_custom_legendary_count")
			* self:GetSpecialValueFor("interval")
	...
	self.target_mod =
		target:AddNewModifier(caster, self, "modifier_primal_beast_pulverize_custom_debuff", { duration = duration })
...
function modifier_primal_beast_pulverize_custom:OnDestroy()
	...
	if not self.parent:HasTalent("modifier_primal_beast_pulverize_6") then
		return
	end
...
function modifier_primal_beast_pulverize_custom_debuff:OnCreated(kv)
	...
	self.base_damage = self.ability:GetSpecialValueFor("damage")
		+ self.caster:GetTalentValue("modifier_primal_beast_pulverize_1", "damage")
			* self.caster:GetStrength()
			/ 100
	...
	if self.caster:HasTalent("modifier_primal_beast_pulverize_6") then
		self.break_effect = self.parent:AddNewModifier(
			self.caster,
			self.ability,
...
function modifier_primal_beast_pulverize_custom_tracker:IsHidden()
	return true
end
function modifier_primal_beast_pulverize_custom_tracker:IsPurgable()
	return false
end
...
function modifier_primal_beast_pulverize_custom_tracker:DamageEvent_out(params)
	...
	if params.inflictor:GetName() ~= "primal_beast_rock_throw" then
		return
	end
...
function modifier_primal_beast_pulverize_custom_tracker:GetModifierCastRangeBonusStacking()
	if not self.parent:HasTalent("modifier_primal_beast_pulverize_3") then
		return
	end
...
function modifier_primal_beast_pulverize_custom_tracker:GetModifierPercentageCooldown()
	if not self.parent:HasTalent("modifier_primal_beast_pulverize_5") then
		return
	end
	return self.cdr
end
...
function modifier_primal_beast_pulverize_custom_tracker:GetModifierSpellAmplify_Percentage()
	if not self.parent:HasTalent("modifier_primal_beast_pulverize_1") then
		return
	end
...
function modifier_primal_beast_pulverize_custom_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_primal_beast_pulverize_7") then
		return
	end
...
function modifier_primal_beast_pulverize_custom_legendary_count:IsHidden()
	return false
end
function modifier_primal_beast_pulverize_custom_legendary_count:IsPurgable()
	return false
end
function modifier_primal_beast_pulverize_custom_legendary_count:IsDebuff()
	return true
end
...
function modifier_primal_beast_pulverize_custom_legendary_rock_cd:IsHidden()
	return true
end
function modifier_primal_beast_pulverize_custom_legendary_rock_cd:IsPurgable()
	return false
end

modifier_primal_beast_pulverize_custom_str_count = class({})
function modifier_primal_beast_pulverize_custom_str_count:IsHidden()
	return false
end
function modifier_primal_beast_pulverize_custom_str_count:IsPurgable()
	return false
end
function modifier_primal_beast_pulverize_custom_str_count:GetTexture()
	return "buffs/pulverize_str"
end
...
function modifier_primal_beast_pulverize_custom_str_count:OnIntervalThink()
	...
	if
		self.parent:HasModifier("modifier_primal_beast_pulverize_custom")
		or self.parent:HasModifier("modifier_primal_beast_pulverize_custom_debuff")
	then
...
function modifier_primal_beast_pulverize_custom_damage_reduce:IsHidden()
	return false
end
function modifier_primal_beast_pulverize_custom_damage_reduce:IsPurgable()
	return false
end
function modifier_primal_beast_pulverize_custom_damage_reduce:GetTexture()
...
function modifier_primal_beast_pulverize_custom_trample_count:IsHidden()
	return true
end
function modifier_primal_beast_pulverize_custom_trample_count:IsPurgable()
	return false
end
