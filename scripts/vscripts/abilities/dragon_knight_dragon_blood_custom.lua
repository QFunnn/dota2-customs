...
LinkLuaModifier(
	...
	"abilities/dragon_knight_dragon_blood_custom",
...
function modifier_dragon_knight_dragon_blood_custom:IsPurgeException()
	return false
end
function modifier_dragon_knight_dragon_blood_custom:RemoveOnDeath()
	return false
end
