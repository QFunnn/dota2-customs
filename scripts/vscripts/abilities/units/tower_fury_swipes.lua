...
function modifier_tower_fury_swipes:IsHidden()
	return true
end
function modifier_tower_fury_swipes:IsDebuff()
	return false
end
function modifier_tower_fury_swipes:IsPurgable()
	return false
end
...
function modifier_tower_fury_swipes:GetOverrideAttackMagical()
	return 1
end
...
function modifier_tower_fury_swipes:GetModifierProcAttack_BonusDamage_Pure(params)
	...
	local stacks = 1
	local new_modifier = target:AddNewModifier(
		self.parent,
		self.ability,
		"modifier_tower_fury_swipes_debuff",
		{ duration = self.reset_time }
	)
...
function modifier_tower_fury_swipes_debuff:IsHidden()
	return false
end
function modifier_tower_fury_swipes_debuff:IsDebuff()
	return true
end
function modifier_tower_fury_swipes_debuff:IsPurgable()
	return false
end
...
function modifier_tower_fury_swipes_debuff:GetDisableHealing()
	return 1
end
