...
function modifier_pudge_innate_custom:IsHidden()
	return false
end
function modifier_pudge_innate_custom:IsPurgable()
	return false
end
function modifier_pudge_innate_custom:RemoveOnDeath()
	return false
end
...
function modifier_pudge_innate_custom:GetModifierSpellAmplify_Percentage()
	if not self.parent:HasTalent("modifier_pudge_flesh_3") then
		return
	end
...
function modifier_pudge_innate_custom:DeathEvent(params)
	...
	if
		mod
		and target:GetTeam() == DOTA_TEAM_NEUTRALS
		and self.parent:HasShard()
...
function modifier_pudge_innate_custom_creeps:IsHidden()
	return true
end
function modifier_pudge_innate_custom_creeps:IsPurgable()
	return false
end
function modifier_pudge_innate_custom_creeps:RemoveOnDeath()
	return false
end
function modifier_pudge_innate_custom_creeps:GetTexture()
	return "buffs/flesh_creep"
end