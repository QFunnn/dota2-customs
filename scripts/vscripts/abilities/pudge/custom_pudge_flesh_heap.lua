...
LinkLuaModifier(
	"modifier_custom_pudge_flesh_heap_stack",
	"abilities/pudge/custom_pudge_flesh_heap",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_pudge_flesh_heap_tempo_count",
	"abilities/pudge/custom_pudge_flesh_heap",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier("modifier_custom_pudge_flesh_heap", "abilities/pudge/custom_pudge_flesh_heap", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier(
	"modifier_custom_pudge_flesh_heap_hit_cd",
	"abilities/pudge/custom_pudge_flesh_heap",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_pudge_flesh_heap_charge",
	"abilities/pudge/custom_pudge_flesh_heap",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_pudge_flesh_heap_charge_active",
	"abilities/pudge/custom_pudge_flesh_heap",
...
function modifier_custom_pudge_flesh_heap:IsHidden()
	return false
end
function modifier_custom_pudge_flesh_heap:IsPurgable()
	return false
end
...
function modifier_custom_pudge_flesh_heap:GetModifierModelScale()
	if not self.parent:HasTalent("modifier_pudge_flesh_legendary") then
		return
	end
...
function modifier_custom_pudge_flesh_heap_stack:IsHidden()
	if not self.parent:HasTalent("modifier_pudge_flesh_5") then
		return true
	end
...
function modifier_custom_pudge_flesh_heap_stack:IsPurgable()
	return false
end
function modifier_custom_pudge_flesh_heap_stack:RemoveOnDeath()
	return false
end
function modifier_custom_pudge_flesh_heap_stack:GetTexture()
	return "buffs/flesh_lowhp"
end
...
function modifier_custom_pudge_flesh_heap_stack:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_pudge_flesh_4") then
		return
	end
	if self.parent:PassivesDisabled() then
		return
	end
	if self.parent:HasModifier("modifier_custom_pudge_flesh_heap_hit_cd") then
		return
	end
	...
	local damage = DoDamage(
		{
			...
			damage = self.parent:GetStrength() * self.stun_damage,
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_custom_pudge_flesh_heap_hit_cd",
		{ duration = self.parent:GetTalentValue("modifier_pudge_flesh_4", "cd") }
	)
	params.target:AddNewModifier(
		self.parent,
		self.ability,
		"modifier_bashed",
		{ duration = (1 - params.target:GetStatusResistance()) * self.stun_duration }
	)
end
...
function modifier_custom_pudge_flesh_heap_stack:DamageEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_pudge_flesh_2") then
		return
	end
...
function modifier_custom_pudge_flesh_heap_stack:OnIntervalThink()
	...
	if
		(self.parent:GetHealthPercent() <= self.low_health and not self.parent:PassivesDisabled()) and not self.particle
	then
		self.particle =
			ParticleManager:CreateParticle("particles/pudge/meat_lowhealth.vpcf", PATTACH_OVERHEAD_FOLLOW, self.parent)
		ParticleManager:SetParticleControlEnt(
			self.particle,
			0,
			self.parent,
...
function modifier_custom_pudge_flesh_heap_tempo_count:IsHidden()
	return false
end
function modifier_custom_pudge_flesh_heap_tempo_count:IsPurgable()
	return false
end
function modifier_custom_pudge_flesh_heap_tempo_count:GetTexture()
...
function modifier_custom_pudge_flesh_heap_hit_cd:IsHidden()
	return false
end
function modifier_custom_pudge_flesh_heap_hit_cd:IsPurgable()
	return false
end
function modifier_custom_pudge_flesh_heap_hit_cd:IsDebuff()
	return true
end
function modifier_custom_pudge_flesh_heap_hit_cd:RemoveOnDeath()
	return false
end
function modifier_custom_pudge_flesh_heap_hit_cd:GetTexture()
	return "buffs/flesh_hit"
end
...
function modifier_custom_pudge_flesh_heap_charge:IsHidden()
	return true
end
function modifier_custom_pudge_flesh_heap_charge:IsPurgable()
	return false
end

modifier_custom_pudge_flesh_heap_charge_active = class({})
function modifier_custom_pudge_flesh_heap_charge_active:IsHidden()
	return true
end
function modifier_custom_pudge_flesh_heap_charge_active:IsPurgable()
	return false
end
...
function modifier_custom_pudge_flesh_heap_charge_active:GetModifierDisableTurning()
	return 1
end
function modifier_custom_pudge_flesh_heap_charge_active:GetStatusEffectName()
	return "particles/status_fx/status_effect_forcestaff.vpcf"
end
function modifier_custom_pudge_flesh_heap_charge_active:StatusEffectPriority()
	...
	if #targets > 0 then
		...
		for _, enemy in pairs(self.parent:FindTargets(self.knock_radius * 2)) do
			...
			enemy:AddNewModifier(
				...
				self.ability,
				"modifier_stunned",
				{ duration = (1 - enemy:GetStatusResistance()) * self.knock_stun }
			)
