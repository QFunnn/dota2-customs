...
LinkLuaModifier(
	...
	"abilities/neutral_frostgolem_slow",
...
function modifier_neutral_frostgolem_slow_passive:IsPurgable()
	return false
end
function modifier_neutral_frostgolem_slow_passive:IsHidden()
	return true
end
...
function modifier_neutral_frostgolem_slow_buff:IsHidden()
	return false
end
...
function modifier_neutral_frostgolem_slow_buff:GetModifierLifestealRegenAmplify_Percentage()
	return self.heal
end
