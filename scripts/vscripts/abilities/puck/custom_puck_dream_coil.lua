...
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_resist",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_tether",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_tracker",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_stun",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_mute",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_puck_dream_coil_legendary_cd",
	"abilities/puck/custom_puck_dream_coil",
	LUA_MODIFIER_MOTION_NONE
)
...
function custom_puck_dream_coil:LegendaryProc(point)
	...
	if not caster:HasTalent("modifier_puck_coil_7") then
		return
	end
	if caster:HasModifier("modifier_custom_puck_dream_coil_legendary_cd") then
		return
	end
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_custom_puck_dream_coil_legendary_cd",
		{ duration = caster:GetTalentValue("modifier_puck_coil_7", "cd") }
	)
	...
	local damageTable = {
		damage = mana * caster:GetTalentValue("modifier_puck_coil_7", "damage") / 100,
	...
	for _, enemy in pairs(caster:FindTargets(radius, point)) do
		...
		local knock = enemy:AddNewModifier(caster, self, "modifier_generic_knockback", {
...
function custom_puck_dream_coil:OnSpellStart()
	...
	if caster:HasScepter() then
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_puck_dream_coil_scepter_caster",
			{ duration = latch_duration, coil_thinker = coil_thinker:entindex() }
		)
	end

	local damageTable =
		{ damage = damage, damage_type = self:GetAbilityDamageType(), attacker = caster, ability = self }
	for _, enemy in pairs(caster:FindTargets(radius, point)) do
		damageTable.victim = enemy
		...
		if not enemy:HasModifier("modifier_custom_puck_dream_coil") then
			enemy:AddNewModifier(
				caster,
				self,
				"modifier_custom_puck_dream_coil",
				{ duration = latch_duration * (1 - enemy:GetStatusResistance()), coil_thinker = coil_thinker:entindex() }
			)
		end
	end
end
...
function modifier_custom_puck_dream_coil:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil:GetAttributes()
...
function modifier_custom_puck_dream_coil:OnCreated(params)
	...
	self.coil_break_radius = self.ability:GetSpecialValueFor("coil_break_radius")
		+ self.caster:GetTalentValue("modifier_puck_coil_1", "radius")
	self.coil_stun_duration = self.ability:GetSpecialValueFor("coil_stun_duration")
		+ self.caster:GetTalentValue("modifier_puck_coil_5", "stun")
	...
	self.leash = self.parent:AddNewModifier(
		self.caster,
		self.caster:BkbAbility(self.ability, self.caster:HasTalent("modifier_puck_coil_5")),
		"modifier_custom_puck_dream_coil_tether",
	...
	if self.caster:HasTalent("modifier_puck_coil_5") then
		self.parent:AddNewModifier(
			...
			"modifier_custom_puck_dream_coil_mute",
			{
				duration = self.caster:GetTalentValue("modifier_puck_coil_5", "duration")
					* (1 - self.parent:GetStatusResistance()),
			}
		)
	end
...
function modifier_custom_puck_dream_coil:OnIntervalThink()
	...
	if (self.parent:GetAbsOrigin() - self.coil_thinker_location):Length2D() < self.coil_break_radius then
		return
	end
	...
	self.parent:ApplyStun(
		self.ability,
		self.caster:HasTalent("modifier_puck_coil_5"),
		self.caster,
		self.coil_stun_duration
	)
	...
	self.parent:AddNewModifier(
		...
		self.ability,
		"modifier_custom_puck_dream_coil_stun",
		{ duration = (1 - self.parent:GetStatusResistance()) * self.coil_stun_duration }
	)
...
function modifier_custom_puck_dream_coil_thinker:OnCreated()
	...
	self.pfx =
		ParticleManager:CreateParticle("particles/units/heroes/hero_puck/puck_dreamcoil.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_custom_puck_dream_coil_thinker:OnIntervalThink()
	...
	if
		...
		and (self.caster:GetAbsOrigin() - self.origin):Length2D() <= self.scepter_max_radius
	then
...
function modifier_custom_puck_dream_coil_thinker:Break()
	...
	if self.caster:HasTalent("modifier_puck_coil_7") then
		...
		local particle =
			ParticleManager:CreateParticle("particles/puck/coil_refresh.vpcf", PATTACH_CUSTOMORIGIN, self.caster)
		ParticleManager:SetParticleControlEnt(
			particle,
			0,
			self.caster,
...
function modifier_custom_puck_dream_coil_resist:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_resist:GetTexture()
...
function modifier_custom_puck_dream_coil_resist:GetModifierMoveSpeedBonus_Percentage()
	if not self:GetCaster():HasTalent("modifier_puck_coil_3") then
		return
	end
...
function modifier_custom_puck_dream_coil_tether:IsHidden()
	return true
end
function modifier_custom_puck_dream_coil_tether:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_tether:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_custom_puck_dream_coil_tracker:IsHidden()
	return true
end
function modifier_custom_puck_dream_coil_tracker:IsPurgable()
	return false
end
...
function modifier_custom_puck_dream_coil_tracker:SpellEvent(params)
	...
	if not self.parent:HasTalent("modifier_puck_coil_7") then
		return
	end
...
function modifier_custom_puck_dream_coil_cdr:IsHidden()
	return not self:GetCaster():HasTalent("modifier_puck_coil_6")
end
function modifier_custom_puck_dream_coil_cdr:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_cdr:RemoveOnDeath()
	return false
end
function modifier_custom_puck_dream_coil_cdr:GetTexture()
	return "buffs/Coil_kills"
end
...
function modifier_custom_puck_dream_coil_cdr:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_puck_coil_6") then
		return
	end
...
function modifier_custom_puck_dream_coil_scepter_caster:IsHidden()
	return false
end
function modifier_custom_puck_dream_coil_scepter_caster:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_scepter_caster:RemoveOnDeath()
	return false
end
function modifier_custom_puck_dream_coil_scepter_caster:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_custom_puck_dream_coil_stun:IsHidden()
	return true
end
function modifier_custom_puck_dream_coil_stun:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_stun:IsPurgeException()
	return true
end
function modifier_custom_puck_dream_coil_stun:IsStunDebuff()
	return true
end

modifier_custom_puck_dream_coil_mute = class({})
function modifier_custom_puck_dream_coil_mute:IsHidden()
	return true
end
function modifier_custom_puck_dream_coil_mute:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_mute:GetEffectName()
	return "particles/generic_gameplay/generic_break.vpcf"
end
function modifier_custom_puck_dream_coil_mute:ShouldUseOverheadOffset()
	return true
end
function modifier_custom_puck_dream_coil_mute:GetEffectAttachType()
...
function modifier_custom_puck_dream_coil_legendary_cd:IsHidden()
	return false
end
function modifier_custom_puck_dream_coil_legendary_cd:IsPurgable()
	return false
end
function modifier_custom_puck_dream_coil_legendary_cd:IsDebuff()
	return true
end