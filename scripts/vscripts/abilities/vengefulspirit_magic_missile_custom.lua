...
LinkLuaModifier(
	...
	"abilities/vengefulspirit_magic_missile_custom",
...
function vengefulspirit_magic_missile_custom:OnProjectileHit_ExtraData(target, location, ExtraData)
	...
	self:GetCaster():EmitSound("Hero_VengefulSpirit.MagicMissileImpact")
	ApplyDamage({
		victim = target,
...
function modifier_vengefulspirit_magic_missile_custom_passive:IsHidden()
	return not self:GetCaster():HasTalent("special_bonus_unique_cha_vengeful_spirit")
end
...
function modifier_vengefulspirit_magic_missile_custom_passive:AttackLandedModifier(params)
	...
	if not self:GetCaster():HasTalent("special_bonus_unique_cha_vengeful_spirit") then
		return
	end
