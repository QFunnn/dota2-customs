...
LinkLuaModifier(
	"modifier_shadow_demon_disseminate_custom",
	"abilities/shadow_demon_disseminate_custom",
...
function shadow_demon_disseminate_custom:OnSpellStart()
	...
	local cast_particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_shadow_demon/shadow_demon_soul_catcher_new.vpcf",
		PATTACH_WORLDORIGIN,
		target
	)
