...
LinkLuaModifier(
	"modifier_queenofpain_blood_pact",
	"abilities/queen_of_pain/custom_queenofpain_blood_pact",
...
function modifier_queenofpain_blood_pact:IsHidden()
	return false
end
function modifier_queenofpain_blood_pact:IsPurgable()
	return false
end
...
function modifier_queenofpain_blood_pact:OnCreated(table)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/queen_of_pain/scream_legendary.vpcf",
...
function modifier_queenofpain_blood_pact:OnIntervalThink()
	...
	self.parent:UpdateUIshort({
		...
		stack = tostring(self.damage * self:GetStackCount()) .. "%",
		style = "QopPact",
	})
end
