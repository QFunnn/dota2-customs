...
LinkLuaModifier(
	"modifier_custom_blink_tracker",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_legendary_attacks",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_legendary_attacks_damage",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_speed_attacks",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_legendary_tracker",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_damage",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_attacks_slow",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_root",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_shield",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_blink_spell_block",
	"abilities/queen_of_pain/custom_queenofpain_blink",
	LUA_MODIFIER_MOTION_NONE
)
...
function custom_queenofpain_blink:GetBehavior()
	...
	if
		caster:HasShard()
		or caster:HasTalent("modifier_queen_blink_7")
		or caster:HasTalent("modifier_queen_blink_5")
	then
...
function custom_queenofpain_blink:ShardStrike(location)
	...
	if caster:HasShard() then
		local blink_shard_pfx = ParticleManager:CreateParticle(
					...
					knock:SetEndCallback(function()
						if enemy and not enemy:IsNull() and knock:GetRemainingTime() <= 0.1 then
							...
							enemy:AddNewModifier(
								...
								self,
								"modifier_custom_blink_root",
								{ duration = (1 - enemy:GetStatusResistance()) * knock_root }
							)
						end
					end)
				end
...
function custom_queenofpain_blink:OnSpellStart()
	...
	local start_b = wearables_system:GetParticleReplacementAbility(
		caster,
		"particles/units/heroes/hero_queenofpain/queen_blink_start.vpcf",
		self
	)
	local end_b = wearables_system:GetParticleReplacementAbility(
		caster,
	...
	if caster:HasTalent("modifier_queen_blink_2") then
		...
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_blink_shield",
			{ duration = caster:GetTalentValue("modifier_queen_blink_2", "duration") }
		)
	end
	...
	if caster:HasTalent("modifier_queen_blink_6") then
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_blink_spell_block",
			{ duration = caster:GetTalentValue("modifier_queen_blink_6", "duration") }
		)
	end
end
...
function modifier_custom_blink_tracker:IsHidden()
	return true
end
function modifier_custom_blink_tracker:IsPurgable()
	return false
end
...
function modifier_custom_blink_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_queen_blink_2") then
		return
	end
...
function modifier_custom_blink_tracker:GetModifierAttackRangeBonus()
	if not self.parent:HasTalent("modifier_queen_blink_3") then
		return
	end
...
function modifier_custom_blink_tracker:GetModifierStatusResistanceStacking()
	if not self.parent:HasTalent("modifier_queen_blink_6") then
		return
	end
...
function modifier_custom_blink_tracker:SpellEvent(params)
	...
	if not self.parent:HasTalent("modifier_queen_blink_7") then
		return
	end
...
function modifier_custom_blink_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_queen_blink_4") then
		return
	end
	...
	local damage = self.parent:GetTalentValue("modifier_queen_blink_4", "damage")
	...
	for _, enemy in pairs(self.parent:FindTargets(self.attack_radius, target:GetAbsOrigin())) do
		...
		enemy:AddNewModifier(
			...
			self.ability,
			"modifier_custom_blink_attacks_slow",
			{ duration = (1 - enemy:GetStatusResistance()) * self.attack_duration }
		)
	end
...
function modifier_custom_blink_legendary_attacks:IsHidden()
	return true
end
function modifier_custom_blink_legendary_attacks:IsPurgable()
	return false
end
...
function modifier_custom_blink_legendary_attacks_damage:IsHidden()
	return true
end
function modifier_custom_blink_legendary_attacks_damage:IsPurgable()
	return false
end
...
function modifier_custom_blink_speed_attacks:IsHidden()
	return false
end
function modifier_custom_blink_speed_attacks:IsPurgable()
	return false
end
function modifier_custom_blink_speed_attacks:GetTexture()
	return "buffs/Crit_damage"
end
...
function modifier_custom_blink_attacks_slow:IsHidden()
	return true
end
function modifier_custom_blink_attacks_slow:IsPurgable()
	return true
end
...
function modifier_custom_blink_legendary_tracker:IsHidden()
	return true
end
function modifier_custom_blink_legendary_tracker:IsPurgable()
	return false
end
...
function modifier_custom_blink_damage:IsHidden()
	return false
end
function modifier_custom_blink_damage:IsPurgable()
	return false
end
function modifier_custom_blink_damage:GetTexture()
...
function modifier_custom_blink_root:IsHidden()
	return true
end
function modifier_custom_blink_root:IsPurgable()
	return true
end
...
function modifier_custom_blink_shield:IsHidden()
	return true
end
function modifier_custom_blink_shield:IsPurgable()
	return false
end
function modifier_custom_blink_shield:OnCreated(table)
	self.parent = self:GetParent()
	self.shield_talent = "modifier_queen_blink_2"
	self.max_shield = self.parent:GetTalentValue("modifier_queen_blink_2", "shield")
		* self.parent:GetIntellect(false)
		/ 100
...
function modifier_custom_blink_spell_block:IsHidden()
	return true
end
function modifier_custom_blink_spell_block:IsPurgable()
	return false
end
