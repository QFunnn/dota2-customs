...
LinkLuaModifier(
	"modifier_queenofpain_innate_custom",
	"abilities/queen_of_pain/queenofpain_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_queenofpain_scepter_custom",
	"abilities/queen_of_pain/queenofpain_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function queenofpain_innate_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/items/queen_of_pain/qop_ti8_immortal/qop_ti8_base_attack.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/items/queen_of_pain/qop_ti8_immortal/qop_ti8_golden_base_attack.vpcf",
		context
	)
...
function modifier_queenofpain_innate_custom:IsHidden()
	return true
end
function modifier_queenofpain_innate_custom:IsPurgable()
	return false
end
function modifier_queenofpain_innate_custom:RemoveOnDeath()
	return false
end
...
function modifier_queenofpain_innate_custom:DamageEvent_out(params)
	...
	if vec:Length2D() > self.max_dist then
		return
	end
...
function modifier_queenofpain_scepter_custom:IsHidden()
	return false
end
function modifier_queenofpain_scepter_custom:IsPurgable()
	return false
end
...
function modifier_queenofpain_scepter_custom:DamageEvent_inc(params)
	...
	if params.inflictor and params.inflictor:GetName() == self.ability:GetName() then
		return
	end
