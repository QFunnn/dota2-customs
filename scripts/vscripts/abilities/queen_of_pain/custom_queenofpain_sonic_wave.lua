...
LinkLuaModifier(
	"modifier_custom_sonic_tracker",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_fire_thinker",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_fire_damage",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_lifesteal",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_stack",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_kill",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_damage",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_damage_arcana_visual",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_legendary_stack",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_sonic_heal_reduce",
	"abilities/queen_of_pain/custom_queenofpain_sonic_wave",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function custom_queenofpain_sonic_wave:GetCooldown(iLevel)
	...
	if caster:HasModifier("modifier_custom_sonic_legendary_stack") then
		k = k
			+ (
					caster:GetTalentValue("modifier_queen_sonic_7", "cd_inc")
					/ caster:GetTalentValue("modifier_queen_sonic_7", "max")
				)
				* caster:GetUpgradeStack("modifier_custom_sonic_legendary_stack")
				/ 100
	end
...
function custom_queenofpain_sonic_wave:OnAbilityPhaseStart()
	...
	if
		particle_name ~= "particles/units/heroes/hero_queenofpain/queen_sonic_wave_cast.vpcf"
		and caster.current_model == "models/items/queenofpain/queenofpain_arcana/queenofpain_arcana.vmdl"
	then
...
function custom_queenofpain_sonic_wave:CreateFire(start_pos, end_pos)
	...
	CreateModifierThinker(
		...
		self,
		"modifier_custom_sonic_fire_thinker",
		{ duration = duration, end_x = end_pos.x, end_y = end_pos.y },
		start_pos,
...
function custom_queenofpain_sonic_wave:OnSpellStart()
	...
	if caster:HasTalent("modifier_queen_sonic_3") then
		caster:AddNewModifier(
			...
			self,
			"modifier_custom_sonic_lifesteal",
			{ duration = caster:GetTalentValue("modifier_queen_sonic_3", "duration") }
		)
	end
	...
	if caster:HasTalent("modifier_queen_sonic_6") then
		caster:AddNewModifier(
			...
			{ duration = caster:GetTalentValue("modifier_queen_sonic_6", "bkb"), effect = 1 }
		)
	end
...
function custom_queenofpain_sonic_wave:OnProjectileHit_ExtraData(target, location, ExtraData)
	...
	if mod and mod.max and mod:GetStackCount() >= mod.max then
		target:AddNewModifier(
			...
			self,
			"modifier_stunned",
			{ duration = (1 - target:GetStatusResistance()) * caster:GetTalentValue("modifier_queen_sonic_4", "stun") }
		)
	end
	...
	if caster:HasTalent("modifier_queen_sonic_5") then
		...
		target:AddNewModifier(
			...
			{ duration = (1 - target:GetStatusResistance())
				* caster:GetTalentValue("modifier_queen_sonic_5", "duration") }
		)
	end
	...
	if caster:HasTalent("modifier_queen_sonic_1") then
		target:AddNewModifier(
			...
			self,
			"modifier_custom_sonic_heal_reduce",
			{ duration = caster:GetTalentValue("modifier_queen_sonic_1", "duration") }
		)
	end
	...
	target:AddNewModifier(
		...
		self,
		"modifier_custom_sonic_kill",
		{ duration = caster:GetTalentValue("modifier_queen_sonic_7", "timer", true) }
	)
...
function modifier_custom_sonic_damage:IsHidden()
	return true
end
function modifier_custom_sonic_damage:IsPurgable()
	return false
end
function modifier_custom_sonic_damage:OnCreated(table)
	...
	local pfx_visual = wearables_system:GetParticleReplacementAbility(
		self.caster,
...
function modifier_custom_sonic_damage:OnDestroy()
	...
	local pfx_visual = wearables_system:GetParticleReplacementAbility(
		self.caster,
		"particles/units/heroes/hero_queenofpain/queen_target_death.vpcf",
		self
	)
...
function modifier_custom_sonic_tracker:IsHidden()
	return true
end
function modifier_custom_sonic_tracker:IsPurgable()
	return false
end
...
function modifier_custom_sonic_tracker:AttackEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_queen_sonic_4") then
		return
	end
...
function modifier_custom_sonic_tracker:DamageEvent_out(params)
	...
	if not self.parent:HasTalent("modifier_queen_sonic_3") then
		return
	end
...
function modifier_custom_sonic_tracker:DeathEvent(params)
	...
	if not self.parent:HasTalent("modifier_queen_sonic_7") then
		return
	end
	if self.parent ~= params.attacker then
		return
	end
	if params.inflictor ~= self.ability and not params.unit:HasModifier("modifier_custom_sonic_kill") then
		return
	end
...
function modifier_custom_sonic_fire_thinker:IsHidden()
	return true
end
function modifier_custom_sonic_fire_thinker:IsPurgable()
	return false
end
...
function modifier_custom_sonic_fire_damage:IsHidden()
	return true
end
function modifier_custom_sonic_fire_damage:IsPurgable()
	return false
end
function modifier_custom_sonic_fire_damage:OnCreated()
	...
	self.damageTable =
		{ attacker = self.caster, ability = self.ability, victim = self.parent, damage_type = DAMAGE_TYPE_PURE }
...
function modifier_custom_sonic_lifesteal:IsHidden()
	return false
end
function modifier_custom_sonic_lifesteal:IsPurgable()
	return false
end
function modifier_custom_sonic_lifesteal:GetTexture()
	return "buffs/sonic_reduce"
end

modifier_custom_sonic_stack = class({})
function modifier_custom_sonic_stack:IsHidden()
	return false
end
function modifier_custom_sonic_stack:IsPurgable()
	return false
end
function modifier_custom_sonic_stack:GetTexture()
...
function modifier_custom_sonic_kill:IsHidden()
	return true
end
function modifier_custom_sonic_kill:IsPurgable()
	return false
end
function modifier_custom_sonic_kill:RemoveOnDeath()
	return false
end

modifier_custom_sonic_damage_arcana_visual = class({})
function modifier_custom_sonic_damage_arcana_visual:IsHidden()
	return true
end
function modifier_custom_sonic_damage_arcana_visual:IsPurgable()
	return false
end
function modifier_custom_sonic_damage_arcana_visual:IsPurgeException()
	return false
end
...
function modifier_custom_sonic_legendary_stack:IsHidden()
	return false
end
function modifier_custom_sonic_legendary_stack:IsPurgable()
	return false
end
function modifier_custom_sonic_legendary_stack:RemoveOnDeath()
	return false
end
...
function modifier_custom_sonic_heal_reduce:IsHidden()
	return true
end
function modifier_custom_sonic_heal_reduce:IsPurgable()
	return false
end
...
function modifier_custom_sonic_cdr_perma:IsHidden()
	return not self:GetCaster():HasTalent("modifier_queen_sonic_6")
end
function modifier_custom_sonic_cdr_perma:IsPurgable()
	return false
end
function modifier_custom_sonic_cdr_perma:RemoveOnDeath()
	return false
end
function modifier_custom_sonic_cdr_perma:GetTexture()
...
function modifier_custom_sonic_cdr_perma:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_queen_sonic_6") then
		return
	end
