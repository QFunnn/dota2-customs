...
LinkLuaModifier(
	"modifier_custom_void_dissimilate_slow_thinker",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_slow",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_resist",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_heal",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_speed",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_tracker",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_dissimilate_legendary",
	"abilities/void_spirit/void_spirit_dissimilate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function void_spirit_dissimilate_custom:GetDamage()
	...
	return self:GetSpecialValueFor("AbilityDamage")
		+ caster:GetTalentValue("modifier_void_astral_1", "damage") * caster:GetIntellect(false) / 100
end
...
function modifier_custom_void_dissimilate:OnCreated(kv)
	...
	if self.parent:HasTalent("modifier_void_astral_legendary") and not self.ability:IsHidden() then
		self.parent:SwapAbilities(
			"void_spirit_dissimilate_custom_cancel",
...
function modifier_custom_void_dissimilate:OnDestroy()
	...
	for _, enemy in pairs(enemies) do
		...
		if self:GetStackCount() > 0 then
			enemy:AddNewModifier(
				...
				self.ability,
				"modifier_custom_void_dissimilate_legendary",
				{ duration = legendary_duration, stack = self:GetStackCount() }
			)
		end
		...
		if self.parent:HasTalent("modifier_void_astral_4") then
			enemy:AddNewModifier(
				...
				self.ability,
				"modifier_stunned",
				{ duration = (1 - enemy:GetStatusResistance()) * stun_duration }
			)
		end
	...
	if self.parent:HasTalent("modifier_void_astral_3") then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_custom_void_dissimilate_speed",
			{ duration = self.parent:GetTalentValue("modifier_void_astral_3", "duration") }
		)
	end
...
function modifier_custom_void_dissimilate_tracker:IsHidden()
	return true
end
function modifier_custom_void_dissimilate_tracker:IsPurgable()
	return false
end
...
function modifier_custom_void_dissimilate_tracker:GetModifierPercentageCooldown()
	if not self.parent:HasTalent("modifier_void_astral_6") then
		return
	end
	return self.cdr
end
...
function modifier_custom_void_dissimilate_tracker:SpellEvent(params)
	...
	if not self.parent:HasTalent("modifier_void_astral_2") then
		return
	end
...
function modifier_custom_void_dissimilate_tracker:AttackEvent_out(params)
	...
	if
		self.parent:HasTalent("modifier_void_astral_legendary")
		and target:HasModifier("modifier_custom_void_dissimilate_legendary")
	then
		...
		local real_damage = DoDamage(
			{
				...
				attacker = self.parent,
				ability = self.ability,
				damage = self.ability:GetDamage() * self.legendary_damage,
				damage_type = DAMAGE_TYPE_MAGICAL,
			},
...
function modifier_custom_void_dissimilate_slow_thinker:IsHidden()
	return true
end
function modifier_custom_void_dissimilate_slow_thinker:IsPurgable()
	return false
end
function modifier_custom_void_dissimilate_slow_thinker:IsAura()
	return true
end
function modifier_custom_void_dissimilate_slow_thinker:GetAuraDuration()
	return 0.2
end
function modifier_custom_void_dissimilate_slow_thinker:GetAuraRadius()
	return self.radius
end
...
function modifier_custom_void_dissimilate_slow_thinker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_custom_void_dissimilate_slow_thinker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_custom_void_dissimilate_slow_thinker:GetModifierAura()
	return "modifier_custom_void_dissimilate_slow"
end

modifier_custom_void_dissimilate_slow = class({})
function modifier_custom_void_dissimilate_slow:IsPurgable()
	return true
end
function modifier_custom_void_dissimilate_slow:IsHidden()
	return false
end
...
function modifier_custom_void_dissimilate_heal:IsHidden()
	return false
end
function modifier_custom_void_dissimilate_heal:IsPurgable()
	return false
end
function modifier_custom_void_dissimilate_heal:GetTexture()
	return "buffs/arcane_regen"
end
function modifier_custom_void_dissimilate_heal:GetEffectName()
...
function modifier_custom_void_dissimilate_heal:OnCreated(table)
	self.parent = self:GetParent()
	self.heal = self.parent:GetMaxMana()
		* (self.parent:GetTalentValue("modifier_void_astral_2", "mana") / 100)
		/ self.parent:GetTalentValue("modifier_void_astral_2", "duration")
end
...
function modifier_custom_void_dissimilate_speed:IsHidden()
	return false
end
function modifier_custom_void_dissimilate_speed:IsPurgable()
	return false
end
function modifier_custom_void_dissimilate_speed:GetTexture()
...
function modifier_custom_void_dissimilate_resist:IsHidden()
	return false
end
function modifier_custom_void_dissimilate_resist:IsPurgable()
	return true
end
function modifier_custom_void_dissimilate_resist:GetTexture()
...
function modifier_custom_void_dissimilate_legendary:IsHidden()
	return true
end
function modifier_custom_void_dissimilate_legendary:IsPurgable()
	return false
end
...
function modifier_custom_void_dissimilate_spell:IsHidden()
	return not self:GetCaster():HasTalent("modifier_void_astral_4")
end
function modifier_custom_void_dissimilate_spell:IsPurgable()
	return false
end
function modifier_custom_void_dissimilate_spell:RemoveOnDeath()
	return false
end
function modifier_custom_void_dissimilate_spell:GetTexture()
	return "buffs/void_speed"
end
...
function modifier_custom_void_dissimilate_spell:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_void_astral_4") then
		return
	end
