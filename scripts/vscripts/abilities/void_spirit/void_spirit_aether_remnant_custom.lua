...
LinkLuaModifier(
	...
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
...
LinkLuaModifier(
	"modifier_custom_void_remnant_target_creep",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_tracker",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_slow",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_legendary_caster",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_speed",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_bonus",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_legendary_illusion",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_damage_reduce",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_custom_void_remnant_auto_cd",
	"abilities/void_spirit/void_spirit_aether_remnant_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function void_spirit_aether_remnant_custom:GetDamage()
	...
	return self:GetSpecialValueFor("impact_damage")
		+ caster:GetTalentValue("modifier_void_remnant_1", "damage") * caster:GetAverageTrueAttackDamage(nil) / 100
end
...
function void_spirit_aether_remnant_custom:OnVectorCastStart(vStartLocation, vDirection)
	...
	CreateModifierThinker(
		...
		self,
		"modifier_custom_void_remnant_thinker",
		{ auto = 0, dir_x = vDirection.x, dir_y = vDirection.y, dir_z = vDirection.z },
		point,
...
function modifier_custom_void_remnant_thinker:OnCreated(kv)
	...
	self.pull_duration = self.ability:GetSpecialValueFor("pull_duration")
		+ self.caster:GetTalentValue("modifier_void_remnant_3", "stun")
...
function modifier_custom_void_remnant_thinker:WatchLogic()
	...
	AddFOWViewer(
		...
		self.origin + self.direction * self.distance / 2,
		self.watch_vision,
		0.1,
		true
	)
	...
	if
		self.caster:HasModifier("modifier_void_step_4")
		and not enemy:HasModifier("modifier_void_spirit_astral_step_spells_max")
	then
		enemy:AddNewModifier(
			self.caster,
			self.ability,
			"modifier_void_spirit_astral_step_spells",
			{ duration = self.caster:GetTalentValue("modifier_void_step_4", "duration") }
		)
	end

	if self.caster:HasTalent("modifier_void_remnant_6") then
		self.caster:GenericHeal(
			self.caster:GetMaxHealth() * self.caster:GetTalentValue("modifier_void_remnant_6", "heal", true) / 100,
			self.ability,
			nil,
			nil,
...
function modifier_custom_void_remnant_target:OnCreated(kv)
	...
	if self.caster:HasTalent("modifier_void_remnant_3") then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_custom_void_remnant_damage_reduce",
			{ duration = self.caster:GetTalentValue("modifier_void_remnant_3", "duration") }
		)
	end
end
...
function modifier_custom_void_remnant_target:OnDestroy()
	...
	if self.caster:HasTalent("modifier_void_remnant_5") and self.auto == 0 then
		...
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_custom_void_remnant_slow",
			{ duration = self.caster:GetTalentValue("modifier_void_remnant_5", "duration") }
		)
	end
end
...
function modifier_custom_void_remnant_target_creep:IsHidden()
	return true
end
function modifier_custom_void_remnant_target_creep:IsPurgable()
	return false
end
function modifier_custom_void_remnant_target_creep:OnCreated()
	...
	self.damageTable = {
		victim = self.parent,
		attacker = self.caster,
		damage = self.damage * self.creeps_interval,
		damage_type = DAMAGE_TYPE_MAGICAL,
		ability = self.ability,
	}
...
function modifier_custom_void_remnant_tracker:IsHidden()
	return true
end
function modifier_custom_void_remnant_tracker:IsPurgable()
	return false
end
function modifier_custom_void_remnant_tracker:RemoveOnDeath()
	return false
end
...
function modifier_custom_void_remnant_tracker:GetAbsorbSpell(params)
	...
	if not self.parent:HasTalent("modifier_void_remnant_6") then
		return
	end
	if self.parent:HasModifier("modifier_custom_void_remnant_auto_cd") then
		return
	end
	...
	CreateModifierThinker(
		...
		self.ability,
		"modifier_custom_void_remnant_thinker",
		{ auto = 1, dir_x = vDirection.x, dir_y = vDirection.y, dir_z = vDirection.z },
		point,
		self.parent:GetTeamNumber(),
		false
	)
...
function modifier_custom_void_remnant_slow:IsHidden()
	return true
end
function modifier_custom_void_remnant_slow:IsPurgable()
	return false
end
function modifier_custom_void_remnant_slow:GetEffectName()
...
function modifier_custom_void_remnant_speed:IsHidden()
	return false
end
function modifier_custom_void_remnant_speed:IsPurgable()
	return false
end
function modifier_custom_void_remnant_speed:GetTexture()
	return "buffs/manavoid_int"
end
...
function modifier_custom_void_remnant_speed:GetModifierProcAttack_Feedback(params)
	...
	for i = 1, 3 do
		local particle = ParticleManager:CreateParticle(
			"particles/void_spirit/void_mark_hit.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			visual_caster
		)
		ParticleManager:SetParticleControlEnt(
	...
	local hit_effect =
		ParticleManager:CreateParticle("particles/void_spirit/remnant_hit.vpcf", PATTACH_CUSTOMORIGIN, params.target)
	ParticleManager:SetParticleControlEnt(
		hit_effect,
		0,
		params.target,
...
function modifier_custom_void_remnant_legendary_illusion:IsHidden()
	return true
end
function modifier_custom_void_remnant_legendary_illusion:IsPurgable()
	return false
end
function modifier_custom_void_remnant_legendary_illusion:GetEffectName()
	return "particles/void_spirit/remnant_legendary.vpcf"
end
function modifier_custom_void_remnant_legendary_illusion:GetEffectAttachType()
...
function modifier_custom_void_remnant_legendary_illusion:OnCreated(table)
	...
	if mod then
		local new_mod = self.parent:AddNewModifier(
			self.caster,
			self.ability,
			"modifier_custom_void_remnant_speed",
			{ duration = self.caster:GetTalentValue("modifier_void_remnant_4", "duration") }
		)
...
function modifier_custom_void_remnant_legendary_illusion:OnDestroy()
	...
	local effect_cast2 =
		ParticleManager:CreateParticle("particles/void_spirit/legendary_remnant_end.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_custom_void_remnant_legendary_caster:IsHidden()
	return true
end
function modifier_custom_void_remnant_legendary_caster:IsPurgable()
	return false
end
function modifier_custom_void_remnant_legendary_caster:RemoveOnDeath()
	return false
end
function modifier_custom_void_remnant_legendary_caster:GetEffectName()
	return "particles/units/heroes/hero_brewmaster/brewmaster_void_debuff.vpcf"
end
function modifier_custom_void_remnant_legendary_caster:GetEffectAttachType()
...
function void_spirit_aether_remnant_custom_legendary:OnSpellStart()
	...
	if not caster.void_clone or caster.void_clone:IsNull() then
		return
	end
...
function modifier_custom_void_remnant_bonus:IsHidden()
	return true
end
function modifier_custom_void_remnant_bonus:IsPurgable()
	return false
end
function modifier_custom_void_remnant_bonus:GetTexture()
...
function modifier_custom_void_remnant_damage_reduce:IsHidden()
	return true
end
function modifier_custom_void_remnant_damage_reduce:IsPurgable()
	return false
end
...
function modifier_custom_void_remnant_auto_cd:IsHidden()
	return false
end
function modifier_custom_void_remnant_auto_cd:IsPurgable()
	return false
end
function modifier_custom_void_remnant_auto_cd:IsDebuff()
	return true
end
function modifier_custom_void_remnant_auto_cd:GetTexture()
	return "buffs/remnant_lowhp"
end
function modifier_custom_void_remnant_auto_cd:RemoveOnDeath()
	return false
end
