...
LinkLuaModifier(
	"modifier_void_spirit_innate_custom",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_void_spirit_innate_custom_aura",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_void_spirit_innate_custom_tracker",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_void_spirit_innate_custom_scepter_step",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_void_spirit_innate_custom_scepter_aura",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_void_spirit_innate_custom_scepter_aura_damage",
	"abilities/void_spirit/void_spirit_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_void_spirit_innate_custom_tracker:IsHidden()
	return true
end
function modifier_void_spirit_innate_custom_tracker:IsPurgable()
	return false
end
...
function modifier_void_spirit_innate_custom:IsHidden()
	return not self:GetParent():HasScepter()
end
function modifier_void_spirit_innate_custom:IsPurgable()
	return false
end
function modifier_void_spirit_innate_custom:OnCreated(table)
	...
	self.int_mana = GameRules:GetGameModeEntity()
		:GetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_INTELLIGENCE_MANA_REGEN)
	self.int_resist = GameRules:GetGameModeEntity()
		:GetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_INTELLIGENCE_MAGIC_RESIST)
...
function modifier_void_spirit_innate_custom:OnIntervalThink()
	...
	if not self.base_magic then
		self.base_magic = self.parent:GetBaseMagicalResistanceValue()
			- self.parent:GetIntellect(false) * self.int_resist
	...
	self.parent:SetBaseMagicalResistanceValue(
		self.base_magic + self.parent:GetIntellect(false) * self.int_resist * self.bonus
	)
	...
	if self.parent:HasScepter() then
		...
		if
			self.current_max_stat == 0
			and not self.parent:HasModifier("modifier_void_spirit_innate_custom_scepter_aura")
		then
			self.parent:AddNewModifier(self.parent, self.ability, "modifier_void_spirit_innate_custom_scepter_aura", {})
		end

		if
			self.current_max_stat == 2
			and not self.parent:HasModifier("modifier_void_spirit_innate_custom_scepter_step")
		then
...
function modifier_void_spirit_innate_custom:DamageEvent_out(params)
	...
	if self.current_max_stat ~= 1 then
		return
	end
...
function modifier_void_spirit_innate_custom:GetModifierSpellAmplify_Percentage()
	if not self.parent:HasScepter() or self.current_max_stat ~= 2 then
		return
	end
...
function modifier_void_spirit_innate_custom:GetModifierBaseAttackTimeConstant()
	if not self.parent:HasScepter() or self.current_max_stat ~= 1 then
		return
	end
...
function modifier_void_spirit_innate_custom:GetModifierHealthBonus()
	if not self.parent:HasScepter() or self.current_max_stat ~= 0 then
		return
	end
...
function modifier_void_spirit_innate_custom:IsAura()
	return self.parent:HasTalent("modifier_void_pulse_2")
end
function modifier_void_spirit_innate_custom:GetAuraDuration()
	return 0.1
end
function modifier_void_spirit_innate_custom:GetAuraRadius()
	return self.aura_radius
end
function modifier_void_spirit_innate_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_void_spirit_innate_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_void_spirit_innate_custom:GetModifierAura()
	return "modifier_void_spirit_innate_custom_aura"
end

modifier_void_spirit_innate_custom_aura = class({})
function modifier_void_spirit_innate_custom_aura:IsHidden()
	return false
end
function modifier_void_spirit_innate_custom_aura:IsPurgable()
	return false
end
function modifier_void_spirit_innate_custom_aura:GetTexture()
	return "buffs/flux_speed"
end
...
function modifier_void_spirit_innate_custom_scepter_step:IsHidden()
	return true
end
function modifier_void_spirit_innate_custom_scepter_step:IsPurgable()
	return false
end
function modifier_void_spirit_innate_custom_scepter_step:RemoveOnDeath()
	return false
end
...
function modifier_void_spirit_innate_custom_scepter_aura:IsHidden()
	return true
end
function modifier_void_spirit_innate_custom_scepter_aura:IsPurgable()
	return false
end
function modifier_void_spirit_innate_custom_scepter_aura:RemoveOnDeath()
	return false
end
...
function modifier_void_spirit_innate_custom_scepter_aura:IsAura()
	return true
end
function modifier_void_spirit_innate_custom_scepter_aura:GetAuraDuration()
	return 0.1
end
function modifier_void_spirit_innate_custom_scepter_aura:GetAuraRadius()
	return self.aura_radius
end
function modifier_void_spirit_innate_custom_scepter_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_void_spirit_innate_custom_scepter_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_void_spirit_innate_custom_scepter_aura:GetModifierAura()
	return "modifier_void_spirit_innate_custom_scepter_aura_damage"
end

modifier_void_spirit_innate_custom_scepter_aura_damage = class({})
function modifier_void_spirit_innate_custom_scepter_aura_damage:IsHidden()
	return true
end
function modifier_void_spirit_innate_custom_scepter_aura_damage:IsPurgable()
	return false
end
function modifier_void_spirit_innate_custom_scepter_aura_damage:GetTexture()
	return "buffs/astral_burn"
end
