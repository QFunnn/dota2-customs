...
function modifier_boar_passive:IsHidden()
	return true
end
...
function modifier_boar_passive:GetModifierProcAttack_Feedback(param)
...
function modifier_boar_slow_debuf:IsHidden()
	return false
end

function modifier_boar_slow_debuf:IsPurgable()
	return false
end
