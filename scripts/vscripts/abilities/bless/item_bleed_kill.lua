...
local a = "abilities/bless/item_bleed_kill"
...
function j.prototype.StaticProperty(self)
	return { [PropertyFunction.DAMAGE_AMPLIFY] = self:GetStackCount() * self:GetSpecialValueFor("damage_pct") }
end
j = e({ i(nil) }, j)
return f