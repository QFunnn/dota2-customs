...
LinkLuaModifier(
	...
	"abilities/doom_bringer_scorched_earth",
...
function doom_bringer_scorched_earth_custom:OnToggle()
	...
	local modifier_doom_bringer_scorched_earth_effect_aura =
		self:GetCaster():FindModifierByName("modifier_doom_bringer_scorched_earth_effect_aura")
	local modifier_doom_bringer_scorched_earth_custom =
		self:GetCaster():FindModifierByName("modifier_doom_bringer_scorched_earth_custom")
...
function modifier_doom_bringer_scorched_earth_custom:IsHidden()
	return false
end
function modifier_doom_bringer_scorched_earth_custom:IsPurgable()
	return false
end
function modifier_doom_bringer_scorched_earth_custom:IsPurgeException()
	return false
end
