...
local a = "abilities/common/super_baby_dragon_attack"
...
local j = c()
j.name = "super_baby_dragon_attack"
d(j, h)
...
function j.prototype.OnSpellStart(self)
	...
	local o = n:GetItemByName("item_super_dragon_baby")
	if not IsValid(o) then
		return
	end
	Bullet:SplitAction(CalcDirection2D(m, l), 5, 10, function(p, q)
