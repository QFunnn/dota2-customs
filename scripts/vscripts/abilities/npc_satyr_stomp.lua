...
function modifier_stomp_break:IsHidden()
	return false
end
function modifier_stomp_break:IsPurgable()
	return false
end
...
function modifier_satyr_stomp_cd:IsHidden()
	return false
end
function modifier_satyr_stomp_cd:IsPurgable()
	return false
end