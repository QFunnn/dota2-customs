...
LinkLuaModifier(
	"modifier_keeper_of_the_light_spirit_form_custom_fly",
	"abilities/keeper_of_the_light_spirit_form_custom",
...
function keeper_of_the_light_spirit_form_custom:OnToggle()
	...
	if not self:GetToggleState() then
		...
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self, "modifier_keeper_of_the_light_spirit_form_custom_fly", {})
...
function modifier_keeper_of_the_light_spirit_form_custom_fly:IsHidden()
	return true
end
function modifier_keeper_of_the_light_spirit_form_custom_fly:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_spirit_form_custom_fly:IsPurgeException()
	return false
end
...
function modifier_keeper_of_the_light_spirit_form_custom:IsHidden()
	return false
end
function modifier_keeper_of_the_light_spirit_form_custom:IsPurgable()
	return false
end
...
function modifier_keeper_of_the_light_spirit_form_custom:TakeDamageScriptModifier(params)
	...
	then
		...
		for _, mod in pairs(self:GetParent():FindAllModifiers()) do
			if
				mod.GetModifierSpellLifestealRegenAmplify_Percentage
				and mod:GetModifierSpellLifestealRegenAmplify_Percentage()
			then
