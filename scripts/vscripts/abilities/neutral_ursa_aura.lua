...
function modifier_ursa_aura:IsPurgable()
	return false
end
function modifier_ursa_aura:IsHidden()
	return true
end
...
function modifier_ursa_aura_buff:IsPurgable()
	return false
end
function modifier_ursa_aura_buff:IsHidden()
	return false
end
