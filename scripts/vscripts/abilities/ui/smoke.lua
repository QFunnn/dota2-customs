...
function custom_ability_smoke:OnSpellStart()
	...
	if caster:HasModifier("modifier_item_custom_smoke_cd") then
		return
	end
...
function modifier_item_custom_smoke_charges:IsHidden()
	return true
end
function modifier_item_custom_smoke_charges:DestroyOnExpire()
	return false
end
function modifier_item_custom_smoke_charges:IsPurgable()
	return false
end
...
function modifier_item_custom_smoke_cd:IsHidden()
	return true
end
function modifier_item_custom_smoke_cd:IsPurgable()
	return false
end

modifier_item_custom_smoke_quest = class({})
function modifier_item_custom_smoke_quest:IsHidden()
	return true
end
function modifier_item_custom_smoke_quest:IsPurgable()
	return false
end
function modifier_item_custom_smoke_quest:RemoveOnDeath()
	return false
end
...
function modifier_item_custom_smoke_quest:OnIntervalThink()
	...
	if not mod then
		self:GetParent():AddNewModifier(
			self:GetParent(),
			nil,
			"modifier_item_custom_smoke_quest_kill",
			{ duration = self:GetParent().quest.number }
		)
		self:Destroy()
	end
end
...
function modifier_item_custom_smoke_quest_kill:IsHidden()
	return false
end
function modifier_item_custom_smoke_quest_kill:IsPurgable()
	return false
end
function modifier_item_custom_smoke_quest_kill:RemoveOnDeath()
	return false
end
function modifier_item_custom_smoke_quest_kill:GetTexture()
	return "buffs/quest_smoke"
end