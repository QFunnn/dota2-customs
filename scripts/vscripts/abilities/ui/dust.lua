...
function custom_ability_dust:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_item_custom_dust_cd") then
		return
	end
	...
	CreateModifierThinker(
		self:GetCaster(),
		self,
		"modifier_item_custom_dust_area",
...
function modifier_item_custom_dust_area:IsHidden()
	return true
end
function modifier_item_custom_dust_area:IsPurgable()
	return false
end
function modifier_item_custom_dust_area:OnCreated()
	...
	local particle =
		ParticleManager:CreateParticle("particles/items_fx/dust_of_appearance.vpcf", PATTACH_WORLDORIGIN, nil)
...
function modifier_item_custom_dust_area:OnIntervalThink()
	...
	for _, unit in pairs(targets) do
		...
		unit:AddNewModifier(
			...
			{ duration = self.duration, movespeed = self.movespeed }
		)
	end
end

modifier_item_custom_dust_charges = class({})
function modifier_item_custom_dust_charges:IsHidden()
	return true
end
function modifier_item_custom_dust_charges:DestroyOnExpire()
	return false
end
function modifier_item_custom_dust_charges:IsPurgable()
	return false
end

modifier_item_custom_dust_cd = class({})
function modifier_item_custom_dust_cd:IsHidden()
	return true
end
function modifier_item_custom_dust_cd:IsPurgable()
	return false
end