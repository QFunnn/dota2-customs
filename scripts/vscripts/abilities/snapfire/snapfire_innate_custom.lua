...
LinkLuaModifier(
	"modifier_snapfire_innate_custom",
	"abilities/snapfire/snapfire_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_innate_custom_nodamage",
	"abilities/snapfire/snapfire_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_innate_custom_nocount",
	"abilities/snapfire/snapfire_innate_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_snapfire_innate_custom:IsHidden()
	return true
end
function modifier_snapfire_innate_custom:IsPurgable()
	return false
end
function modifier_snapfire_innate_custom:RemoveOnDeath()
	return false
end
...
function modifier_snapfire_innate_custom_nodamage:IsHidden()
	return true
end
function modifier_snapfire_innate_custom_nodamage:IsPurgable()
	return false
end

modifier_snapfire_innate_custom_nocount = class({})
function modifier_snapfire_innate_custom_nocount:IsHidden()
	return true
end
function modifier_snapfire_innate_custom_nocount:IsPurgable()
	return false
end