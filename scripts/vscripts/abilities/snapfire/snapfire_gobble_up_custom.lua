...
LinkLuaModifier(
	"modifier_snapfire_mortimer_kisses_custom_gobble",
	"abilities/snapfire/snapfire_gobble_up_custom",
...
LinkLuaModifier(
	"modifier_snapfire_mortimer_kisses_custom_gobble_slow",
	"abilities/snapfire/snapfire_gobble_up_custom",
	LUA_MODIFIER_MOTION_NONE
)
	...
	if arc then
		...
		arc:SetEndCallback(function()
			...
			target:AddNewModifier(
				...
				self,
				"modifier_snapfire_mortimer_kisses_custom_gobble_slow",
				{ duration = (1 - target:GetStatusResistance()) * self:GetSpecialValueFor("move_slow_duration") }
			)
		end)
	end
...
function modifier_snapfire_mortimer_kisses_custom_gobble:IsHidden()
	return false
end
function modifier_snapfire_mortimer_kisses_custom_gobble:IsPurgable()
	return false
end
...
function modifier_snapfire_mortimer_kisses_custom_gobble_caster:IsHidden()
	return false
end
function modifier_snapfire_mortimer_kisses_custom_gobble_caster:IsPurgable()
	return false
end
...
function modifier_snapfire_mortimer_kisses_custom_gobble_slow:IsHidden()
	return true
end
function modifier_snapfire_mortimer_kisses_custom_gobble_slow:IsPurgable()
	return true
end
