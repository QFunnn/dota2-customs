...
LinkLuaModifier(
	...
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_debuff",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_tracker",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_armor",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_silence_cd",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_legendary_spell",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_snapfire_lil_shredder_custom_slow",
	"abilities/snapfire/snapfire_lil_shredder_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_snapfire_lil_shredder_custom:OnCreated(kv)
	...
	self.attack_damage = self.ability:GetSpecialValueFor("attack_damage")
		+ self.parent:GetTalentValue("modifier_snapfire_shredder_1", "damage")
...
function modifier_snapfire_lil_shredder_custom:OnIntervalThink()
	...
	if self.overheat >= self.max then
		...
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_stunned",
			{ duration = (1 - self.parent:GetStatusResistance()) * self.stun }
		)
		self:Destroy()
	end
end
...
function modifier_snapfire_lil_shredder_custom:UpdateEffect()
	...
	self.parent:UpdateUIshort({
		max_time = self.max,
		active = self.overheat >= 60,
		time = self.overheat,
		stack_icon = self:GetRemainingTime(),
		stack_icon_zero = 1,
		style = "SnapfireLil",
	})
...
function modifier_snapfire_lil_shredder_custom:AttackStartEvent_out(params)
	...
	if
		self.parent:HasTalent("modifier_snapfire_shredder_4") or self.parent:HasTalent("modifier_snapfire_shredder_7")
	then
		self.spell_mod = self.parent:AddNewModifier(
			self.parent,
			self.ability,
			"modifier_snapfire_lil_shredder_custom_legendary_spell",
			{}
...
function modifier_snapfire_lil_shredder_custom:ProcAttack(params)
	...
	if not self.parent:HasTalent("modifier_snapfire_shredder_6") then
		return
	end
	if target:HasModifier("modifier_snapfire_lil_shredder_custom_silence_cd") then
		return
	end
	...
	local effect_cast =
		ParticleManager:CreateParticle("particles/items3_fx/black_powder_bag.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
...
function modifier_snapfire_lil_shredder_custom_tracker:IsHidden()
	return true
end
function modifier_snapfire_lil_shredder_custom_tracker:IsPurgable()
	return false
end
...
function modifier_snapfire_lil_shredder_custom_tracker:OnIntervalThink()
	...
	if not self.parent:HasTalent("modifier_snapfire_shredder_5") then
		return
	end
...
function modifier_snapfire_lil_shredder_custom_tracker:SpellEvent(params)
	...
	if not self.parent:HasTalent("modifier_snapfire_shredder_4") then
		return
	end
	...
	if
		params.ability:GetName() == "snapfire_gobble_up_custom"
		and self.parent:HasModifier("modifier_snapfire_mortimer_kisses_custom_gobble_caster")
	then
		return
	end
...
function modifier_snapfire_lil_shredder_custom_armor:IsHidden()
	return false
end
function modifier_snapfire_lil_shredder_custom_armor:IsPurgable()
	return false
end
function modifier_snapfire_lil_shredder_custom_armor:GetTexture()
	return "buffs/shredder_armor"
end
...
function modifier_snapfire_lil_shredder_custom_silence_cd:IsHidden()
	return true
end
function modifier_snapfire_lil_shredder_custom_silence_cd:IsPurgable()
	return false
end

modifier_snapfire_lil_shredder_custom_legendary_spell = class({})
function modifier_snapfire_lil_shredder_custom_legendary_spell:IsHidden()
	return false
end
function modifier_snapfire_lil_shredder_custom_legendary_spell:IsPurgable()
	return false
end
function modifier_snapfire_lil_shredder_custom_legendary_spell:GetTexture()
...
function modifier_snapfire_lil_shredder_custom_slow:IsHidden()
	return true
end
function modifier_snapfire_lil_shredder_custom_slow:IsPurgable()
	return true
end
