...
function modifier_dragon_fire_ability:IsPurgable()
	return false
end

function modifier_dragon_fire_ability:IsHidden()
	return true
end
...
function modifier_dragon_fire_thinker:IsHidden()
	return false
end
function modifier_dragon_fire_thinker:IsPurgable()
	return false
end
...
function modifier_dragon_fire_thinker:GetModifierAura()
	return "modifier_dragon_fire_slow"
end

modifier_dragon_fire_slow = class({})

function modifier_dragon_fire_slow:IsPurgable()
	return false
end
function modifier_dragon_fire_slow:IsHidden()
	return false
end
