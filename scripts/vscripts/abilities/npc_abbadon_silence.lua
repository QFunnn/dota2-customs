...
function modifier_abbadon_stack:IsHidden()
	return false
end
...
function modifier_abbadon_silence:IsHidden()
	return false
end
...
function modifier_abbadon_speed:IsHidden()
	return false
end

function modifier_abbadon_speed:IsPurgable()
	return false
end
...
function modifier_abbadon_speed:GetEffectAttachType()
