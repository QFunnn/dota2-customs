...
function modifier_item_soul_relic:IsHidden()
	return true
end
function modifier_item_soul_relic:IsPurgable()
	return false
end
function modifier_item_soul_relic:IsPurgeException()
	return false
end
function modifier_item_soul_relic:RemoveOnDeath()
	return false
end
