...
function item_shield_of_insight:OnSpellStart()
	...
	for _, target in pairs(targets) do
		target:AddNewModifier(
			self:GetCaster(),
			self,
			"modifier_item_shield_of_insight_active",
...
function modifier_item_shield_of_insight_active:OnCreated()
	...
	local particle =
		ParticleManager:CreateParticle("particles/pavise_effect.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
...
function modifier_item_shield_of_insight:AllowIllusionDuplicate()
	return false
end
function modifier_item_shield_of_insight:IsPurgable()
	return false
end
function modifier_item_shield_of_insight:RemoveOnDeath()
	return false
end
function modifier_item_shield_of_insight:IsHidden()
	return true
end
function modifier_item_shield_of_insight:GetAttributes()
