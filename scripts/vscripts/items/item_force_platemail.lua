...
function modifier_item_force_platemail:IsHidden()
	return true
end
function modifier_item_force_platemail:IsPurgable()
	return false
end
function modifier_item_force_platemail:IsPurgeException()
	return false
end
function modifier_item_force_platemail:GetAttributes()
