...
function modifier_item_veil_desolator_custom:IsHidden()
	return true
end

function modifier_item_veil_desolator_custom:IsPurgable()
	return false
end
function modifier_item_veil_desolator_custom:IsPurgeException()
	return false
end

function modifier_item_veil_desolator_custom:GetAttributes()
