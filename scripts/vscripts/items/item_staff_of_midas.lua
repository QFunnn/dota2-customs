...
function modifier_item_staff_of_midas:IsHidden()
	return true
end
function modifier_item_staff_of_midas:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_item_staff_of_midas:IsPurgable()
	return false
end
function modifier_item_staff_of_midas:IsPurgeException()
	return false
end
function modifier_item_staff_of_midas:RemoveOnDeath()
	return false
end
