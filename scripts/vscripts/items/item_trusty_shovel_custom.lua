...
function modifier_item_trusty_shovel_custom:IsHidden()
	return true
end

function modifier_item_trusty_shovel_custom:IsPurgable()
	return false
end
function modifier_item_trusty_shovel_custom:IsPurgeException()
	return false
end
function modifier_item_trusty_shovel_custom:RemoveOnDeath()
	return false
end
