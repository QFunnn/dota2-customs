...
LinkLuaModifier( "modifier_item_kaya_3_lua", "items/item_kaya_3_lua", LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------------------
...
function modifier_item_kaya_3_lua:GetModifierPercentageManacostStacking(params)
	return self:GetAbility():GetSpecialValueFor("manacost_reduction")
end

function modifier_item_kaya_3_lua:GetModifierManadrainAmplify_Percentage(params)
	return self:GetAbility():GetSpecialValueFor("manacost_reduction")
end