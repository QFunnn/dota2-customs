...
function modifier_item_moon_yasha:IsHidden()
	return true
end
function modifier_item_moon_yasha:IsPurgable()
	return false
end
function modifier_item_moon_yasha:IsPurgeException()
	return false
end
function modifier_item_moon_yasha:GetAttributes()
...
function modifier_item_moon_yasha_buff:IsPurgable()
	return false
end
function modifier_item_moon_yasha_buff:RemoveOnDeath()
	return false
end
function modifier_item_moon_yasha_buff:GetTexture()
	return "item_moon_yasha"
end

function modifier_item_moon_yasha_buff:OnCreated()
	self.movespeed_bonus = 15
end
