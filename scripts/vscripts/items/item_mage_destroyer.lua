...
function item_mage_destroyer:OnSpellStart()
	...
	target:AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_item_orchid_custom_active",
...
function modifier_item_mage_destroyer:IsPurgable()
	return false
end
function modifier_item_mage_destroyer:IsPurgeException()
	return false
end

function modifier_item_mage_destroyer:GetAttributes()
