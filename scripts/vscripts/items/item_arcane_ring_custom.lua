...
function modifier_item_arcane_ring_custom:IsHidden()
	return true
end
function modifier_item_arcane_ring_custom:IsPurgable()
	return false
end
function modifier_item_arcane_ring_custom:IsPurgeException()
	return false
end
function modifier_item_arcane_ring_custom:RemoveOnDeath()
	return false
end
