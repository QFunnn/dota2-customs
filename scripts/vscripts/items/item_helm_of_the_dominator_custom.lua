...
LinkLuaModifier(
	...
	"items/item_helm_of_the_dominator_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_helm_of_the_overlord_custom",
	"items/item_helm_of_the_dominator_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_item_helm_of_the_overlord_custom_vladmir",
	"items/item_helm_of_the_dominator_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_helm_of_the_overlord_custom_vladmir_aura",
	"items/item_helm_of_the_dominator_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_helm_of_the_dominator_custom:IsPurgable()
	return false
end
function modifier_item_helm_of_the_dominator_custom:IsPurgeException()
	return false
end

function modifier_item_helm_of_the_dominator_custom:GetAttributes()
...
function modifier_item_helm_of_the_dominator_custom:IsAura()
	return true
end
...
function modifier_item_helm_of_the_overlord_custom:OnCreated()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_item_helm_of_the_overlord_custom_vladmir", {})
end
...
function modifier_item_helm_of_the_overlord_custom:IsAura()
	return true
end
...
function modifier_item_helm_of_the_overlord_custom_vladmir:IsPurgable()
	return false
end
function modifier_item_helm_of_the_overlord_custom_vladmir:RemoveOnDeath()
	return false
end
function modifier_item_helm_of_the_overlord_custom_vladmir:IsHidden()
	return true
end
...
function modifier_item_helm_of_the_overlord_custom_vladmir_aura:IsPurgable()
	return false
end
...
function modifier_item_helm_of_the_dominator_custom_aura:AddCustomTransmitterData()
	return {
