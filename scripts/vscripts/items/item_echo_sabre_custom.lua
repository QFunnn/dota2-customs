...
function modifier_item_echo_sabre_custom:StartSpeed(target, slow)
	...
	if self:GetParent():HasItemInInventory("item_harpoon") then
		return
	end
...
function modifier_item_echo_sabre_custom:OnAttack(params)
	...
	if not self:GetParent():HasModifier("modifier_vengefulspirit_retribution") then
		return
	end
	if self:GetParent():HasItemInInventory("item_harpoon") then
		return
...
function modifier_item_echo_sabre_custom_speed:IsHidden()
	return true
end
function modifier_item_echo_sabre_custom_speed:IsPurgable()
	return false
end
...
function modifier_item_echo_sabre_custom_slow:IsHidden()
	return false
end
