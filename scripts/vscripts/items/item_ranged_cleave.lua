...
function modifier_item_ranged_cleave:IsDebuff()
	return false
end
function modifier_item_ranged_cleave:IsHidden()
	return true
end
function modifier_item_ranged_cleave:IsPurgable()
	return false
end
...
function modifier_item_ranged_cleave:GetModifierPreAttack_BonusDamage(params)
