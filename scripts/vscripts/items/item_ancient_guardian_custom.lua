...
function modifier_item_ancient_guardian_custom:IsPurgable()
	return false
end
function modifier_item_ancient_guardian_custom:IsHidden()
	return true
end
function modifier_item_ancient_guardian_custom:IsPurgeException()
	return false
end
function modifier_item_ancient_guardian_custom:IsPurgable()
	return false
end
function modifier_item_ancient_guardian_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_ancient_guardian_custom:OnTakeDamage(params)
	...
	if self:GetParent():FindAllModifiersByName("modifier_item_ancient_guardian_custom")[1] ~= self then
		return
	end
