...
LinkLuaModifier(
	"modifier_item_solar_crest_custom_debuff",
	"items/item_solar_crest_custom.lua",
...
function modifier_item_solar_crest_custom:IsHidden()
	return true
end
function modifier_item_solar_crest_custom:IsPurgable()
	return false
end
function modifier_item_solar_crest_custom:IsPurgeException()
	return false
end
