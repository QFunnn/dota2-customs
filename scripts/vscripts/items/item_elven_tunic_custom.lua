...
function modifier_item_elven_tunic_custom:IsHidden()
	return true
end

function modifier_item_elven_tunic_custom:IsPurgable()
	return false
end
function modifier_item_elven_tunic_custom:IsPurgeException()
	return false
end
