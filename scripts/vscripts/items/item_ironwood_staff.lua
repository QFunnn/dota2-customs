...
function modifier_item_ironwood_staff:IsHidden()
	return true
end
function modifier_item_ironwood_staff:IsPurgable()
	return false
end
function modifier_item_ironwood_staff:IsPurgeException()
	return false
end
function modifier_item_ironwood_staff:GetAttributes()
