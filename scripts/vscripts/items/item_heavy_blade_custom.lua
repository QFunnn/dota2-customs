...
function modifier_item_heavy_blade_custom:IsHidden()
	return true
end

function modifier_item_heavy_blade_custom:IsPurgable()
	return false
end
function modifier_item_heavy_blade_custom:IsPurgeException()
	return false
end
