...
function modifier_item_summoner_crown:IsDebuff()
	return false
end
function modifier_item_summoner_crown:IsHidden()
	return true
end
function modifier_item_summoner_crown:IsPurgable()
	return false
end
function modifier_item_summoner_crown:GetAttributes()
...
function modifier_item_summoner_crown_buff_agi:IsDebuff()
	return false
end
function modifier_item_summoner_crown_buff_agi:IsHidden()
	return true
end
function modifier_item_summoner_crown_buff_agi:IsPurgable()
	return false
end
function modifier_item_summoner_crown_buff_agi:GetAttributes()
...
function modifier_item_summoner_crown_buff_int:IsDebuff()
	return false
end
function modifier_item_summoner_crown_buff_int:IsHidden()
	return true
end
function modifier_item_summoner_crown_buff_int:IsPurgable()
	return false
end
function modifier_item_summoner_crown_buff_int:GetAttributes()
	return MODIFIER_ATTRIBUTE_PERMANENT + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end
...
function modifier_item_summoner_crown_buff_int:TakeDamageScriptModifier(params)
	...
	if params.unit:IsAttackImmune() then
		return
	end
	if params.unit:IsInvulnerable() then
		return
	end
...
function modifier_item_summoner_crown_model_size:IsDebuff()
	return false
end
function modifier_item_summoner_crown_model_size:IsHidden()
	return true
end
function modifier_item_summoner_crown_model_size:IsPurgable()
	return false
end
function modifier_item_summoner_crown_model_size:GetAttributes()
	return MODIFIER_ATTRIBUTE_PERMANENT + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end
