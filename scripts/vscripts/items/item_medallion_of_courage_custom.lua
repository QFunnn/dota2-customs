...
LinkLuaModifier(
	"modifier_item_medallion_of_courage_custom",
	"items/item_medallion_of_courage_custom.lua",
...
LinkLuaModifier(
	"modifier_item_medallion_of_courage_custom_debuff",
	"items/item_medallion_of_courage_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_medallion_of_courage_custom:IsHidden()
	return true
end
function modifier_item_medallion_of_courage_custom:IsPurgable()
	return false
end
function modifier_item_medallion_of_courage_custom:IsPurgeException()
	return false
end
function modifier_item_medallion_of_courage_custom:GetAttributes()
