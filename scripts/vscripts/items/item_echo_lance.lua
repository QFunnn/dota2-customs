...
function modifier_item_echo_spear:IsHidden()
	return true
end
function modifier_item_echo_spear:RemoveOnDeath()
	return false
end
function modifier_item_echo_spear:IsPurgable()
	return false
end
function modifier_item_echo_spear:IsPurgeException()
	return false
end
function modifier_item_echo_spear:GetAttributes()
...
function modifier_item_echo_spear:StartSpeed(target, slow)
	...
	if self:GetParent():FindAllModifiersByName("modifier_item_echo_spear")[1] ~= self then
		return
	end
...
function modifier_item_echo_spear_speed:IsHidden()
	return true
end
function modifier_item_echo_spear_speed:IsPurgable()
	return false
end
...
function modifier_item_echo_spear_slow:IsHidden()
	return false
end
function modifier_item_echo_spear_slow:IsPurgable()
	return true
end
