...
LinkLuaModifier(
	"modifier_item_seeds_of_serenity_custom",
	"items/item_seeds_of_serenity_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_seeds_of_serenity_custom_thinker",
	"items/item_seeds_of_serenity_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_seeds_of_serenity_custom_buff",
	"items/item_seeds_of_serenity_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_seeds_of_serenity_custom:IsHidden()
	return true
end
function modifier_item_seeds_of_serenity_custom:IsPurgable()
	return false
end
function modifier_item_seeds_of_serenity_custom:IsPurgeException()
	return false
end
function modifier_item_seeds_of_serenity_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_seeds_of_serenity_custom_thinker:IsHidden()
	return true
end
function modifier_item_seeds_of_serenity_custom_thinker:IsPurgable()
	return false
end
