...
function modifier_item_glimmer_shiled_passive:IsHidden()
	return true
end
function modifier_item_glimmer_shiled_passive:IsPurgable()
	return false
end
function modifier_item_glimmer_shiled_passive:IsPurgeException()
	return false
end
...
function modifier_item_glimmer_shiled_active:IsHidden()
	return false
end
...
function modifier_item_glimmer_shiled_active:GetModifierMoveSpeedBonus_Percentage()
	return self.speed
end
