...
LinkLuaModifier(
	"modifier_item_dagger_of_ristul_custom_debuff",
	"items/item_dagger_of_ristul_custom",
...
function modifier_item_dagger_of_ristul_custom:IsHidden()
	return true
end
function modifier_item_dagger_of_ristul_custom:IsPurgable()
	return false
end
function modifier_item_dagger_of_ristul_custom:IsPurgeException()
	return false
end
function modifier_item_dagger_of_ristul_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_dagger_of_ristul_custom_debuff:IsPurgable()
	return true
end
