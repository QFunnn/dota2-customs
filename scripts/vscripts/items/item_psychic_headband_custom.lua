...
function item_psychic_headband_custom:OnSpellStart()
	...
	target:AddNewModifier(
		...
		{ duration = push_duration, push_length = push_length }
	)
...
function modifier_item_psychic_headband_custom:IsHidden()
	return true
end

function modifier_item_psychic_headband_custom:IsPurgable()
	return false
end
function modifier_item_psychic_headband_custom:IsPurgeException()
	return false
end
