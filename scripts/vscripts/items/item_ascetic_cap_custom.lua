...
function modifier_item_ascetic_cap_custom:IsHidden()
	return true
end

function modifier_item_ascetic_cap_custom:IsPurgable()
	return false
end
function modifier_item_ascetic_cap_custom:IsPurgeException()
	return false
end
