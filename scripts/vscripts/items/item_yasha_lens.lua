...
function modifier_item_yasha_lens:IsHidden()
	return true
end
function modifier_item_yasha_lens:IsPurgable()
	return false
end
function modifier_item_yasha_lens:IsPurgeException()
	return false
end
function modifier_item_yasha_lens:GetAttributes()
...
function modifier_item_yasha_lens_active:IsHidden()
	return true
end
function modifier_item_yasha_lens_active:IsPurgable()
	return false
end
function modifier_item_yasha_lens_active:IsPurgeException()
	return false
end
function modifier_item_yasha_lens_active:IsDebuff()
	return false
end
