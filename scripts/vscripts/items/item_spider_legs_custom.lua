...
function item_spider_legs_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_item_spider_legs_custom_buff", { duration = duration })
...
function modifier_item_spider_legs_custom:IsHidden()
	return true
end

function modifier_item_spider_legs_custom:IsPurgable()
	return false
end
function modifier_item_spider_legs_custom:IsPurgeException()
	return false
end
