...
function item_third_eye_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_item_third_eye_custom_buff", { duration = duration })
end
...
function modifier_item_third_eye_custom:IsHidden()
	return true
end

function modifier_item_third_eye_custom:IsPurgable()
	return false
end
function modifier_item_third_eye_custom:IsPurgeException()
	return false
end
...
function modifier_item_third_eye_custom_buff:IsPurgable()
	return false
end
