...
LinkLuaModifier(
	"modifier_item_revenants_brooch_custom_counter",
...
function modifier_item_revenants_brooch_custom:IsHidden()
	return true
end
function modifier_item_revenants_brooch_custom:IsPurgable()
	return false
end
function modifier_item_revenants_brooch_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_revenants_brooch_custom:TakeDamageScriptModifier(keys)
	...
	if self.parent:FindAllModifiersByName(self:GetName())[1] ~= self then
		return
	end
