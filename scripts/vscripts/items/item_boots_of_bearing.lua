...
function modifier_item_boots_of_bearing_custom:IsHidden()
	return true
end
function modifier_item_boots_of_bearing_custom:IsPurgable()
	return false
end
function modifier_item_boots_of_bearing_custom:IsPurgeException()
	return false
end

function modifier_item_boots_of_bearing_custom:GetAttributes()
