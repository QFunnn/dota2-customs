...
function item_essence_ring_custom:OnSpellStart()
	...
	self:GetCaster():AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_item_essence_ring_custom_active",
		{ duration = self:GetSpecialValueFor("health_gain_duration") }
	)
...
function modifier_item_essence_ring_custom:IsHidden()
	return true
end
function modifier_item_essence_ring_custom:IsPurgable()
	return false
end
function modifier_item_essence_ring_custom:IsPurgeException()
	return false
end
function modifier_item_essence_ring_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_essence_ring_custom_active:GetEffectName()
	return "particles/items5_fx/essence_ring.vpcf"
end
function modifier_item_essence_ring_custom_active:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end
function modifier_item_essence_ring_custom_active:IsPurgable()
	return false
end
function modifier_item_essence_ring_custom_active:IsPurgeException()
	return false
end
