...
LinkLuaModifier(
	"modifier_item_minotaur_horn_custom_buff_immune",
	"items/item_minotaur_horn_custom",
...
function modifier_item_minotaur_horn_custom:IsHidden()
	return true
end

function modifier_item_minotaur_horn_custom:IsPurgable()
	return false
end
function modifier_item_minotaur_horn_custom:IsPurgeException()
	return false
end
...
function modifier_item_minotaur_horn_custom:OnIntervalThink()
	...
	if health <= max then
		if not self:GetParent():HasModifier("modifier_item_minotaur_horn_custom_buff") then
			self:GetParent()
				:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_item_minotaur_horn_custom_buff", {})
		end
	end
end
...
function modifier_item_minotaur_horn_custom_buff:IsPurgable()
	return false
end
...
function modifier_item_minotaur_horn_custom_buff_immune:IsPurgable()
	return false
end
