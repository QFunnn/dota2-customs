...
function modifier_item_moon_kaya:IsHidden()
	return true
end
function modifier_item_moon_kaya:IsPurgable()
	return false
end
function modifier_item_moon_kaya:IsPurgeException()
	return false
end
function modifier_item_moon_kaya:GetAttributes()
...
function modifier_item_moon_kaya:GetModifierMPRegenAmplify_Percentage_Unique()
...
function modifier_item_moon_kaya_buff:IsPurgable()
	return false
end
function modifier_item_moon_kaya_buff:RemoveOnDeath()
	return false
end
function modifier_item_moon_kaya_buff:GetTexture()
	return "item_moon_kaya"
end

function modifier_item_moon_kaya_buff:OnCreated()
	self.spell_amplify = 15
end
