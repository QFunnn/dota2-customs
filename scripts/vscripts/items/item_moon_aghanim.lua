...
function modifier_item_moon_aghanim:IsHidden()
	return true
end
function modifier_item_moon_aghanim:IsPurgable()
	return false
end
function modifier_item_moon_aghanim:IsPurgeException()
	return false
end
...
function modifier_item_moon_aghanim:GetModifierIncomingDamage_Percentage()
	if self:GetParent():HasModifier("modifier_item_moon_aghanim_buff") then
		return
	end
...
function modifier_item_moon_aghanim_buff:IsPurgable()
	return false
end
function modifier_item_moon_aghanim_buff:RemoveOnDeath()
	return false
end
function modifier_item_moon_aghanim_buff:GetTexture()
	return "item_moon_aghanim"
end
