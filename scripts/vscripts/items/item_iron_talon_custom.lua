...
function modifier_item_iron_talon_custom:IsHidden()
	return true
end

function modifier_item_iron_talon_custom:IsPurgable()
	return false
end
function modifier_item_iron_talon_custom:IsPurgeException()
	return false
end
