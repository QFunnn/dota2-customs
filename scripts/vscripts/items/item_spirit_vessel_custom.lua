...
LinkLuaModifier(
	"modifier_item_spirit_vessel_custom_active_ally",
	"items/item_spirit_vessel_custom",
...
function modifier_item_spirit_vessel_custom:IsHidden()
	return true
end
function modifier_item_spirit_vessel_custom:IsPurgable()
	return false
end
function modifier_item_spirit_vessel_custom:RemoveOnDeath()
	return false
end
function modifier_item_spirit_vessel_custom:IsPurgeException()
	return false
end
...
function modifier_item_spirit_vessel_custom_active_ally:IsDebuff()
	return false
end
function modifier_item_spirit_vessel_custom_active_ally:IsHidden()
	return false
end
function modifier_item_spirit_vessel_custom_active_ally:IsPurgable()
	return true
end
...
function modifier_item_spirit_vessel_custom_active_enemy:IsDebuff()
	return true
end
...
function modifier_item_spirit_vessel_custom_active_enemy:IsStunDebuff()
	return false
end
function modifier_item_spirit_vessel_custom_active_enemy:RemoveOnDeath()
	return true
end
