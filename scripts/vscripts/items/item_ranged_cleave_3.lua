...
LinkLuaModifier("modifier_item_ranged_cleave_3", "items/item_ranged_cleave_3", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_ranged_cleave_3:IsDebuff()
	return false
end
function modifier_item_ranged_cleave_3:IsHidden()
	return true
end
function modifier_item_ranged_cleave_3:IsPurgable()
	return false
end
function modifier_item_ranged_cleave_3:IsPurgeException()
	return false
end
function modifier_item_ranged_cleave_3:GetAttributes()
...
function modifier_item_ranged_cleave_3:GetModifierPreAttack_BonusDamage(params)
...
function modifier_item_ranged_cleave_3:GetModifierProcAttack_BonusDamage_Physical(params)
	...
	if
		self.parent:FindAllModifiersByName("modifier_item_ranged_cleave_3")[1] == self and not params.target:IsHero()
	then
		local bonus = 0
...
function modifier_item_ranged_cleave_3:AttackLandedModifier(params)
	...
	if not params.attacker:IsRealHero() or not params.attacker:IsRangedAttacker() then
		return
	end
	if params.attacker:GetTeam() == params.target:GetTeam() then
		return
