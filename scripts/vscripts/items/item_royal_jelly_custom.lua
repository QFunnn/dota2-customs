...
function modifier_item_royal_jelly_custom:IsHidden()
	return true
end

function modifier_item_royal_jelly_custom:IsPurgable()
	return false
end
function modifier_item_royal_jelly_custom:IsPurgeException()
	return false
end
