...
function modifier_item_aghanims_scepter_custom:IsHidden()
	return true
end
function modifier_item_aghanims_scepter_custom:IsPurgable()
	return false
end
function modifier_item_aghanims_scepter_custom:IsPurgeException()
	return false
end
...
function modifier_item_aghanims_scepter_custom:GetModifierIncomingDamage_Percentage()
	...
	if self:GetParent():HasModifier("modifier_item_moon_aghanim") then
		return
	end
