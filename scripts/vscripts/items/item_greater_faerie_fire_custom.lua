...
LinkLuaModifier(
	"modifier_item_greater_faerie_fire_custom_debuff",
	"items/item_greater_faerie_fire_custom",
...
function modifier_item_greater_faerie_fire_custom_debuff:IsPurgable()
	return false
end
function modifier_item_greater_faerie_fire_custom_debuff:IsPurgeException()
	return false
end
function modifier_item_greater_faerie_fire_custom_debuff:RemoveOnDeath()
	return false
end