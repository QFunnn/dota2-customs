...
function modifier_smoke_of_deceit_cha_custom:IsPurgable()
	return false
end
function modifier_smoke_of_deceit_cha_custom:GetPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end
function modifier_smoke_of_deceit_cha_custom:HeroEffectPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end
function modifier_smoke_of_deceit_cha_custom:GetTexture()
...
function modifier_smoke_of_deceit_cha_custom:GetModifierTotalDamageOutgoing_Percentage()
	if not self:GetParent():HasModifier("modifier_skill_hookah_master") then
		return
	end
	return 20
end
...
function modifier_smoke_of_deceit_hookah_master_immunity:IsHidden()
	return true
end
function modifier_smoke_of_deceit_hookah_master_immunity:IsPurgable()
	return false
end
function modifier_smoke_of_deceit_hookah_master_immunity:IsPurgeException()
	return false
end
