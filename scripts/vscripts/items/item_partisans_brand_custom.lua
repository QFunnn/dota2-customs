...
function modifier_item_partisans_brand_custom:IsHidden()
	return true
end
function modifier_item_partisans_brand_custom:IsPurgable()
	return false
end
function modifier_item_partisans_brand_custom:IsPurgeException()
	return false
end
