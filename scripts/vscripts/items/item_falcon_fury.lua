...
function modifier_item_falcon_fury:AllowIllusionDuplicate()
	return false
end
function modifier_item_falcon_fury:IsPurgable()
	return false
end
function modifier_item_falcon_fury:RemoveOnDeath()
	return false
end
function modifier_item_falcon_fury:IsHidden()
	return true
end
function modifier_item_falcon_fury:GetAttributes()
