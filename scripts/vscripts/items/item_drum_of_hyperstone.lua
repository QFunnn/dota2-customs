...
function modifier_item_drum_of_hyperstone:IsHidden()
	return true
end
function modifier_item_drum_of_hyperstone:IsPurgable()
	return false
end
function modifier_item_drum_of_hyperstone:IsPurgeException()
	return false
end
function modifier_item_drum_of_hyperstone:GetAttributes()
