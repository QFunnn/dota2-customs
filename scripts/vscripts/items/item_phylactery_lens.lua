...
function modifier_item_phylactery_lens:IsPurgable()
	return false
end
function modifier_item_phylactery_lens:IsHidden()
	return true
end
function modifier_item_phylactery_lens:IsPurgeException()
	return false
end
function modifier_item_phylactery_lens:IsPurgable()
	return false
end
function modifier_item_phylactery_lens:RemoveOnDeath()
	return false
end
...
function modifier_item_phylactery_lens:OnTakeDamage(params)
	...
	if self:GetParent():FindAllModifiersByName("modifier_item_phylactery_lens")[1] ~= self then
		return
	end
	if self:GetParent():HasModifier("modifier_item_phylactery") then
		return
	end
	...
	params.unit:AddNewModifier(
		self:GetParent(),
		self:GetAbility(),
		"modifier_item_phylactery_lens_debuff",
