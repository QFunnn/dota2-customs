...
LinkLuaModifier(
	"modifier_item_tome_of_aghanim_custom_consume",
	"items/item_tome_of_aghanim_custom",
...
function modifier_item_tome_of_aghanim_custom:IsPurgable()
	return false
end
function modifier_item_tome_of_aghanim_custom:IsPurgeException()
	return false
end
function modifier_item_tome_of_aghanim_custom:RemoveOnDeath()
	return false
end
