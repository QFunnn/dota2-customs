...
LinkLuaModifier(
	...
	"items/item_shadow_amulet_custom",
...
function modifier_item_shadow_amulet_custom_active:IsHidden()
	return false
end
function modifier_item_shadow_amulet_custom_active:IsPurgable()
	return false
end
...
function modifier_item_shadow_amulet_custom_active:GetModifierMoveSpeedBonus_Percentage()
	return self.speed
end
