...
function modifier_item_timeless_relic_custom:IsHidden()
	return true
end
function modifier_item_timeless_relic_custom:IsPurgable()
	return false
end
function modifier_item_timeless_relic_custom:IsPurgeException()
	return false
end
function modifier_item_timeless_relic_custom:RemoveOnDeath()
	return false
end
