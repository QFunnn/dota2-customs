...
function item_gods_locket:OnSpellStart()
	...
	local particle =
		ParticleManager:CreateParticle("particles/items3_fx/fish_bones_active.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
...
function modifier_item_gods_locket:IsPurgable()
	return false
end
function modifier_item_gods_locket:IsPurgeException()
	return false
end
