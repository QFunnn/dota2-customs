...
function modifier_item_warlock_book_custom:IsHidden()
	return true
end
function modifier_item_warlock_book_custom:IsPurgable()
	return false
end
function modifier_item_warlock_book_custom:IsPurgeException()
	return false
end
function modifier_item_warlock_book_custom:RemoveOnDeath()
	return false
end
