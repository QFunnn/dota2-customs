...
function item_pirate_hat_custom:OnChannelFinish(bInterrupted)
	...
	local pfx2 = ParticleManager:CreateParticle(
		"particles/econ/events/ti9/shovel_revealed_generic.vpcf",
		PATTACH_WORLDORIGIN,
		self:GetCaster()
	)
...
function modifier_item_pirate_hat_custom:RemoveOnDeath()
	return false
end
function modifier_item_pirate_hat_custom:IsPurgeException()
	return false
end
