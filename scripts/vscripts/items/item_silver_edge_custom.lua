...
function modifier_item_silver_edge_custom_active:IsPurgable()
	return false
end
...
function modifier_item_silver_edge_custom_active:GetCritDamage()
...
function modifier_item_silver_edge_custom_active:GetModifierProcAttack_BonusDamage_Physical(params)
	...
	params.target:AddNewModifier(
		self:GetParent(),
		self:GetAbility(),
		"modifier_item_silver_edge_custom_break",
		{
			duration = (1 - params.target:GetStatusResistance()) * self:GetAbility()
				:GetSpecialValueFor("backstab_duration"),
		}
	)
	self:Destroy()
	return self.damage
...
function modifier_item_silver_edge_custom_passive:IsHidden()
	return true
end

function modifier_item_silver_edge_custom_passive:IsPurgable()
	return false
end
function modifier_item_silver_edge_custom_passive:IsPurgeException()
	return false
end

function modifier_item_silver_edge_custom_passive:RemoveOnDeath()
	return false
end

function modifier_item_silver_edge_custom_passive:GetAttributes()
...
function modifier_item_silver_edge_custom_passive:GetModifierPreAttack_BonusDamage()
	return self:GetAbility():GetSpecialValueFor("bonus_damage")
end

function modifier_item_silver_edge_custom_passive:GetModifierAttackSpeedBonus_Constant()
	return self:GetAbility():GetSpecialValueFor("bonus_attack_speed")
end

modifier_item_silver_edge_custom_break = class({})

function modifier_item_silver_edge_custom_break:IsHidden()
	return false
end

function modifier_item_silver_edge_custom_break:IsPurgable()
	return false
end

function modifier_item_silver_edge_custom_break:CheckState()
	return { [MODIFIER_STATE_PASSIVES_DISABLED] = true }
end

function modifier_item_silver_edge_custom_break:GetEffectName()
