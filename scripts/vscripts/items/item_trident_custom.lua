...
function modifier_item_trident_custom:IsHidden()
	return true
end
function modifier_item_trident_custom:IsPurgable()
	return false
end
function modifier_item_trident_custom:IsPurgeException()
	return false
end
function modifier_item_trident_custom:RemoveOnDeath()
	return false
end
