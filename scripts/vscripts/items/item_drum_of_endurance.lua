...
function modifier_item_drum_of_endurance:IsHidden()
	return true
end
function modifier_item_drum_of_endurance:IsPurgable()
	return false
end
function modifier_item_drum_of_endurance:IsPurgeException()
	return false
end
...
function modifier_item_drum_of_endurance:GetAttributes()
