...
function modifier_item_ocean_heart_custom:IsHidden()
	return true
end

function modifier_item_ocean_heart_custom:IsPurgable()
	return false
end
function modifier_item_ocean_heart_custom:IsPurgeException()
	return false
end
