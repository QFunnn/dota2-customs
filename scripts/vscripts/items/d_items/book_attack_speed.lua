...
function modifier_item_attack_speed_aura_cd:IsHidden()
	return true
end
function modifier_item_attack_speed_aura_cd:IsDebuff()
	return false
end
function modifier_item_attack_speed_aura_cd:IsPurgable()
	return false
end
function modifier_item_attack_speed_aura_cd:RemoveOnDeath()
	return false
end
...
function item_attack_speed_aura:OnSpellStart()
	if IsServer() then
		...
		for _, Hero in pairs(Heroes) do
			Hero:AddNewModifier(self.caster, self, "modifier_item_attack_speed_aura", { duration = self.duration })
		end
