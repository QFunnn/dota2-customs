...
LinkLuaModifier(
	"modifier_item_elemental_ringmaster_red_buff",
	"items/item_elemental_ringmaster",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_elemental_ringmaster_blue_buff",
	"items/item_elemental_ringmaster",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_elemental_ringmaster_purple_buff",
	"items/item_elemental_ringmaster",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_item_elemental_ringmaster:IsPurgable()
	return false
end
function modifier_item_elemental_ringmaster:IsHidden()
	return true
end
function modifier_item_elemental_ringmaster:IsPurgeException()
	return false
end
function modifier_item_elemental_ringmaster:RemoveOnDeath()
	return false
end
...
function modifier_item_elemental_ringmaster_red_buff:GetTexture()
	return "item_elemental_ringmaster_1"
end
...
function modifier_item_elemental_ringmaster_blue_buff:GetTexture()
	return "item_elemental_ringmaster_2"
end
...
function modifier_item_elemental_ringmaster_purple_buff:IsPurgable()
	return false
end
