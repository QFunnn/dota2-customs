...
LinkLuaModifier(
	"modifier_item_urn_of_shadows_custom_ally",
	"items/item_urn_of_shadows_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_urn_of_shadows_custom_enemy",
	"items/item_urn_of_shadows_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function item_urn_of_shadows_custom:OnSpellStart()
	...
	local particle_fx =
		ParticleManager:CreateParticle("particles/items2_fx/urn_of_shadows.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
...
function modifier_item_urn_of_shadows_custom:IsHidden()
	return true
end
function modifier_item_urn_of_shadows_custom:IsPurgable()
	return false
end
function modifier_item_urn_of_shadows_custom:IsPurgeException()
	return false
end
function modifier_item_urn_of_shadows_custom:RemoveOnDeath()
	return false
end
...
function modifier_item_urn_of_shadows_custom_ally:IsDebuff()
	return false
end
function modifier_item_urn_of_shadows_custom_ally:IsHidden()
	return false
end
function modifier_item_urn_of_shadows_custom_ally:IsPurgable()
	return true
end
...
function modifier_item_urn_of_shadows_custom_ally:OnTakeDamage(keys)
	if not keys.attacker or not keys.attacker:IsHero() then
		return
	end
...
function modifier_item_urn_of_shadows_custom_enemy:IsDebuff()
	return true
end
function modifier_item_urn_of_shadows_custom_enemy:IsHidden()
	return false
end
function modifier_item_urn_of_shadows_custom_enemy:IsPurgable()
	return true
end
function modifier_item_urn_of_shadows_custom_enemy:IsStunDebuff()
	return false
end
function modifier_item_urn_of_shadows_custom_enemy:RemoveOnDeath()
	return true
end
