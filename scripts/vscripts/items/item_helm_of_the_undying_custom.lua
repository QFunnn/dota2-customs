...
LinkLuaModifier(
	"modifier_item_helm_of_the_undying_custom",
	"items/item_helm_of_the_undying_custom",
...
function modifier_item_helm_of_the_undying_custom:IsHidden()
	return true
end

function modifier_item_helm_of_the_undying_custom:IsPurgable()
	return false
end
function modifier_item_helm_of_the_undying_custom:IsPurgeException()
	return false
end
...
function modifier_item_helm_of_the_undying_custom:GetMinHealth()
	...
	if self:GetParent():HasModifier("modifier_phoenix_supernova_custom_death") then
		return
	end
...
function modifier_item_helm_of_the_undying_custom:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_item_helm_of_the_undying_custom_buff") then
		return
	end
	if self:GetParent():HasModifier("modifier_phoenix_supernova_custom_death") then
		return
...
function modifier_item_helm_of_the_undying_custom_buff:GetEffectName()
	return "particles/helm_of_the_undying_custom.vpcf"
end
function modifier_item_helm_of_the_undying_custom_buff:IsHidden()
	return false
end
function modifier_item_helm_of_the_undying_custom_buff:IsPurgable()
	return false
end
