...
function modifier_item_spy_gadget_custom:IsHidden()
	return true
end

function modifier_item_spy_gadget_custom:IsPurgable()
	return false
end
function modifier_item_spy_gadget_custom:IsPurgeException()
	return false
end
