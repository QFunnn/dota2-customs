...
function item_banana_custom:OnSpellStart()
	...
	CreateModifierThinker(
		caster,
		self,
		"modifier_item_banana_custom",
		{ duration = self:GetSpecialValueFor("banana_duration") },
		point,
...
function modifier_item_banana_custom_attribute:IsHidden()
	return true
end
function modifier_item_banana_custom_attribute:IsPurgable()
	return false
end
function modifier_item_banana_custom_attribute:IsPurgeException()
	return false
end
function modifier_item_banana_custom_attribute:IsPurgeException()
	return false
...
function modifier_item_banana_custom_visual:IsHidden()
	return true
end
