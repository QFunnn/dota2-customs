...
function modifier_item_falcon_claymore:IsHidden()
	return true
end

function modifier_item_falcon_claymore:IsPurgable()
	return false
end
function modifier_item_falcon_claymore:IsPurgeException()
	return false
end
...
function modifier_item_falcon_claymore:GetAttributes()
...
function modifier_item_falcon_claymore:OnAttackLanded(params)
	if params.attacker == self:GetParent() then
		...
		if self:GetParent():FindAllModifiersByName("modifier_item_falcon_claymore")[1] ~= self then
			return
		end
