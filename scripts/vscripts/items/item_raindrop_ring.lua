...
function modifier_item_raindrop_ring:IsHidden()
	return true
end
function modifier_item_raindrop_ring:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_item_raindrop_ring:IsPurgable()
	return false
end
function modifier_item_raindrop_ring:IsPurgeException()
	return false
end
...
function modifier_item_raindrop_ring:GetModifierTotal_ConstantBlock(params)
	...
	if self:GetParent():FindAllModifiersByName("modifier_item_raindrop_ring")[1] ~= self then
		return
	end
