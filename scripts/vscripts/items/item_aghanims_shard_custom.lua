...
function modifier_item_aghanims_shard_custom:IsHidden()
	return true
end
function modifier_item_aghanims_shard_custom:IsPurgable()
	return false
end
function modifier_item_aghanims_shard_custom:IsPurgeException()
	return false
end
function modifier_item_aghanims_shard_custom:GetAttributes()
