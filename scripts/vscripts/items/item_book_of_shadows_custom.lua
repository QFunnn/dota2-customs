...
LinkLuaModifier(
	...
	"items/item_book_of_shadows_custom",
...
function item_book_of_shadows_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_item_book_of_shadows_custom_buff", { duration = duration })
...
function modifier_item_book_of_shadows_custom:IsHidden()
	return true
end

function modifier_item_book_of_shadows_custom:IsPurgable()
	return false
end
function modifier_item_book_of_shadows_custom:IsPurgeException()
	return false
end
