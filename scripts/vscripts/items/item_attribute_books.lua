...
function item_book_of_strength_custom:OnSpellStart()
	...
	if modifier_attributes_book_custom == nil then
		modifier_attributes_book_custom = self:GetCaster()
			:AddNewModifier(self:GetCaster(), nil, "modifier_attributes_book_custom", {})
...
function modifier_attributes_book_custom:IsPurgable()
	return false
end
function modifier_attributes_book_custom:IsPurgeException()
	return false
end
function modifier_attributes_book_custom:RemoveOnDeath()
	return false
end
