...
function item_eul_storm:OnSpellStart()
	...
	local target = CreateModifierThinker(
		self:GetCaster(),
		self,
		"modifier_item_eul_storm_thinker",
		nil,
		point,
...
function item_eul_storm:OnProjectileHit(target, vLocation)
	...
	tornado:AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_item_eul_storm_tornado",
...
function modifier_item_eul_storm_thinker:IsHidden()
	return true
end

modifier_item_eul_storm = class({})

function modifier_item_eul_storm:IsHidden()
	return true
end
function modifier_item_eul_storm:IsPurgable()
	return false
end
function modifier_item_eul_storm:IsPurgeException()
	return false
end
function modifier_item_eul_storm:GetAttributes()
...
function modifier_item_eul_storm_pull:IsPurgable()
	return false
end

function modifier_item_eul_storm_pull:IsHidden()
	return true
end

function modifier_item_eul_storm_pull:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_item_eul_storm_pull:OnIntervalThink()
	...
	then
		if
			...
			and not self:GetParent():HasModifier("modifier_pudge_chain_binding")
		then
