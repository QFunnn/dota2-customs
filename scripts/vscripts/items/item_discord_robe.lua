...
function modifier_item_discord_robe:IsHidden()
	return true
end
function modifier_item_discord_robe:IsPurgable()
	return false
end
function modifier_item_discord_robe:IsPurgeException()
	return false
end
function modifier_item_discord_robe:GetAttributes()
...
function modifier_item_discord_robe:IsAura()
	return true
end
...
function modifier_item_discord_robe_debuff:IsPurgable()
	return false
end
