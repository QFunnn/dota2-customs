...
function modifier_item_essence_of_speed:IsPermanent()
	return true
end
function modifier_item_essence_of_speed:AllowIllusionDuplicate()
	return true
end
function modifier_item_essence_of_speed:RemoveOnDeath()
	return false
end
function modifier_item_essence_of_speed:GetAttributes()
