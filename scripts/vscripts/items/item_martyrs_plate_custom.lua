...
function modifier_item_martyrs_plate_custom:IsHidden()
	return true
end

function modifier_item_martyrs_plate_custom:IsPurgable()
	return false
end
function modifier_item_martyrs_plate_custom:IsPurgeException()
	return false
end
...
function modifier_item_martyrs_plate_custom_buff:IsPurgable()
	return false
end
