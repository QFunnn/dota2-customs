...
LinkLuaModifier(
	"modifier_item_guardian_greaves_custom_buff",
	"items/item_guardian_greaves_custom",
...
function item_guardian_greaves_custom:OnSpellStart()
	...
	local particle_1 =
		ParticleManager:CreateParticle("particles/items3_fx/warmage.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
	...
	for _, hero in pairs(heroes) do
		...
		local particle_2 =
			ParticleManager:CreateParticle("particles/items3_fx/warmage_recipient.vpcf", PATTACH_ABSORIGIN_FOLLOW, hero)
...
function modifier_item_guardian_greaves_custom:IsPurgable()
	return false
end
function modifier_item_guardian_greaves_custom:IsPurgeException()
	return false
end
function modifier_item_guardian_greaves_custom:RemoveOnDeath()
	return false
end
function modifier_item_guardian_greaves_custom:GetAttributes()
...
function modifier_item_guardian_greaves_custom:IsAura()
	return true
end
