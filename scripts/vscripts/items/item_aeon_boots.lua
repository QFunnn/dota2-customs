...
function item_aeon_boots:OnSpellStart()
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self, "modifier_item_aeon_boots_buff", { duration = buff_duration })
end

modifier_item_aeon_boots = class({})

function modifier_item_aeon_boots:IsHidden()
	return true
end
function modifier_item_aeon_boots:IsPurgable()
	return false
end
function modifier_item_aeon_boots:IsPurgeException()
	return false
end
function modifier_item_aeon_boots:GetAttributes()
...
function modifier_item_aeon_boots:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_item_aeon_boots_buff") then
		return
	end
