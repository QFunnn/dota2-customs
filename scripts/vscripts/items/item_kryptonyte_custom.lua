...
function modifier_item_kryptonyte_custom:IsHidden()
	return true
end
function modifier_item_kryptonyte_custom:IsPurgable()
	return false
end
function modifier_item_kryptonyte_custom:IsPurgeException()
	return false
end
...
function modifier_item_kryptonyte_custom:OnCreated()
	...
	self.bonus_intellect = self.ability:GetSpecialValueFor("bonus_intellect")
		+ self.ability:GetSpecialValueFor("bonus_all_stats")
...
function modifier_item_kryptonyte_custom:OnAbilityFullyCast(params)
	if params.unit == self.parent then
		...
		if
			...
			and not self:GetParent():HasModifier("modifier_item_kryptonite_another_cooldown")
		then
		...
		if RollPercentage(chance) or self:GetAbility().IsCastAbility then
			...
			if self.parent:HasModifier("modifier_item_kryptonyte_custom_cooldown") then
				...
				self.parent:AddNewModifier(
					self.parent,
					self:GetAbility(),
					"modifier_item_kryptonyte_custom_cooldown",
...
function modifier_item_kryptonyte_custom_cooldown:IsHidden()
	return true
end
function modifier_item_kryptonyte_custom_cooldown:IsPurgable()
	return false
end
function modifier_item_kryptonyte_custom_cooldown:IsPurgeException()
	return false
end