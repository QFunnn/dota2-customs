...
function modifier_item_ghost:IsHidden()
	return true
end
function modifier_item_ghost:IsPurgable()
	return false
end
function modifier_item_ghost:RemoveOnDeath()
	return false
end
...
function modifier_item_ghost_active:IsPurgable()
	return true
end
function modifier_item_ghost_active:IsPurgeException()
	return true
end
...
function modifier_item_crellas_crozier:IsHidden()
	return true
end
function modifier_item_crellas_crozier:IsPurgable()
	return false
end
function modifier_item_crellas_crozier:RemoveOnDeath()
	return false
end
...
function modifier_item_crellas_crozier:IsAura()
	return true
end
function modifier_item_crellas_crozier:GetModifierAura()
	return "modifier_item_crellas_crozier_aura_debuff"
end
...
function modifier_item_crellas_crozier:GetAuraDuration()
	return 0.5
end
function modifier_item_crellas_crozier:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_item_crellas_crozier:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_item_crellas_crozier:GetAuraSearchType()
...
function modifier_item_crellas_crozier_aura_debuff:IsHidden()
	return false
end
function modifier_item_crellas_crozier_aura_debuff:IsPurgable()
	return false
end
function modifier_item_crellas_crozier_aura_debuff:IsDebuff()
	return true
end
...
function modifier_item_crellas_crozier_active_state:IsHidden()
	return true
end
function modifier_item_crellas_crozier_active_state:IsPurgable()
	return false
end

-- Дельта-аура: добавляет ещё -(75-30)=-45% health restoration поверх пассивной ауры
function modifier_item_crellas_crozier_active_state:IsAura()
	return true
end
function modifier_item_crellas_crozier_active_state:GetModifierAura()
	return "modifier_item_crellas_crozier_active_aura_debuff"
end
...
function modifier_item_crellas_crozier_active_state:GetAuraDuration()
	return 0.5
end
function modifier_item_crellas_crozier_active_state:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_item_crellas_crozier_active_state:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_item_crellas_crozier_active_state:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO
end
	...
	for _, enemy in pairs(enemies) do
		if enemy and not enemy:IsNull() then
			enemy:AddNewModifier(
				caster,
				ability,
				"modifier_item_crellas_crozier_ms_slow",
...
function modifier_item_crellas_crozier_active_aura_debuff:IsHidden()
	return true
end
function modifier_item_crellas_crozier_active_aura_debuff:IsPurgable()
	return false
end
function modifier_item_crellas_crozier_active_aura_debuff:IsDebuff()
	return true
end
...
function modifier_item_crellas_crozier_ms_slow:IsHidden()
	return false
end
function modifier_item_crellas_crozier_ms_slow:IsPurgable()
	return true
end
function modifier_item_crellas_crozier_ms_slow:IsDebuff()
	return true
end
function modifier_item_crellas_crozier_ms_slow:GetAttributes()
...
function modifier_item_crellas_crozier_ms_slow:GetModifierMoveSpeedBonus_Percentage()
	if self:GetAbility() then
		return -self:GetAbility():GetSpecialValueFor("move_speed_steal")
	end
	return 0
end
...
function modifier_item_crellas_crozier_ms_steal:IsHidden()
	return false
end
function modifier_item_crellas_crozier_ms_steal:IsPurgable()
	return false
end
function modifier_item_crellas_crozier_ms_steal:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
