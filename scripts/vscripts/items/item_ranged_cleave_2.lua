...
LinkLuaModifier("modifier_item_ranged_cleave_2", "items/item_ranged_cleave_2", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_ranged_cleave_2:IsDebuff()
	return false
end
function modifier_item_ranged_cleave_2:IsHidden()
	return true
end
function modifier_item_ranged_cleave_2:IsPurgable()
	return false
end
function modifier_item_ranged_cleave_2:IsPurgeException()
	return false
end
function modifier_item_ranged_cleave_2:GetAttributes()
...
function modifier_item_ranged_cleave_2:GetModifierPreAttack_BonusDamage(params)
...
function modifier_item_ranged_cleave_2:AttackLandedModifier(keys)
	...
	if not keys.attacker:IsRealHero() or not keys.attacker:IsRangedAttacker() then
		return
	end
