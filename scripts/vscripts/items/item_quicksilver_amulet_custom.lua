...
LinkLuaModifier(
	"modifier_item_quicksilver_amulet_custom",
	"items/item_quicksilver_amulet_custom",
...
function modifier_item_quicksilver_amulet_custom:IsHidden()
	return true
end

function modifier_item_quicksilver_amulet_custom:IsPurgable()
	return false
end
function modifier_item_quicksilver_amulet_custom:IsPurgeException()
	return false
end
