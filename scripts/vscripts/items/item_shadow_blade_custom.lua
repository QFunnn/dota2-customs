...
function modifier_item_shadow_blade_custom_passive:IsHidden()
	return true
end

function modifier_item_shadow_blade_custom_passive:IsPurgable()
	return false
end
function modifier_item_shadow_blade_custom_passive:IsPurgeException()
	return false
end

function modifier_item_shadow_blade_custom_passive:RemoveOnDeath()
	return false
end

function modifier_item_shadow_blade_custom_passive:GetAttributes()
...
function modifier_item_shadow_blade_custom_passive:GetModifierPreAttack_BonusDamage()
	return self:GetAbility():GetSpecialValueFor("bonus_damage")
end

function modifier_item_shadow_blade_custom_passive:GetModifierAttackSpeedBonus_Constant()
	return self:GetAbility():GetSpecialValueFor("bonus_attack_speed")
end

modifier_item_shadow_blade_custom_active = class({})

function modifier_item_shadow_blade_custom_active:IsHidden()
	return false
end
function modifier_item_shadow_blade_custom_active:IsPurgable()
	return false
end
...
function modifier_item_shadow_blade_custom_active:GetModifierMoveSpeedBonus_Percentage()
	return self.speed
end
