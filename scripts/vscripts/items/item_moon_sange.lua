...
function modifier_item_moon_sange:IsHidden()
	return true
end
function modifier_item_moon_sange:IsPurgable()
	return false
end
function modifier_item_moon_sange:IsPurgeException()
	return false
end
...
function modifier_item_moon_sange_buff:IsPurgable()
	return false
end
function modifier_item_moon_sange_buff:RemoveOnDeath()
	return false
end
function modifier_item_moon_sange_buff:GetTexture()
	return "item_moon_sange"
end
