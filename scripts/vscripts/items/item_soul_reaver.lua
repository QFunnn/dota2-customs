...
function modifier_item_soul_reaver:IsHidden()
	return true
end

function modifier_item_soul_reaver:IsPurgable()
	return false
end
function modifier_item_soul_reaver:IsPurgeException()
	return false
end

function modifier_item_soul_reaver:IsAura()
	return true
end
...
function modifier_item_soul_reaver:OnIntervalThink()
	...
	if self:GetParent():FindAllModifiersByName("modifier_item_soul_reaver")[1] ~= self then
...
function modifier_item_soul_reaver:GetAttributes()
...
function modifier_item_soul_reaver_debuff:IsPurgable()
	return false
end
