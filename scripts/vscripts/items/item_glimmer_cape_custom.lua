...
function modifier_item_glimmer_cape_custom_passive:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_item_glimmer_cape_custom_passive:IsHidden()
	return true
end

function modifier_item_glimmer_cape_custom_passive:IsPurgable()
	return false
end
function modifier_item_glimmer_cape_custom_passive:IsPurgeException()
	return false
end
...
function modifier_item_glimmer_cape_custom_passive:GetModifierMagicalResistanceBonus()
	return self:GetAbility():GetSpecialValueFor("bonus_magical_armor")
end

modifier_item_glimmer_cape_custom_active = class({})

function modifier_item_glimmer_cape_custom_active:IsHidden()
	return false
end
...
function modifier_item_glimmer_cape_custom_active:GetModifierMoveSpeedBonus_Constant()
	return self.speed
end
