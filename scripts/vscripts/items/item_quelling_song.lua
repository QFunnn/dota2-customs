...
function modifier_item_quelling_song:IsHidden()
	return true
end
function modifier_item_quelling_song:IsPurgable()
	return false
end
function modifier_item_quelling_song:IsPurgeException()
	return false
end
function modifier_item_quelling_song:GetAttributes()
	return MODIFIER_ATTRIBUTE_PERMANENT
end

function modifier_item_quelling_song:IsAura()
	return true
end
