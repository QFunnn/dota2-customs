...
function modifier_item_desolator_2_custom:IsHidden()
	return true
end
function modifier_item_desolator_2_custom:IsPurgable()
	return false
end
function modifier_item_desolator_2_custom:IsPurgeException()
	return false
end
function modifier_item_desolator_2_custom:RemoveOnDeath()
	return false
end
function modifier_item_desolator_2_custom:GetAttributes()
...
function modifier_item_desolator_2_custom:GetModifierPreAttack_BonusDamage(params)
...
function modifier_item_desolator_2_custom:AttackModifier(params)
	...
	if self.parent:FindAllModifiersByName("modifier_item_desolator_2_custom")[1] ~= self then
		return
	end
...
function modifier_item_desolator_2_custom:AttackModifier(params)
	...
	for i, enemy in pairs(enemies) do
		if attacks >= self.arrow_count then
			break
		end
		attacks = attacks + 1
