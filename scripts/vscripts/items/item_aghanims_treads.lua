...
function modifier_item_aghanims_treads:IsHidden()
	return true
end
function modifier_item_aghanims_treads:IsPurgable()
	return false
end
function modifier_item_aghanims_treads:IsPurgeException()
	return false
end
function modifier_item_aghanims_treads:GetAttributes()
