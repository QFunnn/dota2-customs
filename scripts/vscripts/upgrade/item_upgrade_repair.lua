...
function item_upgrade_repair:OnSpellStart()
	...
	self:GetCursorTarget()
		:AddNewModifier(
			self:GetCaster(),
			self,
			"modifier_upgrade_repair_cd",
			{ duration = self:GetSpecialValueFor("cd") }
		)
	self:GetCursorTarget()
		:AddNewModifier(self:GetCaster(), self, "modifier_repair", { duration = self:GetSpecialValueFor("duration") })
...
function modifier_repair:IsHidden()
	return false
end
function modifier_repair:IsPurgable()
	return false
end
...
function modifier_repair:GetTexture()
	return "item_repair_kit"
end
function modifier_repair:GetModifierHealthRegenPercentage()
	return self.heal
end

modifier_upgrade_repair_cd = class({})

function modifier_upgrade_repair_cd:IsHidden()
	return false
end
function modifier_upgrade_repair_cd:IsPurgable()
	return false
end
function modifier_upgrade_repair_cd:IsDebuff()
	return true
end
function modifier_upgrade_repair_cd:GetTexture()
	return "item_repair_kit"
end