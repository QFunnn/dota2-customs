	...
	local global_values = {
		...
		npc_dota_hero_huskar = {
			...
			["modifier_huskar_leap_3"] = {
				...
				is_through_bkb = 1,
				damage_type = DAMAGE_TYPE_MAGICAL,
				alt_talent = "modifier_huskar_disarm_7",
			},
		...
		npc_dota_hero_pangolier = {
			...
			["modifier_pangolier_lucky_2"] = {
				...
				heal = { 12, 18, 24 },
				bonus = 2,
				alt_talent = "modifier_pangolier_lucky_7",
			},
			...
			["modifier_pangolier_lucky_4"] = {
				...
				cd = 12,
				dash_speed = 1500,
				dash_speed_target = 2000,
				stun = 0.5,
				cd_legendary = -50,
				talent_cd = 12,
				is_root_disabled = 1,
				alt_talent = "modifier_pangolier_buckle_7",
			},
			["modifier_pangolier_lucky_7"] = {
				...
				trigger_ability = "pangolier_heartpiercer_custom",
				banned_talent = "modifier_pangolier_rolling_7",
			},
			...
			["modifier_pangolier_rolling_7"] = {
				...
				trigger_ability = "pangolier_gyroshell_custom_legendary",
				skill_change = "lucky_shot_magic",
				banned_talent = "modifier_pangolier_lucky_7",
			},
		},
		...
		npc_dota_hero_abaddon = {
			...
			["modifier_abaddon_borrowed_4"] = {
				...
				range = 100,
				is_through_bkb = 1,
				alt_talent = "modifier_abaddon_borrowed_7",
			},
		...
		local print_skill = function(name, i)
			...
			if data[talent_name] then
				...
				for param_name, param_data in pairs(data[talent_name]) do
					if not ignore[param_name] then
						if type(param_data) ~= "table" then
							local result = array[skill_number]
								.. i
								.. "_"
								.. param_name
								.. ' = caster:GetTalentValue("'
								.. talent_name
								.. '", "'
								.. param_name
								.. '", true),'
