...
function Halloween:SpawnPumpkinKing()
	...
	local hUnit = CreateUnitByName(
		"npc_dota_pumpkin_king",
		Vector(0, 0, mapCenter:GetAbsOrigin().z),
		true,
		nil,
		nil,
		DOTA_TEAM_NEUTRALS
	...
	local nParticleIndex =
		ParticleManager:CreateParticle("effect/crown_s2/2_shield.vpcf", PATTACH_OVERHEAD_FOLLOW, hUnit)
	ParticleManager:SetParticleControlEnt(
		...
		"follow_origin",
		hUnit:GetAbsOrigin() + Vector(0, 0, 500),
		true
	)
end