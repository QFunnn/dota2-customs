...
function Server:SendBugReportToDiscord(
	playerName,
	steamID,
	bugType,
	description,
	...
	if
		DISCORD_BUG_REPORT_WEBHOOK == nil
		or DISCORD_BUG_REPORT_WEBHOOK == ""
		or DISCORD_BUG_REPORT_WEBHOOK == "YOUR_DISCORD_WEBHOOK_URL_HERE"
	then
...
function Server:OnPlayerReportSubmit(event)
	...
	self:SendPlayerReportToDiscord(
		reporterName,
		reporterSteam,
		targetName,
		targetSteam,
...
function Server:SendPlayerReportToDiscord(
	reporterName,
	reporterSteam,
	targetName,
	targetSteam,
	...
	if
		DISCORD_PLAYER_REPORT_WEBHOOK == nil
		or DISCORD_PLAYER_REPORT_WEBHOOK == ""
		or DISCORD_PLAYER_REPORT_WEBHOOK == "YOUR_DISCORD_WEBHOOK_URL_HERE"
	then
		...
		embeds = {
			{
				...
				fields = {
					{
						name = "🎯 На кого",
						value = targetName .. " (" .. tostring(targetSteam) .. ")",
						inline = false,
					},
					...
					{
						name = "👤 Отправил",
						value = reporterName .. " (" .. tostring(reporterSteam) .. ")",
						inline = false,
					},
					{
						name = "ℹ️ Игра",
