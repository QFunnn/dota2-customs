...
PrecacheManager.particles = {
	...
	"particles/custom_pings/custom_ping_danger.vpcf",
	"particles/custom_pings/custom_ping_retreat.vpcf",
	"particles/custom_pings/custom_ping_waypoint.vpcf",
	"particles/custom_pings/custom_ping_world.vpcf",
...
function PrecacheManager:PrecacheWebInventory(context)
	if not ITEM_DEFINITIONS then
		print("[Precache Manager] no definitions on precache run!")
		return
	end
