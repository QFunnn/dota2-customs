...
require("events/inventory_item_added")
require("events/ability_levelled")
require("events/hero_swap")
...
function Events:Init()
	...
	ListenToGameEvent("dota_inventory_item_added", Dynamic_Wrap(Events, "OnInventoryItemAdded"), Events)
	ListenToGameEvent("dota_hero_swap", Dynamic_Wrap(Events, "OnHeroSwapped"), Events)
end
