...
---@param callbackOnError boolean|nil
function OutboundRequestSender:SendJson(method, url, body, callback, callbackOnError)
    ...
    req:Send(function(res)
        ...
        if callback and (ok or callbackOnError == true) then
            callback(res)
        end
    end)
