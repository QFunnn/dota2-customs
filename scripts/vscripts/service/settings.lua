...
---@field showSelfDuelNotice boolean
...
SettingsKey = SettingsKey
	or {
		...
		SHOW_SELF_DUEL_NOTICE = "showSelfDuelNotice",
	}
...
local function writeNetTable(playerId, settings)
	...
	CustomNetTables:SetTableValue("player_settings", uid, {
		...
		showSelfDuelNotice = settings.showSelfDuelNotice and 1 or 0,
	})
...
local function schedulePersist(playerId, settings)
	...
	pending[uid] = {
		...
		showSelfDuelNotice = settings.showSelfDuelNotice,
	}
	if timers[uid] then
