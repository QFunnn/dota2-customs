...
if AbilityPool == nil then
	AbilityPool = class({})
end ---@class AbilityPool
...
function AbilityPool:RemoveAbility(abilityName)
	...
	if heroName and self.heroAbilityPool[heroName] and table.contains(self.heroAbilityPool[heroName], abilityName) then
