...
demo_dummy = class({}) ---@class demo_dummy : CDOTA_Ability_Lua
...
---------------------------------------------------
modifier_demo_dummy = class({}) ---@class CDOTA_Modifier_Lua
...
function modifier_demo_dummy:OnCreated(kv) end

function modifier_demo_dummy:OnRefresh(kv) end
