...
function modifier_frog_reaper:OnIntervalThink()
	...
	-- 	self.iParticleID = ParticleManager:CreateParticle("particles/econ/items/arc_warden/arc_warden_frostivus_2023/arc_warden_magnetic_frostivus.vpcf", PATTACH_CUSTOMORIGIN, nil)
	-- 	ParticleManager:SetParticleControl(self.iParticleID, 0, GoodFrogPos)
	-- 	ParticleManager:SetParticleControl(self.iParticleID, 1, Vector(400, 0, 0))
	-- 	self:AddParticle(self.iParticleID, false, false, -1, false, false)
	-- end
end
-- function modifier_frog_reaper:GetEffectAttachType()
-- 	return PATTACH_ABSORIGIN_FOLLOW
-- end
-- function modifier_frog_reaper:GetEffectName()
