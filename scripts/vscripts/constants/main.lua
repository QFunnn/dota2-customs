...
-- Разное для обычного игрока и владельца батл-пасса (решение владельца 2026-08-05):
--   без БП — старт 2 заряда, потолок 3;
--   с БП   — старт 3 заряда (2 базовых + 1 бонусный в OnPlayerProfileLoaded), потолок 5.
-- Начисление одинаковое у всех: +1 каждые 30 минут (PLAYERS_PAUSE_CHARGE_COOLDOWN).
PLAYER_MAX_PAUSES = 3
PLAYER_MAX_PAUSES_BP = 5
