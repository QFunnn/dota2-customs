...
ABILITIES_SETTINGS = {
	...
	-- Song of the Siren на главной арене запрещена: массовый сон на хабе ломает
	-- ожидание раунда. Отключение делает modifier_hero_refreshing (SetActivated(false)
	-- при заходе на хаб, обратно — при выходе), как у остальных таких способностей.
	naga_siren_song_of_the_siren_custom = {
