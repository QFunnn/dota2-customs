...
function HeroDemo:Init()
	...
	CustomGameEventManager:RegisterListener("RequestInitialSpawnHeroID", function(...)
		return self:OnRequestInitialSpawnHeroID(...)
	end)
	CustomGameEventManager:RegisterListener("WelcomePanelDismissed", function(...)
		return self:OnWelcomePanelDismissed(...)
	end)
	CustomGameEventManager:RegisterListener("LevelUpButtonPressed", function(...)
		return self:OnLevelUpButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("UltraMaxLevelButtonPressed", function(...)
		return self:OnUltraMaxLevelButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("FreeSpellsButtonPressed", function(...)
		return self:OnFreeSpellsButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("CombatLogButtonPressed", function(...)
		return self:CombatLogButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SelectMainHeroButtonPressed", function(...)
		return self:OnSelectMainHeroButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SelectSpawnHeroButtonPressed", function(...)
		return self:OnSelectSpawnHeroButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("RemoveHeroButtonPressed", function(...)
		return self:OnRemoveHeroButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("LevelUpHero", function(...)
		return self:OnLevelUpHero(...)
	end)
	CustomGameEventManager:RegisterListener("MaxLevelUpHero", function(...)
		return self:OnMaxLevelUpHero(...)
	end)
	CustomGameEventManager:RegisterListener("ScepterHero", function(...)
		return self:OnScepterHero(...)
	end)
	CustomGameEventManager:RegisterListener("ShardHero", function(...)
		return self:OnShardHero(...)
	end)
	CustomGameEventManager:RegisterListener("ResetHero", function(...)
		return self:OnResetHero(...)
	end)
	CustomGameEventManager:RegisterListener("ToggleInvulnerabilityHero", function(...)
		return self:OnSetInvulnerabilityHero(nil, ...)
	end)
	CustomGameEventManager:RegisterListener("InvulnOnHero", function(...)
		return self:OnSetInvulnerabilityHero(true, ...)
	end)
	CustomGameEventManager:RegisterListener("InvulnOffHero", function(...)
		return self:OnSetInvulnerabilityHero(false, ...)
	end)
	CustomGameEventManager:RegisterListener("DummyTargetButtonPressed", function(...)
		return self:OnDummyTargetButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("TestNotification", function(...)
		return self:TestNotification(...)
	end)
	CustomGameEventManager:RegisterListener("TestNotificationRight", function(...)
		return self:TestNotificationRight(...)
	end)
	CustomGameEventManager:RegisterListener("ChangeHeroButtonPressed", function(...)
		return self:OnChangeHeroButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("ChangeCosmeticsButtonPressed", function(...)
		return self:OnChangeCosmeticsButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnCreepsButtonPressed", function(...)
		return self:OnSpawnCreepsButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnSingleCreepWaveButtonPressed", function(...)
		return self:OnSpawnSingleCreepWaveButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("TowersEnabledButtonPressed", function(...)
		return self:OnTowersEnabledButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("PauseButtonPressed", function(...)
		return self:OnPauseButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("LeaveButtonPressed", function(...)
		return self:OnLeaveButtonPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneDoubleDamagePressed", function(...)
		return self:OnSpawnRuneDoubleDamagePressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneHastePressed", function(...)
		return self:OnSpawnRuneHastePressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneIllusionPressed", function(...)
		return self:OnSpawnRuneIllusionPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneInvisibilityPressed", function(...)
		return self:OnSpawnRuneInvisibilityPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneRegenerationPressed", function(...)
		return self:OnSpawnRuneRegenerationPressed(...)
	end)
	CustomGameEventManager:RegisterListener("SpawnRuneArcanePressed", function(...)
		return self:OnSpawnRuneArcanePressed(...)
	end)
	CustomGameEventManager:RegisterListener("CreateDemoChest", function(...)
		return self:CreateDemoChest(...)
	end)
	CustomGameEventManager:RegisterListener("RespawnHeroDemo", function(...)
		return self:RespawnHeroDemo(...)
	end)
	CustomGameEventManager:RegisterListener("SuicideHeroDemo", function(...)
		return self:SuicideHeroDemo(...)
	end)
	CustomGameEventManager:RegisterListener("RefreshHeroDemo", function(...)
		return self:RefreshHeroDemo(...)
	end)
	CustomGameEventManager:RegisterListener("ChooseSkillDemo", function(...)
		return self:ChooseSkillDemo(...)
	end)
	CustomGameEventManager:RegisterListener("debugger_add_quick_skill", function(...)
		return self:AddQuickSkill(...)
	end)

	CustomGameEventManager:RegisterListener("NewNotifications", function(...)
		return self:NewNotifications(...)
	end)
	CustomGameEventManager:RegisterListener("OldNotifications", function(...)
		return self:OldNotifications(...)
	end)
	CustomGameEventManager:RegisterListener("DamageTable", function(...)
		return self:DamageTable(...)
	end)
	CustomGameEventManager:RegisterListener("BetTable", function(...)
		return self:BetTable(...)
	end)

	CustomGameEventManager:RegisterListener("QueueRounds", function(...)
		return self:QueueRounds(...)
	end)

	CustomGameEventManager:RegisterListener("CreateBot", function(...)
		return self:CreateBot(...)
	end)

	CustomGameEventManager:RegisterListener("DamageReduction", function(...)
		return self:DamageReduction(...)
	end)

	CustomGameEventManager:RegisterListener("debugger_start_round", function(source, event)
		return self:StartRound(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_create_dummy", function(source, event)
		return self:CreateDummy(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_delete_dummy", function(source, event)
		return self:DeleteDummy(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_give_item_to_dummy_from_shop", function(source, event)
		return self:GiveItemToDummy(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_add_item", function(source, event)
		return self:AddItemToUnit(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_add_ability", function(source, event)
		return self:AddAbilityToUnit(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_craft_neutral", function(source, event)
		return self:CraftNeutral(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_set_timescale", function(source, event)
		return self:SetTimeScale(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_set_max_health", function(source, event)
		return self:SetMaxHealth(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_replace_main_hero", function(source, event)
		return self:ReplaceMainHero(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_spawn_creep", function(source, event)
		return self:SpawnDebugCreep(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_delete_creep", function(source, event)
		return self:DeleteDebugCreep(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_delete_all_creeps", function(source, event)
		return self:DeleteAllDebugCreeps(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_modify_creep_stats", function(source, event)
		return self:ModifyDebugCreepStats(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_reset_creep_damage", function(source, event)
		return self:ResetDebugCreepDamage(event)
	end)

	CustomGameEventManager:RegisterListener("debugger_give_loser_curse", function(source, event)
		return self:GiveLoserCurse(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_clear_loser_curse", function(source, event)
		return self:ClearLoserCurse(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_give_report_curse", function(source, event)
		return self:GiveReportCurse(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_give_report_warning", function(source, event)
		return self:GiveReportWarning(event)
	end)
	CustomGameEventManager:RegisterListener("debugger_clear_punishments", function(source, event)
		return self:ClearPunishments(event)
	end)
...
function HeroDemo:ReplaceMainHero(event)
	...
	DebugCreateHeroWithVariant(hPlayer, HeroName, 0, DOTA_TEAM_CUSTOM_6, false, function(NewHero)
		if not NewHero then
...
function HeroDemo:CreateDummy(event)
	...
	print(
		"[HeroDemo/Dummy] PlayerHero="
			.. tostring(PlayerHero)
			.. " IsNull="
			.. tostring(PlayerHero and PlayerHero.IsNull and PlayerHero:IsNull())
	)
...
function HeroDemo:AddQuickSkill(eventSourceIndex, data)
	...
	if SKILLS_LIST_TABLE[SkillName] == nil or not HeroBuilder.Players[PlayerID] then
		return
	end
...
function HeroDemo:SpawnHeroDemo(data)
	...
	DebugCreateUnit(hPlayer, sHeroToSpawn, team, false, function(hAlly)
...
function HeroDemo:OnWelcomePanelDismissed(event) end
...
function HeroDemo:CombatLogButtonPressed(eventSourceIndex) end
...
function HeroDemo:OnRequestInitialSpawnHeroID(eventSourceIndex, data) end

function HeroDemo:OnSelectMainHeroButtonPressed(eventSourceIndex, data) end

function HeroDemo:OnSelectSpawnHeroButtonPressed(eventSourceIndex, data) end

function HeroDemo:OnRemoveHeroButtonPressed(eventSourceIndex, data) end
		...
		if hHero.AddExperience then
			...
			for i = 0, hHero:GetAbilityCount() - 1 do
				...
				if hAbility and not hAbility:IsAttributeBonus() then
					while
						hAbility:GetLevel() < hAbility:GetMaxLevel()
						and hAbility:CanAbilityBeUpgraded() == ABILITY_CAN_BE_UPGRADED
...
function HeroDemo:OnTowersEnabledButtonPressed(eventSourceIndex) end

function HeroDemo:SetTowersEnabled(bEnabled) end

function HeroDemo:FindTowers() end

function HeroDemo:OnSpawnCreepsButtonPressed(eventSourceIndex) end

function HeroDemo:OnSpawnSingleCreepWaveButtonPressed(eventSourceIndex) end

function HeroDemo:RemoveCreeps() end
...
function HeroDemo:GetRuneSpawnLocation() end
...
function HeroDemo:OnChangeCosmeticsButtonPressed(eventSourceIndex) end

function HeroDemo:OnChangeHeroButtonPressed(eventSourceIndex, data) end

function HeroDemo:OnPauseButtonPressed(eventSourceIndex) end

function HeroDemo:OnLeaveButtonPressed(eventSourceIndex) end
...
function HeroDemo:SpawnDebugCreep(event)
	...
	PrecacheUnitByNameAsync(unitName, function()
		local creep =
			CreateUnitByName(unitName, hero:GetAbsOrigin(), true, hero, hero:GetPlayerOwner(), DOTA_TEAM_NEUTRALS)
		if not creep then
			return
		end
		...
		CustomGameEventManager:Send_ServerToPlayer(PlayerResource:GetPlayer(PlayerID), "debugger_creep_spawned", {
			entindex = entIndex,
			unit_name = unitName,
...
function HeroDemo:DeleteDebugCreep(event)
	...
	if not self._debug_creeps or not self._debug_creeps[PlayerID] then
		return
	end
...
function HeroDemo:ModifyDebugCreepStats(event)
	...
	if not entIndex or not stat or not value then
		return
	end
