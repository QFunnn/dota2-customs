...
function modifier_patrol_start:IsHidden()
	return true
end
function modifier_patrol_start:IsPurgable()
	return false
end
...
function modifier_patrol_gospawn:IsHidden()
	return true
end
function modifier_patrol_gospawn:IsPurgable()
	return false
end
...
function modifier_patrol_death:IsHidden()
	return true
end
function modifier_patrol_death:IsPurgable()
	return false
end
...
function modifier_patrol_death:OnDestroy()
	...
	if self.parent.friends == nil then
		return
	end
