...
function modifier_neutral_cast:IsHidden()
	return true
end
function modifier_neutral_cast:IsPurgable()
	return false
end
...
function modifier_neutral_cast:OnDestroy()
	...
	if not self.parent_mod or self.parent_mod:IsNull() then
		return
	end
	...
	self.parent:AddNewModifier(
		...
		{ duration = self:GetAbility():GetSpecialValueFor("AbilityCooldown") }
	)
...
function modifier_neutral_cast_cd:IsHidden()
	return false
end
function modifier_neutral_cast_cd:IsDebuff()
	return true
end
function modifier_neutral_cast_cd:IsPurgable()
	return false
end