...
function modifier_generic_orb_effect_lua_jakiro:OnRefresh(kv) end

function modifier_generic_orb_effect_lua_jakiro:OnDestroy(kv) end
...
function modifier_generic_orb_effect_lua_jakiro:GetModifierProjectileName()
	...
	local modifier_generic_orb_effect_lua_jakiro_frost =
		self:GetParent():FindModifierByName("modifier_generic_orb_effect_lua_jakiro_frost")
