...
function modifier_centaur_return_unique_buff:IsHidden()
	return true
end
function modifier_centaur_return_unique_buff:IsPurgeException()
	return false
end
function modifier_centaur_return_unique_buff:IsPurgable()
	return false
end
function modifier_centaur_return_unique_buff:RemoveOnDeath()
	return false
end
...
function modifier_centaur_return_unique_buff:GetModifierIncomingDamage_Percentage(params)
	-- [NP-16] Под Break (отключение пассивок) снижение урона не работает.
