...
function modifier_mid_teleport:IsHidden()
	return false
end
function modifier_mid_teleport:IsPurgable()
	return false
end
...
function modifier_mid_teleport:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_mid_teleport:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_mid_teleport:GetAbsoluteNoDamagePure()
	return 1
end
