...
function modifier_patrol_reward_1_orb:IsHidden()
	return false
end
function modifier_patrol_reward_1_orb:IsPurgable()
	return false
end
function modifier_patrol_reward_1_orb:RemoveOnDeath()
	return false
end
function modifier_patrol_reward_1_orb:GetTexture()
	return "buffs/restrained_orb"
end
