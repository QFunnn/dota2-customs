...
function modifier_patrol_reward_2_buff:IsHidden()
	return false
end
function modifier_patrol_reward_2_buff:GetTexture()
	return "rune_doubledamage"
end
function modifier_patrol_reward_2_buff:RemoveOnDeath()
	return false
end
function modifier_patrol_reward_2_buff:IsPurgable()
	return false
end
