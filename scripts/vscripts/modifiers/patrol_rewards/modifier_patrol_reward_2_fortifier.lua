...
LinkLuaModifier(
	"modifier_patrol_reward_2_fortifier_effect",
	"modifiers/patrol_rewards/modifier_patrol_reward_2_fortifier",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_patrol_reward_2_fortifier_tower",
	"modifiers/patrol_rewards/modifier_patrol_reward_2_fortifier",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_patrol_reward_2_fortifier:IsHidden()
	return false
end
function modifier_patrol_reward_2_fortifier:RemoveOnDeath()
	return false
end
function modifier_patrol_reward_2_fortifier:IsPurgable()
	return false
end
...
function modifier_patrol_reward_2_fortifier_effect:IsHidden()
	return true
end
function modifier_patrol_reward_2_fortifier_effect:IsPurgable()
	return false
end
function modifier_patrol_reward_2_fortifier_effect:OnCreated()
	...
	self.particle =
		ParticleManager:CreateParticle("particles/patrol/fortifier_effect.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
...
function modifier_patrol_reward_2_fortifier_effect:DealDamage()
	...
	self.effect_cast =
		ParticleManager:CreateParticle("particles/patrol/fortifier_effect_damage.vpcf", PATTACH_ABSORIGIN, self.parent)
...
function modifier_patrol_reward_2_fortifier_tower:IsHidden()
	return true
end
function modifier_patrol_reward_2_fortifier_tower:IsPurgable()
	return false
end
function modifier_patrol_reward_2_fortifier_tower:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

modifier_patrol_reward_2_fortifier_tower_leash = class({})
function modifier_patrol_reward_2_fortifier_tower_leash:IsHidden()
	return true
end
function modifier_patrol_reward_2_fortifier_tower_leash:IsPurgable()
	return true
end
