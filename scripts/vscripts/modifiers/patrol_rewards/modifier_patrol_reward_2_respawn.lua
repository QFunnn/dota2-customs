...
function modifier_patrol_reward_2_respawn_cd:IsHidden()
	return false
end
function modifier_patrol_reward_2_respawn_cd:IsPurgable()
	return false
end
function modifier_patrol_reward_2_respawn_cd:IsDebuff()
	return true
end
function modifier_patrol_reward_2_respawn_cd:RemoveOnDeath()
	return false
end
function modifier_patrol_reward_2_respawn_cd:GetTexture()
	return "omniknight_guardian_angel"
end