...
function modifier_patrol_reward_1_shield:IsHidden()
	return false
end
function modifier_patrol_reward_1_shield:GetTexture()
	return "rune_shield"
end
function modifier_patrol_reward_1_shield:RemoveOnDeath()
	return false
end
function modifier_patrol_reward_1_shield:IsPurgable()
	return false
end
