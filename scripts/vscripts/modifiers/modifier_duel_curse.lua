...
function modifier_duel_curse:IsHidden()
	return true
end
function modifier_duel_curse:IsDebuff()
	return false
end
function modifier_duel_curse:IsPurgable()
	return false
end
function modifier_duel_curse:GetAttributes()
...
function modifier_duel_curse_cooldown:IsHidden()
	return true
end
function modifier_duel_curse_cooldown:IsDebuff()
	return false
end
function modifier_duel_curse_cooldown:IsPurgable()
	return false
end
function modifier_duel_curse_cooldown:IsPurgeException()
	return false
end
function modifier_duel_curse_cooldown:GetAttributes()
	return MODIFIER_ATTRIBUTE_PERMANENT + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE + MODIFIER_ATTRIBUTE_IGNORE_DODGE
end
function modifier_duel_curse_cooldown:RemoveOnDeath()
	return false
end
