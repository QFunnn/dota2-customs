...
function modifier_end_choise:IsHidden()
	return false
end
function modifier_end_choise:IsPurgable()
	return false
end
function modifier_end_choise:RemoveOnDeath()
	return false
end
function modifier_end_choise:GetTexture()
	return "buffs/purple"
end
...
function modifier_end_choise:OnDestroy()
	...
	if not player or not player.choise or #player.choise == 0 then
		return
	end
