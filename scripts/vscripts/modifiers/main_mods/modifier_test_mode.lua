...
function modifier_test_hero_custom:IsHidden()
	return false
end
function modifier_test_hero_custom:IsPurgable()
	return false
end
function modifier_test_hero_custom:GetTexture()
	return "buffs/coil_resist"
end
function modifier_test_hero_custom:RemoveOnDeath()
	return false
end
