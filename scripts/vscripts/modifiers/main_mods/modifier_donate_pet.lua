...
function modifier_donate_pet:IsPurgable()
	return false
end
function modifier_donate_pet:RemoveOnDeath()
	return false
end
...
function modifier_donate_pet_inactive:IsHidden()
	return true
end
function modifier_donate_pet_inactive:IsPurgable()
	return false
end
function modifier_donate_pet_inactive:RemoveOnDeath()
	return false
end
...
function modifier_donate_pet_inactive:OnIntervalThink()
	...
	if self.stage == 1 then
		...
		repeat
			self.start_vec =
				RotatePosition(Vector(0, 0, 0), QAngle(0, RandomInt(25 * self.k, 40 * self.k), 0), self.start_vec)
