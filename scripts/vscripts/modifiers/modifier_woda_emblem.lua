...
function modifier_woda_emblem:IsHidden()
	return true
end
function modifier_woda_emblem:IsPurgable()
	return false
end
function modifier_woda_emblem:RemoveOnDeath()
	return false
end
function modifier_woda_emblem:AllowIllusionDuplicate()
	return true
end
