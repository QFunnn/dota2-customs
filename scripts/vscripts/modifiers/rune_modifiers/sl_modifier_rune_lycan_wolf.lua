...
-- 召狼直接产生的狼继承狼人{wolf_gs_pct}%攻击速度、{wolf_atk_pct}%攻击力、{wolf_hp_pct}%生命值（SetSummonAmp，同蛇影）
...
function sl_modifier_rune_lycan_wolf.prototype.OnCreated(self, params)
	...
	Timers:CreateTimer(function()
		...
		self._record_hp = hp
		local amp = {
			as_bonus = as_display * (wolf_gs_pct / 100),
