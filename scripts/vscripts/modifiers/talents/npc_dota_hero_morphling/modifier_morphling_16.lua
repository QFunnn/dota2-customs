...
function modifier_morphling_16:IsHidden()
	return true
end
function modifier_morphling_16:IsPurgable()
	return false
end
function modifier_morphling_16:IsPurgeException()
	return false
end
function modifier_morphling_16:RemoveOnDeath()
	return false
end
