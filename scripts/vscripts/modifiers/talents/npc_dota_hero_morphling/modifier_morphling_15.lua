...
function modifier_morphling_15:IsHidden()
	return true
end
function modifier_morphling_15:IsPurgable()
	return false
end
function modifier_morphling_15:IsPurgeException()
	return false
end
function modifier_morphling_15:RemoveOnDeath()
	return false
end
...
function modifier_morphling_15:OnCreated()
	...
	CustomGameEventManager:Send_ServerToPlayer(
		...
		{
			value = self:GetParent():HasModifier("modifier_morphling_replicate_custom"),
			mod = self:GetParent():HasModifier("modifier_morphling_15"),
		}
	)
end
