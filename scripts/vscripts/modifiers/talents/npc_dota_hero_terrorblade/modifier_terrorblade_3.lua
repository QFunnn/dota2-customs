...
function modifier_terrorblade_3:IsHidden()
	return true
end
function modifier_terrorblade_3:IsPurgable()
	return false
end
function modifier_terrorblade_3:IsPurgeException()
	return false
end
function modifier_terrorblade_3:RemoveOnDeath()
	return false
end
