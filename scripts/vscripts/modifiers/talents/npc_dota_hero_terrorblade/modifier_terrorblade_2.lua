...
function modifier_terrorblade_2:IsHidden()
	return true
end
function modifier_terrorblade_2:IsPurgable()
	return false
end
function modifier_terrorblade_2:IsPurgeException()
	return false
end
function modifier_terrorblade_2:RemoveOnDeath()
	return false
end
