...
function modifier_terrorblade_13:IsHidden()
	return true
end
function modifier_terrorblade_13:IsPurgable()
	return false
end
function modifier_terrorblade_13:IsPurgeException()
	return false
end
function modifier_terrorblade_13:RemoveOnDeath()
	return false
end
