...
function modifier_terrorblade_21:IsHidden()
	return true
end
function modifier_terrorblade_21:IsPurgable()
	return false
end
function modifier_terrorblade_21:IsPurgeException()
	return false
end
function modifier_terrorblade_21:RemoveOnDeath()
	return false
end
