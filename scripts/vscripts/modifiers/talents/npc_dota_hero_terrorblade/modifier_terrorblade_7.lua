...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_terrorblade/modifier_terrorblade_7",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_terrorblade_7_counter",
	"modifiers/talents/npc_dota_hero_terrorblade/modifier_terrorblade_7",
	LUA_MODIFIER_MOTION_NONE
)

function modifier_terrorblade_7:IsHidden()
	return true
end
function modifier_terrorblade_7:IsPurgable()
	return false
end
function modifier_terrorblade_7:IsPurgeException()
	return false
end
function modifier_terrorblade_7:RemoveOnDeath()
	return false
end
...
function modifier_terrorblade_7_counter:IsHidden()
	return false
end
function modifier_terrorblade_7_counter:IsPurgable()
	return false
end
...
function modifier_terrorblade_7_counter:StatusEffectPriority()
	return 10
end
...
function modifier_terrorblade_7_counter:GetTexture()
	return "terrorblade_7"
end

modifier_terrorblade_7_buff = class({})
function modifier_terrorblade_7_buff:IsHidden()
	return true
end
function modifier_terrorblade_7_buff:IsPurgable()
	return false
end
function modifier_terrorblade_7_buff:GetAttributes()
