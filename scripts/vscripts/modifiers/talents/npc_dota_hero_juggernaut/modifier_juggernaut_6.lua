...
function modifier_juggernaut_6:IsHidden()
	return true
end
function modifier_juggernaut_6:IsPurgable()
	return false
end
function modifier_juggernaut_6:IsPurgeException()
	return false
end
function modifier_juggernaut_6:RemoveOnDeath()
	return false
end
