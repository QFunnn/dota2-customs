...
function modifier_muerta_8:IsHidden()
	return true
end
function modifier_muerta_8:IsPurgable()
	return false
end
function modifier_muerta_8:IsPurgeException()
	return false
end
function modifier_muerta_8:RemoveOnDeath()
	return false
end
