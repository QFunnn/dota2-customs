...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_muerta/modifier_muerta_10",
	LUA_MODIFIER_MOTION_NONE
)

modifier_muerta_10 = class({})

function modifier_muerta_10:IsHidden()
	return true
end
function modifier_muerta_10:IsPurgable()
	return false
end
function modifier_muerta_10:IsPurgeException()
	return false
end
function modifier_muerta_10:RemoveOnDeath()
	return false
end
