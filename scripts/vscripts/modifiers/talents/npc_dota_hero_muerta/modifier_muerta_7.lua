...
function modifier_muerta_7:IsHidden()
	return true
end
function modifier_muerta_7:IsPurgable()
	return false
end
function modifier_muerta_7:IsPurgeException()
	return false
end
function modifier_muerta_7:RemoveOnDeath()
	return false
end
...
function modifier_muerta_7:OnCreated()
	...
	if muerta_the_calling_custom then
		...
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), muerta_the_calling_custom, "modifier_muerta_the_calling_caster", {})
