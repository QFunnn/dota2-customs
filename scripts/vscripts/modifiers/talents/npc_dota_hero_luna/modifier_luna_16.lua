...
function modifier_luna_16:IsHidden()
	return true
end
function modifier_luna_16:IsPurgable()
	return false
end
function modifier_luna_16:IsPurgeException()
	return false
end
function modifier_luna_16:RemoveOnDeath()
	return false
end
...
function modifier_luna_16:GetModifierConstantHealthRegen()
	if
		self.is_night == "1"
		or (
			self:GetParent():HasModifier("modifier_luna_16")
			and self:GetParent():HasModifier("modifier_luna_lunar_orbit_custom")
		)
	then
