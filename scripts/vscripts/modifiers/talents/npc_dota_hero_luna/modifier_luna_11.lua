...
function modifier_luna_11:IsHidden()
	return true
end
function modifier_luna_11:IsPurgable()
	return false
end
function modifier_luna_11:IsPurgeException()
	return false
end
function modifier_luna_11:RemoveOnDeath()
	return false
end
