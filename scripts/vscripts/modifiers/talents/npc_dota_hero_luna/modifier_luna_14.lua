...
function modifier_luna_14:IsHidden()
	return true
end
function modifier_luna_14:IsPurgable()
	return false
end
function modifier_luna_14:IsPurgeException()
	return false
end
function modifier_luna_14:RemoveOnDeath()
	return false
end
...
function modifier_luna_14:OnCreated()
	...
	if luna_lunar_orbit_custom then
		...
		self:GetParent()
			:AddNewModifier(self:GetParent(), luna_lunar_orbit_custom, "modifier_luna_lunar_orbit_custom", {})
	end
