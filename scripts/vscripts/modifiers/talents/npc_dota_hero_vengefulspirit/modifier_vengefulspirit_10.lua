...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_vengefulspirit/modifier_vengefulspirit_10",
...
function modifier_vengefulspirit_10:IsHidden()
	return true
end
function modifier_vengefulspirit_10:IsPurgable()
	return false
end
function modifier_vengefulspirit_10:IsPurgeException()
	return false
end
function modifier_vengefulspirit_10:RemoveOnDeath()
	return false
end
...
function modifier_vengefulspirit_10:GetMinHealth()
	...
	if self:GetParent():HasModifier("modifier_vengefulspirit_10_buff_cooldown") then
		return
	end
	return 1
end
...
function modifier_vengefulspirit_10:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_vengefulspirit_10_buff") then
		return
	end
	if self:GetParent():HasModifier("modifier_vengefulspirit_10_buff_cooldown") then
		return
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_vengefulspirit_10_buff", { duration = 3 })
	self:GetParent()
		:AddNewModifier(
			self:GetParent(),
			self:GetAbility(),
...
function modifier_vengefulspirit_10_buff:IsHidden()
	return false
end
function modifier_vengefulspirit_10_buff:IsPurgable()
	return false
end
...
function modifier_vengefulspirit_10_buff:StatusEffectPriority()
	return 10
end
...
function modifier_vengefulspirit_10_buff_cooldown:IsHidden()
	return false
end
function modifier_vengefulspirit_10_buff_cooldown:IsPurgable()
	return false
end
function modifier_vengefulspirit_10_buff_cooldown:IsDebuff()
	return true
end
function modifier_vengefulspirit_10_buff_cooldown:RemoveOnDeath()
	return false
end
