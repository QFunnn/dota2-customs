...
LinkLuaModifier(
	"modifier_vengefulspirit_6_aura",
	"modifiers/talents/npc_dota_hero_vengefulspirit/modifier_vengefulspirit_6",
	LUA_MODIFIER_MOTION_NONE
)

modifier_vengefulspirit_6 = class({})

function modifier_vengefulspirit_6:IsHidden()
	return true
end
function modifier_vengefulspirit_6:IsPurgable()
	return false
end
function modifier_vengefulspirit_6:IsPurgeException()
	return false
end
function modifier_vengefulspirit_6:RemoveOnDeath()
	return false
end
