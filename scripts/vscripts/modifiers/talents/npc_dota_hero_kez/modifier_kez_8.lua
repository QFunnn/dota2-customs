...
function modifier_kez_8:IsHidden()
	return true
end
function modifier_kez_8:IsPurgable()
	return false
end
function modifier_kez_8:IsPurgeException()
	return false
end
function modifier_kez_8:RemoveOnDeath()
	return false
end
...
function modifier_kez_8:OnCreated()
	...
	if kez_switch_weapons_custom then
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), kez_switch_weapons_custom, "modifier_kez_switch_weapons_custom", {})
	end
end
