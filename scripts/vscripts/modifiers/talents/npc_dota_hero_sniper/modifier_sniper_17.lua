...
function modifier_sniper_17:IsHidden()
	return true
end
function modifier_sniper_17:IsPurgable()
	return false
end
function modifier_sniper_17:IsPurgeException()
	return false
end
function modifier_sniper_17:RemoveOnDeath()
	return false
end
