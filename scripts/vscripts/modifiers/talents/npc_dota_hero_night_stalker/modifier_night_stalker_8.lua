...
function modifier_night_stalker_8:IsHidden()
	return true
end
function modifier_night_stalker_8:IsPurgable()
	return false
end
function modifier_night_stalker_8:IsPurgeException()
	return false
end
function modifier_night_stalker_8:RemoveOnDeath()
	return false
end
...
function modifier_night_stalker_8:OnCreated()
	...
	local night_stalker_hunter_in_the_night_custom = self:GetCaster()
		:FindAbilityByName("night_stalker_hunter_in_the_night_custom")
	...
	self:GetParent()
		:SwapAbilities("night_stalker_hunter_in_the_night_custom", "night_stalker_hunter_in_the_day", false, true)
	local night_stalker_hunter_in_the_night_custom = self:GetCaster()
		:FindAbilityByName("night_stalker_hunter_in_the_night_custom")
	if night_stalker_hunter_in_the_night_custom then
