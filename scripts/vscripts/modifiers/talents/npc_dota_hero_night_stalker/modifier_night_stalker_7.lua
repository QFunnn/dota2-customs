...
function modifier_night_stalker_7:IsHidden()
	return true
end
function modifier_night_stalker_7:IsPurgable()
	return false
end
function modifier_night_stalker_7:IsPurgeException()
	return false
end
function modifier_night_stalker_7:RemoveOnDeath()
	return false
end
