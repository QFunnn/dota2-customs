...
function modifier_jakiro_6:IsHidden()
	return true
end
function modifier_jakiro_6:IsPurgable()
	return false
end
function modifier_jakiro_6:IsPurgeException()
	return false
end
function modifier_jakiro_6:RemoveOnDeath()
	return false
end
...
function modifier_jakiro_6:OnIntervalThink()
	...
	AddFOWViewer(
		...
		self.vision[self:GetStackCount()],
		FrameTime(),
		false
	)
end
