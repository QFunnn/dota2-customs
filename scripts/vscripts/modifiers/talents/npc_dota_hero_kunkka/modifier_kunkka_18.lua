...
function modifier_kunkka_18:IsHidden()
	return true
end
function modifier_kunkka_18:IsPurgable()
	return false
end
function modifier_kunkka_18:IsPurgeException()
	return false
end
function modifier_kunkka_18:RemoveOnDeath()
	return false
end
