...
function modifier_ogre_magi_8:IsHidden()
	return true
end
function modifier_ogre_magi_8:IsPurgable()
	return false
end
function modifier_ogre_magi_8:IsPurgeException()
	return false
end
function modifier_ogre_magi_8:RemoveOnDeath()
	return false
end
