...
LinkLuaModifier(
	"modifier_ogre_magi_11_buff",
	"modifiers/talents/npc_dota_hero_ogre_magi/modifier_ogre_magi_11",
	LUA_MODIFIER_MOTION_NONE
)

modifier_ogre_magi_11 = class({})

function modifier_ogre_magi_11:IsHidden()
	return true
end
function modifier_ogre_magi_11:IsPurgable()
	return false
end
function modifier_ogre_magi_11:IsPurgeException()
	return false
end
function modifier_ogre_magi_11:RemoveOnDeath()
	return false
end
...
function modifier_ogre_magi_11_buff:GetTexture()
	return "ogre_magi_11"
end
function modifier_ogre_magi_11_buff:IsHidden()
	return false
end
function modifier_ogre_magi_11_buff:IsPurgable()
	return false
end
