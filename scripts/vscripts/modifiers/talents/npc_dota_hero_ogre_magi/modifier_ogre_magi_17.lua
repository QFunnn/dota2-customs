...
function modifier_ogre_magi_17:IsHidden()
	return true
end
function modifier_ogre_magi_17:IsPurgable()
	return false
end
function modifier_ogre_magi_17:IsPurgeException()
	return false
end
function modifier_ogre_magi_17:RemoveOnDeath()
	return false
end
