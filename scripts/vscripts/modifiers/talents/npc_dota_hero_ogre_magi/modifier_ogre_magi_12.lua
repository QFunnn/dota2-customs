...
function modifier_ogre_magi_12:IsHidden()
	return true
end
function modifier_ogre_magi_12:IsPurgable()
	return false
end
function modifier_ogre_magi_12:IsPurgeException()
	return false
end
function modifier_ogre_magi_12:RemoveOnDeath()
	return false
end
