...
function modifier_ogre_magi_15:IsHidden()
	return true
end
function modifier_ogre_magi_15:IsPurgable()
	return false
end
function modifier_ogre_magi_15:IsPurgeException()
	return false
end
function modifier_ogre_magi_15:RemoveOnDeath()
	return false
end
