...
function modifier_ogre_magi_21:IsHidden()
	return true
end
function modifier_ogre_magi_21:IsPurgable()
	return false
end
function modifier_ogre_magi_21:IsPurgeException()
	return false
end
function modifier_ogre_magi_21:RemoveOnDeath()
	return false
end
...
function modifier_ogre_magi_21:OnCreated()
	...
	local ogre_magi_unrefined_fireblast_custom = self:GetCaster()
		:FindAbilityByName("ogre_magi_unrefined_fireblast_custom")
