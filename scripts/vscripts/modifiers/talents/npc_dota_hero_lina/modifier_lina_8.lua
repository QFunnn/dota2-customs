...
LinkLuaModifier(
	"modifier_lina_8_buff",
	"modifiers/talents/npc_dota_hero_lina/modifier_lina_8",
	LUA_MODIFIER_MOTION_NONE
)

modifier_lina_8 = class({})

function modifier_lina_8:IsHidden()
	return true
end
function modifier_lina_8:IsPurgable()
	return false
end
function modifier_lina_8:IsPurgeException()
	return false
end
function modifier_lina_8:RemoveOnDeath()
	return false
end
	...
	if self.attacks_[params.record] then
		...
		for _, unit in pairs(units) do
			ApplyDamage({
				...
				victim = unit,
				damage = (25 + (self:GetCaster():GetAgility() / 100 * 80)),
				damage_type = DAMAGE_TYPE_MAGICAL,
				ability = self.lina_fiery_soul_custom,
			})
		end
...
function modifier_lina_8_buff:GetTexture()
	return "lina_8"
end
function modifier_lina_8_buff:IsPurgable()
	return false
end
function modifier_lina_8_buff:IsPurgeException()
	return false
end
function modifier_lina_8_buff:RemoveOnDeath()
	return false
end