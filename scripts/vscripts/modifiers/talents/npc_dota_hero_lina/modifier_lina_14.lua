...
LinkLuaModifier(
	"modifier_lina_14_buff",
	"modifiers/talents/npc_dota_hero_lina/modifier_lina_14",
	LUA_MODIFIER_MOTION_NONE
)

modifier_lina_14 = class({})

function modifier_lina_14:IsHidden()
	return true
end
function modifier_lina_14:IsPurgable()
	return false
end
function modifier_lina_14:IsPurgeException()
	return false
end
function modifier_lina_14:RemoveOnDeath()
	return false
end
...
function modifier_lina_14_buff:GetTexture()
	return "lina_14"
end
function modifier_lina_14_buff:IsPurgable()
	return false
end
function modifier_lina_14_buff:IsPurgeException()
	return false
end
