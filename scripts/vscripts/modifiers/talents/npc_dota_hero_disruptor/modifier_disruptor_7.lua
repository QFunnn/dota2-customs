...
function modifier_disruptor_7:IsHidden()
	return true
end
function modifier_disruptor_7:IsPurgable()
	return false
end
function modifier_disruptor_7:IsPurgeException()
	return false
end
function modifier_disruptor_7:RemoveOnDeath()
	return false
end
