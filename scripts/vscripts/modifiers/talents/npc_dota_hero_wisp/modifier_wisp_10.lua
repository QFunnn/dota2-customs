...
LinkLuaModifier(
	"modifier_wisp_10_aura",
	"modifiers/talents/npc_dota_hero_wisp/modifier_wisp_10",
	LUA_MODIFIER_MOTION_NONE
)

modifier_wisp_10 = class({})

function modifier_wisp_10:IsHidden()
	return true
end
function modifier_wisp_10:IsPurgable()
	return false
end
function modifier_wisp_10:IsPurgeException()
	return false
end
function modifier_wisp_10:RemoveOnDeath()
	return false
end
...
function modifier_wisp_10_aura:GetTexture()
	return "wisp_10"
end
