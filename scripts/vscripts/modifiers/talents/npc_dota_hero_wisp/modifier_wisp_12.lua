...
LinkLuaModifier(
	"modifier_wisp_12_buff",
	"modifiers/talents/npc_dota_hero_wisp/modifier_wisp_12",
	LUA_MODIFIER_MOTION_NONE
)

modifier_wisp_12 = class({})

function modifier_wisp_12:IsHidden()
	return true
end
function modifier_wisp_12:IsPurgable()
	return false
end
function modifier_wisp_12:IsPurgeException()
	return false
end
function modifier_wisp_12:RemoveOnDeath()
	return false
end
