...
LinkLuaModifier(
	"modifier_slardar_6_buff",
	"modifiers/talents/npc_dota_hero_slardar/modifier_slardar_6",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_6_buff_counter",
	"modifiers/talents/npc_dota_hero_slardar/modifier_slardar_6",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_slardar_6:IsHidden()
	return true
end
function modifier_slardar_6:IsPurgable()
	return false
end
function modifier_slardar_6:IsPurgeException()
	return false
end
function modifier_slardar_6:RemoveOnDeath()
	return false
end
...
function modifier_slardar_6_buff:IsHidden()
	return true
end
function modifier_slardar_6_buff:IsPurgable()
	return false
end
function modifier_slardar_6_buff:GetAttributes()
