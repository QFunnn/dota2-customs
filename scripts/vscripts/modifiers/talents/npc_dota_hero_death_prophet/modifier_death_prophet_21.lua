...
LinkLuaModifier(
	"modifier_death_prophet_astral_mind_debuff",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_21",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_death_prophet_astral_mind_buff",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_21",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_death_prophet_21:IsHidden()
	return false
end
function modifier_death_prophet_21:IsPurgable()
	return false
end
function modifier_death_prophet_21:IsPurgeException()
	return false
end
function modifier_death_prophet_21:RemoveOnDeath()
	return false
end
function modifier_death_prophet_21:GetTexture()
	return "death_prophet_21"
end
...
function modifier_death_prophet_astral_mind_debuff:GetTexture()
	return "death_prophet_21"
end
