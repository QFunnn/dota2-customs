...
LinkLuaModifier(
	"modifier_death_prophet_4_aura",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_4",
	LUA_MODIFIER_MOTION_NONE
)

modifier_death_prophet_4 = class({})

function modifier_death_prophet_4:IsHidden()
	return true
end
function modifier_death_prophet_4:IsPurgable()
	return false
end
function modifier_death_prophet_4:IsPurgeException()
	return false
end
function modifier_death_prophet_4:RemoveOnDeath()
	return false
end
...
function modifier_death_prophet_4_aura:IsDebuff()
	return true
end
function modifier_death_prophet_4_aura:IsPurgable()
	return false
end
function modifier_death_prophet_4_aura:IsPurgeException()
	return false
end
