...
function modifier_death_prophet_1:IsHidden()
	return false
end
function modifier_death_prophet_1:IsPurgable()
	return false
end
function modifier_death_prophet_1:IsPurgeException()
	return false
end
function modifier_death_prophet_1:RemoveOnDeath()
	return false
end
