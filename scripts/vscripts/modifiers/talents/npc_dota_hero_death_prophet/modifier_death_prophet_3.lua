...
LinkLuaModifier(
	"modifier_death_prophet_3_aura",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_3",
	LUA_MODIFIER_MOTION_NONE
)

modifier_death_prophet_3 = class({})

function modifier_death_prophet_3:IsHidden()
	return true
end
function modifier_death_prophet_3:IsPurgable()
	return false
end
function modifier_death_prophet_3:IsPurgeException()
	return false
end
function modifier_death_prophet_3:RemoveOnDeath()
	return false
end
...
function modifier_death_prophet_3_aura:IsDebuff()
	return true
end
function modifier_death_prophet_3_aura:IsPurgable()
	return false
end
function modifier_death_prophet_3_aura:IsPurgeException()
	return false
end
