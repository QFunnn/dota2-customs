...
function modifier_death_prophet_7:IsHidden()
	return false
end
function modifier_death_prophet_7:IsPurgable()
	return false
end
function modifier_death_prophet_7:IsPurgeException()
	return false
end
function modifier_death_prophet_7:RemoveOnDeath()
	return false
end
