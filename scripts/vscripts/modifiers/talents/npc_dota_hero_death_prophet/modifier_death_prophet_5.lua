...
LinkLuaModifier(
	"modifier_death_prophet_5_aura",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_5",
	LUA_MODIFIER_MOTION_NONE
)

modifier_death_prophet_5 = class({})

function modifier_death_prophet_5:IsHidden()
	return true
end
function modifier_death_prophet_5:IsPurgable()
	return false
end
function modifier_death_prophet_5:IsPurgeException()
	return false
end
function modifier_death_prophet_5:RemoveOnDeath()
	return false
end
...
function modifier_death_prophet_5_aura:IsDebuff()
	return true
end
function modifier_death_prophet_5_aura:IsPurgable()
	return false
end
function modifier_death_prophet_5_aura:IsPurgeException()
	return false
end
