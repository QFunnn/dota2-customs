...
LinkLuaModifier(
	"modifier_death_prophet_6_aura",
	"modifiers/talents/npc_dota_hero_death_prophet/modifier_death_prophet_6",
	LUA_MODIFIER_MOTION_NONE
)

modifier_death_prophet_6 = class({})

function modifier_death_prophet_6:IsHidden()
	return true
end
function modifier_death_prophet_6:IsPurgable()
	return false
end
function modifier_death_prophet_6:IsPurgeException()
	return false
end
function modifier_death_prophet_6:RemoveOnDeath()
	return false
end
...
function modifier_death_prophet_6_aura:IsDebuff()
	return true
end
function modifier_death_prophet_6_aura:IsPurgable()
	return false
end
function modifier_death_prophet_6_aura:IsPurgeException()
	return false
end
