...
function modifier_tinker_10:IsHidden()
	return true
end
function modifier_tinker_10:IsPurgable()
	return false
end
function modifier_tinker_10:IsPurgeException()
	return false
end
function modifier_tinker_10:RemoveOnDeath()
	return false
end
