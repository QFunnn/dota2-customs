...
function modifier_tinker_6:IsHidden()
	return true
end
function modifier_tinker_6:IsPurgable()
	return false
end
function modifier_tinker_6:IsPurgeException()
	return false
end
function modifier_tinker_6:RemoveOnDeath()
	return false
end
