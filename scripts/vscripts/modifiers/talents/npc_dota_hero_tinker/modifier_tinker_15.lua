...
function modifier_tinker_15:IsHidden()
	return true
end
function modifier_tinker_15:IsPurgable()
	return false
end
function modifier_tinker_15:IsPurgeException()
	return false
end
function modifier_tinker_15:RemoveOnDeath()
	return false
end
...
function modifier_tinker_15:OnCreated()
	...
	local tinker_march_of_the_machines_custom = self:GetParent()
		:FindAbilityByName("tinker_march_of_the_machines_custom")
	if tinker_march_of_the_machines_custom then
		tinker_march_of_the_machines_custom:SetActivated(false)
	end
	self:GetCaster()
		:SwapAbilities("tinker_march_of_the_machines_custom", "tinker_heat_seeking_missile_custom", false, true)
end
