...
function modifier_tinker_1:IsHidden()
	return true
end
function modifier_tinker_1:IsPurgable()
	return false
end
function modifier_tinker_1:IsPurgeException()
	return false
end
function modifier_tinker_1:RemoveOnDeath()
	return false
end
