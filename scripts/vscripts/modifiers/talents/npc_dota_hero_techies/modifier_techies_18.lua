...
function modifier_techies_18:IsHidden()
	return true
end
function modifier_techies_18:IsPurgable()
	return false
end
function modifier_techies_18:IsPurgeException()
	return false
end
function modifier_techies_18:RemoveOnDeath()
	return false
end
