...
function modifier_techies_21:IsHidden()
	return true
end
function modifier_techies_21:IsPurgable()
	return false
end
function modifier_techies_21:IsPurgeException()
	return false
end
function modifier_techies_21:RemoveOnDeath()
	return false
end
