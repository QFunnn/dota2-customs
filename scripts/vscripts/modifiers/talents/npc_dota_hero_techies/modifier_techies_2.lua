...
function modifier_techies_2:IsHidden()
	return true
end
function modifier_techies_2:IsPurgable()
	return false
end
function modifier_techies_2:IsPurgeException()
	return false
end
function modifier_techies_2:RemoveOnDeath()
	return false
end
