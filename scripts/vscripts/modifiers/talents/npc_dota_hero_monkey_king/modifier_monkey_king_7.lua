...
function modifier_monkey_king_7:IsHidden()
	return true
end
function modifier_monkey_king_7:IsPurgable()
	return false
end
function modifier_monkey_king_7:IsPurgeException()
	return false
end
function modifier_monkey_king_7:RemoveOnDeath()
	return false
end
...
function modifier_monkey_king_7:OnCreated()
	...
	Timers:CreateTimer(FrameTime(), function()
		if self:GetParent():HasModifier("modifier_monkey_king_wukongs_command_custom_buff") then
			return 0.2
		end
