...
function modifier_monkey_king_16:IsHidden()
	return true
end
function modifier_monkey_king_16:IsPurgable()
	return false
end
function modifier_monkey_king_16:IsPurgeException()
	return false
end
function modifier_monkey_king_16:RemoveOnDeath()
	return false
end
