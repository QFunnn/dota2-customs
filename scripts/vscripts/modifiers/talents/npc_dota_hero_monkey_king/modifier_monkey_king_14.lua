...
function modifier_monkey_king_14:IsHidden()
	return true
end
function modifier_monkey_king_14:IsPurgable()
	return false
end
function modifier_monkey_king_14:IsPurgeException()
	return false
end
function modifier_monkey_king_14:RemoveOnDeath()
	return false
end
