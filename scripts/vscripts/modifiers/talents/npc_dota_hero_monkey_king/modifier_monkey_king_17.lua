...
function modifier_monkey_king_17:IsHidden()
	return true
end
function modifier_monkey_king_17:IsPurgable()
	return false
end
function modifier_monkey_king_17:IsPurgeException()
	return false
end
function modifier_monkey_king_17:RemoveOnDeath()
	return false
end
...
function modifier_monkey_king_17_barrier:IsPurgable()
	return false
end
function modifier_monkey_king_17_barrier:IsPurgeException()
	return false
end
function modifier_monkey_king_17_barrier:GetTexture()
	return "monkey_king_17"
end
