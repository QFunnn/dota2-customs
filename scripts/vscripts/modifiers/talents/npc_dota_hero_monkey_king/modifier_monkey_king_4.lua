...
function modifier_monkey_king_4:IsHidden()
	return true
end
function modifier_monkey_king_4:IsPurgable()
	return false
end
function modifier_monkey_king_4:IsPurgeException()
	return false
end
function modifier_monkey_king_4:RemoveOnDeath()
	return false
end
