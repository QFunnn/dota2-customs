...
function modifier_monkey_king_2:RemoveOnDeath()
	return false
end
...
function modifier_monkey_king_2:OnCreated()
	...
	local monkey_king_primal_spring_early_custom = self:GetParent()
		:FindAbilityByName("monkey_king_primal_spring_early_custom")
