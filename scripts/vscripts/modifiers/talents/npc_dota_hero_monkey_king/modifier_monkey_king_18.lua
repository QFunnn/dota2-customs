...
function modifier_monkey_king_18:IsHidden()
	return true
end
function modifier_monkey_king_18:IsPurgable()
	return false
end
function modifier_monkey_king_18:IsPurgeException()
	return false
end
function modifier_monkey_king_18:RemoveOnDeath()
	return false
end
