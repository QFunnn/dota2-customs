...
LinkLuaModifier(
	"modifier_skeleton_king_19_buff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_19",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skeleton_king_19_debuff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_19",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_skeleton_king_19:IsHidden()
	return true
end
function modifier_skeleton_king_19:IsPurgable()
	return false
end
function modifier_skeleton_king_19:IsPurgeException()
	return false
end
function modifier_skeleton_king_19:RemoveOnDeath()
	return false
end
