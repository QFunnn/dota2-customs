...
LinkLuaModifier(
	"modifier_skeleton_king_21_buff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_21",
	LUA_MODIFIER_MOTION_NONE
)

modifier_skeleton_king_21 = class({})

function modifier_skeleton_king_21:IsHidden()
	return true
end
function modifier_skeleton_king_21:IsPurgable()
	return false
end
function modifier_skeleton_king_21:IsPurgeException()
	return false
end
function modifier_skeleton_king_21:RemoveOnDeath()
	return false
end
