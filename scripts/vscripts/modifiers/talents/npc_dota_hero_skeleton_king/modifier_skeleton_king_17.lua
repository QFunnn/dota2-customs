...
LinkLuaModifier(
	"modifier_skeleton_king_17_buff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_17",
	LUA_MODIFIER_MOTION_NONE
)

modifier_skeleton_king_17 = class({})

function modifier_skeleton_king_17:IsHidden()
	return true
end
function modifier_skeleton_king_17:IsPurgable()
	return false
end
function modifier_skeleton_king_17:IsPurgeException()
	return false
end
function modifier_skeleton_king_17:RemoveOnDeath()
	return false
end
