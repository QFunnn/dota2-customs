...
LinkLuaModifier(
	"modifier_modifier_skeleton_king_11_armor",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_11",
	LUA_MODIFIER_MOTION_NONE
)

modifier_skeleton_king_11 = class({})

function modifier_skeleton_king_11:IsHidden()
	return true
end
function modifier_skeleton_king_11:IsPurgable()
	return false
end
function modifier_skeleton_king_11:IsPurgeException()
	return false
end
function modifier_skeleton_king_11:RemoveOnDeath()
	return false
end
