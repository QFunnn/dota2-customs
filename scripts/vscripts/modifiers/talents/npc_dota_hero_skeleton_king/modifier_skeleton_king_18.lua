...
LinkLuaModifier(
	"modifier_skeleton_king_18_buff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_18",
	LUA_MODIFIER_MOTION_NONE
)

modifier_skeleton_king_18 = class({})

function modifier_skeleton_king_18:IsHidden()
	return true
end
function modifier_skeleton_king_18:IsPurgable()
	return false
end
function modifier_skeleton_king_18:IsPurgeException()
	return false
end
function modifier_skeleton_king_18:RemoveOnDeath()
	return false
end
...
function modifier_skeleton_king_18_buff:GetModifierDamageOutgoing_Percentage()
	...
	return self.bonus[self:GetCaster():GetTalentLevel("modifier_skeleton_king_18")]
		* ((self:GetAuraOwner():GetSpellAmplification(false) * 100) / self.per_bonus)
end