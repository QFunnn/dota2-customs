...
LinkLuaModifier(
	"modifier_skeleton_king_16_buff",
	"modifiers/talents/npc_dota_hero_skeleton_king/modifier_skeleton_king_16",
	LUA_MODIFIER_MOTION_NONE
)

modifier_skeleton_king_16 = class({})

function modifier_skeleton_king_16:IsHidden()
	return true
end
function modifier_skeleton_king_16:IsPurgable()
	return false
end
function modifier_skeleton_king_16:IsPurgeException()
	return false
end
function modifier_skeleton_king_16:RemoveOnDeath()
	return false
end
