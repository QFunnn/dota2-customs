...
function modifier_skeleton_king_5:IsHidden()
	return true
end
function modifier_skeleton_king_5:IsPurgable()
	return false
end
function modifier_skeleton_king_5:IsPurgeException()
	return false
end
function modifier_skeleton_king_5:RemoveOnDeath()
	return false
end
...
function modifier_skeleton_king_5:OnCreated()
	...
	self:GetCaster()
		:SwapAbilities("skeleton_king_reincarnation_custom", "skeleton_king_reincarnation_blink", false, true)
