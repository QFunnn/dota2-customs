...
function modifier_faceless_void_8:IsHidden()
	return true
end
function modifier_faceless_void_8:IsPurgable()
	return false
end
function modifier_faceless_void_8:IsPurgeException()
	return false
end
function modifier_faceless_void_8:RemoveOnDeath()
	return false
end
