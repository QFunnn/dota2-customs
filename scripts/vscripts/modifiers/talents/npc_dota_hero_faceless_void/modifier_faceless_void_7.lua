...
function modifier_faceless_void_7:IsHidden()
	return true
end
function modifier_faceless_void_7:IsPurgable()
	return false
end
function modifier_faceless_void_7:IsPurgeException()
	return false
end
function modifier_faceless_void_7:RemoveOnDeath()
	return false
end
