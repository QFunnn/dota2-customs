...
LinkLuaModifier(
	"modifier_ancient_apparition_16_shield",
	"modifiers/talents/npc_dota_hero_ancient_apparition/modifier_ancient_apparition_16",
	LUA_MODIFIER_MOTION_NONE
)

modifier_ancient_apparition_16 = class({})

function modifier_ancient_apparition_16:IsHidden()
	return true
end
function modifier_ancient_apparition_16:IsPurgable()
	return false
end
function modifier_ancient_apparition_16:IsPurgeException()
	return false
end
function modifier_ancient_apparition_16:RemoveOnDeath()
	return false
end
...
function modifier_ancient_apparition_16:ApplyShield(manacost)
	...
	if manacost ~= nil and manacost > 0 then
		self:GetCaster():AddNewModifier(
			...
			nil,
			"modifier_ancient_apparition_16_shield",
			{ duration = 10, manacost = manacost }
		)
	end
end

modifier_ancient_apparition_16_shield = class({})
function modifier_ancient_apparition_16_shield:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_ancient_apparition_16_shield:IsHidden()
	return true
end
function modifier_ancient_apparition_16_shield:IsPurgable()
	return false
end
