...
function modifier_winter_wyvern_21:IsHidden()
	return true
end
function modifier_winter_wyvern_21:IsPurgable()
	return false
end
function modifier_winter_wyvern_21:IsPurgeException()
	return false
end
function modifier_winter_wyvern_21:RemoveOnDeath()
	return false
end
