...
function modifier_winter_wyvern_2:IsHidden()
	return true
end
function modifier_winter_wyvern_2:IsPurgable()
	return false
end
function modifier_winter_wyvern_2:IsPurgeException()
	return false
end
function modifier_winter_wyvern_2:RemoveOnDeath()
	return false
end
