...
function modifier_abaddon_4:IsHidden()
	return false
end
function modifier_abaddon_4:IsPurgable()
	return false
end
function modifier_abaddon_4:IsPurgeException()
	return false
end
function modifier_abaddon_4:RemoveOnDeath()
	return false
end
function modifier_abaddon_4:GetTexture()
	return "abaddon_4"
end
	...
	then
		if not params.unit:IsOther() then
			...
			ApplyDamage({
				...
				damage = params.original_damage / 100 * self.bonus[self:GetStackCount()],
