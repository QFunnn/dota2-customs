...
function modifier_abaddon_21:IsHidden()
	return true
end
function modifier_abaddon_21:IsPurgable()
	return false
end
function modifier_abaddon_21:IsPurgeException()
	return false
end
function modifier_abaddon_21:RemoveOnDeath()
	return false
end
...
function modifier_abaddon_21:OnCreated()
	...
	if self:GetCaster():HasModifier("modifier_abaddon_8") then
		return
	end
