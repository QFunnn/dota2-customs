...
function modifier_abaddon_11:IsHidden()
	return true
end
function modifier_abaddon_11:IsPurgable()
	return false
end
function modifier_abaddon_11:IsPurgeException()
	return false
end
function modifier_abaddon_11:RemoveOnDeath()
	return false
end
