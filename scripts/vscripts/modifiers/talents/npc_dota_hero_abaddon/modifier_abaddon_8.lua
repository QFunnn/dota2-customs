...
function modifier_abaddon_8:IsHidden()
	return true
end
function modifier_abaddon_8:IsPurgable()
	return false
end
function modifier_abaddon_8:IsPurgeException()
	return false
end
function modifier_abaddon_8:RemoveOnDeath()
	return false
end
