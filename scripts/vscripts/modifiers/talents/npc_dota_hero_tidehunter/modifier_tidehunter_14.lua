...
function modifier_tidehunter_14:IsHidden()
	return true
end
function modifier_tidehunter_14:IsPurgable()
	return false
end
function modifier_tidehunter_14:IsPurgeException()
	return false
end
function modifier_tidehunter_14:RemoveOnDeath()
	return false
end
...
function modifier_tidehunter_14:OnAttackLanded(params)
	...
	if params.no_cooldown_attack then
		return
	end
