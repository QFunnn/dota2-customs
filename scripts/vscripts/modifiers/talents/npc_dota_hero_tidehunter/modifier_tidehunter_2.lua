...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_tidehunter/modifier_tidehunter_2",
	LUA_MODIFIER_MOTION_NONE
)

modifier_tidehunter_2 = class({})

function modifier_tidehunter_2:IsHidden()
	return true
end
function modifier_tidehunter_2:IsPurgable()
	return false
end
function modifier_tidehunter_2:IsPurgeException()
	return false
end
function modifier_tidehunter_2:RemoveOnDeath()
	return false
end
