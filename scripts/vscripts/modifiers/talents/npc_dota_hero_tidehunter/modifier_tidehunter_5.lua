...
function modifier_tidehunter_5:IsHidden()
	return true
end
function modifier_tidehunter_5:IsPurgable()
	return false
end
function modifier_tidehunter_5:IsPurgeException()
	return false
end
function modifier_tidehunter_5:RemoveOnDeath()
	return false
end
