...
function modifier_chaos_knight_3:IsHidden()
	return true
end
function modifier_chaos_knight_3:IsPurgable()
	return false
end
function modifier_chaos_knight_3:IsPurgeException()
	return false
end
function modifier_chaos_knight_3:RemoveOnDeath()
	return false
end
