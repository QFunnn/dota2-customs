...
function modifier_chaos_knight_19:IsHidden()
	return true
end
function modifier_chaos_knight_19:IsPurgable()
	return false
end
function modifier_chaos_knight_19:IsPurgeException()
	return false
end
function modifier_chaos_knight_19:RemoveOnDeath()
	return false
end
