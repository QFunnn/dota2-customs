...
function modifier_chaos_knight_7:IsHidden()
	return true
end
function modifier_chaos_knight_7:IsPurgable()
	return false
end
function modifier_chaos_knight_7:IsPurgeException()
	return false
end
function modifier_chaos_knight_7:RemoveOnDeath()
	return false
end
