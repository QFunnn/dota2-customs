...
function modifier_chaos_knight_4:IsHidden()
	return true
end
function modifier_chaos_knight_4:IsPurgable()
	return false
end
function modifier_chaos_knight_4:IsPurgeException()
	return false
end
function modifier_chaos_knight_4:RemoveOnDeath()
	return false
end
