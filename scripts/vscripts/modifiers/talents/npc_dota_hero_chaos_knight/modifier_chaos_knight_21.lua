...
function modifier_chaos_knight_21:IsHidden()
	return true
end
function modifier_chaos_knight_21:IsPurgable()
	return false
end
function modifier_chaos_knight_21:IsPurgeException()
	return false
end
function modifier_chaos_knight_21:RemoveOnDeath()
	return false
end
