...
LinkLuaModifier(
	"modifier_slark_3_fx",
	"modifiers/talents/npc_dota_hero_slark/modifier_slark_3",
...
function modifier_slark_3:RemoveOnDeath()
	return false
end
...
function modifier_slark_3_fx:GetTexture()
	return "slark_3"
end
function modifier_slark_3_fx:IsPurgable()
	return false
end
function modifier_slark_3_fx:IsPurgeException()
	return false
end
function modifier_slark_3_fx:RemoveOnDeath()
	return false
end
function modifier_slark_3_fx:OnCreated()
	...
	local modifier_slark_essence_shift_custom = self:GetParent()
