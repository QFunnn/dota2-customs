...
function modifier_riki_6:IsHidden()
	return true
end
function modifier_riki_6:IsPurgable()
	return false
end
function modifier_riki_6:IsPurgeException()
	return false
end
function modifier_riki_6:RemoveOnDeath()
	return false
end
...
function modifier_riki_6:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "riki_blink_strike_custom"
