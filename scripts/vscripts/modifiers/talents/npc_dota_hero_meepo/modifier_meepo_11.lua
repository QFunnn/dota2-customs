...
LinkLuaModifier(
	"modifier_meepo_11_shield",
	"modifiers/talents/npc_dota_hero_meepo/modifier_meepo_11",
	LUA_MODIFIER_MOTION_NONE
)

modifier_meepo_11 = class({})

function modifier_meepo_11:IsHidden()
	return true
end
function modifier_meepo_11:IsPurgable()
	return false
end
function modifier_meepo_11:IsPurgeException()
	return false
end
function modifier_meepo_11:RemoveOnDeath()
	return false
end
...
function modifier_meepo_11_shield:IsPurgable()
	return false
end
function modifier_meepo_11_shield:GetTexture()
	return "aghanim_11"
end
