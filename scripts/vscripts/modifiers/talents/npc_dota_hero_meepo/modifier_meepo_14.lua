...
LinkLuaModifier(
	"modifier_meepo_14_debuff",
	"modifiers/talents/npc_dota_hero_meepo/modifier_meepo_14",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_meepo_14_debuff_stack",
	"modifiers/talents/npc_dota_hero_meepo/modifier_meepo_14",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_meepo_14_buff",
	"modifiers/talents/npc_dota_hero_meepo/modifier_meepo_14",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_meepo_14_buff_stack",
	"modifiers/talents/npc_dota_hero_meepo/modifier_meepo_14",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_meepo_14:IsHidden()
	return true
end
function modifier_meepo_14:IsPurgable()
	return false
end
function modifier_meepo_14:IsPurgeException()
	return false
end
function modifier_meepo_14:RemoveOnDeath()
	return false
end
...
function modifier_meepo_14_debuff:GetTexture()
	return "meepo_14"
end
function modifier_meepo_14_debuff:IsPurgable()
	return false
end
...
function modifier_meepo_14_debuff_stack:IsPurgable()
	return false
end
function modifier_meepo_14_debuff_stack:IsHidden()
	return true
end
function modifier_meepo_14_debuff_stack:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_meepo_14_debuff_stack:IsPurgeException()
	return false
end

modifier_meepo_14_buff = class({})
function modifier_meepo_14_buff:GetTexture()
	return "meepo_14"
end
function modifier_meepo_14_buff:IsPurgable()
	return false
end
...
function modifier_meepo_14_buff_stack:IsPurgable()
	return false
end
function modifier_meepo_14_buff_stack:IsHidden()
	return true
end
function modifier_meepo_14_buff_stack:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_meepo_14_buff_stack:IsPurgeException()
	return false
end