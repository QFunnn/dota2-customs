...
function modifier_zuus_14:IsHidden()
	return true
end
function modifier_zuus_14:IsPurgable()
	return false
end
function modifier_zuus_14:IsPurgeException()
	return false
end
function modifier_zuus_14:RemoveOnDeath()
	return false
end
