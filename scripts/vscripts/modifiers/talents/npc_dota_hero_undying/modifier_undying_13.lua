...
LinkLuaModifier(
	"modifier_undying_13_aura_attack_speed",
	"modifiers/talents/npc_dota_hero_undying/modifier_undying_13",
	LUA_MODIFIER_MOTION_NONE
)

modifier_undying_13 = class({})

function modifier_undying_13:IsHidden()
	return true
end
function modifier_undying_13:IsPurgable()
	return false
end
function modifier_undying_13:IsPurgeException()
	return false
end
function modifier_undying_13:RemoveOnDeath()
	return false
end
function modifier_undying_13:IsAura()
	return true
end
function modifier_undying_13:GetAuraDuration()
	return 0
end
...
function modifier_undying_13:GetTexture()
	return "undying_13"
end
...
function modifier_undying_13_aura_attack_speed:GetTexture()
	return "undying_13"
end
