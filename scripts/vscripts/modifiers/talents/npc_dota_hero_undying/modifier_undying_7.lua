...
function modifier_undying_7:IsHidden()
	return true
end
function modifier_undying_7:IsPurgable()
	return false
end
function modifier_undying_7:IsPurgeException()
	return false
end
function modifier_undying_7:RemoveOnDeath()
	return false
end
...
function modifier_undying_7:OnCreated()
	...
	if undying_flesh_golem_custom and undying_flesh_golem_custom:GetLevel() > 0 then
		...
		self:GetParent()
			:AddNewModifier(self:GetParent(), undying_flesh_golem_custom, "modifier_undying_flesh_golem_custom", {})
