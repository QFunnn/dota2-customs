...
LinkLuaModifier(
	"modifier_undying_1_aura",
	"modifiers/talents/npc_dota_hero_undying/modifier_undying_1",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_undying_1_aura_damage",
	"modifiers/talents/npc_dota_hero_undying/modifier_undying_1",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_undying_1:IsHidden()
	return true
end
function modifier_undying_1:IsPurgable()
	return false
end
function modifier_undying_1:IsPurgeException()
	return false
end
function modifier_undying_1:RemoveOnDeath()
	return false
end
...
function modifier_undying_1_aura:IsAura()
	return true
end
function modifier_undying_1_aura:IsAuraActiveOnDeath()
	return false
end
function modifier_undying_1_aura:GetAuraDuration()
	return 0
end
function modifier_undying_1_aura:RemoveOnDeath()
	return false
end
...
function modifier_undying_1_aura:GetTexture()
	return "undying_1"
end
...
function modifier_undying_1_aura_damage:GetTexture()
	return "undying_1"
end
...
function modifier_undying_1_aura_damage:OnIntervalThink()
	...
	if undying_soul_rip_custom then
		ApplyDamage({
			...
			ability = undying_soul_rip_custom,
		})
	end
end