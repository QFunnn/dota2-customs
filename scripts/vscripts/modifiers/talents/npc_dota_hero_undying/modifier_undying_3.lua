...
function modifier_undying_3:IsHidden()
	return true
end
function modifier_undying_3:IsPurgable()
	return false
end
function modifier_undying_3:IsPurgeException()
	return false
end
function modifier_undying_3:RemoveOnDeath()
	return false
end
