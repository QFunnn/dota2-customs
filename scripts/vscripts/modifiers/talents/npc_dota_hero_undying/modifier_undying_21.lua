...
function modifier_undying_21:IsHidden()
	return true
end
function modifier_undying_21:IsPurgable()
	return false
end
function modifier_undying_21:IsPurgeException()
	return false
end
function modifier_undying_21:RemoveOnDeath()
	return false
end
...
function modifier_undying_21:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "undying_tombstone_custom"
