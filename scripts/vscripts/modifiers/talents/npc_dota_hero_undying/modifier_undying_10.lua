...
function modifier_undying_10:IsHidden()
	return true
end
function modifier_undying_10:IsPurgable()
	return false
end
function modifier_undying_10:IsPurgeException()
	return false
end
function modifier_undying_10:RemoveOnDeath()
	return false
end
...
function modifier_undying_10:OnCreated()
	...
	for k, v in pairs(Entities:FindAllInSphere(self:GetCaster():GetAbsOrigin(), 99999)) do
		if
			...
			and v:FindModifierByName("modifier_undying_tombstone_custom")
		then
			v:ForceKill(false)
		end
	end
