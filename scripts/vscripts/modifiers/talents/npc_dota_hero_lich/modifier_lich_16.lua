...
function modifier_lich_16:IsHidden()
	return true
end
function modifier_lich_16:IsPurgable()
	return false
end
function modifier_lich_16:IsPurgeException()
	return false
end
function modifier_lich_16:RemoveOnDeath()
	return false
end
