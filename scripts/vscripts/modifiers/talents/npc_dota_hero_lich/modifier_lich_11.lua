...
function modifier_lich_11:IsHidden()
	return true
end
function modifier_lich_11:IsPurgable()
	return false
end
function modifier_lich_11:IsPurgeException()
	return false
end
function modifier_lich_11:RemoveOnDeath()
	return false
end
