...
function modifier_lich_18:IsHidden()
	return true
end
function modifier_lich_18:IsPurgable()
	return false
end
function modifier_lich_18:IsPurgeException()
	return false
end
function modifier_lich_18:RemoveOnDeath()
	return false
end
