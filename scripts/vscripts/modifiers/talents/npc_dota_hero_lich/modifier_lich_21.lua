...
function modifier_lich_21:IsHidden()
	return true
end
function modifier_lich_21:IsPurgable()
	return false
end
function modifier_lich_21:IsPurgeException()
	return false
end
function modifier_lich_21:RemoveOnDeath()
	return false
end
