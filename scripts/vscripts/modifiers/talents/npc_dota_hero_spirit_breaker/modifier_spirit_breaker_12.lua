...
LinkLuaModifier(
	"modifier_spirit_breaker_12_buff_visual",
	"modifiers/talents/npc_dota_hero_spirit_breaker/modifier_spirit_breaker_12",
	LUA_MODIFIER_MOTION_NONE
)

modifier_spirit_breaker_12 = class({})

function modifier_spirit_breaker_12:IsHidden()
	return true
end
function modifier_spirit_breaker_12:IsPurgable()
	return false
end
function modifier_spirit_breaker_12:IsPurgeException()
	return false
end
function modifier_spirit_breaker_12:RemoveOnDeath()
	return false
end
...
function modifier_spirit_breaker_12:OnIntervalThink()
	...
	local modifier_spirit_breaker_12_buff_visual = self:GetCaster()
		:FindModifierByName("modifier_spirit_breaker_12_buff_visual")
...
function modifier_spirit_breaker_12_buff_visual:IsPurgable()
	return false
end
function modifier_spirit_breaker_12_buff_visual:IsPurgeException()
	return false
end
function modifier_spirit_breaker_12_buff_visual:RemoveOnDeath()
	return false
end
function modifier_spirit_breaker_12_buff_visual:GetTexture()
	return "spirit_breaker_12"
end