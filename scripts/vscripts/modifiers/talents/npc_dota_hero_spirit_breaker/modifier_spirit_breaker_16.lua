...
function modifier_spirit_breaker_16:IsHidden()
	return true
end
function modifier_spirit_breaker_16:IsPurgable()
	return false
end
function modifier_spirit_breaker_16:IsPurgeException()
	return false
end
function modifier_spirit_breaker_16:RemoveOnDeath()
	return false
end
