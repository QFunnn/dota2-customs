...
function modifier_spirit_breaker_1:IsHidden() return true end
function modifier_spirit_breaker_1:IsPurgable() return false end
function modifier_spirit_breaker_1:IsPurgeException() return false end
function modifier_spirit_breaker_1:RemoveOnDeath() return false end
