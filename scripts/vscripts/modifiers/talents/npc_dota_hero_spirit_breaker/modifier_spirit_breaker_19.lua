...
function modifier_spirit_breaker_19:IsHidden()
	return true
end
function modifier_spirit_breaker_19:IsPurgable()
	return false
end
function modifier_spirit_breaker_19:IsPurgeException()
	return false
end
function modifier_spirit_breaker_19:RemoveOnDeath()
	return false
end
