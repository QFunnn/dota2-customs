...
function modifier_spirit_breaker_13:IsHidden()
	return true
end
function modifier_spirit_breaker_13:IsPurgable()
	return false
end
function modifier_spirit_breaker_13:IsPurgeException()
	return false
end
function modifier_spirit_breaker_13:RemoveOnDeath()
	return false
end
...
function modifier_spirit_breaker_13:OnCreated()
	...
	local spirit_breaker_nether_strike_custom = self:GetCaster()
		:FindAbilityByName("spirit_breaker_nether_strike_custom")
