...
function modifier_phoenix_19:GetTexture()
	return "phoenix_19"
end
function modifier_phoenix_19:IsPurgable()
	return false
end
function modifier_phoenix_19:IsPurgeException()
	return false
end
function modifier_phoenix_19:RemoveOnDeath()
	return false
end
