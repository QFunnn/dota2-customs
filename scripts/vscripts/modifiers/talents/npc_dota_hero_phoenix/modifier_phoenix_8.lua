...
function modifier_phoenix_8:IsHidden()
	return true
end
function modifier_phoenix_8:IsPurgable()
	return false
end
function modifier_phoenix_8:IsPurgeException()
	return false
end
function modifier_phoenix_8:RemoveOnDeath()
	return false
end
