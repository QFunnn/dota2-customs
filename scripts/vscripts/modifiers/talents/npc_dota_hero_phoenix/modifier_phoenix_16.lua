...
function modifier_phoenix_16:GetTexture()
	return "phoenix_15"
end

function modifier_phoenix_16:IsPurgable()
	return false
end
function modifier_phoenix_16:IsPurgeException()
	return false
end
function modifier_phoenix_16:RemoveOnDeath()
	return false
end
...
function modifier_phoenix_16:OnCreated()
	...
	if phoenix_freezing_spirits then
		...
		local modifier_phoenix_freezing_spirits = self:GetCaster()
			:FindModifierByName("modifier_phoenix_freezing_spirits")
		if modifier_phoenix_freezing_spirits then
			modifier_phoenix_freezing_spirits.rotation = 180
		end
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), phoenix_freezing_spirits, "modifier_phoenix_freezing_spirits", {})
	end
