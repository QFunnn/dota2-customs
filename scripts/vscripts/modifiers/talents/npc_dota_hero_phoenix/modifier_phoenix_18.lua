...
function modifier_phoenix_18:IsHidden()
	return true
end
function modifier_phoenix_18:IsPurgable()
	return false
end
function modifier_phoenix_18:IsPurgeException()
	return false
end
function modifier_phoenix_18:RemoveOnDeath()
	return false
end
