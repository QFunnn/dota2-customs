...
function modifier_phoenix_12:IsHidden()
	return true
end
function modifier_phoenix_12:IsPurgable()
	return false
end
function modifier_phoenix_12:IsPurgeException()
	return false
end
function modifier_phoenix_12:RemoveOnDeath()
	return false
end
...
function modifier_phoenix_12:OnCreated()
	...
	local modifier_phoenix_fire_spirits_custom_count = self:GetParent()
