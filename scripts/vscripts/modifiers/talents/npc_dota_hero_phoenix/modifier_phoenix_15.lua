...
LinkLuaModifier(
	"modifier_phoenix_15_buff",
	"modifiers/talents/npc_dota_hero_phoenix/modifier_phoenix_15",
	LUA_MODIFIER_MOTION_NONE
)

modifier_phoenix_15 = class({})

function modifier_phoenix_15:IsHidden()
	return true
end
function modifier_phoenix_15:IsPurgable()
	return false
end
function modifier_phoenix_15:IsPurgeException()
	return false
end
function modifier_phoenix_15:RemoveOnDeath()
	return false
end
...
function modifier_phoenix_15:OnCreated()
	...
	local modifier_phoenix_fire_spirits_custom_count = self:GetCaster()
		:FindModifierByName("modifier_phoenix_fire_spirits_custom_count")
