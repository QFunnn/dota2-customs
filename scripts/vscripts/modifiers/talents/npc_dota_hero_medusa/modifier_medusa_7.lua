...
function modifier_medusa_7:IsHidden()
	return true
end
function modifier_medusa_7:IsPurgable()
	return false
end
function modifier_medusa_7:IsPurgeException()
	return false
end
function modifier_medusa_7:RemoveOnDeath()
	return false
end
...
function modifier_medusa_7:GetModifierProcAttack_BonusDamage_Pure(params)
	...
	ApplyDamage({
		...
		damage = self:GetParent():GetMaxHealth() / 100 * 0.7,
