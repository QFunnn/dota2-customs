...
LinkLuaModifier(
	"modifier_medusa_19_debuff",
	"modifiers/talents/npc_dota_hero_medusa/modifier_medusa_19",
	LUA_MODIFIER_MOTION_NONE
)

modifier_medusa_19 = class({})

function modifier_medusa_19:IsHidden()
	return true
end
function modifier_medusa_19:IsPurgable()
	return false
end
function modifier_medusa_19:IsPurgeException()
	return false
end
function modifier_medusa_19:RemoveOnDeath()
	return false
end
...
function modifier_medusa_19_debuff:GetTexture()
	return "medusa_19"
end
