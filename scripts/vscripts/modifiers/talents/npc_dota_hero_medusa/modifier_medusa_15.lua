...
function modifier_medusa_15:IsHidden()
	return true
end
function modifier_medusa_15:IsPurgable()
	return false
end
function modifier_medusa_15:IsPurgeException()
	return false
end
function modifier_medusa_15:RemoveOnDeath()
	return false
end
...
function modifier_medusa_15:GetModifierProcAttack_Feedback(params)
	...
	if self:GetParent().split_shot_attack then
		return
	end
