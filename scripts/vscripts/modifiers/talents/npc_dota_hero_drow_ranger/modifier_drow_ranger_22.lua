...
function modifier_drow_ranger_22:IsHidden()
	return true
end
function modifier_drow_ranger_22:IsPurgable()
	return false
end
function modifier_drow_ranger_22:IsPurgeException()
	return false
end
function modifier_drow_ranger_22:RemoveOnDeath()
	return false
end
