...
function modifier_drow_ranger_12:IsHidden()
	return true
end
function modifier_drow_ranger_12:IsPurgable()
	return false
end
function modifier_drow_ranger_12:IsPurgeException()
	return false
end
function modifier_drow_ranger_12:RemoveOnDeath()
	return false
end
