...
function modifier_drow_ranger_18:IsHidden()
	return true
end
function modifier_drow_ranger_18:IsPurgable()
	return false
end
function modifier_drow_ranger_18:IsPurgeException()
	return false
end
function modifier_drow_ranger_18:RemoveOnDeath()
	return false
end
