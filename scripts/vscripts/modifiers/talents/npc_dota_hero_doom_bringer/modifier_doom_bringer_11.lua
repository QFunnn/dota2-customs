...
function modifier_doom_bringer_11:IsHidden()
	return true
end
function modifier_doom_bringer_11:IsPurgable()
	return false
end
function modifier_doom_bringer_11:IsPurgeException()
	return false
end
function modifier_doom_bringer_11:RemoveOnDeath()
	return false
end
