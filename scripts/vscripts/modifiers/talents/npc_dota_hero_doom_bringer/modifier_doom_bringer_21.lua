...
function modifier_doom_bringer_21:IsHidden()
	return true
end
function modifier_doom_bringer_21:IsPurgable()
	return false
end
function modifier_doom_bringer_21:IsPurgeException()
	return false
end
function modifier_doom_bringer_21:RemoveOnDeath()
	return false
end
...
function modifier_doom_bringer_21:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "doom_bringer_devour_custom"
