...
function modifier_doom_bringer_7:IsHidden()
	return true
end
function modifier_doom_bringer_7:IsPurgable()
	return false
end
function modifier_doom_bringer_7:IsPurgeException()
	return false
end
function modifier_doom_bringer_7:RemoveOnDeath()
	return false
end
...
function modifier_doom_bringer_7:OnCreated()
	...
	if doom_bringer_doom_custom and doom_bringer_doom_custom:GetLevel() > 0 then
		...
		self:GetParent()
			:AddNewModifier(self:GetParent(), doom_bringer_doom_custom, "modifier_doom_bringer_doom_custom_aura", {})
	end
end
