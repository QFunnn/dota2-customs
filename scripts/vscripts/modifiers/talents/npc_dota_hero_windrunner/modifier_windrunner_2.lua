...
function modifier_windrunner_2:IsPurgable()
	return false
end
function modifier_windrunner_2:IsPurgeException()
	return false
end
function modifier_windrunner_2:RemoveOnDeath()
	return false
end
...
function modifier_windrunner_2:GetModifierOverrideAbilitySpecial(data)
	...
	if
		...
		and data.ability_special_value == "AbilityCooldown"
	then
		return 1
	end
end
