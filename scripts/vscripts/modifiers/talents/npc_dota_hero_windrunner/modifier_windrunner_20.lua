...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_windrunner/modifier_windrunner_20",
...
function modifier_windrunner_20:IsHidden()
	return true
end
function modifier_windrunner_20:IsPurgable()
	return false
end
function modifier_windrunner_20:IsPurgeException()
	return false
end
function modifier_windrunner_20:RemoveOnDeath()
	return false
end
...
function modifier_windrunner_20:GetMinHealth()
	...
	if self:GetParent():HasModifier("modifier_modifier_windrunner_20_buff_cooldown") then
		return
	end
	return 1
end
...
function modifier_windrunner_20:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_modifier_windrunner_20_buff") then
		return
	end
	if self:GetParent():HasModifier("modifier_modifier_windrunner_20_buff_cooldown") then
		return
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_modifier_windrunner_20_buff", { duration = 1 })
...
function modifier_modifier_windrunner_20_buff:GetEffectName()
	return "particles/helm_of_the_undying_custom_3.vpcf"
end
function modifier_modifier_windrunner_20_buff:IsHidden()
	return false
end
function modifier_modifier_windrunner_20_buff:IsPurgable()
	return false
end
...
function modifier_modifier_windrunner_20_buff_cooldown:IsHidden()
	return false
end
function modifier_modifier_windrunner_20_buff_cooldown:IsPurgable()
	return false
end
function modifier_modifier_windrunner_20_buff_cooldown:IsDebuff()
	return true
end
function modifier_modifier_windrunner_20_buff_cooldown:RemoveOnDeath()
	return false
end
