...
function modifier_legion_commander_17:IsHidden()
	return true
end
function modifier_legion_commander_17:IsPurgable()
	return false
end
function modifier_legion_commander_17:IsPurgeException()
	return false
end
function modifier_legion_commander_17:RemoveOnDeath()
	return false
end
