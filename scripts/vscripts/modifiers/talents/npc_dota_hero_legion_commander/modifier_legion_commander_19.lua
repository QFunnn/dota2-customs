...
function modifier_legion_commander_19:IsHidden()
	return true
end
function modifier_legion_commander_19:IsPurgable()
	return false
end
function modifier_legion_commander_19:IsPurgeException()
	return false
end
function modifier_legion_commander_19:RemoveOnDeath()
	return false
end
