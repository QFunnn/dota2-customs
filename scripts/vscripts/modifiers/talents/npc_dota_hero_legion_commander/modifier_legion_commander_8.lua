...
function modifier_legion_commander_8:IsHidden()
	return true
end
function modifier_legion_commander_8:IsPurgable()
	return false
end
function modifier_legion_commander_8:IsPurgeException()
	return false
end
function modifier_legion_commander_8:RemoveOnDeath()
	return false
end
