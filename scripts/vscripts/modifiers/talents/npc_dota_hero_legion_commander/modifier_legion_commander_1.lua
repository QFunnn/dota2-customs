...
function modifier_legion_commander_1:IsPurgable()
	return false
end
function modifier_legion_commander_1:IsPurgeException()
	return false
end
function modifier_legion_commander_1:RemoveOnDeath()
	return false
end
