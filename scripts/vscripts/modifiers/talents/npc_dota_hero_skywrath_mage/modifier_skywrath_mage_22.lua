...
function modifier_skywrath_mage_22:IsHidden()
	return true
end
function modifier_skywrath_mage_22:IsPurgable()
	return false
end
function modifier_skywrath_mage_22:IsPurgeException()
	return false
end
function modifier_skywrath_mage_22:RemoveOnDeath()
	return false
end
