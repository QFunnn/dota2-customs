...
LinkLuaModifier(
	"modifier_skywrath_mage_16_cooldown",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_16",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_16_barier",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_16",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_skywrath_mage_16:IsHidden()
	return true
end
function modifier_skywrath_mage_16:IsPurgable()
	return false
end
function modifier_skywrath_mage_16:IsPurgeException()
	return false
end
function modifier_skywrath_mage_16:RemoveOnDeath()
	return false
end
...
function modifier_skywrath_mage_16:OnIntervalThink()
	...
	if self:GetParent():HasModifier("modifier_skywrath_mage_16_cooldown") then
		return
	end
...
function modifier_skywrath_mage_16_cooldown:GetTexture()
	return "skywrath_mage_16"
end
function modifier_skywrath_mage_16_cooldown:IsPurgable()
	return false
end
function modifier_skywrath_mage_16_cooldown:IsPurgeException()
	return false
end
function modifier_skywrath_mage_16_cooldown:IsDebuff()
	return true
end
function modifier_skywrath_mage_16_cooldown:RemoveOnDeath()
	return false
end

modifier_skywrath_mage_16_barier = class({})
function modifier_skywrath_mage_16_barier:IsPurgable()
	return false
end
function modifier_skywrath_mage_16_barier:IsPurgeException()
	return false
end
function modifier_skywrath_mage_16_barier:GetTexture()
	return "skywrath_mage_16"
end
function modifier_skywrath_mage_16_barier:IsHidden()
	return true
end
