...
LinkLuaModifier(
	"modifier_skywrath_mage_17_buff_stack",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_17",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_17_buff",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_17",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_skywrath_mage_17:IsHidden()
	return true
end
function modifier_skywrath_mage_17:IsPurgable()
	return false
end
function modifier_skywrath_mage_17:IsPurgeException()
	return false
end
function modifier_skywrath_mage_17:RemoveOnDeath()
	return false
end
...
function modifier_skywrath_mage_17_buff:GetTexture()
	return "skywrath_mage_17"
end
...
function modifier_skywrath_mage_17_buff_stack:GetTexture()
	return "skywrath_mage_5"
end
function modifier_skywrath_mage_17_buff_stack:IsHidden()
	return true
end
function modifier_skywrath_mage_17_buff_stack:GetAttributes()
