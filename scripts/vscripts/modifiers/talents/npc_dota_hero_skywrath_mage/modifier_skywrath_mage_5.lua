...
LinkLuaModifier(
	"modifier_skywrath_mage_5_buff_stack",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_5",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_5_buff",
	"modifiers/talents/npc_dota_hero_skywrath_mage/modifier_skywrath_mage_5",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_skywrath_mage_5:IsHidden()
	return true
end
function modifier_skywrath_mage_5:IsPurgable()
	return false
end
function modifier_skywrath_mage_5:IsPurgeException()
	return false
end
function modifier_skywrath_mage_5:RemoveOnDeath()
	return false
end
...
function modifier_skywrath_mage_5_buff:GetTexture()
...
function modifier_skywrath_mage_5_buff_stack:GetTexture()
	return "skywrath_mage_5"
end
function modifier_skywrath_mage_5_buff_stack:IsHidden()
	return true
end
function modifier_skywrath_mage_5_buff_stack:GetAttributes()
