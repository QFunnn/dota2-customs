...
LinkLuaModifier(
	"modifier_visage_10_buff",
	"modifiers/talents/npc_dota_hero_visage/modifier_visage_10",
	LUA_MODIFIER_MOTION_NONE
)

modifier_visage_10 = class({})

function modifier_visage_10:IsHidden()
	return true
end
function modifier_visage_10:IsPurgable()
	return false
end
function modifier_visage_10:IsPurgeException()
	return false
end
function modifier_visage_10:RemoveOnDeath()
	return false
end
...
function modifier_visage_10:CheckStoneHearts()
	if
		self:GetCaster():HasModifier("modifier_visage_3")
		and self:GetCaster():HasModifier("modifier_visage_10")
		and self:GetCaster():HasModifier("modifier_visage_17")
	then
...
function modifier_visage_10_buff:IsPurgable()
	return false
end
function modifier_visage_10_buff:IsPurgeException()
	return false
end
function modifier_visage_10_buff:RemoveOnDeath()
	return false
end
function modifier_visage_10_buff:GetTexture()
	return "visage_10"
end
