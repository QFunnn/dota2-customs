...
function modifier_visage_5:IsHidden()
	return true
end
function modifier_visage_5:IsPurgable()
	return false
end
function modifier_visage_5:IsPurgeException()
	return false
end
function modifier_visage_5:RemoveOnDeath()
	return false
end
...
function modifier_visage_5:GetModifierExtraHealthBonus()
	...
	if not visage_summon_familiars_custom then
		return 0
	end
