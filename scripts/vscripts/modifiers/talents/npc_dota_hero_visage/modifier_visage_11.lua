...
function modifier_visage_11:IsHidden()
	return true
end
function modifier_visage_11:IsPurgable()
	return false
end
function modifier_visage_11:IsPurgeException()
	return false
end
function modifier_visage_11:RemoveOnDeath()
	return false
end
