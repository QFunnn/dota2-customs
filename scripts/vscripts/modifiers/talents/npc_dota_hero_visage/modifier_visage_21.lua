...
function modifier_visage_21:IsHidden()
	return true
end
function modifier_visage_21:IsPurgable()
	return false
end
function modifier_visage_21:IsPurgeException()
	return false
end
function modifier_visage_21:RemoveOnDeath()
	return false
end
