...
LinkLuaModifier(
	"modifier_visage_19_charges",
	"modifiers/talents/npc_dota_hero_visage/modifier_visage_19",
	LUA_MODIFIER_MOTION_NONE
)

function modifier_visage_19:IsHidden()
	return true
end
function modifier_visage_19:IsPurgable()
	return false
end
function modifier_visage_19:IsPurgeException()
	return false
end
function modifier_visage_19:RemoveOnDeath()
	return false
end
...
function modifier_visage_19_charges:IsHidden()
	return false
end
function modifier_visage_19_charges:IsPurgable()
	return false
end
function modifier_visage_19_charges:IsPurgeException()
	return false
end
function modifier_visage_19_charges:RemoveOnDeath()
	return false
end
function modifier_visage_19_charges:DestroyOnExpire()
	return false
end
function modifier_visage_19_charges:GetTexture()
	return "visage_stone_form_self_cast"
end
