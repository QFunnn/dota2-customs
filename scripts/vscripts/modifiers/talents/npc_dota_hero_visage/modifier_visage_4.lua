...
function modifier_visage_4:IsHidden()
	return true
end
function modifier_visage_4:IsPurgable()
	return false
end
function modifier_visage_4:IsPurgeException()
	return false
end
function modifier_visage_4:RemoveOnDeath()
	return false
end
...
function modifier_visage_4:OnCreated()
	...
	local modifier_visage_soul_assumption_custom = self:GetCaster()
