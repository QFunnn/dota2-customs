...
function modifier_visage_16:IsHidden()
	return true
end
function modifier_visage_16:IsPurgable()
	return false
end
function modifier_visage_16:IsPurgeException()
	return false
end
function modifier_visage_16:RemoveOnDeath()
	return false
end
...
function modifier_visage_16:RefreshSoulAssumptionCharges()
	local modifier_visage_soul_assumption_custom = self:GetParent()
		:FindModifierByName("modifier_visage_soul_assumption_custom")
