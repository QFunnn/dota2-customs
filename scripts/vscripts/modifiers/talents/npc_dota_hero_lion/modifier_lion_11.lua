...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_lion/modifier_lion_11",
...
function modifier_lion_11:IsHidden()
	return true
end
function modifier_lion_11:IsPurgable()
	return false
end
function modifier_lion_11:IsPurgeException()
	return false
end
function modifier_lion_11:RemoveOnDeath()
	return false
end
...
function modifier_lion_11:GetMinHealth()
	...
	if self:GetParent():HasModifier("modifier_lion_11_buff_cooldown") then
		return
	end
	return 1
end
...
function modifier_lion_11:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_lion_11_buff") then
		return
	end
	if self:GetParent():HasModifier("modifier_lion_11_buff_cooldown") then
		return
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_lion_11_buff_cooldown", { duration = 120 })
	self:GetParent():Purge(false, true, false, true, true)
end

modifier_lion_11_buff = class({})

function modifier_lion_11_buff:IsHidden()
	return false
end
function modifier_lion_11_buff:IsPurgable()
	return false
end
...
function modifier_lion_11_buff_cooldown:IsHidden()
	return false
end
function modifier_lion_11_buff_cooldown:IsPurgable()
	return false
end
function modifier_lion_11_buff_cooldown:IsDebuff()
	return true
end
function modifier_lion_11_buff_cooldown:RemoveOnDeath()
	return false
end
