...
LinkLuaModifier(
	"modifier_modifier_lion_8_armor",
	"modifiers/talents/npc_dota_hero_lion/modifier_lion_8",
	LUA_MODIFIER_MOTION_NONE
)

modifier_lion_8 = class({})

function modifier_lion_8:IsHidden()
	return true
end
function modifier_lion_8:IsPurgable()
	return false
end
function modifier_lion_8:IsPurgeException()
	return false
end
function modifier_lion_8:RemoveOnDeath()
	return false
end
