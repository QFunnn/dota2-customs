...
function modifier_lion_9:IsHidden()
	return true
end
function modifier_lion_9:IsPurgable()
	return false
end
function modifier_lion_9:IsPurgeException()
	return false
end
function modifier_lion_9:RemoveOnDeath()
	return false
end
...
function modifier_lion_9:OnIntervalThink()
	...
	if not self:GetParent():HasModifier("modifier_lion_finger_punch") then
		...
		if lion_finger_of_death_custom and lion_finger_of_death_custom:GetLevel() > 0 then
			self:GetParent()
				:AddNewModifier(self:GetParent(), lion_finger_of_death_custom, "modifier_lion_finger_punch", {})
		end
	end
end
