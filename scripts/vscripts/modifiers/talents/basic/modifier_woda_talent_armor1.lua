...
function modifier_woda_talent_armor1:IsHidden()
	return true
end
function modifier_woda_talent_armor1:IsPurgable()
	return false
end
function modifier_woda_talent_armor1:IsPurgeException()
	return false
end
function modifier_woda_talent_armor1:RemoveOnDeath()
	return false
end
