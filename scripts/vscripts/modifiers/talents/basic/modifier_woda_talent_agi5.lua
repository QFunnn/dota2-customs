...
function modifier_woda_talent_agi5:IsHidden()
	return true
end
function modifier_woda_talent_agi5:IsPurgable()
	return false
end
function modifier_woda_talent_agi5:IsPurgeException()
	return false
end
function modifier_woda_talent_agi5:RemoveOnDeath()
	return false
end
