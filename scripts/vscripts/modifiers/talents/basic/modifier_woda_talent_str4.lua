...
function modifier_woda_talent_str4:IsHidden()
	return true
end
function modifier_woda_talent_str4:IsPurgable()
	return false
end
function modifier_woda_talent_str4:IsPurgeException()
	return false
end
function modifier_woda_talent_str4:RemoveOnDeath()
	return false
end
