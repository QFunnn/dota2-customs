...
function modifier_woda_talent_str3:IsHidden()
	return true
end
function modifier_woda_talent_str3:IsPurgable()
	return false
end
function modifier_woda_talent_str3:IsPurgeException()
	return false
end
function modifier_woda_talent_str3:RemoveOnDeath()
	return false
end
