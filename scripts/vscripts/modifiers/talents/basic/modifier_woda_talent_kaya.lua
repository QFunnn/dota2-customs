...
function modifier_woda_talent_kaya:IsHidden()
	return true
end
function modifier_woda_talent_kaya:IsPurgable()
	return false
end
function modifier_woda_talent_kaya:IsPurgeException()
	return false
end
function modifier_woda_talent_kaya:RemoveOnDeath()
	return false
end
