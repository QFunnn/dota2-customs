...
function modifier_woda_talent_regenmp2:IsHidden()
	return true
end
function modifier_woda_talent_regenmp2:IsPurgable()
	return false
end
function modifier_woda_talent_regenmp2:IsPurgeException()
	return false
end
function modifier_woda_talent_regenmp2:RemoveOnDeath()
	return false
end
