...
function modifier_woda_talent_sliver:IsHidden()
	return true
end
function modifier_woda_talent_sliver:IsPurgable()
	return false
end
function modifier_woda_talent_sliver:IsPurgeException()
	return false
end
function modifier_woda_talent_sliver:RemoveOnDeath()
	return false
end
