...
LinkLuaModifier(
	"modifier_woda_talent_blood_cooldown",
	"modifiers/talents/basic/modifier_woda_talent_blood",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_woda_talent_blood_barier",
	"modifiers/talents/basic/modifier_woda_talent_blood",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_woda_talent_blood:IsHidden()
	return true
end
function modifier_woda_talent_blood:IsPurgable()
	return false
end
function modifier_woda_talent_blood:IsPurgeException()
	return false
end
function modifier_woda_talent_blood:RemoveOnDeath()
	return false
end
...
function modifier_woda_talent_blood:OnIntervalThink()
	...
	if self:GetParent():HasModifier("modifier_woda_talent_blood_cooldown") then
		return
	end
...
function modifier_woda_talent_blood_cooldown:GetTexture()
	return "blood"
end
function modifier_woda_talent_blood_cooldown:IsPurgable()
	return false
end
function modifier_woda_talent_blood_cooldown:IsPurgeException()
	return false
end
function modifier_woda_talent_blood_cooldown:IsDebuff()
	return true
end
function modifier_woda_talent_blood_cooldown:RemoveOnDeath()
	return false
end

modifier_woda_talent_blood_barier = class({})
function modifier_woda_talent_blood_barier:IsPurgable()
	return false
end
function modifier_woda_talent_blood_barier:IsPurgeException()
	return false
end
function modifier_woda_talent_blood_barier:GetTexture()
	return "blood"
end
function modifier_woda_talent_blood_barier:IsHidden()
	return true
end
