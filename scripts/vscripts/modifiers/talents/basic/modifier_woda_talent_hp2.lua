...
function modifier_woda_talent_hp2:IsHidden()
	return true
end
function modifier_woda_talent_hp2:IsPurgable()
	return false
end
function modifier_woda_talent_hp2:IsPurgeException()
	return false
end
function modifier_woda_talent_hp2:RemoveOnDeath()
	return false
end
