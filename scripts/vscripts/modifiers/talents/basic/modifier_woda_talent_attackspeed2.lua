...
function modifier_woda_talent_attackspeed2:IsHidden()
	return true
end
function modifier_woda_talent_attackspeed2:IsPurgable()
	return false
end
function modifier_woda_talent_attackspeed2:IsPurgeException()
	return false
end
function modifier_woda_talent_attackspeed2:RemoveOnDeath()
	return false
end
