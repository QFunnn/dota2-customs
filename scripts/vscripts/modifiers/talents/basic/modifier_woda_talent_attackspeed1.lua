...
function modifier_woda_talent_attackspeed1:IsHidden()
	return true
end
function modifier_woda_talent_attackspeed1:IsPurgable()
	return false
end
function modifier_woda_talent_attackspeed1:IsPurgeException()
	return false
end
function modifier_woda_talent_attackspeed1:RemoveOnDeath()
	return false
end
