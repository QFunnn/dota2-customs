...
function modifier_woda_talent_cloak:IsHidden()
	return true
end
function modifier_woda_talent_cloak:IsPurgable()
	return false
end
function modifier_woda_talent_cloak:IsPurgeException()
	return false
end
function modifier_woda_talent_cloak:RemoveOnDeath()
	return false
end
