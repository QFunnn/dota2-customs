...
function modifier_woda_talent_quickhp:IsHidden()
	return true
end
function modifier_woda_talent_quickhp:IsPurgable()
	return false
end
function modifier_woda_talent_quickhp:IsPurgeException()
	return false
end
function modifier_woda_talent_quickhp:RemoveOnDeath()
	return false
end
