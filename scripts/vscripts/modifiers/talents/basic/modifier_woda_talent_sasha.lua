...
function modifier_woda_talent_sasha:IsHidden()
	return true
end
function modifier_woda_talent_sasha:IsPurgable()
	return false
end
function modifier_woda_talent_sasha:IsPurgeException()
	return false
end
function modifier_woda_talent_sasha:RemoveOnDeath()
	return false
end
