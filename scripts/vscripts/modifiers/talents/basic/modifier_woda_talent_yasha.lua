...
function modifier_woda_talent_yasha:IsHidden()
	return true
end
function modifier_woda_talent_yasha:IsPurgable()
	return false
end
function modifier_woda_talent_yasha:IsPurgeException()
	return false
end
function modifier_woda_talent_yasha:RemoveOnDeath()
	return false
end
