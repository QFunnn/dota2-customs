...
function modifier_woda_talent_regenhp2:IsHidden()
	return true
end
function modifier_woda_talent_regenhp2:IsPurgable()
	return false
end
function modifier_woda_talent_regenhp2:IsPurgeException()
	return false
end
function modifier_woda_talent_regenhp2:RemoveOnDeath()
	return false
end
