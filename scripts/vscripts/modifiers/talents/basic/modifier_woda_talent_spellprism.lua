...
function modifier_woda_talent_spellprism:IsHidden()
	return true
end
function modifier_woda_talent_spellprism:IsPurgable()
	return false
end
function modifier_woda_talent_spellprism:IsPurgeException()
	return false
end
function modifier_woda_talent_spellprism:RemoveOnDeath()
	return false
end
