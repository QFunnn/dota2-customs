...
function modifier_woda_talent_mp2:IsHidden()
	return true
end
function modifier_woda_talent_mp2:IsPurgable()
	return false
end
function modifier_woda_talent_mp2:IsPurgeException()
	return false
end
function modifier_woda_talent_mp2:RemoveOnDeath()
	return false
end
