...
function modifier_woda_talent_spell:IsHidden()
	return true
end
function modifier_woda_talent_spell:IsPurgable()
	return false
end
function modifier_woda_talent_spell:IsPurgeException()
	return false
end
function modifier_woda_talent_spell:RemoveOnDeath()
	return false
end
