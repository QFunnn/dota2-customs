...
function modifier_woda_talent_regenmp1:IsHidden()
	return true
end
function modifier_woda_talent_regenmp1:IsPurgable()
	return false
end
function modifier_woda_talent_regenmp1:IsPurgeException()
	return false
end
function modifier_woda_talent_regenmp1:RemoveOnDeath()
	return false
end
