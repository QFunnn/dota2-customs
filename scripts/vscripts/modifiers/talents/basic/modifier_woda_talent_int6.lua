...
function modifier_woda_talent_int6:IsHidden()
	return true
end
function modifier_woda_talent_int6:IsPurgable()
	return false
end
function modifier_woda_talent_int6:IsPurgeException()
	return false
end
function modifier_woda_talent_int6:RemoveOnDeath()
	return false
end
...
function modifier_woda_talent_int6:OnCreated()
	...
	if
		...
		and self:GetParent():HasModifier("modifier_woda_talent_str6")
	then
