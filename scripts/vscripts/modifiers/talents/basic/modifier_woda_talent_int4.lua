...
function modifier_woda_talent_int4:IsHidden()
	return true
end
function modifier_woda_talent_int4:IsPurgable()
	return false
end
function modifier_woda_talent_int4:IsPurgeException()
	return false
end
function modifier_woda_talent_int4:RemoveOnDeath()
	return false
end
