...
function modifier_woda_talent_fairy:IsHidden()
	return true
end
function modifier_woda_talent_fairy:IsPurgable()
	return false
end
function modifier_woda_talent_fairy:IsPurgeException()
	return false
end
function modifier_woda_talent_fairy:RemoveOnDeath()
	return false
end
