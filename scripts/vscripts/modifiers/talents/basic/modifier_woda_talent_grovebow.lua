...
function modifier_woda_talent_grovebow:IsHidden()
	return true
end
function modifier_woda_talent_grovebow:IsPurgable()
	return false
end
function modifier_woda_talent_grovebow:IsPurgeException()
	return false
end
function modifier_woda_talent_grovebow:RemoveOnDeath()
	return false
end
