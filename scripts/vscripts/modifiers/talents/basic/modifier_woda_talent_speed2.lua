...
function modifier_woda_talent_speed2:IsHidden()
	return true
end
function modifier_woda_talent_speed2:IsPurgable()
	return false
end
function modifier_woda_talent_speed2:IsPurgeException()
	return false
end
function modifier_woda_talent_speed2:RemoveOnDeath()
	return false
end
