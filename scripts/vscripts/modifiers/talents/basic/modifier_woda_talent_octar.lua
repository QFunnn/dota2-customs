...
function modifier_woda_talent_octar:IsHidden()
	return true
end
function modifier_woda_talent_octar:IsPurgable()
	return false
end
function modifier_woda_talent_octar:IsPurgeException()
	return false
end
function modifier_woda_talent_octar:RemoveOnDeath()
	return false
end
