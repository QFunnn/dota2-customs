...
function modifier_woda_talent_agi6:IsHidden()
	return true
end
function modifier_woda_talent_agi6:IsPurgable()
	return false
end
function modifier_woda_talent_agi6:IsPurgeException()
	return false
end
function modifier_woda_talent_agi6:RemoveOnDeath()
	return false
end
...
function modifier_woda_talent_agi6:OnCreated()
	...
	if
		self:GetParent():HasModifier("modifier_woda_talent_str6")
