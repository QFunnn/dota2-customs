...
function modifier_oracle_1:IsHidden()
	return true
end
function modifier_oracle_1:IsPurgable()
	return false
end
function modifier_oracle_1:IsPurgeException()
	return false
end
function modifier_oracle_1:RemoveOnDeath()
	return false
end
