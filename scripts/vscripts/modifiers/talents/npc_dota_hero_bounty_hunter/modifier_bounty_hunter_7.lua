...
LinkLuaModifier(
	"modifier_bounty_hunter_7_armor",
	"modifiers/talents/npc_dota_hero_bounty_hunter/modifier_bounty_hunter_7",
	LUA_MODIFIER_MOTION_NONE
)

modifier_bounty_hunter_7 = class({})

function modifier_bounty_hunter_7:IsHidden()
	return true
end
function modifier_bounty_hunter_7:IsPurgable()
	return false
end
function modifier_bounty_hunter_7:IsPurgeException()
	return false
end
function modifier_bounty_hunter_7:RemoveOnDeath()
	return false
end
