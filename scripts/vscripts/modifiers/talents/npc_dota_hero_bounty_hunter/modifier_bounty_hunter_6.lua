...
function modifier_bounty_hunter_6:IsHidden()
	return true
end
function modifier_bounty_hunter_6:IsPurgable()
	return false
end
function modifier_bounty_hunter_6:IsPurgeException()
	return false
end
function modifier_bounty_hunter_6:RemoveOnDeath()
	return false
end
