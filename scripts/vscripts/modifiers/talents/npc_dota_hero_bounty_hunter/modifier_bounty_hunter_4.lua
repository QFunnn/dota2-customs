...
function modifier_bounty_hunter_4:IsHidden()
	return true
end
function modifier_bounty_hunter_4:IsPurgable()
	return false
end
function modifier_bounty_hunter_4:IsPurgeException()
	return false
end
function modifier_bounty_hunter_4:RemoveOnDeath()
	return false
end
...
function modifier_bounty_hunter_4:OnDeath(params)
	...
	if not params.unit:IsNeutralUnitType() then
		return
	end
