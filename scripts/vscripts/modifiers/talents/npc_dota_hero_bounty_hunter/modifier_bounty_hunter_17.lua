...
function modifier_bounty_hunter_17:IsHidden()
	return true
end
function modifier_bounty_hunter_17:IsPurgable()
	return false
end
function modifier_bounty_hunter_17:IsPurgeException()
	return false
end
function modifier_bounty_hunter_17:RemoveOnDeath()
	return false
end
