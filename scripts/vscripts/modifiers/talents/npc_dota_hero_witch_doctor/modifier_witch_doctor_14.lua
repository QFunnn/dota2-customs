...
function modifier_witch_doctor_14:IsHidden()
	return true
end
function modifier_witch_doctor_14:IsPurgable()
	return false
end
function modifier_witch_doctor_14:IsPurgeException()
	return false
end
function modifier_witch_doctor_14:RemoveOnDeath()
	return false
end
