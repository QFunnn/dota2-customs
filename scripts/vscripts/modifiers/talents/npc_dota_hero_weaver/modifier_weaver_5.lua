...
function modifier_weaver_5:IsHidden()
	return true
end
function modifier_weaver_5:IsPurgable()
	return false
end
function modifier_weaver_5:IsPurgeException()
	return false
end
function modifier_weaver_5:RemoveOnDeath()
	return false
end
