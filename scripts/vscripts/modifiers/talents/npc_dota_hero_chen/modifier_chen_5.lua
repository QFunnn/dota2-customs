...
LinkLuaModifier(
	"modifier_modifier_chen_5_armor",
	"modifiers/talents/npc_dota_hero_chen/modifier_chen_5",
	LUA_MODIFIER_MOTION_NONE
)

modifier_chen_5 = class({})

function modifier_chen_5:IsHidden()
	return true
end
function modifier_chen_5:IsPurgable()
	return false
end
function modifier_chen_5:IsPurgeException()
	return false
end
function modifier_chen_5:RemoveOnDeath()
	return false
end
