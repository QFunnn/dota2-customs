...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_chen/modifier_chen_1",
	LUA_MODIFIER_MOTION_NONE
)

modifier_chen_1 = class({})

function modifier_chen_1:IsHidden()
	return true
end
function modifier_chen_1:IsPurgable()
	return false
end
function modifier_chen_1:IsPurgeException()
	return false
end
function modifier_chen_1:RemoveOnDeath()
	return false
end
...
function modifier_chen_1_buff:IsPurgable()
	return false
end
function modifier_chen_1_buff:IsPurgeException()
	return false
end
function modifier_chen_1_buff:RemoveOnDeath()
	return false
end
