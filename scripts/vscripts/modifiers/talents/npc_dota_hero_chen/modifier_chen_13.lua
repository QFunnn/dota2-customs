...
LinkLuaModifier(
	"modifier_modifier_chen_13_movespeed",
	"modifiers/talents/npc_dota_hero_chen/modifier_chen_13",
	LUA_MODIFIER_MOTION_NONE
)

modifier_chen_13 = class({})

function modifier_chen_13:IsHidden()
	return true
end
function modifier_chen_13:IsPurgable()
	return false
end
function modifier_chen_13:IsPurgeException()
	return false
end
function modifier_chen_13:RemoveOnDeath()
	return false
end
