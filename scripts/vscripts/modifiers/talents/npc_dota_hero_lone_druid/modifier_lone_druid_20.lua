...
function modifier_lone_druid_20:IsHidden()
	return true
end
function modifier_lone_druid_20:IsPurgable()
	return false
end
function modifier_lone_druid_20:IsPurgeException()
	return false
end
function modifier_lone_druid_20:RemoveOnDeath()
	return false
end
...
function modifier_lone_druid_20:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "lone_druid_entangle"
		and data.ability_special_value == "root_heroes_on_cast"
	then
		return 1
	end
	...
	if
		data.ability:GetAbilityName() == "lone_druid_entangle"
		and data.ability_special_value == "nostack_protection"
	then
		return 1
	end
