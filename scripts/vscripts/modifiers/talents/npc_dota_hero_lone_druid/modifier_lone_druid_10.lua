...
function modifier_lone_druid_10:IsHidden()
	return false
end
function modifier_lone_druid_10:IsPurgable()
	return false
end
function modifier_lone_druid_10:IsPurgeException()
	return false
end
function modifier_lone_druid_10:RemoveOnDeath()
	return false
end
...
function modifier_lone_druid_10:GetModifierHealthBonus()
	if self.bonus2 == nil and self:GetStackCount() == 0 then
		return
	end
...
function modifier_lone_druid_10:GetModifierMagicalResistanceBonus()
	if self.bonus3 == nil and self:GetStackCount() == 0 then
		return
	end
...
function modifier_lone_druid_10:GetTexture()
	return "lone_druid_10"
end