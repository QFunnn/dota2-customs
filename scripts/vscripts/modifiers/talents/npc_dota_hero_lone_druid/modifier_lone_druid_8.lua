...
function modifier_lone_druid_8:IsHidden()
	return false
end
function modifier_lone_druid_8:IsPurgable()
	return false
end
function modifier_lone_druid_8:IsPurgeException()
	return false
end
function modifier_lone_druid_8:RemoveOnDeath()
	return false
end
