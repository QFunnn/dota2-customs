...
function modifier_lone_druid_9:IsHidden()
	return true
end
function modifier_lone_druid_9:IsPurgable()
	return false
end
function modifier_lone_druid_9:IsPurgeException()
	return false
end
function modifier_lone_druid_9:RemoveOnDeath()
	return false
end
...
function modifier_lone_druid_9:OnIntervalThink()
	...
	local modifier_lone_druid_spirit_bear_entangle = self:GetParent()
		:FindModifierByName("modifier_lone_druid_spirit_bear_entangle")
	...
	if not self:GetParent():HasModifier("modifier_lone_druid_spirit_bear_entangle") then
		self:GetParent()
			:AddNewModifier(self:GetParent(), lone_druid_entangle, "modifier_lone_druid_spirit_bear_entangle", {})
	end
	local modifier_lone_druid_spirit_bear_entangle_vfx =
		self:GetParent():FindModifierByName("modifier_lone_druid_spirit_bear_entangle_vfx")
	if
		modifier_lone_druid_spirit_bear_entangle_vfx
		and modifier_lone_druid_spirit_bear_entangle_vfx:GetRemainingTime() > 1
	then
	...
	if not self:GetParent():HasModifier("modifier_lone_druid_spirit_bear_entangle_vfx") then
		self:GetParent()
			:AddNewModifier(self:GetParent(), lone_druid_entangle, "modifier_lone_druid_spirit_bear_entangle_vfx", {})
	end
end
