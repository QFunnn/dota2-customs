...
function modifier_lone_druid_5:IsHidden()
	return true
end
function modifier_lone_druid_5:IsPurgable()
	return false
end
function modifier_lone_druid_5:IsPurgeException()
	return false
end
function modifier_lone_druid_5:RemoveOnDeath()
	return false
end
