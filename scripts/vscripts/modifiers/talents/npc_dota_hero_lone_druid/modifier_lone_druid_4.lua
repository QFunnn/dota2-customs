...
function modifier_lone_druid_4:IsHidden()
	return true
end
function modifier_lone_druid_4:IsPurgable()
	return false
end
function modifier_lone_druid_4:IsPurgeException()
	return false
end
function modifier_lone_druid_4:RemoveOnDeath()
	return false
end
