...
function modifier_crystal_maiden_15:IsHidden()
	return true
end
function modifier_crystal_maiden_15:IsPurgable()
	return false
end
function modifier_crystal_maiden_15:IsPurgeException()
	return false
end
function modifier_crystal_maiden_15:RemoveOnDeath()
	return false
end
