...
LinkLuaModifier(
	"modifier_crystal_maiden_arcane_aura_custom_talent_frost_mind",
	"heroes/npc_dota_hero_crystal_maiden_custom/crystal_maiden_arcane_aura_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)

modifier_crystal_maiden_20 = class({})

function modifier_crystal_maiden_20:IsHidden()
	return true
end
function modifier_crystal_maiden_20:IsPurgable()
	return false
end
function modifier_crystal_maiden_20:IsPurgeException()
	return false
end
function modifier_crystal_maiden_20:RemoveOnDeath()
	return false
end
	...
	if IsServer() then
		...
		if self:GetParent():HasModifier("modifier_crystal_maiden_20") and ability then
			self:GetParent():AddNewModifier(
				...
				ability,
				"modifier_crystal_maiden_arcane_aura_custom_talent_frost_mind",
				{ duration = ability.modifier_crystal_maiden_20_duration[self:GetStackCount()] }
			)
		end
	end
	return 0
