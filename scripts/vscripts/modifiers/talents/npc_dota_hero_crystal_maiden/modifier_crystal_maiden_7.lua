...
function modifier_crystal_maiden_7:IsHidden()
	return true
end
function modifier_crystal_maiden_7:IsPurgable()
	return false
end
function modifier_crystal_maiden_7:IsPurgeException()
	return false
end
function modifier_crystal_maiden_7:RemoveOnDeath()
	return false
end
...
function modifier_crystal_maiden_7:OnCreated()
	...
	local modifier_crystal_maiden_arcane_aura_custom_talent_shield =
		self:GetParent():FindModifierByName("modifier_crystal_maiden_arcane_aura_custom_talent_shield")
