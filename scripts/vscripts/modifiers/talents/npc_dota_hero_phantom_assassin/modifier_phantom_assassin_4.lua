...
function modifier_phantom_assassin_4:IsHidden()
	return true
end
function modifier_phantom_assassin_4:IsPurgable()
	return false
end
function modifier_phantom_assassin_4:IsPurgeException()
	return false
end
function modifier_phantom_assassin_4:RemoveOnDeath()
	return false
end
