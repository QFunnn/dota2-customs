...
function modifier_phantom_assassin_2:RemoveOnDeath()
	return false
end
...
function modifier_phantom_assassin_2:OnCreated()
	...
	local phantom_assassin_stifling_dagger_custom = self:GetParent()
		:FindAbilityByName("phantom_assassin_stifling_dagger_custom")
