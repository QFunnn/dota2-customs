...
function modifier_phantom_assassin_12:IsHidden()
	return true
end
function modifier_phantom_assassin_12:IsPurgable()
	return false
end
function modifier_phantom_assassin_12:IsPurgeException()
	return false
end
function modifier_phantom_assassin_12:RemoveOnDeath()
	return false
end
...
function modifier_phantom_assassin_12:OnCreated()
	...
	Timers:CreateTimer(0.1, function()
		local modifier_phantom_assassin_immaterial = self:GetParent()
			:FindModifierByName("modifier_phantom_assassin_immaterial")
