...
LinkLuaModifier(
	"modifier_phantom_assassin_1_armor",
	"modifiers/talents/npc_dota_hero_phantom_assassin/modifier_phantom_assassin_1",
...
function modifier_phantom_assassin_1:RemoveOnDeath()
	return false
end
