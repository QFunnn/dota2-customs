...
function modifier_phantom_assassin_13:IsHidden()
	return true
end
function modifier_phantom_assassin_13:IsPurgable()
	return false
end
function modifier_phantom_assassin_13:IsPurgeException()
	return false
end
function modifier_phantom_assassin_13:RemoveOnDeath()
	return false
end
