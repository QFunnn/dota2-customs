...
function modifier_phantom_assassin_6:IsHidden()
	return true
end
function modifier_phantom_assassin_6:IsPurgable()
	return false
end
function modifier_phantom_assassin_6:IsPurgeException()
	return false
end
function modifier_phantom_assassin_6:RemoveOnDeath()
	return false
end
