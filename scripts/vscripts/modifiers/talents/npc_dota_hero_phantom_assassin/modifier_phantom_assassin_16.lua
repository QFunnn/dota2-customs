...
function modifier_phantom_assassin_16:IsHidden()
	return true
end
function modifier_phantom_assassin_16:IsPurgable()
	return false
end
function modifier_phantom_assassin_16:IsPurgeException()
	return false
end
function modifier_phantom_assassin_16:RemoveOnDeath()
	return false
end
...
function modifier_phantom_assassin_16:OnCreated()
	...
	local phantom_assassin_fan_of_knives_custom = self:GetParent()
		:FindAbilityByName("phantom_assassin_fan_of_knives_custom")
