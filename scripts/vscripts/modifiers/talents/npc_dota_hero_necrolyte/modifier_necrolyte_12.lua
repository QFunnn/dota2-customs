...
LinkLuaModifier(
	"modifier_necrolyte_12_debuff",
	"modifiers/talents/npc_dota_hero_necrolyte/modifier_necrolyte_12",
	LUA_MODIFIER_MOTION_NONE
)

modifier_necrolyte_12 = class({})

function modifier_necrolyte_12:IsHidden()
	return true
end
function modifier_necrolyte_12:IsPurgable()
	return false
end
function modifier_necrolyte_12:IsPurgeException()
	return false
end
function modifier_necrolyte_12:RemoveOnDeath()
	return false
end
...
function modifier_necrolyte_12_debuff:IsPurgable()
	return false
end
function modifier_necrolyte_12_debuff:GetAttributes()
...
function modifier_necrolyte_12_debuff:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/necrolyte_scythe_start_custom.vpcf",
...
function modifier_necrolyte_12_debuff:OnDestroy()
	...
	local damage = self:GetCaster():GetAgility()
		/ 100
		* agility_damage[self:GetCaster():GetTalentLevel("modifier_necrolyte_12")]
	ApplyDamage({
		victim = self:GetParent(),
		attacker = self:GetCaster(),
		damage = damage,
		damage_type = DAMAGE_TYPE_PHYSICAL,
		ability = necrolyte_reapers_scythe_custom,
	})
