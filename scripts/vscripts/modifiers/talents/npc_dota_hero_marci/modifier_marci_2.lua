...
function modifier_marci_2:IsHidden()
	return true
end
function modifier_marci_2:IsPurgable()
	return false
end
function modifier_marci_2:IsPurgeException()
	return false
end
function modifier_marci_2:RemoveOnDeath()
	return false
end
