...
function modifier_marci_14:IsHidden()
	return true
end
function modifier_marci_14:IsPurgable()
	return false
end
function modifier_marci_14:IsPurgeException()
	return false
end
function modifier_marci_14:RemoveOnDeath()
	return false
end
...
function modifier_marci_14:OnCreated()
	...
	if self:GetParent():HasModifier("modifier_marci_15") then
		return
	end
