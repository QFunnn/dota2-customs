...
LinkLuaModifier(
	"modifier_marci_21_debuff",
	"modifiers/talents/npc_dota_hero_marci/modifier_marci_21",
	LUA_MODIFIER_MOTION_NONE
)

modifier_marci_21 = class({})

function modifier_marci_21:IsHidden()
	return true
end
function modifier_marci_21:IsPurgable()
	return false
end
function modifier_marci_21:IsPurgeException()
	return false
end
function modifier_marci_21:RemoveOnDeath()
	return false
end
...
function modifier_marci_21_debuff:GetTexture()
	return "marci_21"
end
