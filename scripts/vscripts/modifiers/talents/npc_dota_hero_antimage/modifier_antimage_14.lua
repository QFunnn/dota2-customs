...
LinkLuaModifier(
	"modifier_antimage_14_aura",
	"modifiers/talents/npc_dota_hero_antimage/modifier_antimage_14",
	LUA_MODIFIER_MOTION_NONE
)

modifier_antimage_14 = class({})

function modifier_antimage_14:IsHidden()
	return true
end
function modifier_antimage_14:IsPurgable()
	return false
end
function modifier_antimage_14:IsPurgeException()
	return false
end
function modifier_antimage_14:RemoveOnDeath()
	return false
end
