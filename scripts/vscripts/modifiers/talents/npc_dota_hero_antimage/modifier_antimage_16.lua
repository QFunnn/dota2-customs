...
LinkLuaModifier(
	"modifier_antimage_16_buff",
	"modifiers/talents/npc_dota_hero_antimage/modifier_antimage_16",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_antimage_16_buff_stack",
	"modifiers/talents/npc_dota_hero_antimage/modifier_antimage_16",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_antimage_16:IsHidden()
	return true
end
function modifier_antimage_16:IsPurgable()
	return false
end
function modifier_antimage_16:IsPurgeException()
	return false
end
function modifier_antimage_16:RemoveOnDeath()
	return false
end
...
function modifier_antimage_16:OnAttackLanded(params)
	...
	self:GetParent():AddNewModifier(
		...
		nil,
		"modifier_antimage_16_buff",
		{ duration = self.duration[self:GetStackCount()] }
	)
	self:GetParent():AddNewModifier(
		self:GetParent(),
		nil,
		"modifier_antimage_16_buff_stack",
		{ duration = self.duration[self:GetStackCount()], mana = mana_bonus[self:GetStackCount()] }
	)
end

modifier_antimage_16_buff = class({})
function modifier_antimage_16_buff:GetTexture()
	return "antimage_16"
end
function modifier_antimage_16_buff:IsPurgable()
	return false
end
...
function modifier_antimage_16_buff_stack:IsHidden()
	return true
end
function modifier_antimage_16_buff_stack:IsPurgable()
	return false
end
function modifier_antimage_16_buff_stack:GetAttributes()
