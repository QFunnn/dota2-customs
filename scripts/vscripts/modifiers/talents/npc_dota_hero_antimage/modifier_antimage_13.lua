...
function modifier_antimage_13:IsHidden()
	return true
end
function modifier_antimage_13:IsPurgable()
	return false
end
function modifier_antimage_13:IsPurgeException()
	return false
end
function modifier_antimage_13:RemoveOnDeath()
	return false
end
