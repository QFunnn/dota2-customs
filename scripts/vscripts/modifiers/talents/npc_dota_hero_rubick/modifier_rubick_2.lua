...
function modifier_rubick_2:IsHidden()
	return true
end
function modifier_rubick_2:IsPurgable()
	return false
end
function modifier_rubick_2:IsPurgeException()
	return false
end
function modifier_rubick_2:RemoveOnDeath()
	return false
end
...
function modifier_rubick_2:OnCreated()
	...
	local modifier_rubick_spell_steal_custom_scepter = self:GetParent()
		:FindModifierByName("modifier_rubick_spell_steal_custom_scepter")
