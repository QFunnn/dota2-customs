...
function modifier_arc_warden_1:IsHidden()
	return true
end
function modifier_arc_warden_1:IsPurgable()
	return false
end
function modifier_arc_warden_1:IsPurgeException()
	return false
end
function modifier_arc_warden_1:RemoveOnDeath()
	return false
end
