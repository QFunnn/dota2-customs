...
function modifier_arc_warden_16:IsHidden()
	return true
end
function modifier_arc_warden_16:IsPurgable()
	return false
end
function modifier_arc_warden_16:IsPurgeException()
	return false
end
function modifier_arc_warden_16:RemoveOnDeath()
	return false
end
