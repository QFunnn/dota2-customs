...
function modifier_spectre_14:IsHidden()
	return true
end
function modifier_spectre_14:IsPurgable()
	return false
end
function modifier_spectre_14:IsPurgeException()
	return false
end
function modifier_spectre_14:RemoveOnDeath()
	return false
end
...
function modifier_spectre_14:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "spectre_shadow_step_custom"
