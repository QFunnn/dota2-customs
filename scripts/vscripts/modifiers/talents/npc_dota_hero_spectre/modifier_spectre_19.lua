...
function modifier_spectre_19:IsHidden()
	return true
end
function modifier_spectre_19:IsPurgable()
	return false
end
function modifier_spectre_19:IsPurgeException()
	return false
end
function modifier_spectre_19:RemoveOnDeath()
	return false
end
