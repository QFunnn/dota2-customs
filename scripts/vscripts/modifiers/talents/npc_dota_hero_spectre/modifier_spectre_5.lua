...
LinkLuaModifier(
	"modifier_spectre_5_aura",
	"modifiers/talents/npc_dota_hero_spectre/modifier_spectre_5",
	LUA_MODIFIER_MOTION_NONE
)

modifier_spectre_5 = class({})

function modifier_spectre_5:IsHidden()
	return true
end
function modifier_spectre_5:IsPurgable()
	return false
end
function modifier_spectre_5:IsPurgeException()
	return false
end
function modifier_spectre_5:RemoveOnDeath()
	return false
end
...
function modifier_spectre_5_aura:GetTexture()
	return "spectre_5"
end
