...
function modifier_nyx_assassin_21:IsHidden()
	return true
end
function modifier_nyx_assassin_21:IsPurgable()
	return false
end
function modifier_nyx_assassin_21:IsPurgeException()
	return false
end
function modifier_nyx_assassin_21:RemoveOnDeath()
	return false
end
...
function modifier_nyx_assassin_21:OnAttackLanded(params)
	...
	local dagon_pfx =
		ParticleManager:CreateParticle("particles/items_fx/dagon.vpcf", PATTACH_RENDERORIGIN_FOLLOW, self:GetParent())
