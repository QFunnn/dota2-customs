...
LinkLuaModifier(
	"modifier_nyx_assassin_14_buff",
	"modifiers/talents/npc_dota_hero_nyx_assassin/modifier_nyx_assassin_14",
	LUA_MODIFIER_MOTION_NONE
)

modifier_nyx_assassin_14 = class({})

function modifier_nyx_assassin_14:IsHidden()
	return true
end
function modifier_nyx_assassin_14:IsPurgable()
	return false
end
function modifier_nyx_assassin_14:IsPurgeException()
	return false
end
function modifier_nyx_assassin_14:RemoveOnDeath()
	return false
end
