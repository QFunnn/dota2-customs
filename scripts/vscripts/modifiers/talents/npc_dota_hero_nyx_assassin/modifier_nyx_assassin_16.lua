...
function modifier_nyx_assassin_16:IsHidden()
	return true
end
function modifier_nyx_assassin_16:IsPurgable()
	return false
end
function modifier_nyx_assassin_16:IsPurgeException()
	return false
end
function modifier_nyx_assassin_16:RemoveOnDeath()
	return false
end
