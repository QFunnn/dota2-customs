...
function modifier_keeper_of_the_light_16:IsHidden()
	return true
end
function modifier_keeper_of_the_light_16:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_16:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_16:RemoveOnDeath()
	return false
end
...
function modifier_keeper_of_the_light_16:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "keeper_of_the_light_radiant_bind"
		and data.ability_special_value == "magic_resistance"
	then
		return 1
	end
end
