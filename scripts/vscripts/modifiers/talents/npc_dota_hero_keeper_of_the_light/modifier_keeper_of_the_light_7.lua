...
function modifier_keeper_of_the_light_7:IsHidden()
	return true
end
function modifier_keeper_of_the_light_7:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_7:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_7:RemoveOnDeath()
	return false
end
...
function modifier_keeper_of_the_light_7:OnCreated()
	...
	if self:GetParent():HasModifier("modifier_keeper_of_the_light_8") then
		return
	end
