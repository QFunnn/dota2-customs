...
function modifier_keeper_of_the_light_4:IsHidden()
	return true
end
function modifier_keeper_of_the_light_4:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_4:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_4:RemoveOnDeath()
	return false
end
