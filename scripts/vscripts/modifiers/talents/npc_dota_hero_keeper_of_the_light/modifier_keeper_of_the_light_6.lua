...
function modifier_keeper_of_the_light_6:IsHidden()
	return true
end
function modifier_keeper_of_the_light_6:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_6:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_6:RemoveOnDeath()
	return false
end
...
function modifier_keeper_of_the_light_6:OnCreated()
	...
	self:GetCaster()
		:SwapAbilities("keeper_of_the_light_blinding_light_custom", "keeper_of_the_light_blinding_dark", false, true)
	local keeper_of_the_light_blinding_light_custom = self:GetCaster()
		:FindAbilityByName("keeper_of_the_light_blinding_light_custom")
