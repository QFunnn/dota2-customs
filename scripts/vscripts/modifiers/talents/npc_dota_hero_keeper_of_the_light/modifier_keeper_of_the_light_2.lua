...
function modifier_keeper_of_the_light_2:IsHidden()
	return true
end
function modifier_keeper_of_the_light_2:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_2:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_2:RemoveOnDeath()
	return false
end
...
function modifier_keeper_of_the_light_2:OnCreated()
	...
	self:GetCaster()
		:SwapAbilities("keeper_of_the_light_spirit_form_custom", "keeper_of_the_light_dark_form", false, true)
	local keeper_of_the_light_spirit_form_custom = self:GetCaster()
		:FindAbilityByName("keeper_of_the_light_spirit_form_custom")
