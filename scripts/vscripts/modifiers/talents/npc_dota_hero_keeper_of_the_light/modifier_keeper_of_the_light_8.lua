...
function modifier_keeper_of_the_light_8:IsHidden()
	return true
end
function modifier_keeper_of_the_light_8:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_8:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_8:RemoveOnDeath()
	return false
end
