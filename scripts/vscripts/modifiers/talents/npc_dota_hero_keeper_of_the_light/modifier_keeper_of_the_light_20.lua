...
function modifier_keeper_of_the_light_20:IsHidden()
	return true
end
function modifier_keeper_of_the_light_20:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_20:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_20:RemoveOnDeath()
	return false
end
