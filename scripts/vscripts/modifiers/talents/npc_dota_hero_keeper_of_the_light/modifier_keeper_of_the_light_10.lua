...
function modifier_keeper_of_the_light_10:IsHidden()
	return true
end
function modifier_keeper_of_the_light_10:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_10:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_10:RemoveOnDeath()
	return false
end
