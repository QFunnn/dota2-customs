...
function modifier_keeper_of_the_light_3:IsHidden()
	return true
end
function modifier_keeper_of_the_light_3:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_3:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_3:RemoveOnDeath()
	return false
end
...
function modifier_keeper_of_the_light_3:OnCreated()
	...
	self:GetCaster()
		:SwapAbilities("keeper_of_the_light_chakra_magic_custom", "keeper_of_the_light_dark_magic", false, true)
	local keeper_of_the_light_chakra_magic_custom = self:GetCaster()
		:FindAbilityByName("keeper_of_the_light_chakra_magic_custom")
