...
function modifier_nevermore_9:IsHidden()
	return true
end
function modifier_nevermore_9:IsPurgable()
	return false
end
function modifier_nevermore_9:IsPurgeException()
	return false
end
function modifier_nevermore_9:RemoveOnDeath()
	return false
end
