...
function modifier_nevermore_4:IsHidden()
	return true
end
function modifier_nevermore_4:IsPurgable()
	return false
end
function modifier_nevermore_4:IsPurgeException()
	return false
end
function modifier_nevermore_4:RemoveOnDeath()
	return false
end
