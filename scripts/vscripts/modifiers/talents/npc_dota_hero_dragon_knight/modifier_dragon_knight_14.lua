...
function modifier_dragon_knight_14:IsHidden()
	return true
end
function modifier_dragon_knight_14:IsPurgable()
	return false
end
function modifier_dragon_knight_14:IsPurgeException()
	return false
end
function modifier_dragon_knight_14:RemoveOnDeath()
	return false
end
