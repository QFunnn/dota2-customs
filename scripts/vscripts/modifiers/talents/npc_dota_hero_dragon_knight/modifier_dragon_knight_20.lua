...
function modifier_dragon_knight_20:IsHidden()
	return true
end
function modifier_dragon_knight_20:IsPurgable()
	return false
end
function modifier_dragon_knight_20:IsPurgeException()
	return false
end
function modifier_dragon_knight_20:RemoveOnDeath()
	return false
end
