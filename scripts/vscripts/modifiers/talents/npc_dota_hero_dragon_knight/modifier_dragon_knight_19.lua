...
LinkLuaModifier(
	"modifier_dragon_knight_19_debuff",
	"modifiers/talents/npc_dota_hero_dragon_knight/modifier_dragon_knight_19",
	LUA_MODIFIER_MOTION_NONE
)

modifier_dragon_knight_19 = class({})

function modifier_dragon_knight_19:IsHidden()
	return true
end
function modifier_dragon_knight_19:IsPurgable()
	return false
end
function modifier_dragon_knight_19:IsPurgeException()
	return false
end
function modifier_dragon_knight_19:RemoveOnDeath()
	return false
end
...
function modifier_dragon_knight_19_debuff:GetTexture()
	return "dragon_knight_19"
end
