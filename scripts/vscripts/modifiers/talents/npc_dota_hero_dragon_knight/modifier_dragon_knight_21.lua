...
LinkLuaModifier(
	"modifier_dragon_knight_21_debuff",
	"modifiers/talents/npc_dota_hero_dragon_knight/modifier_dragon_knight_21",
	LUA_MODIFIER_MOTION_NONE
)

modifier_dragon_knight_21 = class({})

function modifier_dragon_knight_21:IsHidden()
	return true
end
function modifier_dragon_knight_21:IsPurgable()
	return false
end
function modifier_dragon_knight_21:IsPurgeException()
	return false
end
function modifier_dragon_knight_21:RemoveOnDeath()
	return false
end
...
function modifier_dragon_knight_21:OnCreated()
	...
	local dragon_knight_elder_dragon_form_custom = self:GetParent()
...
function modifier_dragon_knight_21:OnIntervalThink()
	...
	local mod_name = "modifier_dragon_knight_elder_dragon_form_custom_3"
	if self:GetParent():HasModifier(mod_name) then
		return
	end
...
function modifier_dragon_knight_21_debuff:GetTexture()
	return "dk_spell_debuff"
end
