...
LinkLuaModifier(
	"modifier_naga_siren_13_debuff",
	"modifiers/talents/npc_dota_hero_naga_siren/modifier_naga_siren_13",
	LUA_MODIFIER_MOTION_NONE
)

modifier_naga_siren_13 = class({})

function modifier_naga_siren_13:IsHidden()
	return true
end
function modifier_naga_siren_13:IsPurgable()
	return false
end
function modifier_naga_siren_13:IsPurgeException()
	return false
end
function modifier_naga_siren_13:RemoveOnDeath()
	return false
end
...
function modifier_naga_siren_13_debuff:GetTexture()
	return "naga_siren_13"
end
