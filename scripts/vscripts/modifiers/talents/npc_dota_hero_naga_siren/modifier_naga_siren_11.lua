...
LinkLuaModifier(
	"modifier_naga_siren_11_aura",
	"modifiers/talents/npc_dota_hero_naga_siren/modifier_naga_siren_11",
	LUA_MODIFIER_MOTION_NONE
)

modifier_naga_siren_11 = class({})

function modifier_naga_siren_11:IsHidden()
	return true
end
function modifier_naga_siren_11:IsPurgable()
	return false
end
function modifier_naga_siren_11:IsPurgeException()
	return false
end
function modifier_naga_siren_11:RemoveOnDeath()
	return false
end
...
function modifier_naga_siren_11_aura:IsHidden()
	return true
end
