...
LinkLuaModifier(
	"modifier_naga_siren_16_buff",
	"modifiers/talents/npc_dota_hero_naga_siren/modifier_naga_siren_16",
	LUA_MODIFIER_MOTION_NONE
)

modifier_naga_siren_16 = class({})

function modifier_naga_siren_16:IsHidden()
	return true
end
function modifier_naga_siren_16:IsPurgable()
	return false
end
function modifier_naga_siren_16:IsPurgeException()
	return false
end
function modifier_naga_siren_16:RemoveOnDeath()
	return false
end
...
function modifier_naga_siren_16:OnCreated()
	...
	Timers:CreateTimer(1, function()
		if naga_siren_mirror_image_custom and naga_siren_mirror_image_custom:GetLevel() <= 0 then
			return 1
		end
...
function modifier_naga_siren_16:CreateIllusion()
	...
	local illusions = CreateIllusions(
		self:GetParent(),
		self:GetParent(),
		{ outgoing_damage = outgoing, incoming_damage = 0 },
		1,
		400,
		false,
		false
...
function modifier_naga_siren_16_buff:IsHidden()
	return true
end
function modifier_naga_siren_16_buff:IsPurgable()
	return false
end
function modifier_naga_siren_16_buff:IsPurgeException()
	return false
end
...
function modifier_naga_siren_16_buff:LeashToBucket()
	self.vLeashDestination = self.vInitialSpawnPos
		+ RandomVector(RandomInt(50, modifier_naga_siren_16_buff.WINTER2022_BUCKET_SOLDIER_MAINTAIN_RANGE))
...
function modifier_naga_siren_16_buff:FindBestTarget()
	local fSearchRadius = modifier_naga_siren_16_buff.WINTER2022_BUCKET_SOLDIER_AGGRO_RANGE
