...
function modifier_huskar_8:IsHidden()
	return true
end
function modifier_huskar_8:IsPurgable()
	return false
end
function modifier_huskar_8:IsPurgeException()
	return false
end
function modifier_huskar_8:RemoveOnDeath()
	return false
end
...
function modifier_huskar_8:OnCreated()
	...
	local modifier_huskar_berserkers_blood_custom = self:GetParent()
		:FindModifierByName("modifier_huskar_berserkers_blood_custom")
	if modifier_huskar_berserkers_blood_custom then
		modifier_huskar_berserkers_blood_custom:Destroy()
	end
	local huskar_berserkers_blood_reverse_custom = self:GetParent()
		:FindAbilityByName("huskar_berserkers_blood_reverse_custom")
	if huskar_berserkers_blood_reverse_custom then
		huskar_berserkers_blood_reverse_custom:SetLevel(self:GetStackCount())
	end
	self:GetParent()
		:SwapAbilities("huskar_berserkers_blood_custom", "huskar_berserkers_blood_reverse_custom", false, true)
end
