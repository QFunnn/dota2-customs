...
LinkLuaModifier(
	"modifier_huskar_4_buff",
	"modifiers/talents/npc_dota_hero_huskar/modifier_huskar_4",
	LUA_MODIFIER_MOTION_NONE
)

modifier_huskar_4 = class({})

function modifier_huskar_4:IsHidden()
	return true
end
function modifier_huskar_4:IsPurgable()
	return false
end
function modifier_huskar_4:IsPurgeException()
	return false
end
function modifier_huskar_4:RemoveOnDeath()
	return false
end
...
function modifier_huskar_4:OnAttackLanded(params)
	...
	if huskar_burning_spear_custom then
		...
		if modifier_huskar_4_buff == nil then
			modifier_huskar_4_buff = self:GetParent()
				:AddNewModifier(self:GetParent(), nil, "modifier_huskar_4_buff", {})
		end
...
function modifier_huskar_4_buff:IsPurgable()
	return false
end
function modifier_huskar_4_buff:IsPurgeException()
	return false
end
function modifier_huskar_4_buff:RemoveOnDeath()
	return false
end
function modifier_huskar_4_buff:GetTexture()
	return "huskar_4"
end