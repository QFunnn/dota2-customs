...
LinkLuaModifier(
	...
	"modifiers/talents/npc_dota_hero_huskar/modifier_huskar_1",
...
function modifier_huskar_1:RemoveOnDeath()
	return false
end
...
function modifier_huskar_1:GetMinHealth()
	...
	if self:GetParent():HasModifier("modifier_huskar_1_buff_cooldown") then
		return
	end
	return 1
end
...
function modifier_huskar_1:OnTakeDamage(params)
	...
	if self:GetParent():HasModifier("modifier_huskar_1_buff") then
		return
	end
	if self:GetParent():HasModifier("modifier_huskar_1_buff_cooldown") then
		return
	...
	self:GetParent():AddNewModifier(
		...
		self:GetAbility(),
		"modifier_huskar_1_buff_cooldown",
		{ duration = self.cooldown[self:GetStackCount()] }
	)
end

modifier_huskar_1_buff = class({})
function modifier_huskar_1_buff:GetEffectName()
	return "particles/helm_of_the_huskar.vpcf"
end
function modifier_huskar_1_buff:IsHidden()
	return false
end
function modifier_huskar_1_buff:IsPurgable()
	return false
end
function modifier_huskar_1_buff:GetTexture()
	return "huskar_1"
end
...
function modifier_huskar_1_buff_cooldown:IsHidden()
	return false
end
function modifier_huskar_1_buff_cooldown:IsPurgable()
	return false
end
function modifier_huskar_1_buff_cooldown:IsDebuff()
	return true
end
function modifier_huskar_1_buff_cooldown:RemoveOnDeath()
	return false
end
function modifier_huskar_1_buff_cooldown:GetTexture()
	return "huskar_1"
end