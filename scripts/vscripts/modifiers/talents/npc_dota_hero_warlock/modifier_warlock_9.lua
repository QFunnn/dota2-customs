...
function modifier_warlock_9:IsHidden()
	return true
end
function modifier_warlock_9:IsPurgable()
	return false
end
function modifier_warlock_9:IsPurgeException()
	return false
end
function modifier_warlock_9:RemoveOnDeath()
	return false
end
...
function modifier_warlock_9:OnCreated()
	...
	local warlock_permanent_immolation_custom = self:GetCaster()
		:FindAbilityByName("warlock_permanent_immolation_custom")
