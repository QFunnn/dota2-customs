...
function modifier_razor_2:IsHidden() return true end
function modifier_razor_2:IsPurgable() return false end
function modifier_razor_2:IsPurgeException() return false end
function modifier_razor_2:RemoveOnDeath() return false end
