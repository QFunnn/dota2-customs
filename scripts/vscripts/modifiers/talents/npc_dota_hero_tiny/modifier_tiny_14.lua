...
function modifier_tiny_14:IsHidden()
	return true
end
function modifier_tiny_14:IsPurgable()
	return false
end
function modifier_tiny_14:IsPurgeException()
	return false
end
function modifier_tiny_14:RemoveOnDeath()
	return false
end
