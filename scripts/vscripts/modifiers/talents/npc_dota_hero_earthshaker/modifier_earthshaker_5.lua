...
LinkLuaModifier(
	"modifier_modifier_earthshaker_5_armor",
	"modifiers/talents/npc_dota_hero_earthshaker/modifier_earthshaker_5",
	LUA_MODIFIER_MOTION_NONE
)

modifier_earthshaker_5 = class({})

function modifier_earthshaker_5:IsHidden()
	return true
end
function modifier_earthshaker_5:IsPurgable()
	return false
end
function modifier_earthshaker_5:IsPurgeException()
	return false
end
function modifier_earthshaker_5:RemoveOnDeath()
	return false
end
