...
function modifier_void_spirit_4:IsHidden()
	return true
end
function modifier_void_spirit_4:IsPurgable()
	return false
end
function modifier_void_spirit_4:IsPurgeException()
	return false
end
function modifier_void_spirit_4:RemoveOnDeath()
	return false
end
...
function modifier_void_spirit_4:OnCreated()
	...
	Timers:CreateTimer(0.1, function()
		local void_spirit_aether_remnant_custom = self:GetParent()
			:FindAbilityByName("void_spirit_aether_remnant_custom")
...
function modifier_void_spirit_4:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "void_spirit_aether_remnant_custom"
