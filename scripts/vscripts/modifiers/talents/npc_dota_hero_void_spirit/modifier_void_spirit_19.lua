...
function modifier_void_spirit_19:IsHidden()
	return true
end
function modifier_void_spirit_19:IsPurgable()
	return false
end
function modifier_void_spirit_19:IsPurgeException()
	return false
end
function modifier_void_spirit_19:RemoveOnDeath()
	return false
end
...
function modifier_void_spirit_19:OnCreated()
	...
	Timers:CreateTimer(0.1, function()
		local void_spirit_resonant_pulse_custom = self:GetParent()
			:FindAbilityByName("void_spirit_resonant_pulse_custom")
...
function modifier_void_spirit_19:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "void_spirit_resonant_pulse_custom"
