...
function modifier_dazzle_5:IsHidden()
	return true
end
function modifier_dazzle_5:IsPurgable()
	return false
end
function modifier_dazzle_5:IsPurgeException()
	return false
end
function modifier_dazzle_5:RemoveOnDeath()
	return false
end
