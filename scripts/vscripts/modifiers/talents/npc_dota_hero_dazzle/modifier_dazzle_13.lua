...
function modifier_dazzle_13:IsHidden()
	return true
end
function modifier_dazzle_13:IsPurgable()
	return false
end
function modifier_dazzle_13:IsPurgeException()
	return false
end
function modifier_dazzle_13:RemoveOnDeath()
	return false
end
...
function modifier_dazzle_13:OnTakeDamage(params)
	...
	if not self:GetParent():HasModifier("modifier_dazzle_nothl_projection_soul_clone") then
		return
	end
	if params.damage_category == DOTA_DAMAGE_CATEGORY_ATTACK then
		...
		then
			...
			local octarine = ParticleManager:CreateParticle(
