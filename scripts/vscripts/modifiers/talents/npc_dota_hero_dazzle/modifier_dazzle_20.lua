...
function modifier_dazzle_20:IsHidden()
	return true
end
function modifier_dazzle_20:IsPurgable()
	return false
end
function modifier_dazzle_20:IsPurgeException()
	return false
end
function modifier_dazzle_20:RemoveOnDeath()
	return false
end
