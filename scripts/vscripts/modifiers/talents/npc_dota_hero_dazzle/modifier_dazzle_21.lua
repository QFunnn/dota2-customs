...
function modifier_dazzle_21:IsHidden()
	return true
end
function modifier_dazzle_21:IsPurgable()
	return false
end
function modifier_dazzle_21:IsPurgeException()
	return false
end
function modifier_dazzle_21:RemoveOnDeath()
	return false
end
