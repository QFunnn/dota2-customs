...
function modifier_dazzle_14:IsHidden()
	return true
end
function modifier_dazzle_14:IsPurgable()
	return false
end
function modifier_dazzle_14:IsPurgeException()
	return false
end
function modifier_dazzle_14:RemoveOnDeath()
	return false
end
...
function modifier_dazzle_14:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "dazzle_nothl_projection"
		and data.ability_special_value == "castable_while_disabled"
	then
		return 1
	end
