...
function modifier_dazzle_1:IsHidden()
	return true
end
function modifier_dazzle_1:IsPurgable()
	return false
end
function modifier_dazzle_1:IsPurgeException()
	return false
end
function modifier_dazzle_1:RemoveOnDeath()
	return false
end
