...
function modifier_debug_creep_damage_tracker:IsHidden()
	return true
end
function modifier_debug_creep_damage_tracker:IsPurgable()
	return false
end
function modifier_debug_creep_damage_tracker:IsPurgeException()
	return false
end
function modifier_debug_creep_damage_tracker:IsPermanent()
	return true
end
function modifier_debug_creep_damage_tracker:RemoveOnDeath()
	return false
end
...
function modifier_debug_creep_damage_tracker:RecordAbilityDamage(key, amount)
	...
	if not self.ability_damage then
		self.ability_damage = {}
	end
