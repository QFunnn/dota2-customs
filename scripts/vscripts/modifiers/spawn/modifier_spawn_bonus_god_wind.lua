...
local a = "modifiers/spawn/modifier_spawn_bonus_god_wind"
...
function j.prototype.DeclareFunctions(self)
	return { MODIFIER_PROPERTY_VISUAL_Z_DELTA, MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS }
end
