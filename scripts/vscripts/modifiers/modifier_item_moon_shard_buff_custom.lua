...
function modifier_item_moon_shard_buff_custom:IsPurgable()
	return false
end
function modifier_item_moon_shard_buff_custom:IsHidden()
	return true
end
function modifier_item_moon_shard_buff_custom:IsPurgeException()
	return false
end
function modifier_item_moon_shard_buff_custom:RemoveOnDeath()
	return false
end
