...
function modifier_report_warning:GetTexture()
	return "punishment_warning"
end
function modifier_report_warning:IsHidden()
	return false
end
function modifier_report_warning:IsDebuff()
	return true
end
function modifier_report_warning:IsPurgable()
	return false
end
function modifier_report_warning:RemoveOnDeath()
	return false
end
function modifier_report_warning:GetAttributes()
