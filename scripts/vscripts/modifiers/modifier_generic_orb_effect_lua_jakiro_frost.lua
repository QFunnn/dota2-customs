...
function modifier_generic_orb_effect_lua_jakiro_frost:OnRefresh( kv )
end

function modifier_generic_orb_effect_lua_jakiro_frost:OnDestroy( kv )
...
function modifier_generic_orb_effect_lua_jakiro_frost:GetModifierProjectileName()
    ...
    local modifier_generic_orb_effect_lua_jakiro = self:GetParent():FindModifierByName("modifier_generic_orb_effect_lua_jakiro")
