...
function modifier_cha_vision:IsHidden()
	return true
end
function modifier_cha_vision:IsPurgeException()
	return false
end
function modifier_cha_vision:IsPurgable()
	return false
end
function modifier_cha_vision:RemoveOnDeath()
	return false
end
...
function modifier_cha_vision:OnIntervalThink()
	...
	CustomGameEventManager:Send_ServerToAllClients(
		"set_player_icon",
		{ entity = self.icon:entindex(), hero = self:GetCaster():entindex() }
	)
end
...
function modifier_cha_vision_icon:IsPurgable()
	return false
end
function modifier_cha_vision_icon:IsHidden()
	return true
end

function modifier_cha_vision_icon:CheckState()
	return {
		[MODIFIER_STATE_NOT_ON_MINIMAP] = (not self:GetCaster():IsAlive() or self:GetCaster():IsInvisible() or self
			:GetCaster()
			:IsNull()),
