...
local a = "modifiers/skin/modifier_5100045"
...
g.modifier_5100045 = c()
local k = g.modifier_5100045
k.name = "modifier_5100045"
d(k, i)
...
function k.prototype.OnIntervalThink(self)
	if IsServer() then
		if self.state then
			...
			self:GetParent():AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_5100045_trans", {})
		end
	end
...
g.modifier_5100045 = k
g.modifier_5100045_trans = c()
local m = g.modifier_5100045_trans
m.name = "modifier_5100045_trans"
d(m, i)
...
function m.prototype.GetModifierModelChange(self)
	return "models/eom/hero/muerta_2/muerta_3.vmdl"
end
