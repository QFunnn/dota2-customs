...
function modifier_events_thinker_woda:IsPurgable()
	return false
end
function modifier_events_thinker_woda:IsPurgeException()
	return false
end
function modifier_events_thinker_woda:RemoveOnDeath()
	return false
end
function modifier_events_thinker_woda:IsPurgeException()
	return false
...
function modifier_events_thinker_woda:OnAbilityFullyCast(params)
	...
	if params.ability and params.ability:GetAbilityName() == "twin_gate_portal_warp" then
		return
	end
	if params.unit then
