...
function modifier_rune_barrier:IsHidden()
	return true
end
function modifier_rune_barrier:IsPurgable()
	return false
end
function modifier_rune_barrier:IsPurgeException()
	return false
end
function modifier_rune_barrier:RemoveOnDeath()
	return false
end
...
function modifier_rune_barrier:OnIntervalThink()
	...
	if self:GetParent():HasModifier("modifier_rune_barrier_cooldown") then
		return
	end
...
function modifier_rune_barrier_cooldown:GetTexture()
	return "rune_barrier"
end
function modifier_rune_barrier_cooldown:IsPurgable()
	return false
end
function modifier_rune_barrier_cooldown:IsPurgeException()
	return false
end
function modifier_rune_barrier_cooldown:IsDebuff()
	return true
end
function modifier_rune_barrier_cooldown:RemoveOnDeath()
	return false
end

modifier_rune_barrier_barier = class({})
function modifier_rune_barrier_barier:IsPurgable()
	return false
end
function modifier_rune_barrier_barier:IsPurgeException()
	return false
end
function modifier_rune_barrier_barier:GetTexture()
	return "rune_barrier"
end
function modifier_rune_barrier_barier:IsHidden()
	return true
end
function modifier_rune_barrier_barier:OnCreated(kv)
	...
	self.max_shield = (self:GetParent():GetMaxMana() + self:GetParent():GetMaxHealth())
		/ 100
		* self.barrier[self:GetCaster():GetTalentLevel("modifier_rune_barrier")]
