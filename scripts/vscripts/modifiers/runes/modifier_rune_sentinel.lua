...
function modifier_rune_sentinel:IsHidden()
	return true
end
function modifier_rune_sentinel:IsPurgable()
	return false
end
function modifier_rune_sentinel:IsPurgeException()
	return false
end
function modifier_rune_sentinel:RemoveOnDeath()
	return false
end
function modifier_rune_sentinel:DeclareFunctions()
	return { MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE }
end
function modifier_rune_sentinel:OnCreated()
	if IsServer() then
		self:GetParent():CalculateStatBonus(true)
	end
end
function modifier_rune_sentinel:OnRefresh()
	if IsServer() then
		self:GetParent():CalculateStatBonus(true)
	end
end
