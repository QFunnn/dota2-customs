...
function modifier_rune_monk:IsHidden()
	return true
end
function modifier_rune_monk:IsPurgable()
	return false
end
function modifier_rune_monk:IsPurgeException()
	return false
end
function modifier_rune_monk:RemoveOnDeath()
	return false
end
function modifier_rune_monk:OnCreated()
	if IsServer() then
		self:GetParent():CalculateStatBonus(true)
	end
end
function modifier_rune_monk:OnRefresh()
	if IsServer() then
		self:GetParent():CalculateStatBonus(true)
	end
end
