...
function modifier_rune_strength:IsHidden()
	return true
end
function modifier_rune_strength:IsPurgable()
	return false
end
function modifier_rune_strength:IsPurgeException()
	return false
end
function modifier_rune_strength:RemoveOnDeath()
	return false
end
