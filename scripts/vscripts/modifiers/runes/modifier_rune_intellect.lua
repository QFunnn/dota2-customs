...
function modifier_rune_intellect:IsHidden()
	return true
end
function modifier_rune_intellect:IsPurgable()
	return false
end
function modifier_rune_intellect:IsPurgeException()
	return false
end
function modifier_rune_intellect:RemoveOnDeath()
	return false
end
