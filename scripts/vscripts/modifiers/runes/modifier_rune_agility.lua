...
function modifier_rune_agility:IsHidden()
	return true
end
function modifier_rune_agility:IsPurgable()
	return false
end
function modifier_rune_agility:IsPurgeException()
	return false
end
function modifier_rune_agility:RemoveOnDeath()
	return false
end
