...
function modifier_cashback_creep_count:IsHidden()
	return not self:GetParent():HasModifier("modifier_skill_cashback")
end
function modifier_cashback_creep_count:IsPurgable()
	return false
end
function modifier_cashback_creep_count:RemoveOnDeath()
	return false
end
function modifier_cashback_creep_count:AllowIllusionDuplicate()
	return true
end
...
function modifier_cashback_creep_count:GetModifierPreAttack_BonusDamage(params)
	if not self:GetParent():HasModifier("modifier_skill_cashback") then
		return
	end
