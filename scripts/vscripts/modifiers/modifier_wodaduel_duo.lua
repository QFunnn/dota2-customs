...
function modifier_wodaduel_duo:IsPurgable()
	return false
end
function modifier_wodaduel_duo:IsPurgeException()
	return false
end
function modifier_wodaduel_duo:IsHidden()
	return true
end
function modifier_wodaduel_duo:RemoveOnDeath()
	return false
end
