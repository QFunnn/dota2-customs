...
local a = "modifiers/city_effect/city_25"
...
g.modifier_city_25 = c()
local l = g.modifier_city_25
l.name = "modifier_city_25"
d(l, k)
...
function l.prototype.OnCreated(self, m)
	if IsServer() then
		RuneTask:setRuneRewardRefreshCost(self.gold)
	end
end
function l.prototype.OnDestroy(self)
	if IsServer() then
		RuneTask:setRuneRewardRefreshCost()
	end
end
l = e(
	{
