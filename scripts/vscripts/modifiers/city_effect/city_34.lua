...
local a = "modifiers/city_effect/city_34"
...
h.modifier_city_34 = c()
local n = h.modifier_city_34
n.name = "modifier_city_34"
d(n, m)
...
function n.prototype.OnCreated(self, o)
	if IsServer() then
		PlayerData:eachPlayer(function(p, q)
			...
			if IsValid(r) then
				local s = r:AddNewModifier(r, nil, "modifier_city_34_buff", nil)
				if IsValid(s) then
...
h.modifier_city_34 = n
h.modifier_city_34_buff = c()
local v = h.modifier_city_34_buff
v.name = "modifier_city_34_buff"
d(v, j)
