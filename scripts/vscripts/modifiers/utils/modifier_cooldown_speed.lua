...
function modifier_cooldown_speed:IsHidden()
	return true
end
function modifier_cooldown_speed:IsPurgable()
	return false
end
function modifier_cooldown_speed:RemoveOnDeath()
	return false
end
function modifier_cooldown_speed:GetAttributes()
