...
local a = "modifiers/utils/modifier_courier_path"
...
g.modifier_courier_path = c()
local k = g.modifier_courier_path
k.name = "modifier_courier_path"
d(k, i)
