...
function modifier_unranked_penalty_1:IsDebuff()
	return true
end
function modifier_unranked_penalty_1:RemoveOnDeath()
	return false
end
function modifier_unranked_penalty_1:GetTexture()
	return "buffs/generic/unranked_penalty"
end
...
function modifier_unranked_penalty_2:IsDebuff()
	return true
end
function modifier_unranked_penalty_2:RemoveOnDeath()
	return false
end
function modifier_unranked_penalty_2:GetTexture()
	return "buffs/generic/unranked_penalty"
end
...
function modifier_unranked_penalty_3:IsDebuff()
	return false
end
function modifier_unranked_penalty_3:RemoveOnDeath()
	return false
end
function modifier_unranked_penalty_3:GetTexture()
	return "buffs/generic/unranked_penalty"
end
