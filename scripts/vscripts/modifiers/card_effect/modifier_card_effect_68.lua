...
local a = "modifiers/card_effect/modifier_card_effect_68"
...
g.modifier_card_effect_68 = c()
local k = g.modifier_card_effect_68
k.name = "modifier_card_effect_68"
d(k, i)
...
function k.prototype.EOM_GetModifierEvasion_Bonus(self, l)
	return self:GetStackCount() > 0 and self.evade or 0
end
k = e(
	{
		j(
