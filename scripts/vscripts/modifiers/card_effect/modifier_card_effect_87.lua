...
local a = "modifiers/card_effect/modifier_card_effect_87"
...
h.modifier_card_effect_87 = c()
local l = h.modifier_card_effect_87
l.name = "modifier_card_effect_87"
d(l, j)
function l.prototype.getCountValue(self, m)
	return BUFF_VALUE["InjuryCampaignGoal" .. tostring(m)] or 0
end
...
function l.prototype.OnBattleStartBefore(self, n)
	if not self.completed then
		...
		r:AddNewModifier(r, nil, "modifier_card_effect87_buff", nil)
	end
end
...
h.modifier_card_effect_87 = l
h.modifier_card_effect87_buff = c()
local u = h.modifier_card_effect87_buff
u.name = "modifier_card_effect87_buff"
d(u, j)
function u.prototype.EDeclareEvents(self)
	return { [EOMModifierEvents.MODIFIER_EVENT_ON_INJURY_GAINED] = { self:GetParent(), -1 } }
end
function u.prototype.OnInjuryGained(self, n)
	if n.iStackCount > 0 then
		local v = PlayerResource:GetSelectedHeroEntity(self.parent:GetPlayerOwnerID())
		v:FindModifierByName("modifier_card_effect_87"):UpdateProgress(n.iStackCount)
	end
end
u = f(
	{
...
h.modifier_card_effect87_buff = u
return h