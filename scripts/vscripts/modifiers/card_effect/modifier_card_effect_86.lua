...
local a = "modifiers/card_effect/modifier_card_effect_86"
...
h.modifier_card_effect_86 = c()
local l = h.modifier_card_effect_86
l.name = "modifier_card_effect_86"
d(l, j)
function l.prototype.getCountValue(self, m)
	return BUFF_VALUE["IceCampaignGoal" .. tostring(m)] or 0
end
...
function l.prototype.OnBattleStartBefore(self, n)
	if not self.completed then
		...
		r:AddNewModifier(r, nil, "modifier_card_effect86_buff", nil)
	end
end
...
h.modifier_card_effect_86 = l
h.modifier_card_effect86_buff = c()
local u = h.modifier_card_effect86_buff
u.name = "modifier_card_effect86_buff"
d(u, j)
function u.prototype.EDeclareEvents(self)
	return { [EOMModifierEvents.MODIFIER_EVENT_ON_ICE_GAINED] = { self:GetParent(), -1 } }
end
function u.prototype.OnIceGained(self, n)
	if n.iStackCount > 0 then
		local v = PlayerResource:GetSelectedHeroEntity(self.parent:GetPlayerOwnerID())
		v:FindModifierByName("modifier_card_effect_86"):UpdateProgress(n.iStackCount)
	end
end
u = f(
	{
...
h.modifier_card_effect86_buff = u
return h