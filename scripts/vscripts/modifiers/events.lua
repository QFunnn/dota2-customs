...
EOMModifierEvents.MODIFIER_EVENT_ON_TREASURE_START = 662
EOMModifierEvents[EOMModifierEvents.MODIFIER_EVENT_ON_TREASURE_START] = "MODIFIER_EVENT_ON_TREASURE_START"
EOMModifierEventsFunctionName = {
	...
	[EOMModifierEvents.MODIFIER_EVENT_ON_TREASURE_START] = "OnTreasureStart",
}
