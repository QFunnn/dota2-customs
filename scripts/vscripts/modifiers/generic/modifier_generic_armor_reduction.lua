...
function modifier_generic_armor_reduction:IsHidden()
	return false
end
function modifier_generic_armor_reduction:IsPurgable()
	return false
end
function modifier_generic_armor_reduction:GetTexture()
	return "buffs/moment_armor"
end
...
function modifier_generic_armor_reduction:AddCustomTransmitterData()
	return {
