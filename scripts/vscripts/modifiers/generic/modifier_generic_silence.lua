...
function modifier_generic_silence:IsHidden()
	return false
end
function modifier_generic_silence:IsPurgable()
	return true
end
function modifier_generic_silence:GetTexture()
...
function modifier_generic_silence:ShouldUseOverheadOffset()
	return true
end
