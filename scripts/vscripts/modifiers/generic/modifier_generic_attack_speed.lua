...
function modifier_generic_attack_speed:IsHidden()
	return false
end
function modifier_generic_attack_speed:IsPurgable()
	return false
end
function modifier_generic_attack_speed:GetTexture()
	return "buffs/bladefury_agility"
end
...
function modifier_generic_attack_speed:AddCustomTransmitterData()
	return {
...
function modifier_generic_attack_speed:GetModifierProcAttack_Feedback(params)
	if not IsServer() then
		return
	end
	if self.attacks_count == nil then
		return
	end
