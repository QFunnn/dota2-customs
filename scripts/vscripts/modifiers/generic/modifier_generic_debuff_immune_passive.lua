...
function modifier_generic_debuff_immune_passive:IsHidden()
	return true
end
function modifier_generic_debuff_immune_passive:IsPurgable()
	return false
end
function modifier_generic_debuff_immune_passive:RemoveOnDeath()
	return false
end
...
function modifier_generic_debuff_immune_passive:AddCustomTransmitterData()
	return {
