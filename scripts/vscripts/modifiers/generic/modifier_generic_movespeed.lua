...
function modifier_generic_movespeed:IsHidden()
	return false
end
function modifier_generic_movespeed:IsPurgable()
	return false
end
function modifier_generic_movespeed:GetTexture()
...
function modifier_generic_movespeed:AddCustomTransmitterData()
	return {
