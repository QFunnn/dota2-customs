...
LinkLuaModifier(
	...
	"modifiers/generic/modifier_generic_knockback_custom",
	LUA_MODIFIER_MOTION_HORIZONTAL
)

modifier_generic_knockback_custom = class({})

function modifier_generic_knockback_custom:IsHidden()
	return true
end
function modifier_generic_knockback_custom:IsPurgable()
	return true
end
