...
function modifier_generic_shield:GetStatusEffectName()
	return self.status_effect
end
function modifier_generic_shield:StatusEffectPriority()
...
function modifier_generic_shield:GetModifierIncomingDamageConstant(params)
	...
	if self.filter_func and not self.filter_func(params) then
		return
	end
...
function modifier_generic_shield_multiple:GetAttributes()
