...
function modifier_generic_knockback:GetAttributes()
...
if IsServer() then
  ...
  self.Purgable = false
  if kv.Purgable and kv.Purgable == 1 then 
    self.Purgable = true
  end 
...
--------------------------------------------------------------------------------
-- Setter
function modifier_generic_knockback:SetEndCallback( func ) 
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_generic_knockback:GetEffectName()
  if not IsServer() then return end
  if self.stun then
