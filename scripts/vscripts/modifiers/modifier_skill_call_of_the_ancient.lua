...
function modifier_skill_call_of_the_ancient_buff:IsPurgable()
	return false
end
function modifier_skill_call_of_the_ancient_buff:IsHidden()
	return false
end
function modifier_skill_call_of_the_ancient_buff:IsDebuff()
	return false
end
function modifier_skill_call_of_the_ancient_buff:GetTexture()
	return "modifier_skill_zoo_director"
end
