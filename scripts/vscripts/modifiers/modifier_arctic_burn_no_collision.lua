...
LinkLuaModifier(
	"modifier_arctic_burn_no_collision_state",
...
function modifier_arctic_burn_no_collision:IsHidden()
	return true
end
function modifier_arctic_burn_no_collision:IsPurgable()
	return false
end
function modifier_arctic_burn_no_collision:IsPurgeException()
	return false
end
function modifier_arctic_burn_no_collision:RemoveOnDeath()
	return false
end
...
function modifier_arctic_burn_no_collision:OnIntervalThink()
	...
	if bActive then
		...
		if p:GetMana() < cost and ab.ToggleAbility then
			ab:ToggleAbility()
		end
...
function modifier_arctic_burn_no_collision_state:IsHidden()
	return true
end
function modifier_arctic_burn_no_collision_state:IsPurgable()
	return false
end
function modifier_arctic_burn_no_collision_state:IsPurgeException()
	return false
end
