...
function modifier_hero_level_upgrade_damage:IsPurgable()
	return false
end
function modifier_hero_level_upgrade_damage:IsHidden()
	return true
end
function modifier_hero_level_upgrade_damage:IsPurgeException()
	return false
end
function modifier_hero_level_upgrade_damage:RemoveOnDeath()
	return false
end
