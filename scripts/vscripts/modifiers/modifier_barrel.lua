...
function modifier_barrel:IsHidden()
	return true
end
function modifier_barrel:IsPurgable()
	return false
end
function modifier_barrel:IsPurgeException()
	return false
end
...
function modifier_barrel:OnDeath(params)
	...
	local particle =
		ParticleManager:CreateParticle("particles/newplayer_fx/npx_tree_break.vpcf", PATTACH_WORLDORIGIN, nil)
