...
function modifier_gaben_int_fixed:IsHidden()
	return true
end
function modifier_gaben_int_fixed:IsDebuff()
	return false
end
function modifier_gaben_int_fixed:IsPurgable()
	return false
end
function modifier_gaben_int_fixed:GetAttributes()
