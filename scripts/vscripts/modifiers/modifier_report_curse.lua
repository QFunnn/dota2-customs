...
function modifier_report_curse:GetTexture()
	return "punishment_curse"
end
function modifier_report_curse:IsHidden()
	return false
end
function modifier_report_curse:IsDebuff()
	return true
end
function modifier_report_curse:IsPurgable()
	return false
end
function modifier_report_curse:RemoveOnDeath()
	return false
end
function modifier_report_curse:GetAttributes()
...
function modifier_report_curse:GetModifierIncomingDamage_Percentage(params)
	if self.parent == nil or self.parent:IsNull() then
		return
	end
...
function modifier_report_curse:GetModifierBonusStats_Strength(params)
	if not IsServer() or self.parent == nil or self.parent:IsNull() then
		return
	end
