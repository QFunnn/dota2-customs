...
function modifier_base_attack_speed_custom:IsPurgable()
	return false
end
function modifier_base_attack_speed_custom:IsPurgeException()
	return false
end
function modifier_base_attack_speed_custom:IsHidden()
	return true
end
function modifier_base_attack_speed_custom:RemoveOnDeath()
	return false
end
