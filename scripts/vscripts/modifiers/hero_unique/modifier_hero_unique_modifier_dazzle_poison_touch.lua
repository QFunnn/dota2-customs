...
function modifier_hero_unique_modifier_dazzle_poison_touch:IsHidden()
	return true
end
function modifier_hero_unique_modifier_dazzle_poison_touch:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_dazzle_poison_touch:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_dazzle_poison_touch:RemoveOnDeath()
	return false
end
