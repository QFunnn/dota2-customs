...
function modifier_hero_unique_modifier_skeleton_king_hellfire_blast:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_skeleton_king_hellfire_blast:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_skeleton_king_hellfire_blast:RemoveOnDeath()
	return false
end
function modifier_hero_unique_modifier_skeleton_king_hellfire_blast:DestroyOnExpire()
	return false
end
...
function modifier_hero_unique_modifier_skeleton_king_hellfire_blast:GetModifierPreAttack_CriticalStrike(params)
	if not IsServer() or not self.ability or params.attacker ~= self.parent or self.ability:GetLevel() <= 0 then
		return
	end
