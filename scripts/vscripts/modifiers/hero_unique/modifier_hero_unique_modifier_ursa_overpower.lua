...
function modifier_hero_unique_modifier_ursa_overpower:IsHidden()
	return true
end
function modifier_hero_unique_modifier_ursa_overpower:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_ursa_overpower:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_ursa_overpower:RemoveOnDeath()
	return false
end
