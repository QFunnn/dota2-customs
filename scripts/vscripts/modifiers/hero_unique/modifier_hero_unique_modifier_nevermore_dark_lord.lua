...
function modifier_hero_unique_modifier_nevermore_dark_lord:IsHidden()
	return true
end
function modifier_hero_unique_modifier_nevermore_dark_lord:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_nevermore_dark_lord:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_nevermore_dark_lord:RemoveOnDeath()
	return false
end
