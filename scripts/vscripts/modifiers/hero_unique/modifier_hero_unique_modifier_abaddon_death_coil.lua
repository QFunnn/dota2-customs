...
function modifier_hero_unique_modifier_abaddon_death_coil:IsHidden()
	return true
end
function modifier_hero_unique_modifier_abaddon_death_coil:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_abaddon_death_coil:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_abaddon_death_coil:RemoveOnDeath()
	return false
end
