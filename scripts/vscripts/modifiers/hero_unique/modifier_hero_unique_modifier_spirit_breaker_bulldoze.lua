...
function modifier_hero_unique_modifier_spirit_breaker_bulldoze:IsHidden()
	return true
end
function modifier_hero_unique_modifier_spirit_breaker_bulldoze:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_spirit_breaker_bulldoze:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_spirit_breaker_bulldoze:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_spirit_breaker_bulldoze:GetModifierStatusResistanceStacking()
	...
	if not self.ability or self.ability:IsNull() or self.ability:GetLevel() <= 0 then
		return 0
	end
