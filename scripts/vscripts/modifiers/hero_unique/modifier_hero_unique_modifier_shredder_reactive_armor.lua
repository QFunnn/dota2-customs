...
function modifier_hero_unique_modifier_shredder_reactive_armor:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_shredder_reactive_armor:IsHidden()
	return true
end
function modifier_hero_unique_modifier_shredder_reactive_armor:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_shredder_reactive_armor:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_shredder_reactive_armor_debuff:IsHidden()
	return false
end
function modifier_hero_unique_modifier_shredder_reactive_armor_debuff:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_shredder_reactive_armor_debuff:IsDebuff()
	return true
end
