...
function modifier_hero_unique_modifier_nyx_assassin_burrow:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_nyx_assassin_burrow:IsHidden()
	return true
end
function modifier_hero_unique_modifier_nyx_assassin_burrow:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_nyx_assassin_burrow:RemoveOnDeath()
	return false
end
