...
function modifier_hero_unique_modifier_weaver_shukuchi:IsHidden()
	return true
end
function modifier_hero_unique_modifier_weaver_shukuchi:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_weaver_shukuchi:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_weaver_shukuchi:RemoveOnDeath()
	return false
end
