...
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura:IsHidden()
	return true
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura:RemoveOnDeath()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura:AllowIllusionDuplicate()
	return true
end

LinkLuaModifier(
	"modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect",
	"modifiers/hero_unique/modifier_hero_unique_modifier_crystal_maiden_brilliance_aura.lua",
...
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:IsHidden()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:RemoveOnDeath()
	return false
end
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:GetTexture()
...
function modifier_hero_unique_modifier_crystal_maiden_brilliance_aura_effect:GetModifierPercentageManacostStacking(
	params
)
	local parent = self:GetParent()
	if parent:PassivesDisabled() then
