...
function modifier_hero_unique_modifier_enchantress_natures_attendants:IsHidden()
	return true
end
function modifier_hero_unique_modifier_enchantress_natures_attendants:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_enchantress_natures_attendants:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_enchantress_natures_attendants:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_enchantress_natures_attendants:GetModifierHealthRegenPercentage()
	if not self:GetParent():HasModifier("modifier_enchantress_natures_attendants") then
		return
	end
	return 5
end