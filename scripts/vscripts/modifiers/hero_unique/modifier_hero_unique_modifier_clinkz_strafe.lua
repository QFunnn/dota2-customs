...
function modifier_hero_unique_modifier_clinkz_strafe:IsHidden()
	return true
end
function modifier_hero_unique_modifier_clinkz_strafe:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_clinkz_strafe:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_clinkz_strafe:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_clinkz_strafe:GetModifierAttackRangeBonus()
	if not self:GetParent():HasModifier("modifier_clinkz_strafe") then
		return
	end
...
function modifier_hero_unique_modifier_clinkz_strafe:GetModifierEvasion_Constant()
	if not self:GetParent():HasModifier("modifier_clinkz_strafe") or not self.ability then
		return 0
	end
