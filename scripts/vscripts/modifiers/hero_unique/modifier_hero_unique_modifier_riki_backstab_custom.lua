...
function modifier_hero_unique_modifier_riki_backstab_custom:IsHidden()
	return true
end
function modifier_hero_unique_modifier_riki_backstab_custom:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_riki_backstab_custom:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_riki_backstab_custom:RemoveOnDeath()
	return false
end
