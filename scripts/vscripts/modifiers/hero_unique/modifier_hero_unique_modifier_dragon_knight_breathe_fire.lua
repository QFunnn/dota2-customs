...
function modifier_hero_unique_modifier_dragon_knight_breathe_fire:IsHidden()
	return true
end
function modifier_hero_unique_modifier_dragon_knight_breathe_fire:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_dragon_knight_breathe_fire:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_dragon_knight_breathe_fire:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_dragon_knight_breathe_fire:AttackLandedModifier(params)
	if not IsServer() or params.attacker ~= self:GetParent() or self:GetAbility():GetLevel() <= 0 then
		return
	end
