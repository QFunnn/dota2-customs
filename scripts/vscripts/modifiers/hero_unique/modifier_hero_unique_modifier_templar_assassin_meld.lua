...
function modifier_hero_unique_modifier_templar_assassin_meld:IsHidden()
	return true
end
function modifier_hero_unique_modifier_templar_assassin_meld:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_templar_assassin_meld:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_templar_assassin_meld:RemoveOnDeath()
	return false
end
