...
LinkLuaModifier(
	"modifier_hero_unique_modifier_elder_titan_natural_order_debuff",
...
function modifier_hero_unique_modifier_elder_titan_natural_order:IsHidden()
	return true
end
function modifier_hero_unique_modifier_elder_titan_natural_order:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_elder_titan_natural_order:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_elder_titan_natural_order:RemoveOnDeath()
	return false
end
