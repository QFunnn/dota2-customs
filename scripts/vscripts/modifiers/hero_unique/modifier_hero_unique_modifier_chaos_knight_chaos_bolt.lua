...
function modifier_hero_unique_modifier_chaos_knight_chaos_bolt:IsHidden()
	return true
end
function modifier_hero_unique_modifier_chaos_knight_chaos_bolt:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_chaos_knight_chaos_bolt:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_chaos_knight_chaos_bolt:RemoveOnDeath()
	return false
end
