...
function modifier_hero_unique_modifier_alchemist_corrosive_weaponry:IsHidden()
	return true
end
function modifier_hero_unique_modifier_alchemist_corrosive_weaponry:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_alchemist_corrosive_weaponry:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_alchemist_corrosive_weaponry:RemoveOnDeath()
	return false
end
