...
function modifier_hero_unique_modifier_queenofpain_scream_of_pain:IsHidden()
	return true
end
function modifier_hero_unique_modifier_queenofpain_scream_of_pain:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_queenofpain_scream_of_pain:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_queenofpain_scream_of_pain:RemoveOnDeath()
	return false
end
