...
function modifier_hero_unique_modifier_tinker_defense_matrix:IsHidden()
	return true
end
function modifier_hero_unique_modifier_tinker_defense_matrix:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_tinker_defense_matrix:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_tinker_defense_matrix:RemoveOnDeath()
	return false
end
