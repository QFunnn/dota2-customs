...
function modifier_hero_unique_modifier_skywrath_mage_concussive_shot:IsHidden()
	return true
end
function modifier_hero_unique_modifier_skywrath_mage_concussive_shot:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_skywrath_mage_concussive_shot:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_skywrath_mage_concussive_shot:RemoveOnDeath()
	return false
end
