...
function modifier_hero_unique_modifier_troll_warlord_berserkers_rage:IsHidden()
	return true
end
function modifier_hero_unique_modifier_troll_warlord_berserkers_rage:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_troll_warlord_berserkers_rage:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_troll_warlord_berserkers_rage:RemoveOnDeath()
	return false
end
