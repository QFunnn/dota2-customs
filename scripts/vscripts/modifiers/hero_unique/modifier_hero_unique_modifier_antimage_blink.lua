...
function modifier_hero_unique_modifier_antimage_blink:IsHidden()
	return true
end
function modifier_hero_unique_modifier_antimage_blink:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_antimage_blink:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_antimage_blink:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_antimage_blink_debuff:IsHidden()
	return false
end
function modifier_hero_unique_modifier_antimage_blink_debuff:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_antimage_blink_debuff:IsDebuff()
	return true
end
