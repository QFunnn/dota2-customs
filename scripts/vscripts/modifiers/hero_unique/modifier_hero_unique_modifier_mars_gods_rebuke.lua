...
function modifier_hero_unique_modifier_mars_gods_rebuke:IsHidden()
	return true
end
function modifier_hero_unique_modifier_mars_gods_rebuke:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_mars_gods_rebuke:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_mars_gods_rebuke:RemoveOnDeath()
	return false
end
