...
function modifier_hero_unique_modifier_phantom_assassin_phantom_strike:IsHidden()
	return true
end
function modifier_hero_unique_modifier_phantom_assassin_phantom_strike:IsPurgable()
	return false
end
function modifier_hero_unique_modifier_phantom_assassin_phantom_strike:IsPurgeException()
	return false
end
function modifier_hero_unique_modifier_phantom_assassin_phantom_strike:RemoveOnDeath()
	return false
end
...
function modifier_hero_unique_modifier_phantom_assassin_phantom_strike:AttackLandedModifier(params)
	...
	if not self:GetParent():HasModifier("modifier_phantom_assassin_phantom_strike") then
		return
	end
