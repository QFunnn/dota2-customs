...
do
	...
	--- 是否阻止强制击杀（失败冷却） boolean
	UnitSymbols.IsPreventForceKill = ____UnitSymbols_IsPreventForceKill_19
	local ____UnitSymbols_IsInCustomForceKillFlow_20 = UnitSymbols.IsInCustomForceKillFlow
	if ____UnitSymbols_IsInCustomForceKillFlow_20 == nil then
		____UnitSymbols_IsInCustomForceKillFlow_20 = __TS__Symbol("IsInCustomForceKillFlow")
	end
	--- 是否正处于自定义强制击杀流程（同步重入保护） boolean
	UnitSymbols.IsInCustomForceKillFlow = ____UnitSymbols_IsInCustomForceKillFlow_20
	local ____UnitSymbols_StrikeCritAttack_AttackRecordOnLanded_21 = UnitSymbols.StrikeCritAttack_AttackRecordOnLanded
	if ____UnitSymbols_StrikeCritAttack_AttackRecordOnLanded_21 == nil then
		____UnitSymbols_StrikeCritAttack_AttackRecordOnLanded_21 = __TS__Symbol("StrikeCritAttack_AttackRecordOnLanded")
	end
	UnitSymbols.StrikeCritAttack_AttackRecordOnLanded = ____UnitSymbols_StrikeCritAttack_AttackRecordOnLanded_21
	local ____UnitSymbols_StrikeCritAttackDamageRecord_22 = UnitSymbols.StrikeCritAttackDamageRecord
	if ____UnitSymbols_StrikeCritAttackDamageRecord_22 == nil then
		____UnitSymbols_StrikeCritAttackDamageRecord_22 = __TS__Symbol("StrikeCritAttackRecord")
	end
	--- 攻击会心一击记录
	UnitSymbols.StrikeCritAttackDamageRecord = ____UnitSymbols_StrikeCritAttackDamageRecord_22
	local ____UnitSymbols_IsForbidCustomImmuneDeathDamage_23 = UnitSymbols.IsForbidCustomImmuneDeathDamage
	if ____UnitSymbols_IsForbidCustomImmuneDeathDamage_23 == nil then
		____UnitSymbols_IsForbidCustomImmuneDeathDamage_23 = __TS__Symbol("IsForbidCustomImmuneDeathDamage")
	end
	--- 是否处于禁用自定义免疫致死伤害的状态 boolean
	UnitSymbols.IsForbidCustomImmuneDeathDamage = ____UnitSymbols_IsForbidCustomImmuneDeathDamage_23
	local ____UnitSymbols_CustomImmuneDeathTriggeredCount_24 = UnitSymbols.CustomImmuneDeathTriggeredCount
	if ____UnitSymbols_CustomImmuneDeathTriggeredCount_24 == nil then
		____UnitSymbols_CustomImmuneDeathTriggeredCount_24 = __TS__Symbol("CustomImmuneDeathTriggeredCount")
	end
	--- 自定义免疫致死伤害的累计触发次数（单调递增，用于同步判断某次击杀是否被免疫致死拦截） number
	UnitSymbols.CustomImmuneDeathTriggeredCount = ____UnitSymbols_CustomImmuneDeathTriggeredCount_24
end
AbilitySymbols = AbilitySymbols or {}
do
	local ____AbilitySymbols_CustomCursorPoint_25 = AbilitySymbols.CustomCursorPoint
	if ____AbilitySymbols_CustomCursorPoint_25 == nil then
		____AbilitySymbols_CustomCursorPoint_25 = __TS__Symbol("AbilityCustomCursorPoint")
	end
	--- 技能自定义坐标记录 Vector
	AbilitySymbols.CustomCursorPoint = ____AbilitySymbols_CustomCursorPoint_25
	local ____AbilitySymbols_CustomRecord_26 = AbilitySymbols.CustomRecord
	if ____AbilitySymbols_CustomRecord_26 == nil then
		____AbilitySymbols_CustomRecord_26 = __TS__Symbol("AbilityCustomRecord")
	end
	--- 技能自定义记录
	AbilitySymbols.CustomRecord = ____AbilitySymbols_CustomRecord_26
	local ____AbilitySymbols_Bless10204RedirectCast_27 = AbilitySymbols.Bless10204RedirectCast
	if ____AbilitySymbols_Bless10204RedirectCast_27 == nil then
		____AbilitySymbols_Bless10204RedirectCast_27 = __TS__Symbol("AbilityBless10204RedirectCast")
	end
	--- 福佑 10204 流离：技能处于转向强制施法中 boolean
	AbilitySymbols.Bless10204RedirectCast = ____AbilitySymbols_Bless10204RedirectCast_27
end