...
LinkLuaModifier(
	"modifier_spectre_dispersion_custom",
	"heroes/npc_dota_hero_spectre_custom/spectre_dispersion_custom",
...
function spectre_dispersion_custom:OnSpellStart()
	...
	local particle =
		ParticleManager:CreateParticle("particles/spectre_call.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
...
function modifier_spectre_dispersion_custom:GetModifierIncomingDamage_Percentage(params)
	...
	if self:GetParent():HasModifier("modifier_spectre_13") then
		return
	end
