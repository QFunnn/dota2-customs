...
LinkLuaModifier(
	"modifier_ability_disruptor_static_storm_thinker",
	"heroes/hero_disruptor/static_storm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ability_disruptor_static_storm",
	"heroes/hero_disruptor/static_storm",
	LUA_MODIFIER_MOTION_NONE
)
...
if IsServer() then
	...
	function modifier_ability_disruptor_static_storm_thinker:OnDestroy()
		...
		EmitSoundOn("Hero_Disruptor.StaticStorm.End", self:GetCaster())
	end
end
