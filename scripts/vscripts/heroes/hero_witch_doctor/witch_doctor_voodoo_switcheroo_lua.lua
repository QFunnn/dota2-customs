...
LinkLuaModifier(
	"modifier_witch_doctor_voodoo_switcheroo_lua",
	"heroes/hero_witch_doctor/witch_doctor_voodoo_switcheroo_lua.lua",
...
LinkLuaModifier(
	"modifier_witch_doctor_voodoo_switcheroo_lua_ward",
	"heroes/hero_witch_doctor/witch_doctor_voodoo_switcheroo_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
