...
LinkLuaModifier("modifier_zuus_cloud_custom", "heroes/npc_dota_hero_zuus_custom/zuus_cloud_custom", LUA_MODIFIER_MOTION_NONE)
...
function modifier_zuus_cloud_custom:IsPurgable() return false end
function modifier_zuus_cloud_custom:IsPurgeException() return false end
