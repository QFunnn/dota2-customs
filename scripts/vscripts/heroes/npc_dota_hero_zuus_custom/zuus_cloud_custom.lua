...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_zuus_custom/zuus_cloud_custom",
...
function zuus_cloud_custom:OnSpellStart()
	...
	self.zuus_nimbus_unit:AddNewModifier(
		...
		self,
		"modifier_zuus_cloud_custom",
		{ duration = cloud_duration, cloud_bolt_interval = cloud_bolt_interval, cloud_radius = cloud_radius }
	)
...
function modifier_zuus_cloud_custom:IsPurgable()
	return false
end
function modifier_zuus_cloud_custom:IsPurgeException()
	return false
end
...
function modifier_zuus_cloud_custom:GetModifierHealthBarPips()
	return 4
end
...
function modifier_zuus_cloud_custom:OnAttack(params)
