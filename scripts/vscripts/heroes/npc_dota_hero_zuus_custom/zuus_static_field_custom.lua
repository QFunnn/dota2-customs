...
LinkLuaModifier(
	"modifier_zuus_static_field_custom",
	"heroes/npc_dota_hero_zuus_custom/zuus_static_field_custom",
...
function modifier_zuus_static_field_custom:IsHidden()
	return true
end
function modifier_zuus_static_field_custom:IsPurgable()
	return false
end
function modifier_zuus_static_field_custom:IsPurgeException()
	return false
end
function modifier_zuus_static_field_custom:RemoveOnDeath()
	return false
end
function modifier_zuus_static_field_custom:OnTakeDamage(params)
	...
	if params.inflictor and params.inflictor:GetAbilityName() == "zuus_static_field_custom" then
		return
	end
