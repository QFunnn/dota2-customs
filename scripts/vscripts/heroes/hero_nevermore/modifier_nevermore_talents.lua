...
LinkLuaModifier(
	"modifier_nevermore_presence_amp",
...
function modifier_nevermore_presence_amp:IsHidden()
	return true
end
function modifier_nevermore_presence_amp:IsPurgable()
	return false
end
function modifier_nevermore_presence_amp:RemoveOnDeath()
	return false
end
function modifier_nevermore_presence_amp:IsAura()
	return true
end
...
function modifier_nevermore_presence_amp:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_nevermore_presence_amp:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC
end
function modifier_nevermore_presence_amp:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES
end
function modifier_nevermore_presence_amp:GetModifierAura()
	return "modifier_nevermore_presence_amp_debuff"
end

modifier_nevermore_presence_amp_debuff = class({})

function modifier_nevermore_presence_amp_debuff:IsHidden()
	return false
end
function modifier_nevermore_presence_amp_debuff:IsDebuff()
	return true
end
function modifier_nevermore_presence_amp_debuff:IsPurgable()
	return false
end
...
function modifier_nevermore_presence_amp_debuff:GetModifierPhysicalArmorBonus()
	...
	if not talent or talent:IsNull() then
		return 0
	end
