...
LinkLuaModifier(
	"modifier_kunkka_attacker_thinker",
	"heroes/npc_dota_hero_kunkka_custom/kunkka_attacker",
...
function kunkka_attacker:OnSpellStart()
	...
	self:GetCaster():AddNewModifier(
		...
		self,
		"modifier_kunkka_attacker_delay",
		{ duration = self:GetSpecialValueFor("delay"), target = thinker:entindex() }
	)
end

modifier_kunkka_attacker_delay = class({})
function modifier_kunkka_attacker_delay:IsPurgable()
	return false
end
function modifier_kunkka_attacker_delay:IsPurgeException()
	return false
end
...
function modifier_kunkka_attacker_delay:OnDestroy()
	...
	self:GetCaster():AddNewModifier(
		...
		self:GetAbility(),
		"modifier_kunkka_attacker_cast",
		{ duration = duration, target = self.target }
	)
end

modifier_kunkka_attacker_cast = class({})
function modifier_kunkka_attacker_cast:IsPurgable()
	return false
end
function modifier_kunkka_attacker_cast:IsPurgeException()
	return false
end
...
function modifier_kunkka_attacker_thinker:IsHidden()
	return true
end
function modifier_kunkka_attacker_thinker:IsPurgable()
	return false
end
function modifier_kunkka_attacker_thinker:IsPurgeException()
	return false
end
