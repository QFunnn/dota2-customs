...
LinkLuaModifier(
	"modifier_roshan_strength_of_the_immortal_custom",
	"heroes/npc_dota_hero_arc_warden_custom/roshan_strength_of_the_immortal_custom",
	LUA_MODIFIER_MOTION_NONE
)

roshan_strength_of_the_immortal_custom = class({})

function roshan_strength_of_the_immortal_custom:IsRefreshable()
	return false
end
...
function modifier_roshan_strength_of_the_immortal_custom:IsPurgable()
	return false
end
function modifier_roshan_strength_of_the_immortal_custom:IsPurgeException()
	return false
end
function modifier_roshan_strength_of_the_immortal_custom:RemoveOnDeath()
	return false
end
