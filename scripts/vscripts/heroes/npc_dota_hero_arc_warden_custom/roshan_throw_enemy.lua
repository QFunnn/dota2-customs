...
LinkLuaModifier(
	"modifier_roshan_throw_enemy_buff",
	"heroes/npc_dota_hero_arc_warden_custom/roshan_throw_enemy",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_roshan_throw_enemy_debuff",
	"heroes/npc_dota_hero_arc_warden_custom/roshan_throw_enemy",
...
function modifier_roshan_throw_enemy_buff:IsHidden()
	return true
end
function modifier_roshan_throw_enemy_buff:IsPurgeException()
	return false
end
function modifier_roshan_throw_enemy_buff:IsPurgable()
	return false
end
...
function modifier_roshan_throw_enemy_debuff:IsHidden()
	return true
end
