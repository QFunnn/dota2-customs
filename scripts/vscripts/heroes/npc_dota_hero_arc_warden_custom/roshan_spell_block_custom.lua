...
LinkLuaModifier(
	"modifier_roshan_spell_block_custom",
	"heroes/npc_dota_hero_arc_warden_custom/roshan_spell_block_custom",
...
function modifier_roshan_spell_block_custom:IsHidden()
	return true
end
function modifier_roshan_spell_block_custom:IsPurgable()
	return false
end
function modifier_roshan_spell_block_custom:IsPurgeException()
	return false
end
function modifier_roshan_spell_block_custom:RemoveOnDeath()
	return false
end
...
function modifier_roshan_spell_block_custom:GetReflectSpell(params)
	if not self:GetCaster():HasModifier("modifier_arc_warden_20") then
		return
	end
	if not IsServer() then
		return 0
