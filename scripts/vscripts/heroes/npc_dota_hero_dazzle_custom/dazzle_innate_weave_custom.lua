...
LinkLuaModifier(
	"modifier_dazzle_innate_weave_custom_armor_buff",
	"heroes/npc_dota_hero_dazzle_custom/dazzle_innate_weave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dazzle_innate_weave_custom_armor_debuff",
	"heroes/npc_dota_hero_dazzle_custom/dazzle_innate_weave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dazzle_innate_weave_custom_armor_buff_counter",
	"heroes/npc_dota_hero_dazzle_custom/dazzle_innate_weave_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dazzle_innate_weave_custom_armor_debuff_counter",
	"heroes/npc_dota_hero_dazzle_custom/dazzle_innate_weave_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function dazzle_innate_weave_custom:TargetModifier(target)
	...
	if target:GetTeamNumber() == self:GetCaster():GetTeamNumber() then
		local modifier_dazzle_innate_weave_custom_armor_buff = target:AddNewModifier(
			self:GetCaster(),
			self,
			"modifier_dazzle_innate_weave_custom_armor_buff",
		...
		local modifier_dazzle_innate_weave_custom_armor_debuff = target:AddNewModifier(
			self:GetCaster(),
			self,
			"modifier_dazzle_innate_weave_custom_armor_debuff",
...
function modifier_dazzle_innate_weave_custom_armor_buff:OnIntervalThink()
	...
	self:SetStackCount(
		#self:GetParent():FindAllModifiersByName("modifier_dazzle_innate_weave_custom_armor_buff_counter")
	)
end
...
function modifier_dazzle_innate_weave_custom_armor_debuff:OnIntervalThink()
	...
	self:SetStackCount(
		#self:GetParent():FindAllModifiersByName("modifier_dazzle_innate_weave_custom_armor_debuff_counter")
	)
end
...
function modifier_dazzle_innate_weave_custom_armor_buff_counter:IsHidden()
	return true
end
function modifier_dazzle_innate_weave_custom_armor_buff_counter:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

modifier_dazzle_innate_weave_custom_armor_debuff_counter = class({})
function modifier_dazzle_innate_weave_custom_armor_debuff_counter:IsHidden()
	return true
end
function modifier_dazzle_innate_weave_custom_armor_debuff_counter:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end