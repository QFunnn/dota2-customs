...
LinkLuaModifier(
	"modifier_marci_special_delivery_custom",
	"heroes/npc_dota_hero_marci_custom/marci_special_delivery_custom",
...
function modifier_marci_special_delivery_custom:OnCreated()
	...
	if GetMapName() ~= "arena" then
		local trigger = SpawnDOTAShopTriggerRadiusApproximate(
	...
	self.model = SpawnEntityFromTableSynchronous(
		"prop_dynamic",
		{
