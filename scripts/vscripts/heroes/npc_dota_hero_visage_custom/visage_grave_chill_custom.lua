...
LinkLuaModifier(
	"modifier_visage_grave_chill_custom_debuff",
	"heroes/npc_dota_hero_visage_custom/visage_grave_chill_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_visage_grave_chill_custom_buff",
	"heroes/npc_dota_hero_visage_custom/visage_grave_chill_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function visage_grave_chill_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_visage_grave_chill_custom_buff", { duration = duration })
...
function modifier_visage_grave_chill_custom_buff:OnCreated(params)
	...
	local chill_particle = ParticleManager:CreateParticle(
