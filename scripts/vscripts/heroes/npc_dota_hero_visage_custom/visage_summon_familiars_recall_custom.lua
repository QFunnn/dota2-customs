...
LinkLuaModifier(
	"modifier_visage_summon_familiars_recall_custom",
	"heroes/npc_dota_hero_visage_custom/visage_summon_familiars_recall_custom",
...
function modifier_visage_summon_familiars_recall_custom:IsPurgable()
	return false
end
function modifier_visage_summon_familiars_recall_custom:IsPurgeException()
	return false
end
