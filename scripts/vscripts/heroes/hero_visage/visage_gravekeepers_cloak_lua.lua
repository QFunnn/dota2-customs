...
LinkLuaModifier("modifier_visage_gravekeepers_cloak_lua", "heroes/hero_visage/visage_gravekeepers_cloak_lua",
	LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_visage_gravekeepers_cloak_secondary_lua", "heroes/hero_visage/visage_gravekeepers_cloak_lua",
	LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_visage_gravekeepers_cloak_lua_shard_buff", "heroes/hero_visage/visage_gravekeepers_cloak_lua",
	LUA_MODIFIER_MOTION_NONE)
...
function visage_gravekeepers_cloak_lua:OnSpellStart()
	...
	caster:AddNewModifier(caster, self, "modifier_visage_gravekeepers_cloak_lua_shard_buff",
		{ duration = shard_duration })
	caster:StartGesture(self:GetCastAnimation())

	Timers:CreateTimer(stun_delay, function()
		local units = FindUnitsInRadius(caster:GetTeamNumber(), caster:GetAbsOrigin(), nil, stun_radius,
		...
		local particleID = ParticleManager:CreateParticle("particles/units/heroes/hero_visage/visage_stone_form.vpcf",
...
function modifier_visage_gravekeepers_cloak_lua:GetModifierAura() return
	"modifier_visage_gravekeepers_cloak_secondary_lua" end
...
function modifier_visage_gravekeepers_cloak_lua:OnStackCountChanged(old_stack_count)
	...
	if new_stack_count and new_stack_count > 0 then
		local cloak_pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_visage/visage_cloak_lyr4.vpcf",
		...
		if not self.barrier_pfx then
			...
			"particles/units/heroes/hero_visage/visage_cloak_ambient.vpcf", PATTACH_ABSORIGIN_FOLLOW, parent)
		end
