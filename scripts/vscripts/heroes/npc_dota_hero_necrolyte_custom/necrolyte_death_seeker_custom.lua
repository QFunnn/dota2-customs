...
LinkLuaModifier(
	"modifier_necrolyte_death_seeker_custom",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_death_seeker_custom",
...
function necrolyte_death_seeker_custom:OnProjectileHit(target, vLocation)
	...
	local modifier_necrolyte_death_seeker_custom = self:GetCaster()
		:FindModifierByName("modifier_necrolyte_death_seeker_custom")
...
function modifier_necrolyte_death_seeker_custom:IsHidden()
	return true
end
function modifier_necrolyte_death_seeker_custom:IsPurgable()
	return false
end
