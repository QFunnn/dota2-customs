...
LinkLuaModifier(
	"modifier_necrolyte_death_custom",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_death_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_death_custom_buff",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_death_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_necrolyte_death_custom:IsPurgable()
	return false
end
function modifier_necrolyte_death_custom:IsPurgeException()
	return false
end
...
function modifier_necrolyte_death_custom:OnRemoved()
	...
	self:GetCaster():AddNewModifier(
		...
		self:GetAbility(),
		"modifier_necrolyte_death_custom_buff",
		{ duration = self:GetAbility():GetSpecialValueFor("duration"), shield = shield }
	)
end

modifier_necrolyte_death_custom_buff = class({})
function modifier_necrolyte_death_custom_buff:IsPurgable()
	return false
end
function modifier_necrolyte_death_custom_buff:IsPurgeException()
	return false
end
function modifier_necrolyte_death_custom_buff:RemoveOnDeath()
	return false
end
