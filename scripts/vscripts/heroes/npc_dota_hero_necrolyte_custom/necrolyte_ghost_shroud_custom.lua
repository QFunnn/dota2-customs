...
LinkLuaModifier(
	"modifier_necrolyte_ghost_shroud_custom",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_ghost_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_ghost_shroud_custom_aura",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_ghost_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_ghost_shroud_custom_aura_debuff",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_ghost_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_necrolyte_ghost_shroud_custom_aura_handler",
	"heroes/npc_dota_hero_necrolyte_custom/necrolyte_ghost_shroud_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function necrolyte_ghost_shroud_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_necrolyte_ghost_shroud_custom", { duration = duration })
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_necrolyte_ghost_shroud_custom_aura", { duration = duration })
end

modifier_necrolyte_ghost_shroud_custom = class({})
function modifier_necrolyte_ghost_shroud_custom:IsHidden()
	return true
end
function modifier_necrolyte_ghost_shroud_custom:IsPurgable()
	return not self:GetCaster():HasModifier("modifier_necrolyte_14")
end
...
function modifier_necrolyte_ghost_shroud_custom:OnDestroy()
	...
	local modifier_necrolyte_ghost_shroud_custom_aura =
		self:GetParent():FindModifierByName("modifier_necrolyte_ghost_shroud_custom_aura")
...
function modifier_necrolyte_ghost_shroud_custom_aura:IsHidden()
	return false
end
function modifier_necrolyte_ghost_shroud_custom_aura:IsPurgable()
	return false
end
function modifier_necrolyte_ghost_shroud_custom_aura:IsAura()
	return true
end
...
function modifier_necrolyte_ghost_shroud_custom_aura_debuff:IsHidden()
	return false
end
function modifier_necrolyte_ghost_shroud_custom_aura_debuff:IsDebuff()
	return true
end
...
function modifier_necrolyte_ghost_shroud_custom_aura_debuff:OnCreated()
	...
	local modifier_necrolyte_ghost_shroud_custom_aura_handler =
		self:GetCaster():FindModifierByName("modifier_necrolyte_ghost_shroud_custom_aura_handler")
...
function modifier_necrolyte_ghost_shroud_custom_aura_handler:IsHidden()
	return true
end
function modifier_necrolyte_ghost_shroud_custom_aura_handler:IsPurgable()
	return false
end
function modifier_necrolyte_ghost_shroud_custom_aura_handler:IsPurgeException()
	return false
end
function modifier_necrolyte_ghost_shroud_custom_aura_handler:RemoveOnDeath()
	return false
end
...
function modifier_necrolyte_ghost_shroud_custom_aura_handler:GetModifierMoveSpeedBonus_Percentage()
	if not self:GetCaster():HasModifier("modifier_necrolyte_4") then
		return
	end
	return self:GetStackCount()
		* self:GetAbility().modifier_necrolyte_4[self:GetCaster():GetTalentLevel("modifier_necrolyte_4")]
end