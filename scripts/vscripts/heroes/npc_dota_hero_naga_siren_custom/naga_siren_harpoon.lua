...
LinkLuaModifier(
	"modifier_naga_siren_harpoon",
	"heroes/npc_dota_hero_naga_siren_custom/naga_siren_harpoon",
...
function modifier_naga_siren_harpoon:IsDebuff()
	return false
end
function modifier_naga_siren_harpoon:IsHidden()
	return true
end
function modifier_naga_siren_harpoon:GetStatusEffectName()
	return "particles/status_fx/status_effect_forcestaff.vpcf"
end
function modifier_naga_siren_harpoon:StatusEffectPriority()
	return 100
end
