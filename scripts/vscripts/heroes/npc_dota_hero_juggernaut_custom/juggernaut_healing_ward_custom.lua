...
LinkLuaModifier(
	"modifier_juggernaut_healing_ward_custom_aura",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_healing_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_juggernaut_healing_ward_custom:DeathEvent()
	...
	for _, enemy in pairs(units) do
		if self:GetCaster():HasModifier("modifier_juggernaut_5") then
			local heal = enemy:GetMaxHealth()
				/ 100
				* self:GetAbility().modifier_juggernaut_5[self:GetCaster():GetTalentLevel("modifier_juggernaut_5")]
			enemy:Heal(heal, self:GetAbility())
		end
	end
end

function modifier_juggernaut_healing_ward_custom:IsHidden()
	return true
end
function modifier_juggernaut_healing_ward_custom:IsPurgable()
	return false
end
function modifier_juggernaut_healing_ward_custom:IsAura()
	return true
end
function modifier_juggernaut_healing_ward_custom:GetAuraDuration()
	return 2
end
function modifier_juggernaut_healing_ward_custom:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius")
end
function modifier_juggernaut_healing_ward_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_juggernaut_healing_ward_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_juggernaut_healing_ward_custom:GetModifierAura()
	return "modifier_juggernaut_healing_ward_custom_aura"
end
...
function modifier_juggernaut_healing_ward_custom:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_juggernaut_healing_ward_custom:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_juggernaut_healing_ward_custom:GetAbsoluteNoDamagePure()
	return 1
end
...
function modifier_juggernaut_healing_ward_custom_aura:IsPurgable()
	return false
end
...
function modifier_juggernaut_healing_ward_custom_aura:GetModifierHealthRegenPercentage()
	return self.health_regen
end

modifier_juggernaut_healing_ward_custom_invul = class({})
function modifier_juggernaut_healing_ward_custom_invul:IsHidden()
	return true
end
function modifier_juggernaut_healing_ward_custom_invul:IsPurgable()
	return false
end
function modifier_juggernaut_healing_ward_custom_invul:IsPurgeException()
	return false
end
...
function modifier_juggernaut_healing_ward_custom_speed:IsHidden()
	return true
end
function modifier_juggernaut_healing_ward_custom_speed:IsPurgable()
	return false
end
function modifier_juggernaut_healing_ward_custom_speed:IsPurgeException()
	return false
end
