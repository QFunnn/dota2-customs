...
LinkLuaModifier(
	"modifier_juggernaut_ice_ward_custom",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_ice_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_ice_ward_custom_aura",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_ice_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_ice_ward_custom_rooted",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_ice_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function modifier_juggernaut_ice_ward_custom:OnCreated(table)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/healing_ward_juggernaut_ice_ling_ward_fortunes_tout_ward.vpcf",
	...
	if self.interval >= self:GetAbility():GetSpecialValueFor("rooted_delay") then
		...
		for _, enemy in pairs(units) do
			enemy:AddNewModifier(
				...
				self:GetAbility(),
				"modifier_juggernaut_ice_ward_custom_rooted",
				{ duration = self:GetAbility():GetSpecialValueFor("rooted_duration") * (1 - enemy:GetStatusResistance()) }
			)
		end
	end
end
...
function modifier_juggernaut_ice_ward_custom:IsHidden()
	return true
end
function modifier_juggernaut_ice_ward_custom:IsPurgable()
	return false
end
function modifier_juggernaut_ice_ward_custom:IsAura()
	return true
end
function modifier_juggernaut_ice_ward_custom:GetAuraDuration()
	return 0
end
function modifier_juggernaut_ice_ward_custom:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius")
end
function modifier_juggernaut_ice_ward_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_juggernaut_ice_ward_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_juggernaut_ice_ward_custom:GetModifierAura()
	return "modifier_juggernaut_ice_ward_custom_aura"
end
...
function modifier_juggernaut_ice_ward_custom:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_juggernaut_ice_ward_custom:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_juggernaut_ice_ward_custom:GetAbsoluteNoDamagePure()
	return 1
end
...
function modifier_juggernaut_ice_ward_custom_aura:IsPurgable()
	return false
end
