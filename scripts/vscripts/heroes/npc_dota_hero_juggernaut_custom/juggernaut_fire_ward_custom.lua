...
LinkLuaModifier(
	"modifier_juggernaut_fire_ward_custom",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_fire_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_fire_ward_custom_aura",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_fire_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function juggernaut_fire_ward_custom:OnSpellStart()
	...
	local wards = Entities:FindAllByModel(
...
function modifier_juggernaut_fire_ward_custom:OnCreated(table)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/juggernaut_healing_ward_fire.vpcf",
...
function modifier_juggernaut_fire_ward_custom:IsHidden()
	return true
end
function modifier_juggernaut_fire_ward_custom:IsPurgable()
	return false
end
function modifier_juggernaut_fire_ward_custom:IsAura()
	return true
end
function modifier_juggernaut_fire_ward_custom:GetAuraDuration()
	return 0
end
function modifier_juggernaut_fire_ward_custom:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius")
end
function modifier_juggernaut_fire_ward_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_juggernaut_fire_ward_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_juggernaut_fire_ward_custom:GetModifierAura()
	return "modifier_juggernaut_fire_ward_custom_aura"
end
...
function modifier_juggernaut_fire_ward_custom:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_juggernaut_fire_ward_custom:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_juggernaut_fire_ward_custom:GetAbsoluteNoDamagePure()
	return 1
end
...
function modifier_juggernaut_fire_ward_custom_aura:IsPurgable()
	return false
end
