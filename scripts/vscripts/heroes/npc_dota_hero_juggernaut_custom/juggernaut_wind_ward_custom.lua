...
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom_aura",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom_enemy_aura",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom_debuff",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom_death_buff",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_wind_ward_custom_death_debuff",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_wind_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_healing_ward_custom_invul",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_healing_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_juggernaut_healing_ward_custom_speed",
	"heroes/npc_dota_hero_juggernaut_custom/juggernaut_healing_ward_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_juggernaut_wind_ward_custom:OnCreated(table)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/healing_ward_juggernaut_winddc.vpcf",
	...
	ParticleManager:SetParticleControl(
		self.particle,
		1,
		Vector(self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius"), 1, 1)
	)
...
function modifier_juggernaut_wind_ward_custom:IsHidden()
	return true
end
function modifier_juggernaut_wind_ward_custom:IsPurgable()
	return false
end
function modifier_juggernaut_wind_ward_custom:IsAura()
	return true
end
function modifier_juggernaut_wind_ward_custom:GetAuraDuration()
	return 0
end
function modifier_juggernaut_wind_ward_custom:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius")
end
function modifier_juggernaut_wind_ward_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_juggernaut_wind_ward_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_juggernaut_wind_ward_custom:GetModifierAura()
	return "modifier_juggernaut_wind_ward_custom_aura"
end
...
function modifier_juggernaut_wind_ward_custom:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_juggernaut_wind_ward_custom:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_juggernaut_wind_ward_custom:GetAbsoluteNoDamagePure()
	return 1
end
...
function modifier_juggernaut_wind_ward_custom:DeathEvent()
	...
	local units_friendly = FindUnitsInRadius(
		self:GetCaster():GetTeamNumber(),
		self:GetParent():GetAbsOrigin(),
		nil,
		self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius"),
	...
	for _, enemy in pairs(units) do
		enemy:AddNewModifier(
			...
			self:GetAbility(),
			"modifier_juggernaut_wind_ward_custom_death_debuff",
			{ duration = self:GetAbility():GetSpecialValueFor("death_effect_duration") }
		)
	end
...
function modifier_juggernaut_wind_ward_custom_aura:IsPurgable()
	return false
end
...
function modifier_juggernaut_wind_ward_custom_enemy_aura:IsHidden()
	return true
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:IsPurgable()
	return false
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:IsAura()
	return true
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:GetAuraDuration()
	return 0
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("healing_ward_aura_radius")
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_juggernaut_wind_ward_custom_enemy_aura:GetModifierAura()
	return "modifier_juggernaut_wind_ward_custom_debuff"
end

modifier_juggernaut_wind_ward_custom_debuff = class({})

function modifier_juggernaut_wind_ward_custom_debuff:IsPurgable()
	return false
end
...
function modifier_juggernaut_wind_ward_custom_death_buff:IsPurgable()
	return false
end
...
function modifier_juggernaut_wind_ward_custom_death_debuff:IsPurgable()
	return false
end
