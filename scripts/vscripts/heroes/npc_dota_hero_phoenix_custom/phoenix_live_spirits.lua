...
LinkLuaModifier(
	"modifier_phoenix_live_spirits",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_live_spirits",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_phoenix_live_spirits_attack",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_live_spirits",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_phoenix_live_spirits_effect",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_live_spirits",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_phoenix_live_spirits:IsHidden()
	return true
end
function modifier_phoenix_live_spirits:IsPurgable()
	return false
end
function modifier_phoenix_live_spirits:RemoveOnDeath()
	return false
end
function modifier_phoenix_live_spirits:IsPurgeException()
	return false
end
function modifier_phoenix_live_spirits:GetAttributes()
...
function modifier_phoenix_live_spirits_effect:PlayEffects()
	self.effect_cast = ParticleManager:CreateParticle(
		"particles/ice_phoenix/phoenix_life_spirits_bid.vpcf",
