...
LinkLuaModifier(
	"modifier_phoenix_icicle_shard_debuff",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_icicle_shard",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_phoenix_icicle_shard_thinker",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_icicle_shard",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_phoenix_icicle_shard_thinker:IsHidden()
	return false
end
function modifier_phoenix_icicle_shard_thinker:IsPurgable()
	return false
end
...
function modifier_phoenix_icicle_shard_thinker:OnDestroy()
	...
	ParticleManager:SetParticleControl(
		effect_cast,
		1,
		Vector(self.radius, self:GetAbility():GetSpecialValueFor("slow_duration"), self.radius)
	)
	ParticleManager:ReleaseParticleIndex(effect_cast)
