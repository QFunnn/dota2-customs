...
LinkLuaModifier(
	"modifier_phoenix_freezing_storm",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_freezing_storm",
...
function phoenix_freezing_storm:OnSpellStart()
	...
	local pfx = ParticleManager:CreateParticle(
		"particles/phoenix_csutom/phoenix_explsoion.vpcf",
...
function modifier_phoenix_freezing_storm:IsPurgable()
	return false
end
function modifier_phoenix_freezing_storm:IsPurgeException()
	return false
end
