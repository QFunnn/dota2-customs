...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_phoenix_custom/phoenix_super_supernova_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_phoenix_super_supernova_custom_handler",
	"heroes/npc_dota_hero_phoenix_custom/phoenix_super_supernova_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function phoenix_super_supernova_custom:OnSpellStart(no_heal)
	...
	self:GetCaster():AddNewModifier(
		...
		self,
		"modifier_phoenix_super_supernova_custom_buff",
		{ duration = self:GetSpecialValueFor("invul_duration") }
	)
	if not no_heal then
...
function modifier_phoenix_super_supernova_custom_buff:IsPurgable()
	return false
end
function modifier_phoenix_super_supernova_custom_buff:IsPurgeException()
	return false
end
...
function modifier_phoenix_super_supernova_custom_buff:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_phoenix_super_supernova_custom_buff:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_phoenix_super_supernova_custom_buff:GetAbsoluteNoDamagePure()
	return 1
end

modifier_phoenix_super_supernova_custom_handler = class({})
function modifier_phoenix_super_supernova_custom_handler:IsHidden()
	return true
end
function modifier_phoenix_super_supernova_custom_handler:IsPurgable()
	return false
end
function modifier_phoenix_super_supernova_custom_handler:IsPurgeException()
	return false
end
...
function modifier_phoenix_super_supernova_custom_handler:OnTakeDamage(params)
	...
	self:GetCaster():AddNewModifier(
		...
		self:GetAbility(),
		"modifier_phoenix_super_supernova_custom_buff",
		{ duration = self:GetAbility():GetSpecialValueFor("invul_duration") }
	)
