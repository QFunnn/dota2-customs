...
modifier_aegis_buff = class({}) ---@class modifier_aegis_buff : CDOTA_Modifier_Lua
...
function modifier_aegis_buff:OnCreated(table)
	local nWingsParticleIndex = ParticleManager:CreateParticle(
	...
	-- Halo particle
	local nHaloParticleIndex = ParticleManager:CreateParticle(
