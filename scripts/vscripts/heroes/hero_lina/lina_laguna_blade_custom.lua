...
LinkLuaModifier(
	...
	"heroes/hero_lina/lina_laguna_blade_custom",
...
function modifier_lina_laguna_blade_custom_passive:IsPurgable()
	return false
end
function modifier_lina_laguna_blade_custom_passive:IsPurgeException()
	return false
end
function modifier_lina_laguna_blade_custom_passive:RemoveOnDeath()
	return false
end
function modifier_lina_laguna_blade_custom_passive:GetAttributes()
...
function modifier_lina_laguna_blade_custom_passive:OnDestroy()
	...
	Timers:CreateTimer(0, function()
		...
		if
			...
			and not ab:IsNull()
			and ab:GetLevel() > 0
			and not hParent:HasModifier("modifier_lina_laguna_blade_custom_passive")
		then
...
function modifier_lina_laguna_blade_custom_passive:OnDeathEvent(params)
	...
	local bHasBuff = params.unit:FindModifierByNameAndCaster(
		"modifier_lina_laguna_blade_custom_damage",
		self:GetParent()
	) ~= nil
...
function modifier_lina_laguna_blade_custom_damage:IsHidden()
	return true
end
function modifier_lina_laguna_blade_custom_damage:IsPurgable()
	return false
end