...
LinkLuaModifier(
	"modifier_dawnbreaker_break_of_dawn_custom",
	"heroes/npc_dota_hero_dawnbreaker_custom/dawnbreaker_break_of_dawn_custom",
...
function modifier_dawnbreaker_break_of_dawn_custom:IsHidden()
	return true
end
function modifier_dawnbreaker_break_of_dawn_custom:IsPurgable()
	return false
end
function modifier_dawnbreaker_break_of_dawn_custom:IsPurgeException()
	return false
end
function modifier_dawnbreaker_break_of_dawn_custom:RemoveOnDeath()
	return false
end
