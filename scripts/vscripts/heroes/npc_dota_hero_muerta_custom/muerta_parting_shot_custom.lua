...
LinkLuaModifier(
	"modifier_generic_knockback_muerta_parting_shot_custom",
	"heroes/npc_dota_hero_muerta_custom/muerta_parting_shot_custom",
...
function muerta_parting_shot_custom:OnSpellStart()
	...
	if target:GetTeamNumber() == self:GetCaster():GetTeamNumber() then
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self, "modifier_generic_knockback_muerta_parting_shot_custom", {
