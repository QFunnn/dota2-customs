...
function jakiro_liquid_fire_lua:IsHiddenWhenStolen()
	return false
end
function jakiro_liquid_fire_lua:IsRefreshable()
	return true
end
function jakiro_liquid_fire_lua:IsStealable()
	return false
end
function jakiro_liquid_fire_lua:IsNetherWardStealable()
	return false
end

function jakiro_liquid_fire_lua:GetIntrinsicModifierName()
	return "modifier_liquid_fire_lua_orb"
end
...
function jakiro_liquid_fire_lua:OnProjectileHit(target, location)
	...
	for _, enemy in pairs(enemies) do
		enemy:AddNewModifier(
			caster,
			self,
			"modifier_liquid_fire_lua",
			{ duration = self:GetSpecialValueFor("duration") * enemy:GetStatusResistanceFactor(caster) }
		)
	end
...
function modifier_liquid_fire_lua:IsDebuff()
	return true
end
function modifier_liquid_fire_lua:IsHidden()
	return false
end
function modifier_liquid_fire_lua:IsPurgable()
	return true
end
function modifier_liquid_fire_lua:IsPurgeException()
	return true
end

function modifier_liquid_fire_lua:GetEffectName()
	return "particles/units/heroes/hero_jakiro/jakiro_liquid_fire_debuff.vpcf"
end
function modifier_liquid_fire_lua:GetEffectAttachType()
...
function modifier_liquid_fire_lua:OnIntervalThink()
	...
	local dmg = self:GetAbility():GetSpecialValueFor("damage")
		/ (1.0 / self:GetAbility():GetSpecialValueFor("damage_interval"))
	local damageTable = {
...
function modifier_liquid_fire_lua:DeclareFunctions()
...
function modifier_liquid_fire_lua_orb:IsDebuff()
	return false
end
function modifier_liquid_fire_lua_orb:IsHidden()
	return true
end
function modifier_liquid_fire_lua_orb:IsPurgable()
	return false
end
function modifier_liquid_fire_lua_orb:IsPurgeException()
	return false
end
