...
LinkLuaModifier(
	"modifier_chen_creep_innate",
	"heroes/npc_dota_hero_chen_custom/chen_creep_innate",
...
function modifier_chen_creep_innate:IsHidden()
	return true
end
function modifier_chen_creep_innate:IsPurgable()
	return false
end
function modifier_chen_creep_innate:RemoveOnDeath()
	return false
end
...
function modifier_chen_creep_innate:GetModifierIncomingDamage_Percentage(params)
	...
	if not self:IsCreepTarget(attacker) then
		return
	end
...
function modifier_chen_creep_innate:GetModifierTotalDamageOutgoing_Percentage(params)
	...
	if not self:IsCreepTarget(target) then
		return
	end
