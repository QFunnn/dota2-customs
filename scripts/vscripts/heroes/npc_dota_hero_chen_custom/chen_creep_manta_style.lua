...
LinkLuaModifier(
	"modifier_chen_creep_manta_style_invulnerable",
	"heroes/npc_dota_hero_chen_custom/chen_creep_manta_style",
...
function chen_creep_manta_style:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_chen_creep_manta_style_invulnerable", { duration = 0.1 })
	ProjectileManager:ProjectileDodge(self:GetCaster())
end

modifier_chen_creep_manta_style_invulnerable = class({})
function modifier_chen_creep_manta_style_invulnerable:IsHidden()
	return true
end
function modifier_chen_creep_manta_style_invulnerable:IsPurgable()
	return false
end
...
function modifier_chen_creep_manta_style_invulnerable:OnDestroy()
	...
	local all_illusions = FindUnitsInRadius(
