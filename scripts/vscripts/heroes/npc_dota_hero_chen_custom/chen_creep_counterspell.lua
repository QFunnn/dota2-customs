...
LinkLuaModifier(
	"modifier_chen_creep_counterspell",
	"heroes/npc_dota_hero_chen_custom/chen_creep_counterspell",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chen_creep_counterspell_active",
	"heroes/npc_dota_hero_chen_custom/chen_creep_counterspell",
	LUA_MODIFIER_MOTION_NONE
)
...
function chen_creep_counterspell:OnSpellStart(target)
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_chen_creep_counterspell_active", { duration = duration })
...
function modifier_chen_creep_counterspell:IsPurgable()
	return false
end
...
function modifier_chen_creep_counterspell_active:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/creep_particles/creep_counter.vpcf",
...
function modifier_chen_creep_counterspell_active:GetAbsorbSpell(params)
	...
	local particle = ParticleManager:CreateParticle(
		"particles/creep_particles/creep_reflect.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControlEnt(
