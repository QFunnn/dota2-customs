...
LinkLuaModifier(
	"modifier_chen_creep_petrify",
	"heroes/npc_dota_hero_chen_custom/chen_creep_petrify",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chen_creep_petrify_orb",
	"heroes/npc_dota_hero_chen_custom/chen_creep_petrify",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_chen_creep_petrify:OnCreated(kv)
	...
	local particle = ParticleManager:CreateParticle(
		"particles/creep_particles/prowler_shaman_shamanistic_ward.vpcf",
