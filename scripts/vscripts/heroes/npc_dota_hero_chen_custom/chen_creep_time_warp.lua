...
LinkLuaModifier(
	"modifier_chen_creep_time_warp",
	"heroes/npc_dota_hero_chen_custom/chen_creep_time_warp",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chen_creep_time_warp_buff",
	"heroes/npc_dota_hero_chen_custom/chen_creep_time_warp",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_chen_creep_time_warp:IsHidden()
	return true
end
function modifier_chen_creep_time_warp:IsPurgable()
	return false
end
function modifier_chen_creep_time_warp:IsPurgeException()
	return false
end
