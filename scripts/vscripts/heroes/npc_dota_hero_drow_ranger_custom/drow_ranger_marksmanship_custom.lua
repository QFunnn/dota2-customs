...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_drow_ranger_custom/drow_ranger_marksmanship_custom",
...
LinkLuaModifier(
	"modifier_drow_ranger_marksmanship_custom_talent",
	"heroes/npc_dota_hero_drow_ranger_custom/drow_ranger_marksmanship_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_drow_ranger_marksmanship_custom_cannot_miss",
	"heroes/npc_dota_hero_drow_ranger_custom/drow_ranger_marksmanship_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function drow_ranger_marksmanship_custom:OnSpellStart()
	...
	for _, enemy in pairs(enemies) do
		...
		if drow_ranger_frost_arrows_custom then
			if
				drow_ranger_frost_arrows_custom:GetAutoCastState() and drow_ranger_frost_arrows_custom:IsFullyCastable()
			then
		...
		local projectile_info = {
			...
			iSourceAttachment = self:GetCaster()
				:GetAttachmentOrigin(self:GetCaster():ScriptLookupAttachment("attach_bow_eyes")),
			bDodgeable = true,
			bIsAttack = true,
...
function modifier_drow_ranger_marksmanship_custom:OnAttackStart(params)
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_drow_ranger_marksmanship_custom_cannot_miss", {})
	self.procs = true
end
...
function modifier_drow_ranger_marksmanship_custom_talent:IsHidden()
	return true
end
function modifier_drow_ranger_marksmanship_custom_talent:IsPurgable()
	return false
end
...
function modifier_drow_ranger_marksmanship_custom_cannot_miss:IsHidden()
	return true
end
function modifier_drow_ranger_marksmanship_custom_cannot_miss:IsPurgable()
	return false
end
function modifier_drow_ranger_marksmanship_custom_cannot_miss:IsPurgeException()
	return false
end
