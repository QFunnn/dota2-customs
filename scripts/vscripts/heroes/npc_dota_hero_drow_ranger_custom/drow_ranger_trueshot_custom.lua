...
LinkLuaModifier(
	"modifier_drow_ranger_trueshot_custom_aura",
	"heroes/npc_dota_hero_drow_ranger_custom/drow_ranger_trueshot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_drow_ranger_trueshot_custom",
	"heroes/npc_dota_hero_drow_ranger_custom/drow_ranger_trueshot_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_drow_ranger_trueshot_custom_aura:IsHidden()
	return true
end
function modifier_drow_ranger_trueshot_custom_aura:IsPurgable()
	return false
end
function modifier_drow_ranger_trueshot_custom_aura:IsPurgeException()
	return false
end
function modifier_drow_ranger_trueshot_custom_aura:RemoveOnDeath()
	return false
end
