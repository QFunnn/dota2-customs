...
LinkLuaModifier(
	"modifier_lina_slow_burn_custom",
	"heroes/npc_dota_hero_lina_custom/lina_slow_burn_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lina_slow_burn_custom_debuff",
	"heroes/npc_dota_hero_lina_custom/lina_slow_burn_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_lina_slow_burn_custom:IsHidden()
	return true
end
function modifier_lina_slow_burn_custom:IsPurgable()
	return false
end
function modifier_lina_slow_burn_custom:IsPurgeException()
	return false
end
function modifier_lina_slow_burn_custom:RemoveOnDeath()
	return false
end
...
function modifier_lina_slow_burn_custom:OnTakeDamage(params)
	...
	if params.inflictor:GetAbilityName() == "lina_fiery_soul_custom" then
		return
	end
	...
	params.unit:AddNewModifier(
		...
		self:GetAbility(),
		"modifier_lina_slow_burn_custom_debuff",
		{ duration = burn_duration, damage = burn_pct / 100 * params.damage }
	)
end

modifier_lina_slow_burn_custom_debuff = class({})

function modifier_lina_slow_burn_custom_debuff:GetAttributes()
