...
LinkLuaModifier(
	"modifier_winter_wyvern_frozen_cemetery",
	"heroes/npc_dota_hero_winter_wyvern_custom/winter_wyvern_frozen_cemetery",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_winter_wyvern_frozen_cemetery_debuff",
	"heroes/npc_dota_hero_winter_wyvern_custom/winter_wyvern_frozen_cemetery",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_winter_wyvern_frozen_cemetery:OnCreated()
	...
	local ground_fx =
		ParticleManager:CreateParticle("particles/wyvern_spell.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
	...
	local particle =
		ParticleManager:CreateParticle("particles/legion_magical_ring.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
