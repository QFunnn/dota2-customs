...
LinkLuaModifier(
	"modifier_winter_wyvern_eldwurms_edda_custom",
	"heroes/npc_dota_hero_winter_wyvern_custom/winter_wyvern_eldwurms_edda_custom",
...
function modifier_winter_wyvern_eldwurms_edda_custom:IsPurgable()
	return false
end
function modifier_winter_wyvern_eldwurms_edda_custom:IsPurgeException()
	return false
end
function modifier_winter_wyvern_eldwurms_edda_custom:IsHidden()
	return true
end
function modifier_winter_wyvern_eldwurms_edda_custom:RemoveOnDeath()
	return false
end
function modifier_winter_wyvern_eldwurms_edda_custom:OnCreated()
	...
	if self:GetAbility().inited then
		return
	end
