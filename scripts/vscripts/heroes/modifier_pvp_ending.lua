...
modifier_pvp_ending = class({}) ---@class CDOTA_Modifier_Lua
...
function modifier_pvp_ending:OnCreated()
	...
	self.LeavePortParticle =
		ParticleManager:CreateParticle("particles/items2_fx/teleport_start.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
...
modifier_pvp_ending_effect = class({}) ---@class CDOTA_Modifier_Lua
