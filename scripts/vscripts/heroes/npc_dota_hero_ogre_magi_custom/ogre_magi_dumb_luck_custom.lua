...
LinkLuaModifier(
	"modifier_ogre_magi_dumb_luck_custom",
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_dumb_luck_custom",
...
function modifier_ogre_magi_dumb_luck_custom:IsHidden()
	return true
end
function modifier_ogre_magi_dumb_luck_custom:IsPurgable()
	return false
end
function modifier_ogre_magi_dumb_luck_custom:RemoveOnDeath()
	return false
end
...
function modifier_ogre_magi_dumb_luck_custom:GetModifierManaBonus()
	...
	if self.parent:HasModifier("modifier_ogre_magi_6") then
		mana_per_str = mana_per_str
			+ self.ability.modifier_ogre_magi_6_mana[self.parent:GetTalentLevel("modifier_ogre_magi_6")]
	end
...
function modifier_ogre_magi_dumb_luck_custom:GetModifierConstantManaRegen()
	...
	if self.parent:HasModifier("modifier_ogre_magi_6") then
		mana_regen_per_str = mana_regen_per_str
			+ self.ability.modifier_ogre_magi_6_regen[self.parent:GetTalentLevel("modifier_ogre_magi_6")]
	end
