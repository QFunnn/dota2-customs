...
LinkLuaModifier(
	"modifier_ogre_magi_lightning_shield_custom_buff",
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_lightning_shield_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ogre_magi_lightning_shield_custom_spell_amp",
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_lightning_shield_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_ogre_magi_lightning_shield_custom_buff:IsHidden()
	return false
end
...
function modifier_ogre_magi_lightning_shield_custom_buff:OnCreated()
	...
	local particle_3 = ParticleManager:CreateParticle(
		"particles/ogre_magi_shield_electr/ogre_magi_shield_electr.vpcf",
...
function modifier_ogre_magi_lightning_shield_custom_buff:OnAbilityFullyCast(params)
	...
	if not self.caster:HasModifier("modifier_ogre_magi_20") then
		return
	end
	...
	self.parent:AddNewModifier(
		...
		"modifier_ogre_magi_lightning_shield_custom_spell_amp",
		{
			duration = self.ability.modifier_ogre_magi_20_duration[self.caster:GetTalentLevel("modifier_ogre_magi_20")],
			spell_amplify = spell_amplify,
		}
	)
end

modifier_ogre_magi_lightning_shield_custom_spell_amp = class({})
function modifier_ogre_magi_lightning_shield_custom_spell_amp:IsHidden()
	return false
end
function modifier_ogre_magi_lightning_shield_custom_spell_amp:IsPurgable()
	return false
end
function modifier_ogre_magi_lightning_shield_custom_spell_amp:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_ogre_magi_lightning_shield_custom_spell_amp:GetTexture()
	return "ogre_magi_20"
end
