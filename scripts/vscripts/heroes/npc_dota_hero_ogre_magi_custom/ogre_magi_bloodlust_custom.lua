...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_bloodlust_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ogre_magi_bloodlust_custom_aura",
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_bloodlust_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ogre_magi_bloodlust_custom_handler",
	"heroes/npc_dota_hero_ogre_magi_custom/ogre_magi_bloodlust_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function ogre_magi_bloodlust_custom:Spawn()
	...
	if
		...
		and not self:GetCaster():HasModifier("modifier_ogre_magi_bloodlust_custom_handler")
	then
...
function ogre_magi_bloodlust_custom:GestIntrinsicModifierName()
	if not self:GetCaster():HasModifier("modifier_ogre_magi_13") then
		return
	end
	if self:GetCaster():HasModifier("modifier_ogre_magi_17") then
		return
	end
...
function modifier_ogre_magi_bloodlust_custom_aura:IsHidden()
	return true
end
function modifier_ogre_magi_bloodlust_custom_aura:IsPurgable()
	return false
end
function modifier_ogre_magi_bloodlust_custom_aura:IsPurgeException()
	return false
end
function modifier_ogre_magi_bloodlust_custom_aura:RemoveOnDeath()
	return false
end
function modifier_ogre_magi_bloodlust_custom_aura:IsAura()
	return true
end
function modifier_ogre_magi_bloodlust_custom_aura:IsAuraActiveOnDeath()
	return false
end
function modifier_ogre_magi_bloodlust_custom_aura:GetModifierAura()
	return "modifier_ogre_magi_bloodlust_custom_buff"
end
function modifier_ogre_magi_bloodlust_custom_aura:GetAuraRadius()
	return 900
end
function modifier_ogre_magi_bloodlust_custom_aura:GetAuraDuration()
	return 0
end
function modifier_ogre_magi_bloodlust_custom_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_ogre_magi_bloodlust_custom_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_ogre_magi_bloodlust_custom_aura:GetAuraSearchFlags()
...
function modifier_ogre_magi_bloodlust_custom_handler:IsHidden()
	return true
end
function modifier_ogre_magi_bloodlust_custom_handler:IsPurgable()
	return false
end
function modifier_ogre_magi_bloodlust_custom_handler:IsPurgeException()
	return false
end
function modifier_ogre_magi_bloodlust_custom_handler:RemoveOnDeath()
	return false
end
...
function modifier_ogre_magi_bloodlust_custom_handler:OnIntervalThink()
	...
	if self:GetParent():HasModifier("modifier_ogre_magi_13") then
		return
	end
	if self:GetParent():HasModifier("modifier_ogre_magi_17") then
		return
	end
	...
	if
		...
		and not self:GetCaster():GetCurrentActiveAbility()
		and not self:GetCaster():HasModifier("modifier_ogre_magi_bloodlust_custom_buff")
	then
