...
LinkLuaModifier(
	"modifier_pugna_ward_winter_2018",
	"heroes/hero_pugna/modifier_pugna_ward_winter_2018",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_pugna_ward_winter_2018_effect",
	"heroes/hero_pugna/modifier_pugna_ward_winter_2018_effect",
	LUA_MODIFIER_MOTION_NONE
)
...
function pugna_ward_winter_2018:OnSpellStart()
	if IsServer() then
		...
		local hWard = CreateUnitByName(
			"npc_dota_pugna_ward_winter_2018",
