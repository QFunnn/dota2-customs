...
LinkLuaModifier(
	"modifier_weaver_auto_swarm_hidden",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_auto_swarm",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_auto_swarm_agility",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_auto_swarm_attack",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_auto_swarm_effect",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_auto_swarm_armor_debuff",
	"heroes/npc_dota_hero_weaver_custom/weaver_auto_swarm",
	LUA_MODIFIER_MOTION_NONE
)
	...
	if target then
		...
		if weaver_the_swarm_custom and weaver_the_swarm_custom:GetLevel() > 0 then
			...
			if self:GetCaster():HasModifier("modifier_weaver_8") then
				damage = damage
					+ weaver_the_swarm_custom.modifier_weaver_8[self:GetCaster():GetTalentLevel("modifier_weaver_8")]
			end
			if self:GetCaster():HasModifier("modifier_weaver_13") then
				armor_reduction = armor_reduction
					+ weaver_the_swarm_custom.modifier_weaver_13[self:GetCaster():GetTalentLevel("modifier_weaver_13")]
			end
			ApplyDamage({
				victim = target,
				damage = damage,
			...
			target:AddNewModifier(
				...
				self,
				"modifier_weaver_auto_swarm_armor_debuff",
				{ duration = 6, arm = armor_reduction }
			)
			if self:GetCaster():HasModifier("modifier_weaver_11") then
				target:Script_ReduceMana(
					damage
						/ 100
						* weaver_the_swarm_custom.modifier_weaver_11[self:GetCaster()
							:GetTalentLevel("modifier_weaver_11")],
...
function modifier_weaver_auto_swarm_hidden:IsHidden()
	return true
end
function modifier_weaver_auto_swarm_hidden:IsPurgable()
	return false
end
function modifier_weaver_auto_swarm_hidden:IsPurgeException()
	return false
end
function modifier_weaver_auto_swarm_hidden:RemoveOnDeath()
	return false
end
...
function modifier_weaver_auto_swarm:IsHidden()
	return true
end
function modifier_weaver_auto_swarm:IsPurgable()
	return false
end
function modifier_weaver_auto_swarm:RemoveOnDeath()
	return false
end
...
function modifier_weaver_auto_swarm_agility:IsHidden()
	return true
end
function modifier_weaver_auto_swarm_agility:IsPurgable()
	return false
end
function modifier_weaver_auto_swarm_agility:RemoveOnDeath()
	return false
end
...
function modifier_weaver_auto_swarm_effect:OnIntervalThink()
	...
	if
		...
		and not self:GetCaster():HasModifier("modifier_weaver_2")
	then
...
function modifier_weaver_auto_swarm_attack:IsHidden()
	return false
end
function modifier_weaver_auto_swarm_attack:IsDebuff()
	return false
end
function modifier_weaver_auto_swarm_attack:IsStunDebuff()
	return false
end
function modifier_weaver_auto_swarm_attack:IsPurgable()
	return false
end
