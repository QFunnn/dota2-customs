...
LinkLuaModifier(
	"modifier_weaver_time_lapse_custom",
	"heroes/npc_dota_hero_weaver_custom/weaver_time_lapse_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_weaver_time_lapse_custom_talent_purge",
	"heroes/npc_dota_hero_weaver_custom/weaver_time_lapse_custom",
	LUA_MODIFIER_MOTION_NONE
)
	...
	then
		...
		if self:GetCaster():HasModifier("modifier_weaver_19") then
			self:GetCaster():AddNewModifier(
				...
				self,
				"modifier_weaver_time_lapse_custom_talent_purge",
				{ duration = self.modifier_weaver_19 }
			)
		end
	end
end
...
function modifier_weaver_time_lapse_custom_talent_purge:IsPurgeException()
	return false
end
function modifier_weaver_time_lapse_custom_talent_purge:IsPurgable()
	return false
end
function modifier_weaver_time_lapse_custom_talent_purge:OnDestroy()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/items_fx/wand_of_sanctitude_purge.vpcf",
