...
function modifier_aghanim_apex:IsHidden()
	return true
end
function modifier_aghanim_apex:IsPurgable()
	return false
end
function modifier_aghanim_apex:IsPurgeException()
	return false
end
function modifier_aghanim_apex:RemoveOnDeath()
	return false
end
...
function modifier_aghanim_apex:GetModifierBonusStats_Strength()
	...
	if
		self:GetCaster():HasModifier("modifier_item_moon_aghanim")
		or self:GetCaster():HasModifier("modifier_item_moon_aghanim_buff")
	then
