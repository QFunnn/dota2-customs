...
LinkLuaModifier(
	"modifier_aghanim_bath_bubble_debuff",
	"heroes/npc_dota_hero_meepo_custom/aghanim_bath_bubble",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_aghanim_bath_bubble_buff",
	"heroes/npc_dota_hero_meepo_custom/aghanim_bath_bubble",
	LUA_MODIFIER_MOTION_NONE
)
...
function aghanim_bath_bubble:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_meepo.vpcf",
		context
	)
end
