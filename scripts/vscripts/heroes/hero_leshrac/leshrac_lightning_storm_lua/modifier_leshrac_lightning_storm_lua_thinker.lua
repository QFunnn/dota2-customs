...
function modifier_leshrac_lightning_storm_lua_thinker:OnRefresh(kv) end

function modifier_leshrac_lightning_storm_lua_thinker:OnRemoved() end
...
function modifier_leshrac_lightning_storm_lua_thinker:OnIntervalThink()
	...
	local enemies = FindUnitsInRadius(
		...
		self.current_target, -- handle, cacheUnit. (not known)
