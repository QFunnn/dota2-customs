...
LinkLuaModifier(
	"modifier_tiny_grow_custom",
	"heroes/npc_dota_hero_tiny_custom/tiny_grow_custom",
...
function tiny_grow_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_tiny.vpcf",
		context
	)
end
...
function tiny_grow_custom:OnUpgrade()
	...
	local grow = ParticleManager:CreateParticle(
