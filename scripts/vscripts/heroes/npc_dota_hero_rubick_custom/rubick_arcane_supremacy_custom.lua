...
LinkLuaModifier(
	"modifier_rubick_arcane_supremacy_custom",
	"heroes/npc_dota_hero_rubick_custom/rubick_arcane_supremacy_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_rubick_arcane_supremacy_buff",
	"heroes/npc_dota_hero_rubick_custom/rubick_arcane_supremacy_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_rubick_arcane_supremacy_debuff",
	"heroes/npc_dota_hero_rubick_custom/rubick_arcane_supremacy_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function rubick_arcane_supremacy_custom:OnToggle() end
...
function modifier_rubick_arcane_supremacy_custom:IsHidden()
	return true
end
function modifier_rubick_arcane_supremacy_custom:IsPurgable()
	return false
end
function modifier_rubick_arcane_supremacy_custom:IsPurgeException()
	return false
end
function modifier_rubick_arcane_supremacy_custom:RemoveOnDeath()
	return false
end
...
function modifier_rubick_arcane_supremacy_buff:IsPurgable()
	return false
end
function modifier_rubick_arcane_supremacy_buff:IsPurgeException()
	return false
end
...
function modifier_rubick_arcane_supremacy_debuff:IsPurgable()
	return false
end
function modifier_rubick_arcane_supremacy_debuff:IsPurgeException()
	return false
end
