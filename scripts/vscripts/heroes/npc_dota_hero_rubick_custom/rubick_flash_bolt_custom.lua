...
LinkLuaModifier(
	"modifier_rubick_flash_bolt_custom_fly",
	"heroes/npc_dota_hero_rubick_custom/rubick_flash_bolt_custom",
...
function rubick_flash_bolt_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_rubick_flash_bolt_custom_fly", { x = point.x, y = point.y })
end

modifier_rubick_flash_bolt_custom_fly = class({})
function modifier_rubick_flash_bolt_custom_fly:IsHidden()
	return true
end
function modifier_rubick_flash_bolt_custom_fly:IsPurgable()
	return false
end
