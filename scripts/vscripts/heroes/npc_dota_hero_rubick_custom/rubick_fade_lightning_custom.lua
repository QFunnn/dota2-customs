...
LinkLuaModifier(
	"modifier_rubick_fade_lightning_custom",
	"heroes/npc_dota_hero_rubick_custom/rubick_fade_lightning_custom",
...
function modifier_rubick_fade_lightning_custom:IsHidden()
	return true
end
function modifier_rubick_fade_lightning_custom:IsPurgable()
	return false
end
function modifier_rubick_fade_lightning_custom:IsPurgeException()
	return false
end
function modifier_rubick_fade_lightning_custom:RemoveOnDeath()
	return false
end
