...
function modifier_shredder_chakram_slow_lua:IsHidden()
	return false
end
function modifier_shredder_chakram_slow_lua:IsDebuff()
	return true
end
function modifier_shredder_chakram_slow_lua:IsStunDebuff()
	return false
end
function modifier_shredder_chakram_slow_lua:IsPurgable()
	return true
end
