...
LinkLuaModifier("modifier_shredder_chakram_thinker_lua", "heroes/hero_shredder/modifier_shredder_chakram_thinker_lua",
	LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shredder_chakram_slow_lua", "heroes/hero_shredder/modifier_shredder_chakram_slow_lua",
	LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shredder_chakram_disarm_lua", "heroes/hero_shredder/modifier_shredder_chakram_disarm_lua",
	LUA_MODIFIER_MOTION_NONE)
