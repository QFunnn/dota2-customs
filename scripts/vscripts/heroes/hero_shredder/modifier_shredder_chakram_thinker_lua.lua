...
function modifier_shredder_chakram_thinker_lua:OnCreated(kv)
	...
	self.chakram_particle_main = ParticleManager:GetParticleReplacement("particles/shredder_chakram_upd.vpcf", self.caster)
    ...
    ParticleManager:SetParticleControl(self.effect_cast, 1, Vector(self:GetAbility():GetSpecialValueFor("radius"), 0, 0) )
