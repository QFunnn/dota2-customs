...
LinkLuaModifier(
	"modifier_huskar_berserkers_blood_custom",
	"heroes/npc_dota_hero_huskar_custom/huskar_berserkers_blood_custom",
...
function huskar_berserkers_blood_custom:OnSpellStart()
	...
	local particle =
		ParticleManager:CreateParticle("particles/items2_fx/soul_ring.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
...
function modifier_huskar_berserkers_blood_custom:IsPurgeException()
	return false
end
function modifier_huskar_berserkers_blood_custom:RemoveOnDeath()
	return false
end
