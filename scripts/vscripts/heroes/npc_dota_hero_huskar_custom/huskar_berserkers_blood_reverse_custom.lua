...
LinkLuaModifier(
	"modifier_huskar_berserkers_blood_reverse_custom",
	"heroes/npc_dota_hero_huskar_custom/huskar_berserkers_blood_reverse_custom",
...
function modifier_huskar_berserkers_blood_reverse_custom:IsPurgable()
	return false
end
function modifier_huskar_berserkers_blood_reverse_custom:IsPurgeException()
	return false
end
function modifier_huskar_berserkers_blood_reverse_custom:RemoveOnDeath()
	return false
end
...
function modifier_huskar_berserkers_blood_reverse_custom:GetModifierAttackSpeedBonus_Constant()
	...
	if self:GetCaster():HasModifier("modifier_huskar_9") then
		maximum_attackspeed = maximum_attackspeed
			+ self:GetAbility().modifier_huskar_9[self:GetCaster():GetTalentLevel("modifier_huskar_9")]
	end
