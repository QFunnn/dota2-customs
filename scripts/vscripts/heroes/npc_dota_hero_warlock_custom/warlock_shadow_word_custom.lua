...
LinkLuaModifier(
	"modifier_warlock_shadow_word_custom",
	"heroes/npc_dota_hero_warlock_custom/warlock_shadow_word_custom",
...
function modifier_warlock_shadow_word_custom:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_warlock_shadow_word_custom:IsDebuff()
...
function modifier_warlock_shadow_word_custom:OnCreated()
	...
	if self:GetCaster():HasModifier("modifier_warlock_3") then
		self.spell_aoe = self.spell_aoe
			+ self:GetAbility().modifier_warlock_3[self:GetCaster():GetTalentLevel("modifier_warlock_3")]
	end
	...
	if self:GetCaster():HasModifier("modifier_warlock_5") then
		damage = damage
			+ (
				...
				/ 100
				* self:GetAbility().modifier_warlock_5[self:GetCaster():GetTalentLevel("modifier_warlock_5")]
			)
	end
