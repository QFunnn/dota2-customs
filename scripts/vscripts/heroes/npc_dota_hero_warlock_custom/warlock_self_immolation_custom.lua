...
LinkLuaModifier(
	"modifier_warlock_self_immolation_custom",
	"heroes/npc_dota_hero_warlock_custom/warlock_self_immolation_custom",
...
function modifier_warlock_self_immolation_custom:IsPurgable()
	return false
end
function modifier_warlock_self_immolation_custom:IsPurgeException()
	return false
end
function modifier_warlock_self_immolation_custom:RemoveOnDeath()
	return false
end
function modifier_warlock_self_immolation_custom:IsHidden()
	return true
end
