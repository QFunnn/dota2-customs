...
LinkLuaModifier(
	"modifier_warlock_flaming_fists_custom",
	"heroes/npc_dota_hero_warlock_custom/warlock_flaming_fists_custom",
...
function modifier_warlock_flaming_fists_custom:IsHidden()
	return true
end
function modifier_warlock_flaming_fists_custom:IsPurgable()
	return false
end
function modifier_warlock_flaming_fists_custom:IsPurgeException()
	return false
end
function modifier_warlock_flaming_fists_custom:RemoveOnDeath()
	return false
end
