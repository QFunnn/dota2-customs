...
LinkLuaModifier(
	"modifier_spirit_breaker_empowering_haste_lua",
	"heroes/hero_spirit_breaker/spirit_breaker_empowering_haste_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_spirit_breaker_empowering_haste_lua_mark",
	"heroes/hero_spirit_breaker/spirit_breaker_empowering_haste_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
