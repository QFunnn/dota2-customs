...
function modifier_ember_spirit_flame_guard_custom:IsDebuff()
	return false
end
function modifier_ember_spirit_flame_guard_custom:IsHidden()
	return false
end
...
function modifier_ember_spirit_flame_guard_custom:GetModifierMagicalResistanceBonus()
	if not self:GetCaster():HasTalent("special_bonus_unique_cha_ember_spirit") then
		return
	end
	return 50
end