...
LinkLuaModifier(
	"modifier_riki_frontstab_custom",
	"heroes/npc_dota_hero_riki_custom/riki_frontstab_custom",
...
function modifier_riki_frontstab_custom:IsHidden()
	return true
end
function modifier_riki_frontstab_custom:IsPurgable()
	return false
end
function modifier_riki_frontstab_custom:IsPurgeException()
	return false
end
function modifier_riki_frontstab_custom:RemoveOnDeath()
	return false
end
