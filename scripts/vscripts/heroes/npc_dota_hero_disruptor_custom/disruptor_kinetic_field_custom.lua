...
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom_big",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom_enemies",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom_friendly",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom_enemies_debuff",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_disruptor_kinetic_field_custom_friendly_buff",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_kinetic_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_disruptor_kinetic_field_custom:IsPurgable()
	return false
end
function modifier_disruptor_kinetic_field_custom:IsPurgeException()
	return false
end
function modifier_disruptor_kinetic_field_custom:GetAttributes()
	...
	if self.owner then
		...
		if self:GetCaster():HasModifier("modifier_disruptor_12") then
			self.duration = self.duration
				+ self:GetAbility().modifier_disruptor_12[self:GetCaster():GetTalentLevel("modifier_disruptor_12")]
		end
		AddFOWViewer(
			self:GetCaster():GetTeamNumber(),
...
function modifier_disruptor_kinetic_field_custom:GetModifierMoveSpeed_Limit(params)
	...
	if self.parent:HasModifier("modifier_woda_neutral_flying") then
		return
	end
...
function modifier_disruptor_kinetic_field_custom_enemies:IsHidden()
	return true
end
...
function modifier_disruptor_kinetic_field_custom_friendly:IsHidden()
	return true
end
...
function modifier_disruptor_kinetic_field_custom_enemies_debuff:GetTexture()
	return "disruptor_9"
end
...
function modifier_disruptor_kinetic_field_custom_enemies_debuff:OnIntervalThink()
	...
	local damage = self:GetCaster():GetAverageTrueAttackDamage(nil)
		/ 100
		* self:GetAbility().modifier_disruptor_9[self:GetCaster():GetTalentLevel("modifier_disruptor_9")]
	ApplyDamage({
...
function modifier_disruptor_kinetic_field_custom_friendly_buff:GetTexture()
	return "disruptor_10"
end
...
function modifier_disruptor_kinetic_field_custom_friendly_buff:OnIntervalThink()
	...
	local heal = self:GetCaster():GetAverageTrueAttackDamage(nil)
		/ 100
		* self:GetAbility().modifier_disruptor_10[self:GetCaster():GetTalentLevel("modifier_disruptor_10")]
...
function modifier_disruptor_kinetic_field_custom_big:IsPurgable()
	return false
end
function modifier_disruptor_kinetic_field_custom_big:IsPurgeException()
	return false
end
function modifier_disruptor_kinetic_field_custom_big:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
