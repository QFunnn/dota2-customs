...
LinkLuaModifier(
	"modifier_disruptor_static_mana",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_static_mana",
...
function disruptor_static_mana:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/items/disruptor/disruptor_2022_immortal/disruptor_2022_immortal_static_storm_hero_debuff.vpcf",
		context
	)
end
...
function modifier_disruptor_static_mana:OnIntervalThink()
	...
	local damage = self:GetAbility():GetSpecialValueFor("damage")
		+ (self:GetCaster():GetMana() / 100 * self:GetAbility():GetSpecialValueFor("damage_mana"))
