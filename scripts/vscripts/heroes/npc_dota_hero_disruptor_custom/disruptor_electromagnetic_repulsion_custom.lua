...
LinkLuaModifier(
	"modifier_disruptor_electromagnetic_repulsion_custom",
	"heroes/npc_dota_hero_disruptor_custom/disruptor_electromagnetic_repulsion_custom",
...
function modifier_disruptor_electromagnetic_repulsion_custom:IsPurgable()
	return false
end
function modifier_disruptor_electromagnetic_repulsion_custom:IsPurgeException()
	return false
end
function modifier_disruptor_electromagnetic_repulsion_custom:IsPurgeException()
	return false
end
function modifier_disruptor_electromagnetic_repulsion_custom:IsHidden()
	return true
end
function modifier_disruptor_electromagnetic_repulsion_custom:RemoveOnDeath()
	return false
end
...
function modifier_disruptor_electromagnetic_repulsion_custom:OnTakeDamage(params)
	...
	if self.current_damage >= self.damage_threshold then
		...
		local particle = ParticleManager:CreateParticle(
			"particles/units/heroes/hero_disruptor/disruptor_pulse_knockback_area.vpcf",
