...
LinkLuaModifier(
	"modifier_pangolier_heartpiercer_custom",
	"heroes/hero_pangolier/pangolier_heartpiercer_custom",
...
function modifier_pangolier_heartpiercer_custom:IsHidden()
	return true
end
function modifier_pangolier_heartpiercer_custom:IsPurgable()
	return false
end
function modifier_pangolier_heartpiercer_custom:GetAttributes()
