...
LinkLuaModifier(
	...
	"heroes/hero_pangolier/pangolier_lucky_shot_custom",
...
function modifier_pangolier_lucky_shot_custom:GetAttributes()
...
function modifier_pangolier_lucky_shot_custom:GetModifierTotalDamageOutgoing_Percentage(params)
	...
	if
		params.damage_category == DOTA_DAMAGE_CATEGORY_ATTACK
		or (params.inflictor and proc_abilities[params.inflictor:GetAbilityName()])
	then
