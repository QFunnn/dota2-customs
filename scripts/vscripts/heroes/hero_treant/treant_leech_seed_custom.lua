...
LinkLuaModifier(
	"modifier_treant_leech_seed_custom",
	"heroes/hero_treant/treant_leech_seed_custom",
...
function modifier_treant_leech_seed_custom:IsPurgable()
	return true
end
function modifier_treant_leech_seed_custom:RemoveOnDeath()
	return false
end
