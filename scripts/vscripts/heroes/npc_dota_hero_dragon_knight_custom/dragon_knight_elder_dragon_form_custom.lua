...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_elder_dragon_form_custom",
...
LinkLuaModifier(
	"modifier_dragon_knight_elder_dragon_form_custom_corrosive",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_elder_dragon_form_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dragon_knight_elder_dragon_form_custom_frost",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_elder_dragon_form_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function dragon_knight_elder_dragon_form_custom:GetBehavior()
	...
	if
		self:GetCaster():HasModifier("modifier_dragon_knight_1")
		and self:GetCaster():HasModifier("modifier_dragon_knight_8")
		and self:GetCaster():HasModifier("modifier_dragon_knight_15")
	then
		return DOTA_ABILITY_BEHAVIOR_PASSIVE
	end
...
function dragon_knight_elder_dragon_form_custom:AttackTargetSplash(target, damage)
	...
	if self:GetLevel() < 2 and self:GetCaster():HasModifier("modifier_dragon_knight_1") then
		...
		range_cleave = self.modifier_dragon_knight_1_radius[talent_level]
			or self.modifier_dragon_knight_1_radius[1]
			or range_cleave
	...
	if self:GetCaster():HasModifier("modifier_dragon_knight_1") then
		cleave_damage = cleave_damage
			+ self.modifier_dragon_knight_1[self:GetCaster():GetTalentLevel("modifier_dragon_knight_1")]
	end
...
function dragon_knight_elder_dragon_form_custom:CorrosiveTarget(target)
	...
	target:AddNewModifier(
		...
		self,
		"modifier_dragon_knight_elder_dragon_form_custom_corrosive",
		{ duration = corrosion_duration * (1 - target:GetStatusResistance()) }
	)
end
...
function dragon_knight_elder_dragon_form_custom:ColdTarget(target)
	...
	if self:GetLevel() < 3 and self:GetCaster():HasModifier("modifier_dragon_knight_15") then
		...
		slow_duration = self.modifier_dragon_knight_15_duration[talent_level]
			or self.modifier_dragon_knight_15_duration[1]
			or slow_duration
	end
...
function modifier_dragon_knight_elder_dragon_form_custom_1:IsPurgable()
	return false
end
function modifier_dragon_knight_elder_dragon_form_custom_1:RemoveOnDeath()
	return not (
		self:GetParent():HasModifier("modifier_dragon_knight_21")
		or self:GetParent():HasModifier("modifier_dragon_knight_7")
		or self:GetParent():HasModifier("modifier_dragon_knight_14")
		or (
			self:GetParent():HasModifier("modifier_dragon_knight_1")
			and self:GetParent():HasModifier("modifier_dragon_knight_8")
...
function modifier_dragon_knight_elder_dragon_form_custom_1:CheckState()
	return {
		[MODIFIER_STATE_ALLOW_PATHING_THROUGH_TREES] = self:GetAbility():GetSpecialValueFor("flying_movement") >= 1
			or nil,
...
function modifier_dragon_knight_elder_dragon_form_custom_2:IsPurgable()
	return false
end
...
function modifier_dragon_knight_elder_dragon_form_custom_3:IsPurgable()
	return false
end
...
function modifier_dragon_knight_elder_dragon_form_custom_4:IsPurgable()
	return false
end
...
function modifier_dragon_knight_elder_dragon_form_custom_corrosive:UpdateDamage()
	...
	if self:GetCaster():HasModifier("modifier_dragon_knight_8") then
		self.damage_per_second = self.damage_per_second
			+ self:GetAbility().modifier_dragon_knight_8[self:GetCaster():GetTalentLevel("modifier_dragon_knight_8")]
	end
end
...
function modifier_dragon_knight_elder_dragon_form_custom_corrosive:OnIntervalThink()
	...
	ApplyDamage({
		...
		damage = self.damage_per_second * stack,
...
function modifier_dragon_knight_elder_dragon_form_custom_frost:OnCreated(kv)
	...
	if self:GetCaster():HasModifier("modifier_dragon_knight_15") then
		self.slow = self.slow
			+ self:GetAbility().modifier_dragon_knight_15[self:GetCaster():GetTalentLevel("modifier_dragon_knight_15")]
		self.slow_attack_speed = self.slow_attack_speed
			+ self:GetAbility().modifier_dragon_knight_15_attack[self:GetCaster()
				:GetTalentLevel("modifier_dragon_knight_15")]
	end
end
