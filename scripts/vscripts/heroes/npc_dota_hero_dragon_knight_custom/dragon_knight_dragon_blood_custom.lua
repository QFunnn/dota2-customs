...
LinkLuaModifier(
	"modifier_dragon_knight_dragon_blood_custom",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_dragon_blood_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dragon_knight_dragon_blood_custom_poison_blood",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_dragon_blood_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dragon_knight_dragon_blood_custom_poison_blood_stack",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_dragon_blood_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_dragon_knight_dragon_blood_custom:HasDragonForm()
	if
		self:GetCaster():HasModifier("modifier_dragon_knight_elder_dragon_form_custom_1")
		...
		or self:GetCaster():HasModifier("modifier_dragon_knight_elder_dragon_form_custom_4")
	then
		return true
	end
	return false
...
function modifier_dragon_knight_dragon_blood_custom:OnCreated(kv)
	...
	self.regen_and_armor_multiplier_during_dragon_form = self:GetAbility():GetSpecialValueFor(
...
function modifier_dragon_knight_dragon_blood_custom:OnAttackLanded(params)
	...
	if self:GetParent():HasModifier("modifier_dragon_knight_12") then
		params.attacker:AddNewModifier(
			...
			"modifier_dragon_knight_dragon_blood_custom_poison_blood_stack",
			{
				duration = self:GetAbility().modifier_dragon_knight_12_stack_duration[self:GetCaster():GetTalentLevel(
					"modifier_dragon_knight_12"
				)],
			}
		)
		params.attacker:AddNewModifier(
...
function modifier_dragon_knight_dragon_blood_custom_poison_blood:IsPurgable()
	return false
end
...
function modifier_dragon_knight_dragon_blood_custom_poison_blood:OnIntervalThink()
	...
	local stack = self:GetParent()
		:FindAllModifiersByName("modifier_dragon_knight_dragon_blood_custom_poison_blood_stack")
	if #stack > 0 then
...
function modifier_dragon_knight_dragon_blood_custom_poison_blood_stack:IsHidden()
	return true
end
function modifier_dragon_knight_dragon_blood_custom_poison_blood_stack:GetAttributes()
