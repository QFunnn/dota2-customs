...
LinkLuaModifier(
	"modifier_dragon_knight_ice_ball",
	"heroes/npc_dota_hero_dragon_knight_custom/dragon_knight_ice_ball",
...
function dragon_knight_ice_ball:PlayEffects(point)
	local effect_cast = ParticleManager:CreateParticle(
		"dragon_knight_shard_fireball_projectile",
...
function modifier_dragon_knight_ice_ball:OnIntervalThink()
	...
	local damage = self:GetAbility():GetSpecialValueFor("damage")
		+ (self:GetCaster():GetIntellect(false) / 100 * self:GetAbility():GetSpecialValueFor("intellect_mult"))
	ApplyDamage({
...
function modifier_dragon_knight_ice_ball:PlayEffects()
	self.pfx =
		ParticleManager:CreateParticle("particles/dragon_knight_shard_fireball_2.vpcf", PATTACH_POINT, self:GetParent())
