...
function CastIllusoryOrb(event)
	...
	local projID = ProjectileManager:CreateLinearProjectile({
		Ability = ability,
		EffectName = "particles/units/heroes/hero_puck/puck_illusory_orb_tracking_projectile.vpcf", --"particles/units/heroes/hero_puck/puck_illusory_orb.vpcf",
...
function CastEtherealJaunt(event) end
