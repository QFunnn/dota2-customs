...
LinkLuaModifier(
	"modifier_kez_switch_weapons_custom",
	"heroes/npc_dota_hero_kez_custom/kez_switch_weapons_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_kez_switch_weapons_custom_handler",
	"heroes/npc_dota_hero_kez_custom/kez_switch_weapons_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_kez_switch_weapons_custom_scepter",
	"heroes/npc_dota_hero_kez_custom/kez_switch_weapons_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_kez_switch_weapons_custom_bonus_movespeed",
	"heroes/npc_dota_hero_kez_custom/kez_switch_weapons_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_kez_switch_weapons_custom_bonus_damage",
	"heroes/npc_dota_hero_kez_custom/kez_switch_weapons_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function kez_switch_weapons_custom:OnSpellStart()
	...
	if modifier_kez_switch_weapons_custom then
		...
		local modifier_kez_switch_weapons_custom_bonus_movespeed =
			self:GetCaster():FindModifierByName("modifier_kez_switch_weapons_custom_bonus_movespeed")
		...
		self:GetCaster():AddNewModifier(
			...
			self,
			"modifier_kez_switch_weapons_custom_bonus_movespeed",
			{ duration = self:GetSpecialValueFor("sai_swap_duration") }
		)
		local modifier_kez_switch_weapons_custom_bonus_damage =
			self:GetCaster():FindModifierByName("modifier_kez_switch_weapons_custom_bonus_damage")
...
function modifier_kez_switch_weapons_custom:IsHidden()
	return true
end
function modifier_kez_switch_weapons_custom:IsPurgable()
	return false
end
function modifier_kez_switch_weapons_custom:IsPurgeException()
	return false
end
function modifier_kez_switch_weapons_custom:RemoveOnDeath()
	return false
end
...
function modifier_kez_switch_weapons_custom_handler:IsHidden()
	return true
end
function modifier_kez_switch_weapons_custom_handler:IsPurgeException()
	return false
end
function modifier_kez_switch_weapons_custom_handler:RemoveOnDeath()
	return false
end
function modifier_kez_switch_weapons_custom_handler:IsPurgable()
	return false
end
...
function modifier_kez_switch_weapons_custom_handler:GetModifierBaseAttack_BonusDamage()
	...
	if self:GetCaster():HasModifier("modifier_kez_1") then
		return self:GetAbility():GetSpecialValueFor("katana_agility_bonus_base_damage")
			/ 100
...
function modifier_kez_switch_weapons_custom_handler:GetModifierTotalDamageOutgoing_Percentage()
	if not self:GetParent():HasModifier("modifier_kez_switch_weapons_custom_bonus_damage") then
		return
	end
...
function modifier_kez_switch_weapons_custom_scepter:IsPurgable()
	return false
end
function modifier_kez_switch_weapons_custom_scepter:IsPurgeException()
	return false
end

modifier_kez_switch_weapons_custom_bonus_movespeed = class({})
function modifier_kez_switch_weapons_custom_bonus_movespeed:IsPurgable()
	return false
end
function modifier_kez_switch_weapons_custom_bonus_movespeed:GetTexture()
	return "kez_switch_weapons_sai"
end
...
function modifier_kez_switch_weapons_custom_bonus_movespeed:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_kez/kez_flutter_sai.vpcf",
...
function modifier_kez_switch_weapons_custom_bonus_damage:IsHidden()
	return self:GetStackCount() == 1
end
function modifier_kez_switch_weapons_custom_bonus_damage:IsPurgable()
	return false
end
function modifier_kez_switch_weapons_custom_bonus_damage:GetTexture()
	return "kez_switch_weapons_katana"
end
...
function modifier_kez_switch_weapons_custom_bonus_damage:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_kez/kez_flutter_katana.vpcf",
		PATTACH_CUSTOMORIGIN_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControlEnt(
