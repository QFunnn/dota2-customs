...
LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_aura",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)

LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_buff",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_aura_buff",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)

LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)

LinkLuaModifier(
	"modifier_ancient_apparition_ice_vortex_custom_stack_debuff",
	"heroes/npc_dota_hero_ancient_apparition_custom/ancient_apparition_ice_vortex_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function ancient_apparition_ice_vortex_custom:OnSpellStart()
	...
	if
		self:GetCaster():HasModifier("modifier_ancient_apparition_10")
		or self:GetCaster():HasModifier("modifier_ancient_apparition_13")
	then
		CreateModifierThinker(
			self:GetCaster(),
			self,
...
function modifier_ancient_apparition_ice_vortex_custom:IsHidden()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom:IsAura()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom:IsAuraActiveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom:GetAuraRadius()
	return self.radius
end
function modifier_ancient_apparition_ice_vortex_custom:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_ancient_apparition_ice_vortex_custom:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_ancient_apparition_ice_vortex_custom:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_ancient_apparition_ice_vortex_custom:GetModifierAura()
	return "modifier_ancient_apparition_ice_vortex_custom_aura"
end
...
function modifier_ancient_apparition_ice_vortex_custom_buff:IsHidden()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_buff:IsAura()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_buff:IsAuraActiveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_buff:GetAuraRadius()
	return self.radius
end
function modifier_ancient_apparition_ice_vortex_custom_buff:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_ancient_apparition_ice_vortex_custom_buff:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_ancient_apparition_ice_vortex_custom_buff:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_ancient_apparition_ice_vortex_custom_buff:GetModifierAura()
	return "modifier_ancient_apparition_ice_vortex_custom_aura_buff"
end

modifier_ancient_apparition_ice_vortex_custom_aura_buff = class({})

function modifier_ancient_apparition_ice_vortex_custom_aura_buff:IsHidden()
	return not self:GetCaster():HasModifier("modifier_ancient_apparition_10")
end
...
function modifier_ancient_apparition_ice_vortex_custom_aura_buff:GetModifierMagicalResistanceBonus()
	if self:GetCaster():HasModifier("modifier_ancient_apparition_13") then
		return self:GetAbility().modifier_ancient_apparition_13[self:GetCaster()
			:GetTalentLevel("modifier_ancient_apparition_13")]
	end
end
...
function modifier_ancient_apparition_ice_vortex_custom_aura_buff:GetModifierAttackSpeedBonus_Constant()
	if self:GetCaster():HasModifier("modifier_ancient_apparition_10") then
		return self:GetAbility().modifier_ancient_apparition_10_attackspeed[self:GetCaster():GetTalentLevel(
			"modifier_ancient_apparition_10"
		)]
	end
end

function modifier_ancient_apparition_ice_vortex_custom_aura_buff:GetModifierProperty_MagicalLifesteal()
	if not self:GetCaster():HasModifier("modifier_ancient_apparition_10") then
		return
	end
	return self:GetAbility().modifier_ancient_apparition_10_lifesteal[self:GetCaster()
		:GetTalentLevel("modifier_ancient_apparition_10")]
end
...
function modifier_ancient_apparition_ice_vortex_custom_aura:OnIntervalThink()
	...
	if self:GetCaster():HasModifier("modifier_ancient_apparition_1") then
		damage = damage
			+ self:GetAbility().modifier_ancient_apparition_1[self:GetCaster()
				:GetTalentLevel("modifier_ancient_apparition_1")]
	end
	if self:GetCaster():HasModifier("modifier_ancient_apparition_3") then
		damage = damage
			+ (self:GetCaster():GetPhysicalArmorValue(false) / 100 * self:GetAbility().modifier_ancient_apparition_3)
	end
	local damageTable = {
	...
	if self:GetCaster():HasModifier("modifier_ancient_apparition_6") then
		self:GetParent():AddNewModifier(
			...
			self:GetAbility(),
			"modifier_ancient_apparition_ice_vortex_custom_stack_debuff",
			{ duration = self:GetAbility().modifier_ancient_apparition_6_duration }
		)
	end
end
...
function modifier_ancient_apparition_ice_vortex_custom_aura:GetModifierAttackSpeedBonus_Constant()
	if self:GetCaster():HasModifier("modifier_ancient_apparition_2") then
		return self:GetAbility().modifier_ancient_apparition_2[self:GetCaster()
			:GetTalentLevel("modifier_ancient_apparition_2")]
	end
end
...
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:IsHidden()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:IsPurgable()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:RemoveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:IsPurgeException()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:OnCreated()
	...
	self.radius = self:GetCaster():GetAoeBonus(
		self:GetAbility().modifier_ancient_apparition_4[self:GetCaster():GetTalentLevel("modifier_ancient_apparition_4")]
	)
	self.vortex_particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_ancient_apparition/ancient_ice_vortex.vpcf",
		PATTACH_POINT_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControlEnt(
		self.vortex_particle,
		0,
		self:GetCaster(),
		PATTACH_POINT_FOLLOW,
		"attach_hitloc",
	...
	self.particle =
		ParticleManager:CreateParticle("particles/apparat_lich_radius.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
	ParticleManager:SetParticleControlEnt(
		self.particle,
		1,
		self:GetParent(),
...
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:OnIntervalThink()
	...
	if self.radius ~= self.current_radius then
		...
		self.particle = ParticleManager:CreateParticle(
			"particles/apparat_lich_radius.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			self:GetParent()
		)
		ParticleManager:SetParticleControlEnt(
...
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:IsAura()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:IsAuraActiveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:GetAuraRadius()
	return self.radius
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_ancient_apparition_ice_vortex_custom_debuff_aura_talent:GetModifierAura()
	return "modifier_ancient_apparition_ice_vortex_custom_aura"
end
...
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:IsHidden()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:IsPurgable()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:RemoveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:IsPurgeException()
	return false
end
...
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:IsAura()
	return true
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:IsAuraActiveOnDeath()
	return false
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:GetAuraRadius()
	return self.radius
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_ancient_apparition_ice_vortex_custom_buff_aura_talent:GetModifierAura()
	return "modifier_ancient_apparition_ice_vortex_custom_aura_buff"
end

modifier_ancient_apparition_ice_vortex_custom_stack_debuff = class({})

function modifier_ancient_apparition_ice_vortex_custom_stack_debuff:GetTexture()
	return "ancient_apparation_3"
end
...
function modifier_ancient_apparition_ice_vortex_custom_stack_debuff:OnRefresh()
	...
	if self:GetStackCount() >= self:GetAbility().modifier_ancient_apparition_6_max_stacks then
		return
	end
...
function modifier_ancient_apparition_ice_vortex_custom_stack_debuff:OnIntervalThink()
	...
	SendOverheadEventMessage(
		...
		self:GetParent(),
		self:GetAbility().modifier_ancient_apparition_6_damage * self:GetStackCount(),
		nil
	)
	ApplyDamage(damageTable)
end
