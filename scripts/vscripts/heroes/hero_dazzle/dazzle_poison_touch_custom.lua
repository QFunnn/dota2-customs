...
LinkLuaModifier(
	...
	"heroes/hero_dazzle/dazzle_poison_touch_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dazzle_poison_touch_hex",
	"heroes/hero_dazzle/dazzle_poison_touch_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dazzle_poison_touch_custom_passive",
	"heroes/hero_dazzle/dazzle_poison_touch_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function dazzle_poison_touch_custom:OnProjectileHit_ExtraData(target, location, extraData)
	...
	if has_shard then
		...
		ParticleManager:ReleaseParticleIndex(
			ParticleManager:CreateParticle("particles/items_fx/item_sheepstick.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
		)
	end
...
modifier_dazzle_poison_touch_custom = class({
	...
	OnTakeDamage = function(self, params)
		...
		if
			params.inflictor
			and not params.inflictor:IsNull()
			and params.inflictor:GetAbilityName() == "dazzle_poison_touch_custom"
		then
			return
		end
