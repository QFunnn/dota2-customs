...
LinkLuaModifier(
	...
	"heroes/hero_dazzle/dazzle_bad_juju_custom",
...
function modifier_dazzle_bad_juju_custom:GetModifierPhysicalArmorBonus()
	return (self.BonusArmor or 0) * self:GetStackCount()
end