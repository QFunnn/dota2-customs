...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_dark_form",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_keeper_of_the_light_dark_form_debuff",
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_dark_form",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_keeper_of_the_light_dark_form_fx",
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_dark_form",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_keeper_of_the_light_dark_form:IsHidden()
	return true
end
function modifier_keeper_of_the_light_dark_form:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_dark_form:IsPurgeException()
	return false
end
function modifier_keeper_of_the_light_dark_form:RemoveOnDeath()
	return false
end
function modifier_keeper_of_the_light_dark_form:IsAura()
	return true
end
function modifier_keeper_of_the_light_dark_form:GetModifierAura()
	return "modifier_keeper_of_the_light_dark_form_debuff"
end
function modifier_keeper_of_the_light_dark_form:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end
function modifier_keeper_of_the_light_dark_form:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_INVULNERABLE
end
function modifier_keeper_of_the_light_dark_form:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_keeper_of_the_light_dark_form:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_keeper_of_the_light_dark_form:GetAuraDuration()
	return 0
end
...
function modifier_keeper_of_the_light_dark_form:OnIntervalThink()
	...
	if not self:GetParent():IsAlive() then
		...
		if not self:GetParent():HasModifier("modifier_keeper_of_the_light_dark_form_fx") then
			self:GetParent()
				:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_keeper_of_the_light_dark_form_fx", {})
		end
		self:StartIntervalThink(1)
	end
end
...
function modifier_keeper_of_the_light_dark_form_fx:IsHidden()
	return true
end
function modifier_keeper_of_the_light_dark_form_fx:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_dark_form_fx:IsPurgeException()
	return false
end
