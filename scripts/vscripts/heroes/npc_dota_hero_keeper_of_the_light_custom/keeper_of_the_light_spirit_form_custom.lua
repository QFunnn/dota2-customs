...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_spirit_form_custom",
...
function modifier_keeper_of_the_light_spirit_form_custom:IsPurgeException()
	return false
end
