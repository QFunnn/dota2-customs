...
LinkLuaModifier(
	"modifier_keeper_of_the_light_obscure",
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_obscure",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_keeper_of_the_light_obscure_thinker",
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_obscure",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function keeper_of_the_light_obscure:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/units/heroes/hero_keeper_of_the_light/keeper_of_the_light_obscure_impact.vpcf",
		context
	)
end
...
function keeper_of_the_light_obscure:OnSpellStart()
	...
	self[index] = {}
	local modifier_keeper_of_the_light_obscure = self:GetCaster():AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_keeper_of_the_light_obscure",
...
function modifier_keeper_of_the_light_obscure:IsHidden()
	return true
end
function modifier_keeper_of_the_light_obscure:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_obscure:OnCreated(params)
	...
	if self:GetParent() == self:GetCaster() then
		local particle = ParticleManager:CreateParticle(
			"particles/units/heroes/hero_keeper_of_the_light/obscure_cast.vpcf",
	...
	self:GetCaster()
		:SwapAbilities("keeper_of_the_light_obscure", "keeper_of_the_light_illuminate_end_custom", false, true)
...
function modifier_keeper_of_the_light_obscure:OnDestroy()
	...
	self:GetCaster():AddNewModifier(
		...
		self:GetAbility(),
		"modifier_keeper_of_the_light_obscure_motion",
		{ duration = distance / speed, direction_x = vVelocity.x, direction_y = vVelocity.y }
	)
	...
	self:GetCaster()
		:SwapAbilities("keeper_of_the_light_illuminate_end_custom", "keeper_of_the_light_obscure", false, true)
end
...
function modifier_keeper_of_the_light_obscure_thinker:OnCreated(params)
	...
	self.particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_keeper_of_the_light/kotl_obscure.vpcf",
...
function modifier_keeper_of_the_light_obscure_motion:IsHidden()
	return true
end
function modifier_keeper_of_the_light_obscure_motion:IsPurgable()
	return false
end
function modifier_keeper_of_the_light_obscure_motion:IsPurgeException()
	return false
end
