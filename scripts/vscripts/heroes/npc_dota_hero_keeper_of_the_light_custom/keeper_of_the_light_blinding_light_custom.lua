...
LinkLuaModifier(
	"modifier_keeper_of_the_light_blinding_light_custom_debuff",
	"heroes/npc_dota_hero_keeper_of_the_light_custom/keeper_of_the_light_blinding_light_custom",
...
function keeper_of_the_light_blinding_light_custom:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_keeper_of_the_light_18") then
		damage = damage
			+ self.modifier_keeper_of_the_light_18_damage[self:GetCaster()
				:GetTalentLevel("modifier_keeper_of_the_light_18")]
	end
	if self:GetCaster():HasModifier("modifier_keeper_of_the_light_1") then
		damage = damage
			+ (
				...
				/ 100
				* self.modifier_keeper_of_the_light_1[self:GetCaster():GetTalentLevel("modifier_keeper_of_the_light_1")]
			)
	end
...
function modifier_keeper_of_the_light_blinding_light_custom_debuff:OnCreated()
	...
	if self:GetCaster():HasModifier("modifier_keeper_of_the_light_18") then
		self.miss_rate = self.miss_rate
			+ self:GetAbility().modifier_keeper_of_the_light_18[self:GetCaster()
				:GetTalentLevel("modifier_keeper_of_the_light_18")]
	end
end
