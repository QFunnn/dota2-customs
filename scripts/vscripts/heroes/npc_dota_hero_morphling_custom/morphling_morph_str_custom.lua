...
LinkLuaModifier(
	"modifier_morphling_morph_str_custom",
	"heroes/npc_dota_hero_morphling_custom/morphling_morph_str_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_morphling_morph_str_custom_interval",
	"heroes/npc_dota_hero_morphling_custom/morphling_morph_str_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_morphling_morph_str_custom:IsPurgable()
	return false
end
function modifier_morphling_morph_str_custom:IsHidden()
	return true
end
...
function modifier_morphling_morph_str_custom_interval:IsPurgable()
	return false
end
function modifier_morphling_morph_str_custom_interval:IsHidden()
	return true
end
