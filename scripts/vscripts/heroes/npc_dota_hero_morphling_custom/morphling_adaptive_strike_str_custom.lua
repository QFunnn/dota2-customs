...
LinkLuaModifier(
	"modifier_morphling_adaptive_strike_str_custom",
	"heroes/npc_dota_hero_morphling_custom/morphling_adaptive_strike_str_custom",
...
function modifier_morphling_adaptive_strike_str_custom:IsPurgable()
	return false
end
function modifier_morphling_adaptive_strike_str_custom:IsHidden()
	return true
end
