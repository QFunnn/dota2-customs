...
function modifier_dark_seer_wall_of_replica_nb2017:OnCreated( kv )
	...
	if IsServer() then
		self.replica_damage_outgoing = self:GetAbility():GetSpecialValueFor( "replica_damage_outgoing" ) + self:GetCaster():GetTalentValue("special_bonus_unique_dark_seer_7")		
