...
LinkLuaModifier(
	"modifier_skywrath_mage_ancient_seal_custom",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_ancient_seal_custom",
...
function skywrath_mage_ancient_seal_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_skywrath_mage.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_skywrath_mage.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_skywrath_mage.vpcf",
		context
	)
end
...
function modifier_skywrath_mage_ancient_seal_custom:GetModifierPropertyRestorationAmplification()
	if self:GetCaster():HasModifier("modifier_skywrath_mage_18") then
		return self:GetAbility().modifier_skywrath_mage_18_heal[self:GetCaster()
			:GetTalentLevel("modifier_skywrath_mage_18")]
	end
	return 0
end
