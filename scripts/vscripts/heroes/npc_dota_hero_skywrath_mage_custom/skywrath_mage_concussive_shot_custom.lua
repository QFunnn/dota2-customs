...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_concussive_shot_custom_14",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_concussive_shot_custom_15",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_concussive_shot_custom_15_stack",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_concussive_shot_custom_friendly_15",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_concussive_shot_custom_friendly_15_stack",
	"heroes/npc_dota_hero_skywrath_mage_custom/skywrath_mage_concussive_shot_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function skywrath_mage_concussive_shot_custom:GetCooldown(level)
	...
	if self:GetCaster():HasModifier("modifier_skywrath_mage_13") then
		cooldown = cooldown
			- self.modifier_skywrath_mage_13[self:GetCaster():GetTalentLevel("modifier_skywrath_mage_13")]
	end
	return cooldown
end
...
function modifier_skywrath_mage_concussive_shot_custom_14:IsHidden()
	return not self:GetCaster():HasModifier("modifier_skywrath_mage_14")
end
function modifier_skywrath_mage_concussive_shot_custom_14:IsPurgable()
	return false
end
...
function modifier_skywrath_mage_concussive_shot_custom_14:OnAttackLanded(params)
	...
	if not self:GetParent():HasModifier("modifier_skywrath_mage_14") then
		return
	end
	...
	if
		self:GetStackCount()
		>= self:GetAbility().modifier_skywrath_mage_14_count[self:GetCaster()
			:GetTalentLevel("modifier_skywrath_mage_14")]
	then
