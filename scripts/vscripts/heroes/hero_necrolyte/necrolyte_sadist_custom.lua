...
LinkLuaModifier(
	"modifier_ghost_shroud_custom_active",
	"heroes/hero_necrolyte/necrolyte_sadist_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ghost_shroud_custom_aura",
	"heroes/hero_necrolyte/necrolyte_sadist_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ghost_shroud_custom_aura_debuff",
	"heroes/hero_necrolyte/necrolyte_sadist_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ghost_shroud_custom_buff",
	"heroes/hero_necrolyte/necrolyte_sadist_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_ghost_shroud_custom_debuff",
	"heroes/hero_necrolyte/necrolyte_sadist_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function necrolyte_sadist_custom:OnSpellStart()
	if IsServer() then
		...
		caster:AddNewModifier(
			...
			self,
			"modifier_ghost_shroud_custom_aura",
			{ duration = duration, radius = radius, healing_amp_pct = healing_amp_pct, slow_pct = slow_pct }
		)
		caster:AddNewModifier(
			caster,
			self,
...
function modifier_ghost_shroud_custom_active:IsHidden()
	return false
end
function modifier_ghost_shroud_custom_active:IsPurgable()
	return true
end
...
function modifier_ghost_shroud_custom_aura:IsHidden()
	return false
end
function modifier_ghost_shroud_custom_aura:IsPurgable()
	return false
end
function modifier_ghost_shroud_custom_aura:IsAura()
	return true
end
...
function modifier_ghost_shroud_custom_buff:IsDebuff()
	return false
end
...
function modifier_ghost_shroud_custom_aura_debuff:IsHidden()
	return true
end
function modifier_ghost_shroud_custom_aura_debuff:IsPurgable()
	return false
end
function modifier_ghost_shroud_custom_aura_debuff:IsAura()
	return true
end
...
function modifier_ghost_shroud_custom_debuff:IsHidden()
	return false
end
function modifier_ghost_shroud_custom_debuff:IsDebuff()
	return true
end
