...
function modifier_necrolyte_heartstopper_aura_lua:OnDeath(params)
	...
	if
		attacker:GetTeamNumber() == unit_killed:GetTeamNumber()
		or unit_killed:IsIllusion()
		or unit_killed:IsTempestDouble()
		or unit_killed:HasModifier("modifier_arc_warden_tempest_double_lua")
	then
		return
	end
