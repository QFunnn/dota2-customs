...
LinkLuaModifier(
	"modifier_zuus_lightning_hands_lua",
	"heroes/hero_zeus/zuus_lightning_hands_lua.lua",
...
function zuus_lightning_hands_lua:OnToggle() end
---------------------------------------------------------------------
--Modifiers
