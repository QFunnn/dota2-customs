...
LinkLuaModifier(
	"modifier_zeus_static_field_lua",
	"heroes/hero_zeus/modifier_zeus_static_field_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_zeus_static_field_shock_lua",
	"heroes/hero_zeus/modifier_zeus_static_field_shock_lua",
	LUA_MODIFIER_MOTION_NONE
)
