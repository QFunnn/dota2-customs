...
LinkLuaModifier(
	"modifier_ursa_maul_custom",
	"heroes/npc_dota_hero_ursa_custom/ursa_maul_custom",
...
function modifier_ursa_maul_custom:IsHidden()
	return true
end
function modifier_ursa_maul_custom:IsPurgable()
	return false
end
function modifier_ursa_maul_custom:RemoveOnDeath()
	return false
end
