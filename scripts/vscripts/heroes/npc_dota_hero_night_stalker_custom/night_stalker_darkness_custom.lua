...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_darkness_custom",
...
function night_stalker_darkness_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_night_stalker_darkness_custom", { duration = duration })
...
function modifier_night_stalker_darkness_custom:IsPurgable()
	return false
end
function modifier_night_stalker_darkness_custom:IsPurgeException()
	return false
end
