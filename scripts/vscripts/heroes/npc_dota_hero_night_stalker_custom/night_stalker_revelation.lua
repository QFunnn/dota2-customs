...
LinkLuaModifier(
	"modifier_night_stalker_revelation",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_revelation",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_revelation_thinker",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_revelation",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_revelation_thinker_debuff",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_revelation",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_revelation_thinker_night",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_revelation",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_revelation_thinker_night_buff",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_revelation",
	LUA_MODIFIER_MOTION_NONE
)
...
function night_stalker_revelation:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_night_stalker_revelation", { duration = duration })
	...
	if self:GetCaster():HasModifier("modifier_night_stalker_10") then
		CreateModifierThinker(
			...
			self,
			"modifier_night_stalker_revelation_thinker",
			{ duration = self.modifier_night_stalker_10_duration },
...
function modifier_night_stalker_revelation_thinker:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_night_stalker/night_stalker_void_zone_day.vpcf",
...
function modifier_night_stalker_revelation_thinker_debuff:IsPurgable()
	return false
end
function modifier_night_stalker_revelation_thinker_debuff:GetTexture()
	return "night_stalker_10"
end
...
function modifier_night_stalker_revelation_thinker_night_buff:IsPurgable()
	return false
end
function modifier_night_stalker_revelation_thinker_night_buff:GetTexture()
	return "night_stalker_10"
end
...
function modifier_night_stalker_revelation_thinker_night_buff:GetModifierProperty_PhysicalLifesteal()
	return self:GetAbility().modifier_night_stalker_10_lifesteal[self:GetCaster()
		:GetTalentLevel("modifier_night_stalker_10")]
end