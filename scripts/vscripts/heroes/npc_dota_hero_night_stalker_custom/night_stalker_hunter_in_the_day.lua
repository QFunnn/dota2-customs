...
LinkLuaModifier(
	"modifier_night_stalker_hunter_in_the_day",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_hunter_in_the_day",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_hunter_in_the_day_buff",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_hunter_in_the_day",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_night_stalker_hunter_in_the_day:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_day:IsHidden()
	return true
end
function modifier_night_stalker_hunter_in_the_day:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_day:IsPurgeException()
	return false
end
function modifier_night_stalker_hunter_in_the_day:RemoveOnDeath()
	return false
end
...
function modifier_night_stalker_hunter_in_the_day:OnIntervalThink()
	...
	if
		GameRules:IsDaytime()
		or self:GetCaster():HasModifier("modifier_night_stalker_revelation_thinker_night_buff")
		or self:GetCaster():HasModifier("modifier_night_stalker_day_walker")
		or self:GetCaster():HasModifier("modifier_night_stalker_14")
	then
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_night_stalker_hunter_in_the_day_buff", {})
	else
...
function modifier_night_stalker_hunter_in_the_day_buff:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_day_buff:IsPurgeException()
	return false
end
...
function modifier_night_stalker_hunter_in_the_day_buff:OnCreated()
	...
	Timers:CreateTimer(FrameTime(), function()
		if self:GetParent():IsRealHero() then
			local particle = ParticleManager:CreateParticle(
				"particles/units/heroes/hero_night_stalker/nightstalker_change_day.vpcf",
	...
	local particle_buff = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_night_stalker/nightstalker_night_buff_day.vpcf",
