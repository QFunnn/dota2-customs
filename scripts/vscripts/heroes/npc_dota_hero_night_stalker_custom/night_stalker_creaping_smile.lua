...
LinkLuaModifier(
	"modifier_night_stalker_creaping_smile",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_creaping_smile",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_creaping_smile_debuff",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_creaping_smile",
	LUA_MODIFIER_MOTION_NONE
)
...
function night_stalker_creaping_smile:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_night_stalker_creaping_smile", { duration = duration })
end
...
function modifier_night_stalker_creaping_smile:IsPurgable()
	return false
end
...
function modifier_night_stalker_creaping_smile:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_night_stalker/nightstalker_crippling_fear_aura_day.vpcf",
