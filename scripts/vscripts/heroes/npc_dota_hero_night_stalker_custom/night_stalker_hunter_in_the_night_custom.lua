...
LinkLuaModifier(
	"modifier_night_stalker_hunter_in_the_night_custom",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_hunter_in_the_night_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_night_stalker_hunter_in_the_night_custom_buff",
	"heroes/npc_dota_hero_night_stalker_custom/night_stalker_hunter_in_the_night_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function night_stalker_hunter_in_the_night_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_night_stalker.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_night_stalker.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_night_stalker.vpcf",
		context
	)
...
function modifier_night_stalker_hunter_in_the_night_custom:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_night_custom:IsHidden()
	return true
end
function modifier_night_stalker_hunter_in_the_night_custom:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_night_custom:IsPurgeException()
	return false
end
function modifier_night_stalker_hunter_in_the_night_custom:RemoveOnDeath()
	return false
end
...
function modifier_night_stalker_hunter_in_the_night_custom:OnIntervalThink()
	...
	if
		self:GetParent():HasModifier("modifier_morphling_replicate_custom_manager")
		and not self:GetParent():HasModifier("modifier_morphling_replicate_custom")
	then
		return
	end
	if
		self:GetCaster():HasModifier("modifier_night_stalker_darkness_custom")
		or not GameRules:IsDaytime()
		or self:GetCaster():HasModifier("modifier_night_stalker_7")
		or self:GetCaster():HasModifier("modifier_night_stalker_void_custom_thinker_night_buff")
	then
...
function modifier_night_stalker_hunter_in_the_night_custom_buff:IsPurgable()
	return false
end
function modifier_night_stalker_hunter_in_the_night_custom_buff:IsPurgeException()
	return false
end
...
function modifier_night_stalker_hunter_in_the_night_custom_buff:OnCreated()
	...
	self.models = {}
	self:SpawnItems()
	local particle_buff = ParticleManager:CreateParticle(
...
function modifier_night_stalker_hunter_in_the_night_custom_buff:SpawnItems()
	...
	local wings = SpawnEntityFromTableSynchronous(
		"prop_dynamic",
		{ model = "models/heroes/nightstalker/nightstalker_wings_night.vmdl" }
	)
	local legs = SpawnEntityFromTableSynchronous(
		"prop_dynamic",
		{ model = "models/heroes/nightstalker/nightstalker_legarmor_night.vmdl" }
	)
	local tail = SpawnEntityFromTableSynchronous(
		"prop_dynamic",
...
function modifier_night_stalker_hunter_in_the_night_custom_buff:GetModifierSpellAmplify_Percentage()
	if not self:GetCaster():HasModifier("modifier_night_stalker_16") then
		return
	end
...
function modifier_night_stalker_hunter_in_the_night_custom_buff:GetModifierAttackSpeedBonus_Constant()
	if self:GetCaster():HasModifier("modifier_night_stalker_16") then
		return
	end
