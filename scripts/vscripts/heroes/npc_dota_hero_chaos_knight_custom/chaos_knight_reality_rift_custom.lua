...
LinkLuaModifier(
	"modifier_chaos_knight_reality_rift_custom",
	"heroes/npc_dota_hero_chaos_knight_custom/chaos_knight_reality_rift_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chaos_knight_reality_rift_custom_break",
	"heroes/npc_dota_hero_chaos_knight_custom/chaos_knight_reality_rift_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chaos_knight_reality_rift_custom_silence",
	"heroes/npc_dota_hero_chaos_knight_custom/chaos_knight_reality_rift_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chaos_knight_reality_rift_custom_disarmed",
	"heroes/npc_dota_hero_chaos_knight_custom/chaos_knight_reality_rift_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function chaos_knight_reality_rift_custom:HasReality()
	if
		self:GetCaster():HasModifier("modifier_chaos_knight_8")
		and self:GetCaster():HasModifier("modifier_chaos_knight_3")
		and self:GetCaster():HasModifier("modifier_chaos_knight_10")
		and self:GetCaster():HasModifier("modifier_chaos_knight_17")
	then
		return true
	end
end
...
function chaos_knight_reality_rift_custom:ApplyEffects(target)
	...
	if caster:HasModifier("modifier_chaos_knight_3") then
		target:AddNewModifier(
			...
			"modifier_chaos_knight_reality_rift_custom_break",
			{
				duration = self.modifier_chaos_knight_3[caster:GetTalentLevel("modifier_chaos_knight_3")]
	...
	if caster:HasModifier("modifier_chaos_knight_10") then
		target:AddNewModifier(
			...
			"modifier_chaos_knight_reality_rift_custom_silence",
			{
				duration = self.modifier_chaos_knight_10[caster:GetTalentLevel("modifier_chaos_knight_10")]
					* (1 - target:GetStatusResistance()),
			}
		)
	end
	...
	if caster:HasModifier("modifier_chaos_knight_17") then
		target:AddNewModifier(
			...
			"modifier_chaos_knight_reality_rift_custom_disarmed",
			{
				duration = self.modifier_chaos_knight_17[caster:GetTalentLevel("modifier_chaos_knight_17")]
					* (1 - target:GetStatusResistance()),
			}
		)
	end
...
function modifier_chaos_knight_reality_rift_custom_break:GetTexture()
	return "chaos_3"
end
...
function modifier_chaos_knight_reality_rift_custom_silence:GetTexture()
	return "chaos_10"
end
...
function modifier_chaos_knight_reality_rift_custom_disarmed:GetTexture()
	return "chaos_17"
end
