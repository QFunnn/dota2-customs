...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_lone_druid_custom/lone_druid_true_form_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lone_druid_true_form_custom_cast",
	"heroes/npc_dota_hero_lone_druid_custom/lone_druid_true_form_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function lone_druid_true_form_custom:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_lone_druid_19") then
		...
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self, "modifier_lone_druid_true_form_custom", { duration = duration })
		local particle = ParticleManager:CreateParticle(
			"particles/units/heroes/hero_lone_druid/lone_druid_true_form_custom.vpcf",
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_lone_druid_true_form_custom_cast", { duration = duration })
end

modifier_lone_druid_true_form_custom_cast = class({})

function modifier_lone_druid_true_form_custom_cast:IsHidden()
	return true
end
function modifier_lone_druid_true_form_custom_cast:IsPurgable()
	return false
end
function modifier_lone_druid_true_form_custom_cast:IsPurgeException()
	return false
end
...
function modifier_lone_druid_true_form_custom:IsPurgeException()
	return false
end
function modifier_lone_druid_true_form_custom:IsPurgable()
	return false
end
