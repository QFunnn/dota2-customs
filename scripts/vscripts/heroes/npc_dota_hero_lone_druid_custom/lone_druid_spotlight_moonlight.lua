...
LinkLuaModifier(
	"modifier_lone_druid_spotlight_moonlight",
	"heroes/npc_dota_hero_lone_druid_custom/lone_druid_spotlight_moonlight",
...
function modifier_lone_druid_spotlight_moonlight:IsPurgable()
	return false
end

function modifier_lone_druid_spotlight_moonlight:GetAttributes()
