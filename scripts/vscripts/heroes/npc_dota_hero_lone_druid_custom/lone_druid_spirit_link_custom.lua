...
LinkLuaModifier(
	"modifier_lone_druid_spirit_link_custom",
	"heroes/npc_dota_hero_lone_druid_custom/lone_druid_spirit_link_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lone_druid_spirit_link_custom_buff",
	"heroes/npc_dota_hero_lone_druid_custom/lone_druid_spirit_link_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_lone_druid_spirit_link_custom:IsHidden()
	return true
end
...
function modifier_lone_druid_spirit_link_custom:GetAuraDuration()
	return 0.03
end
...
function modifier_lone_druid_spirit_link_custom:GetAuraEntityReject(hEntity)
	if
		hEntity:GetOwner() == self:GetCaster()
		or (hEntity == self:GetCaster() or hEntity:GetUnitName() == "npc_dota_lone_druid_bear_custom")
	then
		return false
	end
	return true
...
function modifier_lone_druid_spirit_link_custom_buff:IsPurgable()
	return false
end
function modifier_lone_druid_spirit_link_custom_buff:RemoveOnDeath()
	return false
end
