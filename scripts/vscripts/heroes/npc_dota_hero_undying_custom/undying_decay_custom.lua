...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_undying_custom/undying_decay_custom",
...
function undying_decay_custom:Precache(context)
	...
	PrecacheResource("particle", "particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_undying.vpcf", context)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_undying.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_undying.vpcf",
		context
	)
end
...
undying_decay_custom.modifier_undying_15 = { 30, 60 }
undying_decay_custom.modifier_undying_2 = { 60, 120 }
undying_decay_custom.modifier_undying_5 = { 10, 20 }
...
function undying_decay_custom:DecayCast(point, sound_caster, bonus_radius)
	...
	do
		if enemy:IsHero() and not enemy:IsIllusion() then
			...
			self:GetCaster()
				:AddNewModifier(self:GetCaster(), self, "modifier_undying_decay_custom_buff", { duration = duration })
		...
		if not enemy:IsHero() then
			ApplyDamage({
				victim = enemy,
				damage = damage * self:GetSpecialValueFor("creep_damage_multiplier"),
				damage_type = self:GetAbilityDamageType(),
				damage_flags = DOTA_DAMAGE_FLAG_NONE,
				attacker = self:GetCaster(),
				ability = self,
		...
		if self:GetCaster():HasModifier("modifier_undying_2") and enemy:IsHero() and not enemy:IsDebuffImmune() then
			...
			local knockback = enemy:AddNewModifier(
				...
				{
					duration = 0.1,
					distance = self.modifier_undying_2[self:GetCaster():GetTalentLevel("modifier_undying_2")],
					height = 0,
...
function modifier_undying_decay_custom_buff:IsHidden()
	return true
end
function modifier_undying_decay_custom_buff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_buff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

modifier_undying_decay_custom_debuff = class({})

function modifier_undying_decay_custom_debuff:IsHidden()
	return true
end
function modifier_undying_decay_custom_debuff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_debuff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_undying_decay_custom_buff_counter:IsPurgable()
	return false
end
...
function modifier_undying_decay_custom_debuff_counter:IsPurgable()
	return false
end
...
function modifier_undying_decay_custom_agility_buff:IsHidden()
	return true
end
function modifier_undying_decay_custom_agility_buff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_agility_buff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

modifier_undying_decay_custom_agility_debuff = class({})

function modifier_undying_decay_custom_agility_debuff:IsHidden()
	return true
end
function modifier_undying_decay_custom_agility_debuff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_agility_debuff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_undying_decay_custom_agility_buff_counter:IsPurgable()
	return false
end
...
function modifier_undying_decay_custom_agility_debuff_counter:IsPurgable()
	return false
end
...
function modifier_undying_decay_custom_intellect_buff:IsHidden()
	return true
end
function modifier_undying_decay_custom_intellect_buff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_intellect_buff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

modifier_undying_decay_custom_intellect_debuff = class({})

function modifier_undying_decay_custom_intellect_debuff:IsHidden()
	return true
end
function modifier_undying_decay_custom_intellect_debuff:IsPurgable()
	return false
end
function modifier_undying_decay_custom_intellect_debuff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_undying_decay_custom_intellect_buff_counter:IsPurgable()
	return false
end
...
function modifier_undying_decay_custom_intellect_debuff_counter:IsPurgable()
	return false
end
