...
LinkLuaModifier(
	"modifier_undying_hypnodancer_custom",
	"heroes/npc_dota_hero_undying_custom/undying_hypnodancer_custom",
...
function undying_hypnodancer_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_undying_hypnodancer_custom", { duration = duration + 0.1 })
end

modifier_undying_hypnodancer_custom = class({})
function modifier_undying_hypnodancer_custom:IsPurgable()
	return false
end
