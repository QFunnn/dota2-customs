...
LinkLuaModifier(
	"modifier_undying_ceaseless_dirge_custom",
	"heroes/npc_dota_hero_undying_custom/undying_ceaseless_dirge_custom",
...
function modifier_undying_ceaseless_dirge_custom:RemoveOnDeath()
	return false
end
function modifier_undying_ceaseless_dirge_custom:IsHidden()
	return true
end
function modifier_undying_ceaseless_dirge_custom:IsPurgable()
	return false
end
