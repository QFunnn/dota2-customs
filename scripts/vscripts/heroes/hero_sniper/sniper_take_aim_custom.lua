...
LinkLuaModifier(
	...
	"heroes/hero_sniper/sniper_take_aim_custom",
...
function sniper_take_aim_custom:OnSpellStart()
	...
	local duration = self:GetSpecialValueFor("duration")
		+ self:GetCaster():FindTalentValue("special_bonus_unique_sniper_4")
	self:GetCaster():AddNewModifier(
		...
		"modifier_sniper_take_aim_bonus",
		{
			...
			headshot_chance = self:GetSpecialValueFor("headshot_chance"),
		}
	)
end
