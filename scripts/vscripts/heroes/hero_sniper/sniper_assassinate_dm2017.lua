...
LinkLuaModifier(
	"modifier_sniper_assassinate_dm2017",
	"heroes/hero_sniper/sniper_assassinate_dm2017.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_assassinate_dm2017_crit",
	"heroes/hero_sniper/sniper_assassinate_dm2017.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_assassinate_dm2017_cast_point",
	"heroes/hero_sniper/sniper_assassinate_dm2017.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_assassinate_dm2017_ignore_passives",
	"heroes/hero_sniper/sniper_assassinate_dm2017.lua",
	LUA_MODIFIER_MOTION_NONE
)
		...
		if (not hTarget:IsInvulnerable()) and (not hTarget:TriggerSpellAbsorb(self)) then
			...
			if IsValid(hTarget) and hTarget:IsAlive() then
				...
				hTarget:AddNewModifier(
					...
					self,
					"modifier_stunned",
					{ duration = self:GetSpecialValueFor("stun_duration") * hTarget:GetStatusResistanceFactor(hCaster) }
				)
			end
			-- if self:GetCaster():HasScepter() then
