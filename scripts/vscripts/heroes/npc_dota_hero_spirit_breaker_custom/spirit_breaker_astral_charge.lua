...
LinkLuaModifier(
	"modifier_spirit_breaker_astral_charge",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_astral_charge",
	LUA_MODIFIER_MOTION_BOTH
)
LinkLuaModifier(
	"modifier_spirit_breaker_astral_charge_debuff",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_astral_charge",
...
function spirit_breaker_astral_charge:OnSpellStart()
	...
	local illusion = CreateUnitByName(
		"npc_dota_spirit_breaker_phantom",
...
function modifier_spirit_breaker_astral_charge:IsHidden()
	return true
end
function modifier_spirit_breaker_astral_charge:IsPurgable()
	return false
end
function modifier_spirit_breaker_astral_charge:IsPurgeException()
	return false
end
function modifier_spirit_breaker_astral_charge:RemoveOnDeath()
	return false
end
...
function modifier_spirit_breaker_astral_charge:SetTarget(target)
	...
	self.debuff =
		target:AddNewModifier(self.parent, self:GetAbility(), "modifier_spirit_breaker_astral_charge_debuff", {})
	self.target = target
