...
LinkLuaModifier(
	"modifier_spirit_breaker_charge_of_darkness_custom",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_charge_of_darkness",
	LUA_MODIFIER_MOTION_BOTH
)
LinkLuaModifier(
	"modifier_spirit_breaker_charge_of_darkness_custom_debuff",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_charge_of_darkness",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_spirit_breaker_charge_of_darkness_custom_effect_immune",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_charge_of_darkness",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_spirit_breaker_charge_of_darkness_custom_bonus",
	"heroes/npc_dota_hero_spirit_breaker_custom/spirit_breaker_charge_of_darkness",
	LUA_MODIFIER_MOTION_NONE
)
...
function spirit_breaker_charge_of_darkness_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_spirit_breaker.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_spirit_breaker.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_spirit_breaker.vpcf",
		context
	)
end
...
function spirit_breaker_charge_of_darkness_custom:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self,
		"modifier_spirit_breaker_charge_of_darkness_custom",
		{ target = target:entindex(), is_point = is_point }
	)
end
...
function modifier_spirit_breaker_charge_of_darkness_custom:IsPurgable()
	return false
end
...
function modifier_spirit_breaker_charge_of_darkness_custom:OnDestroy()
	...
	if self:GetCaster():HasModifier("modifier_spirit_breaker_11") then
		self.parent:AddNewModifier(
			...
			self:GetAbility(),
			"modifier_spirit_breaker_charge_of_darkness_custom_bonus",
			{ duration = self:GetAbility().modifier_spirit_breaker_11 }
		)
	end
	...
	if not self.interrupted then
		...
		if self:GetCaster():HasModifier("modifier_spirit_breaker_15") then
			local damage = (
				...
				/ 100
				* self:GetAbility().modifier_spirit_breaker_15_percent[self:GetCaster()
					:GetTalentLevel("modifier_spirit_breaker_15")]
			) + self:GetAbility().modifier_spirit_breaker_15
			ApplyDamage({
				victim = self.target,
...
function modifier_spirit_breaker_charge_of_darkness_custom_effect_immune:IsHidden()
	return true
end
function modifier_spirit_breaker_charge_of_darkness_custom_effect_immune:IsPurgable()
	return false
end
function modifier_spirit_breaker_charge_of_darkness_custom_effect_immune:IsPurgeException()
	return false
end
