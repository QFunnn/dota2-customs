...
LinkLuaModifier(
	"modifier_vengefulspirit_command_aura_custom",
	"heroes/npc_dota_hero_vengefulspirit_custom/vengefulspirit_command_aura_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_vengefulspirit_command_aura_custom_aura",
	"heroes/npc_dota_hero_vengefulspirit_custom/vengefulspirit_command_aura_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_vengefulspirit_command_aura_custom:IsAura()
	return true
end
function modifier_vengefulspirit_command_aura_custom:IsDebuff()
	return false
end
function modifier_vengefulspirit_command_aura_custom:IsHidden()
	return true
end
function modifier_vengefulspirit_command_aura_custom:IsPurgable()
	return false
end
function modifier_vengefulspirit_command_aura_custom:IsPurgeException()
	return false
end
function modifier_vengefulspirit_command_aura_custom:IsStunDebuff()
	return false
end
function modifier_vengefulspirit_command_aura_custom:RemoveOnDeath()
	return false
end
function modifier_vengefulspirit_command_aura_custom:IsAuraActiveOnDeath()
	return false
end
...
function modifier_vengefulspirit_command_aura_custom_aura:IsDebuff()
	return false
end
function modifier_vengefulspirit_command_aura_custom_aura:IsHidden()
	return false
end
function modifier_vengefulspirit_command_aura_custom_aura:IsPurgable()
	return false
end
function modifier_vengefulspirit_command_aura_custom_aura:IsPurgeException()
	return false
end
function modifier_vengefulspirit_command_aura_custom_aura:IsStunDebuff()
	return false
end
function modifier_vengefulspirit_command_aura_custom_aura:RemoveOnDeath()
	return false
end
...
function modifier_vengefulspirit_command_aura_custom_aura:GetModifierBaseDamageOutgoing_Percentage()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_5") then
		bonus =
			self:GetAbility().modifier_vengefulspirit_5[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_5")]
	end
