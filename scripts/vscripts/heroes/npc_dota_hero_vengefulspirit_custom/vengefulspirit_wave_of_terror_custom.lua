...
LinkLuaModifier(
	"modifier_vengefulspirit_wave_of_terror_custom_debuff",
	"heroes/npc_dota_hero_vengefulspirit_custom/vengefulspirit_wave_of_terror_custom",
...
function vengefulspirit_wave_of_terror_custom:OnProjectileThink_ExtraData(location, ExtraData)
	if ExtraData.dummy_entindex then
		AddFOWViewer(
			self:GetCaster():GetTeamNumber(),
			location,
			self:GetSpecialValueFor("vision_aoe"),
...
function vengefulspirit_wave_of_terror_custom:OnProjectileHit_ExtraData(target, location, ExtraData)
	if target then
		...
		if
			self:GetCaster():HasModifier("modifier_vengefulspirit_13")
			and ExtraData.teleport ~= nil
			and ExtraData.teleport == 1
		then
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:IsDebuff()
	return true
end
function modifier_vengefulspirit_wave_of_terror_custom_debuff:IsHidden()
	return false
end
function modifier_vengefulspirit_wave_of_terror_custom_debuff:IsPurgable()
	return true
end
function modifier_vengefulspirit_wave_of_terror_custom_debuff:IsStunDebuff()
	return false
end
function modifier_vengefulspirit_wave_of_terror_custom_debuff:RemoveOnDeath()
	return true
end
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:GetModifierDamageOutgoing_Percentage()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_9") then
		bonus =
			self:GetAbility().modifier_vengefulspirit_9[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_9")]
	end
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:GetModifierPhysicalArmorBonus()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_8") then
		bonus =
			self:GetAbility().modifier_vengefulspirit_8[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_8")]
	end
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:GetModifierMoveSpeedBonus_Percentage()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_1") then
		bonus =
			self:GetAbility().modifier_vengefulspirit_1[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_1")]
	end
	return bonus
end
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:GetModifierMagicalResistanceBonus()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_16") then
		bonus = self:GetAbility().modifier_vengefulspirit_16[self:GetCaster()
			:GetTalentLevel("modifier_vengefulspirit_16")]
	end
	return bonus
end
...
function modifier_vengefulspirit_wave_of_terror_custom_debuff:GetModifierPropertyRestorationAmplification()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_20") then
		bonus = self:GetAbility().modifier_vengefulspirit_20[self:GetCaster()
			:GetTalentLevel("modifier_vengefulspirit_20")]
	end
	return bonus
end
...
function modifier_vengefulspirit_wave_of_terror_custom_spirit:IsHidden()
	return true
end
function modifier_vengefulspirit_wave_of_terror_custom_spirit:IsPurgable()
	return false
end
