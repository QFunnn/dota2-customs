...
LinkLuaModifier(
	"modifier_vengefulspirit_magic_missile_custom_stack_debuff",
	"heroes/npc_dota_hero_vengefulspirit_custom/vengefulspirit_magic_missile_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_vengefulspirit_magic_missile_custom_stack_creep",
	"heroes/npc_dota_hero_vengefulspirit_custom/vengefulspirit_magic_missile_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function vengefulspirit_magic_missile_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_vengefulspirit.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_vengefulspirit.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_vengefulspirit.vpcf",
		context
	)
end
...
function vengefulspirit_magic_missile_custom:OnProjectileHit_ExtraData(target, location, ExtraData)
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_18") then
		magic_missile_damage = magic_missile_damage
			+ (
				self:GetCaster():GetMana()
				/ 100
				* self.modifier_vengefulspirit_18[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_18")]
			)
	end
	local modifier_vengefulspirit_magic_missile_custom_stack_creep =
		self:GetCaster():FindModifierByName("modifier_vengefulspirit_magic_missile_custom_stack_creep")
	if modifier_vengefulspirit_magic_missile_custom_stack_creep then
		magic_missile_damage = magic_missile_damage
			+ (
				modifier_vengefulspirit_magic_missile_custom_stack_creep:GetStackCount()
				* self.modifier_vengefulspirit_15_per_creep
			)
	end
	...
	target:AddNewModifier(
		...
		self,
		"modifier_stunned",
		{ duration = magic_missile_stun * (1 - target:GetStatusResistance()) }
	)

	if
		self:GetCaster():HasModifier("modifier_vengefulspirit_15")
		and ExtraData.count
			< self.modifier_vengefulspirit_15[self:GetCaster():GetTalentLevel("modifier_vengefulspirit_15")]
	then
...
function modifier_vengefulspirit_magic_missile_custom_stack:IsHidden()
	return true
end
function modifier_vengefulspirit_magic_missile_custom_stack:IsPurgable()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack:RemoveOnDeath()
	return false
end
...
function modifier_vengefulspirit_magic_missile_custom_stack_debuff:IsHidden()
	return true
end
function modifier_vengefulspirit_magic_missile_custom_stack_debuff:IsPurgeException()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack_debuff:IsPurgable()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack_debuff:RemoveOnDeath()
	return false
end

modifier_vengefulspirit_magic_missile_custom_passive = class({})

function modifier_vengefulspirit_magic_missile_custom_passive:IsDebuff()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_passive:IsHidden()
	return not self:GetCaster():HasModifier("modifier_vengefulspirit_17")
end
function modifier_vengefulspirit_magic_missile_custom_passive:IsPurgable()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_passive:IsStunDebuff()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_passive:RemoveOnDeath()
	return false
end
...
function modifier_vengefulspirit_magic_missile_custom_passive:OnIntervalThink()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_magic_missile_custom_stack") then
		self:SetStackCount(
			self:GetCaster():FindModifierByName("modifier_vengefulspirit_magic_missile_custom_stack"):GetStackCount()
		)
	end
...
function modifier_vengefulspirit_magic_missile_custom_passive:GetModifierManaBonus()
	...
	if self:GetCaster():HasModifier("modifier_vengefulspirit_17") then
		bonus = self:GetAbility().modifier_vengefulspirit_17[self:GetCaster()
			:GetTalentLevel("modifier_vengefulspirit_17")]
	end
...
function modifier_vengefulspirit_magic_missile_custom_passive:OnDeath(params)
	...
	if not self:GetParent():HasModifier("modifier_vengefulspirit_15") then
		return
	end
	self:GetParent()
		:AddNewModifier(
...
function modifier_vengefulspirit_magic_missile_custom_stack_creep:IsPurgable()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack_creep:IsPurgeException()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack_creep:RemoveOnDeath()
	return false
end
function modifier_vengefulspirit_magic_missile_custom_stack_creep:GetTexture()
	return "vegenfulspirit_15"
end
