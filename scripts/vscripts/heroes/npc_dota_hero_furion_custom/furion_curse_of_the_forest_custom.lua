...
LinkLuaModifier(
	"modifier_furion_curse_of_the_forest_custom",
	"heroes/npc_dota_hero_furion_custom/furion_curse_of_the_forest_custom",
...
function furion_curse_of_the_forest_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_furion.vpcf",
		context
	)
end
...
function modifier_furion_curse_of_the_forest_custom:OnIntervalThink()
	...
	if
		not self:GetParent():IsInvisible()
		or (self:GetParent():IsInvisible() and self:GetCaster():CanEntityBeSeenByMyTeam(self:GetParent()))
	then
