...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_furion_custom/furion_wrath_of_nature_custom",
...
LinkLuaModifier(
	"modifier_furion_wrath_of_nature_custom_buff_stack",
	"heroes/npc_dota_hero_furion_custom/furion_wrath_of_nature_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function furion_wrath_of_nature_custom:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_furion_14") then
		AddFOWViewer(
			...
			2700,
			self.modifier_furion_14_duration_vision,
			false
		)
	end
...
function modifier_furion_wrath_of_nature_custom_buff_stack:IsHidden()
	return true
end
function modifier_furion_wrath_of_nature_custom_buff_stack:GetAttributes()
...
function modifier_furion_wrath_of_nature_custom_root:OnCreated()
	...
	local particle =
		ParticleManager:CreateParticle("particles/treant_root.vpcf", PATTACH_CUSTOMORIGIN, self:GetParent())
