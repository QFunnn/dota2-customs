...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_furion_custom/furion_spirit_of_the_forest_custom",
...
function modifier_furion_spirit_of_the_forest_custom:IsPurgable()
	return false
end
function modifier_furion_spirit_of_the_forest_custom:IsPurgeException()
	return false
end
function modifier_furion_spirit_of_the_forest_custom:RemoveOnDeath()
	return false
end
