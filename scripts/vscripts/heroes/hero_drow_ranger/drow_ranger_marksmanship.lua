...
LinkLuaModifier(
	...
	"heroes/hero_drow_ranger/modifier_drow_ranger_marksmanship_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_drow_ranger_marksmanship_lua_debuff",
	"heroes/hero_drow_ranger/modifier_drow_ranger_marksmanship_lua_debuff",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_drow_ranger_marksmanship_lua_effect",
	"heroes/hero_drow_ranger/modifier_drow_ranger_marksmanship_lua_effect",
	LUA_MODIFIER_MOTION_NONE
)
