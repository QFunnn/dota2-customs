...
LinkLuaModifier(
	...
	"heroes/hero_drow_ranger/drow_ranger_marksmanship_custom",
...
function modifier_drow_ranger_marksmanship_custom_tracker:IsHidden()
	return true
end
function modifier_drow_ranger_marksmanship_custom_tracker:IsPurgable()
	return false
end
...
function modifier_drow_ranger_marksmanship_custom_proc:IsHidden()
	return true
end
function modifier_drow_ranger_marksmanship_custom_proc:IsPurgable()
	return false
end

modifier_drow_ranger_marksmanship_custom_proc_armor = class({})
function modifier_drow_ranger_marksmanship_custom_proc_armor:IsHidden()
	return true
end
function modifier_drow_ranger_marksmanship_custom_proc_armor:IsPurgable()
	return false
end
