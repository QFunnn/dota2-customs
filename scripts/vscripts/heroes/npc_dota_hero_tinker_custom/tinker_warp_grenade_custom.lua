...
LinkLuaModifier(
	"modifier_tinker_warp_grenade_custom_debuff",
	"heroes/npc_dota_hero_tinker_custom/tinker_warp_grenade_custom",
...
function modifier_tinker_warp_grenade_custom_debuff:IsPurgable()
	return true
end
