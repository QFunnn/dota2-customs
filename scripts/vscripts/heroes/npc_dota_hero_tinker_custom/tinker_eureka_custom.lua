...
LinkLuaModifier(
	"modifier_tinker_eureka_custom",
	"heroes/npc_dota_hero_tinker_custom/tinker_eureka_custom",
...
function modifier_tinker_eureka_custom:IsHidden()
	return true
end
function modifier_tinker_eureka_custom:IsPurgable()
	return false
end
function modifier_tinker_eureka_custom:IsPurgeException()
	return false
end
function modifier_tinker_eureka_custom:RemoveOnDeath()
	return false
end
...
function modifier_tinker_eureka_custom:GetModifierOverrideAbilitySpecial(data)
	if
		data.ability:GetAbilityName() == "tinker_eureka_custom"
		and data.ability_special_value == "item_cooldown_tooltip"
	then
		return 1
	end
end
