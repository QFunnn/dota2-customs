...
LinkLuaModifier(
	"modifier_dawnbreaker_luminosity_lua",
	"heroes/hero_dawnbreaker/dawnbreaker_luminosity_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_dawnbreaker_luminosity_lua_counter",
	"heroes/hero_dawnbreaker/dawnbreaker_luminosity_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
