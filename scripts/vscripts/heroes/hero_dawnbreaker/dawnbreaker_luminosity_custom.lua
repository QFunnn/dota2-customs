...
LinkLuaModifier(
	...
	"heroes/hero_dawnbreaker/dawnbreaker_luminosity_custom",
...
function modifier_dawnbreaker_luminosity_custom:AttackLandedModifier(params)
	...
	if self.parent:HasModifier("modifier_starbreaker_fire_wreath_caster") then
		return
	end
	self:Increment()
end
