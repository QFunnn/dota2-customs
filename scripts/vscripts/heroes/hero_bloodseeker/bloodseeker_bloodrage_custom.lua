...
LinkLuaModifier(
	...
	"heroes/hero_bloodseeker/bloodseeker_bloodrage_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modiifer_bloodseeker_bloodrage_custom_cooldown",
	"heroes/hero_bloodseeker/bloodseeker_bloodrage_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function bloodseeker_bloodrage_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modiifer_bloodseeker_bloodrage_custom", { duration = duration })
end
...
function modiifer_bloodseeker_bloodrage_custom:GetModifierPreAttack_BonusDamage(params)
	...
	if self.parent:HasModifier("modiifer_bloodseeker_bloodrage_custom_cooldown") then
		return
	end
...
function modiifer_bloodseeker_bloodrage_custom_cooldown:IsHidden()
	return true
end
function modiifer_bloodseeker_bloodrage_custom_cooldown:IsPurgeException()
	return false
end
function modiifer_bloodseeker_bloodrage_custom_cooldown:IsPurgable()
	return false
end