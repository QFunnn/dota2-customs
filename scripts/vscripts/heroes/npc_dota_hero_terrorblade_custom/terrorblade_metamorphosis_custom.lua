...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_terrorblade_custom/terrorblade_metamorphosis_custom",
...
function terrorblade_metamorphosis_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_terrorblade.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_terrorblade.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_terrorblade.vpcf",
		context
	)
end
...
function terrorblade_metamorphosis_custom:UseMetamorphosis(duration)
	...
	self:GetCaster():AddNewModifier(
		...
		self,
		"modifier_custom_terrorblade_metamorphosis_transform",
		{ duration = delay, meta_duration = duration }
	)
	for _, unit in
		pairs(
			FindUnitsInRadius(
	...
	do
		...
		then
			unit:AddNewModifier(
				...
				self,
				"modifier_custom_terrorblade_metamorphosis_transform",
				{ duration = delay, meta_duration = -1 }
			)
		end
	end
end
...
function modifier_custom_terrorblade_metamorphosis_transform_aura_applier:GetAuraEntityReject(hTarget)
	return hTarget == self:GetParent()
		...
		or (
			hTarget:HasModifier("modifier_terrorblade_reflection_custom")
