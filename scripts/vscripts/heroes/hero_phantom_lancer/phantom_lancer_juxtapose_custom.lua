...
LinkLuaModifier(
	...
	"heroes/hero_phantom_lancer/phantom_lancer_juxtapose_custom",
...
function phantom_lancer_juxtapose_custom:OnSpellStart()
	...
	for i = 1, max_illusions do
		...
		for _, illusion in pairs(illusions) do
			self.spawn_particle = ParticleManager:CreateParticle(
...
function modifier_phantom_lancer_juxtapose_custom:IsHidden()
	return true
end
function modifier_phantom_lancer_juxtapose_custom:IsPurgable()
	return false
end
