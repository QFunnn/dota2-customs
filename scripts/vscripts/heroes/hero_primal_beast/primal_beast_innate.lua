...
LinkLuaModifier(
	"modifier_primal_beast_innate",
	"heroes/hero_primal_beast/primal_beast_innate",
	LUA_MODIFIER_MOTION_NONE
)

modifier_primal_beast_innate = class({})

function modifier_primal_beast_innate:IsHidden()
	return true
end
function modifier_primal_beast_innate:IsPurgable()
	return false
end
function modifier_primal_beast_innate:RemoveOnDeath()
	return false
end
