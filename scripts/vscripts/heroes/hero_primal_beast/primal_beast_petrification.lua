...
LinkLuaModifier(
	"modifier_primal_beast_petrification",
	"heroes/hero_primal_beast/primal_beast_petrification",
...
function modifier_primal_beast_petrification:IsHidden()
	return false
end
function modifier_primal_beast_petrification:IsPurgable()
	return false
end
function modifier_primal_beast_petrification:IsDebuff()
	return false
end
