...
LinkLuaModifier(
	"modifier_slardar_sprint_custom",
	"heroes/npc_dota_hero_slardar_custom/slardar_sprint_custom",
...
function modifier_slardar_sprint_custom:IsPurgable()
	return not self:GetParent():HasModifier("modifier_slardar_13")
end
