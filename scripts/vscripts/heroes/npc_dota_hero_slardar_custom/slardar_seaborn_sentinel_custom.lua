...
LinkLuaModifier(
	"modifier_slardar_seaborn_sentinel_custom",
	"heroes/npc_dota_hero_slardar_custom/slardar_seaborn_sentinel_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_seaborn_sentinel_custom_buff",
	"heroes/npc_dota_hero_slardar_custom/slardar_seaborn_sentinel_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_slardar_seaborn_sentinel_custom:IsHidden()
	return self:Check()
end
function modifier_slardar_seaborn_sentinel_custom:IsPurgable()
	return false
end
function modifier_slardar_seaborn_sentinel_custom:IsPurgeException()
	return false
end
function modifier_slardar_seaborn_sentinel_custom:RemoveOnDeath()
	return false
end
