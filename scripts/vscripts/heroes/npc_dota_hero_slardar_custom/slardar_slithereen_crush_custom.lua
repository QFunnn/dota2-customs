...
LinkLuaModifier(
	"modifier_slardar_slithereen_crush_custom_debuff",
	"heroes/npc_dota_hero_slardar_custom/slardar_slithereen_crush_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_slithereen_crush_custom_puddle",
	"heroes/npc_dota_hero_slardar_custom/slardar_slithereen_crush_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_slithereen_crush_custom_puddle_buff",
	"heroes/npc_dota_hero_slardar_custom/slardar_slithereen_crush_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_slithereen_crush_custom_puddle_buff_aura",
	"heroes/npc_dota_hero_slardar_custom/slardar_slithereen_crush_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_slardar_slithereen_crush_custom_puddle_debuff_aura",
	"heroes/npc_dota_hero_slardar_custom/slardar_slithereen_crush_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function slardar_slithereen_crush_custom:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_slardar_1") then
		puddle_duration = puddle_duration
			+ self.modifier_slardar_1_duration[self:GetCaster():GetTalentLevel("modifier_slardar_1")]
	end
	...
	if self:GetCaster():HasModifier("modifier_slardar_11") then
		self:GetCaster():AddNewModifier(
			...
			self,
			"modifier_slardar_slithereen_crush_custom_puddle_attack_speed",
			{ duration = self.modifier_slardar_11_duration }
		)
	end
	...
	if self:GetCaster():HasModifier("modifier_slardar_1") then
		CreateModifierThinker(
			...
			self,
			"modifier_slardar_slithereen_crush_custom_puddle",
			{ duration = puddle_duration, ultimate = 1, active = 1, damage = 1 },
			point,
			self:GetCaster():GetTeamNumber(),
			false
		)
		...
		CreateModifierThinker(
			...
			self,
			"modifier_slardar_slithereen_crush_custom_puddle",
			{ duration = puddle_duration, damage = 1 },
			point,
			self:GetCaster():GetTeamNumber(),
			false
		)
...
function modifier_slardar_slithereen_crush_custom_puddle:IsHidden()
	return true
end
function modifier_slardar_slithereen_crush_custom_puddle:IsPurgable()
	return false
end
...
function modifier_slardar_slithereen_crush_custom_puddle:OnCreated(params)
	...
	if self:GetCaster():HasModifier("modifier_slardar_1") and params.active then
		self.radius = self.radius
			+ self:GetAbility().modifier_slardar_1_radius[self:GetCaster():GetTalentLevel("modifier_slardar_1")]
	end
...
function modifier_slardar_slithereen_crush_custom_puddle_buff_aura:IsPurgable()
	return false
end
...
function modifier_slardar_slithereen_crush_custom_puddle_buff:IsHidden()
	return true
end
function modifier_slardar_slithereen_crush_custom_puddle_buff:IsPurgable()
	return false
end
function modifier_slardar_slithereen_crush_custom_puddle_buff:IsPurgeException()
	return false
end

modifier_slardar_slithereen_crush_custom_puddle_debuff_aura = class({})

function modifier_slardar_slithereen_crush_custom_puddle_debuff_aura:IsPurgable()
	return false
end
...
function modifier_slardar_slithereen_crush_custom_puddle_debuff_aura:OnIntervalThink()
	...
	local damage = self:GetAbility().modifier_slardar_2_dmg
		+ (
			self:GetCaster():GetPhysicalArmorValue(false)
			/ 100
			* self:GetAbility().modifier_slardar_2_percent_dmg[self:GetCaster():GetTalentLevel("modifier_slardar_2")]
		)
	ApplyDamage({
