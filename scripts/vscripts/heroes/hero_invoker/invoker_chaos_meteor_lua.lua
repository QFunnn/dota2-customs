...
LinkLuaModifier(
	"modifier_invoker_chaos_meteor_lua_thinker",
	"heroes/hero_invoker/invoker_chaos_meteor_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_invoker_chaos_meteor_lua_burn",
	"heroes/hero_invoker/invoker_chaos_meteor_lua",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_invoker_chaos_meteor_lua_thinker:OnRefresh(kv) end
	...
	for _, enemy in pairs(enemies) do
		...
		if enemy:IsAlive() then
			...
			if burn_buff then
				...
				burn_buff = enemy:AddNewModifier(
					self:GetCaster(),
					self:GetAbility(),
					"modifier_invoker_chaos_meteor_lua_burn",
...
function modifier_invoker_chaos_meteor_lua_burn:OnDestroy() end
