...
LinkLuaModifier(
	"modifier_invoker_ghost_walk_lua_buff",
	"heroes/hero_invoker/modifier_invoker_ghost_walk_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_invoker_ghost_walk_lua",
	"heroes/hero_invoker/modifier_invoker_ghost_walk_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_invoker_ghost_walk_lua_debuff",
	"heroes/hero_invoker/modifier_invoker_ghost_walk_lua_debuff",
	LUA_MODIFIER_MOTION_NONE
)
...
function invoker_ghost_walk_lua:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_invoker_ghost_walk_lua_buff", { duration = duration })
