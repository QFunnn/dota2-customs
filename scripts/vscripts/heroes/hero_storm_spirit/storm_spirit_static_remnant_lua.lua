...
LinkLuaModifier( "modifier_storm_spirit_static_remnant_lua_thinker", "heroes/hero_storm_spirit/storm_spirit_static_remnant_lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_storm_spirit_static_remnant_lua_thinker:OnDestroy()
	if not IsServer() or not (IsValid(self.parent)) then return end
