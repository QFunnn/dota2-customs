...
LinkLuaModifier(
	"modifier_storm_spirit_static_remnant_lua_thinker",
	"heroes/hero_storm_spirit/storm_spirit_static_remnant_lua",
...
function modifier_storm_spirit_static_remnant_lua_thinker:OnRefresh(kv) end

function modifier_storm_spirit_static_remnant_lua_thinker:OnRemoved() end

function modifier_storm_spirit_static_remnant_lua_thinker:OnDestroy()
	if not IsServer() or not (IsValid(self.parent)) then
		return
	end
...
function modifier_storm_spirit_static_remnant_lua_thinker:PlayEffects()
	...
	ParticleManager:SetParticleControl(effect_cast, 2, Vector(ACT_DOTA_CAST_ABILITY_1, 1.2, 0))
