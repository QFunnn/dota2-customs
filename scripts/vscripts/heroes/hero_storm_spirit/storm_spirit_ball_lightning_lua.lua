...
LinkLuaModifier("modifier_storm_spirit_ball_lightning_lua", "heroes/hero_storm_spirit/storm_spirit_ball_lightning_lua",
...
function modifier_storm_spirit_ball_lightning_lua:IsHidden() return true end

function modifier_storm_spirit_ball_lightning_lua:IsDebuff() return false end

function modifier_storm_spirit_ball_lightning_lua:IsStunDebuff() return false end

function modifier_storm_spirit_ball_lightning_lua:IsPurgable() return false end
