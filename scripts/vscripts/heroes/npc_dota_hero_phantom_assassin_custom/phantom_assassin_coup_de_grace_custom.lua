...
LinkLuaModifier(
	"modifier_phantom_assassin_coup_de_grace_custom",
	"heroes/npc_dota_hero_phantom_assassin_custom/phantom_assassin_coup_de_grace_custom",
...
LinkLuaModifier(
	"modifier_phantom_assassin_coup_de_grace_custom_focus",
	"heroes/npc_dota_hero_phantom_assassin_custom/phantom_assassin_coup_de_grace_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_phantom_assassin_coup_de_grace_custom:GetCriticalStrikeModifier()
	...
	if self:GetCaster():GetStrength() <= 0 then
		return
	end
	...
	if self:GetCaster():HasModifier("modifier_phantom_assassin_7") then
		local bonus_chance = (self:GetCaster():GetStrength() / self:GetAbility().modifier_phantom_assassin_7_str)
			* self:GetAbility().modifier_phantom_assassin_7_perc
...
function modifier_phantom_assassin_coup_de_grace_custom_active:IsPurgable()
	return false
end
...
function modifier_phantom_assassin_coup_de_grace_custom_focus:IsPurgable()
	return false
end
function modifier_phantom_assassin_coup_de_grace_custom_focus:IsPurgeException()
	return false
end
