...
LinkLuaModifier(
	"modifier_omniknight_degen_aura_custom_original",
	"heroes/hero_omniknight/omniknight_degen_aura_custom",
...
LinkLuaModifier(
	"modifier_omniknight_degen_aura_custom_2",
	"heroes/hero_omniknight/omniknight_degen_aura_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_omniknight_degen_aura_custom_debuff_2",
	"heroes/hero_omniknight/omniknight_degen_aura_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_omniknight_degen_aura_custom_original:OnIntervalThink()
	...
	if not self:GetCaster():HasModifier("modifier_omniknight_degen_aura_custom") then
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_omniknight_degen_aura_custom", {})
	end
	if not self:GetCaster():HasModifier("modifier_omniknight_degen_aura_custom_2") then
		self:GetCaster()
			:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_omniknight_degen_aura_custom_2", {})
	end
end
