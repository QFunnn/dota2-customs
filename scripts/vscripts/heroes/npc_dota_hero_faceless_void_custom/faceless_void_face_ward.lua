...
LinkLuaModifier(
	"modifier_faceless_void_face_ward",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_face_ward",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_faceless_void_face_ward_handler",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_face_ward",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_faceless_void_face_ward:IsHidden()
	return true
end
function modifier_faceless_void_face_ward:IsPurgable()
	return false
end
function modifier_faceless_void_face_ward:IsPurgeException()
	return false
end
...
function modifier_faceless_void_face_ward:OnCreated(params)
	...
	local modifier_faceless_void_face_ward_handler = self:GetCaster()
		:FindModifierByName("modifier_faceless_void_face_ward_handler")
...
function modifier_faceless_void_face_ward_handler:IsHidden()
	return self:GetStackCount() == 0 or not self:GetCaster():HasModifier("modifier_faceless_void_19")
end
function modifier_faceless_void_face_ward_handler:IsPurgable()
	return false
end
function modifier_faceless_void_face_ward_handler:IsPurgeException()
	return false
end
function modifier_faceless_void_face_ward_handler:RemoveOnDeath()
	return false
end
function modifier_faceless_void_face_ward_handler:GetTexture()
	return "faceless_void_face_ward"
end
...
function modifier_faceless_void_face_ward_handler:GetModifierBonusStats_Intellect()
	if not self:GetCaster():HasModifier("modifier_faceless_void_19") then
		return
	end
	return self:GetStackCount()
		* self:GetAbility().modifier_faceless_void_19[self:GetCaster():GetTalentLevel("modifier_faceless_void_19")]
end