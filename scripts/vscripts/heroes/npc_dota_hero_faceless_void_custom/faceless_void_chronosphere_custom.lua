...
LinkLuaModifier(
	"modifier_faceless_void_chronosphere_custom",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_chronosphere_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_faceless_void_chronosphere_custom_enemy",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_chronosphere_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_faceless_void_chronosphere_custom_friendly",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_chronosphere_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_faceless_void_chronosphere_custom_friendly_buff",
	"heroes/npc_dota_hero_faceless_void_custom/faceless_void_chronosphere_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_faceless_void_chronosphere_custom:IsPurgable()
	return false
end
function modifier_faceless_void_chronosphere_custom:IsHidden()
	return true
end
...
function modifier_faceless_void_chronosphere_custom_friendly:IsPurgable()
	return false
end
function modifier_faceless_void_chronosphere_custom_friendly:IsHidden()
	return true
end
...
function modifier_faceless_void_chronosphere_custom_friendly_buff:IsHidden()
	return true
end
function modifier_faceless_void_chronosphere_custom_friendly_buff:IsPurgable()
	return false
end
function modifier_faceless_void_chronosphere_custom_friendly_buff:IsPurgeException()
	return false
end
function modifier_faceless_void_chronosphere_custom_friendly_buff:OnCreated()
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_faceless_void_chronosphere_speed", {})
end
...
function modifier_faceless_void_chronosphere_custom_enemy:IsHidden()
	return true
end
function modifier_faceless_void_chronosphere_custom_enemy:IsPurgable()
	return false
end
function modifier_faceless_void_chronosphere_custom_enemy:IsPurgeException()
	return false
end
function modifier_faceless_void_chronosphere_custom_enemy:OnCreated()
	...
	self:GetParent()
		:AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_faceless_void_chronosphere_freeze", {})
end
