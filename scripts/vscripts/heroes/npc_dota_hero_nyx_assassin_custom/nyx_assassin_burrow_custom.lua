...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_nyx_assassin_custom/nyx_assassin_burrow_custom",
...
function modifier_nyx_assassin_burrow_custom:IsPurgable()
	return false
end
function modifier_nyx_assassin_burrow_custom:IsPurgeException()
	return false
end
...
function modifier_nyx_assassin_burrow_custom:OnDestroy()
	...
	local particle_ground = ParticleManager:CreateParticle(
