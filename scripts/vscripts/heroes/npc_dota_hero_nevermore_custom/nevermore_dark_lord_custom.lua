...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_nevermore_custom/nevermore_dark_lord_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_nevermore_dark_lord_custom_debuff",
	"heroes/npc_dota_hero_nevermore_custom/nevermore_dark_lord_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_nevermore_dark_lord_custom_aura:IsHidden()
	return true
end
function modifier_nevermore_dark_lord_custom_aura:IsPurgable()
	return false
end
function modifier_nevermore_dark_lord_custom_aura:IsDebuff()
	return false
end

function modifier_nevermore_dark_lord_custom_aura:GetAuraEntityReject(target)
	if
		not target:CanEntityBeSeenByMyTeam(self:GetCaster())
		or (self:GetCaster():GetTeam() == target:GetTeam() and self:GetCaster() ~= target)
	then
		return true
	end
	return false
...
function modifier_nevermore_dark_lord_custom_debuff:IsHidden()
	return false
end
function modifier_nevermore_dark_lord_custom_debuff:IsPurgable()
	return false
end
