...
LinkLuaModifier(
	"modifier_pangolier_fortune_favors_the_bold_custom",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_fortune_favors_the_bold_custom",
...
function modifier_pangolier_fortune_favors_the_bold_custom:IsHidden()
	return true
end
function modifier_pangolier_fortune_favors_the_bold_custom:IsPurgable()
	return false
end
function modifier_pangolier_fortune_favors_the_bold_custom:IsPurgeException()
	return false
end
function modifier_pangolier_fortune_favors_the_bold_custom:RemoveOnDeath()
	return false
end
