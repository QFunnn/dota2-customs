...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
...
LinkLuaModifier(
	"modifier_pangolier_swashbuckle_custom_wait",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_pangolier_swashbuckle_custom_handler",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_pangolier_swashbuckle_custom_handler_debuff",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_pangolier_swashbuckle_custom_handler_debuff_hidden",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_pangolier_swashbuckle_custom_debuff",
	"heroes/npc_dota_hero_pangolier_custom/pangolier_swashbuckle_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function pangolier_swashbuckle_custom:DealDamage(target, id)
	...
	local modifier_pangolier_swashbuckle_custom_handler_debuff_hidden = target:AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_pangolier_swashbuckle_custom_handler_debuff_hidden",
		{ duration = 0.2 }
...
function modifier_pangolier_swashbuckle_custom_dash:IsDebuff()
	return false
end
function modifier_pangolier_swashbuckle_custom_dash:IsHidden()
	return true
end
function modifier_pangolier_swashbuckle_custom_dash:IsPurgable()
	return false
end
...
function modifier_pangolier_swashbuckle_custom_dash:GetEffectName()
...
function modifier_pangolier_swashbuckle_custom_dash:OnDestroy()
	...
	if self:GetRemainingTime() < 0.1 then
		self.parent:AddNewModifier(
			...
			self.ability,
			"modifier_pangolier_swashbuckle_custom_attacks",
			{ dir_x = self.direction.x, dir_y = self.direction.y, duration = 3 }
		)
	else
...
function modifier_pangolier_swashbuckle_custom_attacks:GetAttributes()
...
function modifier_pangolier_swashbuckle_custom_attacks:OnCreated(kv)
	...
	if self:GetCaster():HasModifier("modifier_pangolier_9") then
		self.range = self.range
			+ self:GetAbility().modifier_pangolier_9[self:GetCaster():GetTalentLevel("modifier_pangolier_9")]
	end
	...
	if self:GetCaster():HasModifier("modifier_pangolier_10") then
		self.damage = self.damage
			+ self:GetAbility().modifier_pangolier_10[self:GetCaster():GetTalentLevel("modifier_pangolier_10")]
	end
	if self:GetCaster():HasModifier("modifier_pangolier_12") then
		self.damage = self.damage
			+ (
				self:GetCaster():GetAverageTrueAttackDamage(nil)
				/ 100
				* self:GetAbility().modifier_pangolier_12[self:GetCaster():GetTalentLevel("modifier_pangolier_12")]
			)
	end
...
function modifier_pangolier_swashbuckle_custom_wait:IsHidden()
	return true
end
function modifier_pangolier_swashbuckle_custom_wait:IsPurgable()
	return false
end
...
function modifier_pangolier_swashbuckle_custom_handler:IsHidden()
	return not self:GetCaster():HasModifier("modifier_pangolier_14")
end
function modifier_pangolier_swashbuckle_custom_handler:IsPurgable()
	return false
end
function modifier_pangolier_swashbuckle_custom_handler:IsPurgeException()
	return false
end
function modifier_pangolier_swashbuckle_custom_handler:RemoveOnDeath()
	return false
end
function modifier_pangolier_swashbuckle_custom_handler:GetTexture()
	return "pangolier_14"
end
...
function modifier_pangolier_swashbuckle_custom_handler:OnAttackLanded(params)
	...
	if self:GetCaster():HasModifier("modifier_pangolier_14") then
		...
		if self:GetStackCount() == self:GetAbility().modifier_pangolier_14_attacks then
			...
			self:SetStackCount(0)
			local modifier_pangolier_swashbuckle_custom_handler_debuff =
				self:GetParent():FindModifierByName("modifier_pangolier_swashbuckle_custom_handler_debuff")
			...
			self:GetParent():AddNewModifier(
				...
				self:GetAbility(),
				"modifier_pangolier_swashbuckle_custom_attacks",
				{ dir_x = direction.x, dir_y = direction.y, duration = 3, attacks = 1 }
			)
		end
	end
end
...
function modifier_pangolier_swashbuckle_custom_handler_debuff:IsHidden()
	return true
end
function modifier_pangolier_swashbuckle_custom_handler_debuff:IsPurgable()
	return false
end
function modifier_pangolier_swashbuckle_custom_handler_debuff:IsPurgeException()
	return false
end
function modifier_pangolier_swashbuckle_custom_handler_debuff:RemoveOnDeath()
	return false
end
...
function modifier_pangolier_swashbuckle_custom_handler_debuff_hidden:IsHidden()
	return true
end
function modifier_pangolier_swashbuckle_custom_handler_debuff_hidden:IsPurgable()
	return false
end

modifier_pangolier_swashbuckle_custom_debuff = class({})
function modifier_pangolier_swashbuckle_custom_debuff:IsPurgable()
	return true
end
function modifier_pangolier_swashbuckle_custom_debuff:IsHidden()
	return false
end
