...
function modifier_sand_king_caustic_finale_lua:AllowIllusionDuplicate()
	return false
end
--------------------------------------------------------------------------------
-- Initializations
...
function modifier_sand_king_caustic_finale_lua:OnDestroy(kv) end
...
function modifier_sand_king_caustic_finale_lua:GetModifierProcAttack_Feedback(params)
	if IsServer() then
		...
		local modifier =
			params.target:FindModifierByNameAndCaster("modifier_sand_king_caustic_finale_lua_debuff", self:GetParent())
