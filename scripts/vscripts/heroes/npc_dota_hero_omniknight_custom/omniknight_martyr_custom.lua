...
LinkLuaModifier(
	"modifier_omniknight_martyr_custom",
	"heroes/npc_dota_hero_omniknight_custom/omniknight_martyr_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_omniknight_martyr_custom_talent_passive",
	"heroes/npc_dota_hero_omniknight_custom/omniknight_martyr_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
LinkLuaModifier(
	"modifier_omniknight_martyr_custom_talent_passive_buff",
	"heroes/npc_dota_hero_omniknight_custom/omniknight_martyr_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_omniknight_martyr_custom_talent_passive_cooldown:IsDebuff()
	return true
end
function modifier_omniknight_martyr_custom_talent_passive_cooldown:IsPurgable()
	return false
end

modifier_omniknight_martyr_custom_talent_passive = class({})
function modifier_omniknight_martyr_custom_talent_passive:IsHidden()
	return true
end
...
function modifier_omniknight_martyr_custom_talent_passive:OnIntervalThink()
	...
	if self:GetCaster():HasModifier("modifier_omniknight_martyr_custom_talent_passive_cooldown") then
		return
	end
	if not self:GetCaster():HasModifier("modifier_omniknight_6") then
		return
	end
	self:GetCaster():AddNewModifier(
		...
		"modifier_omniknight_martyr_custom_talent_passive_cooldown",
		{
			duration = self:GetAbility().modifier_omniknight_6_cooldown[self:GetCaster()
				:GetTalentLevel("modifier_omniknight_6")],
		}
	)
...
function modifier_omniknight_martyr_custom_talent_passive_buff:IsPurgable()
	return false
end
