...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_omniknight_custom/omniknight_guardian_angel_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_omniknight_guardian_angel_custom_aura",
	"heroes/npc_dota_hero_omniknight_custom/omniknight_guardian_angel_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_omniknight_guardian_angel_custom_aura:IsPurgable()
	return false
end
function modifier_omniknight_guardian_angel_custom_aura:IsPurgeException()
	return false
end
function modifier_omniknight_guardian_angel_custom_aura:IsAura()
	return true
end
function modifier_omniknight_guardian_angel_custom_aura:GetModifierAura()
	return "modifier_omniknight_guardian_angel_custom"
end
function modifier_omniknight_guardian_angel_custom_aura:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end
function modifier_omniknight_guardian_angel_custom_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_omniknight_guardian_angel_custom_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_omniknight_guardian_angel_custom_aura:GetAuraSearchFlags()
...
function modifier_omniknight_guardian_angel_custom_aura:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_omniknight/omniknight_guardian_angel_aura.vpcf",
...
function modifier_omniknight_guardian_angel_custom:GetModifierConstantManaRegen()
	if not self:GetParent():HasModifier("modifier_omniknight_20") then
		return
	end
