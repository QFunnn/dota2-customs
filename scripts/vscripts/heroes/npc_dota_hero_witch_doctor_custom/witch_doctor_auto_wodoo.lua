...
LinkLuaModifier(
	"modifier_witch_doctor_auto_wodoo",
	"heroes/npc_dota_hero_witch_doctor_custom/witch_doctor_auto_wodoo",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_witch_doctor_auto_wodoo_attack",
	"heroes/npc_dota_hero_witch_doctor_custom/witch_doctor_auto_wodoo",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_witch_doctor_auto_wodoo_effect",
	"heroes/npc_dota_hero_witch_doctor_custom/witch_doctor_auto_wodoo",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_witch_doctor_auto_wodoo:IsHidden()
	return true
end
function modifier_witch_doctor_auto_wodoo:IsPurgable()
	return false
end
