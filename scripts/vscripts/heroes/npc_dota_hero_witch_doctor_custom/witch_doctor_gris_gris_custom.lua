...
LinkLuaModifier(
	"modifier_witch_doctor_gris_gris_custom",
	"heroes/npc_dota_hero_witch_doctor_custom/witch_doctor_gris_gris_custom",
...
function modifier_witch_doctor_gris_gris_custom:IsHidden()
	return true
end
function modifier_witch_doctor_gris_gris_custom:IsPurgable()
	return false
end
function modifier_witch_doctor_gris_gris_custom:IsPurgeException()
	return false
end
function modifier_witch_doctor_gris_gris_custom:RemoveOnDeath()
	return false
end
