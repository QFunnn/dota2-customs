...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_witch_doctor_custom/witch_doctor_maledict_custom",
...
function witch_doctor_maledict_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/new_year/anniversary_10th_hat_ambient_npc_dota_hero_witch_doctor.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/new_year_2/anniversary_10th_hat_ambient_npc_dota_hero_witch_doctor.vpcf",
		context
	)
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_witch_doctor.vpcf",
		context
	)
end
...
function modifier_witch_doctor_maledict_custom:IsPurgable()
	return false
end
function modifier_witch_doctor_maledict_custom:IsPurgeException()
	return false
end
...
function modifier_witch_doctor_maledict_custom:OnCreated()
	...
	if self:GetCaster():HasModifier("modifier_witch_doctor_17") then
		self.damage = self.damage
			+ self:GetAbility().modifier_witch_doctor_17[self:GetCaster():GetTalentLevel("modifier_witch_doctor_17")]
	end
...
function modifier_witch_doctor_maledict_custom:DealHPBurstDamage()
	local damage = (self.max_health - self:GetParent():GetHealth())
		/ 100
