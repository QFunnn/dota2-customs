...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_razor_custom/razor_static_link_custom",
...
LinkLuaModifier(
	"modifier_razor_static_link_custom_handler",
	"heroes/npc_dota_hero_razor_custom/razor_static_link_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function razor_static_link_custom:OnAbilityPhaseStart()
	...
	local modifier_razor_static_link_custom_target =
		target:FindModifierByName("modifier_razor_static_link_custom_target")
...
function modifier_razor_static_link_custom:GetAttributes()
...
function modifier_razor_static_link_custom_attacking:OnIntervalThink()
	...
	if
		...
		and not self.caster:IsDisarmedCustom({ ["modifier_razor_static_link_custom_attacking"] = true })
...
function modifier_razor_static_link_custom_handler:GetTexture()
	return "razor_14"
end
function modifier_razor_static_link_custom_handler:IsHidden()
	return self:GetStackCount() <= 0
end
function modifier_razor_static_link_custom_handler:IsPurgable()
	return false
end
function modifier_razor_static_link_custom_handler:RemoveOnDeath()
	return false
end
