...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_razor_custom/razor_plasma_field_custom",
...
LinkLuaModifier(
	"modifier_razor_plasma_field_custom_handler",
	"heroes/npc_dota_hero_razor_custom/razor_plasma_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_plasma_field_custom_silence",
	"heroes/npc_dota_hero_razor_custom/razor_plasma_field_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function razor_plasma_field_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_razor.vpcf",
		context
	)
end
...
function razor_plasma_field_custom:OnSpellStart(new_target)
	...
	local modifier_razor_plasma_field_custom_handler = self:GetCaster()
		:FindModifierByName("modifier_razor_plasma_field_custom_handler")
...
function modifier_razor_plasma_field_custom:OnCreated(kv)
	...
	if self.caster:HasModifier("modifier_razor_19") then
		self.slow_max = self.slow_max
			+ self.ability.modifier_razor_19_slow[self:GetCaster():GetTalentLevel("modifier_razor_19")]
		self.slow_min = self.slow_min
			+ self.ability.modifier_razor_19_slow[self:GetCaster():GetTalentLevel("modifier_razor_19")]
...
function modifier_razor_plasma_field_custom_handler:GetTexture()
	return "razor_21"
end
function modifier_razor_plasma_field_custom_handler:IsHidden()
	return not self:GetCaster():HasModifier("modifier_razor_21")
end
function modifier_razor_plasma_field_custom_handler:IsPurgable()
	return false
end
function modifier_razor_plasma_field_custom_handler:IsPurgeException()
	return false
end
function modifier_razor_plasma_field_custom_handler:RemoveOnDeath()
	return false
end

modifier_razor_plasma_field_custom_silence = class({})
function modifier_razor_plasma_field_custom_silence:GetTexture()
	return "razor_21"
end
function modifier_razor_plasma_field_custom_silence:IsPurgable()
	return false
end
function modifier_razor_plasma_field_custom_silence:IsPurgeException()
	return false
end
