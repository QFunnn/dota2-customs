...
LinkLuaModifier(
	"modifier_razor_striders_custom",
	"heroes/npc_dota_hero_razor_custom/razor_striders_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_striders_custom_thinker",
	"heroes/npc_dota_hero_razor_custom/razor_striders_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_razor_striders_custom_thinker_debuff",
	"heroes/npc_dota_hero_razor_custom/razor_striders_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_razor_striders_custom:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/econ/items/razor/razor_arcana/razor_arcana_phase_boots.vpcf",
...
function modifier_razor_striders_custom_thinker:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/razor_custom/striders_thinker.vpcf",
		PATTACH_ABSORIGIN_FOLLOW,
		self:GetParent()
	)
	ParticleManager:SetParticleControl(particle, 0, self:GetParent():GetAbsOrigin())
