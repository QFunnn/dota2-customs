...
LinkLuaModifier(
	"modifier_tidehunter_anchor_smash_custom",
	"heroes/npc_dota_hero_tidehunter_custom/tidehunter_anchor_smash_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_tidehunter_anchor_smash_custom_buff",
	"heroes/npc_dota_hero_tidehunter_custom/tidehunter_anchor_smash_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function tidehunter_anchor_smash_custom:OnSpellStart()
	...
	if self:GetCaster():HasModifier("modifier_tidehunter_11") then
		bonus_damage = bonus_damage
			+ self.modifier_tidehunter_11[self:GetCaster():GetTalentLevel("modifier_tidehunter_11")]
	end
	...
	local mod =
		caster:AddNewModifier(caster, self, "modifier_tidehunter_anchor_smash_custom_buff", { bonus = bonus_damage })
