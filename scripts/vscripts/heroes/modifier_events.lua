...
function public:OnTakeDamageKillCredit(params)
	...
	if IsValid(params.target) and params.target.tTargetModifierEvents and params.target.tTargetModifierEvents[MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT] then
...
function public:OnHeroKilled(params)
	if IsValid(params.unit) and params.unit.tSourceModifierEvents and params.unit.tSourceModifierEvents[MODIFIER_EVENT_ON_HERO_KILLED] then
	...
	if IsValid(params.target) and params.target.tTargetModifierEvents and params.target.tTargetModifierEvents[MODIFIER_EVENT_ON_HERO_KILLED] then
