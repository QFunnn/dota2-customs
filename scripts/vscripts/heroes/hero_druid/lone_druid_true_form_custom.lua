...
LinkLuaModifier(
	...
	"heroes/hero_druid/lone_druid_true_form_custom",
...
function modifier_lone_druid_true_form_custom:IsHidden()
	return false
end
...
function modifier_lone_druid_true_form_custom:OnCreated()
	...
	self.bonus_hp = self:GetAbility():GetSpecialValueFor("bonus_hp")
		+ self:GetCaster():FindTalentValue("special_bonus_unique_lone_druid_7")
