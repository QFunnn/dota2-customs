...
LinkLuaModifier(
	"modifier_death_prophet_silence_custom",
	"heroes/npc_dota_hero_death_prophet_custom/death_prophet_silence_custom",
...
function death_prophet_silence_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/units/heroes/hero_death_prophet/death_prophet_silence_projectile.vpcf",
		context
	)
...
function death_prophet_silence_custom:GetCastRange(vLocation, hTarget)
	if self:GetCaster():HasModifier("modifier_death_prophet_10") then
		return self:GetSpecialValueFor("radius")
			+ self.modifier_death_prophet_10[self:GetCaster():GetTalentLevel("modifier_death_prophet_10")]
	end
...
function modifier_death_prophet_silence_custom:IsHidden()
	return true
end
