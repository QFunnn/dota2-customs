...
LinkLuaModifier(
	"modifier_death_prophet_witchcraft_custom",
	"heroes/npc_dota_hero_death_prophet_custom/death_prophet_witchcraft_custom",
...
function modifier_death_prophet_witchcraft_custom:IsHidden()
	return true
end
function modifier_death_prophet_witchcraft_custom:IsPurgable()
	return false
end
function modifier_death_prophet_witchcraft_custom:IsPurgeException()
	return false
end
function modifier_death_prophet_witchcraft_custom:RemoveOnDeath()
	return false
end
...
function modifier_death_prophet_witchcraft_custom:GetModifierSpellAmplify_Percentage()
	if self:GetCaster():HasModifier("modifier_death_prophet_19") then
		return self:GetAbility().modifier_death_prophet_19[self:GetCaster():GetTalentLevel("modifier_death_prophet_19")]
			* self:GetParent():GetLevel()
	end
end