...
LinkLuaModifier(
	"modifier_oracle_prognosticate_custom",
	"heroes/npc_dota_hero_oracle_custom/oracle_prognosticate_custom",
...
function modifier_oracle_prognosticate_custom:IsHidden()
	return true
end
function modifier_oracle_prognosticate_custom:IsPurgable()
	return false
end
function modifier_oracle_prognosticate_custom:IsPurgeException()
	return false
end
function modifier_oracle_prognosticate_custom:RemoveOnDeath()
	return false
end
