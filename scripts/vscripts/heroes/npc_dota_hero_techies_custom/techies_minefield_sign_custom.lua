...
LinkLuaModifier(
	"modifier_techies_minefield_sign_custom",
	"heroes/npc_dota_hero_techies_custom/techies_minefield_sign_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_minefield_sign_custom_thinker",
	"heroes/npc_dota_hero_techies_custom/techies_minefield_sign_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_minefield_sign_custom_damage_thinker",
	"heroes/npc_dota_hero_techies_custom/techies_minefield_sign_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_minefield_sign_custom_damage_thinker_debuff",
	"heroes/npc_dota_hero_techies_custom/techies_minefield_sign_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_minefield_sign_custom_sign_activated",
	"heroes/npc_dota_hero_techies_custom/techies_minefield_sign_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function techies_minefield_sign_custom:OnAbilityPhaseStart()
	...
	self.modifier_techies_minefield_sign_custom_thinker = CreateModifierThinker(
		self:GetCaster(),
		self,
		"modifier_techies_minefield_sign_custom_thinker",
...
function techies_minefield_sign_custom:OnAbilityPhaseInterrupted()
	if
		self.modifier_techies_minefield_sign_custom_thinker
		and not self.modifier_techies_minefield_sign_custom_thinker:IsNull()
	then
...
function techies_minefield_sign_custom:OnSpellStart()
	...
	local sign =
		CreateUnitByName("npc_dota_techies_minefield_sign", point, false, nil, nil, self:GetCaster():GetTeamNumber())
...
function modifier_techies_minefield_sign_custom:IsHidden()
	return true
end
function modifier_techies_minefield_sign_custom:IsPurgable()
	return false
end
...
function modifier_techies_minefield_sign_custom:OnIntervalThink()
	...
	local units = FindUnitsInRadius(
		...
		nil,
		self:GetAbility():GetSpecialValueFor("scepter_move_amt"),
	...
	if #units > 0 and not self.activated_sign then
		...
		self:GetParent():AddNewModifier(
			...
			self:GetAbility(),
			"modifier_techies_minefield_sign_custom_sign_activated",
			{ duration = self:GetAbility():GetSpecialValueFor("minefield_duration") }
		)
...
function modifier_techies_minefield_sign_custom_thinker:IsHidden()
	return true
end
function modifier_techies_minefield_sign_custom_thinker:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_techies/techies_minefield_cast.vpcf",
...
function modifier_techies_minefield_sign_custom_sign_activated:IsHidden()
	return true
end
function modifier_techies_minefield_sign_custom_sign_activated:IsPurgable()
	return false
end
...
function modifier_techies_minefield_sign_custom_damage_thinker:IsHidden()
	return true
end
function modifier_techies_minefield_sign_custom_damage_thinker:IsPurgable()
	return false
end
function modifier_techies_minefield_sign_custom_damage_thinker:IsAura()
	return true
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetModifierAura()
	return "modifier_techies_minefield_sign_custom_damage_thinker_debuff"
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("aura_radius")
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetAuraDuration()
	return 0.1
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_techies_minefield_sign_custom_damage_thinker:GetAuraSearchFlags()
	return 0
end
function modifier_techies_minefield_sign_custom_damage_thinker:OnCreated()
	...
	local particle = ParticleManager:CreateParticle(
		"particles/units/heroes/hero_techies/techies_minefield.vpcf",
		PATTACH_WORLDORIGIN,
		nil
	)
	ParticleManager:SetParticleControl(particle, 0, self:GetParent():GetAbsOrigin())
...
function modifier_techies_minefield_sign_custom_damage_thinker_debuff:IsPurgable()
	return false
end
function modifier_techies_minefield_sign_custom_damage_thinker_debuff:IsHidden()
	return false
end
...
function modifier_techies_minefield_sign_custom_damage_thinker_debuff:OnIntervalThink()
	...
	if self.distance >= self.max_distance then
		self.distance = 0
		local particle = ParticleManager:CreateParticle(
			"particles/units/heroes/hero_techies/techies_minefield_scepter_explode.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			self:GetParent()
		)
		ParticleManager:SetParticleControl(particle, 0, self:GetParent():GetAbsOrigin())
		...
		ApplyDamage({
			...
			damage = self:GetAbility():GetSpecialValueFor("scepter_move_damage"),
