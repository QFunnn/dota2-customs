...
LinkLuaModifier(
	"modifier_techies_burn_out_custom",
	"heroes/npc_dota_hero_techies_custom/techies_burn_out_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_burn_out_custom_thinker",
	"heroes/npc_dota_hero_techies_custom/techies_burn_out_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_techies_burn_out_custom_debuff",
	"heroes/npc_dota_hero_techies_custom/techies_burn_out_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function techies_burn_out_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/items/batrider/batrider_ti8_immortal_mount/batrider_ti8_immortal_firefly_debuff.vpcf",
		context
	)
end
...
function modifier_techies_burn_out_custom:IsPurgable()
	return false
end
function modifier_techies_burn_out_custom:IsPurgeException()
	return false
end
...
function modifier_techies_burn_out_custom_thinker:IsHidden()
	return true
end
function modifier_techies_burn_out_custom_thinker:IsPurgable()
	return false
end
function modifier_techies_burn_out_custom_thinker:IsAura()
	return true
end
function modifier_techies_burn_out_custom_thinker:GetModifierAura()
	return "modifier_techies_burn_out_custom_debuff"
end
function modifier_techies_burn_out_custom_thinker:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("width")
end
function modifier_techies_burn_out_custom_thinker:GetAuraDuration()
	return 2
end
function modifier_techies_burn_out_custom_thinker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_techies_burn_out_custom_thinker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_techies_burn_out_custom_thinker:GetAuraSearchFlags()
	return 0
end
...
function modifier_techies_burn_out_custom_debuff:OnIntervalThink()
	...
	ApplyDamage({
		...
		damage = (self:GetCaster():GetMaxHealth() / 100 * self.damage) * 0.5,
