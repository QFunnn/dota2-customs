...
LinkLuaModifier(
	"modifier_antimage_mana_overload_custom_illusion",
	"heroes/npc_dota_hero_antimage_custom/antimage_mana_overload_custom",
...
function antimage_mana_overload_custom:OnSpellStart()
	...
	local illusion = CreateIllusions(
		self:GetCaster(),
		self:GetCaster(),
		{ duration = duration, outgoing_damage = outgoing_damage, incoming_damage = incoming_damage },
		1,
		0,
		false,
		false
...
function modifier_antimage_mana_overload_custom_illusion:IsHidden()
	return false
end
function modifier_antimage_mana_overload_custom_illusion:IsPurgable()
	return false
end