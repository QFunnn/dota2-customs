...
LinkLuaModifier(
	"modifier_luna_lunar_blessing_custom",
	"heroes/npc_dota_hero_luna_custom/luna_lunar_blessing_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_luna_lunar_blessing_custom_buff",
	"heroes/npc_dota_hero_luna_custom/luna_lunar_blessing_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_luna_lunar_blessing_custom:IsHidden()
	return true
end
function modifier_luna_lunar_blessing_custom:IsPurgable()
	return false
end
function modifier_luna_lunar_blessing_custom:IsPurgeException()
	return false
end
function modifier_luna_lunar_blessing_custom:RemoveOnDeath()
	return false
end
...
function modifier_luna_lunar_blessing_custom_buff:IsPurgable()
	return false
end
function modifier_luna_lunar_blessing_custom_buff:IsPurgeException()
	return false
end
