...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_luna_custom/luna_eclipse_custom",
...
function luna_eclipse_custom:Precache(context)
	...
	PrecacheResource(
		"particle",
		"particles/econ/events/anniversary_10th/anniversary_10th_hat_ambient_npc_dota_hero_luna.vpcf",
		context
	)
end
...
function modifier_luna_eclipse_custom:IsPurgeException()
	return false
end
