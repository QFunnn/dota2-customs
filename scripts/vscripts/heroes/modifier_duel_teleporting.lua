...
function modifier_duel_teleporting:IsHidden()
	return true
end
function modifier_duel_teleporting:IsPurgable()
	return false
end
function modifier_duel_teleporting:RemoveOnDeath()
	return false
end
function modifier_duel_teleporting:IsPurgeException()
	return false
end
...
function modifier_duel_teleporting:OnCreated()
	...
	self.teleportFromEffect =
		ParticleManager:CreateParticle("particles/items2_fx/teleport_start.vpcf", PATTACH_ABSORIGIN, self:GetCaster())
...
function modifier_duel_teleporting_2:IsHidden()
	return true
end
function modifier_duel_teleporting_2:IsPurgable()
	return false
end
function modifier_duel_teleporting_2:RemoveOnDeath()
	return false
end
function modifier_duel_teleporting_2:IsPurgeException()
	return false
end
