...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_slark_custom/slark_shadow_dance_custom",
...
LinkLuaModifier(
	"modifier_slark_shadow_dance_custom_pull",
	"heroes/npc_dota_hero_slark_custom/slark_shadow_dance_custom",
...
function slark_shadow_dance_custom:OnSpellStart(new_duration)
	...
	if new_duration then
		...
		local modifier_slark_shadow_dance_custom = self:GetCaster()
			:FindModifierByName("modifier_slark_shadow_dance_custom")
		if modifier_slark_shadow_dance_custom then
			if modifier_slark_shadow_dance_custom:GetRemainingTime() > duration then
				duration = modifier_slark_shadow_dance_custom:GetRemainingTime()
			end
		end
	end
	...
	if self:GetCaster():HasModifier("modifier_slark_12") then
		local enemies = FindUnitsInRadius(
			...
			nil,
			self.modifier_slark_12[self:GetCaster():GetTalentLevel("modifier_slark_12")],
...
function modifier_slark_shadow_dance_custom_pull:GetTexture()
	return "slark_12"
end
