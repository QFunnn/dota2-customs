...
LinkLuaModifier(
	"modifier_slark_fish_bait_custom_debuff",
	"heroes/npc_dota_hero_slark_custom/slark_fish_bait_custom",
...
function modifier_slark_fish_bait_custom_debuff:IsPurgable()
	return not self:GetCaster():HasModifier("modifier_slark_20")
end
