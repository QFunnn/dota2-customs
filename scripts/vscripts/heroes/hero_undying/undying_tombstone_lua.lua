...
LinkLuaModifier(
	...
	"heroes/hero_undying/modifier_undying_tombstone_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_undying_tombstone_lua_passive",
	"heroes/hero_undying/modifier_undying_tombstone_lua_passive",
	LUA_MODIFIER_MOTION_NONE
)
...
function undying_tombstone_lua:Precache(context)
	PrecacheUnitByNameSync("npc_dota_creature_tombstone", context)
	PrecacheUnitByNameSync("npc_dota_creature_tombstone_zombie", context)
	PrecacheUnitByNameSync("npc_dota_creature_tombstone_zombie_torso", context)
end
...
function undying_tombstone_lua:OnSpellStart()
	if IsServer() then
		...
		local hTombstone = CreateUnitByName(
