...
undying_decay_lua = class({}) ---@class undying_decay_lua : CDOTA_Abiltiy_Lua
...
function undying_decay_lua:OnSpellStart()
	...
	local str_steal_hero = self:GetSpecialValueFor("str_steal_hero")
	local str_steal_creep = self:GetSpecialValueFor("str_steal_creep")
...
modifier_undying_decay_lua_debuff = class({}) ---@class modifier_undying_decay_lua_debuff : CDOTA_Modifier_Lua
