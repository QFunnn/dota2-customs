...
function modifier_faceless_void_time_lock_custom:IsPurgable()
	return false
end
function modifier_faceless_void_time_lock_custom:IsDebuff()
	return false
end
function modifier_faceless_void_time_lock_custom:IsHidden()
	return true
end
...
function modifier_faceless_void_time_lock_custom_scepter:IsHidden()
	return true
end
function modifier_faceless_void_time_lock_custom_scepter:IsPurgable()
	return false
end
...
function modifier_faceless_void_time_lock_custom_scepter:OnDestroy()
	...
	if self:GetParent().bCanTriggerLock == true then
		return
	end
