...
LinkLuaModifier(
	"modifier_templar_assassin_inner_peace_custom",
	"heroes/templar_assassin/templar_assassin_inner_peace_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_templar_assassin_inner_peace_custom_activity",
	"heroes/templar_assassin/templar_assassin_inner_peace_custom.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
