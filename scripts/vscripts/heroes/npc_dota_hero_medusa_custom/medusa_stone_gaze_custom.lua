...
LinkLuaModifier(
	"modifier_medusa_stone_gaze_custom_debuff",
	"heroes/npc_dota_hero_medusa_custom/medusa_stone_gaze_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
...
function medusa_stone_gaze_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_medusa_stone_gaze_custom", { duration = duration })
end

modifier_medusa_stone_gaze_custom = class({})
function modifier_medusa_stone_gaze_custom:IsPurgable()
	return false
end
function modifier_medusa_stone_gaze_custom:GetAttributes()
...
function modifier_medusa_stone_gaze_custom_debuff:IsPurgable()
	return false
end
...
function modifier_medusa_stone_gaze_custom_petrified:IsPurgable()
	return true
end
