...
LinkLuaModifier(
	"modifier_medusa_stone_ability",
	"heroes/npc_dota_hero_medusa_custom/medusa_stone_ability",
...
function modifier_medusa_stone_ability:IsPurgable()
	return false
end
function modifier_medusa_stone_ability:IsPurgeException()
	return false
end
