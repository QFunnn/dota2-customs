...
LinkLuaModifier(
	"modifier_chen_hand_of_god_custom",
	"heroes/hero_chen/chen_hand_of_god_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_chen_hand_of_god_custom_immunity",
	"heroes/hero_chen/chen_hand_of_god_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_chen_hand_of_god_custom:GetAttributes()
...
function modifier_chen_hand_of_god_custom_immunity:IsPurgable()
	return false
end
function modifier_chen_hand_of_god_custom_immunity:IsPurgeException()
	return false
end
