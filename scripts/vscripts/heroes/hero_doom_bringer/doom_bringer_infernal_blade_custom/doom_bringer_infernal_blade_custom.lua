...
LinkLuaModifier(
	...
	"heroes/hero_doom_bringer/doom_bringer_infernal_blade_custom/doom_bringer_infernal_blade_custom",
...
function doom_bringer_infernal_blade_custom:OnOrbImpact(params)
	...
	params.target:AddNewModifier(self:GetCaster(), self, "modifier_stunned", { duration = ministun_duration })
end
