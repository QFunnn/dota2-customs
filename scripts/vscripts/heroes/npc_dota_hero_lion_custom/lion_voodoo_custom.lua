...
LinkLuaModifier(
	"modifier_lion_voodoo_custom",
	"heroes/npc_dota_hero_lion_custom/lion_voodoo_custom",
...
function modifier_lion_voodoo_custom:IsPurgable()
	return false
end
function modifier_lion_voodoo_custom:IsPurgeException()
	return true
end
