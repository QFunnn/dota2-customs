...
LinkLuaModifier(
	"modifier_skywrath_mage_shield_of_the_scion_lua",
	"heroes/hero_skywrath_mage/skywrath_mage_shield_of_the_scion_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skywrath_mage_shield_of_the_scion_lua_buff",
	"heroes/hero_skywrath_mage/skywrath_mage_shield_of_the_scion_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
...
function modifier_skywrath_mage_shield_of_the_scion_lua:GetModifierTotalDamageOutgoing_Percentage(params)
	...
	if
		...
		and hInflictor.IsPassive
		and type(hInflictor.IsPassive) == "function"
