...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_windrunner_windrun_custom_tooltip",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_windrunner_windrun_custom_debuff",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_windrunner_windrun_custom_tornado",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)

LinkLuaModifier(
	"modifier_windrunner_windrun_pull_buff",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_windrunner_windrun_pull_debuff",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_windrunner_windrun_pull_armor_debuff",
	"heroes/npc_dota_hero_windrunner_custom/windrunner_windrun_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function windrunner_windrun_custom:OnSpellStart()
	...
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_windrunner_windrun_custom", { duration = duration })
	self:GetCaster()
		:AddNewModifier(self:GetCaster(), self, "modifier_windrunner_windrun_custom_tooltip", { duration = duration })
...
function windrunner_windrun_custom:CreateTornado()
	if self:GetCaster():HasModifier("modifier_windrunner_9") then
		...
		tornado:AddNewModifier(
			self:GetCaster(),
			self,
			"modifier_windrunner_windrun_custom_tornado",
			{ duration = self.modifier_windrunner_9_duration }
		)
...
function modifier_windrunner_windrun_custom_tooltip:IsHidden()
	return true
end
function modifier_windrunner_windrun_custom_tooltip:IsPurgable()
	return true
end
	...
	if self:GetCaster():HasModifier("modifier_windrunner_10") then
		self.damage = self.damage
			+ (
				...
				/ 100
				* self:GetAbility().modifier_windrunner_10_agility_damage[self:GetCaster()
					:GetTalentLevel("modifier_windrunner_10")]
			)
	end
...
function modifier_windrunner_windrun_pull_buff:IsHidden()
	return true
end
function modifier_windrunner_windrun_pull_buff:IsPurgable()
	return false
end
function modifier_windrunner_windrun_pull_buff:IsAura()
	return true
end
...
function modifier_windrunner_windrun_pull_debuff:IsPurgable()
	return false
end
function modifier_windrunner_windrun_pull_debuff:IsHidden()
	return true
end
function modifier_windrunner_windrun_pull_debuff:GetAttributes()
...
function modifier_windrunner_windrun_pull_debuff:OnCreated()
	...
	self.effect_cast =
		ParticleManager:CreateParticle("particles/windrunner_pull.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
...
function modifier_windrunner_windrun_pull_debuff:OnIntervalThink()
	...
	local modifier_windrunner_11_duration = self:GetAbility().modifier_windrunner_11_duration[self:GetCaster()
		:GetTalentLevel("modifier_windrunner_11")]
	self:GetParent():AddNewModifier(
		self:GetCaster(),
		self:GetAbility(),
		"modifier_windrunner_windrun_pull_armor_debuff",
		{ duration = modifier_windrunner_11_duration * (1 - self:GetParent():GetStatusResistance()) }
	)
end
...
function modifier_windrunner_windrun_pull_armor_debuff:IsDebuff()
	return true
end
...
function modifier_windrunner_windrun_pull_armor_debuff:OnCreated()
	...
	if self:GetStackCount() >= self:GetAbility().modifier_windrunner_11_max then
		return
	end
