...
LinkLuaModifier(
	"modifier_lich_ice_spire_custom",
	"heroes/npc_dota_hero_lich_custom/lich_ice_spire_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lich_ice_spire_custom_aura",
	"heroes/npc_dota_hero_lich_custom/lich_ice_spire_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_lich_ice_spire_custom:IsHidden()
	return true
end
function modifier_lich_ice_spire_custom:IsPurgable()
	return false
end
...
function modifier_lich_ice_spire_custom:GetAbsoluteNoDamageMagical()
	return 1
end
function modifier_lich_ice_spire_custom:GetAbsoluteNoDamagePhysical()
	return 1
end
function modifier_lich_ice_spire_custom:GetAbsoluteNoDamagePure()
	return 1
end
