...
LinkLuaModifier(
	"modifier_lich_frost_nova_custom",
	"heroes/npc_dota_hero_lich_custom/lich_frost_nova_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lich_frost_nova_custom_hp_regen",
	"heroes/npc_dota_hero_lich_custom/lich_frost_nova_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_lich_frost_nova_custom_thinker_cast",
	"heroes/npc_dota_hero_lich_custom/lich_frost_nova_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function lich_frost_nova_custom:ApplyFrostStack()
	if self:GetCaster():HasModifier("modifier_lich_19") then
		self:GetCaster():AddNewModifier(
			...
			self,
			"modifier_lich_frost_nova_custom_hp_regen",
			{ duration = self.modifier_lich_19_duration }
		)
	end
end
...
function modifier_lich_frost_nova_custom_hp_regen:GetTexture()
	return "lich_19"
end
...
function modifier_lich_frost_nova_custom_hp_regen:GetModifierConstantHealthRegen()
	return self:GetStackCount()
		* self:GetAbility().modifier_lich_19[self:GetCaster():GetTalentLevel("modifier_lich_19")]
end
...
function modifier_lich_frost_nova_custom_thinker_cast:IsHidden()
	return false
end
function modifier_lich_frost_nova_custom_thinker_cast:IsPurgable()
	return false
end
