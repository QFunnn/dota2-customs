...
LinkLuaModifier(
	...
	"heroes/hero_underlord/abyssal_underlord_firestorm_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_abyssal_underlord_firestorm_custom_thinker",
	"heroes/hero_underlord/abyssal_underlord_firestorm_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_abyssal_underlord_firestorm_custom_thinker:OnIntervalThink()
	...
	for _, enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(self.caster, self.ability, "modifier_abyssal_underlord_firestorm_custom", {
