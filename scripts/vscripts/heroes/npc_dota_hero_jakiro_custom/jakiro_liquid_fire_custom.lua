...
LinkLuaModifier(
	"modifier_generic_orb_effect_lua_jakiro",
	"modifiers/modifier_generic_orb_effect_lua_jakiro",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_jakiro_liquid_fire_custom",
	"heroes/npc_dota_hero_jakiro_custom/jakiro_liquid_fire_custom",
	LUA_MODIFIER_MOTION_NONE
)
