...
function modifier_clinkz_skeletons:IsHidden()
	return true
end
function modifier_clinkz_skeletons:IsDebuff()
	return false
end
function modifier_clinkz_skeletons:IsPurgable()
	return false
end
function modifier_clinkz_skeletons:GetAttributes()
