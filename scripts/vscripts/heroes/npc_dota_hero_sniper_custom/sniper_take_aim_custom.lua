...
LinkLuaModifier(
	...
	"heroes/npc_dota_hero_sniper_custom/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_sniper_take_aim_custom",
	"heroes/npc_dota_hero_sniper_custom/sniper_take_aim_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_sniper_take_aim_custom:IsPurgeException()
	return false
end
function modifier_sniper_take_aim_custom:RemoveOnDeath()
	return false
end
...
function modifier_sniper_take_aim_custom_active:IsHidden()
	return not self:GetCaster():HasModifier("modifier_sniper_14")
end
...
function modifier_sniper_take_aim_custom_active:GetModifierMoveSpeedBonus_Percentage()
	if not self:GetCaster():HasModifier("modifier_sniper_14") then
		return
	end
