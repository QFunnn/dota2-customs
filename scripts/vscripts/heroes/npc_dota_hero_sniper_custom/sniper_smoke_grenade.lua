...
LinkLuaModifier(
	"modifier_sniper_smoke_grenade_debuff",
	"heroes/npc_dota_hero_sniper_custom/sniper_smoke_grenade",
	LUA_MODIFIER_MOTION_BOTH
)
LinkLuaModifier(
	"modifier_sniper_smoke_grenade_thinker",
	"heroes/npc_dota_hero_sniper_custom/sniper_smoke_grenade",
	LUA_MODIFIER_MOTION_BOTH
)
...
function modifier_sniper_smoke_grenade_thinker:IsPurgable()
	return false
end
function modifier_sniper_smoke_grenade_thinker:IsHidden()
	return true
end
function modifier_sniper_smoke_grenade_thinker:IsAura()
	return true
end
function modifier_sniper_smoke_grenade_thinker:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end
function modifier_sniper_smoke_grenade_thinker:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO
end
function modifier_sniper_smoke_grenade_thinker:GetModifierAura()
	return "modifier_sniper_smoke_grenade_debuff"
end
function modifier_sniper_smoke_grenade_thinker:GetAuraRadius()
	return self.radius
end
function modifier_sniper_smoke_grenade_thinker:GetAuraDuration()
	return 0
end
function modifier_sniper_smoke_grenade_thinker:OnCreated()
	...
	self.particle =
		ParticleManager:CreateParticle("particles/boss/riki_smokebomb.vpcf", PATTACH_WORLDORIGIN, self:GetParent())
...
function modifier_sniper_smoke_grenade_debuff:IsPurgable()
	return false
end
function modifier_sniper_smoke_grenade_debuff:IsDebuff()
	return true
end
