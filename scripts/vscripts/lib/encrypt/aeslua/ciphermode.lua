...
local aes = require("lib.encrypt.aeslua.aes");
local util = require("lib.encrypt.aeslua.util");
local buffer = require("lib.encrypt.aeslua.buffer");
...
-- modefunction - function for cipher mode to use
--
function public.decryptString(key, data, iv, modeFunction)
