...
function boss_5.prototype.OnCreated(self)
	if IsClient() then
		...
		local iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/neck.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/belt.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/arms.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/lina_headflame.vpcf", PATTACH_CUSTOMORIGIN, hParent)
		...
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/gold_ambient.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_5/lina_ti6_ambient.vpcf",
		...
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_5/lina_flame_hand_dual_headflame.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hParent
		)
		ParticleManager:SetParticleControlEnt(
...
function boss_5.prototype.OnAbilityExecuted(self, event)
	if
		bit.band(event.ability:GetBehaviorInt(), DOTA_ABILITY_BEHAVIOR_CHANNELLED) ~= DOTA_ABILITY_BEHAVIOR_CHANNELLED
	then
		local bt = BT_Manager:GetUnitBT(self:GetParent())
		bt:UpdateAbltCastTime()
	end
end
boss_5 = __TS__DecorateLegacy({ diy_polymer(_G) }, boss_5)