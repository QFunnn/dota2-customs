...
boss_5_1 = __TS__DecorateLegacy({ register(_G) }, boss_5_1)
...
function modifier_boss_5_1_buff.prototype.OnCreated(self, params)
	...
	if IsClient() then
		local iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_5/b_5_1/b_5_1.vpcf", PATTACH_ABSORIGIN_FOLLOW, hParent)
		ParticleManager:SetParticleControl(iParticleID, 1, Vector(self.distance, 0, 0))
...
modifier_boss_5_1_buff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_5_1_buff)
...
modifier_boss_5_1_aura = __TS__DecorateLegacy({ register(_G) }, modifier_boss_5_1_aura)
...
function modifier_boss_5_1_debuff.prototype.OnCreated(self, params)
	...
	if IsServer() then
		...
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_5/b_5_1/screen_a/screen_a.vpcf",
			PATTACH_CUSTOMORIGIN,
			nil
		)
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_5/boss_5_1/fire_body/fire_body.vpcf",
...
modifier_boss_5_1_debuff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_5_1_debuff)