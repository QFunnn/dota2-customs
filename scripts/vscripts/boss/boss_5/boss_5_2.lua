...
function boss_5_2.prototype.OnProjectileHit_ExtraData(self, target, location, extraData)
	...
	if IsValid(hCaster) and IsValid(target) then
		...
		target:AddNewModifier(hCaster, self, "modifier_boss_5_2_move", {
...
boss_5_2 = __TS__DecorateLegacy({ register(_G) }, boss_5_2)
...
modifier_boss_5_2_move = __TS__DecorateLegacy({ register(_G) }, modifier_boss_5_2_move)