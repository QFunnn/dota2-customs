...
function boss_2_2.prototype.OnAbilityPhaseStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		...
		ParticleManager_s2c:SetParticleControl(self.iParticleID, 2, Vector(radius, fCastPoint, 1 / fCastPoint))
		local iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_2/boss_2_1/blur/blur.vpcf",
...
function boss_2_2.prototype._OnSpellStart(self, hTarget, vPosition)
	if IsValid(hTarget) then
		...
		if IsValid(hModifier) then
			...
			hModifier.flHeight = vSpawnLocation.z - GetGroundHeight(hCaster:GetAbsOrigin(), hCaster)
...
function boss_2_2.prototype.OnProjectileHit(self, target, location)
	if not IsValid(target) then
		...
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_2/boss_2_1/boom/boom.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
...
boss_2_2 = __TS__DecorateLegacy({ register(_G) }, boss_2_2)
...
modifier_boss_2_2_debuff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_2_2_debuff)
...
modifier_boss_2_2_buff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_2_2_buff)