...
function boss_2_1.prototype.OnSpellStart(self)
	...
	hCaster:AddNewModifier(hCaster, self, "modifier_2_1_buff", {
		duration = animation_time + 1,
		vPosition = VectorToString(_G, vPosition),
	})
end
boss_2_1 = __TS__DecorateLegacy({ register(_G) }, boss_2_1)
...
function modifier_2_1_buff.prototype.OnIntervalThink(self)
	...
	ParticleManager_s2c:ToClient(function()
		...
		ParticleManager_s2c:SetParticleControl(iParticleID, 2, Vector(self.radius, 0.63, 1 / 0.63))
	end, { weight = 0 })
	hParent:GameTimer(0.63, function()
...
modifier_2_1_buff = __TS__DecorateLegacy({ register(_G) }, modifier_2_1_buff)