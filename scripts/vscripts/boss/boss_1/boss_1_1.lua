...
function boss_1_1.prototype.OnSpellStart(self)
	...
	hCaster:AddNewModifier(hCaster, self, "modifier_boss_1_1_move", {
		duration = fDuration,
...
function boss_1_1.prototype.OnProjectileHit_ExtraData(self, target, location, extraData)
	...
	if IsValid(hCaster) and IsValid(target) then
		...
		target:AddNewModifier(hCaster, self, "modifier_boss_1_1_knockback", {
			duration = 0.2,
			vDirection = VectorToString(_G, vDirection),
		})
		ApplyDamage({
...
boss_1_1 = __TS__DecorateLegacy({ register(_G) }, boss_1_1)
...
modifier_boss_1_1_move = __TS__DecorateLegacy({ register(_G) }, modifier_boss_1_1_move)
...
modifier_boss_1_1_knockback = __TS__DecorateLegacy({ register(_G) }, modifier_boss_1_1_knockback)