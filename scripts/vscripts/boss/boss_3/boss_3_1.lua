...
function boss_3_1.prototype.OnAbilityPhaseStart(self)
	...
	hCaster:AddNewModifier(hCaster, self, "modifier_boss_3_1_jump", {
		duration = duration,
...
boss_3_1 = __TS__DecorateLegacy({ register(_G) }, boss_3_1)
...
modifier_boss_3_1_jump = __TS__DecorateLegacy({ register(_G) }, modifier_boss_3_1_jump)