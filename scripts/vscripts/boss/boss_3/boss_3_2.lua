...
function boss_3_2.prototype.OnAbilityPhaseStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		self.iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_5/boss_5_2/line/line.vpcf",
		...
		ParticleManager_s2c:SetParticleControl(self.iParticleID, 3, Vector(fWidth, fWidth, 0))
		ParticleManager_s2c:SetParticleControl(self.iParticleID, 5, Vector(fCastPoint, 0, 0))
	end, { weight = 0 })
	return true
end
...
function boss_3_2.prototype.OnSpellStart(self)
	...
	do
		...
		while i < 5 do
			...
			local hSummon = CreateUnitByName("summon_boss_3_2", vPos, true, hCaster, hCaster, hCaster:GetTeamNumber())
			if IsValid(hSummon) then
				hSummon:SetForwardVector(vDirection)
				hSummon:AddNewModifier(hCaster, self, "modifier_boss_3_2_summon", {
					duration = fDuration,
...
boss_3_2 = __TS__DecorateLegacy({ register(_G) }, boss_3_2)
...
modifier_boss_3_2_summon = __TS__DecorateLegacy({ register(_G) }, modifier_boss_3_2_summon)