...
function boss_7_3.prototype.OnAbilityPhaseStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		self.iParticleID =
			ParticleManager_s2c:CreateParticle("particles/warning/circular.vpcf", PATTACH_WORLDORIGIN, nil)
		ParticleManager_s2c:SetParticleControl(self.iParticleID, 0, vPostion)
		ParticleManager_s2c:SetParticleControl(self.iParticleID, 2, Vector(fRadius, fCastPoint, 1 / fCastPoint))
		local tSound = {
			"Boss_7.Start_10",
			"Boss_7.Start_11",
			"Boss_7.Start_12",
...
function boss_7_3.prototype.OnSpellStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		local iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_7/boss_7_3/blink_start/blink_start.vpcf",
		...
		iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_7/boss_7_3/blink_end/blink_end.vpcf",
			PATTACH_CUSTOMORIGIN,
			nil
		)
		...
		ParticleManager_s2c:SetParticleControl(iParticleID, 2, Vector(fRadius, fRadius, fRadius))
		ParticleManager_s2c:SetParticleControl(iParticleID, 3, Vector(fRadius, fRadius, fRadius))
		ParticleManager_s2c:ReleaseParticleIndex(iParticleID)
...
boss_7_3 = __TS__DecorateLegacy({ register(_G) }, boss_7_3)
...
function modifier_boss_7_3_thinker.prototype.OnCreated(self, params)
	...
	if IsClient() then
		...
		ParticleManager:SetParticleControl(iParticleID, 3, Vector(self.radius, self.radius, self.radius))
		...
		ParticleManager:SetParticleControl(iParticleID, 10, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 11, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 12, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 13, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 14, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 15, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 16, Vector(self.radius, self.radius, self.radius))
		ParticleManager:SetParticleControl(iParticleID, 17, Vector(self.radius, self.radius, self.radius))
...
modifier_boss_7_3_thinker = __TS__DecorateLegacy({ register(_G) }, modifier_boss_7_3_thinker)
...
modifier_boss_7_3_debuff = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_7_3_debuff)