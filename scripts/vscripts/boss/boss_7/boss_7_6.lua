...
function boss_7_6.prototype.OnAbilityPhaseStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		local iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/ablts_boss/boss_2/boss_2_3/blink_start.vpcf",
	...
	EachPlayer(_G, function(____, iPlayerID)
...
boss_7_6 = __TS__DecorateLegacy({ register(_G) }, boss_7_6)
...
modifier_boss_7_6 = __TS__DecorateLegacy({ register(_G) }, modifier_boss_7_6)
...
function modifier_boss_7_6_buff.prototype.CreatePoison(self)
	...
	repeat
		do
			vPosition = GetGroundPosition(hParent:GetAbsOrigin(), hParent) + RandomVector(RandomInt(500, 3000))
...
function modifier_boss_7_6_buff.prototype.OnDestroy(self)
	if IsServer() then
		local hParent = self:GetParent()
		local vPosition = GetGroundPosition(hParent:GetAbsOrigin(), hParent)
...
modifier_boss_7_6_buff = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_7_6_buff)
...
function modifier_boss_7_6_thinker.prototype.OnCreated(self, params)
	...
	if IsServer() then
		...
		ParticleManager:SetParticleControl(iParticleID, 2, Vector(self.radius, self.waring_time, 1 / self.waring_time))
...
function modifier_boss_7_6_thinker.prototype.OnIntervalThink(self)
	if IsServer() then
		...
		if self:GetStackCount() == 0 then
			ParticleManager_s2c:ToClient(function()
				local iParticleID = ParticleManager_s2c:CreateParticle(
					"particles/boss/boss_7/boss_7_6/sun_strike/sun_strike.vpcf",
					PATTACH_WORLDORIGIN,
					nil
				)
				ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
				ParticleManager_s2c:SetParticleControl(iParticleID, 2, Vector(self.radius, 0, 0))
				self:AddParticle_s2c(iParticleID, false, false, -1, false, false)
				iParticleID = ParticleManager_s2c:CreateParticle(
					"particles/boss/boss_7/boss_7_6/immortal/immortal.vpcf",
					PATTACH_CUSTOMORIGIN,
					nil
				)
				ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
		...
		if self:GetStackCount() == 1 then
			...
			local tTargets = FindUnitsInRadiusWithAbility(_G, hParent, hAbility, hParent:GetAbsOrigin(), self.radius)
...
modifier_boss_7_6_thinker = __TS__DecorateLegacy({ register(_G) }, modifier_boss_7_6_thinker)
...
function modifier_boss_7_6_black_debuff.prototype.OnCreated(self, params)
	if IsServer() then
		...
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_7/boss_7_6/web_screen/web_screen.vpcf",
			PATTACH_CUSTOMORIGIN,
			nil
		)
		self:AddParticle(iParticleID, false, false, -1, false, false)
...
modifier_boss_7_6_black_debuff = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_7_6_black_debuff)
...
modifier_boss_7_6_stack = __TS__DecorateLegacy({ register(_G) }, modifier_boss_7_6_stack)
...
modifier_boss_7_6_ai = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_7_6_ai)