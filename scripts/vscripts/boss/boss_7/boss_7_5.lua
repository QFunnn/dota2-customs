...
function boss_7_5.prototype.OnSpellStart(self)
	...
	self.sGameTimerID = hCaster:GameTimer(0, function()
		self:_OnSpellStart()
...
function boss_7_5.prototype._OnSpellStart(self)
	...
	local hThinker =
		CreateModifierThinker(hCaster, self, "modifier_boss_7_5_thinker", {}, vPosition, hCaster:GetTeamNumber(), false)
	...
	if IsValid(target) then
		...
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_7/boss_7_5/ultimate_impact/ultimate_impact.vpcf",
	...
	do
		...
		while i < count do
			...
			if IsValid(hEgg) then
				FindClearSpaceForUnit(hEgg, hEgg:GetAbsOrigin(), true)
...
boss_7_5 = __TS__DecorateLegacy({ register(_G) }, boss_7_5)
...
function modifier_boss_7_5_egg.prototype.OnIntervalThink(self)
	...
	if IsValid(hAbility1) and hAbility1.CreateSpiderling then
		...
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_7/boss_7_5/summon_familiars/summon_familiars.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
...
modifier_boss_7_5_egg = __TS__DecorateLegacy({ register(_G) }, modifier_boss_7_5_egg)