...
function boss_6_1.prototype.OnAbilityPhaseStart(self)
	...
	local fRate = 1.4
	self:GameTimer(fCastPoint - 1 / 24 * 7 / fRate, function()
	...
	ParticleManager_s2c:ToClient(function()
		...
		ParticleManager_s2c:SetParticleControl(iPtclID, 2, Vector(fRange, fCastPoint, 1 / fCastPoint))
...
function boss_6_1.prototype.OnSpellStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		local iPtclID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_6/boss_6_1/impact/impact.vpcf",
			PATTACH_WORLDORIGIN,
			nil
		)
		ParticleManager_s2c:SetParticleControl(iPtclID, 0, vTarget)
		...
		ParticleManager_s2c:SetParticleControl(iPtclID, 0, vTarget)
		ParticleManager_s2c:SetParticleControl(iPtclID, 1, Vector(fRange, 0, 0))
		ParticleManager_s2c:ReleaseParticleIndex(iPtclID)
	...
	do
		ParticleManager_s2c:ToClient(function()
			local iPtclID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_6/boss_6_1/target_impact/target_impact.vpcf",
				PATTACH_CUSTOMORIGIN_FOLLOW,
				hTarget
			)
			ParticleManager_s2c:SetParticleControlForward(iPtclID, 1, hCaster:GetAbsOrigin() - hTarget:GetAbsOrigin())
			ParticleManager_s2c:ReleaseParticleIndex(iPtclID)
		end)
		ApplyDamage({
			ability = self,
...
boss_6_1 = __TS__DecorateLegacy({ register(_G) }, boss_6_1)