...
function boss_6_3.prototype.OnAbilityPhaseStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		...
		ParticleManager_s2c:SetParticleControl(iPtclID, 2, Vector(self.Values:range(), fCastPoint, 1 / fCastPoint))
...
function boss_6_3.prototype.OnSpellStart(self)
	...
	ParticleManager_s2c:ToClient(function()
		local iPtclID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_6/boss_6_3/cast/cast.vpcf",
		...
		iPtclID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_6/boss_6_3/cast_cyclone/cast_cyclone.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hCaster
		)
		ParticleManager_s2c:ReleaseParticleIndex(iPtclID)
...
boss_6_3 = __TS__DecorateLegacy({ register(_G) }, boss_6_3)