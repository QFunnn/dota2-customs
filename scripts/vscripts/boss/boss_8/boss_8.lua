...
function boss_8.prototype.OnCreated(self)
	if IsClient() then
		...
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/desolation_ambient.vpcf",
		...
		iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_8/shoulder_ambient.vpcf", PATTACH_CUSTOMORIGIN, hParent)
		ParticleManager:SetParticleControlEnt(
			iParticleID,
			0,
			hParent,
		...
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/arcana_ambient.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hParent
		)
		ParticleManager:SetParticleControlEnt(
		...
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/arcana_loadout.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hParent
		)
		ParticleManager:SetParticleControlEnt(
		...
		self:AddParticle(iParticleID, false, false, -1, false, false)
		iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/arcana_loadout_ribbon.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hParent
		)
		self:AddParticle(iParticleID, false, false, -1, false, false)
...
boss_8 = __TS__DecorateLegacy({ diy_polymer(_G) }, boss_8)