...
__TS__SourceMapTraceBack(
	"scripts\\vscripts\\" .. __FILE_PATH__ .. ".lua",
	{
		["1"] = 2,
		["2"] = 2,
		["12"] = 2,
...
function boss_8_5.prototype.OnAbilityPhaseStart(self)
	...
	hCaster:GameTimer(0, function()
		...
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_5/blink/start.vpcf",
				PATTACH_CUSTOMORIGIN,
				hCaster
			)
			ParticleManager_s2c:SetParticleControl(iParticleID, 0, hCaster:GetAbsOrigin())
		...
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_5/blink/end.vpcf",
				PATTACH_CUSTOMORIGIN,
				hCaster
			)
		...
		local i = 0
		self.sTimeName = hCaster:GameTimer(0, function()
			...
			hCaster:GameTimer(0.5, function()
				ParticleManager_s2c:ToClient(function()
					local iParticleID = ParticleManager_s2c:CreateParticle(
						"particles/boss/boss_8/boss_8_1/shadowraze/shadowraze.vpcf",
						PATTACH_CUSTOMORIGIN,
						nil
					)
					ParticleManager_s2c:SetParticleControl(iParticleID, 0, vEndPosition)
					ParticleManager_s2c:SetParticleControl(iParticleID, 1, Vector(radius, radius, radius))
					ParticleManager_s2c:ReleaseParticleIndex(iParticleID)
...
function boss_8_5.prototype.CreateSummon(self, vEndPosition)
	...
	local duration = self.Values:duration()
	local hSummon = CreateUnitByName("boss_8_3_summon", vEndPosition, true, hCaster, hCaster, hCaster:GetTeamNumber())
	if IsValid(hSummon) then
		...
		AttributeKind.HpLimit.BONUS:Set(hSummon, AttributeKind.HpLimit:Get(hCaster) * hp * 0.01, "BONUS")
		AttributeKind.Armor.BONUS:Set(hSummon, AttributeKind.Armor:Get(hCaster) * armor * 0.01, "BASE")
...
boss_8_5 = __TS__DecorateLegacy({ register(_G) }, boss_8_5)
...
function modifier_boss_8_5.prototype.OnCreated(self, params)
	...
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/boss_8_5/bar_avatar/bar_avatar.vpcf",
...
modifier_boss_8_5 = __TS__DecorateLegacy({ register(_G) }, modifier_boss_8_5)
...
function modifier_boss_8_5_summon.prototype.OnCreated(self, params)
	...
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/boss_8_5/circular/circular.vpcf",
			PATTACH_CUSTOMORIGIN,
			nil
		)
...
function modifier_boss_8_5_summon.prototype.OnDeath(self, event)
	if IsServer() then
		...
		if __TS__ArrayIncludes(hAbility.tSummonIndex, event.unit:entindex()) then
			__TS__ArraySplice(hAbility.tSummonIndex, __TS__ArrayIndexOf(hAbility.tSummonIndex, event.unit:entindex()))
		end
	end
end
...
modifier_boss_8_5_summon = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_8_5_summon)
...
function modifier_boss_8_5_summon_buff.prototype.OnCreated(self, params)
	...
	if IsServer() then
		...
		local iParticleID =
			ParticleManager:CreateParticle("particles/boss/boss_8/boss_8_5/drain/drain.vpcf", PATTACH_CUSTOMORIGIN, nil)
...
modifier_boss_8_5_summon_buff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_8_5_summon_buff)
...
function modifier_boss_8_5_buff.prototype.OnCreated(self, params)
	...
	if IsServer() then
		...
		ParticleManager_s2c:ToClient(function()
			self.iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_5/circular/circular.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
			ParticleManager_s2c:SetParticleControl(self.iParticleID, 0, hParent:GetAbsOrigin())
			ParticleManager_s2c:SetParticleControl(self.iParticleID, 2, Vector(self.radius, self:GetDuration(), 0))
		end, { weight = 0 })
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_5/flower/flower.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
			ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
			ParticleManager_s2c:SetParticleControl(iParticleID, 1, hParent:GetAbsOrigin() + Vector(0, 0, 600))
			ParticleManager_s2c:SetParticleControl(iParticleID, 2, hParent:GetAbsOrigin() + Vector(0, 0, -50))
			self:AddParticle_s2c(iParticleID, false, false, -1, false, false)
		end, { weight = 0 })
	end
end
function modifier_boss_8_5_buff.prototype.OnDestroy(self)
	if IsServer() then
		...
		ParticleManager_s2c:ToClient(function()
			...
			ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
			ParticleManager_s2c:SetParticleControl(iParticleID, 1, Vector(self.radius, self.radius, self.radius))
			ParticleManager_s2c:ReleaseParticleIndex(iParticleID)
		end, { weight = 0 })
		ParticleManager_s2c:ToClient(function()
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_1/shadowraze/shadowraze1.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
			ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
			ParticleManager_s2c:SetParticleControl(iParticleID, 1, Vector(self.radius, self.radius, self.radius))
			ParticleManager_s2c:ReleaseParticleIndex(iParticleID)
			ParticleManager_s2c:StartSoundEventFromPosition("Hero_Nevermore.Shadowraze.Arcana", hParent:GetAbsOrigin())
		end, { weight = 0 })
		ParticleManager_s2c:ToClient(function()
			ParticleManager_s2c:DestroyParticle(self.iParticleID, false)
			local iParticleID = ParticleManager_s2c:CreateParticle(
				"particles/boss/boss_8/boss_8_1/aoe/aoe.vpcf",
				PATTACH_CUSTOMORIGIN,
				nil
			)
			ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
			ParticleManager_s2c:SetParticleControl(iParticleID, 1, Vector(self.radius, 0, 0))
			ParticleManager_s2c:ReleaseParticleIndex(iParticleID)
		end, { weight = 0 })
		local tTargets = FindUnitsInRadiusWithAbility(_G, hParent, hAbility, vPosition, self.radius)
...
modifier_boss_8_5_buff = __TS__DecorateLegacy({ register(_G) }, modifier_boss_8_5_buff)
...
modifier_boss_8_5_summon_invincible = __TS__DecorateLegacy({ register(_G) }, modifier_boss_8_5_summon_invincible)
...
function modifier_boss_8_5_flower_thinker.prototype.OnCreated(self, params)
	...
	if IsServer() then
		...
		local iParticleID = ParticleManager:CreateParticle(
			"particles/boss/boss_8/boss_8_5/flower_fire/flower_fire.vpcf",
			PATTACH_ABSORIGIN_FOLLOW,
			hParent
		)
		ParticleManager:SetParticleControl(iParticleID, 1, Vector(self.flower_dmg_radius, 0, 0))
		self:AddParticle(iParticleID, false, false, -1, false, false)
	end
end
function modifier_boss_8_5_flower_thinker.prototype.OnIntervalThink(self)
	...
	local tTargets = FindUnitsInRadiusWithAbility(_G, hCaster, hAbility, hParent:GetAbsOrigin(), self.flower_dmg_radius)
	ParticleManager_s2c:ToClient(function()
		local iParticleID = ParticleManager_s2c:CreateParticle(
			"particles/boss/boss_8/boss_8_5/flower_boom/flower_boom.vpcf",
			PATTACH_CUSTOMORIGIN,
			nil
		)
		ParticleManager_s2c:SetParticleControl(iParticleID, 0, hParent:GetAbsOrigin())
...
modifier_boss_8_5_flower_thinker = __TS__DecorateLegacy({ register(_G) }, modifier_boss_8_5_flower_thinker)
...
function modifier_boss_8_5_ai.prototype.DDeclareFunctions(self)
	return {
		[AttributeKind.HpMin] = function()
			return self:GetParent():GetMaxHealth() * 0.5
		end,
...
modifier_boss_8_5_ai = __TS__DecorateLegacy({ diy(_G) }, modifier_boss_8_5_ai)