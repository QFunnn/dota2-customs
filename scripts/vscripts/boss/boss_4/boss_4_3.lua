...
function boss_4_3.prototype.OnSpellStart(self)
	...
	do
		...
		while i < iCount do
			...
			self:_OnLine(vStartPosition, vTempDiretion, distance, width, speed, fDamage, 1)
			i = i + 1
		end
	end
	...
	if IsValid(target) then
		...
		do
			...
			while i < 2 do
				...
				self:_OnLine(location, vTempDiretion, distance, width, speed, extraData.fDamage, 2)
				i = i + 1
			end
		end
	end
end
boss_4_3 = __TS__DecorateLegacy({ register(_G) }, boss_4_3)