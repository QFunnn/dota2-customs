...
local a = "units/full_body/abyssal_underlord_v2"
...
function Spawn(self, d)
	...
	if j.PortraitParticle ~= nil then
		local I = ParticleManager:CreateParticle(j.PortraitParticle, PATTACH_ABSORIGIN_FOLLOW, thisEntity)
	end
end