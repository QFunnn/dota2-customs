...
---@class CHALLENGE_DIFFICULTY_MULTIPLIER_KILLS @ difficulty multiplier for challenge target override for kill challenges since they get much harder/impossible
---@type table<CHALLENGE_DIFFICULTY, number>
CHALLENGE_DIFFICULTY_MULTIPLIER_KILLS_OVERRIDE = {
	[CHALLENGE_DIFFICULTY.COMMON] = 1,
	[CHALLENGE_DIFFICULTY.RARE] = 1.25,
	[CHALLENGE_DIFFICULTY.EPIC] = 1.5,
}
...
CHALLENGE_ACCESSOR = {
	...
	-- end,
	[CHALLENGE_TYPE.KILL] = function(player_id)
		return PlayerResource:GetKills(player_id) or 0
	end,
	[CHALLENGE_TYPE.ASSIST] = function(player_id)
		return PlayerResource:GetKills(player_id) + PlayerResource:GetAssists(player_id) or 0
	end,
	[CHALLENGE_TYPE.DEAL_DAMAGE_WITH_SUMMONS] = function(player_id)
		return EndGameStats:GetStats(player_id).summon_damage
	end,
}
