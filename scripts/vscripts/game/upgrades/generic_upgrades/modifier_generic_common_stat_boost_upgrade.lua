...
LinkLuaModifier(
	"modifier_generic_common_stat_boost_upgrade_handler",
	"game/upgrades/generic_upgrades/modifier_generic_common_stat_boost_upgrade",
	LUA_MODIFIER_MOTION_NONE
)

modifier_generic_common_stat_boost_upgrade = modifier_generic_common_stat_boost_upgrade
...
function modifier_generic_common_stat_boost_upgrade_handler:IsHidden()
	return true
end
function modifier_generic_common_stat_boost_upgrade_handler:IsPurgable()
	return false
end
function modifier_generic_common_stat_boost_upgrade_handler:RemoveOnDeath()
	return false
end
function modifier_generic_common_stat_boost_upgrade_handler:OnTooltip()
