...
LinkLuaModifier(
	"modifier_generic_armor_shred_target",
	"game/upgrades/generic_upgrades/modifier_generic_armor_shred_upgrade",
...
function modifier_generic_armor_shred_target:GetTexture()
	return "../items/desolator"
end
function modifier_generic_armor_shred_target:GetAttributes()
