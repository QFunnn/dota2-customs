...
-- ???
LinkLuaModifier(
	"modifier_silencer_new_int_steal",
	"abilities/heroes/silencer/modifier_silencer_new_int_steal",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_nevermore_necromastery_auto",
	"abilities/heroes/nevermore/necromastery.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_skeleton_king_vampiric_aura_auto",
	"abilities/heroes/skeleton_king/vampiric_aura.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_vengefulspirit_command_aura_scepter_debuff_lua",
	"abilities/heroes/vengefulspirit/modifier_vengefulspirit_command_aura_scepter_debuff",
	LUA_MODIFIER_MOTION_NONE
)
-- webapi
LinkLuaModifier(
