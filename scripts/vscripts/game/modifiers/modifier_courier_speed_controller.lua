...
function modifier_courier_speed_controller:IsHidden()
	return true
end
function modifier_courier_speed_controller:IsPurgable()
	return false
end
function modifier_courier_speed_controller:RemoveOnDeath()
	return false
end
...
function modifier_courier_speed_controller:GetModifierMoveSpeedBonus_Constant()
	return self:GetStackCount() > 0 and 20000 or 0
end