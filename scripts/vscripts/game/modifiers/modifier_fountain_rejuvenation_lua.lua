...
LinkLuaModifier(
	"modifier_fountain_rejuvenation_effect_lua",
	"game/modifiers/modifier_fountain_rejuvenation_lua",
	LUA_MODIFIER_MOTION_NONE
)

function modifier_fountain_rejuvenation_lua:IsHidden()
	return true
end
function modifier_fountain_rejuvenation_lua:IsAura()
	return true
end
function modifier_fountain_rejuvenation_lua:IsPurgable()
	return false
end
function modifier_fountain_rejuvenation_lua:GetAttributes()
...
function modifier_fountain_rejuvenation_lua:GetAuraRadius()
	return self:GetParent():Script_GetAttackRange() + 144
end
function modifier_fountain_rejuvenation_lua:GetAuraSearchFlags()
	return DOTA_UNIT_TARGET_FLAG_NONE
end
function modifier_fountain_rejuvenation_lua:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_fountain_rejuvenation_lua:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end
function modifier_fountain_rejuvenation_lua:GetModifierAura()
	return "modifier_fountain_rejuvenation_effect_lua"
end
...
function modifier_fountain_rejuvenation_effect_lua:GetTexture()
...
function modifier_fountain_rejuvenation_effect_lua:OnCreated()
	...
	if shield_modifier and not shield_modifier:IsNull() then
		shield_modifier:ResetShields()
	end
