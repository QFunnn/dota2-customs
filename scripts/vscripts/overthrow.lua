...
dota_ability_xp_global = {
	GetIntrinsicModifierName = function()
		return "modifier_dota_ability_xp_global"
	end,
}
...
dota_ability_xp_granter_arena6 = {
	GetIntrinsicModifierName = function()
		return "modifier_dota_ability_xp_granter_arena6"
	end,
}
...
modifier_get_xp_arena6 = {
	...
	GetTexture = function()
		return "dota_ability_xp_granter_arena6"
	end,
}
