...
function AI_Boss_7.prototype.____constructor(self, hUnit, tData)
	...
	____root_tChildren_0[#____root_tChildren_0 + 1] = __TS__New(AI_Boss_7_6, hUnit:FindAbilityByName("boss_7_6"))
	do
...
function AI_Boss_7_6.prototype.Evaluate(self)
	if BTA_CastAblity.prototype.Evaluate(self) > 0 then
		if
			self.typeResult == 1
			or self.hUnit:HasModifier("modifier_boss_7_6_ai") and self.hUnit:GetHealthPercent() <= 50
		then
			return 10000
		end
		return 0, "未达到50%血量"
