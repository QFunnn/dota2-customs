...
function Spawn(self, entityKeyValues)
	...
	thisEntity:GameTimer(0.1, function()
		__TS__New(AI_Creep_42, thisEntity)
	end)
end
function UpdateOnRemove(self) end
AI_Creep_42 = __TS__Class()
AI_Creep_42.name = "AI_Creep_42"
__TS__ClassExtends(AI_Creep_42, BT_Tree)
function AI_Creep_42.prototype.____constructor(self, hUnit, tData)
	if tData == nil then
		tData = {}
	end
