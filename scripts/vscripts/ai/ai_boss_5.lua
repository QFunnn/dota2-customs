...
function AI_Boss_5.prototype.____constructor(self, hUnit, tData)
	...
	____root_tChildren_0[#____root_tChildren_0 + 1] = __TS__New(AI_BOSS_5_6, hUnit:FindAbilityByName("boss_5_6"))
	do
		local bt = __TS__New(BTC_Random)
		bt.tChildren = {}
		for ____, t in ipairs({
			{ "boss_5_2", AI_BOSS_5_2 },
			{ "boss_5_3", AI_BOSS_5_3 },
			{ "boss_5_4", AI_BOSS_5_4 },
			{ "boss_5_5", AI_BOSS_5_5 },
		}) do
...
function AI_BOSS_5_6.prototype.Evaluate(self)
	if BTA_CastAblity.prototype.Evaluate(self) > 0 then
		if
			self.typeResult == 1
			or self.hUnit:HasModifier("modifier_boss_5_6_ai") and self.hUnit:GetHealthPercent() <= 50
		then
			return 10000
		end
		return 0, "未达到50%血量"
