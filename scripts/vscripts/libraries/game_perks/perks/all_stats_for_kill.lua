...
all_stats_for_kill = class(base_game_perk)

function all_stats_for_kill:__OnCreated()
	if IsClient() then
		return
	end
...
function all_stats_for_kill:DeclareFunctions()
	return {
...
function all_stats_for_kill:OnHeroKilled(keys)
...
function all_stats_for_kill:GetModifierBonusStats_Strength()
	return self.per_kill * self:GetStackCount()
end

function all_stats_for_kill:GetModifierBonusStats_Agility()
	return self.per_kill * self:GetStackCount()
end

function all_stats_for_kill:GetModifierBonusStats_Intellect()
	return self.per_kill * self:GetStackCount()
end