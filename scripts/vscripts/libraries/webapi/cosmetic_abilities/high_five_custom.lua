...
LinkLuaModifier(
	"modifier_high_five_custom_search",
	"libraries/webapi/cosmetic_abilities/high_five_custom",
...
function high_five_custom:OnProjectileHit(target, location)
	...
	if equipped_high_five then
		...
		if impact_particle_variant then
			impact_particle = impact_particle_variant.path
		end
	end
...
function modifier_high_five_custom_search:GetEffectAttachType()
	return PATTACH_OVERHEAD_FOLLOW
end
function modifier_high_five_custom_search:GetEffectName()
	if self.wave_particle_path then
		return self.wave_particle_path
	end
end
...
function modifier_high_five_custom_search:OnCreated()
	...
	if equipped_high_five then
		...
		if wave_particle_variant then
			self.wave_particle_path = wave_particle_variant.path
		end
	end
...
function modifier_high_five_custom_search:LaunchTowards(target)
	...
	if self.equipped_high_five then
		...
		if travel_particle_variant then
			travel_particle = travel_particle_variant.path
		end
	end
