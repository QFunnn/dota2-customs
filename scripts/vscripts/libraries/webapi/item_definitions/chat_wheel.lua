...
CreateChatWheelDef_Currency(
	"cw_what_the_f_just_happened",
	{ sound = "soundboard.what_the_f_just_happened", group = "english_commentators" },
	4999,
	ITEM_RARITIES.MYTHICAL
)
CreateChatWheelDef_Currency(
	"cw_a_net_net_da",
	{ sound = "soundboard.a_net_net_da", group = "russian_commentators" },
	999,
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Currency(
	"cw_eto_takaya_dushka",
	{ sound = "soundboard.eto_takaya_dushka", group = "russian_commentators" },
	999,
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Currency(
	"cw_chto_eto_kakaya_zhest",
	{ sound = "soundboard.chto_eto_kakaya_zhest", group = "russian_commentators" },
	1999,
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Currency(
	"cw_a_nu_ka_idi_suda",
	{ sound = "soundboard.a_nu_ka_idi_suda", group = "russian_commentators" },
	1999,
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Currency(
	"cw_lai_ni_da",
	{ sound = "soundboard.lai_ni_da", group = "chinese_commentators" },
	999,
	ITEM_RARITIES.UNCOMMON
)
...
CreateChatWheelDef_Currency(
	"cw_aghs_1",
	{ sound = "soundboard.ti10eventgame.reward1", group = "aghanim_lines" },
	999,
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Currency(
	"cw_aghs_2",
	{ sound = "soundboard.ti10eventgame.reward2", group = "aghanim_lines" },
	1999,
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Currency(
	"cw_aghs_3",
	{ sound = "soundboard.ti10eventgame.reward3", group = "aghanim_lines" },
	1999,
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Currency(
	"cw_aghs_4",
	{ sound = "soundboard.ti10eventgame.reward4", group = "aghanim_lines" },
	4999,
	ITEM_RARITIES.MYTHICAL
)
CreateChatWheelDef_Currency(
	"cw_aghs_5",
	{ sound = "soundboard.ti10eventgame.reward5", group = "aghanim_lines" },
	9999,
	ITEM_RARITIES.LEGENDARY
)

-- ALL ACTUAL ITEM NAMES ARE PREFIXED WITH chat_wheel_
CreateChatWheelDef_Treasure(
	"cw_boing",
	{ sound = "soundboard.pitch.boing", group = "basic" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_moo",
	{ sound = "soundboard.pitch.moo", group = "basic" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_orchestra",
	{ sound = "soundboard.pitch.orchit", group = "basic" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_heehaw",
	{ sound = "soundboard.pitch.heehaw", group = "basic" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_woopwoo",
	{ sound = "soundboard.pitch.woopwoo", group = "basic" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_oops",
	{ sound = "soundboard.pitch.oops", group = "basic" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.COMMON
)
...
CreateChatWheelDef_Treasure(
	"cw_holy_moly",
	{ sound = "soundboard.holy_moly", group = "english_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_takaya_haliava",
	{ sound = "soundboard.takaya_haliava", group = "russian_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_wo_shi_yi",
	{ sound = "soundboard.wo_shi_yi", group = "chinese_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_oh_my_god_what_oh_oh",
	{ sound = "soundboard.oh_my_god_what_oh_oh", group = "english_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_aaah_aaah_chto",
	{ sound = "soundboard.aaah_aaah_chto", group = "russian_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_ni_xing_ni",
	{ sound = "soundboard.ni_xing_ni", group = "chinese_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.UNCOMMON
)
...
-- ALL ACTUAL ITEM NAMES ARE PREFIXED WITH chat_wheel_
CreateChatWheelDef_Treasure(
	"cw_coming_through_with_the_woooo",
	{ sound = "soundboard.coming_through_with_the_woooo", group = "english_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Treasure(
	"cw_hui_tian_mie",
	{ sound = "soundboard.hui_tian_mie", group = "chinese_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Treasure(
	"cw_see_you_later_nerds",
	{ sound = "soundboard.see_you_later_nerds", group = "english_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Treasure(
	"cw_tiao_zou_le",
	{ sound = "soundboard.tiao_zou_le", group = "chinese_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.RARE
)
...
-- ALL ACTUAL ITEM NAMES ARE PREFIXED WITH chat_wheel_
CreateChatWheelDef_Treasure(
	"cw_nothing_that_can_stop_this_man",
	{ sound = "soundboard.nothing_that_can_stop_this_man", group = "english_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.MYTHICAL
)
CreateChatWheelDef_Treasure(
	"cw_kisi_kisi",
	{ sound = "talent.season12.899273569.2", group = "russian_commentators" },
	"treasure_chat_wheel_1",
	ITEM_RARITIES.MYTHICAL
)
CreateChatWheelDef_Treasure(
	"cw_ay_ay_ay_cn",
	{ sound = "soundboard.ay_ay_ay_cn", group = "chinese_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.MYTHICAL
)
CreateChatWheelDef_Treasure(
	"cw_plaki_plaki",
	{ sound = "talent.season11.899273569.1", group = "russian_commentators" },
	"treasure_chat_wheel_2",
	ITEM_RARITIES.MYTHICAL
)
...
CreateChatWheelDef_Treasure(
	"cw_dc_wow",
	{ sound = "soundboard.darkcarnival_wow", group = "dark_carnival" },
	"treasure_chat_wheel_dc",
	ITEM_RARITIES.COMMON
)
CreateChatWheelDef_Treasure(
	"cw_dc_snoring",
	{ sound = "custom_dc.snoring", group = "dark_carnival" },
	"treasure_chat_wheel_dc",
	ITEM_RARITIES.UNCOMMON
)
CreateChatWheelDef_Treasure(
	"cw_dc_money_and_bones",
	{ sound = "soundboard.money_and_bones", group = "dark_carnival" },
	"treasure_chat_wheel_dc",
	ITEM_RARITIES.RARE
)
CreateChatWheelDef_Treasure(
	"cw_dc_idiots",
	{ sound = "soundboard.darkcarnival_are_we_the_idiots", group = "dark_carnival" },
	"treasure_chat_wheel_dc",
	ITEM_RARITIES.MYTHICAL
)
