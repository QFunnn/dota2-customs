...
OLD_SLOT_NAMES = {
	...
	["2"] = "equippedAuras",
	["3"] = "equippedHeroSkins",
	["4"] = "equippedKillEffects",
	["5"] = "equippedPets",
	["6"] = "equippedCosmeticAbilities",
	["7"] = "equippedSpecials",
	-- unused but required by old schema
	["-1"] = "equippedItems",
	["-2"] = "equippedHeroTrails",
}
...
PRODUCTS_CURRENCY_PRICES = {
	subscription_tier_1 = 10000,
	subscription_tier_2 = 45000,
	reset_mmr = 11500,
}

VARIABLE_DURATION_PRODUCTS = {
	subscription_tier_1 = true,
	subscription_tier_2 = true,
}

SUBSCRIPTION_DURATION_MIN = 1
SUBSCRIPTION_DURATION_MAX = 31
