...
function modifier_woda_neutral_evasion:IsHidden()
	return true
end
function modifier_woda_neutral_evasion:IsPurgable()
	return false
end
function modifier_woda_neutral_evasion:IsPurgeException()
	return false
end
function modifier_woda_neutral_evasion:RemoveOnDeath()
	return false
end
