...
function modifier_woda_neutral_unholy_aura:IsPurgable()
	return false
end
function modifier_woda_neutral_unholy_aura:IsHidden()
	return true
end
function modifier_woda_neutral_unholy_aura:IsAura()
	return true
end
function modifier_woda_neutral_unholy_aura:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_woda_neutral_unholy_aura:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC
end
function modifier_woda_neutral_unholy_aura:GetModifierAura()
	return "modifier_woda_neutral_unholy_aura_buff"
end
function modifier_woda_neutral_unholy_aura:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end

modifier_woda_neutral_unholy_aura_buff = class({})

function modifier_woda_neutral_unholy_aura_buff:IsPurgable()
	return false
end
