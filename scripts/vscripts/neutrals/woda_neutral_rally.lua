...
function modifier_woda_neutral_rally:IsPurgable()
	return false
end
function modifier_woda_neutral_rally:IsHidden()
	return true
end
function modifier_woda_neutral_rally:IsAura()
	return true
end
function modifier_woda_neutral_rally:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_woda_neutral_rally:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC
end
function modifier_woda_neutral_rally:GetModifierAura()
	return "modifier_woda_neutral_rally_buff"
end
function modifier_woda_neutral_rally:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end

modifier_woda_neutral_rally_buff = class({})

function modifier_woda_neutral_rally_buff:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
function modifier_woda_neutral_rally_buff:IsPurgable()
	return false
end
