...
function modifier_creature_hellbear_spawn:IsHidden()
	return true
end
function modifier_creature_hellbear_spawn:IsPurgable()
	return false
end
function modifier_creature_hellbear_spawn:IsPurgeException()
	return false
end
