...
function modifier_creature_hellbear_color:IsHidden()
	return true
end
function modifier_creature_hellbear_color:IsPurgable()
	return false
end
function modifier_creature_hellbear_color:IsPurgeException()
	return false
end
