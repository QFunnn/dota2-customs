...
function modifier_woda_neutral_self_purge:IsHidden()
	return true
end
function modifier_woda_neutral_self_purge:IsPurgable()
	return false
end
function modifier_woda_neutral_self_purge:IsPurgeException()
	return false
end
