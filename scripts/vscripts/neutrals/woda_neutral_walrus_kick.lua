...
LinkLuaModifier(
	"modifier_woda_neutral_walrus_kick_debuff",
	"neutrals/woda_neutral_walrus_kick",
...
function woda_neutral_walrus_kick:OnSpellStart(new_caster, new_target)
	...
	Timers:CreateTimer(0.3, function()
		...
		target:AddNewModifier(
			...
			self,
			"modifier_woda_neutral_walrus_kick_debuff",
			{ duration = (1 + self:GetSpecialValueFor("duration") * (1 - target:GetStatusResistance())) }
		)
...
function modifier_woda_neutral_walrus_kick_debuff:IsPurgable()
	return true
end
