...
woda_neutral_from_4 = class({})

function woda_neutral_from_4:Precache(context)
...
function woda_neutral_from_4:OnSpellStart()
    ...
    Timers:CreateTimer(0.5, function()
        ...
        for d=1, 6 do
            ...
            info.vVelocity = RotatePosition(Vector(0,0,0), QAngle(0,i,0), direction) * 725
            i = i + tick
            ProjectileManager:CreateLinearProjectile(info)
        end
...
function woda_neutral_from_4:OnProjectileHit(target, vLocation)
	if not IsServer() then return end
