...
LinkLuaModifier(
	"modifier_woda_neutral_ice_armor_buff",
	"neutrals/woda_neutral_woda_neutral_ice_armor",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_woda_neutral_ice_armor_debuff",
	"neutrals/woda_neutral_woda_neutral_ice_armor",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_woda_neutral_ice_armor_buff:GetEffectName()
	return "particles/neutral_fx/ogre_magi_frost_armor.vpcf"
end

function modifier_woda_neutral_ice_armor_buff:GetEffectAttachType()
...
function modifier_woda_neutral_ice_armor_buff:OnAttackLanded(params)
	...
	params.attacker:AddNewModifier(
		...
		self:GetAbility(),
		"modifier_woda_neutral_ice_armor_debuff",
		{ duration = duration_debuff * (1 - params.attacker:GetStatusResistance()) }
	)
end
