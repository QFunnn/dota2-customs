...
LinkLuaModifier(
	"modifier_woda_neutral_envenomed_weapon",
	"neutrals/woda_neutral_envenomed_weapon",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_woda_neutral_envenomed_weapon_debuff",
	"neutrals/woda_neutral_envenomed_weapon",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_woda_neutral_envenomed_weapon:IsPurgable()
	return false
end
function modifier_woda_neutral_envenomed_weapon:IsHidden()
	return true
end
...
function modifier_woda_neutral_envenomed_weapon:OnAttackLanded(params)
	...
	params.target:AddNewModifier(
		...
		self:GetAbility(),
		"modifier_woda_neutral_envenomed_weapon_debuff",
		{ duration = self.duration * (1 - params.target:GetStatusResistance()) }
	)
end

modifier_woda_neutral_envenomed_weapon_debuff = class({})

function modifier_woda_neutral_envenomed_weapon_debuff:IsPurgable()
	return false
end
