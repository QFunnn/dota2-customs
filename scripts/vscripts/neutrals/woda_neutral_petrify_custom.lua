...
LinkLuaModifier(
	"modifier_woda_neutral_petrify_custom",
	"neutrals/woda_neutral_petrify_custom",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_woda_neutral_petrify_custom_debuff",
	"neutrals/woda_neutral_petrify_custom",
	LUA_MODIFIER_MOTION_NONE
)
...
function modifier_woda_neutral_petrify_custom:IsHidden()
	return true
end
function modifier_woda_neutral_petrify_custom:IsPurgable()
	return false
end
function modifier_woda_neutral_petrify_custom:IsPurgeException()
	return false
end
