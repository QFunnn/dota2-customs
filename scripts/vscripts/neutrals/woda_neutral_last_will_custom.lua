...
LinkLuaModifier(
	"modifier_woda_neutral_last_will_custom",
	"neutrals/woda_neutral_last_will_custom",
...
function modifier_woda_neutral_last_will_custom:IsPurgable()
	return false
end
function modifier_woda_neutral_last_will_custom:IsHidden()
	return true
end
function modifier_woda_neutral_last_will_custom:IsPurgeException()
	return false
end
function modifier_woda_neutral_last_will_custom:RemoveOnDeath()
	return false
end
