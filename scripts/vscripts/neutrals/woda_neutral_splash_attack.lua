...
function modifier_woda_neutral_splash_attack:IsHidden()
	return true
end
function modifier_woda_neutral_splash_attack:IsPurgable()
	return false
end
...
function modifier_woda_neutral_splash_attack:GetModifierProcAttack_Feedback(params)
	...
	local blast_pfx = ParticleManager:CreateParticle(
		"particles/neutral_fx/black_dragon_attack_explosion.vpcf",
	...
	local damage = self:GetParent():GetAverageTrueAttackDamage(nil)
		/ 100
		* self:GetAbility():GetSpecialValueFor("splash")
