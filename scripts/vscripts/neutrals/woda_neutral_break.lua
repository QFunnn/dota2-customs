...
function modifier_woda_neutral_break:IsPurgable()
	return false
end
function modifier_woda_neutral_break:IsHidden()
	return true
end
...
function modifier_woda_neutral_break:OnAttackLanded(params)
	...
	params.target:AddNewModifier(
		self:GetParent(),
		self:GetAbility(),
		"modifier_woda_neutral_break_debuff",
...
function modifier_woda_neutral_break_debuff:IsPurgable()
	return false
end
