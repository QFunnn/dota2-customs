...
function modifier_woda_neutral_vex:IsPurgable()
	return false
end
function modifier_woda_neutral_vex:IsHidden()
	return true
end
...
function modifier_woda_neutral_vex:OnAttackLanded(params)
	...
	params.target:AddNewModifier(
		self:GetParent(),
		self:GetAbility(),
		"modifier_woda_neutral_vex_debuff",
...
function modifier_woda_neutral_vex_debuff:IsPurgable()
	return false
end
