...
LinkLuaModifier(
	"modifier_woda_neutral_frost_attack_debuff",
	"neutrals/woda_neutral_frost_attack",
...
function modifier_woda_neutral_frost_attack:IsPurgable()
	return false
end
function modifier_woda_neutral_frost_attack:IsHidden()
	return true
end
...
function modifier_woda_neutral_frost_attack_debuff:IsPurgable()
	return false
end
