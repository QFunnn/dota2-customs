...
function modifier_woda_neutral_frenzy:IsPurgable()
	return false
end
function modifier_woda_neutral_frenzy:IsHidden()
	return true
end
function modifier_woda_neutral_frenzy:IsAura()
	return true
end
function modifier_woda_neutral_frenzy:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end
function modifier_woda_neutral_frenzy:GetAuraSearchType()
	return DOTA_UNIT_TARGET_BASIC
end
function modifier_woda_neutral_frenzy:GetModifierAura()
	return "modifier_woda_neutral_frenzy_buff"
end
function modifier_woda_neutral_frenzy:GetAuraRadius()
	return self:GetAbility():GetSpecialValueFor("radius")
end

modifier_woda_neutral_frenzy_buff = class({})

function modifier_woda_neutral_frenzy_buff:IsPurgable()
	return false
end
