...
LinkLuaModifier(
	"modifier_woda_neutral_critical_strike",
	"neutrals/woda_neutral_critical_strike",
...
function modifier_woda_neutral_critical_strike:IsHidden()
	return true
end
function modifier_woda_neutral_critical_strike:IsPurgable()
	return false
end
