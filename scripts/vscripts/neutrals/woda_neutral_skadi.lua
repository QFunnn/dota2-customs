...
function modifier_woda_neutral_skadi:IsHidden()
	return true
end
function modifier_woda_neutral_skadi:IsPurgable()
	return false
end
function modifier_woda_neutral_skadi:IsPurgeException()
	return false
end
function modifier_woda_neutral_skadi:RemoveOnDeath()
	return false
end
...
function modifier_woda_neutral_skadi:OnAttackLanded(params)
	...
	params.target:AddNewModifier(
		self:GetParent(),
		self:GetAbility(),
		"modifier_woda_neutral_skadi_debuff",
