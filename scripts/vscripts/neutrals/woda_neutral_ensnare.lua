...
function woda_neutral_ensnare:OnProjectileHit_ExtraData(target, vLocation, hExtraData)
	...
	target:AddNewModifier(
		self:GetCaster(),
		self,
		"modifier_woda_neutral_ensnare_debuff",
...
function modifier_woda_neutral_ensnare_debuff:IsPurgable()
	return true
end
function modifier_woda_neutral_ensnare_debuff:GetEffectName()
	return "particles/neutral_fx/dark_troll_ensnare.vpcf"
end
function modifier_woda_neutral_ensnare_debuff:GetEffectAttachType()
