...
LinkLuaModifier(
	"modifier_woda_neutral_steal_weapon_debuff",
	"neutrals/woda_neutral_steal_weapon",
...
function modifier_woda_neutral_steal_weapon:IsPurgable()
	return false
end
function modifier_woda_neutral_steal_weapon:IsHidden()
	return true
end
...
function modifier_woda_neutral_steal_weapon_debuff:IsPurgable()
	return false
end
