...
function modifier_donate_hero_illusion_item:IsHidden()
	return true
end
function modifier_donate_hero_illusion_item:IsPurgable()
	return false
end
function modifier_donate_hero_illusion_item:IsPurgeException()
	return false
end
function modifier_donate_hero_illusion_item:RemoveOnDeath()
	return false
end
function modifier_donate_hero_illusion_item:GetAttributes()
