...
function modifier_crystal_maiden_death_custom:IsHidden()
	return true
end
function modifier_crystal_maiden_death_custom:IsPurgable()
	return false
end
function modifier_crystal_maiden_death_custom:IsPurgeException()
	return false
end
function modifier_crystal_maiden_death_custom:RemoveOnDeath()
	return false
end
