...
function modifier_activity_animation_custom:IsHidden()
	return true
end
function modifier_activity_animation_custom:IsPurgable()
	return false
end
function modifier_activity_animation_custom:IsPurgeException()
	return false
end
function modifier_activity_animation_custom:RemoveOnDeath()
	return false
end
function modifier_activity_animation_custom:GetAttributes()
...
function modifier_activity_animation_custom:GetActivityTranslationModifiers()
	if self.activity == "ti9_weapon" and self:GetParent():HasModifier("modifier_centaur_hoof_stomp_custom_charge") then
		return
	end
