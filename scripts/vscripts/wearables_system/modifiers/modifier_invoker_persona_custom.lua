...
function modifier_invoker_persona_custom:IsHidden()
	return true
end
function modifier_invoker_persona_custom:IsPurgable()
	return false
end
function modifier_invoker_persona_custom:IsPurgeException()
	return false
end
function modifier_invoker_persona_custom:RemoveOnDeath()
	return false
end
...
function modifier_invoker_persona_custom:OnIntervalThink()
	...
	elseif (#exort_count > #quas_count) and (#exort_count > #wex_count) then
		self.parent:SetRangedProjectileName(
