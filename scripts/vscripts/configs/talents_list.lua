...
_G.herotalents = {
	...
	["npc_dota_hero_dragon_knight"] = {
		[1] = {
			...
			[2] = {
				...
				{ "empty_3" },
				{
					"modifier_dragon_knight_3",
					"#modifier_dragon_knight_3",
					1,
					"dragon_knight/3",
					{ "modifier_dragon_knight_2", 3 },
				},
				{ "modifier_woda_talent_cloak", "#woda_talent_cloak", 2, "cloak", {} },
				{ "modifier_woda_talent_str6", "#woda_talent_str6", 1, "str6", { "modifier_woda_talent_str3", 2 } },
			},
		...
		[2] = {
			...
			[2] = {
				{
					"modifier_dragon_knight_10",
					"#modifier_dragon_knight_10",
					1,
					"dragon_knight/10",
					{ "modifier_dragon_knight_9", 2 },
				},
				{ "empty_3" },
				{ "empty_4" },
				{ "modifier_woda_talent_miss1", "#woda_talent_miss1", 2, "miss1", {} },
	...
	["npc_dota_hero_omniknight"] = {
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_omniknight_19",
					"#modifier_omniknight_19",
					1,
					"omniknight/19",
					{ "modifier_omniknight_17", 3 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_lone_druid"] = {
		...
		[3] = {
			...
			[2] = {
				...
				{ "empty_3" },
				{
					"modifier_lone_druid_19",
					"#modifier_lone_druid_19",
					1,
					"lone_druid/19",
					{ "modifier_lone_druid_17", 1 },
				},
				{ "modifier_woda_talent_blood", "#woda_talent_blood", 2, "blood", {} },
				{ "modifier_woda_talent_int6", "#woda_talent_int6", 1, "int6", { "modifier_woda_talent_int3", 2 } },
			},
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_lone_druid_18",
					"#modifier_lone_druid_18",
					3,
					"lone_druid/18",
					{ "modifier_lone_druid_19", 1 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_windrunner"] = {
		...
		[2] = {
			...
			[3] = {
				{
					"modifier_windrunner_11",
					"#modifier_windrunner_11",
					3,
					"windrunner/11",
					{ "modifier_windrunner_10", 3 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
	...
	["npc_dota_hero_drow_ranger"] = {
		[1] = {
			...
			[6] = {
				...
				{ "modifier_woda_talent_regenhp2", "#woda_talent_regenhp2", 3, "regenhp2", {} },
				{
					"modifier_drow_ranger_6",
					"#modifier_drow_ranger_6",
					2,
					"drow_ranger/6",
					{ "modifier_drow_ranger_4", 1 },
				},
				{ "empty_15" },
				{ "empty_16" },
			},
	...
	["npc_dota_hero_witch_doctor"] = {
		...
		[2] = {
			...
			[4] = {
				{
					"modifier_witch_doctor_11",
					"#modifier_witch_doctor_11",
					1,
					"witch_doctor/11",
					{ "modifier_witch_doctor_10", 3 },
				},
				{
					"modifier_woda_talent_speed2",
					"#woda_talent_speed2",
	...
	["npc_dota_hero_earthshaker"] = {
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_earthshaker_19",
					"#modifier_earthshaker_19",
					3,
					"earthshaker/19",
					{ "modifier_earthshaker_18", 1 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_skywrath_mage"] = {
		...
		[2] = {
			...
			[3] = {
				{
					"modifier_skywrath_mage_11",
					"#modifier_skywrath_mage_11",
					3,
					"skywrath_mage/11",
					{ "modifier_skywrath_mage_10", 1 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
			...
			[4] = {
				{
					"modifier_skywrath_mage_12",
					"#modifier_skywrath_mage_12",
					3,
					"skywrath_mage/12",
					{ "modifier_skywrath_mage_11", 3 },
				},
				{
					"modifier_woda_talent_speed2",
					"#woda_talent_speed2",
	...
	["npc_dota_hero_phantom_assassin"] = {
		[1] = {
			...
			[6] = {
				...
				{ "modifier_woda_talent_regenhp2", "#woda_talent_regenhp2", 3, "regenhp2", {} },
				{
					"modifier_phantom_assassin_4",
					"#modifier_phantom_assassin_4",
					2,
					"phantom_assassin/4",
					{ "modifier_phantom_assassin_2", 2 },
				},
				{ "empty_15" },
				{ "empty_16" },
			},
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_phantom_assassin_17",
					"#modifier_phantom_assassin_17",
					2,
					"phantom_assassin/17",
					{ "modifier_phantom_assassin_16", 3 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_death_prophet"] = {
		...
		[2] = {
			...
			[3] = {
				{
					"modifier_death_prophet_10",
					"#modifier_death_prophet_10",
					2,
					"death_prophet/10",
					{ "modifier_death_prophet_9", 1 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
	...
	["npc_dota_hero_terrorblade"] = {
		[1] = {
			...
			[4] = {
				...
				{ "empty_9" },
				{
					"modifier_terrorblade_4",
					"#modifier_terrorblade_4",
					2,
					"terrorblade/4",
					{ "modifier_terrorblade_2", 1 },
				},
				{ "modifier_woda_talent_octar", "#woda_talent_octar", 2, "octar", {} },
				{ "modifier_woda_talent_str4", "#woda_talent_str4", 1, "str4", { "modifier_woda_talent_sasha", 1 } },
			},
			...
			[6] = {
				...
				{ "modifier_woda_talent_regenhp2", "#woda_talent_regenhp2", 3, "regenhp2", {} },
				{
					"modifier_terrorblade_6",
					"#modifier_terrorblade_6",
					3,
					"terrorblade/6",
					{ "modifier_terrorblade_4", 2 },
				},
				{ "empty_15" },
				{ "empty_16" },
			},
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_terrorblade_16",
					"#modifier_terrorblade_16",
					1,
					"terrorblade/16",
					{ "modifier_terrorblade_21", 1 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
			[4] = {
				...
				{ "modifier_woda_talent_fairy", "#woda_talent_fairy", 2, "fairy", {} },
				{
					"modifier_terrorblade_17",
					"#modifier_terrorblade_17",
					3,
					"terrorblade/17",
					{ "modifier_terrorblade_16", 1 },
				},
				{ "empty_9" },
				{ "modifier_woda_talent_int4", "#woda_talent_int4", 1, "int4", { "modifier_woda_talent_kaya", 1 } },
			},
			...
			[6] = {
				...
				{ "modifier_woda_talent_regenmp2", "#woda_talent_regenmp2", 3, "regenmp2", {} },
				{
					"modifier_terrorblade_18",
					"#modifier_terrorblade_18",
					3,
					"terrorblade/18",
					{ "modifier_terrorblade_17", 3 },
				},
				{ "empty_15" },
				{ "empty_16" },
			},
	...
	["npc_dota_hero_vengefulspirit"] = {
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_vengefulspirit_17",
					"#modifier_vengefulspirit_17",
					2,
					"vengefulspirit/17",
					{ "modifier_vengefulspirit_18", 2 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_bristleback"] = {
		...
		[2] = {
			...
			[2] = {
				{
					"modifier_bristleback_9",
					"#modifier_bristleback_9",
					2,
					"bristleback/9",
					{ "modifier_bristleback_8", 3 },
				},
				{ "empty_3" },
				{ "empty_4" },
				{ "modifier_woda_talent_miss1", "#woda_talent_miss1", 2, "miss1", {} },
			...
			[3] = {
				{
					"modifier_bristleback_10",
					"#modifier_bristleback_10",
					2,
					"bristleback/10",
					{ "modifier_bristleback_9", 2 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
			...
			[4] = {
				{
					"modifier_bristleback_11",
					"#modifier_bristleback_11",
					3,
					"bristleback/11",
					{ "modifier_bristleback_10", 2 },
				},
				{
					"modifier_woda_talent_speed2",
					"#woda_talent_speed2",
	...
	["npc_dota_hero_ancient_apparition"] = {
		[1] = {
			...
			[4] = {
				...
				{ "empty_9" },
				{
					"modifier_ancient_apparition_4",
					"#modifier_ancient_apparition_4",
					3,
					"ancient_apparition/4",
					{ "modifier_ancient_apparition_2", 2 },
				},
				{ "modifier_woda_talent_octar", "#woda_talent_octar", 2, "octar", {} },
				{ "modifier_woda_talent_str4", "#woda_talent_str4", 1, "str4", { "modifier_woda_talent_sasha", 1 } },
			},
			...
			[6] = {
				...
				{ "modifier_woda_talent_regenhp2", "#woda_talent_regenhp2", 3, "regenhp2", {} },
				{
					"modifier_ancient_apparition_6",
					"#modifier_ancient_apparition_6",
					1,
					"ancient_apparition/6",
					{ "modifier_ancient_apparition_4", 3 },
				},
				{ "empty_15" },
				{ "empty_16" },
			},
	...
	["npc_dota_hero_skeleton_king"] = {
		[1] = {
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_skeleton_king_4",
					"#modifier_skeleton_king_4",
					3,
					"skeleton_king/4",
					{ "modifier_skeleton_king_5", 2 },
				},
				{ "empty_11" },
				{ "modifier_woda_talent_str5", "#woda_talent_str5", 3, "str5", { "modifier_woda_talent_str4", 1 } },
			},
	...
	["npc_dota_hero_naga_siren"] = {
		...
		[3] = {
			...
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_naga_siren_10",
					"#modifier_naga_siren_10",
					3,
					"naga_siren/10",
					{ "modifier_naga_siren_16", 1 },
				},
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
				{ "modifier_woda_talent_kaya", "#woda_talent_kaya", 1, "kaya", { "modifier_woda_talent_int6", 1 } },
			},
	...
	["npc_dota_hero_night_stalker"] = {
		[1] = {
			...
			[4] = {
				...
				{ "empty_9" },
				{
					"modifier_night_stalker_4",
					"#modifier_night_stalker_4",
					1,
					"night_stalker/4",
					{ "modifier_night_stalker_2", 2 },
				},
				{ "modifier_woda_talent_octar", "#woda_talent_octar", 2, "octar", {} },
				{ "modifier_woda_talent_str4", "#woda_talent_str4", 1, "str4", { "modifier_woda_talent_sasha", 1 } },
			},
		...
		[2] = {
			...
			[3] = {
				{
					"modifier_night_stalker_10",
					"#modifier_night_stalker_10",
					3,
					"night_stalker/10",
					{ "modifier_night_stalker_9", 2 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
			...
			[6] = {
				{ "modifier_woda_talent_miss2", "#woda_talent_miss2", 2, "miss2", {} },
				{
					"modifier_night_stalker_13",
					"#modifier_night_stalker_13",
					3,
					"night_stalker/13",
					{ "modifier_night_stalker_12", 1 },
				},
				{ "modifier_woda_talent_attackspeed2", "#woda_talent_attackspeed2", 3, "attackspeed2", {} },
				{ "empty_15" },
				{ "empty_16" },
	...
	["npc_dota_hero_arc_warden"] = {
		...
		[2] = {
			...
			[4] = {
				{
					"modifier_arc_warden_11",
					"#modifier_arc_warden_11",
					3,
					"arc_warden/11",
					{ "modifier_arc_warden_10", 1 },
				},
				{
					"modifier_woda_talent_speed2",
					"#woda_talent_speed2",
	...
	["npc_dota_hero_nyx_assassin"] = {
		...
		[2] = {
			...
			[3] = {
				{
					"modifier_nyx_assassin_10",
					"#modifier_nyx_assassin_10",
					1,
					"nyx_assassin/10",
					{ "modifier_nyx_assassin_9", 1 },
				},
				{ "empty_7" },
				{ "empty_8" },
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
			...
			[4] = {
				{
					"modifier_nyx_assassin_11",
					"#modifier_nyx_assassin_11",
					3,
					"nyx_assassin/11",
					{ "modifier_nyx_assassin_10", 1 },
				},
				{
					"modifier_woda_talent_speed2",
					"#woda_talent_speed2",
	...
	["npc_dota_hero_monkey_king"] = {
		[1] = {
			...
			[3] = {
				...
				{ "modifier_woda_talent_quickhp", "#woda_talent_quickhp", 2, "quickhp", {} },
				{
					"modifier_monkey_king_3",
					"#modifier_monkey_king_3",
					3,
					"monkey_king/3",
					{ "modifier_monkey_king_2", 2 },
				},
				{ "empty_7" },
				{ "modifier_woda_talent_sasha", "#woda_talent_sasha", 1, "sasha", { "modifier_woda_talent_str6", 1 } },
			},
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_monkey_king_5",
					"#modifier_monkey_king_5",
					3,
					"monkey_king/5",
					{ "modifier_monkey_king_3", 3 },
				},
				{ "empty_12" },
				{ "modifier_woda_talent_str5", "#woda_talent_str5", 3, "str5", { "modifier_woda_talent_str4", 1 } },
			},
	...
	["npc_dota_hero_faceless_void"] = {
		[1] = {
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_faceless_void_5",
					"#modifier_faceless_void_5",
					1,
					"faceless_void/5",
					{ "modifier_faceless_void_4", 3 },
				},
				{ "empty_12" },
				{ "modifier_woda_talent_str5", "#woda_talent_str5", 3, "str5", { "modifier_woda_talent_str4", 1 } },
			},
		...
		[2] = {
			...
			[2] = {
				...
				{ "empty_3" },
				{
					"modifier_faceless_void_9",
					"#modifier_faceless_void_9",
					2,
					"faceless_void/9",
					{ "modifier_faceless_void_8", 2 },
				},
				{ "modifier_woda_talent_miss1", "#woda_talent_miss1", 2, "miss1", {} },
				{ "modifier_woda_talent_agi6", "#woda_talent_agi6", 1, "agi6", { "modifier_woda_talent_agi3", 2 } },
			},
			...
			[4] = {
				...
				{
					"modifier_faceless_void_13",
					"#modifier_faceless_void_13",
					2,
					"faceless_void/13",
					{ "modifier_faceless_void_10", 2 },
				},
				{ "modifier_woda_talent_grovebow", "#woda_talent_grovebow", 2, "grovebow", {} },
				{ "modifier_woda_talent_agi4", "#woda_talent_agi4", 1, "agi4", { "modifier_woda_talent_yasha", 1 } },
			},
			...
			[6] = {
				...
				{ "empty_13" },
				{
					"modifier_faceless_void_11",
					"#modifier_faceless_void_11",
					3,
					"faceless_void/11",
					{ "modifier_faceless_void_13", 2 },
				},
				{ "empty_14" },
				{ "modifier_woda_talent_attackspeed2", "#woda_talent_attackspeed2", 3, "attackspeed2", {} },
			},
		...
		[3] = {
			...
			[5] = {
				{ "modifier_woda_talent_spellprism", "#woda_talent_spellprism", 3, "spellprism", {} },
				{
					"modifier_faceless_void_19",
					"#modifier_faceless_void_19",
					3,
					"faceless_void/19",
					{ "modifier_faceless_void_17", 2 },
				},
				{ "empty_10" },
				{ "empty_11" },
				{ "modifier_woda_talent_int5", "#woda_talent_int5", 3, "int5", { "modifier_woda_talent_int4", 1 } },
	...
	["npc_dota_hero_keeper_of_the_light"] = {
		[1] = {
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_keeper_of_the_light_5",
					"#modifier_keeper_of_the_light_5",
					2,
					"keeper_of_the_light/5",
					{ "modifier_keeper_of_the_light_3", 2 },
				},
				{ "empty_12" },
				{ "modifier_woda_talent_str5", "#woda_talent_str5", 3, "str5", { "modifier_woda_talent_str4", 1 } },
			},
		...
		[2] = {
			...
			[2] = {
				...
				{ "empty_3" },
				{
					"modifier_keeper_of_the_light_9",
					"#modifier_keeper_of_the_light_9",
					3,
					"keeper_of_the_light/9",
					{ "modifier_keeper_of_the_light_8", 1 },
				},
				{ "modifier_woda_talent_miss1", "#woda_talent_miss1", 2, "miss1", {} },
				{ "modifier_woda_talent_agi6", "#woda_talent_agi6", 1, "agi6", { "modifier_woda_talent_agi3", 2 } },
			},
			[3] = {
				...
				{ "empty_7" },
				{
					"modifier_keeper_of_the_light_10",
					"#modifier_keeper_of_the_light_10",
					3,
					"keeper_of_the_light/10",
					{ "modifier_keeper_of_the_light_9", 3 },
				},
				{ "modifier_woda_talent_mask1", "#woda_talent_mask1", 2, "mask1", {} },
				{ "modifier_woda_talent_yasha", "#woda_talent_yasha", 1, "yasha", { "modifier_woda_talent_agi6", 1 } },
			},
			[4] = {
				...
				{ "modifier_woda_talent_grovebow", "#woda_talent_grovebow", 2, "grovebow", {} },
				{
					"modifier_keeper_of_the_light_11",
					"#modifier_keeper_of_the_light_11",
					1,
					"keeper_of_the_light/11",
					{},
				},
				{ "modifier_woda_talent_agi4", "#woda_talent_agi4", 1, "agi4", { "modifier_woda_talent_yasha", 1 } },
			},
			[5] = {
				...
				{ "empty_11" },
				{
					...
					"#modifier_keeper_of_the_light_12",
					2,
					"keeper_of_the_light/12",
					{ "modifier_keeper_of_the_light_11", 1 },
				},
				{ "modifier_woda_talent_agi5", "#woda_talent_agi5", 3, "agi5", { "modifier_woda_talent_agi4", 1 } },
			},
			[6] = {
				...
				{ "modifier_woda_talent_attackspeed2", "#woda_talent_attackspeed2", 3, "attackspeed2", {} },
				{
					"modifier_keeper_of_the_light_13",
					"#modifier_keeper_of_the_light_13",
					3,
					"keeper_of_the_light/13",
					{ "modifier_keeper_of_the_light_12", 2 },
				},
				{ "empty_14" },
			},
			[7] = {
				...
				{ "empty_18" },
				{
					"modifier_keeper_of_the_light_14",
					"#modifier_keeper_of_the_light_14",
					1,
		...
		[3] = {
			[1] = {
				...
				{ "modifier_woda_talent_spell", "#woda_talent_spell", 3, "spell", {} },
				{
					"modifier_keeper_of_the_light_15",
					"#modifier_keeper_of_the_light_15",
					3,
					"keeper_of_the_light/15",
					{},
				},
				{ "modifier_woda_talent_int3", "#woda_talent_int3", 2, "int3", {} },
			},
			[2] = {
				...
				{ "empty_4" },
				{
					"modifier_keeper_of_the_light_16",
					"#modifier_keeper_of_the_light_16",
					3,
					"keeper_of_the_light/16",
					{},
				},
				{ "modifier_woda_talent_blood", "#woda_talent_blood", 2, "blood", {} },
				{ "modifier_woda_talent_int6", "#woda_talent_int6", 1, "int6", { "modifier_woda_talent_int3", 2 } },
			...
			[3] = {
				{ "empty_6" },
				{
					"modifier_keeper_of_the_light_17",
					"#modifier_keeper_of_the_light_17",
					3,
					"keeper_of_the_light/17",
					{},
				},
				{ "empty_7" },
				{ "modifier_woda_talent_mask2", "#woda_talent_mask2", 2, "mask2", {} },
			...
			[4] = {
				...
				{ "modifier_woda_talent_fairy", "#woda_talent_fairy", 2, "fairy", {} },
				{
					"modifier_keeper_of_the_light_18",
					"#modifier_keeper_of_the_light_18",
					2,
					"keeper_of_the_light/18",
					{},
				},
				{ "empty_8" },
				{ "modifier_woda_talent_int4", "#woda_talent_int4", 1, "int4", { "modifier_woda_talent_kaya", 1 } },
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_keeper_of_the_light_20",
					"#modifier_keeper_of_the_light_20",
					1,
					"keeper_of_the_light/20",
					{},
				},
				{ "modifier_woda_talent_int5", "#woda_talent_int5", 3, "int5", { "modifier_woda_talent_int4", 1 } },
			},
			[6] = {
				...
				{ "modifier_woda_talent_regenmp2", "#woda_talent_regenmp2", 3, "regenmp2", {} },
				{
					"modifier_keeper_of_the_light_19",
					"#modifier_keeper_of_the_light_19",
					1,
					"keeper_of_the_light/19",
					{},
				},
				{ "empty_15" },
			},
			[7] = {
				...
				{ "empty_18" },
				{
					"modifier_keeper_of_the_light_21",
					"#modifier_keeper_of_the_light_21",
					1,
					"keeper_of_the_light/21",
					{},
				},
				{ "empty_20" },
				{ "empty_21" },
	...
	["npc_dota_hero_dawnbreaker"] = {
		...
		[3] = {
			...
			[5] = {
				...
				{ "empty_10" },
				{
					"modifier_dawnbreaker_19",
					"#modifier_dawnbreaker_19",
					2,
					"dawnbreaker/19",
					{ "modifier_dawnbreaker_17", 1 },
				},
				{ "empty_12" },
				{ "modifier_woda_talent_int5", "#woda_talent_int5", 3, "int5", { "modifier_woda_talent_int4", 1 } },
			},
