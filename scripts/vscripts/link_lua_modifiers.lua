...
LinkLuaModifier(
	"modifier_spell_amplify_controller",
	"heroes/modifier_spell_amplify_controller",
	LUA_MODIFIER_MOTION_NONE
)
...
LinkLuaModifier(
	"modifier_creature_berserk_debuff",
	"creature_ability/modifier_creature_berserk_debuff",
	LUA_MODIFIER_MOTION_NONE
)
...
LinkLuaModifier(
	"modifier_creature_true_sight",
	"creature_ability/modifier_creature_true_sight",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_creature_spell_amplify",
	"creature_ability/modifier_creature_spell_amplify",
	LUA_MODIFIER_MOTION_NONE
)
...
LinkLuaModifier(
	"modifier_broodmother_spin_web_web_lua",
	"heroes/hero_broodmother/modifier_broodmother_spin_web_web_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier("modifier_abilities_fix", "heroes/modifier_abilities_fix.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier(
	"modifier_cosmetic_attack_effect",
	"mechanics/wereable_system/modifier_cosmetic_attack_effect.lua",
	LUA_MODIFIER_MOTION_NONE
)