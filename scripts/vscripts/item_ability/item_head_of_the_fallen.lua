...
LinkLuaModifier(
	"modifier_item_Head_of_the_Fallen",
	"item_ability/item_Head_of_the_Fallen.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_Head_of_the_Fallen_effect",
	"item_ability/item_Head_of_the_Fallen.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_Head_of_the_Fallen_Active",
	"item_ability/item_Head_of_the_Fallen.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_Head_of_the_Fallen_burn",
	"item_ability/item_Head_of_the_Fallen.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
	...
	if IsValid(hCaster) and hCaster:HasModifier("modifier_item_Head_of_the_Fallen_Active") then
		if not self.bActive then
			...
			self.particleID = ParticleManager:CreateParticle(
				"particles/items/head_of_the_fallen.vpcf",
				PATTACH_ABSORIGIN_FOLLOW,
				hParent
			)
		end
