	...
	if IsServer() then
		...
		then
			...
			if hCaster.bTakenOverByBot then
				...
				HeroBuilder.totalAbilityNumber[hCaster:GetPlayerID()] = HeroBuilder.totalAbilityNumber[hCaster:GetPlayerID()]
					+ 1
				...
				if hPlayer then
					...
					HeroBuilder.BonusAbilityNumber[hPlayer:GetPlayerID()] = HeroBuilder.BonusAbilityNumber[hPlayer:GetPlayerID()]
						+ 1
					HeroBuilder.totalAbilityNumber[nPlayerID] = HeroBuilder.BasicAbilityNumber[nPlayerID]
						+ HeroBuilder.BonusAbilityNumber[nPlayerID]
