...
--Abilities
if item_gang_dinner_invitation_letter == nil then
	item_gang_dinner_invitation_letter = class({})
end
function item_gang_dinner_invitation_letter:GetIntrinsicModifierName()
