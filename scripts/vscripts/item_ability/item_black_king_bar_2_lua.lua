...
LinkLuaModifier(
	"modifier_item_black_king_bar_2_lua",
	"item_ability/item_black_king_bar_2_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_black_king_bar_2_lua_debuff",
	"item_ability/item_black_king_bar_2_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_item_black_king_bar_2_lua_buff",
	"item_ability/item_black_king_bar_2_lua.lua",
	LUA_MODIFIER_MOTION_NONE
)
--Abilities
