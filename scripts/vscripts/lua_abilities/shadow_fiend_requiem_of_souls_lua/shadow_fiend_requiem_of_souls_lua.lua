...
LinkLuaModifier(
	...
	"lua_abilities/shadow_fiend_requiem_of_souls_lua/modifier_shadow_fiend_requiem_of_souls_lua",
	LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
	"modifier_shadow_fiend_requiem_of_souls_lua_scepter",
	"lua_abilities/shadow_fiend_requiem_of_souls_lua/modifier_shadow_fiend_requiem_of_souls_lua_scepter",
	LUA_MODIFIER_MOTION_NONE
)
...
function shadow_fiend_requiem_of_souls_lua:OnSpellStart()
	...
	--统计有多少个恶魔
	local demon_count = self:GetCaster().demon_count or 0
...
function shadow_fiend_requiem_of_souls_lua:Explode(lines)
	...
	for i = 0, lines - 1 do
		...
		-- Create the particle
		local particle_lines_fx = ParticleManager:CreateParticle(particle_lines, PATTACH_ABSORIGIN, self:GetCaster())
...
function shadow_fiend_requiem_of_souls_lua:Implode(lines, modifier)
	...
	-- get projectile
	-- local particle_line = "particles/units/heroes/hero_shadow_demon/shadow_demon_shadow_poison_projectile.vpcf"
	local particle_line = "particles/units/heroes/hero_spectre/spectre_spectral_dagger.vpcf"
	local line_length = self:GetSpecialValueFor("requiem_radius")
