...
function modifier_primal_beast_pulverize_lua_debuff:OnRefresh(kv) end
...
function modifier_primal_beast_pulverize_lua_debuff:OnDestroy()
	...
	if
		not (self.parent:IsCurrentlyHorizontalMotionControlled() or self.parent:IsCurrentlyVerticalMotionControlled())
	then
...
function modifier_primal_beast_pulverize_lua_debuff:UpdateVerticalMotion(me, dt)
	...
	mepos.z = pos.z + ((me.dog_index or 0) * 100)
	me:SetOrigin(mepos)
end
