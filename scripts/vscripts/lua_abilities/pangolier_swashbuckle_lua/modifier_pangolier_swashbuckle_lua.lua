...
function modifier_pangolier_swashbuckle_lua:OnRefresh(kv) end

function modifier_pangolier_swashbuckle_lua:OnRemoved() end

function modifier_pangolier_swashbuckle_lua:OnDestroy() end
