...
function AddTinyBody(hUnit)
	if
		hUnit:GetUnitName() == "npc_dota_creature_tiny_01"
		or hUnit:GetUnitName() == "npc_dota_creature_player_tiny_01"
	then
		local hTorso =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_01/tiny_01_body.vmdl" })
		hTorso:FollowEntity(hUnit, true)
		local hLeft_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_01/tiny_01_left_arm.vmdl" })
		hLeft_arm:FollowEntity(hUnit, true)
		local hRight_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_01/tiny_01_right_arm.vmdl" })
		hRight_arm:FollowEntity(hUnit, true)
	end

	if
		hUnit:GetUnitName() == "npc_dota_creature_tiny_02"
		or hUnit:GetUnitName() == "npc_dota_creature_player_tiny_02"
	then
		local hTorso =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_02/tiny_02_body.vmdl" })
		hTorso:FollowEntity(hUnit, true)
		local hLeft_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_02/tiny_02_left_arm.vmdl" })
		hLeft_arm:FollowEntity(hUnit, true)
		local hRight_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_02/tiny_02_right_arm.vmdl" })
		hRight_arm:FollowEntity(hUnit, true)
	end

	if
		hUnit:GetUnitName() == "npc_dota_creature_tiny_03"
		or hUnit:GetUnitName() == "npc_dota_creature_player_tiny_03"
	then
		local hTorso =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_04/tiny_04_body.vmdl" })
		hTorso:FollowEntity(hUnit, true)
		local hLeft_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_04/tiny_04_left_arm.vmdl" })
		hLeft_arm:FollowEntity(hUnit, true)
		local hRight_arm =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_04/tiny_04_right_arm.vmdl" })
		hRight_arm:FollowEntity(hUnit, true)
	end

	if
		hUnit:GetUnitName() == "npc_dota_creature_tiny_04"
		or hUnit:GetUnitName() == "npc_dota_creature_player_tiny_04"
	then
		local hTorso =
			SpawnEntityFromTableSynchronous("prop_dynamic", { model = "models/heroes/tiny_04/tiny_04_body.vmdl" })
		hTorso:FollowEntity(hUnit, true)
...
function CreateIllusion(hUnit, nDuration, nIncomeDamage, nOutDamage, vLocation, vModifiers, hAbility)
	...
	hIllusion:AddNewModifier(
		hUnit,
		hAbility,
		"modifier_illusion",
		{ duration = nDuration, outgoing_damage = nOutDamage, incoming_damage = nIncomeDamage }
	)
