		...
		spring_2021 = {
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					local iParticleID = ParticleManager:CreateParticle(
						"particles/econ/events/spring_2021/blink_dagger_spring_2021_start.vpcf",
						PATTACH_CUSTOMORIGIN,
						hCaster
					)
					ParticleManager:SetParticleControl(iParticleID, 0, hCaster:GetAbsOrigin())
		...
		spring_2021_lvl2 = {
			...
			},
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					local vPos = tData.vPos
					local iParticleID = ParticleManager:CreateParticle(
						"particles/econ/events/spring_2021/blink_dagger_spring_2021_end_lvl2.vpcf",
						PATTACH_CUSTOMORIGIN,
						hCaster
					)
					ParticleManager:SetParticleControl(iParticleID, 0, vPos)
		...
		winter_major = {
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					local iParticleID = ParticleManager:CreateParticle(
						"particles/econ/events/winter_major_2017/blink_dagger_start_wm07.vpcf",
						PATTACH_CUSTOMORIGIN,
						hCaster
					)
					ParticleManager:SetParticleControl(iParticleID, 0, hCaster:GetAbsOrigin())
		...
		["18000001"] = {
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					local iParticleID = ParticleManager:CreateParticle(
						"particles/items/refresher_timer.vpcf",
						PATTACH_ABSORIGIN_FOLLOW,
						hCaster
					)
					ParticleManager:SetParticleControlEnt(
		...
		["18000005"] = {
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					...
					if IsValid(hTarget) then
						local iParticleID = ParticleManager:CreateParticle(
							"particles/items/felling_shield_bone_manaburn_impact_model.vpcf",
						...
						ParticleManager:SetParticleControlTransformForward(
							...
							(hCaster:GetAbsOrigin() - hTarget:GetAbsOrigin()):Normalized()
						)
						ParticleManager:SetParticleControlTransformForward(
							iParticleID,
							10,
							Vector(0, 0, 0),
							hTarget:GetForwardVector()
						)
						ParticleManager:ReleaseParticleIndex(iParticleID)
					end
				end,
			},
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					if IsValid(hCaster) then
						...
						if tBuff then
							local iParticleID = ParticleManager:CreateParticle(
								"particles/items/felling_shield_bone.vpcf",
								PATTACH_ABSORIGIN_FOLLOW,
								hCaster
							)
							tBuff:AddParticle(iParticleID, false, false, -1, false, false)
			...
			},
			{
				...
				callback = function(hCaster, sAbilityName, tData)
					...
					if IsValid(hTarget) then
						if tBuff then
							local iParticleID = ParticleManager:CreateParticle(
								"particles/items/felling_shield_bone_slow.vpcf",
								PATTACH_ABSORIGIN_FOLLOW,
								hTarget
							)
							tBuff:AddParticle(iParticleID, false, false, -1, false, false)
							...
							local iParticleID2 = ParticleManager:CreateParticle(
								"particles/items/felling_shield_bone_slow_chain_cast.vpcf",
								PATTACH_ABSORIGIN_FOLLOW,
								hTarget
							)
							ParticleManager:SetParticleControlEnt(
