...
function modifier_wearable_model:IsHidden()
	return true
end

function modifier_wearable_model:IsDebuff()
	return false
end

function modifier_wearable_model:IsPurgable()
	return false
end

function modifier_wearable_model:GetAttributes()
	return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end

function modifier_wearable_model:RemoveOnDeath()
	return false
end
...
function modifier_wearable_model_refresh:IsHidden()
	return false
end

function modifier_wearable_model_refresh:IsDebuff()
	return false
end

function modifier_wearable_model_refresh:IsPurgable()
	return false
end

function modifier_wearable_model_refresh:GetAttributes()
	return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end

function modifier_wearable_model_refresh:RemoveOnDeath()
	return false
end
...
function modifier_warlock_golem_burning_puppet:IsHidden()
	return true
end
function modifier_warlock_golem_burning_puppet:IsDebuff()
	return false
end
function modifier_warlock_golem_burning_puppet:IsPurgable()
	return false
end
function modifier_warlock_golem_burning_puppet:GetAttributes()
	return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end
function modifier_warlock_golem_burning_puppet:RemoveOnDeath()
	return false
end
